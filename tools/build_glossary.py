...
("toll-houses", "Aerial Toll-houses", {"el": "Τελώνια"},
 "An account of the soul's passage after death, in which it is examined by demons at successive stages. Found in patristic, hagiographic and liturgical sources and defended by many saints; its systematised form is contested by some contemporary theologians and hierarchs. Plithos presents the sources without adjudicating between them.",
 ["eschatology", "departed", "contested"], ["departed-prayers", "panikhida"]),
