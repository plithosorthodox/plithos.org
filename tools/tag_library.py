...
WORKS = {
 ...
 "chrysostom-homilies-acts":                 ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-1corinthians":         ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-2corinthians":         ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-ephesians":            ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-philippians":          ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-colossians":           ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-1thessalonians":       ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-2thessalonians":       ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-1timothy":             ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-2timothy":             ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-titus":                ("St John Chrysostom", "Scripture opened"),
 "chrysostom-homilies-philemon":             ("St John Chrysostom", "Scripture opened"),
 "chrysostom-commentary-galatians": ("St John Chrysostom", "Scripture opened"),
