...
"bg": dict(
 ...
 partial="Всички православни църкви са включени тук. Техните епархии се добавят област по област, затова една църква може да има много повече епархии от показаните.",
