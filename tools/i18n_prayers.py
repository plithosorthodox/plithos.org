...
LANGS = ["en", "el", "ru", "ro", "uk", "de", "es", "ar", "fr", "pt", "it",
         "sr", "ka", "zh", "ja", "ko", "sw", "hy", "arc", "hi", "bn", "ur", "bg"]
...
"bg": {"navCal":"Календар","navSaints":"Светии","navLib":"Библиотека","navPrayers":"Молитви","navRule":"Правило","navGlossary":"Речник","navContact":"Контакти",
 "h1":"Молитви","lede":"Традиционните молитви на Православната църква, подредени като молитвеник. Изберете раздел или потърсете.",
 "sections":"Раздели","all":"Всички молитви","ph":"Търсене на молитви","back":"Всички молитви","copy":"Копирай","copied":"Копирано",
 "none":"Няма съответстваща молитва.","n_one":"1 молитва","n_many":"# молитви","src":"Източник","words":"думи",
 "partial":"Тази молитва все още не е достъпна на този език и е показана на английски."},
}
...
# ----------------------------------------- the "On measure" panel above the list
# Shown at the head of the Prayers page. The Didache is quoted inside it.
MEASURE = {
"en": {"h":"On measure.","b":"These are set out in full because they are the Church's inheritance. Setting them out in full is not the same as saying anyone must keep all of it. The rule you keep is set by your spiritual father, according to your knowledge, your capability and your circumstances - and the earliest Christian manual we possess says plainly:","q":"if you are able to bear all the yoke of the Lord, you will be perfect; but if you are not able, what you are able that do","c":"(The Didache 6)","link":"On the Prayer Rule"},
"el": {"h":"Περὶ μέτρου.","b":"Παρατίθενται πλήρη διότι είναι η κληρονομία της Εκκλησίας. Το να παρατίθενται πλήρη δεν σημαίνει ότι οφείλει κανείς να τα τηρεί όλα. Τον κανόνα που τηρείτε τον ορίζει ο πνευματικός σας πατέρας, κατά τη γνώση, τη δύναμη και τις περιστάσεις σας - και το αρχαιότερο χριστιανικό εγχειρίδιο που έχουμε λέγει καθαρά:","q":"εἰ μὲν δύνασαι βαστάσαι ὅλον τὸν ζυγὸν τοῦ Κυρίου, τέλειος ἔσῃ· εἰ δ' οὐ δύνασαι, ὃ δύνῃ, τοῦτο ποίει","c":"(Διδαχή 6)","link":"Περὶ τοῦ Κανόνος τῆς Προσευχῆς"},
"ru": {"h":"О мере.","b":"Они приводятся полностью, потому что это наследие Церкви. Приводить их полностью не значит говорить, что всякий обязан исполнять всё. Правило, которое вы держите, определяет ваш духовный отец, по вашему разумению, силам и обстоятельствам, - а древнейшее христианское руководство, которым мы располагаем, говорит прямо:","q":"если можешь понести все иго Господне, будешь совершен; если же не можешь, делай то, что можешь","c":"(Дидахе 6)","link":"О молитвенном правиле"},
"ro": {"h":"Despre măsură.","b":"Sunt date în întregime pentru că sunt moștenirea Bisericii. A le da în întregime nu înseamnă a spune că cineva trebuie să le țină pe toate. Pravila pe care o ții este rânduită de duhovnicul tău, după cunoștința, puterea și împrejurările tale - iar cel mai vechi manual creștin pe care îl avem spune limpede:","q":"dacă poți purta tot jugul Domnului, vei fi desăvârșit; iar de nu poți, fă ceea ce poți","c":"(Didahia 6)","link":"Despre pravila de rugăciune"},
"uk": {"h":"Про міру.","b":"Вони наводяться повністю, бо це спадщина Церкви. Наводити їх повністю не означає казати, що кожен мусить виконувати все. Правило, яке ви тримаєте, визначає ваш духовний отець, за вашим розумінням, силами й обставинами, - а найдавніший християнський посібник, який ми маємо, говорить прямо:","q":"якщо можеш понести все ярмо Господнє, будеш досконалий; коли ж не можеш, роби те, що можеш","c":"(Дідахе 6)","link":"Про молитовне правило"},
"de": {"h":"Vom rechten Maß.","b":"Sie stehen hier vollständig, weil sie das Erbe der Kirche sind. Sie vollständig hinzustellen heißt nicht, dass jemand alles halten müsste. Die Regel, die Sie halten, setzt Ihr geistlicher Vater fest, nach Ihrer Erkenntnis, Ihrer Kraft und Ihren Umständen - und das älteste christliche Handbuch, das wir besitzen, sagt es unmissverständlich:","q":"Wenn du das ganze Joch des Herrn tragen kannst, wirst du vollkommen sein; kannst du es aber nicht, so tue, was du kannst","c":"(Didache 6)","link":"Über die Gebetsregel"},
"es": {"h":"Sobre la medida.","b":"Se exponen íntegras porque son la herencia de la Iglesia. Exponerlas íntegras no equivale a decir que alguien deba guardarlas todas. La regla que usted guarda la establece su padre espiritual, según su conocimiento, su capacidad y sus circunstancias - y el manual cristiano más antiguo que poseemos lo dice con claridad:","q":"si puedes llevar todo el yugo del Señor, serás perfecto; pero si no puedes, haz lo que puedas","c":"(Didajé 6)","link":"Sobre la Regla de Oración"},
"ar": {"h":"في المقدار.","b":"تُعرض كاملة لأنها ميراث الكنيسة. وعرضها كاملة ليس قولاً بأن على أحد أن يحفظها كلها. القانون الذي تحفظه يعيّنه أبوك الروحي بحسب معرفتك وطاقتك وظروفك - وأقدم دليل مسيحي بين أيدينا يقول صراحةً:","q":"إن استطعت أن تحمل نير الرب كله فستكون كاملاً؛ وإن لم تستطع، فافعل ما تستطيع","c":"(الديداخي ٦)","link":"في قانون الصلاة"},
"fr": {"h":"De la mesure.","b":"Elles sont données en entier parce qu'elles sont l'héritage de l'Église. Les donner en entier n'est pas dire que quiconque doive tout garder. La règle que vous gardez est fixée par votre père spirituel, selon votre connaissance, votre capacité et vos circonstances - et le plus ancien manuel chrétien que nous possédions le dit clairement:","q":"si tu peux porter tout le joug du Seigneur, tu seras parfait; mais si tu ne le peux, fais ce que tu peux","c":"(Didachè 6)","link":"Sur la Règle de prière"},
"pt": {"h":"Sobre a medida.","b":"São dadas por inteiro porque são a herança da Igreja. Dá-las por inteiro não é dizer que alguém deva guardá-las todas. A regra que guarda é fixada pelo seu pai espiritual, segundo o seu conhecimento, a sua capacidade e as suas circunstâncias - e o mais antigo manual cristão que possuímos diz claramente:","q":"se podes levar todo o jugo do Senhor, serás perfeito; mas se não podes, faz o que podes","c":"(Didaqué 6)","link":"Sobre a Regra de Oração"},
"it": {"h":"Sulla misura.","b":"Sono riportate per intero perché sono l'eredità della Chiesa. Riportarle per intero non equivale a dire che qualcuno debba osservarle tutte. La regola che osservate la stabilisce il vostro padre spirituale, secondo la vostra conoscenza, le vostre forze e le vostre circostanze - e il più antico manuale cristiano che possediamo lo dice chiaramente:","q":"se puoi portare tutto il giogo del Signore, sarai perfetto; ma se non puoi, fa' quello che puoi","c":"(Didachè 6)","link":"Sulla Regola di preghiera"},
"sr": {"h":"О мери.","b":"Наведене су у целини јер су наслеђе Цркве. Навести их у целини не значи рећи да их ико мора све држати. Правило које држиш одређује твој духовни отац, према твом знању, твојој снази и твојим приликама - а најстарији хришћански приручник који имамо каже јасно:","q":"ако можеш понети сав јарам Господњи, бићеш савршен; ако ли не можеш, чини што можеш","c":"(Дидахи 6)","link":"О молитвеном правилу"},
"ka": {"h":"ზომის შესახებ.","b":"ისინი სრულად არის მოცემული, რადგან ეკლესიის მემკვიდრეობაა. სრულად მოცემა არ ნიშნავს, რომ ვინმემ ყველაფერი უნდა შეასრულოს. წესს, რომელსაც იცავთ, თქვენი სულიერი მამა განსაზღვრავს თქვენი ცოდნის, ძალისა და გარემოებების მიხედვით - უძველესი ქრისტიანული სახელმძღვანელო კი ცხადად ამბობს:","q":"თუ შეგიძლია უფლის მთელი უღლის ტვირთვა, სრული იქნები; ხოლო თუ არ შეგიძლია, ის აკეთე, რაც შეგიძლია","c":"(დიდაქე 6)","link":"ლოცვის წესის შესახებ"},
"zh": {"h":"论分寸。","b":"此处全备列出，因这是教会的遗产。全备列出，并非说人人都须尽守。你所守的规则，由你的属灵之父按你的见识、你的力量与你的处境而定——我们所存最古的基督徒手册说得明白：","q":"你若能负主全副的轭，就必完全；若不能，就尽你所能而行","c":"（《十二使徒遗训》六）","link":"论祈祷规则"},
"ja": {"h":"程合いについて。","b":"これらを漏らさず掲げているのは、教会の遺産だからです。漏らさず掲げることは、誰もがそのすべてを守らねばならぬという意味ではありません。あなたが守る規矩は、あなたの知識と力と境遇に応じて、あなたの霊的父が定めます。私たちの有する最古のキリスト教手引はこう明言しています。","q":"主の軛をことごとく負い得るならば、あなたは全き者となる。もし負い得ぬならば、なし得ることをなせ","c":"（ディダケー六）","link":"祈りの規矩について"},
"ko": {"h":"분량에 대하여.","b":"이것들을 빠짐없이 실은 것은 교회의 유산이기 때문입니다. 빠짐없이 싣는다는 것이 누구나 그 전부를 지켜야 한다는 뜻은 아닙니다. 당신이 지키는 규칙은 당신의 지식과 능력과 형편에 따라 당신의 영적 아버지가 정합니다. 우리가 가진 가장 오래된 그리스도교 지침서는 분명히 말합니다.","q":"주님의 멍에를 온전히 질 수 있으면 너는 온전하게 되리라. 그러나 질 수 없거든 할 수 있는 만큼 하라","c":"(디다케 6)","link":"기도 규칙에 대하여"},
"sw": {"h":"Kuhusu kipimo.","b":"Zimewekwa hapa kwa ukamilifu kwa sababu ni urithi wa Kanisa. Kuziweka kwa ukamilifu si kusema kwamba ni lazima mtu azishike zote. Kanuni unayoishika huwekwa na baba yako wa kiroho, kwa kadiri ya ufahamu wako, uwezo wako na hali zako - na mwongozo wa Kikristo wa kale zaidi tulio nao wasema wazi:","q":"kama waweza kubeba nira yote ya Bwana, utakuwa mkamilifu; lakini kama huwezi, fanya uwezalo","c":"(Didache 6)","link":"Kuhusu Kanuni ya Sala"},
"hy": {"h":"Չափի մասին։","b":"Դրանք ամբողջությամբ են բերված, քանի որ Եկեղեցու ժառանգությունն են։ Ամբողջությամբ բերելը չի նշանակում, թե որևէ մեկը պարտավոր է պահել ամենը։ Այն կանոնը, որ պահում ես, սահմանում է քո հոգևոր հայրը՝ ըստ քո գիտության, կարողության և հանգամանքների, - իսկ մեր ունեցած ամենահին քրիստոնեական ձեռնարկը պարզ ասում է.","q":"եթե կարող ես կրել Տիրոջ ամբողջ լուծը, կատարյալ կլինես. իսկ եթե չես կարող, արա այն, ինչ կարող ես","c":"(Դիդախե 6)","link":"Աղոթքի կանոնի մասին"},
"arc": {"h":"ܥܲܠ ܡܫܘܼܚܬܵܐ.","b":"ܡܸܬܬܣܝܼܡܝܼ ܡܫܲܡܠܝܵܐܝܼܬ ܡܛܠ ܕܝܵܪܬܘܼܬܵܐ ܐܸܢܘܿܢ ܕܥܹܕܬܵܐ. ܘܲܣܝܵܡܗܘܿܢ ܡܫܲܡܠܝܵܐܝܼܬ ܠܵܐ ܐܵܡܲܪ ܕܐ̄ܢܵܫ ܘܵܠܹܐ ܕܢܸܛܲܪ ܟܠܗܘܿܢ. ܩܢܘܿܢܵܐ ܕܢܵܛܪܸܬ ܡܸܬܬܣܝܼܡ ܡܼܢ ܐܲܒ݂ܘܼܟ݂ ܪܘܼܚܵܢܵܝܵܐ, ܐܲܝܟ݂ ܝܼܕܲܥܬܵܟ݂ ܘܚܲܝܠܵܟ݂ ܘܣܘܼܥܪ̈ܵܢܲܝܟ - ܘܲܟܬܵܒ݂ܵܐ ܟܪܹܣܛܝܵܢܵܝܵܐ ܥܲܬܝܼܩܵܐ ܕܐܝܼܬ ܠܲܢ ܐܵܡܲܪ ܓܲܠܝܵܐܝܼܬ.","q":"ܐܸܢ ܡܵܨܹܝܬ ܕܬܸܫܩܘܿܠ ܟܠܹܗ ܢܝܼܪܵܐ ܕܡܵܪܝܵܐ, ܓܡܝܼܪܵܐ ܗܵܘܹܝܬ. ܘܐܸܢ ܠܵܐ ܡܵܨܹܝܬ, ܡܸܕܹܡ ܕܡܵܨܹܝܬ ܗܵܘܹܐ ܥܒ݂ܸܕ","c":"(ܕܝܼܕܵܟܹܐ ܘ)","link":"ܥܲܠ ܩܢܘܿܢܵܐ ܕܲܨܠܘܿܬܵܐ"},
"hi": {"h":"मात्रा के विषय में।","b":"ये पूर्ण रूप से यहाँ रखी गई हैं, क्योंकि ये कलीसिया की विरासत हैं। इन्हें पूर्ण रूप से रखने का अर्थ यह नहीं कि किसी को इन सबका पालन करना ही होगा। जिस नियम का आप पालन करते हैं, उसे आपके आध्यात्मिक पिता आपके ज्ञान, आपकी सामर्थ्य और आपकी परिस्थितियों के अनुसार ठहराते हैं - और हमारे पास जो सबसे प्राचीन ईसाई निर्देश-पुस्तक है, वह स्पष्ट कहती है:","q":"यदि तू प्रभु का सारा जूआ उठा सके, तो तू सिद्ध होगा; परन्तु यदि न उठा सके, तो जो कर सके वही कर","c":"(दिदाखे ६)","link":"प्रार्थना के नियम पर"},
"bn": {"h":"পরিমাণ প্রসঙ্গে।","b":"এগুলি সম্পূর্ণরূপে দেওয়া হয়েছে, কারণ এগুলি মণ্ডলীর উত্তরাধিকার। সম্পূর্ণরূপে দেওয়ার অর্থ এই নয় যে কাউকে এর সবই পালন করতে হবে। আপনি যে নিয়ম পালন করেন তা আপনার আধ্যাত্মিক পিতা আপনার জ্ঞান, সামর্থ্য ও পরিস্থিতি অনুসারে স্থির করেন - আর আমাদের কাছে থাকা প্রাচীনতম খ্রিস্টীয় নির্দেশিকা স্পষ্ট বলে:","q":"যদি তুমি প্রভুর সমস্ত জোয়াল বহন করতে পার, তবে তুমি সিদ্ধ হবে; কিন্তু যদি না পার, যা পার তাই কর","c":"(দিদাখে ৬)","link":"প্রার্থনার নিয়ম প্রসঙ্গে"},
"ur": {"h":"مقدار کے بارے میں۔","b":"یہ مکمل طور پر یہاں درج ہیں، کیونکہ یہ کلیسیا کی میراث ہیں۔ مکمل درج کرنے کا مطلب یہ نہیں کہ کسی پر ان سب کا پابند ہونا لازم ہے۔ جو قاعدہ آپ نبھاتے ہیں وہ آپ کا روحانی باپ آپ کے علم، آپ کی طاقت اور آپ کے حالات کے مطابق مقرر کرتا ہے - اور قدیم ترین مسیحی رہنما کتاب جو ہمارے پاس ہے صاف کہتی ہے:","q":"اگر تو خداوند کا سارا جوا اٹھا سکے تو تُو کامل ہوگا؛ لیکن اگر نہ اٹھا سکے تو جو کر سکتا ہے وہی کر","c":"(دیداخے ۶)","link":"دعا کے قاعدے پر"},
"bg": {"h":"За мярката.","b":"Тези молитви са изложени изцяло, защото са наследство на Църквата. Това, че са изложени изцяло, не означава, че всеки трябва да изпълнява всичко. Правилото, което изпълнявате, се определя от духовния ви отец според вашето разбиране, вашите сили и обстоятелствата ви - а най-старото християнско ръководство, което притежаваме, казва ясно:","q":"Ако можеш да носиш цялото Господне иго, ще бъдеш съвършен. Ако не можеш, прави това, което можеш.","c":"(Дидахи 6)","link":"За молитвеното правило"},
}

# Bulgarian follows the vocabulary of the Bulgarian Patriarchate's prayer
# book and the received forms already published in the Bulgarian prayer and
# Rule corpora.
_SECTIONS_BG = {
    "daily": "Утринни и вечерни молитви",
    "hours": "Часовете",
    "heart": "Иисусовата молитва и кратки молитви",
    "communion": "Свето Причастие",
    "intercession": "Богородица, ангелите и светиите",
    "others": "За другите",
    "self": "За себе си",
    "occasions": "Животът и неговите обстоятелства",
    "psalms": "Псалми",
}
_SECTION_DESC_BG = {
    "daily": "Установеното правило за деня, казвано при ставане и преди сън.",
    "hours": "Молитвата на Църквата през деня, от Полунощницата до Повечерието.",
    "heart": "Самата Иисусова молитва и други кратки молитви за употреба през деня.",
    "communion": "Подготовка преди светите Тайни и благодарение след това. Отците поставят като условие за пристъпване чистата съвест, а не броя на предварително прочетените молитви - виж За молитвеното правило.",
    "intercession": "Молитви към Божията Майка, безплътните сили и светиите.",
    "others": "За семейството, сродниците, живите и починалите.",
    "self": "Покаяние, духовен живот и молитва в скръб и изпитание.",
    "occasions": "Домът, пътуването, работата и учението, бракът и раждането на деца.",
    "psalms": "Псалмите, които най-често се употребяват в личната молитва.",
}
_GROUPS_BG = {
    "The Order of Preparation": "Последование за подготовка",
    "Immediately before receiving": "Непосредствено преди причастяване",
    "After receiving": "След причастяване",
    "The Jesus Prayer": "Иисусовата молитва",
    "Short prayers for use through the day": "Кратки молитви през деня",
}
for _key, _value in _SECTIONS_BG.items():
    SECTIONS[_key]["bg"] = _value
for _key, _value in _SECTION_DESC_BG.items():
    SECTION_DESC[_key]["bg"] = _value
for _key, _value in _GROUPS_BG.items():
    GROUPS[_key]["bg"] = _value
