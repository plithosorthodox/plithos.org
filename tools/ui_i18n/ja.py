# -*- coding: utf-8 -*-
"""JA interface strings. TEXT = {"surface|key": the rendering}.
...
"この日は聖体礼儀が行われません（斎日）。定められた聖書日課は晩課と時課にあります。",

"index.NOTES|festalNote":
"示されている聖書日課は祭日に定められたものです。",

"index.NOTES|lectGap":
"この日の日々の聖書日課は連続する読誦の周期を続けるもので、個別には記されていません。",

"index.NOTES|noCommem":
"この日に記される記憶はありません。",

"index.NOTES|westLect":
"歴史的な西方（ローマ・サラム）の一年周期の聖書日課はまだ読み込まれていません。",
...
"prayers.T|lede":
"正教会の伝統的な祈祷文を、祈祷書の順に並べています。区分を選ぶか、検索してください。",
...
"prayers.T|partial":
"この祈祷文はまだこの言語では備わっておらず、英語で表示しています。",
...
"キリキアのタルソスの致命者ウォニファティイと、ローマの義女アグラィヤ",

"names|Martyr Claudius, Asterius, Neon, and Theonilla of Aegæ in Cilicia":
"キリキアのアイガイの致命者クラウディオス、アステリオス、ネオン、フェオニラ",
...
"ローマの致命者サワ・ストラティラト「将軍」と共にいた70人の兵士",
...
"主の生命を与える十字架の尊き木の巡行（八月の三つの「救主の祭」の最初）",
