# -*- coding: utf-8 -*-
"""RO interface strings. TEXT = {"surface|key": the rendering}.
...
"prayers.T|lede":
"Rugăciunile tradiționale ale Bisericii Ortodoxe, rânduite ca un ceaslov. Alegeți o secțiune sau căutați.",
...
"prayers.T|none":
"Nicio rugăciune nu se potrivește.",

"prayers.T|partial":
"Această rugăciune nu este încă disponibilă în această limbă și este dată în engleză.",
...
"Mucenicul Epimah din Alexandria",

"names|Appearance of the Icon of the Mother of God “The Footprint” at Pochaiv":
"Arătarea icoanei Maicii Domnului \"Urma\" la Poceaev",

"names|Arrival of the Ivḗron Icon of the Mother of God in Georgia":
"Sosirea Icoanei Iviron a Maicii Domnului în Georgia",

"names|Ascension Day":
"Înălțarea Domnului",

"names|Ash Wednesday — Lent begins":
"Miercurea Cenușii - începutul Postului",

"names|Blessed John “the Hairy” and Fool-For-Christ at Rostov":
"Fericitul Ioan \"cel Păros\", nebun pentru Hristos din Rostov",

"names|Clean Monday — Great Lent begins":
"Lunea Curată - începutul Postului Mare",

"names|Corpus Christi":
"Sărbătoarea Trupului Domnului (Corpus Christi)",
...
"Marele Mucenic Eustatie Plachida, cu soția și copiii săi, din Roma",
...
"Duminica Sfinților Părinți de la Sinodul I",
...
"Sfânta Schimbare la Față a Domnului Dumnezeu și Mântuitorului nostru Iisus Hristos",
