# -*- coding: utf-8 -*-
"""HY interface strings. TEXT = {"surface|key": the rendering}.
...
"Այս օր Սուրբ Պատարագ չի մատուցւում (պահքի օր է)։ Սահմանուած ընթերցումները կարդացւում են երեկոյեան ժամերգութեան եւ ժամերի ժամանակ։",

"index.NOTES|festalNote":
"Ցուցադրուած ընթերցումները տօնի համար սահմանուածներն են։",

"index.NOTES|lectGap":
"Այս օրուայ ամենօրեայ ընթերցումները շարունակում են ընթացիկ շրջանը եւ առանձին չեն թուարկուած։",

"index.NOTES|noCommem":
"Այս օրուայ համար հիշատակ նշուած չէ։",

"index.NOTES|westLect":
"Պատմական արեւմտեան (հռոմէական/սարումեան) միամեայ ընթերցարանը դեռ բեռնուած չէ։",
...
"prayers.T|lede":
"Ուղղափառ Եկեղեցու աւանդական աղօթքները՝ աղօթագրքի կարգով։ Ընտրէք բաժին կամ որոնէք։",
...
"prayers.T|none":
"Այդ որոնմանը համապատասխանող աղօթք չկայ։",

"prayers.T|partial":
"Այս աղօթքը դեռ չկայ այս լեզուով եւ ցուցադրւում է անգլերէն։",
...
"Տիրոջ կենարար Խաչի պատուական փայտի թափօր (օգոստոսի երեք «Փրկչի տօների» առաջինը)",

"names|Quinquagesima Sunday":
"Կուինկուագեսիմա կիրակի",
...
"Արդար նահապետ Արփաքսադ",

"names|Righteous Forefather Cainan":
"Արդար նահապետ Կայնան",
...
"Արդար Մելքիսեդեկ, Սաղէմի թագաւոր",

"names|Righteous Miriam, sister of Moses":
"Արդար Մարիամ, Մովսէսի քոյրը",
