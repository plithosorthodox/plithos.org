# -*- coding: utf-8 -*-
"""SR interface strings. TEXT = {"surface|key": the rendering}.
...
"На овај дан се не служи Божанствена Литургија (постан дан). Прописана читања су на Вечерњу и на Часовима.",

"index.NOTES|festalNote":
"Приказана читања су она која су прописана за празник.",

"index.NOTES|lectGap":
"Дневна читања за овај дан настављају текући круг и нису појединачно наведена.",

"index.NOTES|noCommem":
"За овај дан није наведен ниједан спомен.",

"index.NOTES|westLect":
"Историјски западни (римски / сарумски) једногодишњи лекционар још није учитан.",
...
"prayers.T|lede":
"Традиционалне молитве Православне Цркве, поређане као молитвеник. Изаберите одељак или претражите.",
...
"prayers.T|none":
"Ниједна молитва не одговара томе.",

"prayers.T|partial":
"Ова молитва још није доступна на овом језику и приказана је на енглеском.",
...
"Проналазак моштију праведног светог Никодима",
...
"Четврта недеља Великог поста (Laetare)",
...
"Великомученик Евстатије Плакида, са женом и децом, римски",

"names|Greatmartyr Theodore Stratelates “the General”":
"Великомученик Теодор Стратилат \"Војвода\"",

"names|Hieromartyr Alexander of Sίdē, in Pamphylia":
"Свештеномученик Александар Сидски, у Памфилији",

"names|Hieromartyr Mίlos (or Milēs) the Wonderworker, and two disciples":
"Свештеномученик Мил (Милес) чудотворац, и два ученика",

"names|Hieromartyr Nikḗtas":
"Свештеномученик Никита",

"names|Hieromartyr Zenobios and his sister Zenobia, of Aegæ in Cilicia":
"Свештеномученик Зиновије и сестра његова Зиновија, из Еге у Киликији",
...
"Недеља Светих Отаца Првог сабора",

"names|Sunday of the Last Judgment (Meatfare)":
"Недеља Страшног суда (Месопусна)",
...
"Свето Преображење Господа Бога и Спаса нашег Исуса Христа (други \"празник Спаситеља\" у августу)",

"names|Third Sunday in Lent":
"Трећа недеља Великог поста",

"names|Thomas Sunday (Antipascha)":
"Недеља Томина (Антипасха)",
