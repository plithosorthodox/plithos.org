# -*- coding: utf-8 -*-
"""ES interface strings. TEXT = {"surface|key": the rendering}.
...
"prayers.T|lede":
"Las oraciones tradicionales de la Iglesia Ortodoxa, ordenadas como un devocionario. Elija una sección o busque.",
...
"prayers.T|none":
"Ninguna oración corresponde a eso.",

"prayers.T|partial":
"Esta oración aún no está disponible en este idioma y se muestra en inglés.",
...
"Mártir Epímaco de Alejandría",

"names|Appearance of the Icon of the Mother of God “The Footprint” at Pochaiv":
"Aparición del Icono de la Madre de Dios «La Huella» en Pochaiv",

"names|Arrival of the Ivḗron Icon of the Mother of God in Georgia":
"Llegada del Icono Iverón de la Madre de Dios a Georgia",
...
"Beato Juan «el Peludo», Loco por Cristo de Rostov",

"names|Clean Monday — Great Lent begins":
"Lunes Limpio - comienzo de la Gran Cuaresma",
...
"Hallazgo de las reliquias del Justo Nicodemo",
...
"Gran Mártir Eustaquio Plácidas, con su esposa e hijos, de Roma",

"names|Greatmartyr Theodore Stratelates “the General”":
"Gran Mártir Teodoro Estratelates, el General",
...
"San Clemente el Estilita, que vivió como asceta en el Monte Ságmata en Beocia",

"names|Saint Emmeleίa":
"Santa Emelia",

"names|Saint Euphrosynē, Great Princess of Moscow":
"Santa Eufrosina, Gran Princesa de Moscú",
...
"Domingo de los Padres del Primer Concilio",
...
"Domingo de la Veneración de la Cruz",
...
"La Santa Transfiguración de nuestro Señor, Dios y Salvador Jesucristo",
...
"Una biblioteca de los Padres, las Escrituras, los Concilios y la Divina Liturgia de la Iglesia Ortodoxa. Elija una colección para comenzar.",
...
"La limosna y los pobres",

"library.RLEX|lx:An unknown preacher":
"Un predicador desconocido",
...
"El libre albedrío y la providencia",
...
"Perpetua de Cartago y un testigo presencial",
...
"Apóstol y Evangelista Marcos",

"library.RLEX|lx:St Methodius of Olympus":
"Hieromártir Metodio de Patara",

"library.RLEX|lx:St Polycarp of Smyrna":
"Hieromártir Policarpo de Esmirna",
...
"Testimonios de fuera de la Iglesia",

"library.RLEX|secBrowseDesc":
"Todo el estante a la vez, ordenado por quien lo escribió, por el siglo del que viene y por aquello para lo que fue escrito.",

"library.RLEX|secCouncilsDesc":
"Los credos y los cánones de los Concilios Ecuménicos.",
...
"El oficio eucarístico: la Liturgia de San Juan Crisóstomo en varios idiomas a la vez y los ritos más antiguos de Jerusalén y Alejandría.",

"library.RLEX|secLivesDesc":
"Relatos de los santos mártires y de los santos.",

"library.RLEX|secNTDesc":
"El Nuevo Testamento en todos los idiomas de la Iglesia.",

"library.RLEX|secNTShelf":
"El Nuevo Testamento",

"library.RLEX|secNTShelfDesc":
"El Nuevo Testamento en los idiomas de la Iglesia.",
