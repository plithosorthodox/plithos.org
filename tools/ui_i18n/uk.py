# -*- coding: utf-8 -*-
"""UK interface strings. TEXT = {"surface|key": the rendering}.
...
"prayers.T|lede":
"Традиційні молитви Православної Церкви, укладені як молитовник. Оберіть розділ або скористайтеся пошуком.",
...
"prayers.T|none":
"Жодна молитва не відповідає цьому запиту.",

"prayers.T|partial":
"Цієї молитви ще немає цією мовою, і вона подана англійською.",
...
"Блж. Іоан «Волохатий», Христа ради юродивий, Ростовський",

"names|Clean Monday — Great Lent begins":
"Чистий понеділок - початок Великого посту",

"names|Corpus Christi":
"Свято Тіла Христового (Corpus Christi)",
...
"Св. мц. діва Феодосія Тирська",

"names|Icon of the Mother of God of Mount Athos, “Sweet Kissing”":
"Ікона Божої Матері «Солодке Лобзання» (Глікофілуса) Афонська",
...
"Прав. праотець Арфаксад",

"names|Righteous Forefather Cainan":
"Прав. праотець Каїнан",
...
"Прав. праотець Малелеїл",

"names|Righteous Forefather Methuselah":
"Прав. праотець Мафусал",
...
"Прав. праматір Олдама пророчиця",
...
"Прав. праматір Рахіль",

"names|Righteous Foremother Rebecca":
"Прав. праматір Ревека",
...
"Прав. Мелхиседек, цар Салимський",

"names|Righteous Miriam, sister of Moses":
"Прав. Маріам, сестра Мойсея",
...
"Неділя свт. Григорія Палами",

"names|Sunday of St John Climacus":
"Неділя прп. Іоана Ліствичника",

"names|Sunday of St Mary of Egypt":
"Неділя прп. Марії Єгипетської",
...
"Святе Преображення Господа Бога і Спаса нашого Іісуса Христа",
...
"Ікона Божої Матері «Подателька розуму»",
...
"Ікона Божої Матері «О Всеоспівана Мати»",

"names|“Our Lady of Sitka” Icon of the Mother of God":
"Сіткинська ікона Божої Матері",

"names|“Ozerianka” Icon of the Mother of God of Shuiu-Smolensk":
"Озерянська ікона Божої Матері, Шуйсько-Смоленська",
...
"Корецька ікона Божої Матері «Поручителька грішних»",

"names|“Svena” Icon of the Mother of God":
"Свенська ікона Божої Матері",

"names|“Virgin of Tenderness” Icon of the Mother of God of the Pskov Caves":
"Ікона Божої Матері «Умилення» Псково-Печерська",
...
"Бібліотека Отців, Писання, Соборів і Божественної Літургії Православної Церкви. Виберіть збірку, щоб почати.",
...
"Перпетуя Карфагенська і свідок-очевидець",
...
"Свідчення про апостолів",

"library.RLEX|lx:Witnesses outside the Church":
"Свідчення поза Церквою",

"library.RLEX|secBrowseDesc":
"Уся полиця відразу, з розподілом за автором, за століттям і за тим, для чого написано.",

"library.RLEX|secCouncilsDesc":
"Символи віри і правила Вселенських Соборів.",

"library.RLEX|secFathersDesc":
"Писання давніх отців Церкви.",

"library.RLEX|secHome":
"Головна",

"library.RLEX|secLiturgyDesc":
"Євхаристійне богослужіння: Літургія святителя Іоана Златоуста кількома мовами поряд і давніші чини Єрусалима та Александрії.",

"library.RLEX|secLivesDesc":
"Оповіді про святих мучеників і преподобних.",

"library.RLEX|secNTDesc":
"Новий Завіт усіма мовами Церкви.",

"library.RLEX|secNTShelf":
"Новий Завіт",

"library.RLEX|secNTShelfDesc":
"Новий Завіт мовами Церкви.",

"library.RLEX|secOTDesc":
"Старий Завіт за Септуагінтою, грецьким текстом, який прийняла Церква.",
}
