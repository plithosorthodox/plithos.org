# -*- coding: utf-8 -*-
"""FR interface strings. TEXT = {"surface|key": the rendering}.
...
"La Divine Liturgie n'est pas célébrée ce jour (jour de jeûne). Les lectures prescrites sont aux Vêpres et aux Heures.",

"index.NOTES|festalNote":
"Les lectures indiquées sont celles prescrites pour la fête.",

"index.NOTES|lectGap":
"Les lectures quotidiennes de ce jour poursuivent le cycle courant et ne sont pas énumérées séparément.",

"index.NOTES|noCommem":
"Aucune commémoration n'est indiquée pour ce jour.",

"index.NOTES|westLect":
"Le lectionnaire occidental historique d'un an (romain ou de Sarum) n'est pas encore chargé.",
...
"prayers.T|lede":
"Les prières traditionnelles de l'Église orthodoxe, disposées comme un livre de prières. Choisissez une section ou faites une recherche.",
...
"prayers.T|partial":
"Cette prière n'est pas encore disponible dans cette langue et est donnée en anglais.",
...
"Apôtre Épimaque d'Alexandrie",

"names|Appearance of the Icon of the Mother of God “The Footprint” at Pochaiv":
"Apparition de l'icône de la Mère de Dieu « L'Empreinte » à Pochaïv",

"names|Arrival of the Ivḗron Icon of the Mother of God in Georgia":
"Arrivée de l'icône d'Iviron de la Mère de Dieu en Géorgie",
...
"Bienheureux Jean « le Chevelu », fol-en-Christ à Rostov",
...
"JOUR DE PÂQUES : la Résurrection du Seigneur",
...
"Invention des reliques du juste saint Nicodème",

"names|First Sunday in Lent":
"Premier dimanche de Carême",

"names|Forgiveness Sunday (Cheesefare)":
"Dimanche du Pardon (de la Tyrophagie)",
...
"Juste aïeule Houlda la prophétesse",
...
"Dimanche du Jugement dernier (Carême-prenant)",
...
"La sainte Transfiguration de notre Seigneur Dieu et Sauveur Jésus-Christ (la deuxième « fête du Sauveur » d'août)",

"names|Third Sunday in Lent":
"Troisième dimanche de Carême",

"names|Thomas Sunday (Antipascha)":
"Dimanche de Thomas (Antipascha)",
...
"Translation de l'image « Non faite de main d'homme » de notre Seigneur Jésus-Christ d'Édesse à Constantinople, la troisième « fête du Sauveur d'août »",

"names|Trinity Sunday":
"Dimanche de la Trinité",

"names|Uncovering of the relics of Saint Nikḗtas, Bishop of Novgorod":
"Invention des reliques de saint Nikḗtas, évêque de Novgorod",
