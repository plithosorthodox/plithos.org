...
LANGS = {
    ...
    # The Bulgarian Patriarchate's 2026 calendar uses Св. 559 times and
    # allows it directly before a personal name about two hundred times, so
    # strict stays False. Its monastic is Преп. or a full form of преподобен;
    # the compound прпмч* forms are monastic too. The rank vocabulary and
    # counts that settle these forms are recorded in docs/BULGARIAN.md.
    "bg": {
        "generic": r"^\W*(?:[Сс]в\.|[Сс]вет(?:и(?:ят|я)?|а(?:та)?))\s+",
        "ranks": (r"[Пп]реп\.|[Пп]реподобн|[Пп]рпмч|[Пп]реподобномъчен|"
                  r"[Мм]чк|[Мм]чца|[Мм]чци|[Мм]ъчен|[Сс]вщмч|"
                  r"[Сс]вещеномъчен|[Вв]мчк|[Вв]мчца|[Вв]еликомъчен|"
                  r"[Аа]п\.|[Аа]постол|[Пп]рор\.|[Пп]ророк|"
                  r"[Рр]авноап\.|[Рр]авноапостол|[Пп]рав\.|[Пп]раведн|"
                  r"[Ии]зповедник|[Бб]езср\.|[Бб]езсребрен|[Юю]родив|"
                  r"[Бб]лагов\.|[Бб]лаговер|[Чч]удотворец|[Сс]ветител|"
                  r"[Аа]рхиепископ|[Ее]пископ|[Мм]итрополит|[Пп]атриарх|"
                  r"[Пп]апа|[Сс]вещеник|[Пп]резвитер|[ИиЙй]ерей|[Дд]якон|"
                  r"[Ии]гумен|[Ии]гумения|[Аа]рхимандрит|[Мм]онах|"
                  r"[Мм]онахиня|[Сс]химонах|[Оо]тшелник|[Пп]устинник|"
                  r"[Зз]атворник|[Сс]тълпник|[Аа]скет|[Дд]евиц|"
                  r"[Пп]редтеча|[Ее]вангелист|[Мм]ироточив|[Мм]ироносиц|"
                  r"[Сс]трастотерпец|[Пп]росветител|[Пп]еснописец|"
                  r"[Ии]конописец|[Цц]елител|[Бб]езплътн|[Аа]рхангел|"
                  r"[Аа]нгел|[Цц]ар|[Цц]арица|[Кк]няз|[Кк]нягиня|"
                  r"[Ии]мператор|[Ии]мператрица|[Сс]ъбор|[Пп]разник|"
                  r"[Ии]кона|[Хх]рам|[Мм]ощи|[Пп]ренасяне|[Нн]амиране|"
                  r"[Уу]спение|[Рр]ождение|[Оо]тсичане"),
        "monastic": (r"[Пп]реп\.|[Пп]реподобн|[Пп]рпмч|"
                      r"[Пп]реподобномъчен|[Мм]онах|[Мм]онахиня|"
                      r"[Сс]химонах|[Ии]гумен|[Ии]гумения|[Аа]рхимандрит"),
        "strict": False,
    },
    "el": {
