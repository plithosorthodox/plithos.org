...
KEYS = ["secBrowse", "fAuthor", "fCentury", "fPurpose", "fTranslator",
        ...
        "howReceived", "fTopic", "alongside", "addLang", "noVerse",
        "tradMix"]
...
T = {
 "en": ["The whole shelf", "Author", "Century", "Purpose", "Translator",
        ...
        "add a language",
        "not in this edition",
        "These editions do not number the verses alike: one follows the Septuagint and one the Hebrew. The rows set verse against verse by number, and in the Psalms especially the numbering itself differs."],
 "el": ["Όλο το ράφι", "Συγγραφέας", "Αιώνας", "Σκοπός",
        ...
        "Παράλληλα",
        "προσθήκη γλώσσας",
        "δεν υπάρχει σε αυτή την έκδοση",
        "Οι εκδόσεις αυτές δεν αριθμούν τους στίχους με τον ίδιο τρόπο: η μία ακολουθεί τους Εβδομήκοντα και η άλλη το εβραϊκό κείμενο. Στους Ψαλμούς ιδίως η ίδια η αρίθμηση διαφέρει."],
 "ru": ["Вся полка", "Автор", "Век", "Назначение", "Переводчик",
        ...
        "добавить язык",
        "нет в этом издании",
        "Эти издания нумеруют стихи по-разному: одно следует Септуагинте, другое еврейскому тексту. В Псалтири сама нумерация расходится."],
 "cu": ["Всѧ̑ книги", "Списатель", "Вѣ́къ", "Намѣре́ніе", "Прево́дникъ",
        ...
        "Ѡ҆б̾ ѻ҆́нъ по́лъ",
        "приложи́ти ѧ҆зы́къ",
        "нѣ́сть въ се́мъ и҆зда́ніи",
        "Сі̑и и҆зда̑нїѧ не є҆ди́накѡ чи́слѧтъ стїхѝ: є҆ди́но послѣ́дꙋетъ седми́десѧтимъ, дрꙋго́е же є҆вре́йскомꙋ. Въ ѱалти́ри же са́мое число̀ и҆́но є҆́сть."],
 "ka": ["მთელი თარო", "ავტორი", "საუკუნე", "დანიშნულება", "მთარგმნელი",
        ...
        "გვერდიგვერდ",
        "ენის დამატება",
        "ამ გამოცემაში არ არის",
        "ეს გამოცემები მუხლებს ერთნაირად არ ანომრებს: ერთი სეპტუაგინტას მისდევს, მეორე ებრაულ ტექსტს. ფსალმუნებში თვით ნუმერაცია განსხვავდება."],
 "ro": ["Tot raftul", "Autor", "Secol", "Scop", "Traducător",
        ...
        "Alături",
        "adaugă o limbă",
        "nu se află în această ediție",
        "Aceste ediții nu numerotează versetele la fel: una urmează Septuaginta, alta textul ebraic. În Psalmi însăși numerotarea diferă."],
 "sr": ["Цела полица", "Аутор", "Век", "Сврха", "Преводилац",
        ...
        "додај језик",
        "нема у овом издању",
        "Ова издања не броје стихове једнако: једно следи Септуагинту, друго јеврејски текст. У Псалтиру се и само бројање разликује."],
 "uk": ["Уся полиця", "Автор", "Століття", "Призначення", "Перекладач",
        ...
        "Поруч",
        "додати мову",
        "немає в цьому виданні",
        "Ці видання нумерують вірші по-різному: одне йде за Септуагінтою, інше за єврейським текстом. У Псалтирі сама нумерація розходиться."],
 "ar": ["الرف كله", "المؤلف", "القرن", "الغرض", "المترجم",
        ...
        "أضف لغة",
        "ليس في هذه الطبعة",
        "هذه الطبعات لا ترقم الآيات بالطريقة نفسها: واحدة تتبع السبعينية وأخرى النص العبري. وفي المزامير يختلف الترقيم نفسه."],
 "es": ["Todo el estante", "Autor", "Siglo", "Propósito", "Traductor",
        ...
        "En paralelo",
        "añadir un idioma",
        "no está en esta edición",
        "Estas ediciones no numeran los versículos igual: una sigue la Septuaginta y otra el texto hebreo. En los Salmos difiere la numeración misma."],
 "pt": ["Toda a estante", "Autor", "Século", "Finalidade", "Tradutor",
        ...
        "Estas edições não numeram os versículos do mesmo modo: uma segue a Septuaginta e outra o texto hebraico. Nos Salmos difere a própria numeração."],
 "it": ["Tutto lo scaffale", "Autore", "Secolo", "Scopo", "Traduttore",
        ...
        "Queste edizioni non numerano i versetti allo stesso modo: una segue i Settanta e l'altra il testo ebraico. Nei Salmi differisce la numerazione stessa."],
 "fr": ["Tout le rayon", "Auteur", "Siècle", "Objet", "Traducteur",
        ...
        "En regard",
        "ajouter une langue",
        "absent de cette édition",
        "Ces éditions ne numérotent pas les versets de la même façon: l'une suit la Septante et l'autre le texte hébreu. Dans les Psaumes la numérotation elle-même diffère."],
 "de": ["Das ganze Regal", "Verfasser", "Jahrhundert", "Zweck", "Übersetzer",
        ...
        "Diese Ausgaben zählen die Verse nicht gleich: die eine folgt der Septuaginta, die andere dem hebräischen Text. In den Psalmen weicht schon die Zählung ab."],
 "zh": ["全部藏书", "作者", "世纪", "用途", "译者",
        "清除", "显示全部", "查找书名或人名",
        "没有符合以上全部条件的书。", "部", "部", "生平",
        ...
        "添加语言",
        "此版本无此节",
        "这些版本的分节编号不同：一者依七十士译本，一者依希伯来文本。诗篇中编号本身即有出入。"],
 "ja": ["蔵書のすべて", "著者", "世紀", "目的", "訳者",
        ...
        "言語を追加",
        "この版にはありません",
        "これらの版は節の番号が同じではありません。一方は七十人訳に、他方はヘブライ語本文に従います。詩篇では番号そのものが異なります。"],
 "ko": ["전체 장서", "저자", "세기", "용도", "역자",
        ...
        "언어 추가",
        "이 판본에는 없습니다",
        "이 판본들은 절 번호가 서로 다릅니다. 하나는 칠십인역을, 다른 하나는 히브리 본문을 따릅니다. 특히 시편에서는 번호 자체가 다릅니다."],
 "sw": ["Rafu nzima", "Mwandishi", "Karne", "Kusudi", "Mfasiri",
        ...
        "Kando kwa kando",
        "ongeza lugha",
        "haipo katika toleo hili",
        "Matoleo haya hayahesabu mistari sawasawa: moja linafuata Septuaginta na jingine maandiko ya Kiebrania. Katika Zaburi hesabu yenyewe inatofautiana."],
 "hi": ["पूरा संग्रह", "लेखक", "शताब्दी", "प्रयोजन", "अनुवादक",
        ...
        "भाषा जोड़ें",
        "इस संस्करण में नहीं",
        "ये संस्करण पदों की संख्या एक समान नहीं देते: एक सेप्टुआजिंट का अनुसरण करता है और दूसरा इब्रानी पाठ का। भजनों में गणना ही भिन्न है।"],
 "hy": ["Ողջ գրադարակը", "Հեղինակ", "Դար", "Նպատակ", "Թարգմանիչ",
        ...
        "Կողք կողքի",
        "ավելացնել լեզու",
        "չկա այս հրատարակության մեջ",
        "Այս հրատարակությունները համարները նույն կերպ չեն դնում. մեկը հետևում է Յոթանասնիցին, մյուսը եբրայերեն բնագրին։ Սաղմոսներում հենց համարակալումն է տարբեր։"],
 ...
 "arc": ["ܟܠܗܘܢ ܟܬܒܐ", "ܟܬܘܒܐ", "ܕܪܐ", "ܢܝܫܐ", "ܡܦܫܩܢܐ",
        ...
        "ܐܘܣܦ ܠܫܢܐ",
        "ܠܐ ܐܝܬ ܒܗܢܐ ܡܦܩܐ",
        "ܗܠܝܢ ܡܦܩ̈ܐ ܠܐ ܡܢܝܢ ܦܣܘ̈ܩܐ ܐܟܘܬܐ܂ ܚܕ ܒܬܪ ܫܒܥܝܢ ܘܐܚܪܢܐ ܒܬܪ ܟܬܒܐ ܥܒܪܝܐ܂"],
}
