...
ROWS = [
 ...
 dict(id="ro-alexandria-teleorman", parent="romania",
      ...
      site="https://episcopiaalexandriei.ro/", sources=MUNTENIA + ["https://episcopiaalexandriei.ro/despre-noi/"],
      founded=u"hotărârea Sfântului Sinod nr. 7453 din 24-25 octombrie 1995, privind înfiinţarea Episcopiei Alexandriei şi Teleormanului"),
 ...
 dict(id="ro-dacia-felix", parent="romania",
      ...
      site="https://episcopiadaciafelix.ro/", sources=MUNTENIA + ["https://episcopiadaciafelix.ro/istoric/"],
      founded=u"Sfântul Sinod al Bisericii Ortodoxe Române, reactualizând mai vechea hotărâre din anul 1933, a aprobat, în şedinţa de lucru din 13-14 februarie 1997, înfiinţarea Episcopiei Ortodoxe Române din Banatul sârbesc, cu sediul (nominal) la Vârşeţ."),
 ...
 dict(id="ro-suceava", parent="romania",
      ...
      site="https://www.arhiepiscopiasucevei.ro/", sources=MOLDAVIA + ["https://www.arhiepiscopiasucevei.ro/istoric/"],
      founded=u"La reînfiinţarea vechii eparhii în 1990 şi începerea activităţii la Suceava, în 1991, s-a acordat titulatura „Arhiepiscopia Sucevei şi Rădăuţilor”."),
 dict(id="ro-roman", parent="romania",
      ...
      site="https://eprb.ro/", sources=MOLDAVIA + ["https://eprb.ro/istoric"],
      founded=u"Sintetizând cele expuse, avem convingerea că domnul Alexandru cel Bun a luat în considerare necesitatea celor două eparhii, apoi le-a întemeiat, în intervalul 1408-1413."),
 dict(id="ro-husi", parent="romania",
      ...
      site="https://episcopiahusilor.ro/", sources=MOLDAVIA + ["https://episcopiahusilor.ro/episcopia"],
      founded=[u"Episcopia Huşilor a fost întemeiată în anul 1598, funcţionând neîntrerupt până în vremea comunismului, când a fost desfiinţată.",
               u"La 5 februarie 1949 se dă decretul de desfiinţare a Episcopiei Huşilor care a fost unită cu Episcopia Romanului sub titulatura de Episcopia Romanului şi Huşilor, fiinţând astfel până în anul 1996 când la data de 15 septembrie are loc un act de dreptate istorică prin reînfiinţarea Episcopiei Huşilor."]),
 ...
 dict(id="ro-covasna", parent="romania",
      ...
      site="https://episcopiacvhr.ro/", sources=TRANSYLVANIA + ["https://episcopiacvhr.ro/istoric/"],
      founded=u"se decide în ședința de lucru din 22-23 martie 1994, \"pe baza propunerilor celor două adunări eparhiale, înființarea, organizarea, delimitarea și reședința noii episcopii\""),
 dict(id="ro-deva", parent="romania",
      ...
      site="https://episcopiadevei.ro/", sources=TRANSYLVANIA + ["https://episcopiadevei.ro/istoric/"],
      founded=u"În ședința sa din 19 iunie 2009, Sfântul Sinod al Bisericii Ortodoxe Române, sub președinția Preafericitului Părinte Daniel - Patriarhul Bisericii Ortodoxe Române, hotăra înființarea Episcopiei Devei și Hunedoarei, cu reședința în municipiul Deva."),
 ...
 dict(id="ro-maramures", parent="romania",
      ...
      site="https://episcopiammsm.ro/", sources=CLUJ + ["https://episcopiammsm.ro/istoric/"],
      founded=[u"În 1937 se înființează prin Hotărârea Consiliului de Miniștri din 23 iulie, Episcopia Ortodoxă a Maramureșului.",
               u"Sfântul Sinod al Bisericii Ortodoxe Române a aprobat memoriul înaintat în 2 februarie 1990 de preoțimea maramureșeană, iar în 12 februarie a aceluiași an s-a hotărât reactivarea Episcopiei Maramureșului, care urma să cuprindă județele Maramureș și Satu Mare."]),
 dict(id="ro-salaj", parent="romania",
      ...
      site="https://episcopiasalajului.ro/", sources=CLUJ + ["https://episcopiasalajului.ro/istoricul-episcopiei/"],
      founded=u"În data de 22 octombrie a anului 2007, Sfântul Sinod al Bisericii Ortodoxe Române a votat, tot în unanimitate, înfiinţarea Episcopiei Sălajului."),
 ...
 dict(id="ro-ramnic", parent="romania",
      ...
      site="https://arhiepiscopiaramnicului.ro/", sources=OLTENIA + ["https://arhiepiscopiaramnicului.ro/arhiepiscopia-ramnicului/despre-noi"],
      founded=[u"A fost înființată la 1503, când, pentru îndreptarea vieții bisericești, voievodul Radu cel Mare (1495-1508) l-a adus în Țara Românească pe Sfântul Ierah Nifon, fostul patriarh al Constantinopolului, pe care l-a așezat mitropolit.",
               u"La 18 iunie 2009, prin hotărârea Sfântului Sinod al Bisericii Ortodoxe Române, Sfânta Episcopie a Râmnicului a fost ridicată la rangul de Arhiepiscopie."]),
 dict(id="ro-severin", parent="romania",
      ...
      site="https://www.episcopiaseverinului.ro/", sources=OLTENIA + ["https://www.episcopiaseverinului.ro/istoric/istoric-ess.html"],
      founded=[u"Episcopia Severinului şi Strehaiei a fost reînfiinţată după 600 de ani.",
               u"Sfântul Sinod al Bisericii Ortodoxe Române, în şedinţa de lucru din 4-5 martie 2003 a aprobat cererea de înfiinţare a Episcopiei Severinului şi Strehaiei cu reşedinţa în municipiul Drobeta-Turnu Severin, ca sufragană a Mitropoliei Olteniei, cu jurisdicţie asupra judeţului Mehedinţi, prin desprinderea acesteia din cadrul Arhiepiscopiei Craiovei."]),
 ...
 dict(id="ro-arad", parent="romania",
      ...
      site="https://www.arhiepiscopiaaradului.ro/", sources=BANAT + ["https://www.arhiepiscopiaaradului.ro/istoric/"],
      founded=u"Prin diploma acordată de imperialii austro-ungari la 15 aprilie 1706, ierarhului Isaia Diacovici, practic ia fiinţă această episcopie, având o continuitate neîntreruptă de mai bine de trei sute de ani."),
 dict(id="ro-caransebes", parent="romania",
      ...
      site="https://www.episcopiacaransebesului.ro/", sources=BANAT + ["https://www.episcopiacaransebesului.ro/istoricul-episcopiei-caransebesului/"],
      founded=[u"Episcopia Caransebeșului a fost restaurată, ca eparhie ortodoxă românească, în 1865.",
               u"În anul 1994 Episcopia Caransebeșului a fost reactivată."]),
 ...
 dict(id="ro-south-bessarabia", parent="romania",
      ...
      address=["Str. Bogdan Petriceicu Hasdeu Nr. 11A",
               "Municipiul Cahul"],
      site="https://www.episcopiabasarabieidesud.md/", sources=BESSARABIA + ["https://www.episcopiabasarabieidesud.md/istoric"],
      founded=[u"la 10 martie 1923 a luat ființă Episcopia Cetății Albe-Ismail, înființată odată cu Episcopia de Hotin",
               u"în ziua de 8 februarie 2001 a fost reactivată Episcopia Cetății Albe-Ismail, cu denumirea Episcopia Basarabiei de Sud, fiind înregistrată de autoritățile din Republica Moldova, potrivit hotărârii Curții de Justiție, la 14 noiembrie 2006"]),
 ...
 dict(id="ro-great-britain", parent="romania",
      ...
      address=["St Paul's Centre, 102A Church Street",
               "Enfield, EN2 6AR"],
      site="https://roarch.org.uk/", sources=WESTERN_EUROPE + ["https://roarch.org.uk/history/"],
      founded=u"The Romanian Orthodox Archdiocese of Great Britain and Northern Ireland was established, initially as a Diocese, by Synodal Decision number 1716, dated March 1, 2024, and was later elevated to the rank of Archdiocese, by Synodal Decision number 6944, dated July 12, 2024."),
 ...
 dict(id="ro-ireland-iceland", parent="romania",
      ...
      site="https://www.eorii.com/", sources=WESTERN_EUROPE + ["https://www.eorii.com/index.php?p=scurt-istoric"],
      founded=u"Ca urmare, Sfântul Sinod al Bisericii Ortodoxe Române, în ședința sa de lucru din 29 februarie 2024, a hotărât înființarea Episcopiei Ortodoxe Române a Irlandei și Islandei, cu sediul la Dublin, ca eparhie sufragană a Mitropoliei Ortodoxe Române a Europei Occidentale și Meridionale."),
 ...
 dict(id="ro-canada", parent="romania",
      ...
      site="https://www.episcopia.ca/", sources=AMERICAS + ["https://www.episcopia.ca/index.php/ro/cine-suntem/istorie"],
      founded=[u"La acest Congres din 1929 s-a hotărât să se înfiinţeze o Episcopie Misionară sub jurisdicţia canonică a Bisericii Ortodoxe Române.",
               u"Actul fondator al Episcopiei Ortodoxe Române a Canadei este hotărârea Congresului Arhiepiscopiei Ortodoxe Române din cele două Americi de la Hamilton, Ontario, din 1-3 iulie 2016, de a înființa Episcopia Ortodoxă Română a Canadei."]),
]
