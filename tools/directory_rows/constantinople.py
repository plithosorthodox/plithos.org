...
READ AGAIN ON 14 SEPTEMBER 2026 IN THE THRONE'S OWN LANGUAGE. Ninety of the
hundred and five rows under the Ecumenical Patriarchate held no name in the
language the body is named in, which was by a long way the largest such hole
in the register, and it was not a cosmetic one: a Greek metropolis writes its
site in Greek, so a row holding only an English name could not be checked
against its own door at all, and thirteen of them were reported as
uncheckable for exactly that reason.

The Throne publishes a Greek entry beside the English one for every eparchy,
and the Greek entry is what those rows now carry - accents, breathings and
final sigma as published, nothing transliterated and nothing normalised.
Three fields came off the same pages. `rank` is the word the Throne calls
each body by, in English: Metropolis, Archdiocese, Patriarchal Exarchate,
Patriarchal and Stavropegic Monastery. `founded` is what an entry says about
its own beginning, in the words it prints, and only where it says it - which
is the eparchies abroad and nowhere else; the sees in Greece and Turkiye are
given a hierarch, a street and a list of churches and no date. `languages`
stayed empty, and that is a finding rather than an omission: what these
entries name is the languages a hierarch speaks, which is a fact about a man
and not about how a see worships, and nothing here says the second.

Three rows in America still carry no name in their own language, and on
purpose. The Carpatho-Russian Diocese and the two Ukrainian Churches are not
Greek-speaking bodies; the Throne prints a Greek title for each, and their
own sites print English, with the Ukrainians in Canada giving only the
initials УПЦК. Writing the Greek in `local` would say that a Ukrainian
Church in Canada names itself in Greek, which it does not.

Four things about the reading, so they are not mistaken for slips here.

The Throne's two faces do not always name the same see alike, and where they
differ the row shows both: `name` follows the English list it was read from,
`local` the Greek entry. Lagadas is Lagadas, Lete and Komotini in English and
Λαγκαδᾶ, Λητῆς καί Ρεντίνης in Greek; Goumenissa ends in Polykarpos in
English and Πολυκάστρου in Greek; Alexandroupolis, Lemnos, Arkalochorion and
Kydonia are given fuller titles in Greek than in English; and Bursa is
Προύσης, the Greek name of the city. None of that is corrected in either
direction.

The Greek entry for Neapolis and Stavroupolis is written with a Latin N where
the Greek nu belongs. That is a keyboard and not a spelling, and the row
carries the letter the title plainly means - the same treatment the
Patriarchate's Derkoi already had here.

Vryoula is on the English list and not on the Greek one, and its Greek entry
can be reached only from its English page; the slug is misspelt at the
Throne's end too. It is cited at the address that answers.

The thirty-six metropolises of the New Lands already cite three pages, which
is the cap, so the Greek entry they were read from is not listed on them. It
is the same entry as the English one they do cite, in the other language.

Two links were looked at again because a name in Greek made it possible to
look. imepa.gr is the Metropolis of Edessa, Pella and Almopia's own site and
the row keeps it; it had been reported as naming neither Edessa nor Pella,
and it names both, in polytonic Greek, in its own running text. immyt.gr is
not the Metropolis of Mytilene's any more - it answers with an online casino
over the see's own domain, which the Throne still prints - so that row now
gives the street and no link.
"""
...
ROWS = [
 ...
 dict(id="ep-chalcedon", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Χαλκηδόνος",
      rank="Metropolis",
 ...
 dict(id="ep-rethymne", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ρεθύμνης καί Αὐλοποτάμου",
      rank="Metropolis",
      seat="Rethymno", country="GR", checked="2026-09-14",
      sources=[E + "metropolis-of-rethymno-and-avlopotamos", GR_LIST,
               EG + "iera-mitropoli-rethymnis-aylopotamoy/"]),
 dict(id="ep-kydonia", parent="constantinople",
      name="Metropolis of Kydonia and Apokoronos",
      local=u"Ἱερά Μητρόπολις Κυδωνίας καί Ἀποκορώνου",
      rank="Metropolis",
 ...
 dict(id="ep-petra", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Πέτρας καί Χερρονήσου",
      rank="Metropolis",
      country="GR", checked="2026-09-14",
 ...
 dict(id="ep-arkalochorion", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ἀρκαλοχωρίου, Καστελλίου καί Βιάννου",
      rank="Metropolis",
      country="GR", checked="2026-09-14",
 ...
 dict(id="ep-kos", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Κώου καί Νισύρου",
      rank="Metropolis",
      seat="Kos", country="GR", checked="2026-09-14",
      sources=[E + "metropolis-of-kos-and-nisyros", GR_LIST,
               EG + "iera-mitropoli-kooy-nisyroy/"]),
 dict(id="ep-leros", parent="constantinople",
      name="Metropolis of Leros, Kalymnos, and Astypalaia",
      local=u"Ἱερά Μητρόπολις Λέρου, Καλύμνου καί Ἀστυπαλαίας",
      rank="Metropolis",
 ...
 dict(id="ep-karpathos", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Καρπάθου καί Κάσου",
      rank="Metropolis",
      seat="Karpathos", country="GR", checked="2026-09-14",
      sources=[E + "metropolis-of-karpathos-and-kasos", GR_LIST,
               EG + "iera-mitropoli-karpathoy-kasoy/"]),
 dict(id="ep-syme", parent="constantinople",
      name="Metropolis of Syme",
      local=u"Ἱερά Μητρόπολις Σύμης",
      rank="Metropolis",
 ...
 dict(id="ep-patmos", parent="constantinople",
      ...
      local=u"Πατριαρχική Εξαρχία Πάτμου",
      rank="Patriarchal Exarchate",
      seat="Patmos", country="GR", checked="2026-09-14",
      address=[u"Τ.Θ. 25", u"Τ.Κ. 855 00 Πάτμος"],
      sources=[E + "patriarchal-exarchate-of-patmos/",
               EG + "patriarxiki-eksarxia-patmoy/"]),
 ...
 dict(id="ep-alexandroupolis", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ἀλεξανδρουπόλεως, Τραϊανουπόλεως καί Σαμοθράκης",
      rank="Metropolis",
      seat="Alexandroupolis", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-beroia", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Βεροίας, Ναούσης καί Καμπανίας",
      rank="Metropolis",
 ...
 dict(id="ep-goumenissa", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Γουμενίσσης, Ἀξιουπόλεως καί Πολυκάστρου",
      rank="Metropolis",
      seat="Goumenissa", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-grevena", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Γρεβενῶν",
      rank="Metropolis",
      seat="Grevena", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-didymoteichon", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Διδυμοτείχου, Ὀρεστιάδος καί Σουφλίου",
      rank="Metropolis",
      seat="Didymoteicho", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-drama", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Δράμας",
      rank="Metropolis",
      seat="Drama", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-dryinoupolis", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Δρυϊνουπόλεως, Πωγωνιανῆς καί Κονίτσης",
      rank="Metropolis",
      seat="Delvinaki", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-edessa", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ἐδέσσης καί Πέλλης",
      rank="Metropolis",
      seat="Edessa", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-elassona", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ἐλασσῶνος",
      rank="Metropolis",
      seat="Elassona", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-eleftheroupolis", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ἐλευθερουπόλεως",
      rank="Metropolis",
      seat="Eleftheroupoli", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-zihna", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ζιχνῶν καί Νευροκοπίου",
      rank="Metropolis",
      seat="Nea Zichni", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-thessaloniki", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Θεσσαλονίκης",
      rank="Metropolis",
 ...
 dict(id="ep-hierissos", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ἱερισσοῦ, Ἁγίου Ὄρους καί Ἀρδαμερίου",
      rank="Metropolis",
      seat="Arnaia", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-ioannina", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ἰωαννίνων",
      rank="Metropolis",
      seat="Ioannina", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-kassandreia", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Κασσανδρείας",
      rank="Metropolis",
      seat="Polygyros", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-kastoria", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Καστορίας",
      rank="Metropolis",
      seat="Kastoria", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-kitros", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Κίτρους",
      rank="Metropolis",
 ...
 dict(id="ep-lagadas", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Λαγκαδᾶ, Λητῆς καί Ρεντίνης",
      rank="Metropolis",
      seat="Lagadas", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-lemnos", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Λήμνου καί Ἁγίου Εὐστρατίου",
      rank="Metropolis",
      seat="Myrina", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-maroneia", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Μαρωνείας καί Κομοτηνῆς",
      rank="Metropolis",
      seat="Komotini", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-mithymna", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Μηθύμνης",
      rank="Metropolis",
      seat="Kalloni", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-mytilene", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Μυτιλήνης",
      rank="Metropolis",
      seat="Mytilene", country="GR", checked="2026-09-14",
      address=[u"Μητροπόλεως 1", u"Τ.Κ. 81100 - Μυτιλήνη"],
      # immyt.gr is the address the Throne still prints for this see and it
      # is no longer the see's. It answers with an online casino, in Greek,
      # over the metropolis's own domain. The street stays, because a reader
      # can still use it; the link is gone.
 ...
 dict(id="ep-neapolis-stavroupolis", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Νεαπόλεως καί Σταυρουπόλεως",
      rank="Metropolis",
 ...
 dict(id="ep-nea-krini", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Νέας Κρήνης καί Καλαμαριᾶς",
      rank="Metropolis",
      seat="Kalamaria", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-nikopolis", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Νικοπόλεως καί Πρεβέζης",
      rank="Metropolis",
      seat="Preveza", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-xanthi", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Ξάνθης",
      rank="Metropolis",
      seat="Xanthi", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-paramythia", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Παραμυθίας, Φιλιατῶν καί Γηρομερίου",
      rank="Metropolis",
 ...
 dict(id="ep-polyane", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Πολυανῆς καί Κιλκισίου",
      rank="Metropolis",
 ...
 dict(id="ep-samos", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Σάμου καί Ἰκαρίας",
      rank="Metropolis",
      seat="Samos", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-servia-kozani", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Σερβίων καί Κοζάνης",
      rank="Metropolis",
 ...
 dict(id="ep-serres", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Σερρῶν καί Νιγρίτης",
      rank="Metropolis",
      seat="Serres", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-siderokastron", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Σιδηροκάστρου",
      rank="Metropolis",
      seat="Siderokastro", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-sisanion", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Σισανίου καί Σιατίστης",
      rank="Metropolis",
      seat="Siatista", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-philippoi", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Φιλίππων, Νεαπόλεως καί Θάσου",
      rank="Metropolis",
      seat="Kavala", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-phlorina", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Φλωρίνης, Πρεσπῶν καί Ἐορδαίας",
      rank="Metropolis",
      seat="Florina", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-chios", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Χίου",
      rank="Metropolis",
      seat="Chios", country="GR", checked="2026-09-14",
 ...
 dict(id="ep-chicago", parent="constantinople",
      ...
      sources=[E + "holy-metropolis-of-chicago/", US_LIST,
               EG + "iera-mitropoli-sikagoy/"]),
 dict(id="ep-denver", parent="constantinople",
      name="Metropolis of Denver",
      local=u"Ἱερά Μητρόπολις Ντένβερ",
      rank="Metropolis",
      seat="Denver, Colorado", country="US", checked="2026-09-14",
      address=["4550 East Alameda Avenue", "Denver. Colorado 80246-1208"],
      sources=[E + "holy-metropolis-of-denver/", US_LIST,
               EG + "iera-mitropoli-ntenver/"]),

 # ------------------------------- the eparchies abroad the earlier rows missed
 dict(id="ep-ireland", parent="constantinople",
      name="Metropolitan of Ireland",
      local=u"Ἱερά Μητρόπολις Ἰρλανδίας",
      rank="Metropolis",
      country="IE", checked="2026-09-14",
      founded=(
       u"Ἱδρύθη διά Πατριαρχικοῦ καί Συνοδικοῦ Τόμου τοῦ Οἰκουμενικοῦ "
       u"Πατριαρχείου, κατά τήν συνεδρίαν τῆς 22ας Μαρτίου 2024, ἐξ "
       u"ἀποσπάσεως ἐκ τῆς Ἱερᾶς Ἀρχιεπισκοπῆς Θυατείρων καί Μεγάλης "
       u"Βρεταννίας"),
      sources=[E + "metropolitan-of-ireland/", EU_LIST,
               EG + "iera-mitropolis-irlandias/"]),
 dict(id="ep-malta", parent="constantinople",
      name="Patriarchal Exarchate of Malta",
      local=u"Πατριαρχική Εξαρχία Μελίτης",
      rank="Patriarchal Exarchate",
      seat="Valletta", country="MT", checked="2026-09-14",
      address=["Greek Orthodox Church of St Nicholas",
               "Merchants Street, Valetta"],
      founded=(
       u"Ἡ Πατριαρχική Ἐξαρχία Μελίτης (Μάλτας) ἱδρύθη διά Πατριαρχικοῦ καί "
       u"Συνοδικοῦ Τόμου τῇ 14ῃ Ἰανουαρίου 2021, ἐξ ἀποσπάσεως ἐκ τῆς μέχρι "
       u"τότε Ἱερᾶς Μητροπόλεως Ἰταλίας καί Μελίτης"),
 ...
 dict(id="ep-lithuania", parent="constantinople",
      ...
      local=u"Πατριαρχική Εξαρχία Λιθουανίας",
      rank="Patriarchal Exarchate",
      country="LT", checked="2026-09-14",
      founded=(
       u"Ἡ Πατριαρχική Ἐξαρχία Λιθουανίας ἱδρύθη, ἀποφάσει τῆς Ἁγίας καί "
       u"Ἱερᾶς Συνόδου, κατ' Ἀπρίλιον τοῦ ἔτους 2023"),
      sources=[E + "patriarchal-exarchate-of-lithuania/", EU_LIST,
               EG + "patriarxiki-eksarxia-lithouanias/"]),
 dict(id="ep-australia", parent="constantinople",
      name="Archdiocese of Australia",
      local=u"Ἱερά Ἀρχιεπισκοπή Αὐστραλίας",
      rank="Archdiocese",
      seat="Sydney", country="AU", checked="2026-09-14",
      address=["242 Cleveland Street", "Redfern NSW 2016"],
      founded=(
       u"Ἱδρύθη διά Πατριαρχικοῦ καί Συνοδικοῦ Τόμου ὑπό τῆς Ἁγίας καί Ἱερᾶς "
       u"Συνόδου τοῦ Οἰκουμενικοῦ Πατριαρχείου τό ἔτος 1924 ὡς «Ἱερά "
       u"Μητρόπολις Αὐστραλίας», μετωνομάσθη τό 1947 εἰς «Ἱεράν Μητρόπολιν "
       u"Αὐστραλίας καί Νέας Ζηλανδίας», τό δέ ἔτος 1959 ἀνυψώθη εἰς "
       u"Ἀρχιεπισκοπήν"),
 ...
 dict(id="ep-new-zealand", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Νέας Ζηλανδίας",
      rank="Metropolis",
      country="NZ", checked="2026-09-14",
      founded=(
       u"Ἱδρύθη τῇ 8ῃ Ἰανουαρίου 1970, δι' ἐκδοθέντος Ἱδρυτικοῦ Πατριαρχικοῦ "
       u"καί Συνοδικοῦ Τόμου, δι' ἀποσπάσεως ἐκ τῆς Ἀρχιεπισκοπῆς Αὐστραλίας, "
       u"εἰς ἥν ὑπήγετο ἕως τότε"),
      sources=[E + "metropolis-of-new-zealand/", OC_LIST,
               EG + "iera-mitropoli-neas-zilandias/"]),
 dict(id="ep-canada", parent="constantinople",
      name="Archdiocese of Canada",
      local=u"Ἱερά Ἀρχιεπισκοπή Καναδᾶ",
      rank="Archdiocese",
      seat="Toronto, Ontario", country="CA", checked="2026-09-14",
      address=["1 Patriarch Bartholomew Way", "(86 Overlea Boulevard)",
               "Toronto, ON M4H 1C6"],
      founded=(
       u"Ἱδρύθη, ὡς Μητρόπολις Τορόντο, τό ἔτος 1996 δι' ἀποσπάσεως ἐκ τῆς "
       u"μέχρι τότε Ἀρχιεπισκοπῆς Ἀμερικῆς Βορείου καί Νοτίου. Τό ἔτος 2019 "
       u"ἀνεδείχθη εἰς Ἀρχιεπισκοπήν Καναδᾶ"),
 ...
 dict(id="ep-buenos-aires", parent="constantinople",
      ...
      local=u"Ἱερά Μητρόπολις Μπουένος Ἄϊρες",
      rank="Metropolis",
      country="AR", checked="2026-09-14",
      founded=(
       u"Ἱδρύθη τό ἔτος 1996, δι' ἀποσπάσεως ἐκ τῆς μέχρι τότε Ἀρχιεπισκοπῆς "
       u"Ἀμερικῆς Βορείου καί Νοτίου"),
      sources=[E + "metropolis-of-buenos-aires/", US_LIST,
               EG + "iera-mitropoli-mpoyenos-aires/"]),
 dict(id="ep-mexico", parent="constantinople",
      name="Metropolis of Mexico",
      local=u"Ἱερά Μητρόπολις Μεξικοῦ",
      rank="Metropolis",
      country="MX", checked="2026-09-14",
      founded=(
       u"Ἡ Ἱερά Μητρόπολις ἱδρύθη διά Πράξεως τῆς Ἁγίας καί Ἱερᾶς Συνόδου τοῦ "
       u"Οἰκουμενικοῦ Πατριαρχείου, κατά τήν Συνεδρίαν τῆς 30ῆς Ἰουλίου 1996, "
       u"ἐξ ἀποσπάσεως ἐκ τῆς ἑνιαίας μέχρι τότε Ἱ. Ἀρχιεπισκοπῆς Ἀμερικῆς "
       u"Βορείου καί Νοτίου"),
      sources=[E + "metropolis-of-mexico/", US_LIST,
               EG + "iera-mitropoli-meksikoy/"]),
 ...
 dict(id="ep-mon-anastasia", parent="constantinople",
      ...
      rank="Royal, Patriarchal and Stavropegic Monastery",
 ...
 dict(id="ep-mon-essex", parent="constantinople",
      ...
      rank="Patriarchal and Stavropegic Monastery",
