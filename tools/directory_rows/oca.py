...
ROWS = [
 ...
 dict(id="oca-albanian", parent="oca", name="Albanian Archdiocese",
      ...
      founded=u"On October 14, 1971, Bp. Stephen led most of the Albanian parishes into the OCA.",
      sources=[OCA_DIOC, "https://albanianarchdiocese.org/",
               "https://albanianarchdiocese.org/history1.html"]),
 dict(id="oca-bulgarian", parent="oca", name="Bulgarian Diocese",
      ...
      founded=[u"1964: Father Kyrill was elevated to the episcopacy to shepherd the newly formed \"Bulgarian Diocese in Exile\" (later known as the Bulgarian Diocese of Toledo), which initially joined the Russian Orthodox Church Outside of Russia (ROCOR).",
               u"1976: Under Bishop Kyrill's leadership, the diocese petitioned to join the Orthodox Church in America to achieve full canonical unity."],
      sources=[OCA_DIOC, "https://www.bdoca.org/",
               "https://www.bdoca.org/history-of-the-bulgarian-diocese.html"]),
 dict(id="oca-canada", parent="oca", name="Archdiocese of Canada",
      ...
      founded=u"The diocese was founded and incorporated by Saint Tikhon, Patriarch of Moscow and all Rus, in 1903.",
      sources=[OCA_DIOC, "https://www.archdiocese.ca/",
               "https://www.archdiocese.ca/history"]),
 ...
 dict(id="oca-south", parent="oca", name="Diocese of the South",
      ...
      founded=u"The OCA, Diocese of the South was established in 1979 after years of operating as a missionary diocese, administered under the auspices of our national Church, the Orthodox Church in America.",
      sources=[OCA_DIOC, "https://dosoca.org/",
               "https://dosoca.org/history-of-the-diocese-of-the-south/"]),
 ...
 dict(id="oca-western-pa", parent="oca", name="Archdiocese of Western Pennsylvania",
      ...
      founded=u"The Archdiocese of Pittsburgh and Western Pennsylvania is one of the oldest dioceses in the Orthodox Church in America, established in 1916.",
      sources=[OCA_DIOC, "https://www.ocadwpa.org/",
               "https://www.ocadwpa.org/history.html"]),
 dict(id="oca-romanian", parent="oca", name="Romanian Episcopate",
      styled="The Romanian Orthodox Episcopate of America",
      rank="Episcopate",
      founded=u"Although Romanian Orthodox parishes were in existence in the United States and Canada from the turn of the century, the Romanian Orthodox Episcopate of America was established as a Diocese only at a general Church Congress held in the city of Detroit, Michigan, on April 25-28, 1929.",
