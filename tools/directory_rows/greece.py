...
# are the Throne's. It is the evidence for the count rather than for a row,
# so a row cites the page it was read from and not this one - with two
# exceptions, added on 14 September 2026. The English edition of the list of
# dioceses carries seventy-six of the eighty-two and leaves out Glyfada and
# Ilia and Oleni, so those two rows had one page apiece and no second in any
# language. The roll names them both, in the part that numbers the sees of
# this Church, and those two rows now cite it beside their own page. It is
# not a stretch: a roll of a Church's hierarchy naming a see is the Church
# saying the see is its own.
...
ROWS = [
 ...
 dict(id="gr-ilia", parent="greece",
      ...
      sources=[G + "eleias-kai-olenes", ROLL]),
