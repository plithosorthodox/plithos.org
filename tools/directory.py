...
CHURCHES = [
 dict(id="constantinople", order=1, kind="church",
      ...
      site="https://ec-patr.org/",
      sources=["https://ec-patr.org/",
               "https://ec-patr.org/en/ecumenical-patriarchate/history/"
...
DIOCESES = [
 ...
 dict(id="goarch", parent="constantinople",
      ...
      local="Ἱερά Ἀρχιεπισκοπή Ἀμερικῆς",
      rank="Archdiocese",
      seat="New York", country="US", checked="2026-09-14",
      address=["8 E. 79th St", "New York, NY 10021"],
      founded=(
       "Ἱδρύθη τό ἔτος 1922 ὡς Ἀρχιεπισκοπή Βορείου καί Νοτίου Ἀμερικῆς, "
       "ἔχουσα τόν Ἀρχιεπίσκοπον καί τούς περί αὐτόν Ἐπισκόπους"),
      site="https://www.goarch.org/",
      sources=["https://ec-patr.org/en/eparchies-of-the-throne/eparchies-in-america/",
               "https://ec-patr.org/en/entities/holy-archdiocese-of-america/",
               "https://ec-patr.org/entities/iera-archiepiskopi-ipa/"]),
 dict(id="acrod", parent="constantinople",
      name="American Carpatho-Russian Orthodox Diocese of North America",
      rank="Diocese",
      seat="Johnstown, Pennsylvania", country="US", checked="2026-09-14",
      address=["312 Garfield Street", "Johnstown, PA 15906"],
      site="https://www.acrod.org/",
      sources=["https://www.acrod.org/about/contact/",
               "https://ec-patr.org/entities/orthodoksoi-karpathorosoi-stis-ipa/"]),
 dict(id="uoc-usa", parent="constantinople",
      name="Ukrainian Orthodox Church of the USA",
      seat="Somerset, New Jersey", country="US", checked="2026-09-14",
      address=["Metropolia Center", "135 Davidson Avenue", "Somerset, NJ 08873"],
      site="https://uocofusa.org/",
      sources=["https://uocofusa.org/",
               "https://ec-patr.org/entities/orthodoksoi-oykranoi-stis-ipa/"]),
 dict(id="uocc", parent="constantinople",
      name="Ukrainian Orthodox Church of Canada",
      seat="Winnipeg, Manitoba", country="CA", checked="2026-09-14",
      address=["9 St. John's Avenue", "Winnipeg, MB R2W 1G8"],
      site="https://www.uocc.ca/",
      sources=["https://www.uocc.ca/contact/",
               "https://ec-patr.org/entities/ukrainian-orthodox-church-in-canada/"]),
 dict(id="albanian-americas", parent="constantinople",
      ...
      rank="Diocese",
      seat="Boston, Massachusetts", country="US", checked="2026-09-14",
      address=["PO Box 224", "245 D Street", "South Boston, MA 02127-0003"],
      site="https://albaniandiocese-ep.org/",
      sources=["https://albaniandiocese-ep.org/",
               "https://ec-patr.org/entities/albanian-orthodox-diocese-in-america/"]),
 ...
 dict(id="antiochian-na", parent="antioch",
      ...
      local=u"\u0646\u064a\u0648\u064a\u0648\u0631\u0643 "
            u"\u0648\u0633\u0627\u0626\u0631 \u0623\u0645\u064a\u0631\u0643\u0627 "
            u"\u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0651\u0629",
      rank="Archdiocese", checked="2026-09-14",
      site="https://www.antiochian.org/",
      sources=["https://www.antiochian.org/", OCA_LIST,
               "https://antiochpatriarchate.org/ar/category/archdioceses/64/"]),
 ...
 dict(id="ep-thyateira", parent="constantinople",
      ...
      local="Ἱερά Ἀρχιεπισκοπή Θυατείρων καί Μεγάλης Βρεταννίας",
      rank="Archdiocese",
      seat="London", country="GB", checked="2026-09-14",
      address=["Thyateira House", "5 Craven Hill", "London W2 3EN"],
      founded=(
       "Ἱδρύθη τό ἔτος 1922. Ἀνεδείχθη εἰς Ἀρχιεπισκοπήν τό πρῶτον τό 1954. "
       "Διαιρεθεῖσα εἰς 4 Μητροπόλεις τό 1962, ἀνεδείχθη ἐκ νέου εἰς "
       "Ἀρχιεπισκοπήν τόν Φεβρουάριον τοῦ ἔτους 1968"),
      site="https://www.thyateira.org.uk/",
      sources=["https://ec-patr.org/en/entities/holy-archdiocese-of-thyatira-and-great-britain/",
               "https://ec-patr.org/entities/iera-arxiepiskopi-thyateiron-megalis-vretanias/"]),
 dict(id="ep-france", parent="constantinople",
      ...
      rank="Metropolis",
      seat="Paris", country="FR", checked="2026-09-14",
      address=["7 Rue Georges Bizet", "75116 Paris"],
      founded=(
       "Ἱδρύθη τό ἔτος 1963, δι' ἀποσπάσεως ἐκ τῆς μέχρι τότε Ἀρχιεπισκοπῆς "
       "Θυατείρων καί Μεγάλης Βρεταννίας"),
      sources=["https://ec-patr.org/en/entities/metropolis-of-france/",
               "https://ec-patr.org/entities/iera-mitropoli-gallias/"]),
 dict(id="ep-germany", parent="constantinople",
      ...
      rank="Metropolis",
      seat="Bonn", country="DE", checked="2026-09-14",
      address=["Dietrich-Bonhoeffer-Str. 2", "53227 Bonn"],
      founded=(
       "Ἱδρύθη τῇ 5ῃ Φεβρουαρίου 1963, δι' ἀποσπάσεως ἐκ τῆς Ἀρχιεπισκοπῆς "
       "Θυατείρων καί Μεγάλης Βρεταννίας, δι' ἐκδοθέντος Ἱδρυτικοῦ "
       "Πατριαρχικοῦ καί Συνοδικοῦ Τόμου"),
      site="https://www.orthodoxie.net/",
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-germany/",
               "https://ec-patr.org/entities/iera-mitropoli-germanias/"]),
 dict(id="ep-austria", parent="constantinople",
      name="Holy Metropolis of Austria",
      local="Ἱερά Μητρόπολις Αὐστρίας",
      rank="Metropolis",
      seat="Vienna", country="AT", checked="2026-09-14",
      address=["Fleischmarkt 13", "1010 Wien"],
      founded=(
       "Ἵδρυσις ὑπό τοῦ Οἰκουμενικοῦ Πατριαρχείου τήν 17ην Φεβρουαρίου 1963"),
      site="https://www.metropolisaustria.at/",
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-austria/",
               "https://ec-patr.org/entities/iera-mitropoli-aystrias/"]),
 dict(id="ep-sweden", parent="constantinople",
      name="Metropolis of Sweden and All Scandinavia",
      local="Ἱερά Μητρόπολις Σουηδίας καί πάσης Σκανδιναυΐας",
      rank="Metropolis",
      seat="Stockholm", country="SE", checked="2026-09-14",
      address=["Birger Jarlsgatan 92", "114 20 Stockholm"],
      founded=(
       "Ἱδρύθη τῇ 12ῃ Αὐγούστου 1969, δι' ἐκδοθέντος Ἱδρυτικοῦ Πατριαρχικοῦ "
       "καί Συνοδικοῦ Τόμου"),
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-sweden-and-all-scandinavia/",
               "https://ec-patr.org/entities/iera-mitropoli-soyidias/"]),
 dict(id="ep-belgium", parent="constantinople",
      name="Metropolis of Belgium",
      local="Ἱερά Μητρόπολις Βελγίου",
      rank="Metropolis",
      seat="Brussels", country="BE", checked="2026-09-14",
      address=["Avenue Charbo 71", "1030 Brussels"],
      founded=(
       "Ἱδρύθη τῇ 12ῃ Αὐγούστου 1969, δι' ἐκδοθέντος Ἱδρυτικοῦ Πατριαρχικοῦ "
       "καί Συνοδικοῦ Τόμου"),
      site="https://orthodoxia.be/",
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-belgium/",
               "https://ec-patr.org/entities/iera-mitropoli-velgioy/"]),
 dict(id="ep-switzerland", parent="constantinople",
      name="Metropolis of Switzerland",
      local="Ἱερά Μητρόπολις Ἑλβετίας",
      rank="Metropolis",
      seat="Chambesy", country="CH", checked="2026-09-14",
      address=["Route de Lausanne 282", "CH-1292 Chambesy"],
      founded=(
       "Ἱδρύθη τήν 2αν Ὀκτωβρίου 1982, διά Πατριαρχικοῦ καί Συνοδικοῦ Τόμου, "
       "δι' ἀποσπάσεως ἐκ τῆς μέχρι τότε Ἱ. Μητροπόλεως Αὐστρίας"),
      site="https://dioceseorthodoxe.org/",
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-switzerland/",
               "https://ec-patr.org/entities/iera-mitropoli-elvetias/"]),
 dict(id="ep-italy", parent="constantinople",
      ...
      seat="Venice", country="IT", checked="2026-09-14",
      address=["Castello 3422", "Campo dei Greci", "30122 Venezia"],
      founded=(
       "Ἱδρύθη διά Πατριαρχικοῦ καί Συνοδικοῦ Τόμου τήν 5ην Νοεμβρίου 1991 "
       "δι' ἀποσπάσεως ἐκ τῆς μέχρι τότε Ἱερᾶς Μητροπόλεως Αὐστρίας καί "
       "Ἐξαρχίας Ἰταλίας καί Οὑγγαρίας"),
      site="https://ortodossia.it/",
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-italy/",
               "https://ec-patr.org/entities/iera-mitropoli-italias-melitis/"]),
 dict(id="ep-spain", parent="constantinople",
      ...
      rank="Metropolis",
      seat="Madrid", country="ES", checked="2026-09-14",
      address=["Calle Nicaragua 12", "28016 Madrid"],
      founded=(
       "Ἱδρύθη τήν 20ήν Ἰανουαρίου 2003 δι' ἀποσπάσεως ἐκ τῆς μέχρι τότε "
       "Ἱερᾶς Μητροπόλεως Γαλλίας καί Ἐξαρχίας πάσης Ἰβηρίας"),
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-spain-and-portugal/",
               "https://ec-patr.org/entities/iera-mitropoli-ispanias/"]),
 dict(id="ep-hongkong", parent="constantinople",
      name="Orthodox Metropolitanate of Hong Kong and South East Asia",
      local="Ἱερά Μητρόπολις Χόνγκ Κόνγκ",
      rank="Metropolis",
      seat="Hong Kong", country="HK", checked="2026-09-14",
      address=["704 Universal Trade Center", "3 Arbuthnot Rd", "Hong Kong"],
      founded=(
       "Ἱδρύθη τό ἔτος 1996 δι' ἀποσπάσεως ἐκ τῆς μέχρι τότε Μητροπόλεως "
       "Νέας Ζηλανδίας καί ἀνεγνωρίσθη τό αὐτό ἔτος ὑπό τῆς Κυβερνήσεως τοῦ "
       "Χόνγκ Κόνγκ"),
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-hong-kong/",
               "https://ec-patr.org/entities/iera-mitropoli-xongk-kongk/"]),
 dict(id="ep-korea", parent="constantinople",
      name="Holy Metropolis of Korea",
      local="Ἱερά Μητρόπολις Κορέας",
      rank="Metropolis",
      seat="Seoul", country="KR", checked="2026-09-14",
      address=["424-1 Ahyeon-dong", "Mapo-gu, Seoul"],
      founded=(
       "Ἱδρύθη διά Πράξεως τῆς Ἁγίας καί Ἱερᾶς Συνόδου τοῦ Οἰκουμενικοῦ "
       "Πατριαρχείου τῇ 20ῇ Ἀπριλίου 2004, ἐντός τῶν ὁρίων τῆς μέχρι τότε "
       "«Ἐξαρχίας τοῦ Οἰκουμενικοῦ Πατριαρχείου ἐν Κορέᾳ», ἥτις ὑπήγετο εἰς "
       "τήν Ἱεράν Μητρόπολιν Νέας Ζηλανδίας"),
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-korea/",
               "https://ec-patr.org/entities/iera-mitropoli-koreas/"]),
 ...
 dict(id="athos", parent="constantinople",
      ...
      sources=["https://ec-patr.org/en/entities/monastic-community-of-the-holy-mountain/",
               ...
               "https://ec-patr.org/entities/monastiki-politeia-agioy-oroys/"]),

 dict(id="ep-singapore", parent="constantinople",
      name="Orthodox Metropolitanate of Singapore and South Asia",
      local="Ἱερά Μητρόπολις Σιγκαπούρης",
      rank="Metropolis",
      seat="Singapore", country="SG", checked="2026-09-14",
      address=["16 Raffles Quay, #41-07", "Hong Leong Building", "Singapore"],
      founded=(
       "Ἱδρύθη διά Πράξεως τῆς Ἱερᾶς Συνόδου τοῦ Οἰκουμενικοῦ Πατριαρχείου, "
       "κατά τήν συνεδρίαν τῆς 9ης Ἰανουαρίου 2008, ἐξ ἀποσπάσεως ἐκ τῆς "
       "Ἱερᾶς Μητροπόλεως Χόνγκ Κόνγκ"),
      site="https://omsgsa.org/",
      sources=["https://ec-patr.org/en/entities/holy-metropolis-of-singapore/",
               "https://ec-patr.org/entities/iera-mitropoli-sigkapoyris/"]),
