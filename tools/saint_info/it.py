# -*- coding: utf-8 -*-
"""Italian calendar entries. TEXT = {English name: {type, life, patron}}.

The calendar's life is the short one the day panel shows; the long one is in
tools/saint_lives/it.py, and a saint is written in both places at once so
...
{"type": "Martiri · III sec.", "life": "I Dieci Santi Martiri di Creta, Teodulo, Saturnino, Euporo, Gelasio, Eunicano, Zotico, Pompeo, Agatopode, Basilide ed Evaristo, patirono nell'anno 250 sotto l'imperatore Decio, il cui governatore nell'isola, anch'egli Decio di nome e di crudeltà, si propose di estirpare la fede da Creta.", "patron": "Si invocano per la gioia davanti alla morte; per la corona contesa nell'amore."},

"12 Greeks who built the Dormition Cathedral in the Kyiv Caves, Far Caves, Lavra":
{"type": "Capomastri, monaci · XI sec.", "life": "I Dodici Greci che edificarono la grande cattedrale della Dormizione delle Grotte di Kyiv sono commemorati in questo giorno, maestri costruttori di Costantinopoli che la Madre di Dio stessa assoldò per la più grande impresa edilizia dell'antica Rus'. Il Paterikon delle Grotte conserva il loro racconto giurato: la Regina del cielo apparve loro nella chiesa delle Blacherne a Costantinopoli, in forma di imperatrice circondata da guerrieri, e comandò loro di andare nella Rus', a Kyiv, e di edificare colà una chiesa in suo onore nel luogo che sarebbe stato loro mostrato.", "patron": "Si invocano per i costruttori; per gli architetti."},

"120 Martyrs of Persia":
{"type": "Martiri · IV sec.", "life": "I Santi Centoventi Martiri di Persia patirono nella grande persecuzione del re Sapore II, verso l'anno 344, negli anni in cui il regno persiano, in guerra con l'impero romano divenuto da poco cristiano, si volse contro la Chiesa entro i propri confini come contro una colonia nemica, e i confessori di Cristo nella Mesopotamia e nella Persia furono presi a migliaia.", "patron": "Si invocano per i prigionieri; per le schiere dei confessori."},

"1st Saturday of Great Lent: The Miracle of the Boiled Wheat":
{"type": "Festa · IV sec.", "life": "Il primo sabato della Grande Quaresima la Chiesa commemora il miracolo del grano bollito, la kolyva, operato dal santo grande martire Teodoro Tirone mezzo secolo dopo il proprio martirio, il soldato di Cristo già morto che monta la guardia sulla prima settimana di digiuno della Chiesa.", "patron": "In questo giorno si prega per quanti osservano il digiuno; per i tentati e gli ingannati."},

"1st Sunday of Great Lent: Sunday of Orthodoxy":
{"type": "Festa · IX sec.", "life": "La prima domenica della Grande Quaresima la Chiesa celebra la Domenica dell'Ortodossia, la festa del Trionfo della vera fede, stabilita nell'anno 843, quando la santa imperatrice Teodora e il santo patriarca Metodio restituirono alla Chiesa la venerazione delle sante icone e posero fine all'ultima grande eresia del mondo antico.", "patron": "In questo giorno si prega per tutta la Chiesa militante; per quanti custodiscono la fede dei Padri."},

"20,000 Martyrs of Nicomedia":
{"type": "Martiri · IV sec.", "life": "I santi Ventimila Martiri di Nicomedia patirono nell'anno 302, quando l'imperatore Massimiano, sapendo quanto potentemente la fede fosse cresciuta nella sua stessa capitale, decise di distruggere i cristiani della città in una sola notte, e scelse per questo la notte in cui tutti sarebbero stati radunati: la festa della Natività di Cristo.", "patron": "Si invocano per le assemblee sotto minaccia; per i catecumeni."},

"26 Martyrs in the Crimea":
{"type": "Martiri · IV sec.", "life": "I santi Ventisei Martiri, le cui reliquie santificarono la Crimea, patirono nella terra dei Goti oltre il Danubio verso l'anno 375, quando il re goto pagano suscitò la persecuzione contro i cristiani del suo popolo, e la giovane chiesa gotica, piantata da prigionieri e da missionari, pagò nel sangue il suo primo grande prezzo.", "patron": "Si invocano per le assemblee riunite per il culto; per i popoli convertiti da poco."},

"2nd Sunday of Great Lent: St Gregory Palamas":
{"type": "Festa · XIV sec.", "life": "La seconda domenica della Grande Quaresima la Chiesa celebra la memoria di san Gregorio Palamas, arcivescovo di Tessalonica, e il giorno è giustamente chiamato il secondo Trionfo dell'Ortodossia, poiché prolunga il primo: come la prima domenica proclama che Dio può essere raffigurato perché veramente si è fatto uomo, così la seconda proclama che Dio può essere sperimentato perché veramente si dona, e l'icona e la luce sono due sentenze di una sola fede.", "patron": "In questo giorno si prega per gli esicasti e quanti pregano; per i teologi dell'esperienza."},

"33 Holy Martyrs of Melitene":
{"type": "Martiri · III sec.", "life": "I santi Trentatré Martiri di Melitene patirono verso l'anno 290, sotto Diocleziano e Massimiano, quando un distaccamento agli ordini del comandante Lisia fu mandato in Cappadocia per estirpare i cristiani e per arruolare nell'esercito uomini robusti. A capo di essi sta Ierone, agricoltore di Tiana, allevato nella pietà dalla madre, uomo di straordinaria forza corporale.", "patron": "Si invocano per i contadini; per i coscritti."},

"3rd Sunday of Great Lent: Veneration of the Cross":
{"type": "Festa · IV sec.", "life": "La terza domenica della Grande Quaresima la Chiesa reca fuori la preziosa e vivificante Croce e la depone in mezzo ai fedeli, ornata di fiori, perché sia venerata per tutta la settimana che segue; e la collocazione è tutta la teologia del giorno, poiché la Croce è piantata nel centro esatto del digiuno, a metà dei quaranta giorni, come un albero di riposo a metà di una strada faticosa.", "patron": "In questo giorno si prega per quanti portano croci; per gli stanchi a metà del cammino."},

"40 Holy Martyrs of Sebaste":
{"type": "Martiri · IV sec.", "life": "I santi Quaranta Martiri di Sebaste erano soldati della celebre Dodicesima Legione, detta Fulminante, di stanza a Sebaste in Armenia intorno all'anno 320, che il sinassario bizantino computa al 322 o al 323, quando l'imperatore Licinio, rompendo la pace con la Chiesa, comandò ai suoi eserciti di sacrificare.", "patron": "Si invocano per i soldati; per le compagnie e le confraternite."},

"42 Martyrs of Ammoria in Phrygia":
{"type": "Martiri · IX sec.", "life": "I santi Quarantadue Martiri di Ammoria erano comandanti e nobili dell'esercito bizantino, presi prigionieri quando la grande città di Ammoria in Frigia cadde in mano ai saraceni nell'anno 838, e fra loro Costantino, Ezio, Teofilo, Teodoro, Melisseno, Callisto e Basoe, il fiore del comando dell'impero, deportati nella Mesopotamia.", "patron": "Si invocano per i soldati; per i comandanti."},

"45 Holy Martyrs at Nicopolis in Armenia":
{"type": "Laici · IV sec.", "life": "I Quarantacinque Santi Martiri di Nicopoli in Armenia patirono sotto l'imperatore Licinio, che regnava sull'Oriente e perseguitava aspramente la Chiesa, decretando la morte per ogni cristiano che non fosse tornato agli idoli. Quando la persecuzione giunse a Nicopoli, più di quaranta fedeli, guidati da Leonzio, Maurizio, Daniele, Antonio e Alessandro, decisero non di nascondersi, ma di presentarsi apertamente davanti ai persecutori e di confessare Cristo.", "patron": "Si invocano per la confessione ardita."},

"4th Sunday of Great Lent: St John Climacus (of the Ladder)":
{"type": "Festa · VII sec.", "life": "La quarta domenica della Grande Quaresima la Chiesa pone davanti ai suoi figli il venerabile Giovanni Climaco, igumeno del Sinai e autore della Scala del divino ascenso, e la scelta è pedagogia deliberata: passata la metà del digiuno, venerata la Croce e non ancora in vista la Pasqua, la Chiesa fa avanti il suo maestro cartografo della vita spirituale, l'uomo che descrisse tutta la salita dalla rinuncia al mondo fino alla vetta dell'amore in trenta gradini esatti, e dice agli stanchi, in sostanza, che la strada su cui sono è stata misurata, che i valichi sono conosciuti, e che la cima si raggiunge.", "patron": "In questo giorno si prega per quanti salgono verso Dio; per quanti lottano a metà Quaresima."},

"5th Saturday of Great Lent: of the Akathist to the Theotokos":
{"type": "Festa · VII sec.", "life": "Il quinto sabato della Grande Quaresima la Chiesa celebra la festa dell'Akathistos, cantando per intero, in una sola notte solenne, il grande inno alla Santissima Theotokos che nel resto dell'anno canta a parti; e la festa è memoriale di guerra non meno che ufficio, poiché fu istituita in rendimento di grazie per le liberazioni di Costantinopoli.", "patron": "In questo giorno si prega per quanti si rifugiano nella Theotokos; per le città assediate."},

"5th Sunday of Great Lent: St Mary of Egypt":
{"type": "Festa · VI sec.", "life": "La venerabile Maria Egiziaca, la cui vita si legge in chiesa durante la Grande Quaresima come immagine del pentimento, trascorse la giovinezza in Alessandria in grande dissolutezza. Andata a Gerusalemme, si trovò trattenuta da una forza invisibile dall'entrare nella chiesa alla festa dell'Esaltazione della Croce e, colpita al cuore, pianse davanti a un'icona della Madre di Dio e promise di mutare vita.", "patron": "In questo giorno si prega per i penitenti alla vetta della Quaresima; per quanti disperano di cambiare."},
...
{"type": "Postfesta", "life": "Nei giorni della Postfesta della Dormizione la Chiesa continua a celebrare il beato transito della nostra Santissima Signora la Theotokos e il suo passaggio nella gloria al regno dei cieli. Gli inni di questi giorni proclamano che colei che portò l'Autore della vita non abbandonò il mondo nella sua dormizione, ma fu assunta dal Figlio suo per regnare con lui e per intercedere senza posa per tutti coloro che la onorano.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},
...
{"type": "Apostolo dei Settanta · I sec.", "life": "Il santo apostolo Tito, uno dei Settanta, era originario di Creta e figlio di una illustre famiglia pagana, e nella sua giovinezza studiò la filosofia e la poesia dei Greci custodendosi dai loro vizi. Attratto dalla verità, divenne discepolo e amato collaboratore dell'apostolo Paolo, che lo chiamò suo vero figlio nella fede comune e lo fece primo vescovo di Creta.", "patron": "Si invoca per i missionari; per Creta."},

"Apostle Trophimus of the Seventy":
{"type": "Apostolo dei Settanta · I sec.", "life": "Il santo apostolo Trofimo dei Settanta era un greco di Efeso, uno dei convertiti dalle genti che l'apostolo Paolo legò a sé come compagni di strada, e le Scritture lo mostrano tre volte, ciascuna apparizione una tappa del discepolato. Compare la prima volta fra i delegati che accompagnavano Paolo dalla Grecia verso Gerusalemme con la colletta per i santi poveri, l'offerta delle giovani Chiese che viaggia sotto la scorta dei loro stessi figli.", "patron": "Si invoca per i compagni dei grandi; per i malati lasciati indietro."},

"Apostle and Evangelist John the Theologian":
{"type": "Apostolo · I sec.", "life": "In questo giorno la Chiesa celebra la festa primaverile del santo, glorioso apostolo ed evangelista Giovanni il Teologo, il discepolo amato e vergine, la cui dormizione essa commemora in settembre; e la festa di maggio ha una sua propria antica occasione, poiché dalla tomba dell'apostolo a Efeso, dove egli aveva ordinato ai suoi discepoli di deporlo e che fu poi trovata vuota del suo corpo, sorgeva ogni anno in questo giorno una polvere fine e santa, che i fedeli chiamavano manna, e per essa, raccolta con la preghiera, erano donate guarigioni di ogni genere, il sepolcro che non poté trattenere il Teologo serbando invece un annuale appuntamento di grazia, e la Chiesa di Efeso edificando questa festa sopra il prodigio. Il giorno raccoglie dunque la sua memoria intera: il figlio del pescatore di Betsaida, nato da Zebedeo e da Salome, fratello di Giacomo, dapprima discepolo del Battista e da lui indicato all'Agnello; uno dei Dodici, e dentro i Dodici uno dei tre, e dentro i tre l'uno, il discepolo che Gesù amava, che nella Cena riposò sul petto del Maestro e da quella vicinanza attinse la teologia che gli dà il nome; solo fra gli apostoli seguì fino alla Croce, e là ricevette l'incarico che corona tutti i suoi titoli, il Signore morente affidandogli la propria Madre, ecco tua madre, il discepolo amato divenuto figlio in luogo di Gesù e custodendo la Theotokos come cosa propria fino alla sua Dormizione; e poi la colonna della Chiesa d'Asia, l'esule di Patmo che vide l'Apocalisse, l'anziano di Efeso che scrisse il quarto Vangelo dall'altezza che l'aquila segna, in principio era il Verbo, e le epistole il cui intero peso, dettato infine, racconta la tradizione, nell'unica frase della sua estrema vecchiaia, era: figlioli, amatevi gli uni gli altri, perché questo basta. La Chiesa onora in questa festa la continua larghezza dell'apostolo dell'amore, insegnando che la tomba vuota di Efeso, che dispensava di anno in anno la sua polvere di guarigione, è il monumento conveniente al discepolo che insegnò che Dio è amore, il suo stesso sepolcro comportandosi generosamente; ed essa rimanda i fedeli della festa di maggio, come la manna rimandava i pellegrini d'un tempo, al suo Vangelo, dove il petto su cui egli si chinò è ancora aperto a ogni lettore, alla stessa vicinanza, in ogni pagina."},

"Apostle and Evangelist Luke":
{"type": "Apostolo · I sec.", "life": "Il santo apostolo ed evangelista Luca era originario di Antiochia, medico per arte ed esperto anche nella pittura, e venuto al Signore fu annoverato fra i Settanta e mandato davanti al suo volto; e fu uno dei due discepoli ai quali il Cristo risorto apparve sulla strada di Emmaus, quando il loro cuore ardeva mentre egli apriva loro le Scritture.", "patron": "Si invoca per i medici; per gli iconografi."},

"Apostle and Evangelist Luke of the Seventy":
{"type": "Apostolo ed evangelista · I sec.", "life": "Il santo apostolo ed evangelista Luca, che i calendari di questo giorno commemorano insieme agli apostoli Natanaele e Clemente, e la cui festa principale la Chiesa celebra in ottobre, era un greco di Antiochia, medico di professione e, aggiunge la tradizione, pittore, le due arti del corpo e dell'occhio portate intere al servizio del Vangelo.", "patron": "Si invoca per i medici; per gli iconografi e i pittori."},

"Apostle and Evangelist Mark":
{"type": "Apostolo · I sec.", "life": "Il santo apostolo ed evangelista Marco, chiamato negli Atti Giovanni Marco, era di Gerusalemme, figlio di quella Maria nella cui casa si radunava la prima Chiesa, le stanze superiori della sua fanciullezza servendo da cattedrale nascosta della città, alla cui porta venne a bussare Pietro la notte in cui l'angelo lo trasse di prigione; e il giovane di quella casa fu formato al focolare stesso della fede, cugino di Barnaba, compagno del primo viaggio missionario fino a che tornò indietro a Perge, l'insuccesso che le Scritture registrano senza belletto e occasione dell'aspro contrasto per il quale Paolo e Barnaba si separarono; e la Chiesa ha sempre tenuto più caro il seguito che l'inciampo, poiché il disertore fu restituito così pienamente che Paolo, nelle sue ultime catene, lo chiese per nome: prendi Marco e conducilo con te, perché mi è utile per il ministero, il fallimento iniziale cancellato dalla lode finale. Ma il suo legame più profondo fu con Pietro, che nella sua epistola lo chiama Marco mio figlio; la tradizione degli antichi, da Papia in poi, lo dice interprete di Pietro, e il suo Vangelo, scritto a Roma su richiesta dei fedeli di là, è la predicazione di Pietro messa per iscritto, il più breve e il più rapido dei quattro, il Vangelo del Servo che non è venuto per essere servito ma per servire, che si apre con la voce che grida nel deserto, donde la Chiesa assegnò a Marco il leone dei quattro viventi. Mandato in Egitto, fondò la Chiesa di Alessandria, la sede che avrebbe dato al mondo Atanasio e Cirillo, piantando il Vangelo tanto a fondo in quella città di filosofi che la sua scuola catechetica divenne la prima grande accademia della cristianità; e là fu perfezionato, preso dai pagani nella Pasqua che cadde contro la festa di Serapide, una fune al collo, trascinato per le strade sopra le pietre finché le sue carni furono lacerate, e gettato in prigione, dove il Signore stesso gli apparve con la parola che la Chiesa alessandrina custodì come suo tesoro: pace a te, Marco, mio evangelista; e trascinato di nuovo il giorno seguente, rese la sua anima, nell'anno 68 come conta la tradizione comune, o nel 63 secondo il computo alessandrino, il fuoco preparato per il suo corpo disperso da un'improvvisa tempesta, e i fedeli lo seppellirono con onore."},

"Apostle and Evangelist Matthew":
{"type": "Apostolo · I sec.", "life": "Il santo apostolo ed evangelista Matteo, chiamato anche Levi, sedeva al banco delle imposte a Cafarnao, pubblicano disprezzato dalla sua gente, quando il Signore passò e disse: seguimi; ed egli, alzatosi, lasciò ogni cosa, fece al Signore un gran convito nella sua casa, e di esattore divenne donatore, di pubblicano apostolo. A lui la Chiesa deve il primo dei quattro Vangeli, scritto, come ritiene l'antica testimonianza, circa otto anni dopo l'Ascensione per i credenti venuti dagli Ebrei, il Vangelo che apre il Nuovo Testamento con il libro della generazione di Gesù Cristo e conserva il Discorso della montagna; e per questo la Chiesa lo chiama Evangelista e onora la sua festa con la veglia. Dopo avere predicato nella Giudea, portò il Vangelo in Siria, in Media, in Persia e nella Partia, e compì il suo corso in Etiopia, terra selvaggia e di costumi feroci, dove la sua predicazione e le sue preghiere cominciarono a radunare una Chiesa; il Signore gli apparve dandogli un bastone da piantare alla porta della chiesa, il quale crebbe in un albero fruttifero con una sorgente d'acqua alle radici, e il popolo, mangiando e lavandosi, si fece mite e credette."},

"Apostles Jason and Sosipater of the Seventy, the Virgin Kerkyra, and those with them":
{"type": "Martiri e apostoli dei Settanta · I sec.", "life": "I santi apostoli Giasone e Sosipatro dei Settanta, con la vergine Cercira e quelli con loro, diedero alla Chiesa una delle più compiute conversioni insulari dell'età apostolica.", "patron": "Si invocano per le chiese delle isole; per i carcerati e chi li converte."},

"Apostles Patrobus, Hermes, Linus, Gaius, and Philologus, of the Seventy":
{"type": "Apostolo dei Settanta · I sec.", "life": "I santi apostoli Patroba, Erma, Lino, Gaio e Filologo dei Settanta sono salutati nelle epistole dell'apostolo Paolo, e ciascuno servì il Vangelo come vescovo, sopportando le fatiche e i pericoli della prima età della Chiesa. Lino, che Paolo nomina nella sua ultima epistola, divenne dopo il martirio dei principi degli apostoli il primo vescovo di Roma, reggendo la Chiesa della città imperiale negli anni della persecuzione di Nerone.", "patron": "Si invoca per i vescovi; per la piantagione delle chiese."},

"Apostles of the Seventy Archippus and Philemon, and Martyr Apphia":
{"type": "Martiri e apostoli dei Settanta · I sec.", "life": "I santi apostoli Archippo e Filemone dei Settanta, e la martire Apfia, sono la famiglia della più breve delle epistole, la casa di Colossi alla quale Paolo scrisse la lettera che porta il nome di Filemone; e la Chiesa li incorona insieme perché insieme vissero, servirono e morirono.", "patron": "Si invocano per le chiese domestiche; per i mariti e le mogli che servono insieme."},
...
{"type": "Apostolo dei Settanta · I sec.", "life": "I santi apostoli Filemone e Archippo, la martire Apfia, moglie di Filemone, e sant'Onesimo, discepolo dell'apostolo Paolo, sono legati per sempre dalla più breve delle epistole di Paolo, scritta a Filemone nostro carissimo e collaboratore, alla nostra amata Apfia, ad Archippo nostro commilitone, e alla chiesa che è nella tua casa.", "patron": "Si invoca per le case della fede; per i padroni e i servi."},

"Apostles of the Seventy: Erastus, Olympas, Herodion, Sosipater, Quartus, and Tertius":
{"type": "Apostolo dei Settanta · I sec.", "life": "I santi apostoli Erasto, Olimpa, Erodione, Sosipatro, Quarto e Terzio dei Settanta furono discepoli e collaboratori del santo apostolo Paolo, che li saluta nella sua Epistola ai Romani. Erasto, che Paolo chiama tesoriere della città, servì come economo della Chiesa di Gerusalemme e poi come vescovo di Paneade in Palestina.", "patron": "Si invoca per i vescovi; per i tesorieri."},

"Appearance of Christ to Saint Martin of Tours":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa commemora l'apparizione di Cristo a san Martino di Tours, la visione che sta in capo a una delle vite più amate dell'Occidente e che predica, in un'unica scena notturna, tutto il venticinquesimo capitolo di Matteo. Martino era allora un giovane soldato della cavalleria romana nelle Gallie, e ancora catecumeno, non battezzato.", "patron": "In questo giorno si prega per i soldati; per quanti danno l'elemosina."},

"Appearance of the Icon of the Mother of God “The Footprint” at Pochaiv":
{"type": "Icona della Madre di Dio · XIV sec.", "life": "In questo giorno la Chiesa commemora l'apparizione della Santissima Madre di Dio sul monte di Pochaiv, il prodigio che fondò la grande Lavra della Volinia e lasciò nella roccia viva l'impronta del suo piede che i fedeli chiamano semplicemente l'Orma.", "patron": "L'impronta lasciata nella roccia."},

"Arrival of the Ivḗron Icon of the Mother of God in Georgia":
{"type": "Icona della Madre di Dio", "life": "In questo giorno la Chiesa di Georgia commemora l'arrivo dell'icona di Iviron della Santissima Madre di Dio in Georgia. Il ventisei settembre dell'anno 1989 una copia esatta della celebre e taumaturga Portaitissa, la Custode della Porta del monastero di Iviron sul Monte Athos, giunse a Tbilisi dalla Santa Montagna, dipinta dai monaci athoniti con la benedizione del catholicos patriarca Ilia secondo in segno di amore e di gratitudine verso il popolo georgiano, i cui padri avevano fondato anticamente il monastero di Iviron.", "patron": "In questo giorno si prega per la protezione della Georgia; per la consolazione nei tempi duri."},

"Beginning of Great Lent":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa entra nella Grande Quaresima, la santa Quarantena, la più antica e la più grande delle sue stagioni di penitenza, custodita fin dalle prime generazioni come la decima dell'anno offerta a Dio e come il cammino comune di tutti i fedeli verso la Pasqua. Le sue radici affondano nelle origini: il Signore stesso digiunò quaranta giorni nel deserto prima della sua predicazione, come Mosè digiunò prima della Legge ed Elia prima della voce di un sottile silenzio, e la Chiesa, apostolica nei suoi istinti, raccolse in una sola primavera dell'anima l'ultima preparazione dei catecumeni al battesimo pasquale e la penitenza di tutto il popolo, ordinata dalle grandi sedi e soprattutto da Gerusalemme con le sue catechesi nei luoghi santi, nella stagione che i fedeli oggi ricevono.", "patron": "In questo giorno si prega per tutti i fedeli; per i catecumeni che si preparano al battesimo."},

"Beheading of Venerable Cornelius, Abbot of the Pskov Caves":
{"type": "Martire e igumeno · XVI sec.", "life": "Lo ieromartire Cornelio, abate delle Grotte di Pskov, nacque a Pskov nel 1501 dal nobile Stefano e da Maria, e fu formato nel monastero di Mirož in tutta la cultura del monachesimo settentrionale, facendo candele, spaccando legna, trascrivendo e ornando libri e dipingendo icone; e quando il funzionario Misjur Munechin condusse il giovane al povero monasterino delle Grotte tra i boschi, la bellezza del luogo e la solennità della chiesa nella grotta decisero della sua vita, perché Cornelio vi ricevette la tonsura e non se ne allontanò più.", "patron": "Si invoca per gli igumeni; per i cronisti."},

"Blessed Andrew of Totma the Fool-For-Christ":
{"type": "Folle per Cristo · XVII sec.", "life": "Il beato Andrea di Tot'ma, folle per Cristo, nacque nel 1638 nel villaggio di Ust-Tot'ma, nelle terre di Vologda, e ancora fanciullo decise di lasciare il mondo. Con la benedizione di Stefano, abate del monastero della Resurrezione a Galič, prese su di sé la dura vocazione della follia per Cristo e si stabilì presso la chiesa della Resurrezione nella città di Tot'ma, sul fiume Suchona.", "patron": "Si invoca per la povertà volontaria; per l'elemosina nascosta."},

"Blessed Andrew the Fool-For-Christ at Constantinople":
{"type": "Folle per Cristo · X sec.", "life": "Il beato Andrea, folle per Cristo, era slavo di nascita, condotto schiavo in giovinezza a Costantinopoli, dove servì un dignitario della città ed era amato per la sua mitezza e per la sua assiduità nelle Scritture. Avendo contemplato in sogno gli eserciti degli angeli e dei demoni in lotta, e avendo udito il Signore chiamarlo al combattimento, prese su di sé, con la libertà che il suo padrone alla fine gli concesse, la più dura delle vie ascetiche, simulando la pazzia per amore di Cristo.", "patron": "Si invoca per i servi nascosti di Dio; per le visioni delle cose celesti."},

"Blessed Cleopatra with her son John, in Egypt":
{"type": "Beata · IV sec.", "life": "La beata Cleopatra era una pia vedova della Palestina che viveva in Egitto ai giorni della persecuzione; e avendo veduto il combattimento del santo martire Varo, ne ottenne di nascosto il corpo e lo portò nel suo villaggio natale di Edra, presso il monte Tabor, dove lo seppellì con onore e sopra di esso edificò una chiesa in nome del martire, mentre tutta la sua casa lo venerava come protettore.", "patron": "Si invoca per le madri; per le madri nel lutto."},

"Blessed Constantine, Metropolitan of Kyiv":
{"type": "Metropolita · XII sec.", "life": "Il beato Costantino, metropolita di Kyiv, resse la Chiesa russa alla metà del secolo dodicesimo, in un tempo di gravi contese intorno alla sede metropolitana, ed è ricordato soprattutto per la stupefacente umiltà con cui cercò, anche nella morte, l'ultimo posto.", "patron": "I gerarchi che cercano l'ultimo posto; gli umili nelle alte cariche."},

"Blessed Dovmont (Timothy), Prince of Pskov":
{"type": "Fedele · XIII sec.", "life": "Il pio principe Dovmont di Pskov, chiamato Timoteo dal suo battesimo, fu un principe lituano e un pagano che divenne uno dei sovrani più amati e il protettore celeste di una città russa, e la sua vita è una parabola dello zelo del convertito riversato nella difesa del popolo che lo aveva accolto.", "patron": "Il principe pagano fatto campione cristiano."},

"Blessed John “the Hairy” and Fool-For-Christ at Rostov":
{"type": "Folle per Cristo · XVI sec.", "life": "Il beato Giovanni, chiamato il Misericordioso e anche il Peloso, prese su di sé a Rostov la dura e nascosta impresa della follia per Cristo, sopportando il freddo, la fame e l'obbrobrio per amore di Dio. Non aveva casa propria, ma trovava riparo ora nella dimora del suo padre spirituale, sacerdote della chiesa di Tutti i Santi, ora presso l'una o l'altra delle povere vedove della città.", "patron": "Si invoca per l'umiltà; per quanti non hanno una casa."},

"Blessed Laurence the Fool-For-Christ at Kaluga":
{"type": "Folle per Cristo · XVI sec.", "life": "Il beato Lorenzo, folle per Cristo e taumaturgo di Kaluga, visse al principio del secolo sedicesimo presso l'antica città di Kaluga, vicino a una chiesa della Natività di Cristo posta su un'alta collina boscosa, alla quale dalla sua abitazione conduceva un lungo passaggio sotterraneo, perché potesse assistere agli uffici.", "patron": "Si invoca per la difesa di Kaluga."},

"Blessed Nicholas (Salos) of Pskov the Fool-For-Christ":
{"type": "Folle per Cristo · XVI sec.", "life": "Il beato Nicola Salos di Pskov, che la città chiamava Mikula il Folle, portò l'impresa della follia per Cristo per più di trent'anni, dormendo sotto i portici, sopportando in stracci il gelo e lo scherno, parlando per enigmi che si avveravano, e acquistando, molto prima della sua morte, la grazia di operare prodigi e di profetare, il pazzo della città divenuto in silenzio il suo oracolo più sicuro.", "patron": "Si invoca per i folli per Cristo; per quanti dicono la verità davanti al potere."},

"Blessed Nicholas Kochanov the Fool-For-Christ at Novgorod":
{"type": "Folle per Cristo · XIV sec.", "life": "Il beato Nicola Kochanov, folle per Cristo di Novgorod, nacque da una famiglia ricca e nobile e fin dalla giovinezza amò la chiesa, il digiuno e la preghiera. Quando la gente cominciò a lodarlo per la sua virtù, egli fuggì quella stima prendendo la via difficile della follia per Cristo, nascondendo la propria santità sotto l'apparenza della pazzia.", "patron": "Si invoca per la riconciliazione; per la pace in mezzo alla discordia."},

"Blessed Prince Gleb Andreevich, son of Saint Andrew Bogoliubsky":
{"type": "Principe · XII sec.", "life": "Il pio principe Gleb Andreevich fu un giovane principe di Vladimir, figlio del santo principe Andrea Bogoljubsky, che visse una breve vita di rara pietà e fu glorificato da Dio con l'incorruzione.", "patron": "I giovani principi della pietà; quanti amano le Scritture e la Chiesa."},

"Blessed Yaropolk (in Baptism Peter), Prince of Volodymyr-Volhynia":
{"type": "Principe · XI sec.", "life": "Il santo principe Iaropolk di Volodymyr-Volinia, chiamato Pietro nel santo battesimo, fu figlio del gran principe Izjaslav di Kyiv e nipote di Jaroslav il Saggio; e la sua breve vita fu una scuola di spogliamento, perché condivise i ripetuti esili del padre tra i polacchi e i tedeschi, quando le contese dei principi li cacciavano dalla Rus, e imparò presto che i troni sono prestati e non donati.", "patron": "Si invoca per i sovrani; per i principi che subiscono il torto senza vendetta."},

"Childmartyr Gabriel of Bialystok":
{"type": "Fanciullo martire · XVII sec.", "life": "Il santo fanciullo martire Gabriele di Białystok nacque nel 1684 nel villaggio di Zverki presso Białystok, figlio di pii contadini ortodossi, Pietro e Anastasia, e visse i sei brevi anni che gli furono dati nella santità ordinaria di un'infanzia contadina amata, le preghiere imparate sulle ginocchia della madre, le feste della chiesa, i campi.", "patron": "Si invoca per i bambini; per gli innocenti e gli indifesi."},

"Church New Year":
{"type": "Festa", "life": "Il primo giorno di settembre la Chiesa celebra l'inizio dell'indizione, cioè il capodanno ecclesiastico. I padri del primo concilio ecumenico di Nicea stabilirono che l'anno della Chiesa cominciasse in questo giorno, seguendo l'antico computo per cui settembre, il mese in cui si raccolgono i frutti, era il principio dell'anno presso gli Ebrei, che in questa stagione offrivano a Dio il loro rendimento di grazie per la sua abbondanza.", "patron": "In questo giorno si prega per il nuovo anno; per il rendimento di grazie."},

"Commemoration of the Apparition of the Sign of the Precious Cross Over Jerusalem, in 351 AD":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa commemora l'apparizione del segno della preziosa Croce nel cielo sopra Gerusalemme, nell'anno 351, sotto l'imperatore Costanzo, figlio di Costantino il Grande: il sette maggio, il martedì che precede la festa dell'Ascensione, verso l'ora terza del giorno, la venerabile e vivificante Croce apparve sopra la città santa a tutto il suo popolo, formata di luce, distesa dal Golgota al monte degli Ulivi, le due estremità del segno posate sul luogo della Crocifissione e sul luogo dell'Ascensione, e il suo splendore, attestarono i testimoni, superava i raggi stessi del sole, il cielo di mezzogiorno vinto in luce dallo strumento della Passione.", "patron": "La Croce scritta attraverso il cielo."},

"Commemoration of the Founding of Constantinople":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa commemora la fondazione e la dedicazione di Costantinopoli, avvenuta lunedì undici maggio dell'anno 330, nella terza indizione; poiché il grande e cristiano imperatore Costantino, avendo scelto l'antica città di Bisanzio sul Bosforo e avendola grandemente ampliata e riedificata, ne mutò il nome e vi impose il proprio, chiamandola Costantinopoli, la città di Costantino, e fu soprannominata la Nuova Roma, perché a essa fu trasferita dall'antica Roma la sede imperiale, e la capitale del mondo si spostò a oriente in una città fondata fin dalla sua prima pietra sotto il segno della Croce.", "patron": "La Nuova Roma fondata sotto la Croce."},

"Commemoration of the Founding of the Church of the Resurrection (Holy Sepulchre) at Jerusalem":
{"type": "Festa", "life": "In questo giorno la Chiesa commemora la fondazione, cioè la solenne consacrazione, della chiesa della Resurrezione di Cristo a Gerusalemme, innalzata dal santo imperatore Costantino il Grande e da sua madre la santa imperatrice Elena sopra il Sepolcro del Signore e la collina del Golgota. Quando Elena fu giunta a Gerusalemme, ebbe distrutto i santuari pagani che profanavano i luoghi santi ed ebbe trovato la Croce vivificante sotto il tempio di Venere, Costantino comandò che si edificasse una chiesa grande e splendida che racchiudesse insieme il luogo della Crocifissione e il Sepolcro della Resurrezione.", "patron": "In questo giorno si prega per la consacrazione delle chiese."},

"Commemoration of the Great Earthquake at Constantinople":
{"type": "Festa", "life": "In questo giorno la Chiesa commemora il grande terremoto che colpì Costantinopoli nell'anno 740, sotto il regno di Leone Isaurico, quando l'ira di Dio scosse la città imperiale, abbattendo chiese, case e lunghi tratti delle mura con le loro torri e facendo perire molta gente, mentre le scosse continuarono per mesi, sicché gli abitanti dimorarono nel timore sotto il cielo aperto.", "patron": "In questo giorno si prega per la liberazione dai terremoti; per la penitenza davanti ai giudizi di Dio."},

"Commemoration of the Holy Fathers of the First Ecumenical Council":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa fa memoria dei santi padri del primo concilio ecumenico, i trecentodiciotto vescovi teofori che si radunarono a Nicea di Bitinia nell'anno 325 per difendere la divinità del Figlio di Dio e confessare la vera fede contro la prima grande eresia.", "patron": "I difensori della divinità del Figlio; i padri dei concili."},

"Commemoration of the Holy Fathers of the Second Ecumenical Council":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa fa memoria dei santi padri del secondo concilio ecumenico, i centocinquanta che si radunarono a Costantinopoli nell'anno 381, sotto l'imperatore Teodosio il Grande, per compiere l'opera di Nicea e difendere l'ultimo articolo della fede che gli eretici di quella generazione avevano assalito, la vera divinità dello Spirito Santo.", "patron": "Il Credo compiuto con l'articolo sullo Spirito."},

"Commemoration of the Holy Fathers of the Seventh Ecumenical Council":
{"type": "Festa", "life": "In questo giorno la Chiesa fa memoria dei santi padri del settimo concilio ecumenico, che si radunò a Nicea nell'anno 787, ai giorni dell'imperatrice Irene e di suo figlio Costantino, sotto la presidenza di san Tarasio, patriarca di Costantinopoli. Circa trecentocinquanta padri si riunirono contro l'eresia degli iconoclasti, che per decenni aveva devastato la Chiesa, distruggendo le sante immagini e perseguitando quanti le veneravano.", "patron": "In questo giorno si prega per la venerazione delle sante icone; per la pienezza dell'insegnamento ortodosso."},

"Commemoration of the Holy Righteous David the King, Joseph the Betrothed, and James the Brother of the Lord":
{"type": "Giusto · I sec.", "life": "Nei giorni dopo la Natività la Chiesa fa memoria insieme dei santi giusti Giuseppe il promesso sposo, Davide il re e Giacomo fratello del Signore, sinassi dei parenti del Signore secondo la carne, fissata anticamente per la domenica dopo la festa e celebrata anche in questo giorno.", "patron": "Si invoca per le famiglie dei servi del Signore; per la parentela con Cristo per obbedienza."},

"Commemoration of the Kazan Icon of the Mother of God and the deliverance from the Poles":
{"type": "Icona della Madre di Dio", "life": "In questo giorno la Chiesa fa memoria dell'icona di Kazan della Santissima Theotokos, in ricordo della liberazione di Mosca e di tutta la Russia dai Polacchi nell'anno 1612. Nel tempo dei torbidi, quando la terra era lacerata dall'invasione e dal tradimento e Mosca stessa era tenuta da armi straniere che schernivano la fede ortodossa, il patriarca Ermogene, chiuso in prigione, chiamò il popolo a levarsi in difesa della Chiesa e della patria.", "patron": "In questo giorno si prega per la liberazione delle nazioni; per la protezione nel tempo dei torbidi."},

"Commemoration of the Miracle of the Archangel Michael at Colossae":
{"type": "Festa", "life": "In questo giorno la Chiesa fa memoria del glorioso miracolo operato dall'arcangelo Michele a Chonae, presso Colossi di Frigia. In quel luogo vi era una sorgente taumaturga, predetta dall'apostolo Giovanni il Teologo quando predicava a Ierapoli; e un uomo di Laodicea, la cui figlia muta ricevette la parola dalle acque di quella sorgente dopo che l'arcangelo gli era apparso in sogno, fu battezzato con tutta la sua casa ed edificò sopra la fonte una chiesa in onore del capo delle schiere celesti Michele.", "patron": "In questo giorno si prega per la protezione; per la guarigione."},

"Commemoration of the Shepherds in Bethlehem who were watching their flocks, and went to see the Lord":
{"type": "Giusto · I sec.", "life": "Nel primo giorno della Natività la Chiesa fa memoria dei pastori di Betlemme, i quali vegliavano di notte sui loro greggi nei campi quando la gloria del Signore li avvolse di luce, ed essi divennero i primi del genere umano a udire l'annuncio del Vangelo.", "patron": "Si invoca per i pastori; per le guardie notturne."},

"Commemoration of the Vladimir Icon of the Mother of God and the deliverance of Moscow from the Invasion of Tamerlane":
{"type": "Icona della Madre di Dio · XIV sec.", "life": "L'icona di Vladimir della Santissima Theotokos, secondo la tradizione dipinta dall'evangelista Luca e portata da Costantinopoli nella Rus', fu posta dal santo principe Andrea Bogoljubskij nella cattedrale di Vladimir, dalla quale prese il nome, e divenne l'icona più amata e più protettrice della terra russa.", "patron": "In questo giorno si prega per la protezione della Russia; per la liberazione dall'invasione."},

"Conception of the Honorable Glorious Prophet, Forerunner and Baptist John":
{"type": "Festa · I sec.", "life": "In questo giorno la Chiesa celebra il concepimento dell'onorevole e glorioso profeta, precursore e battista Giovanni, principio della storia evangelica. Quando il sacerdote Zaccaria, nel turno della sua classe, entrò nel tempio del Signore per offrire l'incenso, l'arcangelo Gabriele gli apparve alla destra dell'altare dei profumi e gli annunciò che la sua preghiera era stata esaudita, e che sua moglie Elisabetta, sterile e avanzata negli anni, gli avrebbe partorito un figlio che sarebbe stato chiamato Giovanni, il quale sarebbe stato grande davanti al Signore, ripieno di Spirito Santo fin dal seno di sua madre, e sarebbe andato innanzi al Messia con lo spirito e la potenza di Elia, per preparare al Signore un popolo ben disposto.", "patron": "In questo giorno si prega per le coppie senza figli; per la preghiera esaudita."},

"Conception of the Most Holy Theotokos by Saint Anna":
{"type": "Festa", "life": "Questa festa celebra il concepimento della Vergine Maria da parte di sua madre, la giusta Anna, nove mesi prima della festa della natività di Maria, l'otto di settembre. Secondo la tradizione della Chiesa, Gioacchino e Anna erano giusti, ma senza figli e avanzati negli anni, e la loro mancanza di figli era tenuta per obbrobrio.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Confessors Barses and Eulogius, Bishops of Edessa, and Protogenes, Bishop of Carrhae":
{"type": "Vescovo · IV sec.", "life": "I santi confessori Barses ed Eulogio, vescovi di Edessa, e Protogene, vescovo di Carre, patirono dagli ariani nella seconda metà del quarto secolo, quando l'imperatore Valente cercava di diffondere quell'eresia e tormentava crudelmente gli ortodossi. Il santo confessore Barses, saldo campione della vera fede, fu cacciato dal suo trono di Edessa e mandato in esilio, prima in un luogo e poi in un altro, sempre più lontano dalla sua città.", "patron": "Si invoca per l'Ortodossia contro l'eresia; per la costanza nell'esilio."},

"Consecration of the Church of the Holy Great Martyr George in Lydda":
{"type": "Festa", "life": "In questo giorno la Chiesa fa memoria della consacrazione della chiesa del santo grande martire Giorgio a Lydda di Palestina e della deposizione ivi delle sue preziose reliquie. Il grande martire, che patì a Nicomedia nell'anno 303 sotto Diocleziano, aveva chiesto al suo servo, prima del suo combattimento, di portare il suo corpo a Lydda, patria della famiglia di sua madre in Terra Santa.", "patron": "In questo giorno si prega per la venerazione del grande martire Giorgio."},

"Constantinople Icon of the Mother of God":
{"type": "Icona della Madre di Dio · I sec.", "life": "In questo giorno la Chiesa fa memoria dell'icona di Costantinopoli della Santissima Theotokos, immagine che la tradizione annovera fra quelle dipinte dal santo apostolo ed evangelista Luca in persona, medico e iconografo della Madre di Dio, il cui pennello, come la Chiesa ritiene, diede per primo ai fedeli la sua effigie e ricevette sopra quell'opera la benedizione di lei, la sua parola che la sua grazia sarebbe stata con le immagini.", "patron": "In questo giorno si prega per gli iconografi; per quanti onorano le icone della Theotokos."},

"Dedication of the Church of the Greatmartyr George at Kyiv":
{"type": "Festa", "life": "In questo giorno la Chiesa fa memoria della consacrazione della chiesa del santo grande martire Giorgio a Kyiv. Era pia consuetudine dei principi della Rus', a cominciare dal santo principe Vladimiro, innalzare chiese in onore dei loro santi patroni: Vladimiro, chiamato Basilio nel battesimo, edificò templi di san Basilio a Kyiv e a Vyšgorod, e i suoi figli lo seguirono in questo.", "patron": "In questo giorno si prega per la venerazione del grande martire Giorgio nella Rus'; per le chiese edificate in rendimento di grazie."},

"Dormition of the Righteous Anna, the Mother of the Most Holy Theotokos":
{"type": "Giusto · I sec.", "life": "Questa festa fa memoria della pacifica dormizione della giusta Anna, madre della Santissima Theotokos e ava del Signore nostro secondo la carne. Anna era figlia del sacerdote Mattan, della tribù di Levi e della stirpe di Aronne, e insieme al suo sposo, il giusto Gioacchino, portò per lunghi anni l'obbrobrio della mancanza di figli, finché nella loro vecchiaia Dio esaudì le loro preghiere e concesse loro una figlia, la pura Vergine Maria, che doveva divenire la Madre di Dio.", "patron": "Si invoca per le madri; per le nonne."},

"Entrance of the Apostle Andrew into Georgia":
{"type": "Festa", "life": "In questo giorno la Chiesa di Georgia fa memoria dell'ingresso del santo apostolo Andrea il primo chiamato nelle terre georgiane, fondamento apostolico sopra il quale quella Chiesa antica si regge. La tradizione della Georgia racconta che, quando gli apostoli tirarono a sorte le nazioni, l'Iberia toccò alla Santissima Theotokos stessa.", "patron": "In questo giorno si prega per il fondamento apostolico della Chiesa georgiana; per la Theotokos protettrice della Georgia."},

"Equal of the Apostles and Emperor Constantine with his Mother Helen":
{"type": "Pari agli apostoli · IV sec.", "life": "Il santo e grande imperatore Costantino, pari agli apostoli, con sua madre l'imperatrice Elena, stanno fra le figure più decisive nella storia della Chiesa, poiché per mezzo loro la fede perseguitata delle catacombe divenne la libera e pubblica confessione dell'impero. Costantino era figlio di Costanzo Cloro, cesare delle province occidentali, e nacque intorno all'anno 280 a Naisso; proclamato successore del padre nel 306, mosse nel 312 contro il tiranno Massenzio, e durante la marcia, in un pomeriggio, vide nel cielo sopra il sole una croce di luce risplendente con le parole: Con questo segno vincerai; e, armati i suoi soldati del sacro segno, sconfisse Massenzio al ponte Milvio ed entrò trionfante in Roma. Signore allora dell'Occidente, mentre Licinio teneva l'Oriente, promulgò nel 313 insieme a Licinio l'editto di Milano, che dava a tutti gli uomini libertà di adorare Dio come volessero e restituiva ai cristiani le loro chiese e i loro diritti, ponendo fine d'un colpo all'età delle persecuzioni; e quando Licinio ruppe la pace e perseguitò di nuovo, Costantino lo sconfisse e lo rimosse, e divenne, entro il 324, solo imperatore d'Oriente e d'Occidente, e ogni persecuzione cessò e il cristianesimo trionfò. Egli pose le fondamenta di Costantinopoli, la nuova Roma consacrata come città cristiana; e, desiderando l'unità della fede che aveva liberato, quando l'eresia di Ario lacerò la Chiesa convocò nel 325 a Nicea il primo concilio ecumenico, dove i padri confessarono il Figlio consostanziale al Padre e anatematizzarono la bestemmia, mentre l'imperatore onorava i vescovi, molti dei quali confessori segnati dalle ferite, e serviva la pace della Chiesa come suo protettore."},

"Equal-to-the-Apostles Blessed Great Princess Olga (in Holy Baptism Helen)":
{"type": "Pari agli apostoli · X sec.", "life": "La santa pari agli apostoli Olga, gran principessa di Kyiv, fu moglie del gran principe Igor, e dopo la morte di lui governò la terra della Rus' con fermezza e sapienza come reggente per il piccolo figlio Svjatoslav. Benché cresciuta nel paganesimo, giunse a desiderare la vera fede, e recatasi a Costantinopoli fu battezzata dal patriarca, prendendo il nome di Elena, mentre l'imperatore stesso le stava padrino. Tornata a Kyiv illuminata da Cristo, si adoperò per condurre il suo popolo alla fede, edificando chiese e confessando il Vangelo, benché suo figlio rimanesse pagano; eppure il seme che ella piantò portò il suo frutto nel nipote, il santo principe Vladimiro, sotto il quale tutta la Rus' fu battezzata. Per questo è onorata come la prima della sua nazione a entrare nel regno di Dio, e come l'aurora che precede il sorgere del sole della Rus'."},

"Equals of the Apostles and Teachers of the Slavs, Cyril and Methodius":
{"type": "Apostolo · IX sec.", "life": "I santi pari agli apostoli Cirillo e Metodio, maestri degli Slavi, erano fratelli di una famiglia senatoria di Tessalonica, la città ai margini del mondo slavo, le cui strade avevano insegnato loro fin dall'infanzia la lingua slava, provvidenza per l'opera che li attendeva.", "patron": "L'alfabeto donato agli slavi."},

"Eve of the Nativity of our Lord":
{"type": "Festa", "life": "La vigilia della Natività del nostro Signore, chiamata Paramonì, è la soglia della festa, e la Chiesa la custodisce come custodisce la sola vigilia della Teofania, con un giorno di digiuno stretto e con la più solenne preparazione del suo anno. Al mattino si cantano le ore regali, dette così perché un tempo vi assistevano gli imperatori: a ogni ora si leggono i salmi dell'Incarnazione, le profezie, l'Apostolo e il Vangelo della nascita, tutta la Scrittura raccolta intorno alla grotta.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Fathers of the First Six Councils":
{"type": "Vescovi", "life": "In questo giorno la Chiesa commemora i santi padri dei primi sei concili ecumenici, i gerarchi teofori e i maestri raccolti da ogni parte del mondo cristiano a difendere la fede apostolica contro le eresie che l'assalivano. A Nicea e al primo concilio di Costantinopoli proclamarono la divinità del Figlio e dello Spirito Santo e diedero alla Chiesa il Simbolo della fede che confessiamo fino a oggi.", "patron": "Si invocano per la dottrina ortodossa; per la vera fede."},

"Finding of the Relics of Saints Basil and Constantine, Princes of Yaroslavl":
{"type": "Festa · XVI sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie dei santi principi fedeli Basilio e Costantino di Jaroslavl', fratelli che governarono la loro città e per essa patirono negli anni amari del giogo tataro, e i cui corpi incorrotti furono rivelati molto tempo dopo in un incendio.", "patron": "I principi di Jaroslavl'; quanti hanno le reliquie ritrovate dopo un incendio."},

"Finding of the relics of Monastic Martyr Adrian of Poshekhonsk, Yaroslavl":
{"type": "Igumeno · XVI sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie del monaco martire Adriano di Pošechonje, avvenuto il diciannove novembre 1625. Sant'Adriano, monaco e iconografo di grande dono, formato nella tradizione dei grandi monasteri del nord, aveva fondato con un compagno di ascesi un monastero della Dormizione della santissima Theotokos nelle foreste di Pošechonje, nelle terre di Jaroslavl', e là faticava nel digiuno, nella preghiera e nella pittura delle sante icone, raccogliendo una fraternità intorno alla chiesa del deserto.", "patron": "Si invoca per gli iconografi; per i monaci."},

"Finding of the relics of Righteous Saint Νikόdēmos":
{"type": "Giusto · I sec.", "life": "San Nicodemo era fariseo e capo dei giudei, e venne al Signore Gesù di notte, come racconta il Vangelo di Giovanni, e udì da lui della nuova nascita per mezzo dell'acqua e dello Spirito. Benché dapprima fosse venuto di nascosto per timore dei giudei, difese il Salvatore davanti al sinedrio, e dopo la crocifissione venne apertamente con Giuseppe d'Arimatea, portando una mistura di mirra e di aloe, e aiutò a ungere e a seppellire il corpo del Signore.", "patron": "Si invoca per i discepoli segreti; per i cercatori della verità."},

"Finding of the relics of Saint Abibas":
{"type": "Giusto · I sec.", "life": "Sant'Abiba era figlio del giusto Gamaliele, il maestro di san Paolo, e insieme al padre ricevette il santo battesimo dalle mani degli apostoli, abbracciando la fede di Cristo. Vivendo nella purezza, si addormentò ancora giovane e fu sepolto dal padre nella grotta di Caphargamala, dove già riposavano il protomartire Stefano e san Nicodemo.", "patron": "Si invoca per la purezza."},

"Finding of the relics of Saint Basil, Bishop of Ryazan":
{"type": "Festa · XVII sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie di san Basilio, vescovo di Rjazan', gerarca del tredicesimo secolo la cui innocenza fu riconosciuta da un prodigio celebre e le cui reliquie furono rivelate negli anni torbidi del diciassettesimo.", "patron": "I falsamente accusati; i vescovi cacciati dalla calunnia."},

"Finding of the relics of Saint Gamaliel":
{"type": "Giusto · I sec.", "life": "San Gamaliele era fariseo e dottore rinomato della Legge, onorato fra i giudei, che consigliò moderazione verso gli apostoli quando furono condotti davanti al sinedrio, come raccontano gli Atti degli apostoli, e che era stato il maestro di san Paolo. Divenne in segreto discepolo di Cristo, e quando il protomartire Stefano fu lapidato e lasciato insepolto, fu Gamaliele a raccoglierne con riverenza il corpo e a deporlo in una grotta della propria terra a Caphargamala.", "patron": "Si invoca per i maestri; per i discepoli segreti."},

"Finding of the relics of Saint Theodore, Prince of Smolensk and Yaroslavl, and his children":
{"type": "Principe · XIII sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie del principe fedele Teodoro di Smolensk e Jaroslavl', detto il Nero, insieme ai figli Davide e Costantino, avvenuto a Jaroslavl' il cinque marzo 1463; la dormizione del principe si celebra in settembre, ma questo giorno appartiene al ritrovamento del suo corpo incorrotto.", "patron": "Si invoca per i sovrani; per le famiglie."},

"Finding of the relics of Venerable Cyril, Abbot of Novoezersk, Vologda":
{"type": "Igumeno · XVI sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie di san Cirillo, igumeno di Novoezersk, avvenuto nell'anno 1649. Nato da nobile famiglia di Galič, fuggì dalla casa dei genitori a quindici anni, attirato dall'amore di Cristo, e giunse attraverso le foreste al grande anziano Cornelio di Komel, il quale, discernendo sul giovane il sigillo di Dio, lo tonsurò.", "patron": "Si invoca per i monaci; per la consacrazione giovanile."},

"Finding of the relics of Venerable Maximus the Greek (July 4, 1996)":
{"type": "Monaco · XVI sec.", "life": "Questa festa commemora il rinvenimento delle reliquie di san Massimo il Greco, monaco dotto e confessore. Nato Michele Trivolis ad Arta in Grecia verso il 1470, studiò in Italia, si fece poi monaco sul monte Athos e nel 1518 fu inviato in Russia a tradurre e correggere i libri sacri.", "patron": "Si invoca per i traduttori e i dotti; per gli ingiustamente incarcerati."},

"First Translation of the relics of Saint Herman, Archbishop of Kazan":
{"type": "Arcivescovo · XVI sec.", "life": "San Germano, arcivescovo di Kazan, nacque a Starica dalla nobile famiglia Sadyrev-Polev, e ricevuta la tonsura al monastero di Volokolamsk fu formato alla scuola di san Giuseppe, distinguendosi per il sapere, la vita ascetica e la fatica di copiare libri. Quando le terre di Kazan appena conquistate furono aperte al Vangelo, fu inviato con san Gurij alla loro illuminazione, e fondò a Sviažsk il monastero della Dormizione della Madre di Dio, che divenne il centro della missione verso i popoli del Volga.", "patron": "Si invoca per i missionari; per l'illuminazione delle terre di Kazan."},

"First and second finding of the Honorable Head of the Holy Glorious Prophet, Forerunner, and Baptist of the Lord, John":
{"type": "Festa · V sec.", "life": "In questo giorno la Chiesa celebra il primo e il secondo ritrovamento del venerabile capo di san Giovanni Precursore, i due capitoli più antichi dello strano itinerario della reliquia più venerata della cristianità dopo gli strumenti della Passione. Quando Erodiade ebbe ottenuto il capo del Battista sul vassoio della sua vendetta, non volle che fosse sepolto con il corpo, temendo, dice la tradizione, la risurrezione dell'uomo che aveva fatto tacere, e lo nascose in un luogo immondo del palazzo di Erode.", "patron": "In questo giorno si prega per quanti cercano ciò che è nascosto; per i custodi delle reliquie."},

"First finding of the relics of Saint Metrophanes, first Bishop of Voronezh":
{"type": "Vescovo · XVIII sec.", "life": "San Metrofane fu il primo vescovo di Voronež, consacrato nel 1682, e fu rinomato per la sua profonda pietà, la sua cura dei poveri e il suo zelo per la Chiesa; consigliere e sostegno dell'imperatore Pietro il Grande nella costruzione della flotta russa a Voronež, non temette di rimproverare il sovrano quando furono innalzate statue pagane, e fu ascoltato.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Forefeast of the Annunciation":
{"type": "Prefesta · I sec.", "life": "In questo giorno la Chiesa celebra la preferia dell'Annunciazione, l'unico giorno di preparazione prima della festa che i padri chiamarono il compimento della nostra salvezza e il principio di tutte le feste, e gli inni del giorno stanno in punta di piedi: oggi, cantano, il grande mistero si avvicina, l'arcangelo sta per essere inviato, la Vergine è alle sue preghiere, e la gioia di tutta la creazione dista una sera soltanto.", "patron": "In questo giorno si prega per quanti si preparano a una grande gioia; per la vigilia del grande lieto annuncio."},

"Forefeast of the Dormition of the Mother of God":
{"type": "Prefesta", "life": "Questo giorno è la preferia della Dormizione della nostra santissima Signora la Theotokos, nel quale la Chiesa comincia a celebrare il suo beato addormentarsi, che si osserva il quindici agosto al termine del digiuno a lei dedicato. Gli inni della preferia chiamano i fedeli a raccogliersi nella letizia, poiché la Madre di Dio sta per partire dalla terra verso il regno celeste, per essere accolta nella gloria dal Figlio suo.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Forefeast of the Elevation of the Cross":
{"type": "Prefesta", "life": "Questa è la preferia dell'universale esaltazione della preziosa e vivificante Croce, nella quale la Chiesa comincia a celebrare la grande festa dell'indomani. Negli uffici cominciano a risuonare gli inni della Croce, che chiamano i fedeli a purificare le loro anime per poter contemplare il santo Legno innalzato in mezzo alla terra.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Forefeast of the Entry into the Temple of the Most Holy Theotokos":
{"type": "Prefesta", "life": "In questo giorno la Chiesa celebra la preferia dell'Ingresso della santissima Theotokos nel Tempio, e sta sulla soglia della festa come la fanciulla Maria stette sulla soglia del santuario. Gli inni della preferia chiamano i fedeli a prepararsi: Rallegriamoci oggi, o fedeli, cantando salmi al Signore, e onoriamo il suo tabernacolo santificato, l'arca vivente che contenne il Verbo che non può essere contenuto.", "patron": "In questo giorno si prega per la preparazione alle feste della Madre di Dio."},

"Forefeast of the Meeting of our Lord in the Temple":
{"type": "Prefesta", "life": "La preferia dell'Incontro del Signore nel Tempio si celebra il primo di febbraio, unico giorno di preparazione prima della festa che chiude tutto il ciclo della Natività del Signore; e in essa la Chiesa volge gli occhi al Tempio di Gerusalemme, dove domani il Legislatore sarà portato dentro come un bambino di quaranta giorni per adempiere la sua stessa Legge.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Forefeast of the Nativity of our Lord":
{"type": "Prefesta", "life": "La preferia della Natività del Signore abbraccia i giorni dal venti dicembre alla vigilia della festa, e in essi la Chiesa, come Betlemme negli inni, si prepara. Gli uffici si volgono interamente verso la grotta: alle stichire di ogni giorno risuona l'invito, Betlemme, prepàrati.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Forefeast of the Nativity of the Mother of God":
{"type": "Prefesta", "life": "Questa è la preferia della Natività della santissima Theotokos, nella quale la Chiesa comincia a celebrare la prima delle grandi feste del nuovo anno ecclesiastico, la nascita della Madre di Dio dai giusti Gioacchino e Anna. In questo giorno gli inni della festa che viene cominciano a risuonare negli uffici, chiamando i fedeli a preparare il cuore per accogliere la Vergine la cui nascita annunciò al mondo l'avvicinarsi della sua salvezza.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Forefeast of the Procession of the Honorable and Lifegiving Cross of the Lord":
{"type": "Prefesta", "life": "Questo giorno è la preferia della processione della preziosa e vivificante Croce del Signore, che la Chiesa celebra il primo di agosto. Nella città imperiale di Costantinopoli era usanza, durante il mese di agosto quando le malattie erano più diffuse, portare fuori il venerabile Legno della Croce dal tesoro degli imperatori e deporlo sul santo altare della Grande Chiesa, e poi portarlo in solenne processione per le strade e i quartieri della città a santificazione del popolo e a sua liberazione dalle malattie.", "patron": "In questo giorno si prega per la liberazione dalla malattia; per la santificazione."},

"Forefeast of the Transfiguration of our Lord":
{"type": "Prefesta", "life": "Questo giorno è la preferia della Trasfigurazione del Signore, Dio e Salvatore nostro Gesù Cristo, che la Chiesa celebra il sei agosto. Volendo dare ai suoi discepoli un pregustamento della gloria del Regno prima della sua Passione, il Signore prese con sé Pietro, Giacomo e Giovanni e li condusse su un alto monte, e là fu trasfigurato davanti a loro, sicché il suo volto risplendette come il sole e le sue vesti divennero bianche come la luce.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Glorification of Saint Innocent, Metropolitan of Moscow, Enlightener of the Aleuts, Apostle to the Americas":
{"type": "Metropolita · XIX sec.", "life": "In questo giorno la Chiesa commemora la glorificazione di sant'Innocenzo, metropolita di Mosca, illuminatore degli aleuti e apostolo delle Americhe, annoverato fra i santi dalla Chiesa ortodossa russa il sei ottobre 1977, su richiesta della Chiesa ortodossa in America. Nato Giovanni Popov-Veniaminov nel 1797 in un villaggio siberiano sulla Lena, si offrì volontario da giovane sacerdote coniugato per le isole Aleutine, e dal 1824 faticò a Unalaska e poi a Sitka, viaggiando in kayak e in slitta da cani fra le isole e le coste, ideando un alfabeto per la lingua aleutina, traducendo il Vangelo e componendo in aleutino la sua amata Indicazione della via nel regno dei cieli, e studiando le lingue e i costumi dei popoli che serviva.", "patron": "Si invoca per i missionari; per i traduttori."},

"Glorification of Saint John of Kronstadt":
{"type": "Festa · XX sec.", "life": "San Giovanni di Kronstadt, uno dei grandi pastori della Chiesa russa, nacque Giovanni Sergiev nel 1829 in un povero villaggio dell'estremo nord e divenne sacerdote coniugato di parrocchia alla cattedrale di Sant'Andrea a Kronstadt, presso San Pietroburgo, dove servì per oltre cinquant'anni.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Glorification of Saint Tikhon, Patriarch of Moscow and All Russia, Enlightener of North America":
{"type": "Patriarca · XX sec.", "life": "In questo giorno la Chiesa commemora la glorificazione di san Tichon, patriarca di Mosca e di tutta la Russia, annoverato fra i santi dal concilio dei vescovi della Chiesa ortodossa russa il nove ottobre 1989. Nato Vasilij Bellavin nel 1865, figlio di un sacerdote di villaggio di Toropec, era tanto amato per la sua mitezza che i compagni di seminario lo chiamavano per scherzo Patriarca, senza sapere di profetare.", "patron": "Si invoca per i gerarchi; per i missionari."},

"Glorification of Venerable Herman of Alaska, Wonderworker of All America":
{"type": "Festa · XIX sec.", "life": "Il venerabile Germano d'Alaska, il primo dei santi ortodossi dell'America del Nord, era un umile monaco del monastero di Valaam in Russia che nel 1794 si unì alla missione inviata a portare il Vangelo ai popoli indigeni dell'Alaska. Stabilitosi nell'Isola degli Abeti, che chiamava Nuova Valaam, visse da asceta e divenne padre e protettore del popolo aleuto, difendendolo dalle ingiustizie dei mercanti russi, istruendo i fanciulli e curando i malati e gli orfani, attirando molti a Cristo con la sua mitezza e il suo amore.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Glorification of the Priestmartyr Alexander Hotovitzky":
{"type": "Protopresbitero · XX sec.", "life": "In questo giorno la Chiesa commemora la glorificazione dello ieromartire Alessandro Chotovickij, annoverato fra i santi dalla Chiesa ortodossa russa il quattro dicembre 1994. Nato l'undici febbraio 1872 a Kremenec in Volinia, figlio di un amato protopresbitero e rettore di seminario, Alessandro si laureò con lode all'Accademia teologica di San Pietroburgo nel 1895 e fu inviato come missionario nella diocesi delle Aleutine e dell'America del Nord, dove, prima come lettore e poi come sacerdote della parrocchia di San Nicola a New York, divenne uno dei pastori più luminosi della missione americana.", "patron": "Si invoca per i parroci; per i missionari."},

"Great Martyr Anastasia the Deliverer from Poisons, her teacher, Martyr Chrysogonos, and many with them":
{"type": "Grande martire · IV sec.", "life": "La santa grande martire Anastasia, liberatrice dai veleni, era romana di nobile nascita, figlia di un padre pagano e di una madre cristiana nel segreto, Fausta, e fu formata nella fede dal suo maestro, il saggio confessore Crisogono. Data in matrimonio contro il suo cuore al pagano Publio, conservò la verginità fingendosi inferma, e indossate vesti da mendicante andava con una sola serva per le prigioni di Roma, nutrendo, curando e riscattando i prigionieri di Cristo, poiché era esperta nelle arti mediche e fece della sua scienza un ministero.", "patron": "Si invoca per gli infermieri; per i medici."},

"Great Martyr Euphemia the All-praised":
{"type": "Grande martire · IV sec.", "life": "La santa grande martire Eufemia la lodatissima era figlia di pii cristiani di Calcedonia, e patì in quella città nell'anno 303, nella persecuzione di Diocleziano. Quando il proconsole Prisco comandò a tutti gli abitanti di prendere parte alla festa dell'idolo Ares, Eufemia, con altri cristiani che si erano nascosti per adorare il vero Dio, fu scoperta e condotta in giudizio.", "patron": "Si invoca per la purezza; per la rivendicazione dell'Ortodossia."},

"Great Martyr Irene":
{"type": "Grande martire · IV sec.", "life": "La santa grande martire Irene, una delle più amate fra le donne martiri d'oriente, nacque, narrano i racconti greci, nella città di Magedon, figlia di un governatore pagano di nome Licinio, e fu chiamata Penelope; suo padre, fiero della sua bellezza, la crebbe in una torre con fanciulle al servizio, sigillata dal mondo, e in quella fanciullezza sigillata Dio mandò i suoi segni, una colomba con un ramo d'ulivo, un'aquila con una corona di fiori e un corvo con un serpente, che il suo precettore Appelliano le interpretò come figura del cammino che l'attendeva, la pace, la vittoria e l'afflizione; e istruita in Cristo, vuole la tradizione, per la linea di insegnamento di Timoteo discepolo dell'apostolo Paolo, fu battezzata e prese il nome di Irene, Pace, e il nome divenne il programma di una vita spesa a non fare pace con nessun idolo.", "patron": "Il nome di Pace meritato attraverso le guerre."},

"Great Martyr Katherine of Alexandria":
{"type": "Grande martire · IV sec.", "life": "La santa grande martire Caterina di Alessandria, onorata come una delle più sapienti fra le vergini martiri, veniva da una nobile famiglia di Alessandria ed era rinomata per il suo sapere nella filosofia, nella retorica e nelle scienze. Venuta alla fede in Cristo, affrontò con audacia l'imperatore durante una festa pagana e, nella disputa, confuse i cinquanta filosofi convocati a confutarla, i quali si convertirono essi stessi e diedero la vita per Cristo. Incarcerata e crudelmente torturata, convertì l'imperatrice e il comandante mandato a lei, e quando una ruota irta di punte preparata per il suo tormento andò in pezzi, fu infine decapitata."},

"Great Martyr Marina (Margaret) of Antioch":
{"type": "Grande martire · IV sec.", "life": "La santa grande martire Marina, conosciuta in occidente come Margherita, nacque ad Antiochia di Pisidia in Asia Minore, figlia di un sacerdote pagano, e, essendo morta la madre quando era in fasce, fu allevata da una nutrice e messa a pascolare le pecore. Venuta a conoscere la fede di Cristo, gli donò interamente il cuore e fece voto di custodire per lui la sua verginità. Quando aveva circa quindici anni, un prefetto romano, colpito dalla sua bellezza, cercò di prenderla per sé, e poiché ella lo rifiutò e si confessò cristiana, fu consegnata alla tortura."},

"Great Martyr Mercurius of Caesarea, in Cappadocia":
{"type": "Grande martire · III sec.", "life": "Il santo grande martire Mercurio di Cesarea era un giovane soldato di stirpe scita che serviva negli eserciti romani, figlio di un ufficiale cristiano; e quando i barbari dilagarono oltre la frontiera nei giorni dell'imperatore Decio, un angelo del Signore gli apparve, gli pose una spada nella mano e gli promise la vittoria, comandandogli di ricordare il Signore suo Dio.", "patron": "Si invoca per i soldati; per la vittoria donata dal cielo."},

"Great Martyr Theodore the Tyro (Recruit)":
{"type": "Grande martire · IV sec.", "life": "Il santo grande martire Teodoro Tirone, la recluta, era un giovane soldato da poco arruolato nella coorte Marmarita ad Amasea nel Ponto quando la persecuzione di Massimiano raggiunse la sua legione, verso l'anno 306; comandato con il suo reparto di sacrificare, la recluta rispose che era cristiano e non poteva offrire nulla se non a Cristo, e poiché gli fu dato, in quanto soldato inesperto, tempo per ripensarci, Teodoro spese quella dilazione in modo indimenticabile, andando di notte al tempio della madre degli dèi in Amasea e riducendolo in cenere: il ripensamento della recluta giunto come incendio contro gli idoli. Preso e interrogato, confessò insieme la fede e il fuoco; fu torturato e gettato in carcere a morire di fame, e là il Signore stesso apparve al suo giovane atleta, confortandolo e promettendogli la propria presenza, sicché le guardie udirono la cella sigillata riempirsi del canto di molte voci, la recluta che vegliava con un coro angelico; e condotto fuori a nuovi tormenti e a ultime richieste, Teodoro rispose al giudice con la serenità di un uomo già rinforzato, e fu condannato alle fiamme. Entrò nella fornace pregando e rese l'anima con il corpo non arso, come attesta il racconto del testimone oculare; e la pia donna Eusebia ottenne le sue reliquie e le seppellì a Euchaita, che divenne uno dei grandi santuari di pellegrinaggio dell'Asia Minore, la città dei due Teodori.", "patron": "Si invoca tradizionalmente per ritrovare ciò che è stato rubato."},

"Greatmartyr Artemius at Antioch":
{"type": "Grande martire · IV sec.", "life": "Il santo grande martire Artemio di Antiochia fu un comandante illustre sotto san Costantino il Grande e suo figlio Costanzo, onorato per il valore e per il servizio e fatto vicario imperiale d'Egitto, dove faticò molto per la diffusione della fede; e fu Artemio che l'imperatore inviò a portare le reliquie dell'apostolo Andrea da Patrasso e dell'apostolo Luca da Tebe di Beozia a Costantinopoli, dove furono deposte nella chiesa dei Santi Apostoli.", "patron": "Si invoca per i soldati; per i funzionari."},

"Greatmartyr Barbara and Martyr Juliana, at Heliopolis in Syria":
{"type": "Grande martire · IV sec.", "life": "La santa grande martire Barbara patì a Eliopoli in oriente durante le persecuzioni della Chiesa antica. Secondo la sua vita era figlia di un ricco pagano di nome Dioscoro, il quale la rinchiuse in una torre per custodirne la bellezza; là, contemplando il mondo creato, giunse alla conoscenza dell'unico vero Dio e fu battezzata di nascosto. Confessò la sua fede facendo aprire una terza finestra nel suo bagno in onore della Santa Trinità, e quando il padre lo scoprì la denunciò al governatore. Dopo gravi tormenti sopportati con coraggio fu messa a morte, secondo la tradizione per mano del padre stesso, che ne fu subito abbattuto."},

"Greatmartyr Euphemia the All-praised":
{"type": "Vergine · IV sec.", "life": "Questo giorno commemora il grande miracolo operato per mezzo di santa Eufemia la lodatissima in difesa della fede ortodossa. Avendo patito il martirio a Calcedonia sotto Diocleziano, fu glorificata di nuovo un secolo e mezzo più tardi, nell'anno 451, quando il quarto concilio ecumenico si riunì nella chiesa stessa dove riposavano le sue reliquie, per condannare l'eresia dei monofisiti e confessare le due nature del Cristo, divina e umana.", "patron": "Si invoca per la difesa della dottrina ortodossa."},

"Greatmartyr Eustáthios Placidas, with his wife and children, of Rome":
{"type": "Grande martire · II sec.", "life": "Il santo grande martire Eustazio, prima del battesimo chiamato Placida, era un celebre generale romano sotto gli imperatori Tito e Traiano, generoso verso i poveri benché ancora pagano; e mentre un giorno cacciava gli fu concessa una visione mirabile, un cervo che si volgeva verso di lui con la Croce raggiante di Cristo splendente fra le corna, e una voce che lo chiamava per nome, dicendo: Perché mi perseguiti, Placida?", "patron": "Si invoca per i soldati; per i cacciatori."},

"Greatmartyr George the New at Sofia, Bulgaria":
{"type": "Grande martire · XVI sec.", "life": "Il santo grande martire Giorgio il Nuovo, che patì a Sofia, era un giovane cristiano slavo del sud nell'epoca del giogo turco, e questo giorno conserva la memoria del levarsi e del custodire delle sue sante reliquie, che seguì poco dopo il suo martirio.", "patron": "Il diciottenne saldo come un diamante."},

"Greatmartyr James the Persian":
{"type": "Grande martire · V sec.", "life": "Il santo grande martire Giacomo il persiano, detto Intercisus, il tagliato a pezzi, era un nobile cristiano di Persia, ricco, onorato e caro al re Yezdegerd; e la sua anima, presa nell'amicizia del re, cadde nel grande peccato della sua vita, poiché quando il re si volse contro i cristiani Giacomo, non volendo perdere il favore, rinnegò Cristo insieme alla corte.", "patron": "Si invoca per i cortigiani; per la penitenza dopo il rinnegamento."},

"Greatmartyr Niketas the Goth":
{"type": "Grande martire · IV sec.", "life": "Il santo grande martire Niceta era un goto, nato e dimorante sulle rive del Danubio, e fu battezzato da Teofilo, vescovo dei goti, che aveva preso parte al primo concilio ecumenico. Quando la guerra divise il suo popolo e il capo pagano Atanarico levò una feroce persecuzione contro i cristiani fra i goti, Niceta, che con la predicazione e la vita santa aveva condotto a Cristo molti dei suoi parenti, divenne colonna della Chiesa perseguitata, rinsaldando i fedeli per il martirio e denunciando con audacia il persecutore per la sua crudeltà e la sua empietà.", "patron": "Si invoca per i soldati; per i bambini."},

"Greatmartyr Paraskevi of Iconium":
{"type": "Grande martire · III sec.", "life": "La santa grande martire Parasceve di Iconio visse nel terzo secolo, nata da una famiglia ricca e devota che teneva in speciale riverenza il venerdì della Passione del Signore, e per questo chiamò la figlia Parasceve, che significa venerdì. Amando la purezza fin dalla giovinezza, votò a Cristo la sua verginità e, alla dormizione dei genitori, diede le sue ricchezze ai poveri e si dedicò a illuminare i pagani della sua città con la luce del Vangelo.", "patron": "Si invoca per i mercanti; per i commercianti."},

"Greatmartyr Procopius of Caesarea, in Palestine":
{"type": "Proconsole (comandante militare) · IV sec.", "life": "Il santo grande martire Procopio, chiamato Neanio prima del battesimo, era originario di Gerusalemme e visse sotto l'imperatore Diocleziano. Allevato dalla madre pagana Teodosia dopo la morte del padre cristiano, ricevette un'ottima istruzione, salì rapidamente nel servizio imperiale e fu inviato come proconsole ad Alessandria a perseguitare i cristiani.", "patron": "Si invoca per i soldati; per la conversione."},

"Greatmartyr and Healer Panteleimon":
{"type": "Grande martire · inizio del IV sec.", "life": "Il santo grande martire e guaritore Panteleimon nacque a Nicomedia di Bitinia sul finire del terzo secolo, figlio di un padre pagano e di una madre cristiana. Formato come medico, fu condotto alla fede dal sacerdote Ermolao e battezzato, e da allora guariva gratuitamente i malati nel nome di Cristo, rifiutando ogni compenso, sicché è onorato come guaritore anargiro. Il suo successo e la sua aperta confessione della fede suscitarono l'invidia degli altri medici, i quali lo denunciarono all'imperatore Massimiano durante la persecuzione dei cristiani. Dopo aver sopportato molti tormenti, dai quali fu più volte preservato, fu decapitato verso l'anno 305.", "patron": "Patrono dei medici e dei malati; si invoca per la guarigione del corpo e dell'anima."},

"Greatmartyr, Victory-bearer, and Wonderworker George":
{"type": "Grande martire · IV sec.", "life": "Il santo grande martire Giorgio, detto portatore di vittoria e trofeoforo, nacque sul finire del terzo secolo da una devota famiglia cristiana di Cappadocia in Asia Minore. Suo padre, ufficiale dell'esercito romano, fu martirizzato per Cristo quando Giorgio era ancora fanciullo, e sua madre, nobildonna di Lidda in Palestina, lo crebbe nella pietà. Entrato egli stesso nell'esercito, Giorgio salì ad alto grado e servì nella guardia dell'imperatore Diocleziano."},

"Heiromartyr Theokteristus":
{"type": "Confessore martire e igumeno · IX sec.", "life": "Il santo confessore e martire Teosteritto, detto anche Teostericto, igumeno del monastero di Pelekete presso Prusa, stette al centro di una delle atrocità più oscure della persecuzione iconoclasta e donò alla Chiesa, da quel buio, una delle sue preghiere più amate. Nato a Triglia in Bitinia, si fece monaco in gioventù al monastero di San Giovanni il Teologo detto Pelekete, e ne divenne igumeno, pascendo una grande fraternità negli anni in cui Costantino Copronimo volse tutto l'apparato dell'impero contro le sante icone e soprattutto contro i monaci che le difendevano; e il giovedì santo dell'anno 763, mentre l'igumeno stava alla Divina Liturgia con le sue centinaia di monaci, il generale dell'imperatore irruppe nel monastero con i soldati, infranse sul pavimento il santo calice, colpì l'igumeno in volto e ne pretese la firma contro le icone, e ricevutone il rifiuto scatenò un massacro nel quale centinaia di fratelli furono trucidati dentro e intorno alla chiesa, la settimana stessa dello Sposo intrisa del sangue dei suoi monaci, e i superstiti furono trascinati con il loro igumeno davanti all'imperatore, che decapitò i confessori a uno a uno mentre ciascuno a sua volta lo rifiutava.", "patron": "Si invoca per gli igumeni; per gli innografi."},

"Hieromartyr Alexander of Sίdē, in Pamphylia":
{"type": "Ieromartire · III sec.", "life": "Lo ieromartire Alessandro era sacerdote della città di Side in Panfilia, sulla costa meridionale dell'Asia Minore, e patì sotto l'imperatore Aureliano, nell'ultimo spasimo di persecuzione del terzo secolo prima della grande tempesta di Diocleziano. Condotto davanti al governatore Antonino, al sacerdote fu chiesto il nome e la condizione, ed egli rispose con la confessione che rendeva inevitabile tutto il resto, che era cristiano e pastore del gregge di Cristo.", "patron": "Si invoca per i sacerdoti davanti ai tribunali; per la risposta ardita sotto Aureliano."},

"Hieromartyr Alexander, Bishop of Adrianopolis, and the Martyrs Heraclius, Anna, Elizabeth, Theodota, and Glyceria":
{"type": "Martiri · III sec.", "life": "I santi martiri Alessandro vescovo, Eraclio soldato e le donne Anna, Elisabetta, Teodota e Glicera patirono ad Adrianopoli in Tracia nell'epoca delle persecuzioni. Alessandro, vescovo di quella città, proclamava il Vangelo con audacia e rifiutò di offrire sacrificio agli idoli, per il che fu sottoposto a tormenti prolungati e feroci.", "patron": "Si invocano per la conversione per la testimonianza dei martiri."},

"Hieromartyr Alexander, Bishop of Comana":
{"type": "Vescovo · III sec.", "life": "Sant'Alessandro visse nel terzo secolo presso Neocesarea, uomo dotto nelle Scritture e in molte scienze, che tuttavia prese su di sé l'impresa nascosta della follia per Cristo, vivendo in povertà e vendendo carbone nella piazza della città. Il suo volto era sempre annerito dalla polvere di carbone, e molti lo guardavano con disprezzo, ignorandone la sapienza e la santità.", "patron": "Si invoca per l'umiltà; per la sapienza nascosta."},

"Hieromartyr Alexander, Bishop of Jerusalem":
{"type": "Vescovo · III sec.", "life": "Lo ieromartire Alessandro, vescovo di Gerusalemme, fu formato alla scuola catechetica di Alessandria sotto Clemente, condiscepolo e amico per tutta la vita di Origene, e divenne vescovo di una città della Cappadocia, dove la persecuzione di Settimio Severo lo tenne in catene per anni, confessore prima di essere gerarca.", "patron": "Si invoca per i bibliotecari; per i dotti."},

"Hieromartyr Antherus (Antheros) Pope of Rome":
{"type": "Vescovo · III sec.", "life": "Sant'Antero, greco di nascita, fu scelto vescovo di Roma a succedere a san Ponziano, ma tenne la sede per poco tempo, poiché confessò ben presto Cristo e subì la morte per la fede nell'anno 236. Fu deposto nella catacomba di San Callisto, primo fra i vescovi di Roma a essere sepolto in quel luogo consacrato, e dopo di lui san Fabiano fu scelto a pascere la Chiesa di Roma.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Hieromartyr Anthimus, Bishop of Nicomedia and those with him":
{"type": "Vescovo · IV sec.", "life": "Lo ieromartire Antimo, vescovo di Nicomedia, nacque in quella città e fu allevato fin dall'infanzia nella fede cristiana, e poiché era umile, pacifico e pieno di zelo per la gloria di Dio, fu col tempo fatto vescovo di Nicomedia. Pascé la Chiesa di quel luogo durante la feroce persecuzione di Diocleziano e Massimiano, quando il sangue dei cristiani scorreva a fiumi, e nella festa stessa della Natività di Cristo circa ventimila fedeli furono arsi dentro una sola chiesa, mentre molti altri erano decapitati, annegati o sepolti vivi, e fra loro una grande schiera di martiri che Antimo rinsaldava e incoraggiava.", "patron": "Si invoca per la confessione salda; per la fedele cura del gregge sotto persecuzione."},

"Hieromartyr Antipas, Bishop of Pergamum and Disciple of Saint John the Theologian":
{"type": "Ieromartire · I sec.", "life": "Il santo ieromartire Antipa, vescovo di Pergamo, porta una distinzione che nessun altro martire della Chiesa condivide, poiché la sua testimonianza è attestata nelle Scritture dalla voce del Cristo stesso; infatti nell'Apocalisse, nella lettera alla chiesa di Pergamo, il Signore dice: So dove abiti, là dove è il trono di Satana, e tieni fermo il mio nome e non hai rinnegato la mia fede, neppure in quei giorni nei quali Antipa fu il mio testimone fedele, che fu ucciso presso di voi, là dove abita Satana: l'elogio funebre del vescovo scritto dal suo Dio.", "patron": "Si invoca per i vescovi della piantagione apostolica; per quanti soffrono di mali dei denti."},

"Hieromartyr Apollinaris, Bishop of Ravenna":
{"type": "Vescovo · I sec.", "life": "Lo ieromartire Apollinare fu discepolo dell'apostolo Pietro, che seguì da Antiochia a Roma, e Pietro lo consacrò primo vescovo di Ravenna e ve lo inviò a predicare il Vangelo. Giunto come forestiero, gli diede ospitalità il soldato Ireneo, del quale guarì il figlio cieco, e così Ireneo e la sua casa divennero i primi cristiani di Ravenna.", "patron": "Si invoca per l'illuminazione missionaria; per la guarigione."},

"Hieromartyr Artemon of Laodikeia":
{"type": "Ieromartire · IV sec.", "life": "Lo ieromartire Artemone, presbitero di Laodicea in Siria, diede alla Chiesa una vita intera prima di darle il proprio sangue: nato da genitori cristiani, servì come lettore per sedici anni, come diacono per ventotto e come sacerdote per trentatré, settantasette anni negli ordini ascendenti del santuario, sicché quando scoppiò la persecuzione di Diocleziano l'uomo che essa trovò a Laodicea era un anziano che tre generazioni avevano udito leggere, servire e offrire.", "patron": "Si invoca per i lettori, i diaconi e i sacerdoti; per quanti servono da lungo tempo."},

"Hieromartyr Athanasios, Venerable Anthousa, and others":
{"type": "Vescovo · III sec.", "life": "Sant'Atanasio, vescovo di Tarso in Cilicia, e quelli con lui patirono per Cristo nel terzo secolo. Sant'Antusa, fanciulla di Seleucia in Siria e figlia di ricchi pagani, aveva udito parlare della fede cristiana e desiderava essere istruita dal vescovo Atanasio, e così, prendendo con sé due servi, Carisimo e Neofito, venne a Tarso con il pretesto di un altro viaggio.", "patron": "Si invoca per la conversione; per la confessione salda."},

"Hieromartyr Athenogenes, Bishop of Heracleopolis, and his ten disciples":
{"type": "Vescovo · IV sec.", "life": "Lo ieromartire Atenogene, vescovo di Eracleopoli, patì insieme ai suoi dieci discepoli durante la persecuzione di Diocleziano nella città di Sebaste di Cappadocia. Quando il governatore Filomaco tenne una grande festa in onore degli idoli e comandò al popolo di sacrificare, i cittadini di Sebaste, per la maggior parte cristiani, rifiutarono, e molti ricevettero la corona del martirio sotto le spade dei soldati.", "patron": "Si invoca per la fedele cura del gregge."},

"Hieromartyr Autonomus, Bishop in Italy":
{"type": "Vescovo · IV sec.", "life": "Lo ieromartire Autonomo era vescovo in Italia nei giorni della persecuzione di Diocleziano, e ritirandosi davanti alla tempesta venne a Soreoi in Bitinia, dove fu accolto da un uomo pio di nome Cornelio e, lungi dal riposare al sicuro, si diede a una predicazione instancabile, convertendo una moltitudine così grande di pagani che ordinò Cornelio diacono e poi vescovo per il gregge che aveva raccolto.", "patron": "Si invoca per i missionari; per la predicazione missionaria."},

"Hieromartyr Babylas, Bishop of Antioch, and those with him":
{"type": "Vescovo · III sec.", "life": "Lo ieromartire Babila, vescovo di Antiochia, patì sotto l'imperatore Decio insieme ai tre giovani fratelli Urbano, Prilidiano ed Epolonio e alla loro madre Cristodula. Quando l'imperatore, durante una festa pagana nella città, volle per curiosità entrare nella chiesa dove il santo vescovo celebrava la Divina Liturgia, Babila uscì e gli sbarrò il passo, rifiutando di lasciare entrare nel tempio di Dio il sovrano empio.", "patron": "Si invoca per l'audacia davanti ai sovrani; per la confessione salda."},

"Hieromartyr Basil of Ancyra":
{"type": "Ieromartire · IV sec.", "life": "Lo ieromartire Basilio, sacerdote di Ancira in Galazia, fu il custode del gregge di quella città attraverso due tempeste successive, l'ariana e la pagana, e cadde nella seconda. Negli anni in cui gli ariani tenevano il potere e le chiese di Galazia erano sconvolte, il presbitero Basilio faticò senza posa per la fede nicena, rinsaldando gli incerti, denunciando apertamente l'eresia e mantenendo il popolo di Ancira nella vera confessione, benché gli costasse persecuzioni e sospensione per mano ariana, il sacerdote di parrocchia che teneva una linea che i gerarchi stavano abbandonando.", "patron": "Si invoca per i parroci; per i difensori del gregge contro l'eresia e l'apostasia."},

"Hieromartyr Basil, Bishop of Amasea":
{"type": "Ieromartire · IV sec.", "life": "Il santo ieromartire Basilio, vescovo di Amasea nel Ponto, conquistò la sua corona nell'ultima ora della persecuzione, sotto Licinio, quando il coimperatore d'oriente, rompendo le sue promesse di tolleranza, si volse nuovamente contro i cristiani per gelosia di Costantino; e la lotta di Basilio nacque da un atto di ospitalità.", "patron": "Si invoca per i vescovi che danno rifugio ai perseguitati; per i protettori delle donne in pericolo."},

"Hieromartyr Clement, Pope of Rome":
{"type": "Patriarca · II sec.", "life": "Lo ieromartire Clemente, papa di Roma, nacque a Roma da una famiglia ricca e illustre imparentata con gli imperatori, e per una strana provvidenza fu separato nell'infanzia dai genitori e dai fratelli, allevato fra estranei con ogni vantaggio di istruzione ma con il cuore inquieto di un orfano.", "patron": "Si invoca per gli scalpellini; per gli esuli."},

"Hieromartyr Cornelius the Centurion":
{"type": "Vescovo · I sec.", "life": "Lo ieromartire Cornelio centurione, primizia delle genti, era un ufficiale romano della coorte Italica di stanza a Cesarea di Palestina, uomo devoto che temeva Dio con tutta la sua casa, faceva generosamente l'elemosina e pregava sempre, come attestano gli Atti degli apostoli. A lui apparve un angelo, dicendogli che le sue preghiere e le sue elemosine erano salite come memoriale davanti a Dio, e comandandogli di mandare a chiamare Simone Pietro.", "patron": "Si invoca per i soldati; per i convertiti."},

"Hieromartyr Cyprian, Bishop of Carthage":
{"type": "Vescovo · III sec.", "life": "Lo ieromartire Cipriano, vescovo di Cartagine, uno dei più grandi padri della Chiesa antica, nacque verso l'anno 200 in quella città, figlio di un ricco senatore pagano, e divenne celebre maestro di retorica e di filosofia e avvocato nei tribunali. A lungo, come confessò egli stesso più tardi, rimase in una profonda tenebra, lontano dalla luce della verità, e le sue ricchezze e i suoi piaceri non poterono spegnere la sua sete di qualcosa di più alto.", "patron": "Si invoca per i teologi; per l'unità della Chiesa."},

"Hieromartyr Cyprian, Virgin Martyr Justina, and Martyr Theoctistus, of Nicomedia":
{"type": "Vescovo · IV sec.", "life": "Lo ieromartire Cipriano, la vergine martire Giustina e il martire Teoctisto patirono a Nicomedia nell'anno 304. Cipriano era un filosofo e mago di Antiochia, istruito fin dall'infanzia nei misteri pagani sull'Olimpo e ad Argo, a Menfi e a Babilonia, finché divenne famoso come servitore del principe delle tenebre.", "patron": "Si invoca per la liberazione dalla stregoneria e dagli spiriti maligni; per la purezza custodita dalla Croce."},

"Hieromartyr Cyril, Bishop of Gortyna in Crete":
{"type": "Vescovo · IV sec.", "life": "Lo ieromartire Cirillo era vescovo di Gortina nell'isola di Creta, che pascé fedelmente per cinquant'anni, ed era un vecchio di grande età quando la persecuzione dei cristiani raggiunse la sua città. Preso e comandato di sacrificare agli idoli, rifiutò e fu condannato a essere arso vivo.", "patron": "Si invoca per la predicazione salda."},

"Hieromartyr Desan, Bishop in Persia, and 272 others with him":
{"type": "Ieromartiri · IV sec.", "life": "Il santo ieromartire Desan, vescovo in Persia, patì con duecentosettantadue compagni nella persecuzione del re Sapore II, verso gli anni dal 362 al 364, e la loro lotta conserva la memoria di una delle crudeltà caratteristiche di quella persecuzione, il martirio dei deportati. Quando gli eserciti persiani presero le fortezze romane di frontiera della Mesopotamia, ne portarono via in blocco le popolazioni cristiane verso l'interno del regno, clero e popolo insieme, comunità sradicate con i loro pastori e condotte a oriente come bottino vivente.", "patron": "Si invocano per le comunità deportate; per il clero con il proprio popolo."},

"Hieromartyr Dionysius the Areopagite, Bishop of Athens":
{"type": "Vescovo · I sec.", "life": "Lo ieromartire Dionigi l'Areopagita era un nobile ateniese, dotto in tutta la sapienza dei greci, il quale da giovane, studiando a Eliopoli in Egitto, vide le tenebre che coprirono la terra nell'ora della Crocifissione e disse: O Dio patisce, o il mondo va verso la sua fine.", "patron": "Si invoca per i teologi; per i filosofi."},

"Hieromartyr Dorotheus, Bishop of Tyre":
{"type": "Ieromartire · IV sec.", "life": "Il santo ieromartire Doroteo, vescovo di Tiro, fu confessore e martire di straordinaria longevità, che attraversò tre persecuzioni e diede alla Chiesa, oltre alla sua testimonianza, un prezioso racconto degli apostoli.", "patron": "I vescovi di lunga vita e di molte prove; i confessori sotto persecuzioni successive."},

"Hieromartyr Emilian and with him Martyrs Hilarion, Dionysius, and Hermippus":
{"type": "Vescovo · IV sec.", "life": "Lo ieromartire Emiliano, vescovo di Trevi, insieme a Ilarione, Dionisio ed Ermippo, nacque in Armenia; e dopo la morte dei genitori i fratelli Emiliano, Dionisio ed Ermippo, con il loro maestro Ilarione, lasciarono la patria e vennero in Italia, alla città di Spoleto. Là Emiliano predicò il Vangelo ai pagani, e stimato per la sua vita austera e virtuosa fu scelto vescovo di Trevi e consacrato da Marcellino di Roma.", "patron": "Si invoca per la predicazione missionaria."},

"Hieromartyr Eusebius, Bishop of Samosata":
{"type": "Ieromartire · IV sec.", "life": "Il santo ieromartire Eusebio, vescovo di Samosata, fu uno dei grandi campioni della fede ortodossa contro l'eresia ariana nel quarto secolo, amico e compagno di fatiche dei più grandi padri della sua epoca e confessore che morì di morte da martire.", "patron": "I difensori dell'Ortodossia contro l'eresia; i vescovi esiliati per la fede."},

"Hieromartyr Euthymius, Bishop of Sardis":
{"type": "Vescovo · IX sec.", "life": "Lo ieromartire Eutimio, vescovo di Sardi, fu elevato a quell'antica sede per la sua vita virtuosa nei giorni di Costantino e di Irene, e stette al settimo concilio ecumenico nel 787 fra quanti denunciarono l'eresia iconoclasta; e quando l'eresia tornò sul trono, il suo episcopato divenne una catena di quarant'anni di esili, uno per ciascun imperatore che gli chiese ciò che egli non voleva dare.", "patron": "Si invoca per i vescovi in esilio; per la venerazione delle sante icone."},

"Hieromartyr Eutyches, disciple of Saint John the Theologian":
{"type": "Vescovo · II sec.", "life": "Lo ieromartire Eutichio fu discepolo dei santi apostoli Giovanni il Teologo e Paolo, e benché non fosse fra i Settanta è onorato con il nome di apostolo per le sue fatiche accanto a loro, dai quali fu fatto vescovo. Nato nella città di Sebastea in Samaria, seguì dapprima l'apostolo Giovanni, e poi, incontrato l'apostolo Paolo, predicò con lui il Vangelo nei suoi viaggi, e percorse molte terre proclamando Cristo e abbattendo i templi degli idoli.", "patron": "Si invoca per i missionari; per la predicazione."},

"Hieromartyr Gregory, Bishop of Greater Armenia, Equal of the Apostles, Enlightener of Armenia":
{"type": "Vescovo · IV sec.", "life": "Lo ieromartire Gregorio, vescovo della Grande Armenia, pari agli apostoli e illuminatore dell'Armenia, era figlio del nobile parto Anak, che aveva ucciso il re armeno; e il piccolo Gregorio, sottratto alla vendetta che distrusse la sua casa, fu portato a Cesarea di Cappadocia e là allevato nella fede cristiana.", "patron": "Si invoca per i missionari; per l'illuminazione delle nazioni."},

"Hieromartyr Hermogenes, Patriarch of Moscow and All Russia":
{"type": "Martire · XVII sec.", "life": "Il santo ieromartire Ermogene, patriarca di Mosca e di tutta la Russia, la cui glorificazione la Chiesa commemora in questo giorno, fu il pastore la cui fermezza in carcere salvò il suo paese, e la Chiesa russa ne celebra la festa nella data della glorificazione come ne celebra la dormizione in febbraio.", "patron": "Le lettere che sollevarono le milizie."},

"Hieromartyr Hermogenes, Patriarch of Moscow, Wonderworker of All Russia":
{"type": "Ieromartire e patriarca · XVII sec.", "life": "Lo ieromartire Ermogene, patriarca di Mosca e di tutta la Russia, fu l'ancora che tenne una nazione che affondava, e la tenne da una cella dove moriva di fame. Nato verso il 1530, servì come sacerdote di parrocchia a Kazan, e nel 1579 stette all'avvenimento che segnò la sua vita, il ritrovamento dell'icona di Kazan della Madre di Dio, portando con le proprie mani in processione l'immagine appena rivelata e componendo poi tanto il racconto della sua apparizione quanto l'ufficio in suo onore, il sacerdote divenuto il primo storico dell'icona.", "patron": "Si invoca per i patriarchi; per i difensori dell'anima di una nazione."},

"Hieromartyr Hermolaus and Martyrs Hermippus and Hermocrates at Nicomedia":
{"type": "Sacerdote · IV sec.", "life": "Gli ieromartiri Ermolao, Ermippo ed Ermocrate furono fra i pochi sopravvissuti dopo che ventimila cristiani furono arsi in una chiesa a Nicomedia durante la persecuzione di Massimiano. Vivendo nascosti, non cessarono di predicare il Vangelo ai pagani, e fu il sacerdote Ermolao che, vedendo passare davanti alla sua dimora il giovane pagano Pantoleone, lo chiamò dentro e gli insegnò la vanità dell'idolatria e la verità di Cristo.", "patron": "Si invoca per i catechisti."},

"Hieromartyr Hierotheus, Bishop of Athens":
{"type": "Vescovo · I sec.", "life": "Lo ieromartire Ieroteo, vescovo di Atene, era membro del tribunale dell'Areopago e fu condotto a Cristo, insieme a Dionigi l'Areopagita, dalla predicazione del santo apostolo Paolo, che lo consacrò primo vescovo di Atene; ed egli a sua volta istruì Dionigi più perfettamente nei misteri della fede, sicché il suo discepolo lo chiama maestro e parla con riverenza dei suoi inni e delle sue definizioni dell'amore divino.", "patron": "Si invoca per i teologi; per gli innografi."},

"Hieromartyr Hippolytus, and those with him":
{"type": "Ieromartire · III sec.", "life": "Lo ieromartire Ippolito di Roma patì con i martiri Censorino, Sabino, la vergine Crise e altri venti nel terzo secolo, verso l'anno 269, sotto l'imperatore Claudio; e la lotta di quella schiera cominciò da un magistrato. Censorino, funzionario di alto grado, fu denunciato come cristiano e incarcerato, e nel carcere la grazia di Cristo operò per mezzo suo un prodigio che decise tutta la vicenda, poiché alla sua preghiera un morto fu risuscitato, e venti soldati e guardie carcerarie, testimoni della risurrezione, confessarono Cristo sul posto e furono decapitati insieme al magistrato che erano stati posti a custodire.", "patron": "Si invoca per i teologi; per gli scrittori."},

"Hieromartyr Ignatius the God-Bearer, Bishop of Antioch":
{"type": "Ieromartire · II sec.", "life": "Lo ieromartire Ignazio il teoforo, vescovo di Antiochia, fu discepolo dell'apostolo Giovanni il Teologo insieme a Policarpo di Smirne, e un'antica tradizione custodisce che egli fosse il fanciullo che il Signore prese fra le braccia e pose in mezzo ai discepoli, dicendo che di tali è il Regno; il nome di Theophoros, portatore di Dio, egli stesso lo spiegò più semplicemente, come di colui che porta Cristo dentro il proprio cuore. Secondo vescovo di Antiochia dopo gli apostoli, pascé quella grande sede per quattro decenni, attraverso la persecuzione di Domiziano e fin dentro il regno di Traiano; e quando l'imperatore, passando per Antiochia, condannò il vescovo alle belve a Roma, Ignazio andò alla sua morte per tutta la larghezza dell'impero, incatenato a un drappello di soldati che chiamava i suoi dieci leopardi, la cui crudeltà, diceva, non faceva che istruirlo ulteriormente. Quella marcia verso la morte divenne uno dei tesori della Chiesa, poiché lungo il cammino, a Smirne e a Troade, il prigioniero scrisse sette lettere, agli efesini, ai magnesi, ai tralliani, ai romani, ai filadelfiesi, agli smirnesi e a Policarpo, la voce più antica dopo gli apostoli, che insegna l'unità della Chiesa intorno al suo vescovo, chiama l'Eucaristia farmaco di immortalità e per prima scrive le parole Chiesa cattolica; e ai romani, che avrebbero potuto ottenerne la liberazione, scrisse la supplica che non è mai stata superata: Lasciate che io sia cibo delle belve; sono frumento di Dio, e sono macinato dai denti delle belve, per essere trovato puro pane di Cristo."},

"Hieromartyr Irenaeus, Bishop of Lyons":
{"type": "Vescovo · III sec.", "life": "Lo ieromartire Ireneo, vescovo di Lione, uno dei grandi maestri della Chiesa antica, nacque verso l'anno 130 a Smirne e ricevette un'ottima istruzione nel sapere del suo tempo. Sua guida nella fede fu san Policarpo di Smirne, egli stesso discepolo dell'apostolo Giovanni il Teologo, e nella vecchiaia Ireneo ricordava come da fanciullo avesse ascoltato Policarpo parlare dei suoi colloqui con quanti avevano veduto il Signore, scrivendo queste cose, come diceva, non sulla carta ma nel proprio cuore.", "patron": "Si invoca per i teologi; per la teologia ortodossa."},

"Hieromartyr Irenaeus, Bishop of Sirmium":
{"type": "Ieromartire · IV sec.", "life": "Lo ieromartire Ireneo, vescovo di Sirmio in Pannonia, patì nella grande persecuzione dell'anno 304, e la sua lotta è conservata in atti di prima autenticità, fra i più preziosi degli antichi verbali dei martiri. Giovane per il suo ufficio, e coniugato con figli secondo la disciplina di quell'epoca, Ireneo fu preso in quanto vescovo e condotto davanti al governatore Probo.", "patron": "Si invoca per i vescovi con famiglia; per quanti hanno i propri cari che li supplicano contro la loro confessione."},

"Hieromartyr Januarius, Bishop of Benevento, and his companions, at Pozzuoli":
{"type": "Ieromartire · IV sec.", "life": "Il santo ieromartire Gennaro, vescovo di Benevento, patì con i suoi compagni a Pozzuoli nell'anno 305, al culmine della persecuzione di Diocleziano, e la sua passione è un ritratto dei legami d'affetto della Chiesa antica, poiché fu preso a causa di una visita: quando il suo diacono Sosso di Miseno e altri chierici furono incarcerati nella persecuzione, Gennaro andò apertamente a rinsaldare i confessori nelle loro catene, e la visita, come egli doveva sapere che poteva accadere, lo unì alla loro causa, il vescovo arrestato per cura pastorale, imputato, in sostanza, di essersi presentato.", "patron": "Si invoca per i vescovi con i loro diaconi; per le città e i loro protettori."},

"Hieromartyr Kindeos the Presbyter of Pamphylia":
{"type": "Sacerdote · IV sec.", "life": "Lo ieromartire Kindeo era sacerdote in Panfilia in Asia Minore durante la persecuzione dell'imperatore Diocleziano. Non trattenuto dal pericolo, faticava con zelo per predicare il Vangelo e rinsaldare i fedeli, e quando per questo fu denunciato alle autorità fu preso e messo a morte per il nome di Cristo.", "patron": "Si invoca per la predicazione zelante."},

"Hieromartyr Kuksha and Venerable Pimen of the Kyiv Near Caves":
{"type": "Ieromonaco · XII sec.", "life": "Lo ieromartire Kukša era un monaco delle Grotte di Kyiv che andò a predicare il Vangelo ai vjatiči, un popolo pagano e feroce che abitava nelle foreste lungo il fiume Oka e che viveva, come disse il cronista, soltanto per il giorno presente e non conosceva nulla della legge di Dio.", "patron": "Si invoca per i missionari; per l'illuminazione missionaria."},
...
{"type": "Sacerdote · III sec.", "life": "Il santo martire Mirone era sacerdote in Acaia, uomo di nascita ricca e nobile e tuttavia mite e benigno con tutti, amante di Dio e del prossimo, e coraggioso nella difesa del suo gregge. Patì nell'anno 250, nella persecuzione di Decio, quando nella festa della Natività di Cristo il governatore Antipatro irruppe nella chiesa durante l'ufficio per prendere i cristiani, e san Mirone arditamente lo rimproverò di profanare il culto di Dio.", "patron": "Si invoca per la difesa del gregge."},

"Martyr Nectan of Hartland":
{"type": "Ieromartire · VI sec.", "life": "San Nectan di Hartland fu eremita e martire celtico del sesto secolo, onorato nel West Country di Britannia, e la sua vita appartiene a quella grande famiglia di santi della Chiesa celtica che lasciarono le loro patrie per cercare Dio nella solitudine.", "patron": "Gli eremiti e i solitari; quanti portano il proprio capo."},

"Martyr Nestor of Thessalonica":
{"type": "Martire · IV sec.", "life": "Il santo martire Nestore di Tessalonica era un giovane cristiano, bello d'aspetto e noto al grande martire Demetrio, che lo aveva istruito nella fede. Quando l'imperatore Massimiano tenne giochi nella città, il suo campione, un gigantesco vandalo di nome Lieo, gettava sfidante dopo sfidante da un'alta impalcatura sopra lance rivolte all'insù, con diletto dell'imperatore e rovina di molti, fra i quali cristiani costretti nell'arena.", "patron": "Si invoca per i soldati; per gli atleti."},

"Martyr Nicander of Egypt":
{"type": "Martire · IV sec.", "life": "Il santo martire Nicandro d'Egitto era medico, e nella persecuzione di Diocleziano volse la sua professione in un duplice ministero che gli editti avevano reso due volte delitto capitale: visitava i cristiani imprigionati, curandone le piaghe dei tormenti, portando loro cibo e conforto nelle carceri dove l'impero intendeva lasciarli marcire fra un interrogatorio e l'altro.", "patron": "Si invoca per i medici; per quanti seppelliscono i morti."},

"Martyr Nikon and 199 disciples with him in Sicily":
{"type": "Ieromartire · III sec.", "life": "Il santo martire Nicone e i suoi centonovantanove discepoli patirono in Sicilia nella persecuzione di Decio, verso l'anno 251, e la sua strada verso quella schiera cominciò in un esercito. Soldato di professione, figlio di padre pagano e di madre cristiana, Nicone andò alla guerra non battezzato ma non senza istruzione, poiché sua madre aveva posto in lui il seme della fede.", "patron": "Si invoca per i vescovi con i loro greggi; per i maestri e i loro allievi."},

"Martyr Onesimus of Isauria":
{"type": "Martire · I sec.", "life": "Il santo martire Onesimo, detto anche Onisio, è annoverato fra i primi testimoni di Cristo che sigillarono con il sangue la loro confessione per mezzo della spada. I racconti che di lui sopravvivono sono brevissimi, e non concordano pienamente neppure sulla sua patria, poiché mentre è commemorato nei calendari come Onesimo d'Isauria, e posto accanto al martire Conone di quella regione, il cui inno unisce i loro due nomi, le Vite dei santi della Chiesa ortodossa in America registrano semplicemente che visse in Palestina.", "patron": "Si invoca per i saldi sotto interrogatorio; per la confessione sigillata dalla spada."},

"Martyr Orestes, Physician of Cappadocia":
{"type": "Martire · IV sec.", "life": "Il santo martire Oreste medico visse a Tiana di Cappadocia sotto Diocleziano, guaritore dotto e valente dei corpi e, fin dall'infanzia, vero cristiano. Quando l'ufficiale Massimino fu mandato a Tiana per schiacciare la fede, Oreste fu fra i primi condotti a giudizio, e confessò apertamente il Signore crocifisso e risorto, non smosso dalle ricchezze e dagli onori che gli venivano offerti.", "patron": "Si invoca per i medici; per la guarigione."},

"Martyr Pancharius at Nicomedia":
{"type": "Martire · IV sec.", "life": "Il santo martire Pancario era un romano di alto grado, favorito dell'imperatore Massimiano, e cristiano; e il suo certame è prezioso alla Chiesa perché comincia con una caduta. Quando la persecuzione rese incompatibili la fede e il favore, Pancario, non volendo perdere il suo posto accanto all'imperatore, nascose e in effetti rinnegò il suo cristianesimo, tenendo la corte e lasciando andare Cristo, la quieta apostasia della convenienza che non lascia cicatrice visibile di fuori.", "patron": "Si invoca per quanti hanno rinnegato e vorrebbero tornare; per i figli lontani da casa."},

"Martyr Papas of Lyconia":
{"type": "Martire · IV sec.", "life": "Il santo martire Papa di Licaonia patì nella persecuzione all'aprirsi del quarto secolo, quando gli editti di Diocleziano e Massimiano giunsero fin negli altipiani dell'Asia Minore interna dove Paolo e Barnaba avevano per primi seminato la parola; e il certame di Papa è ricordato per la sua strada e per il suo albero.", "patron": "Si invoca per quanti sono spinti oltre le proprie forze; per la marcia nei sandali chiodati."},

"Martyr Paramon and 370 Martyrs in Bithynia":
{"type": "Martiri · III sec.", "life": "Il santo martire Paramone e i trecentosettanta martiri con lui patirono in Bitinia nell'anno 250, nella persecuzione di Decio. Il governatore Aquilino, venuto alle sorgenti calde di quelle parti, teneva con sé in catene una moltitudine di cristiani, trecentosettanta di numero.", "patron": "Si invocano per la parola che non vuole tacere davanti all'ingiustizia."},

"Martyr Paraskevi of Rome":
{"type": "Monaca · II sec.", "life": "La venerabile martire Parasceve era l'unica figlia di genitori cristiani devoti in Roma, e fin dai primi anni si diede alla preghiera e allo studio delle sante Scritture. Alla morte dei genitori distribuì la sua eredità ai poveri e consacrò a Cristo la sua verginità, e a imitazione degli apostoli andava attorno predicando il Vangelo e volgendo molti pagani dai loro idoli.", "patron": "Si invoca per i disturbi degli occhi; per i malati."},

"Martyr Pausilippus of Heraclea in Thrace":
{"type": "Martire · II sec.", "life": "Il santo martire Pausilippo patì a Eraclea di Tracia sotto l'imperatore Adriano, fra gli anni 117 e 138, nella generazione in cui le persecuzioni non correvano per grandi editti ma per tempeste locali, bastando lo zelo di un governatore o il rancore di una città a riempire le carceri.", "patron": "Si invoca per quanti muoiono per le loro ferite; per i confessori fuori dell'arena."},

"Martyr Peter the Aleut":
{"type": "Martire · XIX sec.", "life": "Il santo martire Pietro l'aleuta era un giovane nativo della regione di Kodiak in Alaska, battezzato nella fede ortodossa dai missionari russi e impiegato con i suoi connazionali nelle squadre di caccia della colonia. Nell'anno 1815 fu catturato con altri aleuti da soldati spagnoli in California, e là si fecero pressioni sui prigionieri perché abbandonassero l'ortodossia per la fede latina.", "patron": "Si invoca per i cacciatori; per i popoli indigeni."},

"Martyr Phaedrus":
{"type": "Martire · III sec.", "life": "Il santo martire Fedro è commemorato in questo giorno insieme al martire Filomeno di Ancira, nella schiera di quelli che patirono in Galazia nella persecuzione dell'imperatore Aureliano, verso l'anno 274. I sinassari greci registrano il modo del suo certame: rifiutando di rinnegare Cristo, fu messo a morte con pece bollente versatagli sul corpo, e così, scottato nella carne ma non bruciato nell'anima, rese lo spirito a Dio.", "patron": "Si invoca per i fedeli di cui non resta memoria."},

"Martyr Philetus the Senator, his wife and sons, and those with them in Illyria":
{"type": "Martiri · II sec.", "life": "I santi martiri Fileto senatore, sua moglie Lidia, i loro figli Macedone e Teoprepio, Anfilochio comandante e Cronide notaio patirono sotto l'imperatore Adriano, al principio del secondo secolo, e il loro certame è di quelli che la Chiesa ricorda per la strana dolcezza della fine.", "patron": "Si invocano per le famiglie che confessano insieme; per i funzionari convertiti."},

"Martyr Philosophus at Alexandria":
{"type": "Martire · III sec.", "life": "Il santo martire Filosofo patì per Cristo ad Alessandria nella persecuzione dell'imperatore Decio, verso l'anno 250, e il suo certame fu di una specie rara e terribile, una battaglia non contro la spada ma contro la carne, nella quale vinse volgendo il proprio dolore contro i suoi tentatori.", "patron": "La tentazione della carne vinta con una ferita."},

"Martyr Philoumenus of Ancyra":
{"type": "Martire · III sec.", "life": "Il santo martire Filomeno patì per Cristo nell'anno 274, nella persecuzione dell'imperatore Aureliano. Nativo della Licaonia e fornaio di mestiere, forniva pane alle città della Galazia, guadagnandosi onestamente da vivere e confessando Cristo apertamente; e uomini invidiosi lo denunciarono come cristiano al governatore Felice ad Ancira.", "patron": "Si invoca per i panettieri; per i mercanti."},

"Martyr Photini the Samaritan Woman, her sons, and those with them":
{"type": "Martire · I sec.", "life": "La santa grande martire Fotina, pari agli apostoli, è la samaritana del Vangelo, che il Signore incontrò al pozzo di Giacobbe nel mezzo del giorno e alla quale chiese da bere; a lei rivelò l'acqua viva, l'adorazione in spirito e verità, e, apertamente come a pochi altri nei Vangeli, che Egli stesso era il Messia; ed ella, lasciando la sua brocca come gli apostoli lasciarono le loro reti, corse alla città, e per la sua parola, registra l'evangelista, molti dei samaritani credettero in Lui. Dopo la Pentecoste fu battezzata con il nome di Fotina, l'illuminata, e divenne ciò che la sua prima ambasciata aveva prefigurato, una predicatrice di Cristo, evangelizzando con le sue cinque sorelle, Anatolia, Foto, Fotide, Parasceve e Ciriaca, e con i suoi due figli, Giose e Vittore, detto Fotino, portando il Vangelo fino a Cartagine in Africa, la donna del pozzo divenuta una fonte della parola all'udito di tre continenti. Sotto Nerone la persecuzione raggiunse la sua famiglia: suo figlio Vittore, ufficiale, fu spinto a perseguitare i cristiani e invece confessò insieme al comandante militare Sebastiano, che per mezzo suo si convertì; e Fotina con tutta la sua casa fu condotta a Roma, dove l'imperatore provò su di lei a sua volta le arti del mondo, tormenti che non poterono toccare la loro gioia, le mollezze del palazzo, e infine la propria figlia Domnina, posta a sedurre la prigioniera all'apostasia; e Fotina fece a Domnina quel che aveva fatto una volta alla Samaria, convertendo a Cristo la figlia dell'imperatore con le sue ancelle, perdendo l'interrogatorio un altro interrogante. Adirato oltre le sue arti, Nerone fece mettere a morte i confessori a uno a uno, le sorelle e i figli perfezionati prima o dopo la madre con vari tormenti; Fotina stessa, dopo anni di carcere nei quali predicò a quanti venivano, fu alla fine gettata in un pozzo, e là rese l'anima verso l'anno 66, la donna la cui vita si era volta presso un pozzo che discendeva in un pozzo per la sua corona, chiudendosi a Roma il cerchio che Dio aveva tracciato a Sicar."},

"Martyr Platon of Ancyra":
{"type": "Martire · IV sec.", "life": "Il santo martire Platone patì ad Ancira di Galazia al principio del quarto secolo, giovane di casa cristiana e fratello del martire Antioco. Andando arditamente per la città, insegnava ai suoi concittadini a disprezzare gli idoli e a conoscere il vero Dio, per il che fu preso e condotto davanti al governatore Agrippino.", "patron": "Si invoca per i giovani; per il rifiuto di ogni patto contro Cristo."},

"Martyr Polycarp of Alexandria":
{"type": "Martire · IV sec.", "life": "Il santo martire Policarpo di Alessandria patì all'aprirsi del quarto secolo, nella grande persecuzione di Massimiano, e il suo certame appartiene alla schiera di quelli che la vista stessa della crudeltà spinse nell'arena. Vedendo in Alessandria la ferocia con cui i confessori di Cristo erano tormentati, gli innocenti torturati e il sangue dei fedeli versato a divertimento degli editti, Policarpo non custodì in silenzio la sua sicurezza come la prudenza suggeriva, ma si fece avanti e rimproverò i persecutori in faccia, denunciando l'ingiustizia e la disumanità di quel che si faceva e confessando apertamente di essere anch'egli cristiano, lo spettatore che rifiutava l'immunità dello spettatore, e convertiva la sua indignazione nell'unica moneta che il tribunale riconoscesse, una vita posta sul tavolo.", "patron": "Si invoca per quanti parlano contro la crudeltà; per i persecutori rimproverati in faccia."},

"Martyr Potitus at Naples":
{"type": "Laico · II sec.", "life": "Il santo martire Potito patì nel secondo secolo sotto l'imperatore Antonino Pio. Venuto a conoscere la fede cristiana da fanciullo, fu battezzato all'età di tredici anni, e quando il padre pagano cercò prima con la persuasione e poi con le minacce di distoglierlo da Cristo, il padre stesso fu vinto dalla saldezza del figlio e divenne cristiano.", "patron": "Si invoca per i malati; per la liberazione dai demoni."},

"Martyr Quadratus and those with him at Corinth":
{"type": "Martire · III sec.", "life": "Il santo martire Quadrato di Corinto nacque nel deserto e fu allevato dal cielo stesso: durante una persecuzione del terzo secolo sua madre, donna pia di nome Rufina, fuggì da Corinto sui monti per sfuggire agli inseguitori, e là partorì un figlio e poco dopo morì.", "patron": "Si invoca per i medici; per gli orfani."},

"Martyr Quadratus and those with him at Nicomedia":
{"type": "Martire · III sec.", "life": "Il santo martire Quadrato di Nicomedia patì con Saturnino, Rufino e altri nelle persecuzioni dell'imperatore Decio e del suo successore Valeriano. Disceso da illustre famiglia e provvisto di considerevoli ricchezze, Quadrato non risparmiò i suoi beni per Cristo, ma li spese per i carcerati: quando le prigioni di Nicomedia si riempirono di cristiani, andò da loro apertamente, corrompendo le guardie per entrare, provvedendo ai bisogni dei prigionieri, fasciandone le ferite, e soprattutto fortificandone le anime per il certame che le attendeva, il ricco che convertiva la sua fortuna in coraggio per i poveri.", "patron": "Si invoca per quanti visitano i carcerati; per i ricchi che spendono se stessi."},

"Martyr Romanus the Deacon of Caesarea":
{"type": "Diacono · IV sec.", "life": "Il santo martire Romano, diacono della chiesa di Cesarea di Palestina, si trovava ad Antiochia quando la persecuzione di Diocleziano si abbatté su quella città; e vedendo i cristiani che accorrevano impauriti alla festa pagana per salvarsi la vita con il sacrificio, stette alle porte e gridò loro di ricordarsi di Cristo, ritraendone molti dall'apostasia sulla soglia stessa del tempio.", "patron": "Si invoca per i diaconi; per i predicatori."},

"Martyr Romulus and with him many others":
{"type": "Martiri · II sec.", "life": "Il santo martire Romolo visse sotto l'imperatore Traiano e teneva un alto ufficio alla corte imperiale. Quando l'imperatore, in guerra in Oriente, ordinò il censimento dei cristiani che servivano nei suoi eserciti, ne furono trovati undicimila, ed egli comandò che fossero tutti privati del grado e mandati in esilio in Armenia.", "patron": "Si invocano per i soldati."},

"Martyr Sabinus (Abibus) of Egypt":
{"type": "Martire · III sec.", "life": "Il santo martire Sabino, detto anche Abibo, era uomo ragguardevole di Ermopoli in Egitto, di alto stato e noto per la sua carità; e quando la persecuzione cadde sulla chiesa egiziana sotto Diocleziano, i cristiani della città lo supplicarono di conservarsi, e Sabino si ritirò con pochi compagni in una capanna fuori della città, dove rimasero nascosti, sostenendosi nella preghiera e nel digiuno mentre la tempesta passava per Ermopoli.", "patron": "Si invoca per i traditi; per i benefattori ripagati con il male."},

"Martyr Sabinus of Egypt":
{"type": "Martire · III sec.", "life": "Il santo martire Sabino d'Egitto, che i calendari greci commemorano in questo giorno e gli slavi il tredici di marzo, era cittadino ragguardevole di Ermopoli, stimato nella città e generoso con i suoi poveri; e quando la persecuzione del tempo di Diocleziano si abbatté sull'Egitto, i cristiani di Ermopoli lo indussero a conservarsi per il bene del gregge, e Sabino si ritirò con una manciata di compagni in una capanna fuori della città, dove rimasero nascosti nel digiuno e nella preghiera continua mentre i tribunali sbrigavano i confessori della città.", "patron": "Si invoca per i traditi; per i benefattori ripagati con il male."},

"Martyr Savva Stratelates “the General” of Rome, and 70 soldiers with him":
{"type": "Martire · III sec.", "life": "Il santo martire Saba Stratilate, il generale, era goto di stirpe e salì nel servizio romano al grado di comandante militare sotto l'imperatore Aureliano, e visse dentro quella carriera una vita che il grado non era mai stato fatto per contenere: cristiano fin dalla giovinezza, osservò i comandamenti con l'esattezza di un soldato, diede ai bisognosi e fece delle carceri il suo secondo posto di servizio, visitando i confessori nelle loro catene, provvedendo ai loro bisogni e fortificandoli per i loro certami, il generale che passava in rassegna le truppe della Chiesa con la stessa dedizione di quelle dell'impero.", "patron": "Si invoca per i comandanti; per quanti visitano i carcerati."},

"Martyr Sebastian at Rome, and his companions":
{"type": "Martiri · III sec.", "life": "Il santo martire Sebastiano e i suoi compagni patirono a Roma nell'anno 288, sotto Diocleziano. Sebastiano, capitano della guardia pretoria, onorato dagli imperatori e segretamente cristiano, usò il suo grado come scudo per la Chiesa; e quando i fratelli gemelli Marco e Marcellino, imprigionati per la fede, cominciarono a vacillare davanti alle lacrime dei genitori pagani, Sebastiano venne al carcere e talmente li fortificò con le sue parole che ne fu guadagnata invece tutta la casa: mentre parlava, Zoe, moglie del carceriere Nicostrato, muta da sei anni, gli cadde ai piedi e riebbe la parola, e a quel prodigio Nicostrato con i suoi prigionieri, il padre dei gemelli Tranquillino, guarito dalla sua lunga infermità, la loro madre, tutta la compagnia del sacerdote e molti altri ricevettero il santo battesimo, divenendo il carcere una chiesa.", "patron": "Si invocano per i soldati; per gli arcieri."},

"Martyr Serapion":
{"type": "Laico · III sec.", "life": "Il santo martire Serapione patì per Cristo nella persecuzione dell'imperatore Severo. Condotto davanti al governatore Achille e comandato di rinnegare la sua fede, si proclamò fermamente cristiano e confessò il vero Dio davanti ai pagani, e per questo fu sottoposto a torture disumane e gettato in carcere.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Martyr Severian of Sebaste":
{"type": "Martire · IV sec.", "life": "Il santo martire Severiano, nobile di Sebaste in Armenia, patì per Cristo nell'anno 320, nella persecuzione dell'imperatore Licinio. Quando i quaranta martiri di Sebaste giacevano in carcere per la loro confessione di Cristo, Severiano mostrò loro una compassione aperta e senza timore, visitandoli nelle catene, incoraggiandone gli animi e fortificandoli per il loro certame sul lago ghiacciato.", "patron": "Si invoca per la cura dei carcerati; per la confessione salda."},

"Martyr Solomonia, mother of the Holy Seven Maccabee Martyrs":
{"type": "Madre · II sec. a.C.", "life": "Santa Solomonia era la madre dei sette fratelli Maccabei che patirono sotto Antioco Epifane per la loro fedeltà alla Legge di Dio. Invece di consigliare ai figli di salvarsi la vita infrangendo l'alleanza, questa madre valorosa esortò ciascuno di loro a rimanere fedele a Dio anche di fronte alla morte, e con un coraggio superiore alla sua natura vide tutti e sette morire in un solo giorno, esortandoli a resistere.", "patron": "Si invoca per le madri; per il coraggio."},

"Martyr Sophia and her three daughters at Rome":
{"type": "Martiri · II sec.", "life": "La santa martire Sofia e le sue tre giovani figlie, Fede, Speranza e Carità, patirono a Roma verso l'anno 137, sotto l'imperatore Adriano. Sofia, il cui nome significa Sapienza, era una vedova cristiana che aveva chiamato le figlie con i nomi delle tre grandi virtù e le aveva allevate in fervente amore per Cristo.", "patron": "Si invocano per le madri."},

"Martyr Sozon of Cilicia":
{"type": "Martire · IV sec.", "life": "Il santo martire Sozonte, nativo della Licaonia e chiamato Tarasio prima del battesimo, era un pastore che visse alla fine del terzo secolo, studiando le sante Scritture mentre custodiva i greggi e ammirando la mitezza delle sue pecore, che si sforzava di imitare e di superare.", "patron": "Si invoca per i pastori."},

"Martyr Stephanida of Damascus":
{"type": "Martire · II sec.", "life": "La santa martire Stefanide patì a Damasco nel secondo secolo, nella persecuzione di Marco Aurelio. Giovane cristiana di nascita spagnola e moglie di un soldato, stava fra gli spettatori al supplizio del santo martire Vittore; e vedendo la grazia di Dio che lo sosteneva, vide, come narra il racconto, due corone che scendevano dal cielo, una per Vittore e una per sé, e gridò apertamente, benedicendo il martire e confessandosi cristiana.", "patron": "Si invoca per le giovani spose; per la testimonianza accesa dalla testimonianza."},

"Martyr Susanna, Queen of Georgia":
{"type": "Martire · V sec.", "life": "Santa Šušanik, detta Susanna, era moglie di Varsken, signore di Hereti nella Georgia orientale, ed era stata allevata fin dall'infanzia in una famiglia cristiana devota. Quando suo marito si recò dal re persiano e là rinnegò Cristo per adorare il fuoco, promettendo di convertire al ritorno la moglie e i figli, Šušanik ne fu ferita nel cuore e pianse amaramente per lui, e quando egli tornò e la incalzò a seguirlo rispose senza vacillare che come egli aveva abbandonato il suo Creatore, così ella abbandonava lui, e che sarebbe morta piuttosto che perdere l'anima.", "patron": "Si invoca per la confessione salda; per quanti sono perseguitati dalla famiglia per la fede."},

"Martyr Tathuil, and his sister, Bebaia":
{"type": "Martiri · II sec.", "life": "I santi martiri Tathuil e sua sorella Bebaia patirono per Cristo a Edessa ai giorni dell'imperatore Adriano, per la loro predicazione ardita e feconda del Vangelo fra i pagani. Tathuil, che alcuni racconti chiamano Tifael, si era volto dal servizio degli idoli al vero Dio, e per le sue parole molti furono condotti alla fede.", "patron": "Si invocano per la predicazione ardita; per la confessione salda."},

"Martyr Tation (Tatio) of Claudiopolis":
{"type": "Martire · IV sec.", "life": "Il santo martire Tazione visse in Bitinia e patì per Cristo nella persecuzione di Diocleziano. Quando si seppe che era cristiano, fu preso e condotto alla città di Claudiopoli davanti al governatore Urbano, il quale molte volte lo esortò a rinnegare Cristo e, non volendo egli, lo gettò in carcere e lo sottopose a vari tormenti, facendolo battere con i bastoni.", "patron": "Si invoca per la confessione salda."},

"Martyr Terence and 40 others beheaded at Carthage":
{"type": "Martiri · III sec.", "life": "Il santo martire Terenzio e i suoi quaranta compagni patirono a Cartagine nella persecuzione di Decio, verso l'anno 250, e la loro è la commemorazione principale della schiera africana che la Chiesa ricorda anche in marzo; i calendari conservano i nomi dei capi, Terenzio, Africano, Massimo, Pompeo, e con loro Zenone, Alessandro, Teodoro e Macario, e contano tutta la messe a più di quaranta corone.", "patron": "Si invocano per le schiere dei confessori; per i carcerati."},

"Martyr Theodota and her three sons in Bithynia":
{"type": "Laica · IV sec.", "life": "La santa martire Teodota e i suoi tre giovani figli patirono durante la persecuzione di Diocleziano. Cristiana e vedova di Nicea in Bitinia, conduceva vita devota e allevava i figli nella fede, ed era stretta amica spirituale di sant'Anastasia. Quando la persecuzione si levò e le sante donne furono arrestate, il funzionario Leucadio, preso dalla bellezza di Teodota, la condusse in casa sua con l'intenzione di sposarla.", "patron": "Si invoca per le madri; per la purezza."},

"Martyr Theodota at Nicea":
{"type": "Martire · III sec.", "life": "La santa martire Teodota patì per Cristo a Nicea di Bitinia verso l'anno 230, sotto l'imperatore Alessandro Severo. Denunciata come cristiana, fu gettata in carcere e vi fu tenuta a lungo, e condotta a giudizio confessò il suo Signore senza vacillare.", "patron": "Si invoca per la confessione salda."},
...
{"type": "Martire · IV sec.", "life": "Il santo martire Teodoto e le sette sante vergini Alessandra, Tecusa, Claudia, Faine, Eufrasia, Matrona e Giulia patirono ad Ancira di Galazia nella grande persecuzione allo scorcio del quarto secolo, e la loro storia intrecciata è una delle più commoventi del calendario, unendo il coraggio di sette donne anziane alla devozione dell'uomo che le seppellì.", "patron": "Le reliquie dei martiri sottratte e sepolte."},

"Martyr Thomais of Alexandria":
{"type": "Martire · V sec.", "life": "La santa martire Tomaide di Alessandria era una giovane sposa di quella città, allevata nella pietà e maritata a un pescatore, e il suo martirio le venne addosso non da un impero ma da dentro la sua stessa casa. Una notte, mentre suo marito era via alla pesca, il padre di lui, per suggestione del diavolo e preso dalla bellezza di lei, tentò di trascinare la nuora al peccato.", "patron": "Si invoca per quanti hanno subito violenza; per le mogli."},

"Martyr Timothy the Reader and his wife, Maura, in Egypt":
{"type": "Martire · IV sec.", "life": "I santi martiri Timoteo e Maura, marito e moglie, patirono nella Tebaide d'Egitto nella grande persecuzione, nell'anno 304 secondo il computo del sinassario melchita, o verso il 286 come calcolano alcuni libri, e il loro certame è il più tenero ritratto che la Chiesa possieda del matrimonio perfezionato nel sangue.", "patron": "I libri sottratti al fuoco."},

"Martyr Troadius of Neocaesarea":
{"type": "Martire · III sec.", "life": "Il santo martire Troadio di Neocesarea patì nella persecuzione di Decio, verso l'anno 250, giovane di quella città pontica il cui certame è famoso meno per il proprio verbale che per il suo spettatore, poiché la Chiesa conosce Troadio soprattutto attraverso gli occhi di un santo che lo guardò da miglia lontano.", "patron": "Si invoca per i giovani nella prova; per quanti sono sostenuti da una preghiera invisibile."},

"Martyr Trophimus and 14 Others in Lycia":
{"type": "Laici · IV sec.", "life": "I santi martiri Trofimo, Teofilo e altri tredici con loro patirono per Cristo in Licia durante la persecuzione dell'imperatore Diocleziano. Condotti a giudizio, si confessarono arditamente cristiani e rifiutarono di offrire sacrificio agli idoli, e dopo essere stati sottoposti a fiere torture furono loro spezzate le gambe e furono gettati in un fuoco.", "patron": "Si invocano per la confessione salda."},

"Martyr Tryphaίnē at Cyzicus":
{"type": "Martire · I sec.", "life": "La santa martire Trifena di Cizico, la città sull'Ellesponto, era figlia del senatore Anastasio e della sua devota moglie Socratia, e fu allevata in una pietà che il suo certame rese pubblica; poiché quando la persecuzione cadde sulla città ed ella vide i deboli fra i cristiani tremare verso il rinnegamento, Trifena non attese di essere trovata ma confessò la sua fede arditamente e apertamente, proclamando Cristo e il trionfo finale della sua verità proprio per fortificare gli esitanti, offrendosi l'anima forte come l'esempio di cui gli impauriti avevano bisogno.", "patron": "Si invoca per le madri che allattano; per le donne che rinsaldano i deboli."},

"Martyr Tryphon of Lampsacus Near Apamea in Syria":
{"type": "Martire · III sec.", "life": "Il santo martire Trifone nacque nel villaggio di Kampsada presso Apamea in Frigia, contadinello che badava alle oche; e sopra questo meno titolato fra i guaritori della Chiesa il Signore riversò fin dai primi anni il potere di cacciare i demoni e di curare ogni malattia. I suoi prodigi ebbero la misura della sua carità: salvò dalla fame il suo distretto natale respingendo con la preghiera una piaga di locuste che divorava il grano, comandando il guardiano d'oche ai distruttori dei campi.", "patron": "Si invoca per i giardinieri; per i contadini."},

"Martyr Urpasianus of Nicomedia":
{"type": "Martire · IV sec.", "life": "Il santo martire Urpasiano patì nella città di Nicomedia sotto l'imperatore Massimiano Galerio, che perseguitò crudelmente i cristiani che servivano nel suo esercito e alla sua corte; e in quel vaglio, come registrano le Vite, alcuni dei timidi d'animo cominciarono a vacillare e ad adorare gli dèi pagani, mentre i forti tennero fino alla fine, e Urpasiano stette a capo dei forti.", "patron": "Si invoca per i cortigiani; per quanti rinunciano al rango per Cristo."},

"Martyr Valerian":
{"type": "Martire · III sec.", "life": "Il santo martire Valeriano è commemorato in questo giorno insieme al martire Filomeno di Ancira, fra quelli che patirono in Galazia nella persecuzione dell'imperatore Aureliano, verso l'anno 274. I sinassari greci registrano che fu perfezionato nel martirio per mezzo della spada: confessando Cristo davanti ai persecutori e rifiutando ogni ingiunzione di sacrificare, fu decapitato, e la sua anima salì al Signore per il quale aveva stimato nulla la propria vita.", "patron": "Si invoca per i fedeli di cui non resta memoria."},

"Martyr Varus, and seven Monastic Martyrs with him":
{"type": "Martire · IV sec.", "life": "Il santo martire Varo era comandante militare in Egitto ai giorni della persecuzione di Massimiano, e cristiano in segreto, che di notte visitava i confessori imprigionati, portando loro cibo, fasciandone le ferite e fortificandone le anime. Una volta passò tutta la notte in carcere con sette maestri asceti dei cristiani che attendevano l'esecuzione, ammirandone il coraggio e dolendosi che il timore lo avesse fino allora trattenuto dalla confessione aperta.", "patron": "Si invoca per i soldati; per i defunti morti fuori della fede."},

"Martyr Victor at Damascus":
{"type": "Martire · II sec.", "life": "Il santo martire Vittore era un soldato d'Italia che prestava servizio a Damasco sotto Marco Aurelio; e quando la persecuzione esigette dall'esercito il sacrificio, si dichiarò cristiano e rifiutò. Il comandante lo consegnò a tormenti di straordinaria crudeltà: gli furono spezzate e storte le dita, fu gettato in un forno ardente e vi rimase tre giorni illeso, e fu chiamato un mago a distruggerlo con cibi avvelenati, ma il martire mangiò e non ne ebbe danno, al che il mago, vedendo che la potenza di Cristo era maggiore di tutte le sue arti, gettò via i suoi libri, credette e confessò egli stesso Cristo.", "patron": "Si invoca per i soldati; per la costanza oltre la natura."},

"Martyr Victor, and his companions, of Nicomedia":
{"type": "Martiri · IV sec.", "life": "I santi martiri Vittore, Zotico, Zenone, Acindino e Severiano patirono a Nicomedia nell'anno 303, e le loro corone furono accese al fuoco di un altro: erano fra la moltitudine che contemplò il certame del santo grande martire Giorgio, allora torturato alla corte imperiale con tutta la crudeltà inventiva della capitale di Diocleziano, e quel che lo spettacolo era fatto per insegnare loro, la vanità della speranza cristiana, lo insegnò al rovescio.", "patron": "Si invocano per i soldati convertiti dalla testimonianza altrui; per gli spettatori che passano dall'altra parte."},

"Martyr Vincent of Spain":
{"type": "Diacono · IV sec.", "life": "Il santo martire Vincenzo di Spagna era arcidiacono della chiesa di Saragozza sotto l'anziano vescovo Valerio, al cui impedimento di parola il diacono eloquente supplì, predicando la parola di Dio nel nome del suo vescovo; e quando la persecuzione di Diocleziano giunse in Spagna, il governatore Daciano li fece arrestare entrambi e condurre in catene a Valencia.", "patron": "Si invoca per i diaconi; per i predicatori."},

"Martyr Zosimas the Hermit of Cilicia":
{"type": "Monaco · IV sec.", "life": "Il santo martire Zosima l'eremita visse nel quarto secolo come abitatore del deserto in Cilicia, essendosi ritirato dal mondo per servire Dio nella quiete; e tanta grazia dimorava in lui che le fiere del deserto si raccoglievano mansuete intorno a lui come intorno ad Adamo in paradiso.", "patron": "Si invoca per l'armonia con il creato; per la costanza sotto tortura."},

"Martyr Zosimus the Soldier at Antioch, in Pisidia":
{"type": "Martire · II sec.", "life": "Il santo martire Zosima soldato patì per Cristo nell'età delle persecuzioni, ed è onorato per la salda confessione con la quale un uomo d'arme depose la vita per il suo Signore.", "patron": "I soldati che confessano Cristo; quanti sono torturati per la fede."},

"Martyr Zoticus the Keeper of Orphans":
{"type": "Sacerdote · IV sec.", "life": "Il santo ieromartire Zotico, custode degli orfani, era un illustre e ricco romano al servizio di san Costantino il Grande, e venne con l'imperatore alla nuova capitale sul Bosforo, dove fu ordinato sacerdote e dove le sue ricchezze trovarono la loro vocazione. Quando un editto, temendo il contagio, condannò all'annegamento i lebbrosi della città, Zotico andò dall'imperatore e chiese oro per comprare pietre preziose e perle a gloria dell'impero.", "patron": "Si invoca per gli orfani; per i lebbrosi."},

"Martyr and Archdeacon Euplus of Catania":
{"type": "Diacono · IV sec.", "life": "Il santo arcidiacono Euplo patì nell'anno 304 nella città siciliana di Catania, durante la persecuzione di Diocleziano e Massimiano. Portava il Vangelo con sé dovunque e predicava arditamente Cristo ai pagani, e una volta, mentre leggeva e spiegava al popolo il libro sacro, fu preso e condotto a giudizio.", "patron": "Si invoca per i diaconi; per la predicazione del Vangelo."},

"Martyr and Archdeacon Laurence, and those with him, of Rome":
{"type": "Diacono · III sec.", "life": "Il santo arcidiacono Lorenzo e quelli con lui patirono a Roma nell'anno 258, nella persecuzione dell'imperatore Valeriano. San Sisto, ateniese che era stato filosofo prima di farsi cristiano, era allora vescovo di Roma, e quando fu preso con i suoi diaconi Felicissimo e Agapito, Lorenzo lo seguì piangendo e supplicando di condividerne la morte, dicendo, Dove vai, padre, senza il tuo figlio?", "patron": "Si invoca per i diaconi; per i cuochi."},

"Martyred Holy Fathers who were slain at the Monastery of Saint Savva":
{"type": "Monaci martiri · VIII sec.", "life": "I santi padri uccisi al monastero di San Saba patirono nell'anno 796, secondo alcuni racconti nel 797, quando bande di predoni arabi, in una stagione di anarchia in Palestina, piombarono sulla Grande Lavra nel deserto di Giuda; e il loro martirio è noto alla Chiesa in rari particolari, poiché uno dei sopravvissuti mise per iscritto un racconto oculare di ogni cosa.", "patron": "Si invocano per i monaci sotto le incursioni; per le comunità che non vogliono disperdersi."},

"Martyrs Acindynus, Pegasius, Aphthonius, Elpidephorus, Anempodistus, and 7,000 with them, of Persia":
{"type": "Martiri · IV sec.", "life": "I santi martiri Acindino, Pegasio, Aftonio, Elpidoforo e Anempodisto, con settemila martiri, patirono in Persia verso l'anno 341, sotto il re Sapore secondo. Acindino, Pegasio e Anempodisto erano cortigiani del re e cristiani in segreto; e quando Sapore levò la sua persecuzione contro la Chiesa, furono denunciati e condotti a giudizio, dove confessarono apertamente Cristo e furono consegnati a tormenti tanto crudeli che prodigio dopo prodigio li accompagnò, essendo i sofferenti preservati interi mentre i loro tormentatori cadevano accecati ed erano di nuovo guariti alla preghiera dei martiri.", "patron": "Si invocano per i cortigiani; per i funzionari."},

"Martyrs Adrian and Natalia and 23 companions, of Nicomedia":
{"type": "Martiri · IV sec.", "life": "Sant'Adriano era un ufficiale pagano della corte imperiale a Nicomedia nella persecuzione di Massimiano, e trovandosi presente mentre ventitré cristiani erano torturati per la loro fede, ammirò la loro saldezza e chiese quale ricompensa sperassero di ricevere; e quando essi parlarono dei beni che Dio ha preparati per quelli che lo amano, fu improvvisamente mosso a dichiararsi anch'egli cristiano, sicché il suo nome fu scritto fra i condannati.", "patron": "Si invocano per gli sposi; per il matrimonio."},

"Martyrs Africanus, Publius, and Terence, of Carthage":
{"type": "Martiri · III sec.", "life": "I santi martiri Africano, Publio e Terenzio patirono a Cartagine nella persecuzione di Decio, verso l'anno 250, tre nomi serbati in questo giorno di una schiera più ampia di confessori la cui commemorazione principale la Chiesa celebra in aprile; e gli uffici in loro onore erano anticamente celebrati nel monastero detto Paulopetrion, celebrando la capitale d'Oriente la festa dei martiri d'Africa, come la Chiesa ha sempre messo in comune i suoi testimoni al di là dei mari.", "patron": "Si invocano per le schiere dei confessori; per la fossa dei serpenti attraversata senza danno."},

"Martyrs Agapius, Publius, Timolaus, Romulus, two named Dionysius, and two named Alexander, at Caesarea in Palestine":
{"type": "Martiri · IV sec.", "life": "I santi martiri Agapio, Publio, Timolao, Romolo, i due di nome Dionisio e i due di nome Alessandro patirono a Cesarea di Palestina allo scoppiare della grande persecuzione, decapitati il ventiquattro di marzo dell'anno 304 secondo il computo di Eusebio e del sinassario greco, o nel 303 secondo i racconti slavi, e il loro certame è conservato alla Chiesa da un testimone oculare, poiché Eusebio di Cesarea, che visse quegli anni in quella città, lo registrò fra i martiri della Palestina.", "patron": "Si invocano per i giovani; per i volontari della confessione."},

"Martyrs Agathopodes the Deacon and Theodulus the Reader at Thessalonica":
{"type": "Martiri · IV sec.", "life": "I santi martiri Agatopode diacono e Teodulo lettore servirono un solo altare a Tessalonica e ricevettero una sola corona, raccogliendo la persecuzione degli anni di Diocleziano in una sola rete i due estremi del ministero della chiesa, un diacono anziano pieno di anni e di riverenza e un giovane lettore radioso di purezza, il nonno e il ragazzo dello stesso santuario.", "patron": "Si invocano per i diaconi e i lettori; per il vecchio e il giovane aggiogati in una sola confessione."},

"Martyrs Akepsimas and Aithalas of Egypt":
{"type": "Martiri · IV sec.", "life": "I santi martiri Acepsima e Aitala patirono ad Arbela nella terra di Persia, nelle persecuzioni che i re persiani levarono contro la Chiesa, quando i magi incalzavano i cristiani dell'impero ad adorare il sole e il fuoco e sigillavano con il sangue i loro rifiuti. La tradizione di quella Chiesa sofferente narra che Aitala era stato egli stesso sacerdote degli idoli ad Arbela prima che la grazia di Cristo lo trovasse, sicché i persecutori perdettero a favore del Vangelo uno dei propri ministri d'altare, ferita che non perdonarono mai.", "patron": "Si invocano per la Chiesa sotto la Persia; per i sacerdoti degli idoli convertiti."},

"Martyrs Amphianus and Edesius of Lycia":
{"type": "Martiri · IV sec.", "life": "I santi martiri Anfiano ed Edesio, chiamati in greco Apfiano e Edesio, erano fratelli di una ricca casa pagana della Licia, mandati alle celebri scuole di Berito, dove invece del mondo trovarono Cristo; e Apfiano, lasciate famiglia ed eredità, venne a Cesarea di Palestina e si unì al santo Panfilo, nella cui scuola di Scrittura e di santità Eusebio, lo storico della sua morte, gli fu condiscepolo.", "patron": "Si invocano per gli studenti; per i fratelli."},

"Martyrs Ananias the Presbyter, Peter, and seven soldiers, in Phoenicia":
{"type": "Martiri · III sec.", "life": "I santi martiri Anania presbitero, Pietro guardia carceraria e sette soldati patirono in Fenicia nell'anno 295, durante la persecuzione di Diocleziano. Anania, sacerdote di quel paese, fu arrestato per aver confessato Cristo e rifiutato gli idoli, e condotto davanti a Massimo, governatore della Fenicia, che gli impose tutta la grammatica dei tribunali: il presbitero fu battuto con i martelli, bruciato con il fuoco e gli fu strofinato del sale nella carne arsa, e sopportò tutto con la compostezza di un uomo il cui tesoro era altrove.", "patron": "Si invocano per i sacerdoti; per le guardie carcerarie."},

"Martyrs Anatolius and Protoleon, soldiers converted by witnessing the martyrdom of Saint George":
{"type": "Martiri · IV sec.", "life": "I santi martiri Anatolio e Protoleone erano soldati a Nicomedia, e le loro corone furono vinte in un solo istante, l'istante in cui la ruota fallì. Quando il grande martire Giorgio fu stato spezzato, come tutti credevano, sulla ruota di lame, e la corte si era dispersa soddisfatta che il campione dei cristiani fosse distrutto, il martire fu trovato in piedi e intero, guarito dall'angelo del Signore, davanti alle guardie stupefatte.", "patron": "Si invocano per i soldati; per i primi a farsi avanti."},
...
{"type": "Martiri · I sec.", "life": "I santi martiri Leonzio, Ipazio e Teodulo patirono per Cristo a Tripoli di Fenicia nella prima età della Chiesa, e il loro martirio è la storia di un persecutore mutato in compagno di confessione.", "patron": "I soldati e i comandanti; quanti si convertono mentre perseguitano."},

"Martyrs Manuel and Theodosius":
{"type": "Martiri · IV sec.", "life": "I santi martiri Manuele e Teodosio patirono nell'anno 304, al colmo della grande persecuzione, e appartengono a quella schiera di testimoni che le morti altrui arruolarono: vedendo la costanza dei martiri della loro regione, i tormenti sopportati con gioia e le corone ricevute davanti alle folle, i due giovani non ne furono spaventati, come i persecutori intendevano che ogni spettatore fosse, ma accesi, funzionando lo spettacolo dell'arena esattamente al rovescio, come fece per tutta quell'età, e facendo convertiti del suo pubblico.", "patron": "Si invocano per quanti sono mossi dall'esempio dei martiri; per la confessione offerta spontaneamente."},

"Martyrs Manuel, Sabel, and Ismael, of Persia":
{"type": "Martiri · IV sec.", "life": "I santi martiri Manuele, Sabel e Ismaele erano tre fratelli di nobile stirpe persiana che patirono per Cristo alla corte di Giuliano l'Apostata nel quarto secolo, e il loro martirio mutò un'ambasceria di pace in una testimonianza di fede.", "patron": "Gli inviati e gli ambasciatori; i fratelli nella fede."},

"Martyrs Marcian and Martyrius, the Notaries of Constantinople":
{"type": "Martiri · IV sec.", "life": "I santi martiri Marciano e Martirio servivano come notai, cioè segretari e lettori, di san Paolo il confessore, patriarca di Costantinopoli, negli anni in cui l'eresia ariana, sostenuta dalla corte imperiale, infuriava contro i difensori della fede nicena. Quando il santo patriarca fu esiliato e strangolato di nascosto nell'esilio, gli ariani cercarono di guadagnarsi i suoi fedeli notai, offrendo loro oro, onori e perfino troni episcopali se avessero abbracciato l'eresia che faceva del Figlio di Dio una creatura.", "patron": "Si invocano per i notai; per i segretari."},

"Martyrs Maurice and his son, Photinus, and Martyrs Theodore, Philip, and 70 soldiers, at Apamea in Syria":
{"type": "Martiri · IV sec.", "life": "Il santo martire Maurizio, comandante militare di Apamea in Siria, patì nell'anno 305 sotto Massimiano Galerio, insieme al figlio Fotino e ai settanta soldati del suo comando, dei quali soltanto due nomi, Teodoro e Filippo, sono giunti fino a noi, essendo gli altri scritti, come dicono i padri di tali schiere, nel solo Libro della Vita.", "patron": "Si invocano per i comandanti; per i padri e i figli in armi."},

"Martyrs Maximus, Theodotus, Hesychius, and Asclepiodota, of Adrianopolis":
{"type": "Martiri · IV sec.", "life": "I santi martiri Massimo, Teodoto, Esichio e Asclepiodota patirono in Tracia nella persecuzione di Massimiano, verso l'anno 305, tre uomini di Adrianopoli e con loro Asclepiodota, donna di nobile famiglia il cui coraggio diede il tono a tutto il certame della schiera. Denunciati come cristiani negli anni in cui gli editti imperiali vuotavano le chiese dei Balcani, i quattro furono presi e condotti a giudizio, e risposero all'offerta consueta, sacrifica e vivi, con il rifiuto consueto che i tribunali non riuscivano mai del tutto a credere da parte di gente con beni, posizione e anni ancora davanti; e Asclepiodota in particolare stupì la corte, incontrando la nobildonna con una fermezza che i soldati fra gli spettatori rispettarono le minacce pensate per la mollezza del suo rango, notando i racconti di tali martirii ancora e ancora che i persecutori trovavano le donne le più difficili da spezzare.", "patron": "Si invocano per i compagni nella prova; per le nobildonne coraggiose."},

"Martyrs Menas, Hermogenes, and Eugraphus, of Alexandria":
{"type": "Martiri · IV sec.", "life": "I santi martiri Mena, Ermogene ed Eugrafo patirono ad Alessandria verso l'anno 313, sotto l'imperatore Massimiano, e il loro certame è una catena di conversioni forgiata sotto la tortura. Mena, ateniese famoso per l'eloquenza, che i greci chiamano Kallikelados, il soavemente parlante, fu mandato dall'imperatore ad Alessandria per acquietare la discordia fra pagani e cristiani.", "patron": "Si invocano per gli oratori; per i giudici."},

"Martyrs Menodora, Metrodora, and Nymphodora, at Nicomedia":
{"type": "Martiri · IV sec.", "life": "Le sante vergini martiri Menodora, Metrodora e Ninfodora erano sorelle di Bitinia nell'Asia Minore, le quali, desiderando conservare a Cristo la loro verginità e sfuggire alla vanità del mondo, si ritirarono in un luogo solitario fra le colline, dove vissero nel digiuno e nella preghiera; e la fama della loro santità si sparse, poiché guarigioni cominciarono a scorrere per le loro preghiere.", "patron": "Si invocano per l'amore fra sorelle; per la purezza."},

"Martyrs Modestus, Crescentia, and Vitus, at Lucania":
{"type": "Martiri · IV sec.", "life": "I santi martiri Vito, Modesto e Crescenzia patirono per Cristo nella persecuzione di Diocleziano, e la loro schiera unì un fanciullo al precettore e alla nutrice che lo avevano allevato nella fede e morirono con lui.", "patron": "I bambini e i loro tutori; i precettori e le nutrici."},

"Martyrs Nestor, Tribimius, and those with them":
{"type": "Martiri · III sec.", "life": "I santi martiri Nestore, Tribimio, Marcello e Antonio di Perge in Panfilia patirono sotto l'imperatore Decio, verso l'anno 250, nella persecuzione che esigeva da ogni anima dell'impero un certificato di sacrificio e faceva di ogni rifiuto un caso capitale. I quattro erano cristiani di Perge che non attesero di essere trovati: come registra la loro vita, predicavano Cristo senza timore nella città, confessando apertamente nella stagione in cui la prudenza consigliava le cantine, e i pagani, scandalizzati da un ardire là dove l'editto si aspettava il silenzio, li denunciarono al governatore della regione, consegnando al tribunale quattro uomini che si erano, in effetti, denunciati da sé per primi, dividendosi dovunque i martiri dell'anno di Decio fra i cercati e quelli che si annunciavano da sé, e stando i quattro di Perge con i secondi.", "patron": "Si invocano per i compagni nella confessione; per quattro corone per la spada."},

"Martyrs Nikephoros, Antoninus, and Germanus of Caesarea, in Palestine":
{"type": "Martiri · IV sec.", "life": "I santi martiri Antonino, Niceforo e Germano patirono a Cesarea di Palestina verso l'anno 308, sotto Massimino, quando il governatore Firmiliano spingeva la persecuzione contro la Chiesa con sacrifici e spettacoli pubblici. Mentre i riti pagani si celebravano davanti alla città radunata, i tre cristiani si fecero avanti di loro volontà e, stando davanti al governatore, rimproverarono il culto degli idoli senza vita e confessarono a gran voce l'unico vero Dio e il suo Cristo.", "patron": "Si invocano per l'audacia davanti ai persecutori."},

"Martyrs Onesiphorus and Porphyrius of Ephesus":
{"type": "Martiri · III sec.", "life": "I santi martiri Onesiforo e Porfirio patirono per Cristo nella persecuzione di Diocleziano, verso la fine del terzo secolo. Confessandosi cristiani, furono condotti a giudizio e sottoposti a fieri tormenti, battuti e bruciati con il fuoco; e quando né il dolore né le promesse poterono distoglierli da Cristo, i tormentatori legarono i martiri a cavalli selvaggi, che li trascinarono sopra le rocce e i rovi finché non resero a Dio le loro sante anime.", "patron": "Si invocano per la costanza fino alla fine."},

"Martyrs Pamphilius the Presbyter, Valens the Deacon, and those with them, at Caesarea in Palestine":
{"type": "Ieromartire · IV sec.", "life": "I santi martiri Panfilo presbitero, Valente diacono, Paolo, Porfirio, Seleuco, Teodulo, Giuliano e i cinque giovani egiziani Elia, Geremia, Isaia, Samuele e Daniele patirono a Cesarea di Palestina verso l'anno 309, nel settimo anno della grande persecuzione, e il loro certame fu registrato da un testimone oculare che li amava, Eusebio storico, il quale chiamò la loro schiera un'immagine perfetta di tutta un'assemblea della Chiesa.", "patron": "Si invoca per i dotti; per i copisti."},

"Martyrs Patermuthius, Coprius, and Alexander the Soldier, in Egypt":
{"type": "Monaco · IV sec.", "life": "I santi martiri Patermuzio, Coprio e Alessandro patirono in Egitto sotto l'imperatore Giuliano l'Apostata. Patermuzio era stato un tempo pagano e capo di una banda di briganti, ma venuto a penitenza fu battezzato e si ritirò nel deserto, dove si diede alla fatica ascetica e ricevette i doni della guarigione e della profezia.", "patron": "Si invoca per la penitenza; per la perseveranza."},

"Martyrs Paul and Juliana of Syria":
{"type": "Martiri · III sec.", "life": "I santi martiri Paolo e sua sorella Giuliana patirono per Cristo sotto l'imperatore Aureliano, nella città fenicia di Tolemaide. Quando l'imperatore venne in quella città, Paolo, incontrandolo in mezzo alla folla, si fece il segno della Croce, e per questo fu preso e gettato in carcere, e il giorno seguente, condotto a giudizio, confessò la sua fede in Cristo apertamente e senza timore, per il che fu crudelmente torturato.", "patron": "Si invocano per la purezza; per la confessione salda."},

"Martyrs Paul and two sisters, Chionia (Thea) and Alevtina (Valentina), at Cæsarea in Palestine":
{"type": "Laicato · IV sec.", "life": "I santi martiri Paolo e le due sorelle Chionia e Alevtina erano nativi d'Egitto e patirono per Cristo nella persecuzione dell'imperatore Massimiano. Presi per la loro fede, furono condotti a Cesarea di Palestina, dove senza il minimo timore si confessarono seguaci di Cristo davanti ai loro giudici e rifiutarono di sacrificare agli idoli.", "patron": "Si invoca per la confessione senza paura."},

"Martyrs Perpetua, a woman of Carthage, and the Catechumens: Saturus, Revocatus, Saturninus, Secundulus and Felicitas":
{"type": "Martiri · III sec.", "life": "Le sante martiri Perpetua e Felicita, con i catecumeni Saturo, Revocato, Saturnino e Secondulo, patirono a Cartagine verso l'anno 203, e il loro certame è il più intimamente conosciuto della Chiesa antica, poiché Perpetua tenne un diario in carcere, e la Chiesa legge da diciotto secoli la sua propria mano, il più antico scritto che possediamo di una donna cristiana.", "patron": "Si invocano per le madri; per le donne in attesa."},

"Martyrs Peter, Dionysius, Andrew, Paul, and Christina who suffered under Decius":
{"type": "Martire · III sec.", "life": "I santi martiri Pietro, Dionisio, Andrea, Paolo e Cristina patirono per Cristo nella persecuzione dell'imperatore Decio, verso la metà del terzo secolo, e sono commemorati insieme in questo giorno, benché la tradizione ponga le loro sofferenze in più di una città d'Oriente, Pietro, Andrea, Paolo e Dionisio a Lampsaco sull'Ellesponto, e la fanciulla Cristina a Tiro di Fenicia, raccogliendo la Chiesa in una sola memoria i suoi testimoni sparsi di quella persecuzione.", "patron": "La fede custodita sotto Decio."},

"Martyrs Philadelphus, Cyprian, Alphius, Onesimus, Erasmus, and 14 others, in Sicily":
{"type": "Martire · III sec.", "life": "I santi martiri Alfio, Filadelfo e Cipriano, tre fratelli, patirono con il loro maestro Onesimo, con Erasmo e con altri quattordici nella persecuzione di Decio, verso l'anno 251, e il loro certame unì i due estremi del Mediterraneo cristiano, cominciando nell'Italia meridionale e finendo in Sicilia.", "patron": "Tre fratelli e una sola confessione."},

"Martyrs Philemon, Apollonios, Arrian, and Theonas of Alexandria":
{"type": "Martiri · III sec.", "life": "I santi martiri Filemone, Apollonio, Arriano e Teona patirono in Egitto verso l'anno 286, e la loro storia è una staffetta di grazia nella quale ogni corridore passa la corona al seguente. Apollonio, lettore della chiesa di Antinoe, temendo le torture, assoldò il pagano Filemone, suonatore di flauto famoso per tutto l'Egitto, perché si velasse nelle sue vesti e offrisse il sacrificio in suo nome.", "patron": "Si invocano per i musicisti; per i suonatori di flauto."},

"Martyrs Probus, Tarachus, and Andronicus, at Tarsus in Cilicia":
{"type": "Martiri · IV sec.", "life": "I santi martiri Probo, Taraco e Andronico patirono in Cilicia nell'anno 304, nella persecuzione di Diocleziano. Taraco era un anziano soldato romano di sessantacinque anni, che aveva lasciato l'esercito piuttosto che rinnegare Cristo.", "patron": "Si invocano per i soldati; per gli anziani."},

"Martyrs Processus and Martinian of Rome":
{"type": "Martiri · I sec.", "life": "I santi martiri Processo e Martiniano erano i custodi del carcere Mamertino a Roma, le guardie poste sopra i principi degli apostoli Pietro e Paolo nella loro ultima prigionia; e la Chiesa si diletta della loro storia come della perfetta miniatura del metodo del Vangelo, poiché il carcere si convertì al rovescio, da dentro in fuori.", "patron": "Si invocano per le guardie carcerarie; per i custodi convertiti dai loro prigionieri."},

"Martyrs Proclus and Hilary of Ancyra":
{"type": "Laici · II sec.", "life": "I santi martiri Proclo e Ilario erano parenti di un villaggio presso Ancira che patirono nella persecuzione dell'imperatore Traiano. Proclo fu arrestato per primo, e quando confessò arditamente Cristo davanti al governatore Massimo e predisse che il governatore stesso sarebbe stato un giorno costretto a riconoscere il vero Dio, fu crudelmente torturato e fatto correre dietro al carro del governatore.", "patron": "Si invocano per la confessione ardita."},

"Martyrs Rhipsime and Gaianḗ of Armenia and those with them":
{"type": "Martiri · IV sec.", "life": "Le sante martiri Ripsime e Gaiana e le loro compagne erano vergini di una comunità di Roma, che fuggirono in Oriente quando l'imperatore Diocleziano, avendo veduta la bellezza di Ripsime, cercò di prenderla in moglie; e giunte in Armenia, si stabilirono in povertà presso la città di Vagharshapat, vivendo del lavoro delle loro mani.", "patron": "Si invocano per la purezza; per la conversione dell'Armenia."},

"Martyrs Rusticus the Presbyter and Eleutherius the Deacon":
{"type": "Martiri · I sec.", "life": "I santi martiri Rustico presbitero ed Eleuterio diacono furono i fedeli compagni del ieromartire Dionigi l'areopagita nelle sue fatiche apostoliche in Occidente. Viaggiando con lui di terra in terra, ne condivisero la predicazione, i pericoli e le catene, convertendo molti a Cristo a Roma e oltre.", "patron": "Si invocano per la compagnia fedele nel Vangelo."},

"Martyrs Sergius and Bacchus in Syria":
{"type": "Martiri · IV sec.", "life": "I santi martiri Sergio e Bacco erano nobili romani, ufficiali di alto grado nelle truppe di casa dell'imperatore Massimiano, il quale li teneva in onore non sapendo che erano cristiani. Quando fu riferito che non entravano nei templi con la corte, l'imperatore comandò loro di sacrificare.", "patron": "Si invocano per i soldati; per la santa amicizia."},

"Martyrs Simeon, Isaac and Bachtisius, of Persia":
{"type": "Martire · IV sec.", "life": "I santi martiri Simeone, Isacco e Bachtisio patirono per Cristo in Persia, fra la grande schiera di martiri che la Chiesa dell'impero persiano diede a Dio nel quarto secolo, quando la potenza zoroastriana, che teneva il culto del fuoco e del sole come religione dello stato, si volse contro le crescenti comunità cristiane entro i suoi confini e levò una delle persecuzioni più fiere e più lunghe che la Chiesa abbia conosciute, oltre la frontiera orientale di Roma e fuori della protezione di ogni imperatore cristiano.", "patron": "Cristo confessato contro il culto del fuoco."},

"Martyrs Solochon, Pamphamer, and Pamphalon, at Chalcedon":
{"type": "Martire · IV sec.", "life": "I santi martiri Solocone, Panfamer e Panfalone erano soldati, egiziani di nascita, che servivano nell'esercito romano a Calcedonia di Bitinia sotto l'imperatore Massimiano, allo scorcio del quarto secolo, e patirono insieme per aver rifiutato il sacrificio che la persecuzione aveva fatto la prova della lealtà di un soldato.", "patron": "Il sacrificio rifiutato davanti al tribuno."},

"Martyrs Sophia, Irene, and Castor of Egypt":
{"type": "Martiri · III sec.", "life": "Le sante martiri Sofia e Irene patirono per Cristo in Egitto nell'età delle persecuzioni, e con loro è commemorato il martire Castore. Del loro certame poco è stato conservato oltre la testimonianza degli antichi calendari, i quali registrano che le sante donne, avendo confessato Cristo davanti ai loro persecutori e rifiutato di offrire sacrificio agli idoli, furono decapitate di spada, e che anche Castore compì la sua corsa nel martirio.", "patron": "Si invocano per la confessione salda."},

"Martyrs Theodore and his son, John, of Kyiv":
{"type": "Laici · X sec.", "life": "I santi martiri Teodoro il variago e suo figlio Giovanni furono i primi martiri della terra di Rus', vivendo a Kyiv nel decimo secolo, ai giorni prima che il principe Vladimiro abbracciasse la fede. Teodoro, variago di stirpe e cristiano, era tornato a Kyiv con il suo giovane figlio Giovanni.", "patron": "Si invocano per la confessione davanti all'idolatria."},

"Martyrs Theodotus and Rufina of Caesarea, in Cappadocia":
{"type": "Martiri · III sec.", "life": "I santi martiri Teodoto e Rufina, genitori del grande martire Mamante, erano di famiglie patrizie e onorati da tutti per la loro pietà cristiana. Quando il magistrato di Gangra li convocò per aver rifiutato di adorare gli idoli come il decreto imperiale comandava, Teodoto non volle obbedire, e poiché il suo nobile rango vietava al magistrato di punirlo, fu mandato al governatore Fausto a Cesarea di Cappadocia, il quale lo gettò subito in carcere.", "patron": "Si invocano per gli sposi; per la confessione salda."},

"Martyrs Theodotus, Asclepiodotus, and Maximus, of Adrianopolis":
{"type": "Martiri · IV sec.", "life": "I santi martiri Teodoto, Asclepiodota e Massimo patirono al principio del quarto secolo, nella persecuzione di Massimiano Galerio. Massimo e Asclepiodota erano cittadini ragguardevoli di Marcianopoli in Tracia che conducevano una devota vita cristiana, e insieme a Teodoto furono denunciati per la fede e condotti a giudizio.", "patron": "Si invocano per la confessione salda."},

"Martyrs Thyrsos, Leukios, and Kallinikos":
{"type": "Martiri · III sec.", "life": "I santi martiri Tirso, Leucio e Callinico patirono ad Apollonia di Bitinia verso l'anno 250, nella persecuzione di Decio. Leucio aprì il certame: vedendo le crudeltà inflitte ai cristiani, rimproverò in faccia al governatore Cumbricio di far guerra a Dio, e dopo le torture fu decapitato, accendendo la città il suo ardire.", "patron": "Si invocano per i segantini; per i sacerdoti convertiti dagli idoli."},

"Martyrs Timothy, Agapius, and Thekla, of Palestine":
{"type": "Martiri · IV sec.", "life": "I santi martiri Timoteo, Agapio e Tecla patirono per Cristo nell'anno 304, nella persecuzione di Diocleziano. San Timoteo era nativo di Cesarea di Palestina, aveva studiato le sante Scritture e, dotato di eloquenza, divenne maestro della fede cristiana. Arrestato e comandato di rinnegare Cristo e di sacrificare agli idoli, rifiutò con fermezza, e dopo aver sopportato crudeli tormenti fu bruciato vivo, rendendo l'anima a Dio.", "patron": "Si invocano per la confessione salda."},

"Martyrs Trophimus and Eucarpus of Nicomedia":
{"type": "Martiri · III sec.", "life": "I santi martiri Trofimo ed Eucarpo erano soldati a Nicomedia ai giorni della grande persecuzione, verso l'anno 300, e cominciarono dalla parte sbagliata di essa: uomini superbi e violenti, zelanti nella caccia ai cristiani, segnalati fra i persecutori per la crudeltà con cui rintracciavano i fedeli, li trascinavano ai tribunali e si arricchivano sul terrore, i due esecutori degli editti che cavalcavano proprio verso l'incarico che li avrebbe finiti.", "patron": "Si invocano per i persecutori convertiti; per i soldati distolti dalla crudeltà."},

"Martyrs Trophimus, Sabbatius, and Dorymedon of Synnada":
{"type": "Martiri · III sec.", "life": "I santi martiri Trofimo, Sabbazio e Dorimedonte patirono per Cristo sotto l'imperatore Probo. Trofimo e Sabbazio, giunti ad Antiochia durante una tumultuosa festa pagana, si dolsero di quello spettacolo e pregarono per gli erranti, al che furono notati, presi e condotti davanti al governatore; e confessando la fede senza vacillare, Sabbazio morì sotto i suoi fieri tormenti, mentre Trofimo fu mandato, calzato di stivali di ferro irti di chiodi, per la lunga strada di Sinnada in Frigia a torture ancor più crudeli.", "patron": "Si invocano per l'amicizia in Cristo; per la cura dei carcerati."},

"Martyrs Valentine and Pasikrates in Moesia, Bulgaria":
{"type": "Martiri · III sec.", "life": "I santi martiri Pasicrate e Valentino erano soldati della guarnigione di Durostoro sul Danubio, la fortezza di frontiera della Mesia nelle terre dell'odierna Bulgaria, e patirono sotto il governatore Absolano, nell'anno 228 secondo il computo comune dei libri, giovani di ventidue e trent'anni il cui reggimento era il loro mondo e il cui Cristo stava sopra il loro reggimento.", "patron": "Si invocano per i giovani soldati; per i fratelli e i compagni d'arme."},

"Martyrs Victorinus, Victor, Nikēphóros, Claudius, Diodorus, Serapion, and Papias, of Egypt":
{"type": "Martiri · III sec.", "life": "I santi martiri Vittorino, Vittore, Niceforo, Claudio, Diodoro, Serapione e Papia patirono a Corinto nell'anno 251, nella persecuzione dell'imperatore Decio, sette cristiani di quella città presi nella messe di tutto l'impero che Decio decretò quando comandò a ogni suddito di sacrificare o di morire. Condotti davanti al tribunale, i sette confessarono con una sola voce.", "patron": "Si invocano per le compagnie di amici; per quanti affrontano prove di ogni sorta."},

"Martyrs Zeno and his servant, Zenas, of Philadelphia":
{"type": "Martiri · IV sec.", "life": "I santi martiri Zenone e Zena suo servitore patirono per Cristo a Filadelfia d'Arabia nella persecuzione degli imperatori, e la loro storia è una testimonianza della fratellanza che la fede fa fra padrone e servitore.", "patron": "I padroni e i loro servi; quanti affrancano i propri schiavi."},

"Martyrs and Passion-Bearers Boris and Gleb":
{"type": "Principi · XI sec.", "life": "I santi Boris e Gleb, chiamati Roman e David nel santo battesimo, erano figli minori di san Vladimiro, il battezzatore della Rus', e furono i primi santi glorificati nella terra russa. Alla morte del padre nell'anno 1015, il loro fratello maggiore Svjatopolk si impadronì del trono di Kyiv e decise di distruggere i fratelli per regnare senza rivali.", "patron": "Si invocano per la non resistenza al male; per l'amore fraterno."},

"Martyrs and Unmercenaries Cosmas and Damian in Cilicia, and their brothers, Leontius, Anthimus, and Eutropius":
{"type": "Martiri · III sec.", "life": "I santi martiri e anargiri Cosma e Damiano d'Arabia, che la Chiesa distingue dalle altre due coppie di santi fratelli anargiri dello stesso nome, erano medici che viaggiavano per le città e i villaggi guarendo i malati senza compenso, chiedendo a quelli che curavano soltanto la fede in Cristo, e con la loro arte e la loro carità trassero una moltitudine alla conoscenza di Dio.", "patron": "Si invocano per i medici; per i guaritori."},

"Martyrs of the Kvabtakhevi Monastery in Georgia":
{"type": "Martiri · XIV sec.", "life": "I santi martiri del monastero di Kvabtakhevi patirono nell'anno 1386, quando Timur, detto Tamerlano, riversò i suoi eserciti sulla Georgia sotto il re Bagrat quinto, una delle sette invasioni con le quali quel flagello visitò quella terra, radendo al suolo le chiese, portando via i tesori dei secoli e abbattendo il popolo del Kartli.", "patron": "Si invocano per i monaci sotto l'invasione; per le assemblee che non vollero disperdersi."},

"Meeting of the Vladimir Icon of the Mother of God":
{"type": "Icona della Madre di Dio · XVI sec.", "life": "In questo giorno la Chiesa commemora una delle tre grandi feste dell'icona di Vladimir della santissima Madre di Dio, protettrice della terra russa, istituita in rendimento di grazie per la liberazione di Mosca dall'invasione tartara dell'anno 1521.", "patron": "Mosca liberata dal Tataro senza battaglia."},

"Monastic Martyr Adrian of Poshekhonye, Yaroslavl":
{"type": "Monaco martire e igumeno · XVI sec.", "life": "Il monaco martire Adriano di Pošechonje fu formato alla vita monastica nel monastero di san Cornelio di Komel, dove divenne abile iconografo, uno di una schiera di fratelli dotati raccolti intorno a quel grande anziano; e attratto, secondo il modello dei fondatori del nord, dalle foreste profonde, uscì con un compagno d'ascesi di nome Leonida nel deserto del paese di Pošechonje nelle terre di Jaroslavl, e vi fondò un monastero della Dormizione della santissima Madre di Dio, edificandolo dal nulla e servendolo da igumeno nell'austerità e nella preghiera.", "patron": "Si invoca per gli iconografi; per i fondatori."},

"Monastic Martyr Anastasia of Rome":
{"type": "Monaca · III sec.", "life": "La santa monaca martire Anastasia la romana fu resa orfana a tre anni e allevata in una comunità di vergini presso Roma dalla santa anziana Sofia, che la formò nella preghiera, nel digiuno e nell'amore di Cristo, sicché mentre cresceva la bellezza della sua anima superava in splendore la grande bellezza del suo volto.", "patron": "Si invoca per le monache; per la verginità."},

"Monastic Martyr Andrew of Crete":
{"type": "Monaco · VIII sec.", "life": "Il santo monaco martire Andrea di Creta, che la Chiesa distingue dal grande innografo dello stesso nome e della stessa isola, era un asceta di Creta ai giorni in cui l'imperatore Costantino Copronimo infuriava contro le sante icone, torturando e uccidendo i monaci che le difendevano. Udendo delle sofferenze dei confessori, Andrea lasciò la sua quiete e venne a Costantinopoli, e trovato l'imperatore alla chiesa del santo martire Mamante, lo rimproverò davanti a tutti, chiedendogli perché, se si diceva cristiano, facesse guerra a Cristo nella sua immagine e ai suoi servi.", "patron": "Si invoca per la venerazione delle sante icone; per l'audacia davanti agli imperatori."},

"Monastic Martyr Bademus (Vadim) of Persia":
{"type": "Monaco martire · IV sec.", "life": "Il monaco martire Bademo, detto Vadim, archimandrita di Persia, era un uomo ricco di Bethlapeta che diede i suoi beni ai poveri e la sua vita a Dio, fondando un monastero presso la sua città e formando discepoli nelle scienze del deserto, il digiuno, la veglia e la preghiera incessante, igumeno di tanta dolcezza e quiete che la sua fama corse per la Persia negli anni stessi in cui la persecuzione del re Sapore la rastrellava.", "patron": "Si invoca per gli igumeni; per quanti sono uccisi dai lapsi."},

"Monastic Martyr Christopher of Dionysiou, Mount Athos":
{"type": "Monaco martire · XIX sec.", "life": "Il santo monaco martire Cristoforo di Dionysiou percorse la strada che la Chiesa dei secoli turchi venne a conoscere come il pentimento dei rinnegati, la più esigente penitenza che la sua sapienza pastorale abbia mai formulata; poiché Cristoforo, cristiano della regione di Adrianopoli, aveva nella sua giovinezza, in un'ora di debolezza per pressione, timore o passione, rinnegato la fede ed era stato ricevuto nella religione dei conquistatori, la caduta che quel tempo rendeva facile e dalla quale rendeva capitale il ritorno.", "patron": "Si invoca per i penitenti che cercano di riparare un rinnegamento; per i monaci di Dionysiou."},

"Monastic Martyr Damascene of the Lavra":
{"type": "Monaco · XVII sec.", "life": "Il santo monaco martire Damasceno della Lavra nacque nel quartiere di Galata a Costantinopoli da genitori pii di nome Kyriakos e Kyriake, che chiamarono il figlio Diamantes. Rimasto orfano da giovane e senza guida, il ragazzo cadde in una vita disordinata, e preso un giorno in un atto illecito, si salvò dal castigo acconsentendo ad accettare l'islam.", "patron": "Si invoca per la penitenza dopo il rinnegamento; per l'apostasia lavata nel sangue."},

"Monastic Martyr Euphrosynus of Blue Jay Lake, Novgorod":
{"type": "Monaco martire · XVII sec.", "life": "Il monaco martire Eufrosino del lago Azzurro era careliano di nascita, cresciuto presso la Ladoga nell'orbita del grande monastero di Valaam, e servì dapprima la Chiesa come lettore prima di ricevere la tonsura al monastero della Dormizione di Tichvin; e attratto dal deserto, uscì verso l'anno 1600 nel selvaggio paese di confine delle terre di Novgorod e si stabilì da eremita presso il lago Azzurro, Sinozersk, dove la sua santità raccolse fratelli e un eremo dell'Annunciazione della santissima Madre di Dio sorse in riva all'acqua, guidandolo l'anziano nell'austerità e nella preghiera.", "patron": "Si invoca per quanti restano quando gli altri devono fuggire; per gli eremiti delle terre di confine."},

"Monastic Martyr Eustratius of the Kyiv Near Caves":
{"type": "Monaco martire · XI sec.", "life": "Il monaco martire Eustrazio delle Grotte Vicine di Kyiv, detto il digiunatore, era un kyivano che diede il suo patrimonio ai poveri e prese la tonsura alle Grotte, dove il suo digiuno fu tanto severo che i fratelli gli diedero il nome che porta; e la sua corona venne per una catastrofe, poiché nell'anno 1096, quando l'orda cumana di Bonjak piombò su Kyiv e saccheggiò il monastero, abbattendo i monaci alle loro preghiere, Eustrazio fu portato via fra i prigionieri, e venduto con altri cinquanta, gente del monastero e kyivani, nelle mani di un mercante di schiavi a Cherson in Crimea.", "patron": "Si invoca per i prigionieri; per quanti digiunano."},

"Monastic Martyr Euthymius of Prodromou, Mount Athos":
{"type": "Neomartire · XIX sec.", "life": "Il santo neomartire Eutimio dello skite del Precursore sul monte Athos nacque Eleuterio a Demitsana nel Peloponneso, da genitori pii, e cadde nella sua giovinezza per la strada che molti dei neomartiri percorsero: gettato fra i turchi nei suoi vagabondaggi, incalzato e invischiato, il giovane in un'ora di debolezza rinnegò Cristo e accettò l'islam, guadagnando la sicurezza del mondo e perdendo la propria pace, poiché il rinnegamento non gli diede riposo né di giorno né di notte, e il pentimento salì in lui come una febbre che una sola medicina poteva raffreddare.", "patron": "Si invoca per quanti hanno rinnegato e vorrebbero tornare; per i giovani nella penitenza."},

"Monastic Martyr Joseph of Dionysiou, Mount Athos":
{"type": "Monaco · XIX sec.", "life": "San Giuseppe era monaco del monastero di Dionysiou sul monte Athos, dove risplendette nelle virtù della vita monastica e faticò come iconografo, dipingendo l'icona dei santi arcangeli per l'iconostasi della chiesa principale del monastero. Per obbedienza al suo igumeno Stefano, viaggiò a Costantinopoli come compagno di un certo Eudocimo, che aveva apostatato all'islam e ora, pentendosi, desiderava lavare il suo rinnegamento con il martirio.", "patron": "Si invoca per gli iconografi; per la confessione salda."},

"Monastic Martyr Macarius of Dionysiou, Mount Athos":
{"type": "Ieromonaco · XVI sec.", "life": "San Macario era monaco del monastero di Dionysiou sul monte Athos e discepolo del santo patriarca Nifone di Costantinopoli, il quale negli anni del suo ritiro faticò in quel monastero; e dal suo anziano Macario apprese l'obbedienza, la preghiera e l'amore ardente per Cristo. Consumato dal desiderio di rendere testimonianza al suo Signore fra quelli che lo rinnegavano, ricevette la benedizione di san Nifone, che gliene predisse la fine, e andò a Tessalonica, dove cominciò a predicare apertamente Cristo ai turchi e a chiamarli via dal loro errore.", "patron": "Si invoca per i predicatori; per la predicazione ardita."},

"Monastic Martyr Macarius of Saint Anne Skete, Mount Athos":
{"type": "Monaco · XVI sec.", "life": "San Macario neomartire nacque a Kios di Bitinia, e nella sua giovinezza, ai giorni del giogo ottomano, fu attratto con la forza e con l'inganno verso la religione dei conquistatori, ferita che gli bruciò poi nella coscienza. Fuggito alla Santa Montagna dell'Athos, venne allo skite di Sant'Anna, dove fu accolto, tonsurato e formato nella penitenza, nella preghiera e nelle lacrime sotto gli anziani di quel santo luogo.", "patron": "Si invoca per la penitenza sigillata nel sangue; per la confessione salda."},

"Monastic Martyr Paul of the Lavra, Mount Athos":
{"type": "Martire", "life": "Il monaco martire Paolo della Lavra sul monte Athos è commemorato dalla Chiesa in questo giorno come uno dei suoi santi, benché dei particolari della sua vita e del suo certame il verbale non sia giunto, e i libri comuni confessino apertamente che di lui non sopravvive alcun racconto.", "patron": "La corona conquistata e il racconto non scritto."},

"Monastic Martyr and Confessor Stephen the New":
{"type": "Monaco · VIII sec.", "life": "Il monaco martire e confessore Stefano il Nuovo, grande campione delle sante icone, nacque nel 715 a Costantinopoli da genitori pii che, avendo due figlie, chiesero al Signore un figlio; e sua madre, ricevutolo, portò il neonato alla chiesa delle Blacherne della santissima Madre di Dio e lo consacrò a Dio davanti alla sua icona.", "patron": "Si invoca per i monaci; per i difensori delle icone."},

"Monastic Martyrs Conon and his son, Conon, of Iconium":
{"type": "Ieromartire, e suo figlio · III sec.", "life": "I santi monaci martiri Conone e suo figlio Conone patirono a Iconio nell'Asia Minore sotto l'imperatore Aureliano. Il Conone anziano, rimasto vedovo, entrò in un monastero insieme al figlio, e per la santità della sua vita gli fu concessa grazia dall'alto, cacciando i demoni, guarendo i malati, ridando la vista ai ciechi e predicando Cristo fra i pagani, per il che ne convertì molti.", "patron": "Si invoca per i padri vedovi; per i padri e i figli."},

"Monastic Martyrs Menas, David, and John, of Palestine":
{"type": "Monaci martiri · VII sec.", "life": "I santi monaci martiri Mena, David e Giovanni erano monaci di Palestina, asceti delle comunità del deserto che portarono la tradizione di Caritone, di Eutimio e di Saba attraverso i secoli dopo che le conquiste persiana e araba ebbero spezzato l'antica pace della Terra santa; e furono uccisi da predoni saraceni, abbattuti dalle frecce, registrano i racconti, negli anni turbolenti in cui le bande che vagavano per il deserto piombavano ancora e ancora sulle lavre e sulle celle indifese, trovando nei monaci l'unica popolazione che non avrebbe né lasciato il proprio posto né levato un'arma in propria difesa.", "patron": "Si invocano per i monaci uccisi presso le loro celle; per i fedeli di cui non resta memoria."},

"Monastic Martyrs and Confessors Auxentius, Basil, Gregory, another Gregory, John, Andrew, Peter and many others":
{"type": "Martiri · VIII sec.", "life": "I santi martiri e confessori Aussenzio, Basilio, Gregorio, un altro Gregorio, Giovanni, Andrea, Pietro e molti altri patirono per la venerazione delle sante icone nella persecuzione di Costantino Copronimo, insieme al monaco martire Stefano il Nuovo. Erano questi i confessori, per lo più monaci, che l'imperatore iconoclasta aveva raccolti da tutto l'impero nelle carceri di Costantinopoli, uomini che già portavano nei loro corpi i segni della persecuzione, flagellati, marchiati, mutilati nel naso e nelle orecchie e nelle mani e negli occhi per aver rifiutato di bestemmiare l'immagine di Cristo.", "patron": "Si invocano per i monaci; per le sante icone."},

"Myrrhbearer and Equal of the Apostles Mary Magdalene":
{"type": "Pari agli apostoli · I sec.", "life": "Santa Maria Maddalena, mirofora e pari agli apostoli, nacque nel borgo di Magdala sulla riva del mare di Galilea. Liberata dal Signore da sette demoni, fu chiamata dalle tenebre alla luce e da quell'ora divenne sua fedele discepola, seguendolo per le città e i villaggi mentre predicava il regno di Dio. Quando gli altri discepoli fuggirono per il timore, Maria rimase salda, stando presso la Croce del suo Signore crocifisso e partecipando alle sue sofferenze, e venendo di buon'ora al sepolcro fu trovata degna sopra tutti: il Cristo risorto apparve prima a lei, e la mandò ad annunciare la sua Risurrezione agli apostoli, sicché è onorata come l'apostola degli apostoli."},

"Nativity of the Holy Glorious Prophet, Forerunner and Baptist, John":
{"type": "Profeta · I sec.", "life": "La Natività dell'onorabile glorioso profeta, precursore e battista Giovanni celebra la nascita dell'ultimo e più grande dei profeti, colui che avrebbe preparato la via del Signore. Come narra il Vangelo di Luca, l'anziano sacerdote Zaccaria e sua moglie Elisabetta, parente della vergine Maria, erano giusti ma senza figli. Mentre Zaccaria serviva nel Tempio, l'arcangelo Gabriele annunciò che Elisabetta avrebbe partorito un figlio da chiamarsi Giovanni, il quale sarebbe andato davanti al Signore nello spirito e nella potenza di Elia; e poiché Zaccaria dubitò, fu reso muto finché il bambino non fu nato ed egli non scrisse il nome Giovanni, al che gli tornò la parola ed egli profetò."},

"New Martyr Anastasius of Epirus":
{"type": "Martire · XVIII sec.", "life": "Il santo neomartire Anastasio di Paramythia in Epiro patì sotto il giogo ottomano nell'anno 1750. Giovane cristiano greco di quella città, fu preso dagli uomini del signore locale e, falsamente accusato, gli fu posta la scelta che spezzò o incoronò tanti della sua generazione: abbracciare l'islam e vivere onorato, o rimanere cristiano e morire.", "patron": "Si invoca per la Chiesa asservita; per la testimonianza che converte la casa del persecutore."},

"New Martyr Archpriest Vasily Martysz":
{"type": "Martire · XX sec.", "life": "Il santo neomartire protopresbitero Vasilij Martysz abbracciò in una sola vita i mondi ortodossi dell'Alaska e della Polonia, e li sigillò entrambi con una morte del Venerdì santo.", "patron": "I giri in kayak dell'Alaska."},

"New Martyr Ephraim":
{"type": "Martire · XV sec.", "life": "Il santo ieromartire Efrem di Nea Makri, il nuovo rivelato, fu nascosto da Dio per cinquecento anni e dato alla Chiesa nel suo bisogno moderno, e la sua vita è perciò narrata da entrambi i capi.", "patron": "Gli otto mesi di tormenti sopportati."},

"New Martyr Euthymius of Mount Athos":
{"type": "Martire · XIX sec.", "life": "Il santo neomartire Eutimio del monte Athos, commemorato in questo giorno nella sinassi comune dei tre neomartiri dello skite del Precursore, nacque a Demetsana nel Peloponneso, la città di montagna che diede alla nazione greca tanti dei suoi sacerdoti e dei suoi martiri, fra i quali il patriarca Gregorio quinto; e la sua strada verso la corona passò per la caduta che segnò tutta la sua generazione di neomartiri, poiché nella stoltezza della giovinezza, lontano da casa e sotto pressione, rinnegò Cristo e fu ricevuto nella religione dei conquistatori, la ferita che quel tempo infliggeva ai suoi giovani con la maggiore facilità e perdonava di meno.", "patron": "L'apostasia della giovinezza lavata nel sangue."},

"New Martyr Habakkuk":
{"type": "Monaco · XVII sec.", "life": "Il neomartire Abacuc rese testimonianza a Cristo nella grande città di Tessalonica nell'anno 1628, durante la lunga notte del giogo turco. Quasi nulla della sua vita è stato conservato, poiché nessun racconto completo del suo martirio è sopravvissuto; la sua memoria è nota soltanto da un breve ricordo registrato in un manoscritto della Grande Lavra sul monte Athos, il quale dichiara che nel mese di agosto il venerabile Abacuc rese la sua testimonianza a Cristo, a gloria e vanto dei cristiani ortodossi.", "patron": "Si invoca per la confessione salda sotto persecuzione."},

"New Martyr Ignatius the Martyr of Mount Athos":
{"type": "Martire · XIX sec.", "life": "Il santo neomartire Ignazio del monte Athos, commemorato in questo giorno con Eutimio e Acacio nella sinassi dei tre neomartiri dello skite del Precursore, nacque Giovanni a Stara Zagora in Bulgaria, e la sua caduta fu la caduta di un ragazzo spaventato: incalzato da musulmani che ne esigevano la conversione, promise nel suo terrore che avrebbe obbedito, e poi fuggì la promessa e il luogo, non consumato mai il rinnegamento in un rito ma reale abbastanza nella sua coscienza da divenire il motore di tutto il suo dopo.", "patron": "La promessa estorta dalla paura ritrattata nel sangue."},

"New Martyr John Kalphes, the Apprentice":
{"type": "Neomartire · XVI sec.", "life": "Il santo neomartire Giovanni Kalphes patì a Costantinopoli nell'anno 1575, nella seconda generazione dopo la caduta della Città, e il suo titolo è il suo mestiere: kalphes, il capomastro garzone, poiché Giovanni era un giovane artigiano valente delle officine imperiali, cristiano la cui eccellenza lo aveva portato al servizio della corte ottomana stessa, dove costruiva e rifiniva per i conquistatori con l'onestà di un operaio, stimato dai grandi per il suo mestiere e dai cristiani per la sua pietà e le sue larghe elemosine.", "patron": "Si invoca per i costruttori; per i falegnami."},
...
{"type": "Metropolita · XV sec.", "life": "San Cipriano, metropolita di Kyiv e di Mosca e di tutta la Russia, era bulgaro di nascita, della città di Tarnovo, e fu formato nella tradizione esicasta, faticando come monaco sulla Santa Montagna dell'Athos prima di essere mandato al nord dal patriarca di Costantinopoli. Consacrato metropolita in un tempo di divisione e di torbidi, sopportò molte prove ed espulsioni prima che il suo trono fosse saldamente stabilito a Mosca, e da allora pascolò con saggezza per molti anni la Chiesa russa, faticando senza posa alla correzione e alla traduzione dei libri liturgici dal greco, copiando di sua mano libri della liturgia e dell'istruzione spirituale, e piantando in Russia i frutti del rinnovamento esicasta della sua patria.", "patron": "Si invoca per i traduttori; per gli innografi."},

"Repose of Saint Cyril, Equal of the Apostles and Teacher of the Slavs":
{"type": "Pari agli apostoli · IX sec.", "life": "In questo giorno la Chiesa celebra la dormizione di san Cirillo, pari agli apostoli e maestro degli slavi, che morì a Roma il quattordici di febbraio dell'869; la sua festa congiunta con il fratello Metodio si celebra in maggio, ma questo giorno appartiene all'uomo stesso.", "patron": "Si invocano per i traduttori; per i maestri."},

"Repose of Saint Herman, Archbishop of Kazan":
{"type": "Arcivescovo · XVI sec.", "life": "In questo giorno la Chiesa commemora la dormizione di san Germano, arcivescovo di Kazan. Nato Gregorio, della famiglia boiara dei Polev a Starica, fu tonsurato al monastero di San Giuseppe di Volokolamsk, dove il sapere e l'ascesi erano congiunti, e divenne archimandrita del monastero della Dormizione nella sua Starica natale.", "patron": "Si invoca per i missionari; per l'illuminazione di Kazan."},

"Repose of Saint Innocent, Metropolitan of Moscow, Enlightener of the Aleuts, Apostle to the Americas":
{"type": "Metropolita pari agli apostoli · XIX sec.", "life": "Sant'Innocenzo, metropolita di Mosca e illuminatore dell'America settentrionale, nacque Ivan Popov nel 1797 nel villaggio di Anga nel paese di Irkutsk in Siberia, povero figlio di un prete che al seminario prese il cognome di Veniaminov; e nel 1824, giovane sacerdote sposato con doti che avrebbero adornato qualunque capitale, si offrì volontario per l'incarico che nessuno voleva, le isole Aleutine all'estremità del mondo, e salpò con la sua famiglia per Unalaska.", "patron": "Si invoca per i missionari; per i traduttori."},

"Repose of Saint Innocent, first Bishop of Irkutsk":
{"type": "Vescovo · XVIII sec.", "life": "In questo giorno la Chiesa commemora sant'Innocenzo, primo vescovo di Irkutsk, illuminatore della Siberia orientale. Nato verso il 1680 nella nobile famiglia dei Kul'čickij delle terre di Černihiv, Giovanni fu educato all'Accademia di Kyiv, ricevette la tonsura monastica con il nome di Innocenzo, e insegnò nelle scuole di Mosca e di San Pietroburgo.", "patron": "Si invoca per i missionari; per i maestri."},

"Repose of Saint Jacob Netsvetov, Enlightener of the Peoples of Alaska":
{"type": "Sacerdote · XIX sec.", "life": "San Jakov Netsvetov, illuminatore dei popoli dell'Alaska, nacque nell'anno 1802 nell'isola di Atka nelle Aleutine, figlio di padre russo di Tobolsk e di madre aleuta, e fu così congiunto per sangue proprio al popolo che avrebbe servito. Istruito e col tempo ordinato sacerdote, tornò ad Atka a pascolare una parrocchia che si stendeva per quasi duemila miglia attraverso le isole, dove edificò una chiesa e una scuola e, dotato come traduttore, insegnò alla sua gente a leggere e a scrivere nella propria lingua unangan oltre che in russo.", "patron": "Si invoca per i missionari; per i traduttori."},

"Repose of Saint John Chrysostom, Archbishop of Constantinople":
{"type": "Arcivescovo · V sec.", "life": "San Giovanni Crisostomo, detto Bocca d'oro per la sua eloquenza senza pari e onorato come uno dei tre santi gerarchi, nacque ad Antiochia verso l'anno 347 e fu allevato nella pietà dalla madre vedova Antusa. Formato nella retorica sotto il celebre Libanio, abbandonò una brillante carriera mondana, fu battezzato da san Meletio, e si diede alla vita ascetica negli eremi presso Antiochia, finché la salute non gli venne meno ed egli tornò in città, dove fu ordinato diacono e poi sacerdote.", "patron": "Si invoca per i predicatori; per gli oratori."},

"Repose of Saint Jonah, Archbishop of Novgorod":
{"type": "Arcivescovo · XV sec.", "life": "San Giona, arcivescovo di Novgorod, era nel mondo Giovanni, orfano nell'infanzia e allevato da una pia vedova a Novgorod; e una volta, mentre il fanciullo stava fra i suoi compagni, il beato Michele di Klops, folle per Cristo, passò e, inchinandosi al bambino, disse, Giovanni, studia con diligenza il tuo libro, poiché sarai arcivescovo della Grande Novgorod.", "patron": "Si invoca per gli orfani; per i gerarchi."},

"Repose of Saint Nikolai of Zhicha":
{"type": "Confessore e vescovo · XX sec.", "life": "San Nikolaj di Žiča, il nuovo Crisostomo della Chiesa serba, nacque Nikola Velimirović nel 1880 nel villaggio di Lelić, primo di molti figli di pii contadini, e salì per pura genialità donata da Dio attraverso le scuole di Serbia e le università d'Europa, prendendo dottorati in Occidente e restando interamente figlio del villaggio serbo e della sua fede.", "patron": "Si invoca per i predicatori; per gli scrittori."},

"Repose of Saint Peter, Metropolitan of Moscow, Wonderworker of All Russia":
{"type": "Metropolita · XIV sec.", "life": "San Pietro, metropolita di Kyiv e di tutta la Rus', taumaturgo di Mosca, nacque in Volinia e fu dato a un monastero a dodici anni, dove accanto all'obbedienza e alla preghiera padroneggiò l'arte dell'icona, dipingendo immagini del Salvatore e della Madre di Dio, una delle quali, la Petrovskaja, è venerata fino a oggi.", "patron": "Si invoca per i gerarchi; per gli iconografi."},

"Repose of Saint Raphael, Bishop of Brooklyn":
{"type": "Vescovo · XX sec.", "life": "San Raffaele, vescovo di Brooklyn, la cui dormizione questo giorno commemora, fu il buon pastore delle pecore perdute d'America, e il primo vescovo ortodosso consacrato nel Nuovo Mondo. Nato a Beirut nel 1860 da una povera famiglia damascena in fuga dai massacri di quell'anno, fu educato dalla Chiesa che lo discernette, alla scuola patriarcale, a Halki e all'Accademia teologica di Kyiv, padroneggiando l'arabo, il greco, il turco, il russo e col tempo l'inglese, un sinodo di lingue in un uomo solo.", "patron": "Si invoca per gli immigrati; per i vescovi missionari."},

"Repose of Saint Theodore Yaroslavich, older brother of Saint Alexander Nevsky":
{"type": "Principe · XIII sec.", "life": "San Teodoro Jaroslavič era il fratello maggiore del grande sant'Alessandro Nevskij, giovane principe della casa di Vladimir che fu colto dalla morte sulla soglia stessa della sua virilità ed è onorato per la purezza della sua breve vita e per l'incorruzione delle sue reliquie.", "patron": "I giovani che muoiono nella purezza; i principi stroncati prima del tempo."},

"Repose of Saint Theoktistos, Archbishop of Novgorod":
{"type": "Arcivescovo · XIV sec.", "life": "San Teoctisto, arcivescovo di Novgorod, era igumeno del monastero dell'Annunciazione presso quella città quando, alla dormizione dell'arcivescovo Clemente nel 1300, il popolo di Novgorod lo scelse per suo pastore secondo l'antico costume della sua repubblica; e fu consacrato il ventinove di giugno del 1300 dal metropolita Massimo di Kyiv e di tutta la Rus' con i vescovi di Rostov e di Tver'.", "patron": "Si invoca per i gerarchi che si ritirano con umiltà; per i costruttori di chiese."},

"Repose of Saint Tikhon, Patriarch of Moscow, Enlightener of North America":
{"type": "Confessore e patriarca · XX sec.", "life": "San Tichon, patriarca di Mosca e illuminatore dell'America settentrionale, nacque Vasilij Bellavin nel 1865, figlio di un prete di villaggio di Toropec, e salì per il seminario e per la tonsura monastica con una dolcezza tanto marcata che i suoi condiscepoli, metà per scherzo e interamente per profezia, chiamavano il giovane Patriarca.", "patron": "Si invoca per i patriarchi in prigionia; per la Chiesa sotto persecuzione."},

"Repose of Venerable Abramius of Galich or Chukhloma Lake, disciple of Venerable Sergius of Radonezh":
{"type": "Festa · XIV sec.", "life": "Il venerabile Abramio di Galič fu discepolo di san Sergio di Radonež che faticò al monastero della Santa Trinità per tutto il quattordicesimo secolo, servendo molti anni da novizio prima di essere ordinato sacerdote. Desiderando una quiete più profonda, ricevette la benedizione del suo anziano e nel 1350 si ritirò nel deserto del paese di Galič nel nord della Russia, allora ancora abitato da tribù non battezzate.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Repose of Venerable Cornelius of Pereyaslavl":
{"type": "Monaco · XVII sec.", "life": "Il venerabile Cornelio di Pereslavl', chiamato Konon nel mondo, era figlio di un mercante di Rjazan'. Nella sua giovinezza lasciò la casa paterna e servì cinque anni da novizio sotto l'anziano Paolo nel deserto di Lukianov, passando poi al monastero di Pereslavl' dei santi Boris e Gleb sulle Sabbie.", "patron": "Si invoca per i monaci; per il silenzio."},

"Repose of Venerable Herman of Alaska, Wonderworker of All America":
{"type": "Monaco · XIX sec.", "life": "San Germano d'Alaska, taumaturgo di tutta l'America, nacque verso il 1756 a Serpuchov presso Mosca, e fu formato come monaco al monastero di Valaam sotto l'anziano Nazario; e nel 1794, uno di dieci missionari mandati attraverso settemila miglia di impero e di oceano, giunse all'isola di Kodiak nell'America russa dopo un viaggio di quasi un anno, per portare il Vangelo al popolo alutiiq.", "patron": "Si invoca per i missionari; per gli orfani."},

"Repose of Venerable Job the Wonderworker, Abbot of Pochaiv":
{"type": "Igumeno · XVII sec.", "life": "Il venerabile Giobbe di Počaiv, nel mondo Ivan Železo, nacque verso il 1551 in Pokutia di Galizia, e venne a dieci anni al monastero della Trasfigurazione di Ugornica, ricevendo la tonsura a dodici con il nome di Giobbe. La sua santità maturò tanto presto che fu ordinato sacerdote ancora giovane e divenne famoso per tutte le terre occidentali.", "patron": "Si invoca per gli stampatori; per gli apologisti."},

"Repose of Venerable Nilus, Abbot of Sora":
{"type": "Venerabile · XVI sec.", "life": "Il venerabile Nilo di Sora, grande maestro della vita di skite e della preghiera del cuore in Russia, nacque Nicola Majkov verso il 1433, di Mosca, e fu tonsurato al monastero di Kirillo-Belozersk, la scuola più severa del nord; e la sua formazione fu compiuta all'estero, poiché Nilo viaggiò con il suo discepolo Innocenzo a Costantinopoli e alla Santa Montagna, e visse anni fra gli esicasti dell'Athos, bevendo alla fonte la tradizione del Sinai e dei padri filocalici, la custodia della mente, il discernimento dei pensieri e l'incessante preghiera di Gesù; e tornato in Russia non rientrò nel grande cenobio ma si ritirò nelle paludi boscose sul piccolo fiume Sora, e vi stabilì qualcosa che la Russia non aveva mai visto, uno skite secondo l'antica via di mezzo, né solitaria né comune, due o tre fratelli per cella, radunati per gli uffici, che vivevano del lavoro delle proprie mani, non possedendo nulla oltre il bisogno, rifiutando terre, villaggi e perfino l'ornamentazione della chiesa, declinato per principio tutto l'apparato della ricchezza monastica, perché nulla stesse fra la mente e Dio.", "patron": "La via dello skite piantata in Russia."},

"Repose of Venerable Sergius the Wonderworker, Abbot of Radonezh":
{"type": "Venerabile · XIV sec.", "life": "San Sergio di Radonež, grande igumeno e restauratore del monachesimo russo, nacque Bartolomeo verso il 1314 dai pii nobili Cirillo e Maria presso Rostov, e da fanciullo ricevette per un incontro prodigioso il dono dell'apprendere che gli era sfuggito. Dopo la morte dei genitori si ritirò con il fratello nel deserto boscoso di Radonež, dove edificò una piccola chiesa della Santa Trinità e visse in solitudine e in dura fatica finché discepoli non si raccolsero intorno a lui e non sorse un grande monastero, la Lavra della Trinità che porta ancora il suo nome. Tonsurato con il nome di Sergio, ne divenne igumeno e tuttavia servì i fratelli come il minimo fra loro, rifiutando gli onori e vivendo in profonda umiltà, e gli furono concesse visioni della Madre di Dio e della luce divina."},

"Repose of Venerable Shio the Anchorite of Georgia":
{"type": "Venerabile · VI sec.", "life": "Il venerabile Shio di Mgvime, l'anacoreta, uno dei tredici padri siri che piantarono il monachesimo in Georgia, venne da Antiochia nel sesto secolo come discepolo di san Giovanni di Zedazeni, nella schiera che la Chiesa georgiana venera come la costellazione fondatrice del suo deserto, dodici discepoli e il loro anziano mandati per indicazione della Madre di Dio stessa dalla Siria nella terra iberica; e quando i padri si dispersero da Zedazeni verso le regioni loro assegnate, Shio, i cui genitori erano stati persuasi dal loro unico figlio a precederlo nella vita monastica, dissolvendosi la famiglia verso Dio prima ancora che egli lasciasse la Siria, cercò la sorte più aspra di tutte, ritirandosi sulle rupi desolate a occidente di Mtskheta e rinchiudendosi in una grotta, anacoreta del luogo che i georgiani vennero a chiamare semplicemente Mgvime, la Grotta.", "patron": "La colomba che gli portava il pane."},

"Repose of the Blessed John of Ustiug the Fool-for-Christ":
{"type": "Folle per Cristo · XV sec.", "life": "Il beato Giovanni di Ustjug, folle per Cristo, fu un asceta della città settentrionale di Velikij Ustjug che prese la più dura e la più nascosta delle vie della santità, la follia per Cristo, e la praticò fin dalla sua infanzia.", "patron": "La follia simulata per nascondere i digiuni e le veglie."},

"Repose of the Holy Apostle and Evangelist John the Theologian":
{"type": "Apostolo · II sec.", "life": "Il santo apostolo ed evangelista Giovanni il Teologo, il discepolo prediletto, era figlio di Zebedeo e di Salome e fratello di Giacomo, chiamato dalle sue reti sul mare di Galilea a seguire Cristo, e fra tutti i discepoli fu quello che giacque più vicino al petto del Signore.", "patron": "Si invoca per i teologi; per gli scrittori."},

"Repose of the Holy Right-believing Princess Anna of Kashin":
{"type": "Monaca · XIV sec.", "life": "La santa principessa Anna di Kašin era figlia del principe Demetrio di Rostov, e nel 1294 divenne moglie del santo gran principe Michele di Tver'. Dio le assegnò una vita di dolore quasi ininterrotto: seppellì la figlioletta e il padre, vide Tver' bruciare e la pestilenza percorrere la terra, e nel 1318 suo marito fu torturato e assassinato all'Orda per aver rifiutato di salvarsi a spese del suo popolo.", "patron": "Si invoca per le vedove; per quanti hanno perduto una persona cara per violenza."},

"Return of the Relics of the Apostle Bartholomew from Anastasiopolis to Lipari":
{"type": "Apostolo · I sec.", "life": "Il santo apostolo Bartolomeo, uno dei Dodici, patì per Cristo in Armenia, dove fu scorticato e decapitato verso l'anno 71, e le sue reliquie rimasero in quella terra operando molti miracoli. Sotto l'imperatore Anastasio furono portate alla nuova città di Anastasiopoli, ma quando più tardi mani ostili le minacciarono, i fedeli posero le reliquie in una cassa di piombo e le affidarono al mare, consegnando l'apostolo alla provvidenza di Dio.", "patron": "Si invoca per la guarigione."},

"Right-Believing Prince Roman of Uglich":
{"type": "Principe · XIII sec.", "life": "Il principe fedele Roman di Uglič governò il suo appannaggio del Volga nel tredicesimo secolo, nelle amare prime generazioni del giogo mongolo, e lasciò dietro di sé la più rara delle reputazioni medievali, un regno ricordato per null'altro che per la bontà. Figlio del pio principe Vladimir di Uglič, Roman fu allevato nel timore di Dio, e ricevuto il principato dopo il padre e il fratello maggiore, lo governò come un'amministrazione: i cronisti della città contarono a dozzine le chiese che edificò, e accanto alle chiese innalzò ospizi e case per i malati e per gli indigenti, mantenne a sue spese i pellegrini e i poveri, e ascoltò egli stesso la causa della vedova e dell'orfano, funzionando la corte del principe come ultimo rifugio degli indifesi; e la sua condotta personale fu quella di un monaco, presenza quotidiana agli uffici, digiuno severo e preghiera, vivendo il sovrano di Uglič nella propria capitale come un pellegrino di passaggio.", "patron": "Si invoca per i sovrani; per i costruttori di chiese e di ospedali."},

"Right-believing George the Great Prince of Vladimir":
{"type": "Martire e gran principe · XIII sec.", "life": "Il principe fedele Giorgio, gran principe di Vladimir, nacque nel 1189, figlio del gran principe Vsevolod detto Grande Nido, e ricevette il trono di Vladimir nel 1212; distinto fin dalla giovinezza per valore militare e per pietà, governò il più forte principato del nord russo lungo un quarto di secolo di costruzioni, fondando nel 1221, all'incontro del Volga e dell'Oka, la città fortificata di Nižnij Novgorod, le cui mura custodiscono fino a oggi la sua memoria.", "patron": "Si invoca per i sovrani nella catastrofe; per i difensori della patria."},

"Right-believing Great Prince Rostislav-Michael, Prince of Kyiv":
{"type": "Principe · XII sec.", "life": "Il fedele gran principe Rostislav di Kyiv, chiamato Michele nel santo battesimo, era figlio di Mstislav il Grande e nipote di Vladimir Monomaco, e portò il meglio di quella stirpe, la sua pietà e la sua opera di pace, attraverso una delle generazioni più litigiose della Rus'. Come principe di Smolensk per più di trent'anni fu il vero costruttore di quella terra: ne innalzò le chiese, vi stabilì una sede vescovile, sicché Smolensk ricevette sotto di lui il proprio gerarca e la propria cattedrale, e governò con tale giustizia e generosità che le cronache ricordano la sua Smolensk come un principato governato come una casa di Dio; e chiamato infine al grande trono di Kyiv, che le faide dei principi avevano fatto un premio strappato di qua e di là, Rostislav lo tenne alla maniera dell'anziano Monomaco, non come un possesso ma come un peso di pace, faticando di continuo a riconciliare i cugini in guerra, cedendo quel che si poteva cedere, e serbando la terra russa, per la sua stagione, dal divorare se stessa.", "patron": "Si invoca per i sovrani; per i pacificatori."},

"Right-believing John, Prince of Uglich, tonsured as Ignatius":
{"type": "Fedele · XVI sec.", "life": "Il santo principe fedele Giovanni di Uglič, tonsurato prima della morte con il nome di Ignazio, fu cristiano devoto e timorato di Dio fin dalla giovinezza, al quale il mondo diede in sorte una pura ingiustizia ed egli la mutò, per grazia, in una santità nascosta.", "patron": "I trentadue anni di carcere sopportati senza amarezza."},

"Right-believing Prince Basil (Vasilko) of Rostov":
{"type": "Principe e portatore della passione · XIII sec.", "life": "Il principe fedele Basilio, detto Vasil'ko, di Rostov apparteneva al ramo di Suzdal' dei monomachidi, nipote di Vsevolod detto Grande Nido e figlio del pio principe Costantino di Rostov; e le cronache del nord lo ricordano come il fiore della sua generazione, bello, coraggioso, generoso e devoto, amato dal suo popolo e dal clero del quale seguiva il consiglio.", "patron": "Si invoca per i sovrani sotto la conquista; per i giovani."},

"Right-believing Prince Roman of Ryazan":
{"type": "Principe · XIII sec.", "life": "Il santo principe Roman Olegovič di Rjazan' governò il suo principato negli anni amari del giogo tartaro, quando le terre russe giacevano sotto il dominio dell'Orda d'oro. Sovrano pio e giusto che difendeva il suo popolo e la sua fede, fu calunniato davanti al khan da uomini invidiosi che lo accusarono di aver ingiuriato la religione tartara.", "patron": "Si invoca per la confessione della fede sotto persecuzione."},

"Right-believing Prince Vladimir Yaroslavich of Novgorod":
{"type": "Principe · XI sec.", "life": "Il santo principe Vladimir Jaroslavič di Novgorod, il taumaturgo, era il figlio maggiore del gran principe Jaroslav il Saggio e della pia principessa Irene, che finì i suoi giorni come la monaca Anna ed è onorata con il figlio. Posto dal padre a capo di Novgorod a quattordici anni, fu guidato da saggi consiglieri e dal santo vescovo della città, e crebbe in un coraggioso difensore della sua terra e in un devoto cristiano, innalzando per il suo popolo una fortezza di pietra e istruendosi diligentemente nella legge del Signore.", "patron": "Si invoca per i costruttori di chiese; per l'edificazione delle chiese."},

"Right-believing Princess Juliana of Vyazma":
{"type": "Principessa · XV sec.", "life": "La principessa fedele Giuliana di Vjazma, casta portatrice della passione, era moglie del principe Simeone Mstislavič di Vjazma, e ne condivise l'esilio quando Smolensk e Vjazma caddero alla Lituania e i principi spodestati si rifugiarono a Toržok al servizio del principe Jurij di Smolensk. Là la sua bellezza divenne la sua croce: Jurij, infiammato di passione per la moglie del suo stesso fedele compagno, e trovandone la virtù inamovibile, decise la violenza, e a un banchetto nell'inverno del 1406 abbatté il principe Simeone alla mensa, pensando di prendersi la vedova insieme al marito.", "patron": "Si invoca per le mogli; per le donne in pericolo."},

"Righteous Abel the Shepherd":
{"type": "Giusto · Antico Testamento", "life": "Abele fu il secondo figlio di Adamo e di Eva e pascolava le pecore, mentre suo fratello Caino lavorava la terra. Entrambi portarono offerte a Dio, e Dio guardò all'offerta di Abele e al suo sacrificio dei primogeniti del gregge, ma non all'offerta di Caino. Caino si adirò, e levandosi contro il fratello nel campo lo uccise, e la voce del suo sangue gridò dalla terra.", "patron": "Si invoca per gli innocenti uccisi; per i pastori."},
...
{"type": "Lo zar e la famiglia imperiale · XX sec.", "life": "In questo giorno la Chiesa commemora i santi portatori della passione della famiglia imperiale: lo zar Nicola secondo, sua moglie la zarina Alessandra, il loro figlio lo zarevič Aleksej, e le loro figlie le granduchesse Ol'ga, Tat'jana, Maria e Anastasia, insieme ai fedeli servitori che scelsero di rimanere con loro fino alla fine.", "patron": "Si invoca per il perdono dei nemici; per la famiglia."},

"Saint Agapitos the Confessor and Wonderworker, Bishop of Synnada in Phrygia":
{"type": "Confessore e vescovo · IV sec.", "life": "Sant'Agapito confessore e taumaturgo, vescovo di Sinnada, era cappadoce ed entrò nella vita monastica in gioventù, faticando in una fraternità frigia dove il suo digiuno, la sua obbedienza e la sua preghiera furono coronati presto dal dono dei prodigi, guarendo il giovane monaco i malati che erano portati alle porte.", "patron": "Si invoca per i coscritti; per i soldati della fede."},

"Saint Aidan, Bishop of Lindesfarne":
{"type": "Vescovo · VII sec.", "life": "Sant'Aidan, illuminatore della Northumbria, nacque in Irlanda e si fece monaco nell'isola di Iona, nel monastero fondato da san Columba, dove fu noto per la sua rigorosa ascesi e per la sua dolcezza. Quando Oswald, il re cristiano della Northumbria, chiese un vescovo che portasse il Vangelo al suo popolo ancora pagano, Aidan fu mandato, ed egli stabilì la sua sede episcopale nell'isola di Lindisfarne, presso la fortezza regale, scegliendo un luogo quieto in disparte dal mondo.", "patron": "Si invoca per i missionari; per l'illuminazione missionaria."},

"Saint Akakios, Bishop of Melitēnḗ":
{"type": "Confessore e vescovo · III sec.", "life": "Sant'Acacio, vescovo di Melitene in Armenia, confessò Cristo nella persecuzione dell'imperatore Decio, verso l'anno 250, e il suo certame appartiene all'ordine che la Chiesa chiama dei confessori, quelli che sopportarono i tormenti dei martiri senza ricevere la morte dei martiri. Pastore di Melitene in un'età in cui l'episcopato era il primo bersaglio della persecuzione, Acacio fu preso e condotto davanti al tribunale, e là rispose all'interrogatorio con una franchezza e una sapienza che i racconti del suo esame conservano con gusto, confessando l'unico Dio e il suo Cristo, smontando le pretese degli idoli, e ricevendo con serenità le torture con le quali i giudici cercavano di emendare la sua teologia; e né le ferite né le minacce mutarono una sillaba, trattando il vescovo il cavalletto come una seconda cattedra e l'interrogatorio come un catechismo tenuto a proprie spese.", "patron": "Si invoca per i vescovi sotto interrogatorio; per i confessori rilasciati vivi."},

"Saint Alban, Protomartyr of Britain":
{"type": "Protomartire · IV sec.", "life": "Sant'Alban è onorato come protomartire di Britannia, il primo di quella terra a versare il sangue per Cristo, e la sua conversione e la sua morte sono una parabola della potenza del Vangelo. Era cittadino della città romana di Verulamium in Britannia, pagano, quando in tempo di persecuzione un sacerdote cristiano, in fuga dai suoi inseguitori, giunse alla sua porta; e Alban, mosso a pietà, accolse il sacerdote e lo nascose.", "patron": "I primi martiri di una terra; quanti danno rifugio ai perseguitati."},

"Saint Alexander of Guria":
{"type": "Vescovo · XX sec.", "life": "Il santo gerarca Alessandro di Guria, nel mondo Alexi Okropiridze, nacque nel 1824 nel villaggio di Disevi nel distretto di Gori, figlio del prete del villaggio, e dopo il seminario di Tbilisi fu tonsurato monaco e compì con lode i suoi studi all'accademia teologica di Kazan.", "patron": "Si invoca per i maestri; per gli educatori."},

"Saint Alexander, Patriarch of Constantinople":
{"type": "Patriarca · IV sec.", "life": "Sant'Alessandro era vescovo sotto san Metrofane, primo patriarca di Costantinopoli, e per la grande età di Metrofane fu mandato in sua vece al primo concilio ecumenico di Nicea, dove l'eresia ariana fu condannata; e alla dormizione di Metrofane, che lo aveva nominato nel suo testamento, Alessandro gli succedette sul trono della città imperiale.", "patron": "Si invoca per l'Ortodossia contro l'arianesimo."},

"Saint Alexei, Metropolitan of Moscow, Wonderworker of All Russia":
{"type": "Metropolita · XIV sec.", "life": "Sant'Alessio, metropolita di Mosca e di tutta la Russia, taumaturgo, nacque Eleuterio nella famiglia boiara dei Bjakont verso l'anno 1300, e Dio gli si rivolse nella fanciullezza per mezzo del suo stesso passatempo: sonnecchiando sulle sue reti da uccellagione a dodici anni, il ragazzo udì una voce dire, Alessio, perché fatichi invano? Io ti farò pescatore di uomini.", "patron": "Si invoca per i gerarchi; per gli uomini di stato."},

"Saint Ambrose, Bishop of Milan":
{"type": "Vescovo · IV sec.", "life": "Sant'Ambrogio, vescovo di Milano, uno dei grandi padri dell'Occidente, nacque verso il 340 a Treviri, figlio del prefetto del pretorio delle Gallie; e la tradizione narra che uno sciame di api si posò sulle labbra del bambino e se ne andò senza fargli male, presagio della parola melliflua che sarebbe venuta.", "patron": "Si invoca per i vescovi; per i governatori."},

"Saint Amphilochius, Bishop of Vladimir, Volhynia":
{"type": "Vescovo · XII sec.", "life": "Sant'Anfilochio, vescovo di Vladimir in Volinia, fu il terzo vescovo di quella sede, una delle più antiche della terra russa, stabilita ai giorni di san Vladimiro il Grande; i suoi predecessori furono Stefano, scelto sotto Vladimiro stesso, e Stefano igumeno delle Grotte di Kyiv che era succeduto a san Teodosio.", "patron": "Si invoca per i missionari; per lo sradicamento del paganesimo."},

"Saint Amphilokhios, Bishop of Iconium":
{"type": "Vescovo · IV sec.", "life": "Sant'Anfilochio, vescovo di Iconio, nacque verso l'anno 340 a Cesarea di Cappadocia, quel vivaio dei grandi padri, e fu parente di Gregorio il Teologo e caro amico di Basilio il Grande. Avvocato brillante a Costantinopoli, lasciò i tribunali per Cristo, ritirandosi a una vita di ascesi e alla cura del padre anziano.", "patron": "Si invoca per gli avvocati; per i vescovi."},

"Saint Anastasia the Patrician of Alexandria":
{"type": "Monaca · VI sec.", "life": "La venerabile Anastasia patrizia visse a Costantinopoli, discesa da famiglia aristocratica, immagine di virtù che godeva della grande stima dell'imperatore Giustiniano stesso; e proprio quella stima divenne il pericolo della sua vita. Rimasta vedova giovane, e stanca delle invidie e degli intrighi che il favore di corte le aveva suscitati, Anastasia decise di lasciare il mondo e di salvare l'anima lontano dalla capitale: si ritirò ad Alessandria e vi fondò un monastero fuori della città, dove la gran dama divenne monaca fra le sue stesse sorelle, e la prima fuga parve compiuta.", "patron": "Si invoca per le vedove; per le donne in fuga da onori non voluti."},

"Saint Anastasius of the Strumitza Eparchy":
{"type": "Martire · XVIII sec.", "life": "Il neomartire Anastasio nacque nell'anno 1774 nel villaggio di Radoviste, nella diocesi di Strumica, e da giovane andò a Tessalonica per imparare un mestiere. Là, quando aveva circa vent'anni, cadde sotto l'ira dei turchi, i quali colsero un pretesto e cercarono di costringerlo a rinnegare Cristo e ad abbracciare l'islam.", "patron": "Si invoca per la confessione salda."},

"Saint Andrew, Archbishop of Crete":
{"type": "Arcivescovo · VIII sec.", "life": "Sant'Andrea, arcivescovo di Creta, uno dei più grandi innografi della Chiesa, nacque a Damasco in una devota famiglia cristiana, e si racconta che fu muto fino a sette anni, ricevendo il dono della parola dopo essersi comunicato per la prima volta ai santi Misteri.", "patron": "Si invoca per gli innografi; per la penitenza."},

"Saint Angelina of Serbia":
{"type": "Monaca · XVI sec.", "life": "La venerabile Angelina, onorata come madre di santi, era figlia del principe Giorgio d'Albania. Fu data in moglie a santo Stefano Branković, il signore esiliato e ingiustamente accecato della Serbia, che aveva trovato rifugio alla corte di suo padre, ed ella ne condivise le sofferenze con fede e coraggio.", "patron": "Si invoca per le vedove e le madri."},

"Saint Antiochus":
{"type": "Monaco · VII sec.", "life": "Sant'Antioco monaco, della Grande Lavra di San Saba, visse l'ora più oscura del monachesimo palestinese e ne mutò la rovina in un libro. Galata d'origine e sabbaita di formazione, era monaco della Lavra quando l'invasione persiana del 614 si abbatté sulla Terra santa, e ne divenne il cronista testimone oculare dei martiri, registrando la strage dei quarantaquattro padri di San Saba che non vollero fuggire dalle loro celle, memoriale che la Chiesa serba fino a oggi sulla sua testimonianza.", "patron": "Si invoca per gli scrittori; per i bibliotecari."},

"Saint Archippus of Herapolis":
{"type": "Venerabile · IV sec.", "life": "Sant'Archippo nacque a Ierapoli di Frigia da genitori cristiani devoti, e a dieci anni, venuto a pregare alla chiesa del capo delle schiere Michele sopra la sorgente taumaturga presso Colossi, vi rimase a servire come suo custode per tutto il resto della vita.", "patron": "Si invoca per i custodi delle chiese; per il servizio fedele."},

"Saint Arkadios the Wonderworker, Bishop of Arsinoe, Cyprus":
{"type": "Vescovo · IV sec.", "life": "Sant'Arcadio taumaturgo nacque ad Arsinoe nell'isola di Cipro, figlio di genitori pii e ricchi di nome Michele e Anna, e visse dalla fine del terzo secolo al principio del quarto. Mandato a studiare a Costantinopoli, tornò nella sua Arsinoe natale, dove divenne rinomato per le sue fatiche ascetiche e per la grandezza delle sue virtù, sicché quando il vescovo Nicone si addormentò, Arcadio fu scelto a succedergli sul trono episcopale.", "patron": "Si invoca per l'umiltà; per l'astinenza."},

"Saint Arsenius, Bishop of Tver":
{"type": "Vescovo · XV sec.", "life": "Sant'Arsenio, vescovo di Tver', fu formato come monaco alla Lavra delle Grotte di Kyiv, casa madre del monachesimo russo, e ne portò al nord la tradizione in entrambe le forme che durano, la pietra e l'inchiostro. Preso al servizio del metropolita Cipriano, fu consacrato alla sede di Tver' nel 1390, in un momento in cui quel principato si lacerava nelle faide dei suoi principi e nelle liti che avevano lasciato contesa la sede stessa.", "patron": "Si invoca per i pacificatori; per i gerarchi."},

"Saint Artemon, Bishop of Seleucia":
{"type": "Vescovo · I sec.", "life": "Sant'Artemone, primo vescovo di Seleucia di Pisidia, appartiene alla generazione che gli apostoli costituirono con le proprie mani, e la sua consacrazione è il centro luminoso della sua biografia: quando l'apostolo Paolo, nel corso dei suoi viaggi missionari per gli altipiani dell'Asia Minore, venne a Seleucia e vi predicò Cristo, trovò in Artemone un uomo già maturo per la messe, prudente, fervente e amato dal popolo.", "patron": "Si invoca per i primi vescovi; per quanti sono ordinati da mani apostoliche."},

"Saint Athanasius of Lubensk, Patriarch of Constantinople":
{"type": "Gerarca · XVII sec.", "life": "Sant'Atanasio Patellarios, patriarca di Costantinopoli, detto di Lubensk dal luogo della sua dormizione, e noto fra i fedeli come Atanasio il seduto per la singolare intronizzazione delle sue reliquie, nacque Alessio a Rethymno di Creta verso il 1597, da famiglia ragguardevole, e divenne uno dei greci più dotti della sua generazione, padrone di lingue, filosofo, innografo e traduttore del Salterio; tonsurato nelle dipendenze del Sinai e risplendente nella vita ascetica, salì per il trono di Tessalonica fino al trono ecumenico di Costantinopoli stesso, che occupò, nella crudele porta girevole che la potenza ottomana aveva fatta di quell'ufficio, brevemente e ripetutamente, essendo il patriarcato di quei secoli una carica comprata sopra la testa di chi la deteneva da intriganti e tassata in un debito perpetuo, sicché Atanasio conobbe la prima sede d'Oriente soprattutto come una croce, la tenne nella povertà, nella deposizione e nell'esilio, e governò, ogni volta che gli fu permesso, con un sapere e una santità che il caos intorno al trono non poté toccare.", "patron": "Il trono ecumenico tenuto nella povertà."},

"Saint Athanasius the Great, Patriarch of Alexandria":
{"type": "Gerarca · IV sec.", "life": "In questo giorno la Chiesa celebra la memoria della dormizione e della traslazione delle reliquie di sant'Atanasio il Grande, patriarca di Alessandria, colonna dell'ortodossia, la cui festa principale si celebra in gennaio con san Cirillo; e la commemorazione di maggio, ancorata al giorno della sua dormizione, invita i fedeli a leggere la sua vita come egli la finì, intera, e a farne l'aritmetica della costanza.", "patron": "L'omousios tenuto fermo contro il mondo."},

"Saint Averkios the Wonderworker, Bishop of Hieropolis, Equal of the Apostles":
{"type": "Vescovo · II sec.", "life": "Sant'Abercio taumaturgo, vescovo di Ierapoli di Frigia, pari agli apostoli, pascolò il suo piccolo gregge in una città data agli idoli ai giorni di Marco Aurelio. Comandato in visione di distruggere gli inganni dei demoni, entrò di notte nel tempio e rovesciò gli idoli.", "patron": "Si invoca per la guarigione; per la conversione delle città."},

"Saint Barsanuphius, Bishop of Tver":
{"type": "Vescovo · XVI sec.", "life": "San Barsanufio, vescovo di Tver' e illuminatore di Kazan, nacque Vasilij, figlio di un prete di Serpuchov, e ricevette per catastrofe l'equipaggiamento più strano della sua vita: preso da giovane in un'incursione dei tartari di Crimea, passò anni in cattività servendo padroni musulmani, e là, invece di disperarsi, fece quel che soltanto la grazia spiega, custodendo le sue preghiere, i suoi digiuni entro i limiti della schiavitù e la sua speranza, e imparando intanto perfettamente la lingua tartara e la fede, i costumi e il cuore dei suoi rapitori, conducendo lo schiavo, senza saperlo, lo studio sul campo per una missione non ancora concepita.", "patron": "Si invoca per quanti sono stati prigionieri; per i missionari che parlano la lingua dei popoli."},

"Saint Basil of Poiana Marului":
{"type": "Igumeno · XVIII sec.", "life": "Il venerabile Basilio di Poiana Mărului fu la sorgente nascosta del grande rinnovamento esicasta, l'anziano la cui cella nei monti di Buzău in Valacchia nutrì il fiume che avrebbe irrigato l'Athos, la Moldavia e tutta la Russia; monaco formato negli skiti dei Carpazi negli anni duri dei secoli turchi, divenne igumeno dello skite di Poiana Mărului, la Radura dei Meli, e col tempo guida spirituale di tutti gli skiti dei monti di Buzău, una dozzina di piccole fraternità che guardavano a un solo anziano, organizzato invisibilmente il deserto intorno a un solo cuore che discerneva.", "patron": "Si invoca per gli anziani e le guide spirituali; per i maestri della preghiera di Gesù."},

"Saint Basil the Confessor, Bishop of Parium":
{"type": "Confessore e vescovo · VIII sec.", "life": "San Basilio il confessore, vescovo di Pario sull'Ellesponto, pascolò la sua sede nell'età del primo iconoclasmo, e il sinassario bizantino riassume tutto il suo episcopato in una sola grave frase, che seguendo l'esempio dell'apostolo Paolo passò la vita in persecuzioni, dolori e tribolazioni, fuggendo senza posa di luogo in luogo per non cadere nelle mani degli iconoclasti ed essere costretto a sottoscrivere contro le sante icone.", "patron": "Si invoca per i vescovi che non vogliono firmare; per i braccati e i profughi."},

"Saint Basil, Bishop of Zakholmsk in Montenegro, Serbia":
{"type": "Vescovo · XVI sec.", "life": "San Basilio, vescovo di Zakholm in Montenegro, è commemorato sotto questo titolo nei calendari slavi in questo giorno, e la Chiesa pone qui apertamente quel che i registri mostrano: questa voce e il grande taumaturgo Basilio di Ostrog, metropolita di Zahumlje, sono uno e lo stesso santo, portato nei libri sotto due stili.", "patron": "Si invoca per i gerarchi della sede di Zahumlje; per la sede di Zahumlje mantenuta santa sotto il giogo."},

"Saint Boniface the Merciful, Bishop of Ferentino":
{"type": "Vescovo · VI sec.", "life": "San Bonifacio il misericordioso, vescovo di Ferentino in Italia, visse nel sesto secolo, e i suoi prodigi furono messi per iscritto entro la memoria dei viventi da san Gregorio Magno nei Dialoghi, dove il papa di Roma conservò le storie dei santi del suo stesso suolo italiano. La misericordia corse davanti alla ragione di Bonifacio fin dall'infanzia: tutto quel che veniva in mano al fanciullo andava ai poveri, la sua stessa camicia compresa, e una volta, trovato il granaio di sua madre vedova, la provvista di tutto l'anno della casa, diede quasi tutto il grano ai bisognosi.", "patron": "Si invoca per quelli che fanno l'elemosina; per gli amministratori di piccoli mezzi."},

"Saint Caesarius, brother of Saint Gregory the Theologian":
{"type": "Giusto · IV sec.", "life": "San Cesario, fratello di san Gregorio il Teologo, era il figlio minore di Gregorio il vecchio, vescovo di Nazianzo, e della giusta Nonna, nato nell'unica casa che diede alla Chiesa una famiglia intera di santi; e là dove suo fratello prese la via delle lettere e dell'altare, Cesario prese la via delle scienze, studiando ad Alessandria medicina, geometria e astronomia finché non divenne il medico più illustre del suo tempo, chiamato a Costantinopoli e innalzato alla corte imperiale come suo primo medico.", "patron": "Si invoca per i medici; per gli scienziati."},

"Saint Charitina, Princess of Lithuania":
{"type": "Monaca · XIII sec.", "life": "Santa Caritina, principessa di Lituania, lasciò la sua terra natale nei tempi torbidi del tredicesimo secolo e trovò rifugio a Novgorod, dove, decisa a dare interamente la vita al Signore, ricevette la tonsura monastica nel monastero femminile dei santi apostoli Pietro e Paolo sul colle di Sinič.", "patron": "Si invoca per le badesse; per gli esuli."},
...
{"type": "Vescovo · X sec.", "life": "I santi Clemente, Naum, Sava, Gorazd e Angelario erano slavi e discepoli dei santi pari agli apostoli Cirillo e Metodio, e insieme ai loro maestri sono onorati come illuminatori dei popoli slavi. Faticarono dapprima in Moravia, dove predicarono e celebrarono i divini uffici nella lingua slava, usando le lettere ideate da san Cirillo, e san Gorazd succedette a san Metodio come arcivescovo.", "patron": "Si invoca per i maestri; per i traduttori."},

"Saint Clement the Stylite who lived as an ascetic on Mount Ságmata in Boeotia":
{"type": "Stilita · XII sec.", "life": "Il venerabile Clemente stilita visse da asceta sul monte Sagmata in Beozia e si addormentò nell'anno 1111, uno dei tardi e solitari eredi dei santi della colonna, portando nel dodicesimo secolo la più verticale di tutte le vocazioni della Chiesa. Ritiratosi dal mondo sulla vetta del Sagmata, il monte che sta sopra la pianura beotica in vista dell'antica Tebe, Clemente salì sopra una stretta colonna e ne fece il suo capitello la cella, la chiesa e la tomba in attesa, esposto solo al sole, al vento e agli inverni dell'altura.", "patron": "Si invoca per gli stiliti; per i solitari dei monti."},

"Saint Cosmas the Hymnographer, Bishop of Maiuma":
{"type": "Vescovo · VIII sec.", "life": "San Cosma innografo, vescovo di Maiuma, rimase orfano e fu adottato dal pio Sergio di Damasco, padre di san Giovanni Damasceno, sicché i due fanciulli furono allevati come fratelli; e furono educati insieme da un dotto anziano, chiamato anch'egli Cosma, monaco d'Italia che Sergio aveva riscattato dalla cattività.", "patron": "Si invoca per gli innografi; per i cantori."},

"Saint Cosmas, Bishop of Chalcedon, and his fellow ascetic, Saint Auxentius":
{"type": "Confessore e vescovo · IX sec.", "life": "San Cosma, vescovo di Calcedonia, e il suo compagno d'ascesi Aussenzio confessarono insieme le sante icone nel secondo iconoclasmo, e la Chiesa li commemora insieme, il gerarca e il suo compagno di cella uniti nel calendario come lo furono nella resistenza. Cosma aveva abbracciato la vita monastica fin dalla giovinezza, e la sua misura ascetica lo portò, nel modo consueto della Chiesa con i riluttanti, al trono episcopale di Calcedonia, la sede del quarto concilio ecumenico, il cui vescovo portava nel titolo stesso la memoria della fede definita dalla Chiesa.", "patron": "Si invoca per i vescovi e i loro compagni; per gli amici nella confessione."},
...
{"type": "Monaco · XIV sec.", "life": "Il venerabile Dionisio il costruttore fu il fondatore del grande monastero del Precursore sul monte Athos, la casa che prese il suo stesso nome ed è detta Dionysiou.", "patron": "I fondatori di monasteri; quanti costruiscono alla visione di una luce."},
...
{"type": "Monaco · VI sec.", "life": "Il venerabile Emiliano di Roma, nel mondo Vittorino, era romano di nascita e passò quasi tutta la vita nel peccato, e la Chiesa ne serba la memoria proprio perché la storia non finì là: nella sua vecchiaia tornò in sé, si pentì e, lasciato il mondo che gli aveva divorato gli anni, entrò in un monastero, dove ricevette la tonsura con il nome di Emiliano e si mise, nel poco tempo che restava, a riscattare i decenni perduti.", "patron": "Si invoca per i penitenti della vecchiaia; per quanti si pentono in segreto."},
...
{"type": "Sacerdote · IV sec.", "life": "I santi Giulio presbitero e Giuliano diacono furono due fratelli, un sacerdote e un diacono, che faticarono come missionari nell'Italia settentrionale nell'età degli imperatori cristiani, abbattendo i templi degli idoli e innalzando al loro posto chiese di Cristo.", "patron": "I fratelli missionari; i costruttori di chiese."},

"Saint Justinian the Emperor":
{"type": "Imperatore · VI sec.", "life": "San Giustiniano imperatore, una delle grandi figure dell'impero cristiano, nacque nel 483 a Tauresium nell'Illirico, di stirpe contadina e, come ritiene un'antica tradizione, di discendenza slava; e innalzato al trono nel 527 come nipote ed erede dell'imperatore Giustino, regnò trentotto anni con la visione dell'impero come servitore terreno del regno celeste.", "patron": "Si invoca per i legislatori; per i costruttori."},

"Saint Juvenal, Patriarch of Jerusalem":
{"type": "Patriarca · V sec.", "life": "San Giovenale fu patriarca di Gerusalemme lungo gli anni centrali del quinto secolo, occupando il trono della Città santa per trentotto anni, in un'età adornata da luminari quali Eutimio il Grande, del quale fu stretto amico. Il suo episcopato cadde in un tempo di grande lotta dottrinale, ed egli prese parte principale alla difesa della fede: stette fra i padri del terzo concilio ecumenico di Efeso, che condannò l'errore di Nestorio, e del quarto di Calcedonia, che condannò l'insegnamento monofisita di Eutiche e confessò le due nature di Cristo, divina e umana, unite senza separazione e senza confusione.", "patron": "Si invoca per la difesa della dottrina ortodossa."},

"Saint Kevin of Glendalough":
{"type": "Igumeno · VII sec.", "life": "Il venerabile Kevin di Glendalough fu uno dei grandi fondatori monastici d'Irlanda, un eremita la cui fuga in una solitudine di montagna diede origine a una delle più famose città monastiche della Chiesa celtica.", "patron": "I fondatori di monasteri; gli eremiti e gli amanti della solitudine."},

"Saint Leo of Cappadocia":
{"type": "Martire e monaco · IX sec.", "life": "Il venerabile Leone di Cappadocia è ricordato nel calendario per una sola transazione, ed è quella che il Signore stesso nominò come il colmo dell'amore. Monaco del paese cappadoce nell'età delle incursioni saracene, quando le terre di confine dell'Asia Minore vivevano sotto il flagello perpetuo delle razzie di schiavi, Leone vide i predoni portare via tre dei suoi fratelli monaci, uomini malati e infermi, inutili come lavoratori e perciò destinati a essere abbandonati nel deserto appena la loro debolezza avesse rallentato la colonna.", "patron": "Si invoca per i prigionieri; per quanti riscattano gli altri."},

"Saint Leo the Great, Pope of Rome":
{"type": "Gerarca · V sec.", "life": "San Leone il Grande, papa di Roma, governò la sede apostolica per la metà del quinto secolo, mentre l'impero d'Occidente si dissolveva intorno a essa, e stette sulla breccia due volte per la fede e due volte per la città, i quattro atti della sua grandezza. Il monumento della sua mente è il Tomo, la lettera che indirizzò nel 449 a Flaviano di Costantinopoli contro l'errore di Eutiche, esponendo con romana chiarezza e con equilibrio da giurista il mistero dell'unico Cristo in due nature complete, vero Dio e vero uomo, operando ciascuna natura quel che le è proprio in comunione con l'altra; soppresso con la violenza al latrocinio, il Tomo fu letto infine davanti al quarto concilio ecumenico di Calcedonia nel 451, e i padri radunati gridarono, Pietro ha parlato per bocca di Leone, ponendo l'Oriente il suo sigillo conciliare sulla pagina del dottore occidentale, che sta per sempre incorporata nella definizione che la Chiesa dà del suo Signore. I monumenti del suo coraggio sono due incontri: nel 452, quando Attila e gli unni, cancellata Aquileia, si volsero verso una Roma indifesa, il papa uscì nei suoi paramenti a incontrare il terrore del mondo presso il fiume Mincio, e Attila, che nulla di vivente temeva, fece voltare la sua orda, registrando la tradizione della Chiesa che l'unno vide gli apostoli Pietro e Paolo stare armati sopra il vecchio mentre parlava; e nel 455, quando Genserico e i vandali non poterono essere respinti, Leone incontrò anche lui alle porte e strappò al sacco i suoi denti peggiori, niente incendi, niente stragi, niente torture, la città saccheggiata ma viva, trattando il papa con i barbari le clausole della sopravvivenza."},

"Saint Leo, Bishop of Catania in Sicily":
{"type": "Vescovo · VIII sec.", "life": "San Leone, vescovo di Catania in Sicilia, pascolò quella città sotto l'Etna nell'ottavo secolo, gerarca famoso per compassione verso i poveri e i malati, per guarigioni concesse alla sua preghiera, e per una dolcezza che rese tanto più terribile la sua ultima severità; e il suo nome è fissato nella memoria della Chiesa dal suo duello con il mago Eliodoro.", "patron": "Si invoca per i vescovi contro la stregoneria; per i protettori dei semplici del gregge."},

"Saint Liberius, Pope of Rome":
{"type": "Papa · IV sec.", "life": "San Liberio divenne vescovo di Roma nell'anno 352, dopo la dormizione di papa Giulio, e si mostrò zelante difensore della fede ortodossa contro l'eresia ariana e campione di sant'Atanasio di Alessandria. Quando l'imperatore Costanzo, favorendo gli ariani, chiese che condannasse Atanasio, Liberio rifiutò e fu mandato in esilio.", "patron": "Si invoca per l'Ortodossia contro l'eresia."},

"Saint Luke (Voino-Yasenetsky), Archbishop of Simferopol and Crimea (1961)":
{"type": "Confessore e arcivescovo · XX sec.", "life": "San Luca di Simferopoli, nel mondo Valentin Feliksovič Vojno-Jaseneckij, fu uno dei grandi confessori della Chiesa russa sotto la persecuzione sovietica, chirurgo rinomato che divenne vescovo e rese testimonianza a Cristo attraverso il carcere, l'esilio e una fatica incessante per i malati.", "patron": "I medici e i chirurghi; i confessori sotto il potere senza Dio."},

"Saint Macarius the Roman of Mesopotamia":
{"type": "Monaco · IV sec.", "life": "Il venerabile Macario il romano è noto alla Chiesa per l'antico racconto di tre monaci di Mesopotamia, Teofilo, Sergio e Igino, i quali viaggiarono verso oriente in cerca dei confini della terra e, dopo lunghe peregrinazioni per terre strane, trovarono, in un deserto oltre ogni abitato, una grotta e un anziano di terribile aspetto, vestito soltanto dei capelli bianchi della sua grande vecchiaia, con due leoni che dimoravano mansueti accanto a lui.", "patron": "Si invoca per gli eremiti; per la penitenza."},

"Saint Makarios the Roman":
{"type": "Igumeno · XVI sec.", "life": "Il venerabile Makarij il romano nacque alla fine del quindicesimo secolo in una ricca famiglia di Roma e ricevette un'eccellente educazione, ma non fece alcun conto degli onori terreni, cercando soltanto la salvezza della sua anima. Addolorato per i peccati e per le divisioni che scuotevano la Chiesa occidentale ai suoi giorni, pregò con lacrime che Dio gli mostrasse la via della verità e, venendo a comprendere che la pienezza della salvezza era nella Chiesa ortodossa, viaggiò in Russia.", "patron": "Si invoca per i monaci; per la conversione all'Ortodossia."},

"Saint Marcian of Cyrrhus":
{"type": "Monaco · IV sec.", "life": "Il venerabile Marciano di Cirro nacque da nobile famiglia di quella città siriana e, abbandonati il rango e le ricchezze, si ritirò nel deserto di Calcide, dove si rinchiuse in una cella tanto piccola che non poteva né stare eretto né distendersi per intero, dimorandovi nel digiuno, nella preghiera incessante e nel canto dei salmi.", "patron": "Si invoca per gli eremiti; per la moderazione unita al rigore."},

"Saint Mardarije (Uskokovic) of Libertyville":
{"type": "Vescovo · XX sec.", "life": "San Mardarije di Libertyville, primo vescovo serbo d'America e del Canada, nacque Ivan Uskoković il due di novembre del 1889 nel villaggio di Kornet in Montenegro; e ardendo per la vita monastica fin dall'infanzia, lasciò la casa a sedici anni, fu tonsurato con il nome di Mardarije, e fu mandato in Russia, dove compì la sua formazione teologica e servì la missione della chiesa serba finché la rivoluzione non lo spinse verso occidente.", "patron": "Si invoca per le comunità di immigrati; per i costruttori di chiese."},

"Saint Mariamne the sister of the Apostle Philip":
{"type": "Giusta vergine · I sec.", "life": "Santa Mariamne, sorella del santo apostolo Filippo, diede la sua verginità e tutta la sua vita al servizio dell'apostolato del fratello, e sta nel calendario come patrona di tutti quelli che servono il Vangelo accompagnandone i predicatori. Quando i Dodici uscirono nel mondo, Mariamne andò con Filippo e con l'apostolo Bartolomeo per le città dell'Asia Minore, condividendo le strade, le dispute nelle sinagoghe, le guarigioni e l'ostilità, tenendo la sorella la piccola economia della missione, servendo i convertiti e istruendo le donne che gli apostoli non potevano facilmente raggiungere, la metà indispensabile e non accreditata dell'opera, come è stata in ogni missione da allora.", "patron": "Si invoca per le sorelle; per le donne che servono la missione."},

"Saint Martin the Confessor, Pope of Rome":
{"type": "Confessore e papa di Roma · VII sec.", "life": "San Martino il confessore, papa di Roma, nacque in Toscana verso la fine del sesto secolo, servì come apocrisiario della Chiesa romana a Costantinopoli, dove apprese l'eresia imperiale alla sua fonte, e fu eletto al trono di Roma nel 649; e pochi mesi dopo la sua elezione convocò il grande sinodo lateranense, l'atto conciliare più ardito del suo tempo, nel quale, faticando san Massimo il confessore accanto ai vescovi, l'eresia monotelita fu condannata fin dalla radice, confessando il sinodo in Cristo due volontà e due operazioni naturali, divina e umana, contro la dottrina di una sola volontà che gli imperatori avevano imposta per decreto, e nominando gli eresiarchi da Ciro di Alessandria fino ai patriarchi di Costantinopoli; e Martino, compiendo l'opera del defunto Sofronio, estese la sua cura all'Oriente devastato, nominando un vicario per le sedi vedove di Gerusalemme e di Antiochia, agendo il papa come custode della confessione di tutta la Chiesa mentre il trono di Costantino imponeva il proprio errore.", "patron": "Si invoca per i papi e i patriarchi; per i prigionieri politici."},

"Saint Maruthas, Bishop of Martyropolis in Mesopotamia":
{"type": "Vescovo · V sec.", "life": "San Maruta, vescovo di Martiropoli, fu il medico e diplomatico che Dio pose al cardine di due imperi, pastore di Mayperqat sulla frontiera romano-persiana allo scorcio del quinto secolo, dotto in medicina, nelle lettere siriache e nei modi delle corti. Due volte gli imperatori di Costantinopoli lo mandarono ambasciatore al re persiano Yazdegerd, e il medico superò il diplomatico: Maruta guarì il re di un male cronico del capo che i magi non avevano potuto toccare, e liberò da uno spirito maligno un membro della casa reale, e il re riconoscente aprì l'orecchio al cristiano; al che i magi minacciati misero in scena la loro famosa frode, nascondendo un uomo sotto il pavimento del tempio del fuoco perché gridasse, mentre il re entrava con Maruta, che l'empio il quale credeva al sacerdote cristiano doveva essere espulso, e Maruta, imperturbato, consigliò al re di far sollevare il pavimento, e la voce sepolta fu tratta alla luce del giorno, convertendo l'impostura il patrono della sua vittima designata, poiché Yazdegerd, disingannato, diede ai cristiani di Persia la tolleranza, il permesso di riedificare le loro chiese e la libertà di culto, negoziata la fine ufficiale della lunga persecuzione con una visita a domicilio e un'asse del pavimento.", "patron": "Si invoca per i medici; per i diplomatici."},

"Saint Matrona of Moscow":
{"type": "Beata · XX sec.", "life": "La beata Matrona di Mosca, l'anziana priva di vista che divenne l'occhio veggente della Russia ortodossa attraverso il mezzo secolo più oscuro della sua storia, nacque Matrona Nikonova nel 1881 nel villaggio di Sebino nel paese di Tula, quarta figlia di contadini poveri e pii, e nacque cieca, con le palpebre chiuse sopra orbite vuote; e la povertà che aveva tentato sua madre di dare via la bambina fu smentita prima della nascita da un sogno di un uccello bianco dal volto umano e dagli occhi chiusi che si posava sul suo petto, sicché la madre la tenne, e il cielo si tenne il suo segreto su quel che aveva mandato.", "patron": "La vista donata ai ciechi."},

"Saint Maximus, Metropolitan of Kyiv":
{"type": "Metropolita · XIV sec.", "life": "San Massimo, metropolita di Kyiv e di tutta la Rus', greco di nascita, fu mandato da Costantinopoli nel 1283 a pascolare la Chiesa della Rus' nella notte fonda del giogo tartaro, quando Kyiv, due volte devastata, giaceva mezzo in rovina e la corte stessa del metropolita si poteva a stento mantenere in mezzo alla desolazione.", "patron": "Si invoca per i gerarchi; per la cura pastorale di una terra devastata."},

"Saint Meletius, Archbishop of Antioch":
{"type": "Arcivescovo · IV sec.", "life": "San Meletio, arcivescovo di Antiochia, nacque a Melitene in Armenia da nobile famiglia, e venne al trono di Antiochia nel 360 con l'approvazione degli ariani, che scambiarono la sua mitezza per la loro propria dottrina; il suo primo sermone li disingannò, poiché il nuovo arcivescovo predicò il Figlio consustanziale al Padre, ed entro un mese il partito che lo aveva insediato ne aveva ottenuto l'esilio, dimostrandosi il vescovo più mite d'Oriente incorruttibile alla prima richiesta.", "patron": "Si invoca per i vescovi dei greggi divisi; per i pacificatori."},

"Saint Meletius, Archbishop of Khar'kov and Akhtyrsk":
{"type": "Arcivescovo · XIX sec.", "life": "San Meletio, arcivescovo di Charkiv e Achtyrka, nato Leontovič nelle terre di Poltava, fu uno di quegli asceti nascosti che la Chiesa sinodale del diciannovesimo secolo innalzò, quasi suo malgrado, ai suoi troni. Brillante nelle scuole, insegnò e governò nelle accademie teologiche, rettore e formatore di una generazione di clero, e passò per l'episcopato di più sedi prima di venire nel 1835 a Charkiv.", "patron": "Si invoca per i gerarchi della veglia notturna; per gli asceti in carica."},

"Saint Menas, Patriarch of Constantinople":
{"type": "Patriarca · VI sec.", "life": "San Mena, patriarca di Costantinopoli, fu dapprima presbitero di quella città e custode dell'ospizio di San Sansone, dove ai giorni dell'imperatore Giustiniano si prese cura dei poveri e dei malati con grande compassione. Quando il patriarca Antimo fu deposto per aver tenuto in segreto l'errore monofisita, Mena, uomo di provata santità, fu scelto al suo posto e consacrato da papa Agapito di Roma, che si trovava allora nella città imperiale.", "patron": "Si invoca per i poveri e i malati; per la carità."},

"Saint Methodius, Equal of the Apostles, Archbishop of Moravia, Enlightener of the Slavs":
{"type": "Arcivescovo pari agli apostoli · IX sec.", "life": "San Metodio, pari agli apostoli e arcivescovo di Moravia, fu il maggiore dei due fratelli di Tessalonica per mezzo dei quali le nazioni slave ricevettero le Scritture e la Liturgia nella loro propria lingua; nato da illustre casato, governò in gioventù una provincia slava dell'impero, imparando da amministratore la lingua che avrebbe speso la vita a battezzare, e rinunciò poi al mondo per i monasteri dell'Olimpo in Bitinia, dai quali la chiamata di Dio, arrivando come le chiamate arrivano in forma di lettere imperiali, lo trasse fuori accanto al suo brillante fratello Costantino, detto Cirillo, dapprima dai cazari, e poi, nell'863, nell'ambasceria che mutò la carta della cristianità, nella Grande Moravia, il cui principe aveva chiesto maestri che dessero al suo popolo la fede in parole che comprendesse.", "patron": "Si invoca per i missionari; per i traduttori."},

"Saint Methodius, Patriarch of Constantinople":
{"type": "Confessore e patriarca · IX sec.", "life": "San Metodio, patriarca di Costantinopoli, fu confessore delle sante icone, patì grandemente per la fede e visse fino a proclamarne la vittoria finale nel Trionfo dell'Ortodossia.", "patron": "I confessori delle sante icone; quanti sono incarcerati per la fede."},

"Saint Metrophanes, first Patriarch of Constantinople":
{"type": "Patriarca · IV sec.", "life": "San Metrofane, onorato come primo patriarca di Costantinopoli, fu vescovo di Bisanzio nell'ora stessa in cui quella città divenne la capitale cristiana del mondo, contemporaneo di san Costantino il Grande, e visse fino a grande vecchiaia nella santità e nell'umiltà.", "patron": "I primi gerarchi della città imperiale; i patriarchi di grande età e umiltà."},

"Saint Michael the Confessor, Bishop of Synnada":
{"type": "Gerarca · IX sec.", "life": "San Michele il confessore, vescovo di Sinnada in Frigia, fu gerarca, ambasciatore e confessore delle sante icone, spendendo i suoi doni al servizio della Chiesa e dell'impero e le sue sofferenze in difesa delle immagini di Cristo.", "patron": "Le icone difese contro l'imperatore."},

"Saint Michael, first Metropolitan of Kyiv":
{"type": "Metropolita · X sec.", "life": "San Michele, primo metropolita di Kyiv, fu per la tradizione della Chiesa siro di nascita, e fu mandato da Costantinopoli alla terra della Rus' quando il gran principe Vladimir ricevette il santo battesimo e volse il suo popolo a Cristo. Venuto a Kyiv con il clero nell'anno del battesimo della Rus', stette al fianco del principe nell'abbattimento degli idoli e nel battesimo del popolo nel Dnipro, e si diede tutto alla piantagione della Chiesa nella terra appena illuminata: battezzò, catechizzò e stabilì chiese e le prime scuole, e viaggiò con il Vangelo fino a Novgorod e a Rostov, abbattendovi gli idoli e innalzandovi la Croce.", "patron": "Si invoca per i missionari; per i gerarchi."},

"Saint Modestos, Archbishop of Jerusalem":
{"type": "Patriarca · VII sec.", "life": "San Modesto, arcivescovo di Gerusalemme, nacque a Sebaste di Cappadocia da genitori cristiani e, abbracciata la vita monastica in Terra Santa, salì a essere igumeno del monastero di san Teodosio; e Dio lo aveva addestrato nel deserto per l'ora più buia che la Città Santa avesse conosciuta dopo Tito.", "patron": "Si invoca per i mandriani; per i contadini."},

"Saint Moses, Archbishop of Novgorod":
{"type": "Arcivescovo · XIV sec.", "life": "San Mosè, arcivescovo di Novgorod, nacque in quella città da genitori ricchi e pii e fu chiamato Mitrofan nel battesimo; e fuggendo insieme le nozze e l'eredità, fu tonsurato con il nome di Mosè, faticò nei monasteri della terra di Novgorod e salì per pura fama a essere archimandrita del grande monastero di Jur'ev, dal quale, nel 1325, la città lo chiamò al suo trono arcivescovile.", "patron": "Si invoca per gli scribi; per i costruttori di chiese."},

"Saint Mstislav (George), Prince of Novgorod":
{"type": "Principe · XII sec.", "life": "San Mstislav, nel battesimo Giorgio, detto il Valoroso, fu principe di Novgorod nel dodicesimo secolo, onorato per il suo valore, la sua giustizia e la sua cura disinteressata del popolo e della terra a lui affidati.", "patron": "I principi giusti e valorosi; i difensori del popolo."},

"Saint Nektarios, Metropolitan of Pentapolis, Wonderworker of Aegina (1920)":
{"type": "Metropolita · XX sec.", "life": "San Nettario di Egina, uno dei taumaturghi più amati dei tempi moderni, nacque Anastasio Kefalas nel 1846 a Selimbria di Tracia da famiglia povera e pia. Dopo aver faticato per istruirsi a Costantinopoli e aver insegnato a Chio, vi si fece monaco nel 1876 e fu poi ordinato, e sotto il patrocinio del patriarca di Alessandria studiò teologia ad Atene e servì con distinzione in Egitto, dove nel 1889 fu consacrato metropolita di Pentapoli.", "patron": "Si invoca per quanti cercano lavoro; per il cancro e le malattie gravi."},

"Saint Nicholas the Wonderworker, Archbishop of Myra in Lycia":
{"type": "Gerarca · IV sec.", "life": "San Nicola nacque alla fine del terzo secolo a Patara di Licia, sulla costa meridionale dell'Asia Minore, figlio unico di genitori pii e ricchi che erano stati lungamente senza figli. Rimasto orfano giovane, diede via tutta la sua eredità ai poveri, e più celebremente lasciando di nascosto dell'oro per le doti di tre fanciulle indigenti, per salvarle dalla rovina, il gesto che sta dietro alla sua successiva associazione con i doni segreti. Dopo un pellegrinaggio in Terra Santa fu scelto, per una rivelazione ai vescovi radunati, arcivescovo di Mira.", "patron": "Patrono dei marinai, dei viaggiatori, dei bambini e dei falsamente accusati; si invoca per quanti sono nel bisogno e nel pericolo."},

"Saint Nikephoros the Confessor, Patriarch of Constantinople":
{"type": "Confessore e patriarca · IX sec.", "life": "San Niceforo il confessore, patriarca di Costantinopoli, fu difensore delle sante icone che perdette il suo trono e morì in esilio piuttosto che cedere la fede, e fu anche uno degli storici dotti del suo tempo.", "patron": "I confessori delle sante icone; i patriarchi deposti per la verità."},

"Saint Niketas, Bishop of Chalcedon":
{"type": "Gerarca · IX sec.", "life": "San Niceta il confessore, vescovo di Calcedonia, fu gerarca del principio del nono secolo, rinomato tanto per la sua misericordia verso i poveri quanto per la sua salda confessione delle sante icone nel secondo scoppio dell'eresia iconoclasta.", "patron": "Le icone difese contro l'imperatore."},

"Saint Nikḗtas, Bishop of Novgorod, Recluse of the Kyiv Far Caves":
{"type": "Gerarca · XII sec.", "life": "San Niceta, vescovo di Novgorod, recluso delle Grotte di Kyiv, è il grande esempio insieme ammonitore e consolante che la Chiesa ha dell'anima ingannata e restituita, e la sua memoria è tenuta in questo giorno a Novgorod, dove riposano le sue reliquie, come è tenuta in gennaio alla sua dormizione e in aprile al loro rinvenimento.", "patron": "Il recluso ingannato dall'angelo di luce e salvato."},

"Saint Niphon, Bishop of Constantia, Cyprus":
{"type": "Vescovo · IV sec.", "life": "San Nifone, vescovo di Costanzia a Cipro, nacque in Paflagonia nel quarto secolo e fu educato a Costantinopoli, fanciullo mite che amava gli uffici della Chiesa; e poi la sua giovinezza cadde nella fossa, anni di vita sregolata e dissoluta nei quali il ragazzo che aveva amato l'altare divenne straniero a se stesso, finché la grazia, servendosi del volto afflitto di un amico come suo specchio, non mostrò a Nifone il proprio sembiante oscurato, e cominciò la grande penitenza.", "patron": "Si invoca per i penitenti; per quanti sono tormentati dagli spiriti maligni."},

"Saint Niphon, Bishop of Novgorod":
{"type": "Vescovo · XII sec.", "life": "San Nifone, vescovo di Novgorod, fu tonsurato alla Lavra delle Grotte di Kyiv e portò al nord la sua formazione quando fu consacrato alla grande sede di Novgorod nel 1130; là pascolò con l'energia della tradizione delle Grotte, edificando e adornando chiese, coprendo di tetto la Santa Sofia e abbellendola, riconciliando i principi eternamente in lite e respingendo una volta, per puro peso morale, una campagna fratricida fra Novgorod e Kyiv, e governando la sua turbolenta città come un padre che non poteva essere né comprato né spaventato.", "patron": "Si invoca per i difensori dell'ordine canonico; per i vescovi fra i principi."},

"Saint Oleg, Prince of Briansk":
{"type": "Principe · XIII sec.", "life": "Il santo principe Oleg di Brjansk fu nipote del santo martire Michele di Černihiv, ed ereditò con il sangue la pietà per la quale il suo avo era morto all'Orda. Governando il principato di Brjansk nella seconda metà del tredicesimo secolo, pose il cuore non nell'ingrandimento della sua potenza ma nel regno di Dio.", "patron": "Si invoca per i sovrani; per la rinuncia al potere."},

"Saint Onuphrius of Saint David Gareji Monastery, Georgia":
{"type": "Monaco · XVIII sec.", "life": "Il venerabile Onofrio di Gareji, nel mondo Otar Machutadze, visse nel diciottesimo secolo, nobile della Kartli famoso per la sua ricchezza, la sua ospitalità e la sua mano aperta ai poveri. Desiderando in segreto la vita ascetica, portava un cilicio sotto le sue splendide vesti e pregava senza posa che Dio lo stimasse degno dell'abito angelico.", "patron": "Si invoca per i monaci; per l'ospitalità."},

"Saint Papias, Bishop of Hierapolis":
{"type": "Gerarca · II sec.", "life": "San Papia, vescovo di Ierapoli in Frigia, appartenne alla generazione che stava accanto agli apostoli e poteva ancora interrogare quanti li avevano uditi. Sant'Ireneo lo chiama uomo antico, uditore di Giovanni e compagno di Policarpo di Smirne; fu contemporaneo delle figlie dell'apostolo Filippo, che abitavano a Ierapoli, e riferisce ciò che udì da loro.", "patron": "Si invoca per quanti raccolgono e trasmettono la testimonianza."},
...
{"type": "Eremita · V sec.", "life": "I venerabili Martiniano, Zoe e Fotina di Cesarea di Palestina condividono una sola festa perché condividono una sola storia, la grande cronaca che la Chiesa ha della tentazione combattuta fino a una triplice vittoria. Martiniano andò nel deserto presso Cesarea a diciotto anni, e per venticinque anni si diede alle opere ascetiche e al silenzio, ricevendo i doni della guarigione e della cacciata dei demoni.", "patron": "Si invoca per i tentati; per i penitenti."},
...
{"type": "Monaco · XIII sec.", "life": "Il venerabile Dimitrie il nuovo, protettore di Bucarest, nacque nel tredicesimo secolo nel villaggio di Basarbov sul fiume Lom nelle terre bulgare, da genitori poveri e pii, e in giovinezza pascolava il bestiame del villaggio. Tanto delicata era la sua coscienza che, avendo una volta schiacciato senza saperlo sotto il piede un nido di uccellini, punì quel piede per tre anni, lasciandolo scalzo nel gelo e nella calura.", "patron": "Si invoca per i mandriani; per i pastori."},
...
{"type": "Monaca · XI sec.", "life": "La venerabile Parasceve di Iași, detta la nuova, nacque nell'undicesimo secolo a Epivato in Tracia, sulla riva del mare di Marmara, da genitori pii e ricchi. Da fanciulla, udendo in chiesa la parola del Signore, Chi vuol venire dietro a me, rinneghi se stesso, cominciò a dare ai poveri le sue vesti ricche, sopportando i rimproveri della sua famiglia.", "patron": "Si invoca per i poveri; per i pellegrini."},
...
{"type": "Monaco", "life": "I venerabili Sergio e Germano furono i fondatori del grande monastero della Trasfigurazione nell'isola di Valaam nel lago Ladoga, l'Athos settentrionale della terra russa. Antica tradizione tiene che fossero ieromonaci greci venuti nelle terre di Novgorod e stabilitisi sull'isola rocciosa, radunando una fraternità e piantando la luce dell'Ortodossia fra le tribù pagane della Carelia.", "patron": "Si invoca per i monaci; per il monachesimo del nord."},

"Translation of the Relics of the Holy Passionbearers Boris and Gleb (in Baptism Roman and David, 1072 and 1115)":
{"type": "Festa · XII sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie dei santi portatori della passione Boris e Gleb, nel santo battesimo Romano e David, i primi santi glorificati dalla terra della Rus', la cui memoria principale ella tiene in luglio; figli del pari agli apostoli Vladimir, uccisi nel 1015 dall'ambizione del loro fratello e fatti santi dal loro rifiuto di affrontarla con la spada, i due principi divennero subito la coscienza della loro dinastia, e il loro sepolcro a Vyšgorod l'unico terreno sul quale la casa in faida della Rus' acconsentì a stare insieme.", "patron": "I fratelli intronizzati dal loro popolo."},

"Translation of the Relics of the holy and wonderworking Unmercenaries Cyrus and John":
{"type": "Festa · V sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie dei santi e taumaturghi anargiri Ciro e Giovanni, martiri d'Egitto, i cui sacri corpi furono portati in un luogo di guarigione per abbattere la potenza dei demoni.", "patron": "I medici e gli anargiri; quanti scacciano i demoni per mezzo dei santi."},

"Translation of the relics of Blessed James of Borovichi, Wonderworker of Novgorod":
{"type": "Festa · XVI sec.", "life": "Il beato Giacomo di Boroviči, taumaturgo di Novgorod, fu rivelato alla Chiesa non dal racconto della sua vita ma dalla gloria delle sue reliquie. Nella primavera del 1540, alle rapide del fiume Msta presso l'abitato di Boroviči, un grande lastrone di ghiaccio risalì il fiume contro la corrente, portando sopra di sé una bara di legno bruciacchiato nella quale giaceva il corpo di un giovane.", "patron": "In questo giorno si prega per i barcaioli; per i giusti sconosciuti."},

"Translation of the relics of Blessed Vsevolod (in Baptism Gabriel), Prince of Pskov":
{"type": "Festa · XIX sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie del beato Vsevolod, nel santo battesimo Gabriele, principe di Pskov, il taumaturgo la cui memoria principale ella tiene in febbraio.", "patron": "In questo giorno si prega per quanti onorano le reliquie dei santi; per il principe riportato in gloria alla sua cattedrale."},

"Translation of the relics of Hieromartyr Philip, Metropolitan of Moscow":
{"type": "Metropolita · XVI sec.", "life": "Questa festa commemora la solenne traslazione delle reliquie di san Filippo, metropolita di Mosca, nella capitale nell'anno 1652. Nato Feodor Kolyčev, san Filippo fu igumeno del monastero di Solovki prima di essere innalzato alla sede di Mosca, dove rimproverò senza timore le crudeltà dello zar Ivan il terribile e le oppressioni della sua guardia.", "patron": "Si invoca per la libertà della Chiesa davanti allo stato."},

"Translation of the relics of Righteous Simeon of Verkhoturye":
{"type": "Festa · XVII sec.", "life": "Il giusto Simeone di Verchoturje fu un nobile della Russia europea che, nascondendo la sua nascita, venne nei tempi torbidi del principio del diciassettesimo secolo alle terre appena colonizzate oltre gli Urali e visse come povero vagabondo nel villaggio di Merkušino presso Verchoturje. Si guadagnava il pane cucendo pellicce per i contadini, e aveva l'abitudine, per evitare il pagamento, di lasciare qualche piccola parte del lavoro non finita e di partire quietamente, portando i rimproveri dei suoi committenti per amore della santa povertà.", "patron": "In questo giorno si prega per i sarti; per i pescatori."},

"Translation of the relics of Saint Gurias, Archbishop of Kazan":
{"type": "Festa · XVII sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie di san Gurij, primo arcivescovo di Kazan, illuminatore di quella terra appena conquistata.", "patron": "I primi gerarchi di una terra convertita; quanti hanno le reliquie traslate nella gloria."},

"Translation of the relics of Saint Hilarion, Bishop of Meglin in Bulgaria":
{"type": "Vescovo · XII sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie di sant'Ilarione, vescovo di Meglin, avvenuta nell'anno 1206, quando lo zar bulgaro Kalojan, raccogliendo i santi tesori della terra, portò le reliquie taumaturghe del gerarca alla sua capitale di Tarnovo.", "patron": "Si invoca per gli apologisti; per la difesa dell'Ortodossia contro l'eresia."},

"Translation of the relics of Saint John Chrysostom, Archbishop of Constantinople":
{"type": "Arcivescovo · V sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie di san Giovanni Crisostomo, arcivescovo di Costantinopoli, il rovesciamento in gloria della grande ingiustizia del suo tempo. La bocca d'oro era stata cacciata dal suo trono dall'inimicizia dell'imperatrice Eudossia e dagli intrighi dei suoi rivali, ed era morto in esilio a Comana nel 407, consumato da marce forzate, con le parole che riassumono tutta la sua teologia, Gloria a Dio per tutte le cose.", "patron": "Si invoca per i predicatori; per gli esuli riconosciuti innocenti."},

"Translation of the relics of Saint Maximus the Confessor":
{"type": "Monaco · VII sec.", "life": "San Massimo il confessore, uno dei più grandi teologi della Chiesa, nacque a Costantinopoli verso l'anno 580 e servì come primo segretario dell'imperatore Eraclio prima di abbandonare la corte per la vita monastica al monastero di Crisopoli, dove col tempo divenne igumeno.", "patron": "Si invoca per i teologi; per la teologia ortodossa."},

"Translation of the relics of Saint Nicholas the Wonderworker from Myra to Bari":
{"type": "Festa · XI sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie di san Nicola il taumaturgo, arcivescovo di Mira di Licia, da Mira alla città di Bari in Italia, nell'anno 1087, festa che il popolo russo venne a chiamare il Nicola di primavera e ad amare appena meno della sua memoria di dicembre.", "patron": "Il taumaturgo portato a occidente prima della tempesta."},

"Translation of the relics of Saint Nikephoros, Patriarch of Constantinople":
{"type": "Confessore e patriarca · IX sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie di san Niceforo, patriarca di Costantinopoli, uno dei grandi confessori delle sante icone, la cui festa principale è tenuta in giugno; la commemorazione di marzo segna il giorno del suo trionfale ritorno nella Città, che fu anche, per l'esatta contabilità di Dio, il giorno della sua espulsione da essa.", "patron": "Si invoca per i patriarchi; per i teologi dell'icona."},

"Translation of the relics of Saint Peter, Metropolitan of Moscow and All Russia":
{"type": "Metropolita · XIV sec.", "life": "San Pietro, metropolita di Mosca e di tutta la Russia, fu il primo primate della Chiesa russa a prendere dimora a Mosca, e con questo benedisse l'ascesa di quella città, che sotto i suoi successori divenne il cuore della terra russa. Pastore di grande santità e sapienza, fortificò la fede fra il suo gregge in un tempo duro di divisione e di dominio tataro, sostenne l'unità della Chiesa e predisse la futura gloria di Mosca.", "patron": "Si invoca per Mosca; per l'unità della Chiesa."},

"Translation of the relics of Saint Tikhon of Luchov, Kostroma":
{"type": "Festa · XVI sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie di san Tichon di Luchov, l'antico soldato che divenne povero monaco nel paese di Kostroma e fu glorificato da Dio con l'incorruzione.", "patron": "Quanti hanno le reliquie ritrovate incorrotte; i monaci poveri glorificati da Dio."},

"Translation of the relics of Venerable Ephraim, Abbot of Perekop, Novgorod":
{"type": "Festa · XVI sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie del venerabile Efrem, igumeno di Perekop e taumaturgo di Novgorod, traslazione avvenuta nell'anno 1545 e confermata come festa dal concilio di Mosca del 1549, essendosi il santo stesso addormentato il ventisei settembre del 1492, giorno nel quale è tenuta la sua memoria principale.", "patron": "Il canale scavato fino al lago."},

"Translation of the relics of Venerable John, Abbot of Rila, Bulgaria":
{"type": "Monaco · X sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie di san Giovanni di Rila, protettore celeste del popolo bulgaro. Nato verso l'anno 876 nel villaggio di Skrino, custodì da povero orfano le greggi della sua famiglia prima di abbandonare tutto per farsi monaco.", "patron": "Si invoca per i monaci; per gli eremiti."},

"Translation of the relics of Venerable Lazarus of Mount Galesius near Ephesus":
{"type": "Monaco (stilita) · XI sec.", "life": "Questa festa commemora la traslazione delle reliquie di san Lazzaro il taumaturgo del monte Galesio. Nato a Magnesia di Lidia, Lazzaro fu un giovane dotto che amò Dio fin dalla giovinezza, e viaggiò in Terra Santa, dove fu tonsurato alla Lavra di san Saba e faticò dieci anni, guadagnandosi l'amore dei fratelli con i suoi certami ascetici, finché non fu ordinato sacerdote dal patriarca di Gerusalemme.", "patron": "Si invoca per i monaci; per la lotta ascetica."},

"Translation of the relics of Venerable Nilus of Stolobensk":
{"type": "Festa · XVII sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento e la traslazione delle reliquie del venerabile Nilo di Stolobnyj, il grande eremita del lago Seliger, avvenuti nell'anno 1667, più di un secolo dopo la sua dormizione.", "patron": "L'eremo insulare del Seliger."},

"Translation of the relics of Venerable Theodore, Abbot of Studion":
{"type": "Igumeno · IX sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie del venerabile Teodoro, igumeno dello Studio, la cui festa principale è tenuta in novembre; la commemorazione di gennaio ricorda il giorno in cui il grande confessore tornò a casa. Teodoro aveva passato la vita a difendere le sante icone e la libertà della Chiesa contro gli imperatori, sopportando flagellazioni, carceri e ripetuti esili, e si era addormentato nell'826 nel bando, lontano dal suo monastero, negli anni in cui l'iconoclasmo teneva ancora il palazzo.", "patron": "Si invoca per i monaci; per i confessori riconosciuti innocenti."},

"Translation of the relics of Venerable Theodosius of the Kyiv Far Caves":
{"type": "Igumeno · XI sec.", "life": "San Teodosio delle Grotte fu il padre del monachesimo cenobitico nella terra della Rus'. Nato a Vasyliv presso Kyiv, fu attratto fin dall'infanzia alla vita ascetica, disdegnando i giochi dei bambini, vestendosi di abiti poveri e faticando nei campi, finché non lasciò la sua casa per cercare Dio nella vita monastica.", "patron": "Si invoca per i monaci; per la vita monastica."},

"Translation of the relics of Venerable Zosimas and Sabbatius of Solovki":
{"type": "Venerabile · XV sec.", "life": "I venerabili Savvatij e Zosima furono i fondatori del grande monastero di Solovki nella sua isola nel freddo mare Bianco del nord russo. San Savvatij, cercando una solitudine assoluta, fu il primo a stabilirsi nell'isola disabitata, dove faticò e si addormentò nell'anno 1435.", "patron": "Si invoca per gli apicoltori; per i monaci."},

"Translation of the relics of slain Crown Prince Demetrius of Moscow":
{"type": "Festa · XVII sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie del santo e ortodosso zarevič Dimitrij di Uglič, il principe fanciullo e portatore della passione assassinato a Uglič nel 1591, il cui corpo incorrotto fu portato a Mosca nell'anno 1606 per servire a un tempo da sepolcro e da testimonianza contro una grande menzogna.", "patron": "Gli assassinati e riconosciuti innocenti; quanti hanno le reliquie che confondono l'impostore."},

"Translation of the relics of the Greatmartyr Theodore Stratelates":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie del santo gran martire Teodoro Stratilate, il generale, il cui martirio è tenuto in febbraio e il cui sacro corpo fu riportato in patria alla sua città per essere fontana di grazia.", "patron": "I soldati e i comandanti; quanti onorano i grandi martiri."},

"Translation of the relics of the Hieromartyr Phocas, Bishop of Sinope":
{"type": "Vescovo · II sec.", "life": "Questa festa commemora la traslazione delle reliquie del sacro martire Foca, vescovo di Sinope, dalla sua città a Costantinopoli nell'anno 403 o 404. Nato a Sinope sul Mar Nero, Foca condusse fin dalla giovinezza una vita cristiana virtuosa e a suo tempo divenne vescovo di quella città, dove con la sua predicazione convertì molti pagani a Cristo.", "patron": "Si invoca per i marinai; per la protezione dal fuoco."},

"Translation of the relics of the Martyr Epimachus of Pelusium":
{"type": "Martire · III sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie del santo martire Epimaco di Pelusio, detto anche di Alessandria, la cui festa principale è tenuta alla fine di ottobre; la commemorazione di marzo segna il trasporto delle sue sante reliquie a Costantinopoli, dove la Città ricevette il martire egiziano fra i suoi tesori e stabilì questa memoria annuale del suo arrivo.", "patron": "Si invoca per gli zelanti; per quanti sono guariti dai martiri."},

"Translation of the relics of the Protomartyr and Archdeacon Stephen from Jerusalem to Constantinople":
{"type": "Festa · V sec.", "life": "Dopo che il santo protomartire e arcidiacono Stefano fu lapidato, il suo corpo fu lasciato insepolto fuori della città, ma di notte il rinomato maestro della Legge Gamaliele, discepolo segreto di Cristo, lo raccolse e lo depose in una grotta nella sua proprietà a Caphargamala, a circa venti miglia da Gerusalemme.", "patron": "In questo giorno si prega per la guarigione."},

"Translation of the relics of the Right-believing Igor-George, Tonsured Gabriel, Grand Prince of Chernihiv, and Kyiv":
{"type": "Portatore della passione · XII sec.", "life": "In questo giorno la Chiesa commemora la traslazione delle reliquie del santo portatore della passione Igor, nel battesimo Giorgio, della casa principesca di Černihiv, che tenne brevemente il trono di Kyiv, si fece monaco e fu assassinato dalla folla mentre pregava, e le cui reliquie furono traslate a Černihiv nel 1150.", "patron": "I principi che si fanno monaci; le vittime della folla in tumulto."},

"Uncovering of the Precious Cross and the Precious Nails by Empress Saint Helen in Jerusalem":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento della preziosa Croce e dei preziosi Chiodi da parte della santa imperatrice Elena, madre di san Costantino il Grande, nell'anno 326. Mossa da suo figlio l'imperatore e dal proprio grande amore di Cristo, l'attempata Elena viaggiò a Gerusalemme a cercare i luoghi santi, che i pagani avevano lungamente profanati e sepolti, avendo innalzato sopra il Golgota e la tomba del Signore un tempio dei loro idoli per cancellare la memoria dei santuari dei cristiani.", "patron": "In questo giorno si prega per quanti cercano ciò che è sepolto; per i pellegrini."},

"Uncovering of the relics Saint Acacius, Bishop of Melitene":
{"type": "Vescovo · III sec.", "life": "Sant'Acacio il confessore fu vescovo di Melitene in Armenia ai giorni della persecuzione sotto Decio. Arrestato come cristiano e condotto davanti al governatore Marciano, confessò arditamente Cristo e confutò la stoltezza dell'idolatria, per il che fu sottoposto alla tortura; eppure non fu messo a morte, ma dopo un tempo fu rimesso in libertà, portando sul suo corpo le ferite di Cristo, e governò poi il suo gregge come martire vivente, addormentandosi alla fine in pace.", "patron": "Si invoca per i confessori; per la costanza sotto tortura."},

"Uncovering of the relics of Holy Princess Juliana Olshanskaya":
{"type": "Principessa · XVI sec.", "life": "Santa Giuliana fu figlia del principe Jurij Dubrovickij-Ol'šanskij, la cui famiglia governava Ol'šansk quando Kyiv giaceva sotto il regno lituano. Benefattore della Lavra delle Grotte di Kyiv, suo padre la seppellì presso la grande chiesa del monastero quando ella si addormentò vergine pura all'età di sedici anni, nel sedicesimo secolo.", "patron": "Si invoca per le donne; per la guarigione dell'anima."},

"Uncovering of the relics of Saint Alexis, Metropolitan of Moscow and Wonderworker of All Russia":
{"type": "Festa · XV sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie di sant'Alessio, metropolita di Mosca e taumaturgo di tutta la Russia, il grande gerarca e uomo di stato che guidò la Chiesa russa e lo stato moscovita per la metà del quattordicesimo secolo, precettore e reggente del giovane Dmitrij Donskoj e guaritore della chansa tatara Tajdula, la cui festa principale è tenuta in febbraio alla sua dormizione del 1378.", "patron": "Le reliquie incorrotte rivelate da un tetto crollato."},

"Uncovering of the relics of Saint Andrew, Prince of Smolensk":
{"type": "Principe · XIV sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie di sant'Andrea, principe di Smolensk, avvenuto a Pereslavl'-Zalesskij nell'anno 1539 per le fatiche di san Daniele di Pereslavl'. Il santo principe, addolorato dall'inimicizia e dalla discordia dei suoi parenti, aveva abbandonato in segreto il suo principato, e venuto come povero sconosciuto a Pereslavl', servì per trent'anni come sacrestano alla chiesa di San Nicola, nel digiuno, nella preghiera e in perfetto nascondimento, non sapendo nessuno che l'umile servitore della chiesa era principe di nascita.", "patron": "Si invoca per i sagrestani; per gli inservienti della chiesa."},

"Uncovering of the relics of Saint Basil, Bishop of Amasea":
{"type": "Festa · IV sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie del santo sacro martire Basilio, vescovo di Amasea, il cui certame ella tiene prima in questa stessa settimana; decapitato a Nicomedia nella persecuzione di Licinio, verso l'anno 322, per aver dato riparo alla vergine Glafira dai disegni dell'imperatore, Basilio patì dopo la morte l'ultimo dispetto del persecutore, gettato il suo corpo in mare, intendendo il tiranno che alla Chiesa mancasse perfino una tomba presso la quale radunarsi, cancellato il martire, come i nemici dei martiri sempre sperano, dall'acqua e dal silenzio.", "patron": "In questo giorno si prega per quanti cercano le reliquie dei martiri; per il mare costretto a restituire ciò che gli era stato affidato."},

"Uncovering of the relics of Saint Demetrius (Dmitri), Metropolitan of Rostov":
{"type": "Metropolita · XVIII sec.", "life": "San Dimitrij, metropolita di Rostov, nel mondo Daniil Tuptalo, nacque nel 1651 presso Kyiv e fu educato all'accademia di Kyiv, ricevendo in giovinezza la tonsura monastica; e dotato di rari doni di dottrina e di parola, fu chiamato alla più grande fatica letteraria della Chiesa russa, la compilazione del menologio di lettura, le Vite complete dei santi per ogni giorno dell'anno, opera alla quale faticò vent'anni con la preghiera e con il digiuno, apparendogli i santi stessi, come registrò, nel sonno per aiutare e correggere il suo lavoro.", "patron": "Si invoca per gli agiografi; per gli scrittori."},

"Uncovering of the relics of Saint Gurias, first Archbishop of Kazan, and Saint Barsanuphius, Bishop of Tver":
{"type": "Arcivescovo · XVI sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie di san Gurij, primo arcivescovo di Kazan, e di san Barsanufio, vescovo di Tver', avvenuto a Kazan nell'anno 1595, mentre si costruiva una nuova chiesa di pietra della Trasfigurazione al monastero che Barsanufio aveva fondato, e le tombe dei due gerarchi furono trovate sotto la vecchia chiesa di legno.", "patron": "Si invoca per i missionari; per i maestri."},

"Uncovering of the relics of Saint Joasaph, Bishop of Belgorod":
{"type": "Vescovo · XVIII sec.", "life": "Sant'Ioasaf, vescovo di Belgorod, nacque nel 1705 a Priluki nelle terre di Poltava, nella festa stessa della Natività della Madre di Dio, dalla nobile stirpe ucraina dei Gorlenko, e fu chiamato Gioacchino nel battesimo. Educato all'accademia spirituale di Kyiv, fu attratto presto alla vita monastica, fu tonsurato con il nome di Ioasaf, e dopo aver servito come igumeno del monastero di Mgar e come vicario della Lavra della Trinità e di San Sergio, fu consacrato vescovo di Belgorod nel 1748.", "patron": "Si invoca per il rigore di vita; per la cura del clero."},

"Uncovering of the relics of Saint Nikḗtas, Bishop of Novgorod":
{"type": "Festa · XVI sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie di san Niceta, vescovo di Novgorod, il recluso delle Grotte di Kyiv che cadde in giovinezza nell'inganno del nemico, fu restituito dalle preghiere dei padri, e salì per l'umiltà all'episcopato che aveva un tempo quasi perduto per la superbia, pascolando Novgorod nella santità e nei prodigi, chiamando la pioggia con la preghiera e spegnendo con la sua intercessione un incendio della città, fino alla sua dormizione nel 1108.", "patron": "In questo giorno si prega per quanti onorano le reliquie dei santi; per quanti soffrono di mali degli occhi."},

"Uncovering of the relics of Saint Vsévolod (Gabriel) of Pskov":
{"type": "Principe · XII sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie del santo principe Vsevolod di Pskov, chiamato Gabriele nel santo battesimo, avvenuto nell'anno 1192. Nipote di Vladimir Monomaco e figlio di san Mstislav il Grande, Vsevolod governò Novgorod fin dalla giovinezza con giustizia e a mani aperte, costruendo chiese, nutrendo a proprie spese i poveri nella carestia, e conducendo le schiere della città.", "patron": "Si invoca per i sovrani; per i costruttori."},

"Uncovering of the relics of Venerable Alexander, Abbot of Svir":
{"type": "Festa · XVII sec.", "life": "In questo giorno la Chiesa commemora il rinvenimento delle reliquie del venerabile Alessandro di Svir', il grande asceta delle foreste settentrionali fra i laghi Ladoga e Onega, la cui festa principale ella tiene alla fine di agosto; più di un secolo dopo la dormizione del santo, nell'anno 1641, durante la riedificazione in pietra della chiesa della Trasfigurazione al suo monastero della Trinità sulla Svir', i fratelli, scavando le fondamenta, si imbatterono in una tomba la cui bara stava intera nella terra, e aprendola trovarono il corpo del loro fondatore incorrotto, giacendo il venerabile, registrarono i testimoni, come un uomo che dorme, il volto sereno e i paramenti stessi conservati, e conobbero dal prodigio e dalla testimonianza della memoria del monastero che Dio aveva restituito loro il padre Alessandro.", "patron": "In questo giorno si prega per quanti onorano le reliquie dei santi; per il fondatore incorrotto rivelato."},
...
{"type": "Monaco · XVI sec.", "life": "Il venerabile Cassiano di Uglič, detto il greco, fu nel mondo Costantino, discendente dei principi greci di Mangup in Crimea, e venne in Russia nel seguito che accompagnò la principessa Sofia Paleologa alle sue nozze con il gran principe di Mosca. Onorato a corte e messogli davanti un alto ufficio, scelse invece la compagnia degli uomini santi, ritirandosi con l'arcivescovo Ioasaf al monastero di Ferapontov sul lago Bianco.", "patron": "Si invoca per i monaci; per gli esuli."},
...
{"type": "Igumeno · XVI sec.", "life": "Il venerabile Daniele di Šužgorsk nacque nelle terre di Mosca nel sedicesimo secolo, e abbandonato il mondo ricevette la tonsura monastica al monastero di Komel fondato da san Cornelio, dove fu formato nelle tradizioni dei grandi asceti settentrionali. Desiderando la vita solitaria, partì nel paese selvaggio del nord russo, e si stabilì sul colle boscoso detto Šužgora, nella regione fra Belozersk e Novgorod, dove faticò da solo nella preghiera, nel digiuno e nei certami del deserto.", "patron": "Si invoca per i monaci; per la solitudine."},

"Venerable Diodoros, Igoumen of George Hill":
{"type": "Igumeno · XVII sec.", "life": "Il venerabile Diodoro del colle di Giorgio nacque nel villaggio di Turčasovo sul fiume Onega, a mezza via fra Kargopol e il mare Bianco, da genitori pii di nome Ieroteo e Maria, che chiamarono il loro figlio Diomede. A quindici anni di età andò in pellegrinaggio al grande monastero di Solovki nel mare settentrionale, e vi rimase, ricevendo col tempo la tonsura monastica con il nome di Diodoro.", "patron": "Si invoca per i monaci; per la vita eremitica dell'estremo nord."},
...
{"type": "Igumeno · V sec.", "life": "Il venerabile Dios nacque ad Antiochia di Siria verso la fine del quarto secolo in una devota famiglia cristiana, e fin dalla giovinezza si distinse per la temperanza, mangiando poco e non ogni giorno, e umiliando la sua carne con la veglia e con la preghiera incessante. Per queste fatiche il Signore gli concesse l'impassibilità e il dono dei prodigi.", "patron": "Si invoca per i monaci; per la lotta ascetica."},

"Venerable Dometius of Dionysiou":
{"type": "Monaco · XIV sec.", "life": "Il venerabile Dometio di Dionysiou fu discepolo e collaboratore di san Dionisio, fondatore del monastero di Dionysiou sul monte Athos, e condivise la vita ascetica e la santità di quella casa nei suoi primi giorni.", "patron": "I discepoli dei santi fondatori; gli eremiti e gli asceti."},
...
{"type": "Igumeno · XV sec.", "life": "Il venerabile Dositeo di Verchneostrov fu discepolo del grande anziano Eufrosino di Pskov, sotto la cui guida fu formato nelle severe tradizioni del deserto di Pskov, nell'obbedienza, nel digiuno e nella preghiera incessante. Cercando un luogo di quiete, si stabilì sull'Isola Alta, il Verchnij Ostrov, fra le isole del lago di Pskov, dove le acque riparavano la sua solitudine.", "patron": "Si invoca per i monaci; per il monachesimo insulare."},
...
{"type": "Granduchessa · XV sec.", "life": "La venerabile Eufrosina, conosciuta nel mondo come Eudocia, fu figlia del principe di Suzdal', e dall'anno 1367 moglie del gran principe Dmitrij del Don, la cui unione fu pegno di pace fra Mosca e Suzdal'. Guidata nella vita spirituale da sant'Alessio di Mosca e da san Sergio di Radonež, che battezzò uno dei suoi figli, portò le cure di una principessa regnante coltivando insieme una vita nascosta di preghiera e di severa ascesi, portando pesanti catene sotto le sue vesti regali.", "patron": "Si invoca per l'ascesi segreta."},

"Venerable Euphrosyne of Alexandria":
{"type": "Monaca · V sec.", "life": "La venerabile Eufrosina di Alessandria visse nel quinto secolo, unica e amatissima figlia di un uomo ricco e pio di nome Pafnuzio. Votata nel cuore alla verginità, e non potendo sfuggire alle nozze che suo padre aveva combinate, ricevette segretamente la tonsura monastica, e sapendo che suo padre l'avrebbe cercata in ogni monastero femminile, si vestì da uomo ed entrò in un monastero di monaci sotto il nome dell'eunuco Smaragdo.", "patron": "Si invoca per l'ascesi nascosta; per la verginità."},

"Venerable Euphrosyne, Abbess of Polotsk":
{"type": "Venerabile · XII sec.", "life": "La venerabile Eufrosina di Polotsk, chiamata Predslava nel mondo, fu principessa della casa di Polotsk, figlia del principe Giorgio Vseslavič e discendente della stirpe di san Vladimir, e divenne la grande illuminatrice della terra bielorussa e una delle donne più luminose di tutta la Chiesa russa.", "patron": "La fanciulla regale che scelse il velo al posto della corona."},

"Venerable Euphrosynē of Suzdal":
{"type": "Monaca · XIII sec.", "life": "La venerabile Eufrosina di Suzdal' nacque figlia maggiore del santo principe Michele di Černihiv, che poi versò il suo sangue per Cristo all'Orda, e nel battesimo fu chiamata Teodulia. Allevata nella pietà e in una dottrina superiore ai suoi anni, fu promessa a un principe; ma quando il suo sposo morì alla vigilia stessa delle nozze, vide nel suo dolore la provvidenza di Dio e rimase nel monastero della Deposizione della Veste a Suzdal', dove ricevette la tonsura con il nome di Eufrosina.", "patron": "Si invoca per le monache; per i maestri delle donne."},
...
{"type": "Monaco · IX sec.", "life": "Il venerabile Gregorio di Decapoli nacque a Irenopoli, nella Decapoli d'Isauria, e fuggendo in giovinezza dalle nozze che i suoi genitori avevano combinate, si diede a Dio nella vita monastica, formato sotto un anziano pieno di discernimento e provato da anni di reclusione in una caverna, dove sopportò gli assalti aperti dei demoni e ricevette visioni di grazia.", "patron": "Si invoca per i viaggiatori per la verità; per la difesa delle sante icone."},
...
{"type": "Monaco · XVI sec.", "life": "Il venerabile Erodione di Iloezersk fu discepolo di san Cornelio di Komel, nel cui monastero fu tonsurato e addestrato nelle tradizioni ascetiche del deserto di Vologda. Dopo la dormizione del suo anziano, cercando la quiete, si ritirò nelle foreste del paese di Belozersk e si stabilì presso il piccolo lago Ilo, dove si costruì una cella e una cappella in onore della Natività della santissima Madre di Dio, e visse solo nel digiuno, nella veglia e nella preghiera incessante, prendendo alla fine sopra di sé il grande schema.", "patron": "Si invoca per gli eremiti; per l'esichia."},
...
{"type": "Igumeno · VIII sec.", "life": "Il venerabile Ilarione il nuovo, igumeno del monastero di Pelekete presso Prusa in Bitinia, fu dato a Dio fin dalla giovinezza, e passando per tutta la scuola della vita monastica, il silenzio, l'obbedienza, il digiuno e il salterio a memoria, fu ordinato sacerdote e col tempo fatto igumeno di Pelekete, una delle rinomate case monastiche della riva bitinia, che governò da padre negli anni centrali dell'ottavo secolo, gli anni stessi nei quali il primo iconoclasmo si levò dal trono di Costantino Copronimo e cominciò ad abbattersi sui monasteri, i cui monaci erano i difensori più irremovibili delle icone.", "patron": "Si invoca per gli igumeni nei giorni cattivi; per quanti pregano per la pioggia e per il raccolto."},

"Venerable Hilarion the New, Abbot of the Dalmatian Monastery":
{"type": "Igumeno · IX sec.", "life": "Sant'Ilarione il nuovo fu igumeno dell'antico monastero di Dalmatos a Costantinopoli, il primo monastero della città imperiale, e confessore delle sante icone che patì grandemente per la fede lungo i regni degli imperatori iconoclasti.", "patron": "Gli igumeni e i confessori delle icone; quanti sono incarcerati e flagellati per la fede."},

"Venerable Hilarion the Schemamonk of the Kyiv Caves":
{"type": "Metropolita · XI sec.", "life": "Sant'Ilarione monaco di schema delle Grotte di Kyiv si addormentò verso l'anno 1066, e la tradizione della Lavra lo identifica con il grande Ilarione, metropolita di Kyiv, il primo della Rus' di nascita a occupare il trono metropolitano. Presbitero al villaggio principesco di Berestovo, uomo dotto e di sovrabbondante pietà, soleva ritirarsi sopra una collina boscosa sopra il Dnipro, dove scavò con le proprie mani una piccola grotta per la preghiera e la salmodia.", "patron": "Si invoca per i predicatori; per gli scrittori."},

"Venerable Hilarion, Abbot of Gdov and Pskov Lake":
{"type": "Igumeno · XV sec.", "life": "Il venerabile Ilarione di Gdov fu discepolo del grande anziano Eufrosino di Pskov, formato nella sua scuola del deserto di digiuno rigoroso, di obbedienza e di preghiera incessante. Uscito con la benedizione del suo anziano, fondò sul fiume Želča, non lontano da Gdov presso le acque del paese dei laghi di Pskov, un monastero in onore della Protezione della santissima Madre di Dio, in una terra di confine esposta alle scorrerie dei cavalieri livoni.", "patron": "Si invoca per i monaci; per i monasteri delle terre di confine."},

"Venerable Ignatius of Loma and Yaroslav":
{"type": "Monaco · XVI sec.", "life": "Il venerabile Ignazio di Loma e di Jaroslavl' nascose così bene i suoi inizi che le circostanze della sua vita nel mondo sono ignote, il che è esso stesso il primo fatto della sua biografia, un uomo che entrò nel registro soltanto quando entrò nel servizio di Dio. Cominciò il suo cammino ascetico al monastero del Salvatore di Priluki presso Vologda, e ricevette la tonsura monastica al grande monastero di san Cirillo al lago Bianco, formandolo nell'obbedienza e nella preghiera le due case madri della Tebaide del Nord.", "patron": "Si invoca per gli eremiti; per i fondatori che si ritirano."},

"Venerable Ignatius, Archimandrite of the Kyiv Caves":
{"type": "Archimandrita · XV sec.", "life": "Il venerabile Ignazio, archimandrita delle Grotte di Kyiv, governò la grande Lavra nel quindicesimo secolo, verso l'anno 1435, e la sua breve biografia è stata tramandata nell'iscrizione copiata in età successive dalla sua pietra tombale: che per la sua santa vita il monaco Ignazio ottenne da Dio il dono dei prodigi, e guarì molti malati con le sue preghiere, e che la guarigione era data per mezzo del gusto della prosfora che egli aveva offerta, ricevendo i fedeli le cure mangiando il pane santo delle Liturgie che aveva celebrate.", "patron": "Si invoca per i sacerdoti che celebrano la Liturgia; per i malati."},

"Venerable Irenarchus, Abbot of Solovki":
{"type": "Igumeno · XVII sec.", "life": "Il venerabile Irinarco ricevette la tonsura monastica al monastero di Solovki nel nord estremo della Russia, dove imitò con zelo i fondatori di quel santo luogo, i santi Zosima e Savvatij, nelle loro fatiche ascetiche. Nell'anno 1614, alla morte dell'igumeno Antonio, fu scelto a succedergli come igumeno, e governò fedelmente la comunità in un'età difficile, quando il monastero di Solovki stava come baluardo per la difesa delle terre settentrionali contro gli svedesi e i danesi.", "patron": "Si invoca per i monaci; per la vita monastica."},

"Venerable Isaac the Ascetic of the Dalmatian Monastery at Constantinople":
{"type": "Igumeno · IV sec.", "life": "Sant'Isacco fu eremita del deserto orientale che visse nel quarto secolo, sotto il regno dell'imperatore ariano Valente. Quando udì che Valente perseguitava gli ortodossi, cacciandone i vescovi e consegnando le loro chiese agli eretici, lasciò la sua solitudine e venne a Costantinopoli ad affrontare l'imperatore, che stava allora partendo in guerra contro i goti.", "patron": "Si invoca per i monaci; per la difesa dell'Ortodossia contro l'eresia."},

"Venerable Isaac the Confessor, Founder of the Dalmatian Monastery at Constantinople":
{"type": "Confessore e igumeno · IV sec.", "life": "Il venerabile Isacco il confessore, fondatore del monastero dalmata, fu eremita del deserto siriano che la crisi della Chiesa trasse fuori dalla sua solitudine e sulla strada di un imperatore. Nei giorni in cui Valente, ariano, aveva dato agli eretici le chiese di Costantinopoli e cacciato gli ortodossi, Isacco venne nella capitale a fortificare i perseguitati.", "patron": "Si invoca per i monaci che affrontano il potere; per i fondatori."},

"Venerable Isaac the Recluse of the Kyiv Near Caves":
{"type": "Recluso · XI sec.", "life": "Il venerabile Isacco il recluso delle Grotte Vicine di Kyiv fu il primo dei solitari ingannati delle Grotte, e il Paterik narra la sua caduta e la sua vittoria con eguale onestà, perché la Chiesa ha bisogno di entrambe le metà. Ricco mercante di Toropec, diede via ogni cosa, venne da sant'Antonio, e superò tutti in severità: murato in una cella larga quattro cubiti, portando una pelle di capra cruda che gli si seccò addosso, mangiando una prosfora ogni due giorni, pregò sette anni senza coricarsi.", "patron": "Si invoca per gli ingannati e i ristabiliti; per quanti lavorano in cucina."},

"Venerable Isaac, Founder of Dalmátos Monastery at Constantinople":
{"type": "Venerabile · IV sec.", "life": "Il venerabile Isacco, fondatore del monastero di Dalmatos a Costantinopoli, fu un confessore che non temette il volto di alcun imperatore, ed è ricordato soprattutto per il suo intrepido rimprovero all'imperatore ariano Valente e per la sua profezia della terribile fine di quell'imperatore.", "patron": "L'imperatore ariano rimproverato in faccia."},

"Venerable Isaiah, Wonderworker of the Kyiv Near Caves":
{"type": "Venerabile · XII sec.", "life": "Il venerabile Isaia il taumaturgo, delle Grotte Vicine di Kyiv, faticò nel grande monastero alla fine dell'undicesimo secolo e al principio del dodicesimo e si addormentò, registra la tradizione, verso l'anno 1115, e la sua memoria è tenuta in questo giorno, che condivide con il suo omonimo Isaia di Rostov, onorati insieme i due Isaia della generazione delle Grotte.", "patron": "Le fatiche delle Grotte offerte a Dio."},

"Venerable Isidore of Pelusium":
{"type": "Ieromonaco · V sec.", "life": "Il venerabile Isidoro di Pelusio nacque ad Alessandria da cristiani pii, parente degli arcivescovi Teofilo e Cirillo, e ricevette la migliore educazione della più grande città dotta del suo tempo; e mentre era ancora giovane lasciò il mondo, ritirandosi in un monastero sul monte presso Pelusio alla foce orientale del Nilo, dove col tempo fu ordinato sacerdote e divenne padre della comunità, asceta della scuola più severa che si rivestì, come scrissero i suoi ammiratori, di tutta l'armatura della guerra monastica.", "patron": "Si invoca per quanti scrivono lettere; per i direttori spirituali."},

"Venerable Isidore the Fool-For-Christ and Wonderworker of Rostov":
{"type": "Folle per Cristo · XV sec.", "life": "Il beato Isidoro Tverdislov, folle per Cristo e taumaturgo di Rostov, venne alla Russia e alla santità dall'occidente latino, uno dei richiami del calendario che la follia per Cristo non conobbe una nazione sola.", "patron": "La ricchezza di una casa straniera lasciata per una capanna di frasche."},

"Venerable James, Abbot of Zheleznoborov":
{"type": "Igumeno · XV sec.", "life": "Il venerabile Giacomo di Železnoborov nacque nella seconda metà del quattordicesimo secolo dalla nobile stirpe degli Amosov, le cui terre giacevano presso Galič nel paese di Kostroma, e da giovane fece la scelta che lo pose dentro la più grande discendenza spirituale del suo tempo, andando al monastero della Trinità e divenendo discepolo di san Sergio di Radonež in persona, ricevendo la tonsura dalle mani dell'igumeno di tutta la Russia ed essendo formato per anni nella scuola di Sergio, la povertà, la fatica, i lunghi uffici, la mitezza davanti a tutti, e la preghiera del cuore che il fondatore della Trinità spirò in tutta una generazione di futuri fondatori.", "patron": "Si invoca per i discepoli di Sergio; per i fondatori nelle terre aspre."},

"Venerable Joannicius the Great":
{"type": "Monaco · IX sec.", "life": "Il venerabile Gioannicio il Grande nacque nel 752 nel villaggio bitinio di Marikat, da genitori così poveri che il ragazzo non ricevette istruzione ma pascolava il bestiame di famiglia, riempiendo di preghiera i pascoli; e cresciuto in forze, servì con distinzione per molti anni come soldato dell'impero, combattendo nelle guerre bulgare.", "patron": "Si invoca per i soldati fattisi monaci; per la penitenza dall'errore."},

"Venerable Joasaph of Snetogorsk, Pskov":
{"type": "Ieromartire e igumeno · XIII sec.", "life": "Il sacro martire Ioasaf, igumeno del monastero di Snetogorsk presso Pskov, patì con una schiera dei suoi monaci nella scorreria tedesca che si abbatté sulla terra di Pskov alla fine del tredicesimo secolo. Snetogorsk, dedicato alla Natività della santissima Madre di Dio, era fra i monasteri più antichi della regione, e Ioasaf lo governava da padre, tenendovi una stretta vita comune.", "patron": "Si invoca per gli igumeni; per i monaci delle case assediate."},

"Venerable Job of Ushchelsk":
{"type": "Ieromonaco · XVII sec.", "life": "Il venerabile Giobbe, detto l'abitatore della gola, fu monaco del monastero di Solovki che nell'anno 1608 fu ordinato ieromonaco dal metropolita Isidoro di Novgorod. Nel 1614 fu mandato nella lontana regione settentrionale del Mezen', e là, in un luogo detto Uščel'e dove il fiume Ezega incontra il Mezen', fondò un eremo e innalzò una chiesa, radunando intorno a sé una piccola fraternità in quel deserto remoto.", "patron": "Si invoca per i monaci."},

"Venerable John Cassian the Roman":
{"type": "Sacerdote e igumeno · V sec.", "life": "Il venerabile Giovanni Cassiano il romano è il grande corriere del deserto, l'uomo che impacchettò la sapienza dell'Egitto in due libri e la portò in Occidente, e la Chiesa gli dà la festa più rara del suo calendario, il ventinove febbraio, come segnando che tali uomini vengono una volta ogni molto tempo.", "patron": "Si invoca per i monaci d'occidente; per quanti scrivono sulla preghiera."},

"Venerable John Climacus of Sinai, Author of “the Ladder”":
{"type": "Venerabile · VII sec.", "life": "Il venerabile Giovanni Climaco, igumeno del Sinai, ricevette il suo soprannome dal suo libro, e il suo libro dal suo monte: la Scala, il Klimax, con la quale la Chiesa ha insegnato per quattordici secoli l'ascesa a Dio, fu scritta sul monte dell'ascesa medesima, dove Mosè salì nella tenebra e ricevette la Legge. Giovanni venne al Sinai a sedici anni, già dotto, e piegò la sua dottrina sotto il giogo, dandosi in assoluta obbedienza all'anziano Martirio, nel quale, come scrisse poi, aveva annegato la propria volontà; tonsurato a vent'anni, seppellì il suo anziano dopo diciannove anni di quella scuola, e si ritirò nel deserto di Tholas ai piedi del monte, dove visse da eremita per quarant'anni, in un nascondimento nutrito di lacrime, di preghiera incessante e della guerra con i pensieri che il suo libro avrebbe un giorno mappato come un paese misurato, mangiando quel che la regola permetteva ma poco di esso, dormendo soltanto quanto bastava perché la mente non andasse in rovina, e ricevendo il dono delle lacrime in tale misura che il suo pianto scavò, dice la tradizione, il luogo stesso dove pregava. La sua grazia si mostrò nei prodigi con parsimonia, come consigliava agli altri di mostrare la loro: per la sua preghiera il suo discepolo Mosè fu salvato da una roccia che cadeva, avvertito nel sonno per l'intercessione dell'anziano; e per la sua preghiera fu data la pioggia nella siccità; ma il suo grande prodigio fu la diagnosi delle anime, e quando ebbe quasi settantacinque anni i padri del Sinai lo costrinsero a essere loro igumeno, l'eremita posto sopra il monte, e fu allora che, a richiesta di Giovanni igumeno di Raithu, mise per iscritto per i monaci di quella comunità il trattato che tutta la Chiesa afferrò per sé, la Scala del divino ascenso, trenta gradini dalla rinuncia al mondo attraverso la guerra con ciascuna passione a sua volta, l'obbedienza, la penitenza, la memoria della morte, il pianto, la mitezza e le loro sorelle, su per la quiete e la preghiera fino alla vetta dove la fede, la speranza e l'amore rimangono, e la più grande di esse riceve chi è salito; con il suo piccolo compagno Al pastore, il manuale di quanti guidano."},

"Venerable John of Damascus":
{"type": "Ieromonaco · VIII sec.", "life": "Il venerabile Giovanni Damasceno, l'ultimo dei grandi padri della Chiesa antica e il primo cantore della sua teologia compiuta, nacque verso il 675 a Damasco, figlio di un alto funzionario cristiano alla corte del califfo; educato insieme al suo fratello adottivo Cosma da un monaco dotto riscattato dalla prigionia, padroneggiò tutta la sapienza dei greci, e succedette a suo padre nell'ufficio sotto il dominio saraceno.", "patron": "Si invoca per i teologi; per gli innografi."},

"Venerable John of the Ancient Caves in Palestine":
{"type": "Monaco · IX sec.", "life": "Il venerabile Giovanni delle antiche grotte, chiamato nei libri greci il paleolavrita, fu monaco e sacerdote dell'antica lavra nel deserto di Giuda, il monastero delle caverne di Suka fondato dal venerabile Caritone il confessore nel quarto secolo, la più antica di tutte le case del deserto, che i monaci delle età successive chiamarono semplicemente l'antica lavra, essendo il suo nome medesimo una genealogia.", "patron": "Si invoca per i sacerdoti del deserto; per i pellegrini che restano."},

"Venerable John the Anchorite of Egypt":
{"type": "Anacoreta · IV sec.", "life": "Il venerabile Giovanni l'anacoreta d'Egitto è commemorato in questo giorno fra i padri del deserto i cui nomi la Chiesa ha custoditi mentre i deserti custodivano le loro storie, uno della grande schiera anonima degli anacoreti, gli uomini che uscirono oltre perfino gli skiti e le lavre nella solitudine totale, e la cui vocazione era, per sua stessa definizione, di non lasciare testimoni.", "patron": "Si invoca per gli eremiti; per i nascosti."},

"Venerable John the Clairvoyant, Anchorite, of Egypt":
{"type": "Anacoreta · IV sec.", "life": "Il venerabile Giovanni il chiaroveggente, il grande anacoreta di Lycopolis nella Tebaide egiziana, fu in giovinezza un artigiano, manovale di un costruttore, che lasciò il mondo nella prima età adulta, e dopo anni di formazione sotto gli anziani si sigillò, verso il suo quarantesimo anno, in una cella che si era preparata nella rupe sopra Lycopolis, tre piccole camere murate con lui dentro, e vi visse rinchiuso per quasi cinquant'anni, senza mai uscire e senza essere mai veduto, ricevendo egualmente il necessario e i visitatori soltanto per una sola finestra, e questo soltanto il sabato e la domenica, tenuta la settimana interamente per Dio e aperto il fine settimana alle ferite del mondo.", "patron": "Si invoca per i reclusi; per i consiglieri dei sovrani."},

"Venerable John the Faster of the Kyiv Near Caves":
{"type": "Monaco · XII sec.", "life": "Il venerabile Giovanni il digiunatore faticò nelle Grotte Vicine della Lavra di Kyiv nel dodicesimo secolo, nella prima fioritura del monastero dei santi Antonio e Teodosio, e portò la medesima guerra e il medesimo titolo del grande patriarca di Costantinopoli del quale condivideva il nome: fu un digiunatore, atleta dell'astinenza nella scuola dove il digiuno era contato fondamento di ogni altra vittoria.", "patron": "Si invoca per il dominio dell'appetito; per la lotta nascosta."},

"Venerable John the Long-Suffering of the Kyiv Near Caves":
{"type": "Monaco · XII sec.", "life": "Il venerabile Giovanni il molto sofferente lottò alla Lavra delle Grotte di Kyiv, e porta il suo nome dalla guerra fiera e durata tutta la vita che combatté per amore della purezza. Fin dalla giovinezza fu tormentato dalla passione della carne, e né la fame né la sete né il portare pesanti catene poterono liberarnelo.", "patron": "Si invoca per la castità; per quanti sono tentati dalla concupiscenza."},

"Venerable John the Silent of Saint Sabbas Monastery":
{"type": "Vescovo · VI sec.", "life": "San Giovanni il silenzioso, detto anche l'esicasta, nacque nel 454 a Nicopoli d'Armenia, da nobile famiglia di generali e di governatori; e avendo costruito in giovinezza una chiesa della Madre di Dio e radunata una piccola fraternità, fu costretto a ventotto anni ad accettare il vescovado di Colonia d'Armenia.", "patron": "Si invoca per gli esicasti; per i vescovi che depongono l'ufficio."},

"Venerable John, Ascetic of the Syrian Deserts":
{"type": "Eremita · V sec.", "life": "Il venerabile Giovanni, asceta dei deserti siriani, è commemorato in questo giorno con la compagnia degli eremiti all'aperto di Siria le cui imprese Teodoreto di Cirro, loro vicino e vescovo, mise per iscritto per la Chiesa; e in quel reggimento degli esposti Giovanni tenne la sua postazione sopra un'altura nuda per circa venticinque anni, un quarto di secolo senza tetto, senza cella e senza riparo, stando l'eremita nel clima di Siria come in una liturgia che non ammetteva congedo.", "patron": "Si invoca per i solitari; per quanti sopportano senza testimoni."},

"Venerable John, disciple of Venerable Gregory of Decapolis":
{"type": "Monaco · IX sec.", "life": "Il venerabile Giovanni, discepolo di san Gregorio di Decapoli, appartiene a uno dei cerchi luminosi del nono secolo, la piccola compagnia che si radunò a Costantinopoli intorno al grande Decapolita negli anni del secondo iconoclasmo; poiché Gregorio, l'asceta taumaturgo che aveva attraversato l'impero difendendo le icone, trasse a sé discepoli degni della scuola, e fra essi Giuseppe, futuro innografo di tutta la Chiesa, e questo Giovanni, che diede all'anziano l'intera offerta del discepolo, l'obbedienza, il servizio e l'imitazione che è la lode più vera del deserto.", "patron": "Si invoca per i discepoli dei grandi anziani; per i monaci del secondo rango."},

"Venerable John-Barsanuphius, Bishop of Damascus":
{"type": "Monaco e vescovo · V sec.", "life": "Il venerabile Giovanni, detto Barsanufio, vescovo di Damasco, compì la fuga che molti gerarchi hanno sognata e pochi hanno osata: rassegnò un trono nelle mani di Dio senza dirlo a nessuno, e finì la sua vita come lavoratore anonimo fra i monaci d'Egitto. Vescovo della grande sede di Damasco nel quinto secolo, Giovanni governò, tiene la tradizione, con la diligenza di un buon pastore.", "patron": "Si invoca per i gerarchi che anelano al nascondimento; per i portatori d'acqua e i taglialegna."},

"Venerable Jonah, Abbot of Yashezersk":
{"type": "Igumeno · XVI sec.", "life": "Il venerabile Giona di Jašezersk fu nativo delle terre careliane e continuò nel nord la tradizione dei grandi abitatori del deserto della scuola di sant'Alessandro di Svir'. Stabilitosi nel deserto presso il lago Jašezero, visse dapprima in completa solitudine, nel digiuno, nella veglia e nella preghiera incessante.", "patron": "Si invoca per i monaci; per il monachesimo del nord."},

"Venerable Joseph the Hymnographer":
{"type": "Monaco e innografo · IX sec.", "life": "Il venerabile Giuseppe l'innografo, il poeta più abbondante che la Chiesa abbia mai posseduto, nacque in Sicilia verso l'816 da genitori pii, Plotino e Agata, e quando l'invasione araba si abbatté sull'isola la sua famiglia fuggì nel Peloponneso; il giovane andò avanti a Tessalonica, ricevette la tonsura e col tempo il sacerdozio, e risplendette nel digiuno, nella veglia e nella salmodia finché il grande Gregorio di Decapoli, incontrandolo, non ne riconobbe la misura e non lo portò al suo monastero a Costantinopoli.", "patron": "Si invoca per gli innografi; per i poeti della Chiesa."},

"Venerable Joseph the Much-Ailing, of the Kyiv Far Caves":
{"type": "Monaco · XIV sec.", "life": "Il venerabile Giuseppe il molto infermo, delle Grotte Lontane di Kyiv, guadagnò il suo soprannome nel mondo prima di santificarlo nel monastero: fu uomo consumato da una lunga e grave malattia, anno dopo anno di un male che la medicina non sapeva togliere, e nel fondo di esso si volse a Dio con il patto dei disperati e dei devoti, promettendo che se il Signore lo avesse rialzato dal suo letto, sarebbe andato al monastero delle Grotte e vi avrebbe servito la fraternità tutti i giorni che gli fossero restituiti.", "patron": "Si invoca per i malati cronici; per quanti mercanteggiano con Dio nella malattia."},

"Venerable Joseph the Wonderworker, Igumen of Volokolamsk":
{"type": "Igumeno · XVI sec.", "life": "In questo giorno la Chiesa commemora la glorificazione di san Giuseppe il taumaturgo, igumeno di Volokolamsk, che fu annoverato fra i santi di tutta la Chiesa russa dal concilio dell'anno 1591, essendo già stata stabilita nel 1579 la sua venerazione locale. Nato nel 1440 e formato sotto san Pafnuzio di Borovsk, Giuseppe fondò nelle foreste della sua Volokolamsk natale il famoso monastero della Dormizione, la cui stretta vita comune, la cui grande biblioteca e la cui elemosina senza limiti ne fecero una scuola di gerarchi e un rifugio dei poveri, nutrendo centinaia di persone in tempo di carestia.", "patron": "Si invoca per i monaci; per i teologi."},

"Venerable Joseph, Abbot of Volokolamsk, Volotsk":
{"type": "Igumeno · XVI sec.", "life": "Il venerabile Giuseppe di Volokolamsk, nel mondo Giovanni Sanin, nacque nel 1440 in un villaggio presso Volokolamsk, e dato da ragazzo all'anziano Arsenio per l'istruzione, padroneggiò il Salterio in un solo anno e tutte le Scritture in quello seguente, stupendo tutti per la sua memoria.", "patron": "Si invoca per i monaci; per i teologi."},

"Venerable Julian the Hermit of Mesopotamia":
{"type": "Monaco · IV sec.", "life": "San Giuliano l'eremita di Mesopotamia, che il popolo chiamava Sabas, l'anziano, pose la sua cella nel deserto dell'Osroene presso l'Eufrate, trovando nel profondo del deserto una caverna non fatta da mano d'uomo, che stimò più dei palazzi d'oro; e là per mezzo secolo faticò nel digiuno e nella preghiera incessante, essendo suo cibo pane di miglio con sale e sua bevanda acqua, presi una volta la settimana.", "patron": "Si invoca per gli eremiti; per la salmodia incessante."},

"Venerable Karion (Cyrion) and his son, Venerable Zachariah, of Egypt":
{"type": "Monaci · IV sec.", "life": "I venerabili Carione e suo figlio Zaccaria faticarono a Sceti in Egitto nel quarto secolo, e la loro storia è una delle più strane e più tenere del deserto. Carione lasciò moglie e due figli per la vita monastica; e quando la carestia colpì l'Egitto, sua moglie portò i bambini alla porta del monastero, e il monaco prese suo figlio Zaccaria per allevarlo nello skite, mentre la figlia rimase con la madre.", "patron": "Si invocano per i padri e i figli; per l'umiliazione abbracciata."},

"Venerable Kyriakos the Anchorite":
{"type": "Ieromonaco · VI sec.", "life": "San Ciriaco l'anacoreta nacque a Corinto nell'anno 448, figlio di un presbitero, e a diciotto anni di età, udendo in chiesa la parola del Signore, Chi vuol venire dietro a me rinneghi se stesso, navigò in Terra Santa e fu ricevuto da sant'Eutimio il Grande, che lo rivestì dell'abito monastico e lo mandò a san Gerasimo presso il Giordano.", "patron": "Si invoca per i monaci; per il digiuno rigoroso."},

"Venerable Laurence, Abbot of Komel":
{"type": "Venerabile · XVI sec.", "life": "Il venerabile Lorenzo di Komel fu, come san Cassiano con il quale la Chiesa lo commemora in questo giorno, discepolo di san Cornelio di Komel, e portò avanti l'opera di governare il monastero di Vologda nello spirito e nella regola del loro comune maestro.", "patron": "La discendenza di Cornelio portata avanti."},
...
{"type": "Igumeno · XV sec.", "life": "Il venerabile Nikon di Radonež, discepolo e successore di san Sergio, nacque a Jur'ev-Pol'skij e venne in giovinezza dal grande anziano, il quale, provandone l'umiltà, lo mandò dapprima dal suo discepolo Atanasio a Serpuchov; e là Nikon fu tonsurato e ordinato, tornando infine da Sergio, che lo amò tanto da tenerlo nella propria cella e, sei mesi prima della sua dormizione, ritirandosi nel silenzio, da porlo sopra la fraternità.", "patron": "Si invoca per gli igumeni; per i costruttori."},
...
{"type": "Monaca · V sec.", "life": "La venerabile Pelagia la penitente fu la più famosa danzatrice e cortigiana di Antiochia, chiamata Margarita, la perla, per la sua bellezza e per i suoi gioielli; e un giorno, passando in splendore con il suo seguito davanti alle porte dove sedeva un concilio di vescovi, attirò gli occhi di tutti, e il santo vescovo Nonno pianse, dicendo agli altri, Questa donna si dà più cura di adornarsi per gli uomini di quanta ce ne diamo noi di adornare le nostre anime per Dio, e pregò per lei tutta la notte.", "patron": "Si invoca per le attrici; per i penitenti."},

"Venerable Peter of Constantinople":
{"type": "Monaco · IX sec.", "life": "Il venerabile Pietro nacque da famiglia patrizia a Costantinopoli verso la fine dell'ottavo secolo. Nominato ufficiale sotto l'imperatore Niceforo, prese parte alle campagne contro la Bulgaria, e nella battaglia in cui l'imperatore fu ucciso fu fra i molti presi prigionieri.", "patron": "Si invoca per i prigionieri e i carcerati."},

"Venerable Peter of Mount Athos":
{"type": "Monaco · VIII sec.", "life": "Il venerabile Pietro del monte Athos fu il primo eremita conosciuto della Santa Montagna, che vi dimorò in solitudine per cinquantatré anni ed è onorato come padre del monachesimo athonita.", "patron": "Gli eremiti e i primi dei solitari; il monte Athos e i suoi monaci."},
...
{"type": "Diacono · VI sec.", "life": "Il venerabile Romano il melode, il dolce cantore della Chiesa, nacque a Emesa in Siria e servì come diacono prima a Beirut e poi a Costantinopoli ai giorni dell'imperatore Anastasio, attendendo alla chiesa della Theotokos a Kyros e vegliando di notte alle Blacherne.", "patron": "Si invoca per i cantori; per gli innografi."},
...
{"type": "Archimandrita · VI sec.", "life": "Il venerabile Saba il santificato, il legislatore del monachesimo palestinese, nacque nel 439 a Mutalaska di Cappadocia, ed entrato in un monastero a otto anni mostrò da fanciullo la volontà di un anziano: avendo una volta colto e mangiato una mela contro la regola, fece voto di non gustare mai più mele, e mantenne il voto fino alla morte; e una volta entrò illeso in un forno acceso per ritrarne delle vesti, rendendo Dio testimonianza al ragazzo.", "patron": "Si invoca per i monaci; per i liturgisti."},
...
{"type": "Monaca · IX sec.", "life": "La venerabile Teodora, che veniva dall'isola di Egina, e sua figlia, chiamata nel monachesimo Teopiste, vissero nella città di Tessalonica nel nono secolo. Ancora sposata, Teodora con il marito diede la loro unica figlia a un monastero di donne, dove fu tonsurata e ricevette il nome nuovo.", "patron": "Si invoca per i monaci; per la vita monastica."},

"Venerable Theodora of Alexandria":
{"type": "Monaca · V sec.", "life": "La venerabile Teodora di Alessandria visse nel quinto secolo con il marito in amore e concordia, finché, presa nella rete dall'insistenza di un certo ricco e dall'inganno di una mezzana che le disse che Dio non vede ciò che si fa nelle tenebre, cadde in peccato.", "patron": "Si invoca per la penitenza; per quanti portano una falsa accusa."},
...
{"type": "Venerabile · IV sec.", "life": "Il venerabile Teodoro il santificato fu discepolo ed emulo di san Pacomio il Grande nella via della perfezione monastica, e riposò nel quarto secolo, nella prima fioritura della vita cenobitica lungo il Nilo; e il suo soprannome porta tutto il racconto della sua santità.", "patron": "La perfezione appresa al fianco di Pacomio."},
...
{"type": "Monaco · X sec.", "life": "Il venerabile Tommaso Dephourkinos nacque in Bitinia nel decimo secolo, e datosi fin dalla giovinezza alla vita monastica, passò per le obbedienze della vita comune e poi si ritirò nel deserto, stabilendosi infine sul monte Kyminas, uno dei monti santi della Bitinia le cui lavre e i cui eremi rivaleggiavano con l'Olimpo e prepararono la via all'Athos.", "patron": "Si invoca per i padri spirituali; per quanti scrivono lettere."},

"Venerable Thomas of Mount Maleos":
{"type": "Monaco (eremita) · X sec.", "life": "Il venerabile Tommaso del monte Maleon fu nella sua vita anteriore soldato e comandante, illustre e ricco, il quale al colmo del suo successo mondano volse il cuore tutto a Dio. Rinunciando al grado e distribuendo i beni ai poveri, abbracciò la vita monastica, e, guidato come racconta la tradizione dal profeta Elia, si ritirò nella solitudine del monte Maleon per darsi alla preghiera e alla lotta ascetica.", "patron": "Se ne fa memoria nel santo calendario della Chiesa."},

"Venerable Tikhon of Kaluga Or Medin":
{"type": "Igumeno · XV sec.", "life": "Il venerabile Tichon di Kaluga, detto anche di Medyn', fu eremita e fondatore del quindicesimo secolo, che santificò con la sua solitudine le foreste profonde della regione di Kaluga.", "patron": "Gli eremiti e gli amanti della solitudine; i fondatori dei monasteri della foresta."},

"Venerable Tikhon of Luchov, Kostroma":
{"type": "Monaco · XVI sec.", "life": "Il venerabile Tichon di Luchov, nel secolo Timoteo, fu monaco della regione di Kostroma che scambiò il servizio di un principe terreno con il servizio di Dio e visse e morì nella povertà che amava.", "patron": "Quanti lasciano il mondo e il suo servizio; i poveri e i lavoratori."},
