...
{"type": "Igumeno · VII sec.", "life": "San Kevin di Glendalough fu uno dei grandi fondatori monastici d'Irlanda, un eremita la cui fuga in una solitudine di montagna diede origine a una delle più famose città monastiche della Chiesa celtica.", "patron": "I fondatori di monasteri; gli eremiti e gli amanti della solitudine."},

"Saint Leo of Cappadocia":
{"type": "Martire e monaco · IX sec.", "life": "San Leone di Cappadocia è ricordato nel calendario per una sola transazione, ed è quella che il Signore stesso nominò come il colmo dell'amore. Monaco del paese cappadoce nell'età delle incursioni saracene, quando le terre di confine dell'Asia Minore vivevano sotto il flagello perpetuo delle razzie di schiavi, Leone vide i predoni portare via tre dei suoi fratelli monaci, uomini malati e infermi, inutili come lavoratori e perciò destinati a essere abbandonati nel deserto appena la loro debolezza avesse rallentato la colonna.", "patron": "Si invoca per i prigionieri; per quanti riscattano gli altri."},
...
{"type": "Monaco · IV sec.", "life": "San Macario il romano è noto alla Chiesa per l'antico racconto di tre monaci di Mesopotamia, Teofilo, Sergio e Igino, i quali viaggiarono verso oriente in cerca dei confini della terra e, dopo lunghe peregrinazioni per terre strane, trovarono, in un deserto oltre ogni abitato, una grotta e un anziano di terribile aspetto, vestito soltanto dei capelli bianchi della sua grande vecchiaia, con due leoni che dimoravano mansueti accanto a lui.", "patron": "Si invoca per gli eremiti; per la penitenza."},

"Saint Makarios the Roman":
{"type": "Igumeno · XVI sec.", "life": "San Makarij il romano nacque alla fine del quindicesimo secolo in una ricca famiglia di Roma e ricevette un'eccellente educazione, ma non fece alcun conto degli onori terreni, cercando soltanto la salvezza della sua anima. Addolorato per i peccati e per le divisioni che scuotevano la Chiesa occidentale ai suoi giorni, pregò con lacrime che Dio gli mostrasse la via della verità e, venendo a comprendere che la pienezza della salvezza era nella Chiesa ortodossa, viaggiò in Russia.", "patron": "Si invoca per i monaci; per la conversione all'Ortodossia."},

"Saint Marcian of Cyrrhus":
{"type": "Monaco · IV sec.", "life": "San Marciano di Cirro nacque da nobile famiglia di quella città siriana e, abbandonati il rango e le ricchezze, si ritirò nel deserto di Calcide, dove si rinchiuse in una cella tanto piccola che non poteva né stare eretto né distendersi per intero, dimorandovi nel digiuno, nella preghiera incessante e nel canto dei salmi.", "patron": "Si invoca per gli eremiti; per la moderazione unita al rigore."},
...
{"type": "Monaco · IX sec.", "life": "San Gioannicio il Grande nacque nel 752 nel villaggio bitinio di Marikat, da genitori così poveri che il ragazzo non ricevette istruzione ma pascolava il bestiame di famiglia, riempiendo di preghiera i pascoli; e cresciuto in forze, servì con distinzione per molti anni come soldato dell'impero, combattendo nelle guerre bulgare.", "patron": "Si invoca per i soldati fattisi monaci; per la penitenza dall'errore."},
...
{"type": "Ieromonaco · VIII sec.", "life": "San Giovanni Damasceno, l'ultimo dei grandi padri della Chiesa antica e il primo cantore della sua teologia compiuta, nacque verso il 675 a Damasco, figlio di un alto funzionario cristiano alla corte del califfo; educato insieme al suo fratello adottivo Cosma da un monaco dotto riscattato dalla prigionia, padroneggiò tutta la sapienza dei greci, e succedette a suo padre nell'ufficio sotto il dominio saraceno.", "patron": "Si invoca per i teologi; per gli innografi."},
...
{"type": "Igumeno · XVI sec.", "life": "San Giuseppe di Volokolamsk, nel mondo Giovanni Sanin, nacque nel 1440 in un villaggio presso Volokolamsk, e dato da ragazzo all'anziano Arsenio per l'istruzione, padroneggiò il Salterio in un solo anno e tutte le Scritture in quello seguente, stupendo tutti per la sua memoria.", "patron": "Si invoca per i monaci; per i teologi."},
...
{"type": "Monaci · IV sec.", "life": "I santi Carione e suo figlio Zaccaria faticarono a Sceti in Egitto nel quarto secolo, e la loro storia è una delle più strane e più tenere del deserto. Carione lasciò moglie e due figli per la vita monastica; e quando la carestia colpì l'Egitto, sua moglie portò i bambini alla porta del monastero, e il monaco prese suo figlio Zaccaria per allevarlo nello skite, mentre la figlia rimase con la madre.", "patron": "Si invocano per i padri e i figli; per l'umiliazione abbracciata."},
