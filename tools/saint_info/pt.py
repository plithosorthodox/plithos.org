# -*- coding: utf-8 -*-
"""Portuguese calendar entries. TEXT = {English name: {type, life, patron}}.

The calendar's life is the short one the day panel shows; the long one is in
tools/saint_lives/pt.py, and a saint is written in both places at once so
...
{"type": "Mártires · séc. III", "life": "Os dez santos mártires de Creta, Teódulo, Saturnino, Euporo, Gelásio, Euniciano, Zótico, Pômpio, Agatópode, Basílides e Evaristo, padeceram no ano 250 sob o imperador Décio, cujo governador na ilha, um Décio igualmente no nome e na crueldade, empenhou-se em arrancar a fé de Creta.", "patron": "Invoca-se sua intercessão pela alegria diante da morte; pela coroa que se disputa no amor."},

"12 Greeks who built the Dormition Cathedral in the Kyiv Caves, Far Caves, Lavra":
{"type": "Mestres construtores, monges · séc. XI", "life": "Os doze gregos que edificaram a grande catedral da Dormição das Cavernas de Kyiv são comemorados neste dia, mestres construtores de Constantinopla a quem a própria Mãe de Deus contratou para a maior obra da antiga Rus. O Patericon das Cavernas guarda o testemunho jurado deles: a Rainha do Céu apareceu-lhes na igreja das Blaquernas, em figura de imperatriz cercada de guerreiros, e mandou-os ir à Rus, a Kyiv, e edificar ali uma igreja em sua honra no lugar que lhes seria mostrado.", "patron": "Invoca-se sua intercessão pelos construtores; pelos arquitetos."},

"120 Martyrs of Persia":
{"type": "Mártires · séc. IV", "life": "Os cento e vinte santos mártires da Pérsia padeceram na grande perseguição do rei Sapor II, por volta do ano 344, nos anos em que o reino persa, em guerra com o império romano havia pouco tornado cristão, voltou-se contra a Igreja dentro de suas próprias fronteiras como contra uma colônia inimiga, e os confessores de Cristo na Mesopotâmia e na Pérsia foram presos aos milhares.", "patron": "Invoca-se sua intercessão pelos cativos; pelas companhias de confessores."},

"1st Saturday of Great Lent: The Miracle of the Boiled Wheat":
{"type": "Festa · séc. IV", "life": "No primeiro sábado da Grande Quaresma a Igreja comemora o milagre do trigo cozido, a kólyva, obrado pelo santo grande mártir Teodoro Tíron meio século depois de seu próprio martírio, o soldado morto de Cristo montando guarda sobre a primeira semana de jejum da Igreja.", "patron": "Neste dia se pede por todos os que guardam o jejum; pelos tentados e enganados."},

"1st Sunday of Great Lent: Sunday of Orthodoxy":
{"type": "Festa · séc. IX", "life": "No primeiro domingo da Grande Quaresma a Igreja celebra o Domingo da Ortodoxia, a festa do triunfo da fé verdadeira, estabelecida no ano 843, quando a santa imperatriz Teodora e o santo patriarca Metódio restauraram a veneração dos ícones e puseram fim à última grande heresia do mundo antigo.", "patron": "Neste dia se pede por toda a Igreja militante; por todos os que guardam a fé dos Padres."},

"20,000 Martyrs of Nicomedia":
{"type": "Mártires · séc. IV", "life": "Os santos vinte mil mártires de Nicomédia padeceram no ano 302, quando o imperador Maximiano, sabendo quão poderosamente a fé havia crescido em sua própria capital, resolveu destruir os cristãos da cidade numa só noite, e escolheu para isso a noite em que todos estariam reunidos: a festa da Natividade de Cristo.", "patron": "Invoca-se sua intercessão pelas assembleias ameaçadas; pelos catecúmenos."},

"26 Martyrs in the Crimea":
{"type": "Mártires · séc. IV", "life": "Os santos vinte e seis mártires, cujas relíquias santificaram a Crimeia, padeceram na terra dos godos além do Danúbio por volta do ano 375, quando o rei godo pagão levantou perseguição contra os cristãos de seu povo, e a jovem Igreja goda, plantada por cativos e missionários, pagou em sangue seu primeiro grande preço.", "patron": "Invoca-se sua intercessão pelas assembleias em oração; pelos povos recém-convertidos."},

"2nd Sunday of Great Lent: St Gregory Palamas":
{"type": "Festa · séc. XIV", "life": "No segundo domingo da Grande Quaresma a Igreja faz memória de são Gregório Palamas, arcebispo de Tessalônica, e o dia com razão se chama o segundo triunfo da Ortodoxia, pois estende o primeiro: como o primeiro domingo proclama que Deus pode ser representado porque verdadeiramente se fez homem, o segundo proclama que Deus pode ser experimentado porque verdadeiramente se dá, sendo o ícone e a luz duas sentenças de uma só fé.", "patron": "Neste dia se pede pelos hesicastas e por todos os que oram; pelos teólogos da experiência."},

"33 Holy Martyrs of Melitene":
{"type": "Mártires · séc. III", "life": "Os santos trinta e três mártires de Melitene padeceram por volta do ano 290, no reinado de Diocleciano e Maximiano, quando um destacamento sob o comandante Lísias foi enviado à Capadócia para arrancar os cristãos e recrutar homens fortes para o exército. À frente deles está Hierão, lavrador de Tiana, criado na piedade por sua mãe, homem de força corporal extraordinária.", "patron": "Invoca-se sua intercessão pelos lavradores; pelos recrutas."},

"3rd Sunday of Great Lent: Veneration of the Cross":
{"type": "Festa · séc. IV", "life": "No terceiro domingo da Grande Quaresma a Igreja tira a preciosa e vivificante Cruz e a põe no meio dos fiéis, adornada de flores, para a veneração ao longo da semana que se segue; e esse lugar é toda a teologia do dia, pois a Cruz fica plantada no centro exato do jejum, na metade dos quarenta dias, como árvore de descanso no meio de um caminho duro.", "patron": "Neste dia se pede por todos os que carregam cruzes; pelos cansados na metade do caminho."},

"40 Holy Martyrs of Sebaste":
{"type": "Mártires · séc. IV", "life": "Os santos quarenta mártires de Sebaste eram soldados da célebre décima segunda legião, chamada Fulminante, aquartelada em Sebaste da Armênia por volta do ano 320, que o sinaxário bizantino conta como 322 ou 323, quando o imperador Licínio, rompendo sua paz com a Igreja, mandou que seus exércitos sacrificassem.", "patron": "Invoca-se sua intercessão pelos soldados; pelas companhias e irmandades."},

"42 Martyrs of Ammoria in Phrygia":
{"type": "Mártires · séc. IX", "life": "Os santos quarenta e dois mártires de Amório eram os comandantes e nobres do exército bizantino levados cativos quando a grande cidade de Amório, na Frígia, caiu diante dos sarracenos no ano 838, entre eles Constantino, Aécio, Teófilo, Teodoro, Melisseno, Calisto e Bassoes, a flor da chefia do império arrastada para a Mesopotâmia.", "patron": "Invoca-se sua intercessão pelos soldados; pelos comandantes."},

"45 Holy Martyrs at Nicopolis in Armenia":
{"type": "Leigos · séc. IV", "life": "Os quarenta e cinco santos mártires de Nicópolis, na Armênia, padeceram sob o imperador Licínio, que governava o Oriente e perseguia duramente a Igreja, decretando a morte para todo cristão que não voltasse aos ídolos. Quando a perseguição chegou a Nicópolis, mais de quarenta fiéis, à frente deles Leôncio, Maurício, Daniel, Antônio e Alexandre, resolveram não se esconder, mas apresentar-se abertamente diante dos perseguidores e confessar Cristo.", "patron": "Invoca-se sua intercessão pela confissão corajosa."},

"4th Sunday of Great Lent: St John Climacus (of the Ladder)":
{"type": "Festa · séc. VII", "life": "No quarto domingo da Grande Quaresma a Igreja põe diante de seus filhos são João Clímaco, igumeno do Sinai e autor da Escada da Ascensão Divina, e a escolha é pedagogia deliberada: passada a metade do jejum, venerada a Cruz e ainda sem a Páscoa à vista, a Igreja apresenta o mestre cartógrafo da vida espiritual.", "patron": "Neste dia se pede por todos os que sobem para Deus; pelos que lutam na metade do jejum."},

"5th Saturday of Great Lent: of the Akathist to the Theotokos":
{"type": "Festa · séc. VII", "life": "No quinto sábado da Grande Quaresma a Igreja celebra a festa do Acatisto, cantando inteiro, numa só noite solene, o grande hino à Santíssima Mãe de Deus que no resto do ano canta por partes; e a festa é tanto um memorial de guerra quanto um ofício, pois foi estabelecida em ação de graças pelas libertações de Constantinopla.", "patron": "Neste dia se pede por todos os que se acolhem à Mãe de Deus; pelas cidades sitiadas."},

"5th Sunday of Great Lent: St Mary of Egypt":
{"type": "Festa · séc. VI", "life": "Santa Maria Egipcíaca, cuja vida se lê na igreja durante a Grande Quaresma como imagem da penitência, passou a juventude em Alexandria na maior devassidão. Indo a Jerusalém, viu-se detida por um poder invisível ao entrar na igreja na Exaltação da Cruz, e, ferida no coração, chorou diante de um ícone da Mãe de Deus e prometeu emendar a vida.", "patron": "Neste dia se pede pelos penitentes no cume do jejum; por todos os que desesperam de mudar."},

"7 Holy Maccabee Martyrs":
{"type": "Jovens · séc. II a.C.", "life": "Os sete santos irmãos Macabeus, Abim, Antônio, Gúrias, Eleazar, Eusebono, Álimo e Marcelo, padeceram no ano 166 antes de Cristo sob o ímpio rei Antíoco Epifânio, que desprezava a fé dos judeus e se empenhava em desviar o povo da Lei de Moisés, profanando o Templo e erguendo nele um ídolo de Zeus para que todos o adorassem.", "patron": "Invoca-se sua intercessão pela fidelidade à lei de Deus; pela coragem nos tormentos."},

"7 Holy Youths “Seven Sleepers” of Ephesus":
{"type": "Jovens · séc. V", "life": "Os sete santos jovens de Éfeso, Maximiliano, Jâmblico, Martiniano, João, Dionísio, Exacustodiano e Antonino, viveram no século III e eram filhos de cidadãos ilustres, amigos desde a infância e soldados juntos. Quando o imperador Décio veio a Éfeso e mandou que todos sacrificassem aos ídolos, os sete confessaram Cristo, e, ainda que lhes tirassem os cinturões do posto, o imperador os deixou livres por um tempo, esperando que cedessem.", "patron": "Invoca-se sua intercessão pela ressurreição dos mortos; pelos enfermos que não conseguem dormir."},

"Afterfeast of the Dormition of the Mother of God":
{"type": "Pós-festa", "life": "Nos dias da Pós-festa da Dormição a Igreja continua a celebrar o bem-aventurado adormecer de nossa Senhora, a Santíssima Mãe de Deus, e sua trasladação em glória para o reino celeste. Os hinos destes dias proclamam que aquela que gerou o Autor da Vida não abandonou o mundo em seu repouso, mas foi levada por seu Filho para reinar com Ele e interceder sem cessar por todos os que a honram.", "patron": "Comemora-se no santo calendário da Igreja."},

"Afterfeast of the Elevation of the Cross":
{"type": "Pós-festa", "life": "São estes os dias da Pós-festa da Universal Exaltação da Preciosa e Vivificante Cruz, durante os quais a Igreja continua a celebrar a grande festa da Cruz do Senhor. Os hinos da Exaltação juntam-se aos ofícios diários, e os fiéis continuam a venerar o santo Lenho levantado no meio da terra, contemplando o mistério pelo qual o instrumento da morte se tornou a árvore da vida.", "patron": "Comemora-se no santo calendário da Igreja."},

"Afterfeast of the Entry of the Most Holy Mother of God into the Temple":
{"type": "Pós-festa", "life": "Nos dias da Pós-festa da Entrada da Santíssima Mãe de Deus no Templo a Igreja permanece na luz da festa, continuando a cantar seus hinos e a contemplar seu mistério: a menina de três anos, levada por Joaquim e Ana em cumprimento de seu voto, subindo sozinha os grandes degraus do Templo, recebida pelo sumo sacerdote Zacarias e conduzida, contra todo costume, ao próprio Santo dos Santos, onde outrora estavam a arca e o propiciatório.", "patron": "Nestes dias se pede a permanência na graça da festa."},

"Afterfeast of the Meeting of our Lord in the Temple":
{"type": "Pós-festa", "life": "A Pós-festa do Encontro de nosso Senhor no Templo leva a festa do dia dois de fevereiro pelos dias que se seguem, até o encerramento no dia nove, e neles a Igreja permanece de pé no Templo com o Menino nos braços; pois o Encontro é o gonzo em que se fecha todo o ciclo da Natividade, o cumprimento da lei da Encarnação aos quarenta dias, e um mistério de tal peso não se despede num só dia.", "patron": "Comemora-se no santo calendário da Igreja."},

"Afterfeast of the Nativity of our Lord and Savior Jesus Christ":
{"type": "Pós-festa", "life": "A Pós-festa da Natividade de nosso Senhor leva a celebração pelos dias que se seguem à festa, pois a Igreja não fecha a gruta de Belém depois de um dia, mas habita dentro dela, repetindo em cada ofício o tropário e o condáquio da festa, cantando Cristo nasce, glorificai-O sobre os santos de cada dia e os trabalhos de cada dia, de modo que mártires, hierarcas e ascetas comemorados nestes dias são todos contemplados à luz da manjedoura.", "patron": "Comemora-se no santo calendário da Igreja."},

"Afterfeast of the Nativity of the Mother of God":
{"type": "Pós-festa", "life": "São estes os dias da Pós-festa da Natividade da Santíssima Mãe de Deus, durante os quais a Igreja continua a celebrar o nascimento da Mãe de Deus dos justos Joaquim e Ana. Os hinos da festa cantam-se junto com os ofícios diários, prolongando a alegria da solenidade, enquanto os fiéis contemplam a esterilidade de Ana desatada e o aparecimento no mundo daquela que desde os séculos foi predestinada a tornar-se a Mãe do Salvador.", "patron": "Comemora-se no santo calendário da Igreja."},

"Afterfeast of the Transfiguration of our Lord":
{"type": "Pós-festa", "life": "Este é o primeiro dia da Pós-festa da Transfiguração do Senhor, no qual a Igreja continua a celebrar a glória revelada no monte santo. Os hinos da festa recordam o assombro dos apóstolos Pedro, Tiago e João ao verem seu Mestre transfigurado diante deles, o rosto e as vestes brilhando mais que o sol, e proclamam sua igualdade com o Pai, pois Aquele que se cobre de luz como de um manto mostrou aos discípulos seu resplendor divino.", "patron": "Comemora-se no santo calendário da Igreja."},

"Apostle Alphaeus of the Seventy":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Alfeu foi um dos Setenta que o Senhor escolheu e enviou adiante de si, de dois em dois, a toda cidade e lugar aonde Ele mesmo havia de ir, e é honrado pela Igreja entre aquela segunda companhia de apóstolos que, depois dos Doze, levaram o Evangelho pelo mundo.", "patron": "O Evangelho pregado entre os primeiros discípulos."},

"Apostle Ananias of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Ananias, dos Setenta, era discípulo do Senhor e morava em Damasco, e a ele o Senhor apareceu em visão, mandando-o ir à rua chamada Direita e impor as mãos sobre Saulo de Tarso, o perseguidor da Igreja, que ali orava cego.", "patron": "Invoca-se sua intercessão pela cura da cegueira; pela obediência ao chamado de Deus."},

"Apostle Andrew, the Holy and All-Praised First-Called":
{"type": "Apóstolo · séc. I", "life": "O santo e louvadíssimo apóstolo André, o Primeiro-Chamado, era de Betsaida da Galileia, pescador e irmão de Simão Pedro; e, sendo discípulo de João, o Precursor, ouviu o Batista dizer de Jesus, Eis o Cordeiro de Deus, e seguiu o Senhor antes de todos os apóstolos, pelo que a Igreja o chama o Primeiro-Chamado.", "patron": "Invoca-se sua intercessão pelos pescadores; pelos missionários."},

"Apostle Andronicus of the Seventy and his fellow-laborer, Junia":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Andrônico, um dos Setenta, e sua companheira de trabalho Júnia têm seus nomes guardados para a Igreja pelo próprio são Paulo, na saudação de sua epístola aos Romanos, onde escreve, Saudai Andrônico e Júnia, meus parentes e companheiros de prisão.", "patron": "Os parentes e companheiros de prisão de Paulo."},

"Apostle Aquila of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Áquila, um dos Setenta, era judeu natural do Ponto e vivia em Roma com sua mulher Priscila, até que, no reinado do imperador Cláudio, os judeus foram expulsos da cidade e o casal se estabeleceu em Corinto. Ali encontraram o apóstolo Paulo, que, sendo do mesmo ofício, se hospedou com eles e com eles trabalhou em fazer tendas, e, recebendo dele o batismo, tornaram-se seus discípulos dedicados.", "patron": "Invoca-se sua intercessão pelos fabricantes de tendas; pelos casais."},

"Apostle Aristarchus of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Aristarco, dos Setenta, era macedônio de Tessalônica e um dos mais fiéis companheiros do santo apóstolo Paulo, por ele nomeado em suas epístolas como colaborador e companheiro de prisão. Partilhou os trabalhos e os perigos do Apóstolo em Éfeso, onde foi arrastado pela multidão para o teatro.", "patron": "Invoca-se sua intercessão pelos colaboradores; pela fidelidade na companhia."},

"Apostle Aristobulus of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Aristóbulo, dos Setenta, irmão do apóstolo Barnabé, nasceu em Chipre e seguiu o santo apóstolo Paulo, que saúda a sua casa na Epístola aos Romanos; e, sagrado por Paulo, como relatam os antigos, foi enviado como bispo à Bretanha, o extremo ocidente do mundo conhecido.", "patron": "Invoca-se sua intercessão pelos missionários; pela iluminação das ilhas."},

"Apostle Aristobulus of the Seventy, Bishop of Britain":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Aristóbulo, dos Setenta, nasceu em Chipre, irmão do apóstolo Barnabé, e com o irmão acompanhou o apóstolo Paulo em suas viagens missionárias, um daquela segunda ordem de apóstolos que o Senhor enviou adiante de si e que os Doze espalharam pelo mundo depois de Pentecostes.", "patron": "Invoca-se sua intercessão pelos missionários das fronteiras distantes; pelos primeiros pregadores de uma terra."},

"Apostle Barnabas of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Barnabé, um dos Setenta, foi dos primeiros e mais amados guias da Igreja apostólica, companheiro de são Paulo e fundador da Igreja de sua Chipre natal.", "patron": "Invoca-se sua intercessão pela ilha de Chipre; pelos que animam e consolam."},

"Apostle Bartholomew of the Twelve":
{"type": "Apóstolo · séc. I", "life": "O santo e louvadíssimo apóstolo Bartolomeu, um dos Doze, é geralmente tido pela tradição da Igreja como o mesmo Natanael de Caná da Galileia, o israelita sem dolo que o Senhor viu debaixo da figueira antes que Filipe o chamasse.", "patron": "Invoca-se sua intercessão pela terra da Armênia; pelos missionários do Oriente."},

"Apostle Carpus of the Seventy":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Carpo foi um dos Setenta e companheiro e ajudante do apóstolo Paulo, e seu nome ficou guardado para a Igreja nas Escrituras pela mão do próprio Paulo, na segunda epístola a Timóteo.", "patron": "A capa guardada para o Apóstolo em Trôade."},

"Apostle Crescens of the Seventy":
{"type": "Bispo · séc. II", "life": "O santo apóstolo Crescente, um dos Setenta, era discípulo do Salvador, e o apóstolo Paulo o menciona na segunda epístola a Timóteo, registrando que Crescente partira a pregar na Galácia. Ali foi feito bispo, e depois levou o Evangelho às Gálias, no Ocidente, onde em Vienne estabeleceu como bispo seu próprio discípulo Zacarias.", "patron": "Invoca-se sua intercessão pela pregação missionária."},

"Apostle Epenetus of the Seventy":
{"type": "Bispo · séc. I", "life": "O santo apóstolo Epêneto, um dos Setenta, era discípulo do Salvador, e o apóstolo Paulo o saúda com afeto na Epístola aos Romanos como seu amado Epêneto, primícias da Acaia para Cristo. Foi constituído bispo de Cartago, e ali, suportando muitas aflições às mãos dos idólatras, trabalhou para levar os pagãos ao conhecimento do Deus verdadeiro, ganhando muitos para a fé.", "patron": "Invoca-se sua intercessão pela pregação missionária."},

"Apostle Epίmakhos of Alexandria":
{"type": "Mártir · séc. III", "life": "O santo mártir Epímaco de Alexandria era egípcio e desde a juventude amou o Senhor, retirando-se para a região de Pelúsio, onde viveu como asceta no deserto em jejum e oração. Quando a perseguição de Décio caiu sobre Alexandria, o eremita, ardendo de zelo, desceu à cidade para fortalecer os confessores.", "patron": "Invoca-se sua intercessão pela cura dos olhos; pelo zelo por Deus."},

"Apostle Hermas of the Seventy":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Hermas foi um dos Setenta, e também seu nome ficou guardado para a Igreja nas Escrituras pela mão de são Paulo, que nas saudações finais de sua epístola aos Romanos cumprimenta Hermas entre os fiéis da igreja de Roma.", "patron": "O nome saudado na epístola aos Romanos."},

"Apostle Hermes of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Hermes, dos Setenta, é um dos homens que as Escrituras tornaram imortais numa só palavra: o apóstolo Paulo, fechando sua Epístola aos Romanos com a chamada dos irmãos que amava, escreve, Saudai Assíncrito, Flegonte, Hermas, Pátrobas, Hermes e os irmãos que estão com eles, e por essa saudação Hermes entrou no cânon da Escritura, lido em voz alta em toda igreja do mundo em cada geração desde então.", "patron": "Invoca-se sua intercessão pelos saudados e não lembrados; pelos bispos de sés silenciosas."},

"Apostle Herodion of the Seventy, and those with Him":
{"type": "Apóstolos dos Setenta · séc. I", "life": "Neste dia a Igreja comemora juntos seis apóstolos dos Setenta, Herodião, Ágabo, Rufo, Assíncrito, Flegonte e Hermes, companhia reunida sobretudo de uma só página da Escritura, o capítulo dezesseis da Epístola aos Romanos, onde o apóstolo Paulo, saudando nome por nome a igreja da capital, ditou sem o saber um pedaço do calendário da Igreja.", "patron": "Invoca-se sua intercessão pelos bispos da primeira plantação; pelos profetas."},

"Apostle James the Brother of Saint John the Theologian":
{"type": "Apóstolo, mártir · séc. I", "life": "O santo apóstolo Tiago, filho de Zebedeu e irmão de João, o Teólogo, foi chamado das redes da Galileia com seu irmão num só chamado, deixando os dois o pai na barca a uma palavra; e o Senhor deu ao par o sobrenome de Boanerges, filhos do trovão, pelo fogo que neles ardia e que uma vez quis fazer descer a chama do céu sobre uma aldeia inóspita, e aprendeu antes de que espírito era.", "patron": "Invoca-se sua intercessão pelos apóstolos e missionários; pelos filhos do trovão."},

"Apostle James, son of Alphaeus":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Tiago, filho de Alfeu, foi um dos Doze, chamado pelo Senhor junto com os pescadores da Galileia, e pela tradição da Igreja era irmão do apóstolo e evangelista Mateus, o antigo publicano. De suas palavras nada registram os Evangelhos, mas seus feitos enchem o silêncio: depois de Pentecostes pregou a fé pela Judeia e passou com são André às terras do sul.", "patron": "Invoca-se sua intercessão pela semeadura da palavra; pelo trabalho apostólico."},

"Apostle James, the Brother of the Lord":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Tiago, irmão do Senhor, era filho do justo José, o Desposado, de seu primeiro matrimônio, e desde a infância partilhou a pobreza e as jornadas da Sagrada Família, acompanhando-a, como relata a tradição, na fuga para o Egito. Nazireu consagrado a Deus, não bebia vinho, não comia carne e vestia uma só túnica, e orava tão sem cessar no Templo que seus joelhos endureceram como os de um camelo, pelo que toda Jerusalém, mesmo os de fora da Igreja, o chamava Tiago, o Justo.", "patron": "Invoca-se sua intercessão pelos bispos; pelos que servem a Divina Liturgia."},

"Apostle Jude the Brother of the Lord":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Judas, chamado irmão do Senhor, foi um dos Doze Apóstolos, conhecido também pelos nomes de Tadeu e Lebeu, e honrado como parente de Cristo segundo a carne.", "patron": "Invoca-se sua intercessão pelos parentes do Senhor; pelos que perguntam como Cristo se dá a conhecer."},

"Apostle Justus of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Justo, dos Setenta, chamado José Barsabás, era, segundo a tradição da Igreja, filho do justo José, o Desposado, e por isso contado entre os irmãos do Senhor, crescido à sombra do Verbo encarnado. Depois da Ascensão, quando os onze quiseram preencher o lugar de Judas, dois foram apresentados dentre os que haviam acompanhado o Senhor desde o batismo de João, José chamado Barsabás, por sobrenome Justo, e Matias.", "patron": "Invoca-se sua intercessão pelo contentamento sem honras; pela fidelidade de quem não é escolhido."},

"Apostle Mark of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Marcos, dos Setenta, que a Igreja distingue do evangelista do mesmo nome, é identificado pela tradição com João chamado Marcos, em cuja casa materna, a de Maria em Jerusalém, os fiéis se reuniam para orar, e à qual Pedro veio quando o anjo o tirou da prisão.", "patron": "Invoca-se sua intercessão pela cura; pelo serviço do Evangelho."},

"Apostle Matthias of the Seventy":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Matias nasceu em Belém, da tribo de Judá, e desde a infância foi instruído na Lei de Deus por são Simeão, o Recebedor de Deus. Quando o Senhor Jesus Cristo apareceu no mundo, Matias creu nele como o Messias e o seguiu fielmente, e foi contado entre os Setenta que o Senhor enviou de dois em dois adiante de sua face.", "patron": "Invoca-se sua intercessão pelos missionários; pela fidelidade escondida."},

"Apostle Nathaniel of the Seventy":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Natanael, comemorado neste dia com Lucas e Clemente, é o homem de Caná da Galileia cujo chamado o Evangelho de João guarda como uma de suas joias: quando Filipe o encontrou com a notícia de que fora achado aquele de quem escreveram Moisés e os profetas, Jesus de Nazaré, Natanael respondeu com o preconceito honesto de um homem honesto, De Nazaré pode sair alguma coisa boa, e Filipe, sem gastar argumento, disse apenas, Vem e vê.", "patron": "Invoca-se sua intercessão pelos que não têm dolo; pelos estudiosos das Escrituras."},

"Apostle Nicanor the Deacon of the Seventy":
{"type": "Diácono · séc. I", "life": "O santo apóstolo Nicanor foi um dos primeiros sete diáconos da Igreja de Cristo, escolhidos, como registram os Atos dos Apóstolos, quando os Doze convocaram a multidão dos discípulos e designaram sete homens de boa reputação, cheios do Espírito Santo e de sabedoria, Estêvão, Filipe, Prócoro, Nicanor, Timão, Parmenas e Nicolau, para servir às mesas e cuidar das viúvas, a fim de que o serviço da misericórdia fosse tão ordenado quanto o serviço da palavra.", "patron": "Invoca-se sua intercessão pelos diáconos; pelos que servem às mesas."},

"Apostle Onesimus of the Seventy":
{"type": "Apóstolo dos Setenta, mártir · séc. II", "life": "O santo apóstolo Onésimo, dos Setenta, é o único homem do Novo Testamento que é também seu assunto, pois a mais curta das epístolas de Paulo foi escrita inteiramente a respeito dele. Escravo de Filêmon, o cristão de Colossos, Onésimo lesou seu senhor e fugiu, e a estrada do fugitivo terminou, pela providência que governa tais estradas, em Roma, aos pés de Paulo preso.", "patron": "Invoca-se sua intercessão pelos servos; pelos que foram escravos."},

"Apostle Philip of the Seventy, One of the Seven Deacons":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Filipe, dos Setenta, um dos Sete Diáconos, foi escolhido com Estêvão e os demais pelos apóstolos para servir às mesas das viúvas na primeira Igreja de Jerusalém, sendo homem cheio de fé e do Espírito Santo. Quando a perseguição dispersou a Igreja, Filipe desceu a Samaria e ali pregou Cristo com sinais e prodígios, de modo que a cidade recebeu a palavra com grande alegria, e até Simão, o mago, creu e foi batizado.", "patron": "Invoca-se sua intercessão pelos diáconos; pelos evangelizadores."},

"Apostle Pudens of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Pudente, dos Setenta, era romano de ordem senatorial, e está nas Escrituras numa só saudação, pois o apóstolo Paulo, escrevendo sua última epístola da prisão em Roma, envia a Timóteo as saudações de Êubulo, Pudente, Lino e Cláudia, o círculo que restava ao Apóstolo condenado na capital comprimido em quatro nomes, e um deles era o deste senador.", "patron": "Invoca-se sua intercessão pelos que hospedam a Igreja; pelas casas que se tornam igrejas."},

"Apostle Quadratus of the Seventy":
{"type": "Apóstolo dos Setenta · séc. II", "life": "O santo apóstolo Quadrato, dos Setenta, pregou a palavra de Deus em Atenas e em Magnésia, e foi bispo de Atenas, chamado por seu biógrafo estrela da manhã brilhando entre as nuvens do paganismo. Por sua pregação converteu muitos pagãos à fé verdadeira, pelo que suportou perseguição, apedrejamento e prisão às mãos dos inimigos de Cristo.", "patron": "Invoca-se sua intercessão pelos apologistas; pela defesa da fé."},

"Apostle Silas of the Seventy":
{"type": "Bispo · séc. I", "life": "O santo apóstolo Silas, um dos Setenta, era membro respeitado da primeira Igreja de Jerusalém e contado entre os principais dos irmãos. Quando o Concílio Apostólico se reuniu em Jerusalém para decidir que os convertidos dentre os gentios não precisavam guardar a Lei de Moisés, Silas foi escolhido, sendo cheio da graça do Espírito Santo, para levar e explicar o decreto aos fiéis de Antioquia.", "patron": "Invoca-se sua intercessão pela pregação missionária."},

"Apostle Silvanus of the Seventy":
{"type": "Bispo · séc. I", "life": "O santo apóstolo Silvano, um dos Setenta, pregou a palavra de Deus junto com os apóstolos Pedro e Paulo, e o apóstolo Pedro o nomeia com honra em sua Primeira Epístola, chamando-o irmão fiel por meio de quem havia escrito. Trabalhando na propagação do Evangelho e confirmando as igrejas, são Silvano foi constituído bispo de Tessalônica, onde apascentou o rebanho de Cristo.", "patron": "Invoca-se sua intercessão pela pregação missionária."},

"Apostle Simon the Zealot":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo Simão, o Zelota, foi um dos Doze escolhidos pelo Senhor, chamado por são Mateus o Cananeu e por são Lucas o Zelota, significando os dois nomes a mesma coisa, pois Cananeu verte a palavra aramaica que o grego Zelotes traduz.", "patron": "O zelo que lhe deu o nome."},

"Apostle Sosthenes of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Sóstenes, dos Setenta, entra nas Escrituras duas vezes, uma espancado e outra abençoando, e a distância entre as duas é a história de sua alma. Nos Atos dos Apóstolos ele é o chefe da sinagoga de Corinto quando os judeus se levantaram contra Paulo e o arrastaram ao tribunal do procônsul Gálio.", "patron": "Invoca-se sua intercessão pelos convertidos dentre os adversários; pelos espancados injustamente."},

"Apostle Tertius of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Tércio, dos Setenta, deixou sua própria saudação dentro das Sagradas Escrituras, pois foi sua mão que escreveu a Epístola do apóstolo Paulo aos Romanos sob o ditado do Apóstolo, e ali consignou, Eu, Tércio, que escrevi esta epístola, vos saúdo no Senhor, tornando-se o escrivão da grande carta do Evangelho da graça uma pequena palavra viva dentro dela.", "patron": "Invoca-se sua intercessão pelos escribas; pelos copistas."},

"Apostle Thaddeus of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Tadeu, um dos Setenta, era hebreu de nascimento, nascido na cidade síria de Edessa; distingue-se de Judas, também chamado Tadeu, que era um dos Doze. Vindo a Jerusalém para uma festa, ouviu a pregação de João, o Precursor, e por ele foi batizado, e, vendo o Senhor Jesus, seguiu-o e foi contado entre os setenta discípulos.", "patron": "Invoca-se sua intercessão pelos missionários; pela pregação missionária."},

"Apostle Timon the Deacon of the Seventy":
{"type": "Bispo · séc. I", "life": "O santo apóstolo Timão foi um dos sete diáconos designados pelos apóstolos, como registram os Atos dos Apóstolos, quando os Doze escolheram homens cheios do Espírito Santo e de sabedoria para servir às viúvas desamparadas da igreja de Jerusalém, Estêvão e Filipe à frente e Timão entre eles, os primeiros ordenados para o serviço da misericórdia da Igreja.", "patron": "Invoca-se sua intercessão pelos diáconos; pelos bispos das sés de fronteira."},

"Apostle Titus of the Seventy and Bishop of Crete":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Tito, um dos Setenta, era natural de Creta e filho de ilustre família pagã, e na juventude estudou a filosofia e a poesia dos gregos guardando-se de seus vícios. Atraído pela verdade, tornou-se discípulo e amado colaborador do apóstolo Paulo, que o chamou seu verdadeiro filho na fé comum e o fez primeiro bispo de Creta.", "patron": "Invoca-se sua intercessão pelos missionários; pela ilha de Creta."},

"Apostle Trophimus of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "O santo apóstolo Trófimo, dos Setenta, era grego de Éfeso, um dos convertidos dentre os gentios que o apóstolo Paulo ligou a si como companheiros de estrada, e as Escrituras o mostram três vezes, sendo cada vislumbre uma estação do discipulado. Aparece primeiro entre os delegados que acompanham Paulo da Grécia para Jerusalém com a coleta para os santos pobres, a oferta das jovens igrejas viajando sob a guarda de seus próprios filhos.", "patron": "Invoca-se sua intercessão pelos companheiros dos grandes; pelos enfermos deixados para trás."},

"Apostle and Evangelist John the Theologian":
{"type": "Apóstolo · séc. I", "life": "São João, o Teólogo, filho de Zebedeu e irmão de Tiago, era o discípulo amado de Cristo. Viu a Transfiguração e esteve junto à Cruz com a Mãe de Deus. Pregou o Evangelho, escreveu o quarto Evangelho, as epístolas e o Apocalipse, e repousou em Éfeso em extrema velhice."},

"Apostle and Evangelist Luke":
{"type": "Apóstolo · séc. I", "life": "O santo apóstolo e evangelista Lucas era natural de Antioquia, médico de ofício e versado também na pintura, e, vindo ao Senhor, foi contado entre os Setenta e enviado adiante de sua face; e foi um dos dois discípulos a quem Cristo ressuscitado apareceu no caminho de Emaús, quando lhes ardia o coração ao abrir-lhes Ele as Escrituras.", "patron": "Invoca-se sua intercessão pelos médicos; pelos iconógrafos."},

"Apostle and Evangelist Luke of the Seventy":
{"type": "Apóstolo, evangelista · séc. I", "life": "O santo apóstolo e evangelista Lucas, que os calendários deste dia comemoram com os apóstolos Natanael e Clemente, e cuja festa principal a Igreja guarda em outubro, era grego de Antioquia, médico de profissão e, acrescenta a tradição, pintor, as duas artes do corpo e do olho trazidas inteiras ao serviço do Evangelho.", "patron": "Invoca-se sua intercessão pelos médicos; pelos iconógrafos e pintores."},

"Apostle and Evangelist Mark":
{"type": "Apóstolo · séc. I", "life": "São Marcos foi um dos setenta apóstolos e o evangelista que escreveu o segundo Evangelho. Companheiro de Pedro, Paulo e Barnabé, pregou em muitos lugares e fundou a Igreja de Alexandria. Padeceu por Cristo no Egito e recebeu a coroa do martírio no primeiro século."},

"Apostle and Evangelist Matthew":
{"type": "Apóstolo · séc. I", "life": "São Mateus era um cobrador de impostos chamado por Cristo a ser um dos Doze Apóstolos. Deixou seu antigo ofício, seguiu o Senhor e escreveu o Evangelho que leva seu nome. Depois de Pentecostes pregou o Evangelho em muitas terras, suportou sofrimentos por Cristo e recebeu a coroa do martírio no primeiro século."},

"Apostles Jason and Sosipater of the Seventy, the Virgin Kerkyra, and those with them":
{"type": "Apóstolos dos Setenta, mártires · séc. I", "life": "Os santos apóstolos Jasão e Sosípatro, dos Setenta, com a virgem Cércira e os que estavam com eles, deram à Igreja uma das mais completas conversões insulares da era apostólica; Jasão era de Tarso, o primeiro cristão da cidade natal do apóstolo Paulo, e Sosípatro da Acaia, e Paulo na Epístola aos Romanos os chama seus parentes, acrescentando a tradição que Jasão é o homem de Tessalônica que hospedou Paulo e Silas e respondeu por isso diante dos magistrados.", "patron": "Invoca-se sua intercessão pelas igrejas das ilhas; pelos presos e por quem os converte."},

"Apostles Patrobus, Hermes, Linus, Gaius, and Philologus, of the Seventy":
{"type": "Apóstolo dos Setenta · séc. I", "life": "Os santos apóstolos Pátrobas, Hermes, Lino, Gaio e Filólogo, dos Setenta, são saudados nas epístolas do apóstolo Paulo, e cada um serviu ao Evangelho como bispo, suportando os trabalhos e os perigos da primeira era da Igreja. Lino, a quem Paulo nomeia em sua última epístola, tornou-se, depois do martírio dos apóstolos maiores, o primeiro bispo de Roma, governando a igreja da cidade imperial nos anos da perseguição de Nero.", "patron": "Invoca-se sua intercessão pelos bispos; pela plantação das igrejas."},

"Apostles of the Seventy Archippus and Philemon, and Martyr Apphia":
{"type": "Apóstolos dos Setenta, mártires · séc. I", "life": "Os santos apóstolos Arquipo e Filêmon, dos Setenta, e a mártir Áfia são a casa da mais curta epístola, a família de Colossos a quem Paulo escreveu a carta que leva o nome de Filêmon.", "patron": "Invoca-se sua intercessão pelas igrejas domésticas; pelos esposos que servem juntos."},
...
{"type": "Apóstolo dos Setenta · séc. I", "life": "Os santos apóstolos Filêmon e Arquipo, a mártir Áfia, mulher de Filêmon, e são Onésimo, discípulo do apóstolo Paulo, estão ligados para sempre pela mais curta das epístolas de Paulo, escrita a Filêmon, nosso muito amado e colaborador, à amada Áfia, a Arquipo, nosso companheiro de milícia, e à igreja que está em tua casa.", "patron": "Invoca-se sua intercessão pelas casas de fé; pelos senhores e pelos servos."},

"Apostles of the Seventy: Erastus, Olympas, Herodion, Sosipater, Quartus, and Tertius":
{"type": "Apóstolo dos Setenta · séc. I", "life": "Os santos apóstolos Erasto, Olimpas, Herodião, Sosípatro, Quarto e Tércio, dos Setenta, foram discípulos e colaboradores do santo apóstolo Paulo, que os saúda em sua Epístola aos Romanos. Erasto, a quem Paulo chama tesoureiro da cidade, serviu como ecônomo da Igreja de Jerusalém e depois como bispo de Panéade, na Palestina.", "patron": "Invoca-se sua intercessão pelos bispos; pelos tesoureiros."},

"Appearance of Christ to Saint Martin of Tours":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora a aparição de Cristo a são Martinho de Tours, a visão que está à frente de uma das vidas mais amadas do Ocidente e prega, numa só cena noturna, todo o capítulo vinte e cinco de Mateus. Martinho era então um jovem soldado da cavalaria romana nas Gálias, e ainda catecúmeno, não batizado.", "patron": "Invoca-se sua intercessão pelos soldados; pelos que dão esmola."},

"Appearance of the Icon of the Mother of God “The Footprint” at Pochaiv":
{"type": "Festa · séc. XIV", "life": "Neste dia a Igreja comemora a aparição da Santíssima Mãe de Deus sobre o monte de Potchaiv, o prodígio que fundou a grande lavra da Volínia e deixou na rocha viva a marca de seu pé que os fiéis chamam simplesmente a Pegada.", "patron": "A pegada deixada na rocha."},

"Arrival of the Ivḗron Icon of the Mother of God in Georgia":
{"type": "Festa", "life": "Neste dia a Igreja da Geórgia comemora a chegada do ícone de Ivíron da Santíssima Mãe de Deus à Geórgia. Em vinte e seis de setembro de 1989, uma cópia exata da célebre e milagrosa Portaítissa, a Guardiã da Porta do mosteiro de Ivíron no Monte Atos, chegou a Tbilisi vinda do Monte Santo, pintada pelos monges atonitas com a bênção do católico-patriarca Ilia II em sinal de amor e gratidão para com o povo georgiano, cujos pais haviam fundado antigamente o mosteiro de Ivíron.", "patron": "Invoca-se sua intercessão pela proteção da Geórgia; pela consolação nos tempos difíceis."},

"Beginning of Great Lent":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja entra na Grande Quaresma, os santos Quarenta Dias, a mais antiga e maior de suas estações de penitência, guardada desde as primeiras gerações como o dízimo do ano oferecido a Deus e a jornada comum de todos os fiéis para a Páscoa. Suas raízes chegam ao princípio: o próprio Senhor jejuou quarenta dias.", "patron": "Invoca-se sua intercessão por todos os fiéis; pelos catecúmenos que se preparam para o batismo."},

"Beheading of Venerable Cornelius, Abbot of the Pskov Caves":
{"type": "Igumeno, mártir · séc. XVI", "life": "Nosso venerável pai Cornélio, igumeno das Cavernas de Pskov e hieromártir, nasceu em Pskov em 1501, de Estêvão e Maria, gente nobre, e formou-se no mosteiro de Miroj em toda a cultura do monaquismo do norte, fazendo velas, cortando lenha, copiando e adornando livros e pintando ícones; e, quando o escrivão Missiur Munekhin levou o jovem ao pobre mosteiro das Cavernas no meio da mata, a beleza do lugar e a solenidade da igreja rupestre decidiram sua vida, pois ali recebeu a tonsura e nunca mais partiu.", "patron": "Invoca-se sua intercessão pelos igumenos; pelos cronistas."},

"Blessed Andrew of Totma the Fool-For-Christ":
{"type": "Louco por Cristo · séc. XVII", "life": "O bem-aventurado André de Totma, louco por Cristo, nasceu em 1638 na aldeia de Ust-Totma, nas terras de Vólogda, e ainda menino resolveu deixar o mundo. Com a bênção de Estêvão, igumeno do mosteiro da Ressurreição em Galitch, tomou sobre si o duro chamado da loucura por amor de Cristo, e fixou-se junto à igreja da Ressurreição na vila de Totma, sobre o rio Sukhona.", "patron": "Invoca-se sua intercessão pela pobreza voluntária; pela esmola escondida."},

"Blessed Andrew the Fool-For-Christ at Constantinople":
{"type": "Louco por Cristo · séc. X", "life": "O bem-aventurado André, louco por Cristo, era eslavo de nascimento, levado ainda jovem como escravo a Constantinopla, onde serviu a um dignitário da cidade e foi amado por sua mansidão e por sua aplicação às Escrituras. Vendo em sonho os exércitos dos anjos e dos demônios em combate, e ouvindo o Senhor chamá-lo para a luta, tomou sobre si, depois de alforriado por seu senhor, o mais duro dos caminhos ascéticos, fingindo-se louco por amor de Cristo.", "patron": "Invoca-se sua intercessão pelos servos escondidos de Deus; pelas visões das coisas celestes."},

"Blessed Cleopatra with her son John, in Egypt":
{"type": "Santa · séc. IV", "life": "A bem-aventurada Cleópatra era uma viúva piedosa da Palestina, que vivia no Egito nos dias da perseguição, e, vendo o combate do santo mártir Varo, obteve em segredo seu corpo e o levou à sua aldeia natal de Edra, junto ao monte Tabor, onde o sepultou com honra e edificou sobre ele uma igreja em nome do mártir, venerando-o toda a sua casa como protetor.", "patron": "Invoca-se sua intercessão pelas mães; pelas mães que choram."},

"Blessed Constantine, Metropolitan of Kyiv":
{"type": "Metropolita · séc. XII", "life": "O bem-aventurado Constantino, metropolita de Kyiv, governou a Igreja russa em meados do século XII, num tempo de graves contendas pela sé metropolitana, e é lembrado sobretudo pela assombrosa humildade com que buscou, mesmo na morte, o último lugar.", "patron": "Invoca-se sua intercessão pelos hierarcas que buscam o último lugar; pelos humildes em altos cargos."},

"Blessed Dovmont (Timothy), Prince of Pskov":
{"type": "Príncipe fiel · séc. XIII", "life": "O santo príncipe fiel Dovmont de Pskov, chamado Timóteo desde seu batismo, era um príncipe lituano e pagão que se tornou um dos governantes mais amados e o protetor celeste de uma cidade russa, sendo sua vida uma parábola do zelo do convertido derramado na defesa do povo que o acolheu.", "patron": "O príncipe pagão feito campeão cristão."},

"Blessed John “the Hairy” and Fool-For-Christ at Rostov":
{"type": "Louco por Cristo · séc. XVI", "life": "O bem-aventurado João, chamado o Misericordioso e também o Cabeludo, tomou sobre si em Rostov o duro e escondido combate da loucura por amor de Cristo, suportando frio, fome e injúria pelo amor de Deus. Não tinha casa própria, mas achava abrigo ora na casa de seu pai espiritual, sacerdote da igreja de Todos os Santos, ora com uma ou outra das viúvas pobres da cidade.", "patron": "Invoca-se sua intercessão pela humildade; pelos que não têm casa."},

"Blessed Laurence the Fool-For-Christ at Kaluga":
{"type": "Louco por Cristo · séc. XVI", "life": "O bem-aventurado Lourenço, louco por Cristo e taumaturgo de Kaluga, viveu no princípio do século XVI perto da velha cidade de Kaluga, junto a uma igreja da Natividade de Cristo erguida sobre um alto outeiro arborizado, ao qual levava de sua morada uma longa passagem subterrânea, para que pudesse assistir aos ofícios.", "patron": "Invoca-se sua intercessão pela defesa de Kaluga."},

"Blessed Nicholas (Salos) of Pskov the Fool-For-Christ":
{"type": "Louco por Cristo · séc. XVI", "life": "O bem-aventurado Nicolau Salos de Pskov, a quem a cidade chamava Mikula, o Louco, levou por mais de três décadas o combate da loucura por Cristo, dormindo nos alpendres, suportando a geada e o escárnio em farrapos, falando por enigmas que se cumpriam, e alcançando, muito antes de seu repouso, a graça dos milagres e da profecia, tornando-se o louco da cidade, sem alarde, o seu mais seguro oráculo.", "patron": "Invoca-se sua intercessão pelos loucos por Cristo; pelos que dizem a verdade diante do poder."},

"Blessed Nicholas Kochanov the Fool-For-Christ at Novgorod":
{"type": "Louco por Cristo · séc. XIV", "life": "O bem-aventurado Nicolau Kotchanov, louco por Cristo de Nóvgorod, nasceu de família rica e nobre e desde a juventude amou a igreja, o jejum e a oração. Quando o povo começou a louvá-lo por sua virtude, fugiu dessa estima tomando o difícil caminho da loucura por Cristo, escondendo sua santidade sob a aparência da demência.", "patron": "Invoca-se sua intercessão pela reconciliação; pela paz em meio à discórdia."},

"Blessed Prince Gleb Andreevich, son of Saint Andrew Bogoliubsky":
{"type": "Príncipe · séc. XII", "life": "São Gleb Andreievitch era um jovem príncipe de Vladímir, filho do santo príncipe André Bogoliubsky, que viveu uma vida breve de rara piedade e foi glorificado por Deus com a incorrupção de suas relíquias.", "patron": "Invoca-se sua intercessão pelos jovens príncipes piedosos; pelos que amam as Escrituras e a Igreja."},

"Blessed Yaropolk (in Baptism Peter), Prince of Volodymyr-Volhynia":
{"type": "Príncipe · séc. XI", "life": "O santo príncipe Iaropolk de Volodymyr-Volínia, chamado Pedro no santo batismo, era filho do grão-príncipe Iziaslav de Kyiv e neto de Iaroslav, o Sábio; e sua vida breve foi uma escola de despojamento, pois partilhou os repetidos exílios de seu pai entre os poloneses e os alemães, quando a discórdia dos príncipes os expulsava da Rus, aprendendo cedo que os tronos são emprestados e não dados.", "patron": "Invoca-se sua intercessão pelos governantes; pelos príncipes que sofrem injustiça sem vingança."},

"Childmartyr Gabriel of Bialystok":
{"type": "Menino mártir · séc. XVII", "life": "O santo menino mártir Gabriel de Bialystok nasceu em 1684 na aldeia de Zverki, perto de Bialystok, filho de aldeões ortodoxos piedosos, Pedro e Anastássia, e viveu os seis breves anos que lhe foram dados na santidade comum de uma infância camponesa amada, as orações aprendidas no colo da mãe, as festas da igreja, os campos.", "patron": "Invoca-se sua intercessão pelas crianças; pelos inocentes e indefesos."},

"Church New Year":
{"type": "Festa", "life": "No primeiro dia de setembro a Igreja celebra o começo da Indicção, isto é, o Ano Novo eclesiástico. Os Padres do Primeiro Concílio Ecumênico de Niceia determinaram que o ano da Igreja começasse neste dia, seguindo a antiga contagem pela qual setembro, o mês da colheita recolhida, era o princípio do ano entre os hebreus, que nesta estação ofereciam a Deus suas graças por sua abundância.", "patron": "Invoca-se sua intercessão pelo ano novo; pela ação de graças."},

"Commemoration of the Apparition of the Sign of the Precious Cross Over Jerusalem, in 351 AD":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora a aparição do sinal da preciosa Cruz no céu sobre Jerusalém, no ano 351, sob o imperador Constâncio, filho de Constantino, o Grande; a sete de maio, na terça-feira anterior à festa da Ascensão.", "patron": "A Cruz escrita através do céu."},

"Commemoration of the Founding of Constantinople":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora a fundação e a dedicação de Constantinopla, que se deu na segunda-feira, onze de maio do ano 330, na terceira indicção, pelo grande e cristão imperador Constantino.", "patron": "A Nova Roma fundada sob a Cruz."},

"Commemoration of the Founding of the Church of the Resurrection (Holy Sepulchre) at Jerusalem":
{"type": "Festa", "life": "Neste dia a Igreja comemora a fundação, isto é, a solene consagração, da igreja da Ressurreição de Cristo em Jerusalém, erguida por são Constantino, o Grande, e por sua mãe, a santa imperatriz Helena, sobre o Túmulo do Senhor e o outeiro do Gólgota. Tendo Helena chegado a Jerusalém, destruído os santuários pagãos que profanavam os lugares santos e achado a vivificante Cruz sob o templo de Vênus, Constantino mandou edificar uma grande e esplêndida igreja que encerrasse ao mesmo tempo o lugar da Crucificação e o Sepulcro da Ressurreição.", "patron": "Invoca-se sua intercessão pela consagração das igrejas."},

"Commemoration of the Great Earthquake at Constantinople":
{"type": "Festa", "life": "Neste dia a Igreja comemora o grande terremoto que abalou Constantinopla no ano 740, no reinado de Leão, o Isáurio, quando a ira de Deus sacudiu a cidade imperial, derrubando igrejas, moradias e longos trechos das muralhas com suas torres, e matando muita gente, continuando os tremores por meses, de sorte que os habitantes viviam com medo sob o céu aberto.", "patron": "Invoca-se sua intercessão pelo livramento dos terremotos; pela penitência diante dos juízos de Deus."},

"Commemoration of the Holy Fathers of the First Ecumenical Council":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora os santos Padres do Primeiro Concílio Ecumênico, os trezentos e dezoito reunidos em Niceia no ano 325.", "patron": "Invoca-se sua intercessão pelos defensores da divindade do Filho; pelos padres dos concílios."},

"Commemoration of the Holy Fathers of the Second Ecumenical Council":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora os santos Padres do Segundo Concílio Ecumênico, os cento e cinquenta que se reuniram em Constantinopla no ano 381, sob o imperador Teodósio, o Grande.", "patron": "O Símbolo completado com o artigo do Espírito."},

"Commemoration of the Holy Fathers of the Seventh Ecumenical Council":
{"type": "Festa", "life": "Neste dia a Igreja comemora os santos Padres do Sétimo Concílio Ecumênico, reunido em Niceia no ano 787, nos dias da imperatriz Irene e de seu filho Constantino, sob a presidência de são Tarásio, patriarca de Constantinopla. Cerca de trezentos e cinquenta padres se juntaram contra a heresia dos iconoclastas, que por décadas devastara a Igreja, destruindo as santas imagens e perseguindo os que as veneravam.", "patron": "Invoca-se sua intercessão pela veneração dos santos ícones; pela plenitude do ensino ortodoxo."},

"Commemoration of the Holy Righteous David the King, Joseph the Betrothed, and James the Brother of the Lord":
{"type": "Justos · séc. I", "life": "Nos dias que seguem à Natividade a Igreja comemora juntos os santos e justos José, o Desposado, Davi, o rei, e Tiago, irmão do Senhor, a sinaxe da parentela do Senhor segundo a carne, fixada desde antigo para o domingo depois da festa e guardada também neste dia.", "patron": "Invoca-se sua intercessão pelas famílias dos servos do Senhor; pelo parentesco com Cristo pela obediência."},

"Commemoration of the Kazan Icon of the Mother of God and the deliverance from the Poles":
{"type": "Festa", "life": "Neste dia a Igreja comemora o ícone de Kazan da Santíssima Mãe de Deus em memória do livramento de Moscou e de toda a Rússia dos poloneses no ano de 1612. No Tempo das Perturbações, quando a terra estava dilacerada pela invasão e pela traição e a própria Moscou era mantida por armas estrangeiras que zombavam da fé ortodoxa, o patriarca Hermógenes, preso, chamou o povo a levantar-se em defesa da Igreja e da pátria.", "patron": "Invoca-se sua intercessão pelo livramento das nações; pela proteção no tempo das perturbações."},

"Commemoration of the Miracle of the Archangel Michael at Colossae":
{"type": "Festa", "life": "Neste dia a Igreja comemora o glorioso milagre obrado pelo arcanjo Miguel em Chonas, perto de Colossos, na Frígia. Havia naquele lugar uma fonte milagrosa, anunciada pelo apóstolo João, o Teólogo, quando pregava em Hierápolis; e um homem de Laodiceia, cuja filha muda recebeu a fala por aquelas águas depois que o Arcanjo lhe apareceu em sonho, foi batizado com toda a sua casa e edificou sobre a fonte uma igreja em honra do Comandante Supremo Miguel.", "patron": "Invoca-se sua intercessão pela proteção; pela cura."},

"Commemoration of the Shepherds in Bethlehem who were watching their flocks, and went to see the Lord":
{"type": "Justos · séc. I", "life": "No primeiro dia da Natividade a Igreja comemora os pastores de Belém, que velavam de noite sobre seus rebanhos nos campos quando a glória do Senhor os cercou de luz, e foram os primeiros do gênero humano a ouvir a pregação do Evangelho.", "patron": "Invoca-se sua intercessão pelos pastores; pelos que velam de noite."},

"Commemoration of the Vladimir Icon of the Mother of God and the deliverance of Moscow from the Invasion of Tamerlane":
{"type": "Festa · séc. XIV", "life": "O ícone de Vladímir da Santíssima Mãe de Deus, segundo a tradição pintado pelo evangelista Lucas e trazido de Constantinopla à Rus, foi colocado por são André Bogoliubsky na catedral de Vladímir, de onde tomou o nome, e tornou-se o ícone mais amado e mais protetor da terra russa.", "patron": "Invoca-se sua intercessão pela proteção da Rússia; pelo livramento da invasão."},

"Conception of the Honorable Glorious Prophet, Forerunner and Baptist John":
{"type": "Festa · séc. I", "life": "Neste dia a Igreja celebra a Concepção do venerável e glorioso profeta, precursor e batista João, o começo da história do Evangelho. Quando o sacerdote Zacarias, na ordem de seu turno, entrou no Templo do Senhor para oferecer o incenso, o arcanjo Gabriel apareceu-lhe à direita do altar do incenso e anunciou-lhe o filho que sua mulher Isabel, estéril e já idosa, haveria de dar à luz.", "patron": "Invoca-se sua intercessão pelos casais sem filhos; pela oração atendida."},

"Conception of the Most Holy Theotokos by Saint Anna":
{"type": "Festa", "life": "Esta festa celebra a concepção da Virgem Maria por sua mãe, a justa Ana, nove meses antes da festa da natividade de Maria, a oito de setembro. Segundo a tradição da Igreja, Joaquim e Ana eram justos, mas não tinham filhos e eram avançados em anos, e sua esterilidade era tida por opróbrio.", "patron": "Comemora-se no santo calendário da Igreja."},

"Confessors Barses and Eulogius, Bishops of Edessa, and Protogenes, Bishop of Carrhae":
{"type": "Bispo · séc. IV", "life": "Os santos Barses e Eulógio, bispos de Edessa, e Protógenes, bispo de Carras, foram confessores que padeceram às mãos dos arianos na segunda metade do século IV, quando o imperador Valente procurava difundir aquela heresia e perseguia cruelmente os ortodoxos. São Barses, campeão firme da fé verdadeira, foi expulso de seu trono em Edessa e mandado ao exílio, primeiro a um lugar e depois a outro, cada vez mais longe de sua cidade.", "patron": "Invoca-se sua intercessão pela Ortodoxia contra a heresia; pela perseverança no exílio."},

"Consecration of the Church of the Holy Great Martyr George in Lydda":
{"type": "Festa", "life": "Neste dia a Igreja comemora a consagração da igreja do santo grande mártir Jorge em Lida, na Palestina, e a deposição ali de suas preciosas relíquias. O grande mártir, que padeceu em Nicomédia no ano 303 sob Diocleciano, pedira a seu servo, antes do combate, que levasse seu corpo a Lida, terra da família de sua mãe na Terra Santa.", "patron": "Invoca-se sua intercessão pela veneração do grande mártir Jorge."},

"Constantinople Icon of the Mother of God":
{"type": "Festa · séc. I", "life": "Neste dia a Igreja comemora o ícone de Constantinopla da Santíssima Mãe de Deus, imagem que a tradição conta entre as pintadas pelo próprio santo apóstolo e evangelista Lucas, médico e iconógrafo da Mãe de Deus, cujo pincel, sustenta a Igreja, deu primeiro aos fiéis a sua semelhança e recebeu dela mesma a bênção sobre a obra, sua palavra de que sua graça estaria com as imagens.", "patron": "Invoca-se sua intercessão pelos iconógrafos; por todos os que honram os ícones da Mãe de Deus."},

"Dedication of the Church of the Greatmartyr George at Kyiv":
{"type": "Festa", "life": "Neste dia a Igreja comemora a consagração da igreja do santo grande mártir Jorge em Kyiv. Era costume piedoso dos príncipes da Rus, a começar por são Vladímir, erguer igrejas em honra de seus santos padroeiros: Vladímir, chamado Basílio no batismo, edificou templos de são Basílio em Kyiv e em Vyshgorod, e seus filhos o seguiram nisso.", "patron": "Invoca-se sua intercessão pela veneração do grande mártir Jorge na Rus; pelas igrejas edificadas em ação de graças."},

"Dormition of the Righteous Anna, the Mother of the Most Holy Theotokos":
{"type": "Justa · séc. I", "life": "Esta festa comemora o repouso pacífico da justa Ana, mãe da Santíssima Mãe de Deus e avó de nosso Senhor segundo a carne. Ana era filha do sacerdote Matã, da tribo de Levi e da linhagem de Arão, e junto com seu marido, o justo Joaquim, levou por longos anos o opróbrio da esterilidade, até que em sua velhice Deus ouviu suas orações e lhes deu uma filha, a pura Virgem Maria, que havia de tornar-se a Mãe de Deus.", "patron": "Invoca-se sua intercessão pelas mães; pelas avós."},

"Entrance of the Apostle Andrew into Georgia":
{"type": "Festa", "life": "Neste dia a Igreja da Geórgia comemora a entrada do santo apóstolo André, o Primeiro-Chamado, nas terras georgianas, o fundamento apostólico sobre o qual está aquela antiga Igreja. A tradição da Geórgia relata que, quando os apóstolos lançaram sortes sobre as nações, a Ibéria coube à própria Santíssima Mãe de Deus.", "patron": "Invoca-se sua intercessão pelo fundamento apostólico da Igreja da Geórgia; pela Mãe de Deus como protetora da Geórgia."},

"Equal of the Apostles and Emperor Constantine with his Mother Helen":
{"type": "Igual aos apóstolos · séc. IV", "life": "São Constantino tornou-se imperador dos romanos e pôs fim à perseguição dos cristãos pelo Édito de Milão. Sustentou a Igreja e convocou o Primeiro Concílio Ecumênico em Niceia. Sua mãe, santa Helena, viajou a Jerusalém e está ligada ao encontro da vivificante Cruz. Repousaram no século IV."},

"Equal-to-the-Apostles Blessed Great Princess Olga (in Holy Baptism Helen)":
{"type": "Igual aos apóstolos · séc. X", "life": "Santa Olga era princesa de Kyiv e avó de são Vladímir. Depois da morte do príncipe Igor, governou a Rus com sabedoria. Recebeu o santo batismo com o nome de Helena e favoreceu o cristianismo entre seu povo, ainda que a Rus não estivesse batizada. Repousou em 969."},

"Equals of the Apostles and Teachers of the Slavs, Cyril and Methodius":
{"type": "Apóstolo · séc. IX", "life": "Os santos Cirilo e Metódio, iguais aos apóstolos e mestres dos eslavos, eram irmãos de uma família senatorial de Tessalônica, a cidade à beira do mundo eslavo cujas ruas lhes haviam ensinado a língua eslava desde a infância, providência para a obra que os esperava.", "patron": "O alfabeto dado aos eslavos."},

"Eve of the Nativity of our Lord":
{"type": "Festa", "life": "A véspera da Natividade de nosso Senhor, chamada a Paramonia, é o limiar da festa, e a Igreja a guarda como guarda apenas a véspera da Teofania, com um dia de jejum rigoroso e a mais solene preparação de seu ano. Pela manhã cantam-se as Horas Reais, assim chamadas porque outrora os imperadores as assistiam de pé: em cada hora se leem os salmos da Encarnação, as profecias, o Apóstolo e o Evangelho do nascimento, toda a Escritura reunida em torno da gruta.", "patron": "Comemora-se no santo calendário da Igreja."},

"Fathers of the First Six Councils":
{"type": "Bispos", "life": "Neste dia se comemoram os santos Padres dos seis primeiros Concílios Ecumênicos, os hierarcas e mestres portadores de Deus reunidos de toda parte do mundo cristão para defender a fé apostólica das heresias que a assaltavam. Em Niceia e no Primeiro Concílio de Constantinopla proclamaram a divindade do Filho e do Espírito Santo e deram à Igreja o Símbolo da Fé que confessamos até hoje.", "patron": "Invoca-se sua intercessão pela doutrina ortodoxa; pela fé verdadeira."},

"Finding of the Relics of Saints Basil and Constantine, Princes of Yaroslavl":
{"type": "Festa · séc. XVI", "life": "Neste dia a Igreja comemora a descoberta das relíquias dos santos príncipes fiéis Basílio e Constantino de Iaroslavl, irmãos que governaram e padeceram por sua cidade nos anos amargos do jugo tártaro e cujos corpos incorruptos foram revelados muito depois, num incêndio.", "patron": "Invoca-se sua intercessão pelos príncipes de Iaroslavl; por aqueles cujas relíquias se acham depois do fogo."},

"Finding of the relics of Monastic Martyr Adrian of Poshekhonsk, Yaroslavl":
{"type": "Igumeno · séc. XVI", "life": "Neste dia a Igreja comemora a descoberta das relíquias do venerável mártir Adriano de Pochekhonie, ocorrida a dezenove de novembro de 1625. Santo Adriano, monge e iconógrafo dotado, formado na tradição dos grandes mosteiros do norte, fundara com um companheiro de ascese um mosteiro da Dormição da Santíssima Mãe de Deus nas matas de Pochekhonie, nas terras de Iaroslavl, trabalhando ali em jejum, oração e pintura de santos ícones, e reunindo uma irmandade em torno da igreja do ermo.", "patron": "Invoca-se sua intercessão pelos iconógrafos; pelos monges."},

"Finding of the relics of Righteous Saint Νikόdēmos":
{"type": "Justo · séc. I", "life": "São Nicodemos era fariseu e chefe dos judeus, e veio ao Senhor Jesus de noite, como relata o Evangelho de João, e dele ouviu falar do novo nascimento pela água e pelo Espírito. Ainda que a princípio viesse às escondidas por medo dos judeus, defendeu o Salvador diante do conselho, e depois da crucificação veio abertamente com José de Arimateia, trazendo uma mistura de mirra e aloés, e ajudou a ungir e a sepultar o corpo do Senhor.", "patron": "Invoca-se sua intercessão pelos discípulos ocultos; pelos que buscam a verdade."},

"Finding of the relics of Saint Abibas":
{"type": "Justo · séc. I", "life": "Santo Abibo era filho do justo Gamaliel, mestre de são Paulo, e junto com seu pai recebeu o santo batismo pelas mãos dos apóstolos, abraçando a fé de Cristo. Vivendo em pureza, repousou ainda jovem e foi sepultado por seu pai na gruta de Cafargamala, onde já jaziam o protomártir Estêvão e são Nicodemos.", "patron": "Invoca-se sua intercessão pela pureza."},

"Finding of the relics of Saint Basil, Bishop of Ryazan":
{"type": "Festa · séc. XVII", "life": "Neste dia a Igreja comemora a descoberta das relíquias de são Basílio, bispo de Riazan, hierarca do século XIII cuja inocência foi confirmada por um célebre prodígio e cujas relíquias se revelaram nos anos turvos do século XVII.", "patron": "Invoca-se sua intercessão pelos falsamente acusados; pelos bispos expulsos pela calúnia."},

"Finding of the relics of Saint Gamaliel":
{"type": "Justo · séc. I", "life": "São Gamaliel era fariseu e doutor renomado da Lei, honrado entre os judeus, que aconselhou moderação para com os apóstolos quando estes foram levados diante do conselho, como relatam os Atos dos Apóstolos, e que fora o mestre de são Paulo. Em segredo tornou-se discípulo de Cristo, e quando o protomártir Estêvão foi apedrejado e deixado insepulto, foi Gamaliel quem com reverência recolheu seu corpo e o pôs numa gruta de suas próprias terras, em Cafargamala.", "patron": "Invoca-se sua intercessão pelos mestres; pelos discípulos ocultos."},

"Finding of the relics of Saint Theodore, Prince of Smolensk and Yaroslavl, and his children":
{"type": "Príncipe · séc. XIII", "life": "Neste dia a Igreja comemora a descoberta das relíquias do príncipe fiel Teodoro de Smolensk e Iaroslavl, chamado o Negro, junto com seus filhos Davi e Constantino, ocorrida em Iaroslavl a cinco de março de 1463; o repouso do próprio príncipe guarda-se em setembro, e este dia pertence ao achado de seu corpo incorrupto.", "patron": "Invoca-se sua intercessão pelos governantes; pelas famílias."},

"Finding of the relics of Venerable Cyril, Abbot of Novoezersk, Vologda":
{"type": "Igumeno · séc. XVI", "life": "Neste dia a Igreja comemora a descoberta das relíquias de nosso venerável pai Cirilo, igumeno de Novoezersk, ocorrida no ano de 1649. Nascido de família nobre de Galitch, fugiu da casa de seus pais aos quinze anos, atraído pelo amor de Cristo, e chegou pelas matas ao grande ancião Cornélio de Komel, que, discernindo no rapaz o selo de Deus, o tonsurou.", "patron": "Invoca-se sua intercessão pelos monges; pela consagração na juventude."},

"Finding of the relics of Venerable Maximus the Greek (July 4, 1996)":
{"type": "Monge · séc. XVI", "life": "Esta festa comemora a descoberta das relíquias de nosso venerável pai Máximo, o Grego, monge sábio e confessor. Nascido Miguel Trivolis em Arta, na Grécia, por volta de 1470, estudou na Itália, depois fez-se monge no Monte Atos, e em 1518 foi enviado à Rússia para traduzir e corrigir os livros sagrados.", "patron": "Invoca-se sua intercessão pelos tradutores e estudiosos; pelos presos injustamente."},

"First Translation of the relics of Saint Herman, Archbishop of Kazan":
{"type": "Arcebispo · séc. XVI", "life": "São Germano, arcebispo de Kazan, nasceu em Staritsa, da nobre família Sadyrev-Polev, e, recebendo a tonsura no mosteiro de Volokolamsk, foi formado na escola de são José, tornando-se conhecido por sua ciência, sua vida ascética e seu trabalho de copiar livros. Quando as terras de Kazan, recém-conquistadas, se abriram ao Evangelho, foi enviado com são Gúrias para a iluminação delas, e fundou em Sviajsk o mosteiro da Dormição da Mãe de Deus, que se tornou o centro da missão junto aos povos do Volga.", "patron": "Invoca-se sua intercessão pelos missionários; pela iluminação das terras de Kazan."},

"First and second finding of the Honorable Head of the Holy Glorious Prophet, Forerunner, and Baptist of the Lord, John":
{"type": "Festa · séc. V", "life": "Neste dia a Igreja celebra a primeira e a segunda descobertas da preciosa cabeça de são João, o Precursor, os dois primeiros capítulos do estranho itinerário da relíquia mais venerada da cristandade depois dos instrumentos da Paixão. Quando Herodíade obteve na bandeja de sua vingança a cabeça do Batista, não consentiu que fosse sepultada com o corpo, temendo, diz a tradição, a ressurreição do homem que calara, e escondeu-a num lugar imundo do palácio de Herodes.", "patron": "Invoca-se sua intercessão por todos os que buscam o que está escondido; pelos guardiães das relíquias."},

"First finding of the relics of Saint Metrophanes, first Bishop of Voronezh":
{"type": "Bispo · séc. XVIII", "life": "São Mitrofânio foi o primeiro bispo de Voronej, sagrado em 1682, e foi célebre por sua profunda piedade, seu cuidado com os pobres e seu zelo pela Igreja; conselheiro e apoio do imperador Pedro, o Grande, na construção da frota russa em Voronej, não temeu repreender o soberano quando se ergueram estátuas pagãs, e foi ouvido.", "patron": "Comemora-se no santo calendário da Igreja."},

"Forefeast of the Annunciation":
{"type": "Pré-festa · séc. I", "life": "Neste dia a Igreja guarda a pré-festa da Anunciação, o único dia de preparação antes da festa que os padres chamaram a coroa de nossa salvação e o princípio de todas as festas, e os hinos do dia ficam na ponta dos pés: hoje, cantam, aproxima-se o grande mistério, o arcanjo está sendo enviado, a Virgem está em oração, e a alegria de toda a criação está a uma tarde de distância.", "patron": "Invoca-se sua intercessão por todos os que se preparam para uma grande alegria; pela véspera da grande boa nova."},

"Forefeast of the Dormition of the Mother of God":
{"type": "Pré-festa", "life": "Este dia é a pré-festa da Dormição de nossa Senhora, a Santíssima Mãe de Deus, no qual a Igreja começa a celebrar seu bem-aventurado adormecer, guardado a quinze de agosto ao fim do jejum a ela dedicado. Os hinos da pré-festa chamam os fiéis a reunir-se em alegria, pois a Mãe de Deus está para partir da terra ao reino celeste, para ser levada em glória por seu Filho.", "patron": "Comemora-se no santo calendário da Igreja."},

"Forefeast of the Elevation of the Cross":
{"type": "Pré-festa", "life": "Esta é a pré-festa da Universal Exaltação da Preciosa e Vivificante Cruz, na qual a Igreja começa a celebrar a grande festa do dia seguinte. Nos ofícios começam a soar os hinos da Cruz, chamando os fiéis a purificar suas almas para que possam contemplar o santo Lenho levantado no meio da terra.", "patron": "Comemora-se no santo calendário da Igreja."},

"Forefeast of the Entry into the Temple of the Most Holy Theotokos":
{"type": "Pré-festa", "life": "Neste dia a Igreja guarda a pré-festa da Entrada da Santíssima Mãe de Deus no Templo, estando ao limiar da festa como a menina Maria esteve ao limiar do santuário. Os hinos da pré-festa convocam os fiéis a preparar-se: Alegremo-nos hoje, ó fiéis, salmodiando ao Senhor, e honremos seu tabernáculo santificado, a arca viva que conteve o Verbo incontível.", "patron": "Invoca-se sua intercessão pela preparação para as festas da Mãe de Deus."},

"Forefeast of the Meeting of our Lord in the Temple":
{"type": "Pré-festa", "life": "A pré-festa do Encontro de nosso Senhor no Templo guarda-se no primeiro de fevereiro, um só dia de preparação antes da festa que fecha todo o ciclo da Natividade do Senhor; e nela a Igreja volta os olhos para o Templo de Jerusalém, onde amanhã o Legislador será levado como menino de quarenta dias para cumprir sua própria Lei.", "patron": "Comemora-se no santo calendário da Igreja."},

"Forefeast of the Nativity of our Lord":
{"type": "Pré-festa", "life": "A pré-festa da Natividade de nosso Senhor abraça os dias que vão de vinte de dezembro à vigília da festa, e neles a Igreja, como Belém nos hinos, se apronta. Os ofícios voltam-se inteiramente para a gruta: nas estíqueras de cada dia ressoa o chamado, Belém, prepara-te.", "patron": "Comemora-se no santo calendário da Igreja."},

"Forefeast of the Nativity of the Mother of God":
{"type": "Pré-festa", "life": "Esta é a pré-festa da Natividade da Santíssima Mãe de Deus, na qual a Igreja começa a celebrar a primeira das grandes festas do novo ano eclesiástico, o nascimento da Mãe de Deus dos justos Joaquim e Ana. Neste dia os hinos da festa que vem começam a soar nos ofícios, chamando os fiéis a preparar o coração para saudar a Virgem cujo nascimento anunciou ao mundo a aproximação de sua salvação.", "patron": "Comemora-se no santo calendário da Igreja."},

"Forefeast of the Procession of the Honorable and Lifegiving Cross of the Lord":
{"type": "Pré-festa", "life": "Este dia é a pré-festa da Procissão da Preciosa e Vivificante Cruz do Senhor, que a Igreja celebra no primeiro de agosto. Na cidade imperial de Constantinopla era costume, durante o mês de agosto, quando as doenças mais grassavam, tirar do tesouro o venerável Lenho da Cruz.", "patron": "Invoca-se sua intercessão pelo livramento das doenças; pela santificação."},

"Forefeast of the Transfiguration of our Lord":
{"type": "Pré-festa", "life": "Este dia é a pré-festa da Transfiguração de nosso Senhor, Deus e Salvador Jesus Cristo, que a Igreja celebra a seis de agosto. Querendo dar a seus discípulos um antegosto da glória do Reino antes de sua Paixão, o Senhor tomou consigo Pedro, Tiago e João e os levou a um alto monte, e ali se transfigurou diante deles, de modo que seu rosto resplandeceu como o sol e suas vestes se tornaram brancas como a luz.", "patron": "Comemora-se no santo calendário da Igreja."},

"Glorification of Saint Innocent, Metropolitan of Moscow, Enlightener of the Aleuts, Apostle to the Americas":
{"type": "Metropolita · séc. XIX", "life": "Neste dia a Igreja comemora a glorificação de santo Inocêncio, metropolita de Moscou, iluminador dos aleútas e apóstolo das Américas, contado entre os santos pela Igreja Ortodoxa Russa a seis de outubro de 1977, a pedido da Igreja Ortodoxa na América. Nascido João Popov-Veniaminov em 1797 numa aldeia da Sibéria, aprendeu as línguas dos povos do norte e lhes traduziu o Evangelho.", "patron": "Invoca-se sua intercessão pelos missionários; pelos tradutores."},

"Glorification of Saint John of Kronstadt":
{"type": "Santo · séc. XX", "life": "São João de Kronstadt, um dos grandes pastores da Igreja russa, nasceu João Sergiev em 1829 numa aldeia pobre do extremo norte e tornou-se sacerdote casado de paróquia na catedral de Santo André em Kronstadt, perto de São Petersburgo, onde serviu por mais de cinquenta anos.", "patron": "Comemora-se no santo calendário da Igreja."},

"Glorification of Saint Tikhon, Patriarch of Moscow and All Russia, Enlightener of North America":
{"type": "Patriarca · séc. XX", "life": "Neste dia a Igreja comemora a glorificação de são Tíkhon, patriarca de Moscou e de toda a Rússia, contado entre os santos pelo Concílio dos Bispos da Igreja Ortodoxa Russa a nove de outubro de 1989. Nascido Basílio Bellavin em 1865, filho de um sacerdote de aldeia de Toropets, era tão amado por sua mansidão que os colegas de seminário o chamavam Patriarca por brincadeira, sem saber que profetizavam.", "patron": "Invoca-se sua intercessão pelos hierarcas; pelos missionários."},

"Glorification of Venerable Herman of Alaska, Wonderworker of All America":
{"type": "Santo · séc. XIX", "life": "Nosso venerável pai Germano do Alasca, primeiro dos santos ortodoxos da América do Norte, era um humilde monge do mosteiro de Valaam, na Rússia, que em 1794 se juntou à missão enviada a levar o Evangelho aos povos nativos do Alasca. Fixando-se na ilha de Spruce, que chamou Novo Valaam, viveu como asceta e tornou-se pai e protetor do povo aleúta, defendendo-o das injustiças dos comerciantes russos, ensinando as crianças e cuidando dos enfermos e dos órfãos.", "patron": "Comemora-se no santo calendário da Igreja."},

"Glorification of the Priestmartyr Alexander Hotovitzky":
{"type": "Protopresbítero · séc. XX", "life": "Neste dia a Igreja comemora a glorificação do hieromártir Alexandre Hotovitzky, contado entre os santos pela Igreja Ortodoxa Russa a quatro de dezembro de 1994. Nascido a onze de fevereiro de 1872 em Kremenets, na Volínia, filho de um amado arcipreste e reitor de seminário, Alexandre formou-se com distinção na Academia Teológica de São Petersburgo.", "patron": "Invoca-se sua intercessão pelos sacerdotes de paróquia; pelos missionários."},

"Great Martyr Anastasia the Deliverer from Poisons, her teacher, Martyr Chrysogonos, and many with them":
{"type": "Grande mártir · séc. IV", "life": "A santa grande mártir Anastássia, a que livra dos venenos, era romana de nascimento nobre, filha de pai pagão e de mãe cristã em segredo, Fausta, e foi formada na fé por seu mestre, o sábio confessor Crisógono. Casada contra seu coração com o pagão Públio, guardou a virgindade fingindo-se doente, e, vestindo trajes de mendiga, percorreu com uma só serva as prisões de Roma, alimentando, tratando e resgatando os cativos de Cristo, pois era hábil na arte médica e fez de sua ciência um ministério.", "patron": "Invoca-se sua intercessão pelos enfermeiros; pelos médicos."},

"Great Martyr Euphemia the All-praised":
{"type": "Grande mártir · séc. IV", "life": "A santa grande mártir Eufêmia, a Louvadíssima, era filha de piedosos cristãos de Calcedônia, e padeceu naquela cidade no ano 303, na perseguição de Diocleciano. Quando o procônsul Prisco mandou que todos os habitantes tomassem parte na festa do ídolo Ares, Eufêmia, com outros cristãos que se haviam escondido para adorar o Deus verdadeiro, foi descoberta e levada a julgamento.", "patron": "Invoca-se sua intercessão pela pureza; pela vindicação da Ortodoxia."},

"Great Martyr Irene":
{"type": "Grande mártir · séc. IV", "life": "A santa grande mártir Irene, uma das mais amadas entre as mártires do Oriente, nasceu, dizem as narrativas gregas, na cidade de Magedon, filha de um governante pagão chamado Licínio, e recebeu o nome de Penélope; seu pai, orgulhoso de sua beleza, encerrou-a numa torre com treze companheiras.", "patron": "O nome de Paz ganho através de guerras."},

"Great Martyr Katherine of Alexandria":
{"type": "Grande mártir · séc. IV", "life": "Santa Catarina de Alexandria era uma jovem instruída, de linhagem real, que confessou Cristo durante a perseguição de Maximino. Refutou os filósofos pagãos, converteu muitos e recusou o casamento com o imperador. Depois da prisão e dos tormentos, entre eles a roda quebrada, foi decapitada e recebeu a coroa do martírio no princípio do século IV."},

"Great Martyr Marina (Margaret) of Antioch":
{"type": "Grande mártir · séc. IV", "life": "Santa Marina de Antioquia foi criada em Antioquia da Pisídia e confessou Cristo ainda jovem durante a perseguição de Diocleciano. Recusando o casamento com um funcionário pagão e recusando sacrificar aos ídolos, suportou a prisão e os tormentos. Fortalecida por Cristo, foi por fim decapitada e recebeu a coroa do martírio no princípio do século IV."},

"Great Martyr Mercurius of Caesarea, in Cappadocia":
{"type": "Grande mártir · séc. III", "life": "O santo grande mártir Mercúrio de Cesareia era um jovem soldado de origem cita que servia nos exércitos romanos, filho de um oficial cristão; e quando os bárbaros transpuseram a fronteira nos dias do imperador Décio, um anjo do Senhor apareceu-lhe, pôs-lhe uma espada na mão e prometeu-lhe a vitória, mandando-o lembrar-se do Senhor seu Deus.", "patron": "Invoca-se sua intercessão pelos soldados; pela vitória dada do céu."},

"Great Martyr Theodore the Tyro (Recruit)":
{"type": "Grande mártir · séc. IV", "life": "São Teodoro Tíron era um recruta do exército romano em Amaseia durante a perseguição de Maximiano. Recusando sacrificar aos ídolos, queimou um templo pagão e confessou Cristo diante do governador. Depois da prisão e dos tormentos, foi lançado ao fogo e recebeu a coroa do martírio no princípio do século IV.", "patron": "Invoca-se sua intercessão, por antiga tradição, pela recuperação do que foi roubado."},

"Greatmartyr Artemius at Antioch":
{"type": "Grande mártir · séc. IV", "life": "O santo grande mártir Artêmio de Antioquia foi comandante ilustre sob são Constantino, o Grande, e seu filho Constâncio, honrado pelo valor e pelo serviço e feito vice-rei imperial do Egito, onde muito trabalhou pela propagação da fé; e foi Artêmio quem o imperador enviou a trazer as relíquias do apóstolo André, de Patras, e do apóstolo Lucas, de Tebas da Beócia, para Constantinopla, onde foram depositadas na igreja dos Santos Apóstolos.", "patron": "Invoca-se sua intercessão pelos soldados; pelos funcionários."},

"Greatmartyr Barbara and Martyr Juliana, at Heliopolis in Syria":
{"type": "Grande mártir · séc. IV", "life": "Santa Bárbara viveu em Heliópolis da Síria no reinado de Maximiano. Mantida em reclusão por seu pai pagão, veio a conhecer o Deus verdadeiro e confessou Cristo. Depois dos tormentos, foi decapitada pelo próprio pai. Santa Juliana, que presenciou seu sofrimento e confessou Cristo, também padeceu o martírio no princípio do século IV."},

"Greatmartyr Euphemia the All-praised":
{"type": "Virgem · séc. IV", "life": "Neste dia se comemora o grande milagre obrado por santa Eufêmia, a Louvadíssima, em defesa da fé ortodoxa. Tendo padecido o martírio em Calcedônia sob Diocleciano, foi glorificada de novo um século e meio depois, no ano 451, quando o Quarto Concílio Ecumênico se reuniu na própria igreja onde jaziam suas relíquias, para condenar a heresia dos monofisitas e confessar as duas naturezas de Cristo, a divina e a humana.", "patron": "Invoca-se sua intercessão pela defesa da doutrina ortodoxa."},

"Greatmartyr Eustáthios Placidas, with his wife and children, of Rome":
{"type": "Grande mártir · séc. II", "life": "O santo grande mártir Eustáquio, antes de seu batismo chamado Plácidas, era um general romano de renome sob os imperadores Tito e Trajano, generoso com os pobres ainda sendo pagão; e, caçando um dia, foi-lhe dada uma visão admirável, um veado que se voltou para ele com a Cruz resplandecente de Cristo brilhando entre as hastes, e uma voz que o chamou pelo nome, dizendo, Por que me persegues, Plácidas, eu sou o Cristo a quem sem saber honras com tuas boas obras.", "patron": "Invoca-se sua intercessão pelos soldados; pelos caçadores."},

"Greatmartyr George the New at Sofia, Bulgaria":
{"type": "Grande mártir · séc. XVI", "life": "O santo grande mártir Jorge, o Novo, que padeceu em Sófia, era um jovem cristão eslavo do sul, do tempo do jugo turco, e este dia guarda a memória do levantamento e da deposição de suas santas relíquias, que se seguiram logo a seu martírio.", "patron": "O jovem de dezoito anos firme como um diamante."},

"Greatmartyr James the Persian":
{"type": "Grande mártir · séc. V", "life": "O santo grande mártir Tiago, o Persa, chamado Intercisus, o Cortado em Pedaços, era um nobre cristão da Pérsia, rico, honrado e amado do rei Isdigerdes; e sua alma, presa pela amizade do rei, caiu no grande pecado de sua vida, pois quando o rei se voltou contra os cristãos, Tiago, não querendo perder o favor, negou Cristo com a corte.", "patron": "Invoca-se sua intercessão pelos cortesãos; pela penitência depois da negação."},

"Greatmartyr Niketas the Goth":
{"type": "Grande mártir · séc. IV", "life": "O santo grande mártir Nicetas era godo, nascido e morador às margens do Danúbio, e foi batizado por Teófilo, bispo dos godos, que tomara parte no Primeiro Concílio Ecumênico. Quando a guerra dividiu seu povo e o chefe pagão Atanarico levantou dura perseguição contra os cristãos entre os godos, Nicetas, que por sua pregação e sua vida santa trouxera muitos parentes a Cristo, tornou-se coluna da Igreja perseguida, fortalecendo os fiéis para o martírio e denunciando com ousadia a crueldade e a impiedade do perseguidor.", "patron": "Invoca-se sua intercessão pelos soldados; pelas crianças."},

"Greatmartyr Paraskevi of Iconium":
{"type": "Grande mártir · séc. III", "life": "A santa grande mártir Paraskevi de Icônio viveu no século III, nascida de família rica e devota que tinha em especial reverência a sexta-feira da Paixão do Senhor, e por isso deu à filha o nome de Paraskevi, que quer dizer sexta-feira. Amando a pureza desde a juventude, consagrou sua virgindade a Cristo e, quando seus pais repousaram, deu seus bens aos pobres e entregou-se a iluminar com a luz do Evangelho os pagãos de sua cidade.", "patron": "Invoca-se sua intercessão pelos comerciantes; pelos que vivem do mercado."},

"Greatmartyr Procopius of Caesarea, in Palestine":
{"type": "Procônsul, comandante militar · séc. IV", "life": "O santo grande mártir Procópio, chamado Neânio antes de seu batismo, era natural de Jerusalém e viveu sob o imperador Diocleciano. Criado por sua mãe pagã Teodósia depois da morte de seu pai cristão, recebeu excelente educação, subiu depressa no serviço imperial e foi enviado como procônsul a Alexandria para perseguir os cristãos.", "patron": "Invoca-se sua intercessão pelos soldados; pela conversão."},

"Greatmartyr and Healer Panteleimon":
{"type": "Grande mártir · início do séc. IV", "life": "Jovem médico de Nicomédia, convertido a Cristo e instruído pelo sacerdote Hermólao. Curava os enfermos de graça em nome de Cristo, mesmo os que os médicos pagãos não podiam curar, e deu seus bens aos pobres. Denunciado sob Maximiano, suportou muitos tormentos sem dano antes de ser decapitado. É contado entre os santos anárgiros.", "patron": "Padroeiro dos médicos e dos enfermos; invoca-se sua intercessão pela cura do corpo e da alma."},

"Greatmartyr, Victory-bearer, and Wonderworker George":
{"type": "Grande mártir · séc. IV", "life": "São Jorge era um soldado capadócio que servia no exército romano sob Diocleciano. Quando surgiu a perseguição, confessou Cristo abertamente, distribuiu seus bens e recusou adorar os ídolos. Suportou muitos tormentos e foi decapitado em Nicomédia por volta de 303, tornando-se célebre como portador da vitória e taumaturgo."},

"Heiromartyr Theokteristus":
{"type": "Igumeno, confessor e mártir · séc. IX", "life": "Nosso venerável pai Teoctérito, chamado também Teostérito, igumeno do mosteiro de Peleceta perto de Prusa, esteve no centro de uma das mais sombrias atrocidades da perseguição iconoclasta e deu à Igreja, daquela escuridão, uma de suas orações mais amadas. Nascido em Tríglia da Bitínia, fez-se monge na juventude no mosteiro de São João.", "patron": "Invoca-se sua intercessão pelos igumenos; pelos hinógrafos."},

"Hieromartyr Alexander of Sίdē, in Pamphylia":
{"type": "Hieromártir · séc. III", "life": "O santo hieromártir Alexandre era sacerdote da cidade de Side, na Panfília, na costa meridional da Ásia Menor, e padeceu no reinado do imperador Aureliano, no último espasmo de perseguição do século III antes da grande tormenta de Diocleciano. Levado diante do governador Antonino, foi-lhe perguntado o nome e o ofício, e respondeu com a confissão que tornou inevitável o resto, que era cristão e pastor do rebanho de Cristo.", "patron": "Invoca-se sua intercessão pelos sacerdotes diante dos tribunais; pela resposta ousada sob Aureliano."},

"Hieromartyr Alexander, Bishop of Adrianopolis, and the Martyrs Heraclius, Anna, Elizabeth, Theodota, and Glyceria":
{"type": "Mártires · séc. III", "life": "Os santos mártires Alexandre, o bispo, Heráclio, o soldado, e as mulheres Ana, Isabel, Teódota e Glicéria padeceram em Adrianópolis da Trácia na era das perseguições. Alexandre, bispo daquela cidade, proclamou o Evangelho com ousadia e recusou oferecer sacrifício aos ídolos, pelo que foi submetido a prolongados e cruéis tormentos.", "patron": "Invoca-se sua intercessão pela conversão pelo testemunho dos mártires."},

"Hieromartyr Alexander, Bishop of Comana":
{"type": "Bispo · séc. III", "life": "Santo Alexandre viveu no século III perto de Neocesareia, homem versado nas Escrituras e em muitas ciências, que todavia tomou sobre si o combate escondido da loucura por Cristo, vivendo na pobreza e vendendo carvão na praça da cidade. Seu rosto estava sempre enegrecido pelo pó do carvão, e muitos o olhavam com desprezo, sem conhecer sua sabedoria nem sua santidade.", "patron": "Invoca-se sua intercessão pela humildade; pela sabedoria escondida."},

"Hieromartyr Alexander, Bishop of Jerusalem":
{"type": "Bispo · séc. III", "life": "O santo hieromártir Alexandre, bispo de Jerusalém, formou-se na escola catequética de Alexandria sob Clemente, condiscípulo e amigo de toda a vida de Orígenes, e tornou-se bispo de uma cidade da Capadócia, onde a perseguição de Sétimo Severo o pôs em cadeias por anos, confessor antes de ser hierarca.", "patron": "Invoca-se sua intercessão pelos bibliotecários; pelos estudiosos."},

"Hieromartyr Antherus (Antheros) Pope of Rome":
{"type": "Bispo · séc. III", "life": "Santo Ântero, grego de nascimento, foi escolhido bispo de Roma para suceder a são Ponciano, mas ocupou a sé por pouco tempo, pois logo confessou Cristo e sofreu a morte pela fé no ano 236. Foi depositado na catacumba de São Calisto, o primeiro dos bispos de Roma a ser sepultado naquele lugar consagrado, e depois dele foi escolhido são Fabiano para apascentar a Igreja de Roma.", "patron": "Comemora-se no santo calendário da Igreja."},

"Hieromartyr Anthimus, Bishop of Nicomedia and those with him":
{"type": "Bispo · séc. IV", "life": "O santo hieromártir Ântimo, bispo de Nicomédia, nasceu naquela cidade e foi criado desde a infância na fé cristã, e, sendo humilde, pacífico e cheio de zelo pela glória de Deus, foi com o tempo feito bispo de Nicomédia. Apascentou ali a Igreja durante a dura perseguição de Diocleciano e Maximiano, quando o sangue dos cristãos corria pela cidade.", "patron": "Invoca-se sua intercessão pela confissão firme; pelo pastoreio fiel na perseguição."},

"Hieromartyr Antipas, Bishop of Pergamum and Disciple of Saint John the Theologian":
{"type": "Hieromártir · séc. I", "life": "O santo hieromártir Ântipas, bispo de Pérgamo, tem uma distinção que nenhum outro mártir da Igreja partilha, a de ter seu testemunho certificado nas Escrituras pela voz do próprio Cristo; pois no Apocalipse, na carta à igreja de Pérgamo, o Senhor diz, Sei onde habitas, onde está o trono de Satanás, e reténs o meu nome e não negaste a minha fé, mesmo nos dias em que Ântipas, minha fiel testemunha, foi morto entre vós, onde Satanás habita.", "patron": "Invoca-se sua intercessão pelos bispos da plantação apostólica; pelos que sofrem dos dentes."},

"Hieromartyr Apollinaris, Bishop of Ravenna":
{"type": "Bispo · séc. I", "life": "O santo hieromártir Apolinário foi discípulo do apóstolo Pedro, a quem seguiu de Antioquia a Roma, e Pedro o sagrou primeiro bispo de Ravena e o enviou para ali pregar o Evangelho. Chegando como forasteiro, foi acolhido pelo soldado Irineu, cujo filho cego curou, e assim Irineu e toda a sua casa se tornaram os primeiros cristãos de Ravena.", "patron": "Invoca-se sua intercessão pela iluminação missionária; pela cura."},

"Hieromartyr Artemon of Laodikeia":
{"type": "Hieromártir · séc. IV", "life": "O santo hieromártir Artêmon, presbítero de Laodiceia da Síria, deu à Igreja uma vida inteira antes de lhe dar seu sangue: nascido de pais cristãos, serviu como leitor dezesseis anos, como diácono vinte e oito e como sacerdote trinta e três, setenta e sete anos nas ordens ascendentes do santuário, de sorte que, quando irrompeu a perseguição de Diocleciano, o homem que ela achou em Laodiceia era um ancião a quem três gerações tinham ouvido ler, servir e oferecer.", "patron": "Invoca-se sua intercessão pelos leitores, diáconos e sacerdotes; pelos que servem por longos anos."},

"Hieromartyr Athanasios, Venerable Anthousa, and others":
{"type": "Bispo · séc. III", "life": "Santo Atanásio, bispo de Tarso da Cilícia, e os que estavam com ele padeceram por Cristo no século III. Santa Antusa, donzela de Selêucia da Síria e filha de pais pagãos ricos, ouvira falar da fé cristã e desejava ser instruída pelo bispo Atanásio, e assim, levando consigo dois servos, Carísimo e Neófito, veio a Tarso sob pretexto de outra viagem.", "patron": "Invoca-se sua intercessão pela conversão; pela confissão firme."},

"Hieromartyr Athenogenes, Bishop of Heracleopolis, and his ten disciples":
{"type": "Bispo · séc. IV", "life": "O santo hieromártir Atenógenes, bispo de Heracleópolis, padeceu junto com seus dez discípulos durante a perseguição de Diocleciano na cidade de Sebaste da Capadócia. Quando o governador Filômaco celebrou uma grande festa aos ídolos e mandou que o povo sacrificasse, os cidadãos de Sebaste, em sua maioria cristãos, recusaram, e muitos receberam a coroa do martírio sob as espadas dos soldados.", "patron": "Invoca-se sua intercessão pelo pastoreio fiel."},

"Hieromartyr Autonomus, Bishop in Italy":
{"type": "Bispo · séc. IV", "life": "O santo hieromártir Autônomo era bispo na Itália nos dias da perseguição de Diocleciano, e, retirando-se diante da tormenta, veio a Soreos na Bitínia, onde foi acolhido por um homem piedoso chamado Cornélio e, longe de descansar em segurança, entregou-se a pregar sem descanso, convertendo tão grande multidão de pagãos que ordenou Cornélio diácono e depois bispo do rebanho que reunira.", "patron": "Invoca-se sua intercessão pelos missionários; pela pregação missionária."},

"Hieromartyr Babylas, Bishop of Antioch, and those with him":
{"type": "Bispo · séc. III", "life": "O santo hieromártir Bábilas, bispo de Antioquia, padeceu sob o imperador Décio junto com os três meninos irmãos Urbano, Prilidiano e Epolônio e sua mãe Cristódula. Quando o imperador, durante uma festa pagã na cidade, quis por curiosidade entrar na igreja onde o santo bispo servia a Divina Liturgia, Bábilas saiu e lhe barrou o caminho, recusando deixar o ímpio governante entrar no templo de Deus.", "patron": "Invoca-se sua intercessão pela ousadia diante dos governantes; pela confissão firme."},

"Hieromartyr Basil of Ancyra":
{"type": "Hieromártir · séc. IV", "life": "O santo hieromártir Basílio, sacerdote de Ancira da Galácia, foi o guardião do rebanho daquela cidade através de duas tormentas seguidas, a ariana e a pagã, e caiu na segunda. Nos anos em que os arianos tinham o poder e as igrejas da Galácia andavam perturbadas, o presbítero Basílio trabalhou sem descanso pela fé de Niceia, fortalecendo os vacilantes, denunciando abertamente a heresia e conservando o povo de Ancira na confissão verdadeira, ainda que isso lhe custasse perseguição e suspensão às mãos dos arianos.", "patron": "Invoca-se sua intercessão pelos sacerdotes de paróquia; pelos que defendem o rebanho da heresia e da apostasia."},

"Hieromartyr Basil, Bishop of Amasea":
{"type": "Hieromártir · séc. IV", "life": "O santo hieromártir Basílio, bispo de Amaseia do Ponto, ganhou sua coroa na última hora da perseguição, sob Licínio, quando o coimperador do Oriente, rompendo suas promessas de tolerância, voltou-se de novo contra os cristãos por ciúme de Constantino; e o combate de Basílio nasceu de um ato de abrigo.", "patron": "Invoca-se sua intercessão pelos bispos que abrigam os perseguidos; pelos que protegem as mulheres em perigo."},

"Hieromartyr Clement, Pope of Rome":
{"type": "Patriarca · séc. II", "life": "O santo hieromártir Clemente, bispo de Roma, nasceu em Roma de família rica e ilustre, aparentada com os imperadores, e por estranha providência foi separado na infância de seus pais e irmãos, criado entre estranhos com todas as vantagens do estudo, mas com o coração ansioso de um órfão.", "patron": "Invoca-se sua intercessão pelos canteiros; pelos exilados."},

"Hieromartyr Cornelius the Centurion":
{"type": "Bispo · séc. I", "life": "O santo hieromártir Cornélio, o Centurião, primícias dos gentios, era um oficial romano da coorte itálica aquartelada em Cesareia da Palestina, homem devoto que temia a Deus com toda a sua casa, dava esmolas com largueza e orava sempre, como testemunham os Atos dos Apóstolos. A ele apareceu um anjo, dizendo-lhe que suas orações e esmolas haviam subido como memorial diante de Deus, e mandando-o chamar Simão Pedro.", "patron": "Invoca-se sua intercessão pelos soldados; pelos convertidos."},
...
{"type": "Mártires · séc. IX", "life": "Os santos mártires André, João e os filhos de João, Pedro e Antonino, eram naturais de Siracusa, na Sicília, levados cativos para a África no século IX, quando os sarracenos assolaram a ilha. Os dois meninos, tomados pequenos, foram criados na corte do emir e instruídos no saber e na religião de seus captores, sendo por fora contados entre os muçulmanos.", "patron": "Invoca-se sua intercessão pelos cativos; pela fé guardada em terra estranha."},

"Martyrs Anicetus and Photius of Nicomedia, and those with them":
{"type": "Leigos · séc. IV", "life": "Os santos mártires Aniceto e Fócio, um tio e seu sobrinho, eram naturais de Nicomédia. Quando o imperador Diocleciano mandou levantar na praça pública um engenho de execução para aterrorizar os cristãos, Aniceto, funcionário da corte, denunciou-o abertamente, e o imperador enfurecido entregou-o ao tormento.", "patron": "Invoca-se sua intercessão pela confissão firme."},

"Martyrs Anthony, John, and Eustathius of Vilnius":
{"type": "Mártires · séc. XIV", "life": "Os santos mártires Antônio, João e Eustáquio de Vilnius eram jovens cortesãos de Algirdas, grão-duque da Lituânia pagã, a última grande potência não batizada da Europa, e traziam antes do batismo os nomes de Kumets, Nejilo e Kruglets; instruídos e batizados em segredo por um sacerdote chamado Nestor, os irmãos Antônio e João se traíram à própria mesa do príncipe, pois não comiam carne nos dias de jejum, e a corte adoradora do fogo leu corretamente a abstinência, descoberto todo o conflito de duas religiões num prato recusado.", "patron": "Invoca-se sua intercessão pelos cortesãos de potências pagãs; pelos irmãos na confissão."},

"Martyrs Basil and Theodore of the Kyiv Caves":
{"type": "Monge · séc. XI", "life": "Os veneráveis mártires Basílio e Teodoro lutaram como ascetas no século XI nas Cavernas Próximas de Kyiv. São Teodoro havia distribuído sua riqueza aos pobres e entrado no mosteiro, fixando-se na Caverna dos Varegues, mas depois de muitos anos o inimigo o tentou com o pensamento de um tesouro de ouro e prata que ali se dizia escondido, buscando afastá-lo de seus votos monásticos.", "patron": "Invoca-se sua intercessão pelo desapego das riquezas; contra a avareza."},

"Martyrs Basilissa and Anastasia of Rome, disciples of Apostles Peter and Paul":
{"type": "Mártires · séc. I", "life": "As santas mártires Basilissa e Anastássia eram nobres de Roma, convertidas pela pregação dos apóstolos maiores e contadas entre os discípulos do próprio Pedro e do próprio Paulo, formadas na nascente, nos anos em que a primeira igreja da capital se reunia em casas e a fé passava dos lábios dos Apóstolos.", "patron": "Invoca-se sua intercessão pelos que sepultam os mártires; pelos discípulos dos apóstolos."},

"Martyrs Carpus, Papylus, Agathadorus, and Agathonica, at Pergamum":
{"type": "Mártires · séc. III", "life": "Os santos mártires Carpo, Papilo, Agatodoro e Agatônica padeceram em Pérgamo na perseguição de Décio, no ano 251. Carpo era bispo de Tiatira e Papilo seu diácono, homem que dera sua riqueza aos pobres; e, quando o governador da região soube que não guardavam as festas pagãs, mandou levá-los a julgamento, e, achando-os inabaláveis na confissão de Cristo, submeteu-os a tormentos: foram arrastados atrás de cavalos, rasgados e entregues às feras, que não os quiseram tocar.", "patron": "Invoca-se sua intercessão pela confissão firme; pela cura."},

"Martyrs Christopher, Theonas, and Anthony, at Rome":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Cristóvão, Teonas e Antônio eram lanceiros do imperador Diocleciano, soldados da guarda mais próxima, e sua conversão veio pelo preço mais alto que a corte podia presenciar: vendo os sofrimentos do santo grande mártir Jorge, o jovem tribuno atormentado diante do trono com todos os artifícios e sustentado por um poder que todo o palácio podia ver, os três guardas tiraram a conclusão de soldados, que a vitória estava do lado do prisioneiro.", "patron": "Invoca-se sua intercessão pelas guardas imperiais; pelos que, estando perto do poder, escolhem Cristo."},

"Martyrs Chrysanthus and Daria, and those with them at Rome":
{"type": "Mártires · séc. III", "life": "Os santos mártires Crisanto e Dária padeceram em Roma no ano 283 pelas contas romana e grega, ainda que os livros que os põem sob Valeriano deem por volta do ano 253, e seu combate reuniu toda uma colheita de companheiros antes de encerrar-se. Crisanto, filho do senador Polêmio, veio com o pai de Alexandria a Roma, e no curso de seus estudos encontrou as Escrituras, e pela instrução do presbítero Carpóforo foi batizado, e começou logo a confessar Cristo.", "patron": "Invoca-se sua intercessão pelos casais que fazem voto de pureza; pelos convertidos por convertidos."},

"Martyrs Dada, Maximus, and Quinctilian, at Dorostolum":
{"type": "Mártires · séc. III", "life": "Os santos mártires Dada, Máximo e Quintiliano padeceram na aldeia de Ozóvia, perto de Doróstolo, sobre o Danúbio, no ano 286, na perseguição do reinado de Diocleciano, mais três nomes na rica coroa de mártires daquela terra de fronteira, cujas guarnições e aldeias alimentaram por uma geração o calendário da Igreja.", "patron": "Invoca-se sua intercessão pelos aldeões que confessam; pelos assaltados de noite."},

"Martyrs Dadas, Gabdelas, and Kazdoa of Persia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Dadas, Gabdelas e Kazdoa padeceram por Cristo na Pérsia sob o rei Sapor. Dadas, parente do rei e mordomo-mor de sua corte, foi descoberto como cristão e despojado de suas honras, e entregue ao tormento; mas, quando o fogo preparado para ele foi desviado por sua oração e prodígios se obraram diante de todos, o próprio filho do rei, Gabdelas, e sua filha Kazdoa, vendo o poder de Cristo, creram no Deus do homem que haviam sido mandados condenar.", "patron": "Invoca-se sua intercessão pelos convertidos da casa dos perseguidores."},

"Martyrs Demetrius, his wife Euanthia, and their son Demetrian, at Skepsis on the Hellespont":
{"type": "Mártires · séc. I", "life": "Os santos mártires Demétrio, sua mulher Evântia e seu filho Demetriano padeceram por Cristo no primeiro século na cidade de Cépsis, sobre o Helesponto. Demétrio era governante daquela cidade, e, segundo a tradição da Igreja, foi trazido à fé pela pregação e pelos prodígios do hieromártir Cornélio, o Centurião, o mesmo que o apóstolo Pedro batizara, quando Cornélio veio a Cépsis anunciando Cristo.", "patron": "Invoca-se sua intercessão pelas famílias cristãs; pela confissão firme."},

"Martyrs Diodorus and Rhodopianus, Deacons, at Aphrodisia in Anatolia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Diodoro e Rodopiano, diáconos, padeceram em Afrodísia da Cária na perseguição de Diocleciano, entre os anos 284 e 305, e seu combate traz a marca de sua cidade.", "patron": "Invoca-se sua intercessão pelos diáconos; pelos mortos pelas mãos de seus vizinhos."},

"Martyrs Elias, Probus, and Ares in Cilicia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Elias, Probo e Ares eram egípcios de nascimento, e seu crime foi a misericórdia: na perseguição de Maximiano partiram do Egito para a Cilícia, sem cuidar da própria segurança, a fim de servir aos confessores de Cristo ali presos e condenados às minas, levando consolo aos que o império havia lançado fora.", "patron": "Invoca-se sua intercessão pelos que visitam os presos; pelos que servem aos perseguidos."},

"Martyrs Elpidius, Marcellus, and Eustochius, who suffered under Julian the Apostate":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Elpídio, Marcelo e Eustóquio padeceram sob Juliano, o Apóstata, nos anos de 361 a 363, quando o império, tendo provado a paz da Igreja, foi arrastado de volta por seu governante para o culto dos ídolos. Elpídio era senador, homem de alta dignidade, e foi levado com seus companheiros diante do juiz imperial sob a acusação de ser cristão.", "patron": "Invoca-se sua intercessão pelos senadores; pelos funcionários."},

"Martyrs Eudoxios, Agapios, Atticus, and those with them, at Sebaste":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Ático, Agápio, Eudóxio, Cartério, Istucário chamado Estírax, Pactóbio e Nictopólion, com seus companheiros, eram soldados de Sebaste da Armênia, e padeceram por volta do ano 320 na perseguição de Licínio, que, preparando guerra contra são Constantino, expurgou seus exércitos dos cristãos e exigiu das guarnições sacrifício aos ídolos.", "patron": "Invoca-se sua intercessão pelos soldados; pelos soldados fiéis a Cristo."},

"Martyrs Eudoxius, Zeno, and Macarius":
{"type": "Comandante · séc. IV", "life": "Os santos mártires Eudóxio, Zenão e Macário padeceram sob Maximiano Galério, sucessor de Diocleciano. Eudóxio era comandante de alta patente nos exércitos imperiais e cristão, como o eram seu amigo Zenão e seu mordomo Macário; e, quando saiu o decreto contra os fiéis, retirou-se com a família, mas foi procurado por soldados que, não o conhecendo, receberam sua hospitalidade.", "patron": "Invoca-se sua intercessão pelos soldados."},

"Martyrs Eulampius and Eulampia, at Nicomedia, and 200 Martyrs with them":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Eulâmpio e Eulâmpia, irmão e irmã, viviam em Nicomédia no princípio do século IV. Quando o decreto do imperador Maximiano que condenava à morte todos os cristãos foi afixado na cidade, o jovem Eulâmpio o leu e lamentou em voz alta que o imperador pegasse em armas contra seus próprios súditos inocentes em vez de contra os inimigos do império.", "patron": "Invoca-se sua intercessão pelos irmãos e irmãs em Cristo; pela ousadia diante dos ídolos."},

"Martyrs Eustochius, Gaius, Probus, Lollius, and Urban, of Ancyra":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Eustóquio, Gaio, Probo, Lólio e Urbano padeceram por Cristo em Ancira da Galácia na era das perseguições, e sua companhia foi ganha para Cristo pela própria constância dos mártires a quem antes se opunham.", "patron": "Invoca-se sua intercessão pelos convertidos do paganismo; pelos parentes que confessam juntos."},

"Martyrs Eustratius, Auxentius, Eugene, Mardarius, and Orestes, at Sebaste":
{"type": "Mártires · séc. III", "life": "Os santos mártires Eustrácio, Auxêncio, Eugênio, Mardário e Orestes, os Cinco Companheiros, brilharam como cinco estrelas sobre a Armênia na perseguição de Diocleciano e Maximiano, por volta do ano 296, e seu combate é uma corrente de confissões livres, adiantando-se cada um sem ser forçado. Auxêncio, sacerdote de Arauraka, foi preso primeiro pelos governadores Lísias e Agrícolau.", "patron": "Invoca-se sua intercessão pelos soldados; pelos arquivistas."},

"Martyrs Eutropius, Cleonicus, and Basiliscus of Amasea":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Eutrópio, Cleônico e Basilisco padeceram em Amaseia do Ponto por volta do ano 308, e seu combate é a continuação de um combate famoso, pois os três eram companheiros do grande mártir Teodoro Tíron, sendo Basilisco seu parente de sangue e os três seus parentes de armas, presos na mesma perseguição que coroara Teodoro dois anos antes e guardados na mesma prisão, onde a memória da vitória do recruta era o ar que os três respiravam.", "patron": "Invoca-se sua intercessão pelos parentes e companheiros na provação; pelos soldados de Cristo."},

"Martyrs Florus and Laurus of Illyria":
{"type": "Mártires · séc. II", "life": "Os santos mártires Floro e Lauro eram irmãos gêmeos, aparentados não só na carne, mas no espírito, que viveram no século II e se fixaram na Ilíria, onde trabalhavam como canteiros; de seus mestres cristãos, Proclo e Máximo, haviam aprendido tanto o ofício quanto o modo de vida agradável a Deus.", "patron": "Invoca-se sua intercessão pelos canteiros; pelos cavalos e pelos cavaleiros."},

"Martyrs Frontasius, Severinus, Severian, and Silanus, of Gaul":
{"type": "Mártires · séc. I", "life": "Os santos mártires Frontásio, Severino, Severiano e Silano são honrados entre os primeiros pregadores do Evangelho e os primeiros mártires da Gália, tidos pela tradição de sua região por pertencentes à primeira geração da missão da Igreja nas terras do ocidente.", "patron": "Invoca-se sua intercessão pelos primeiros iluminadores da Gália; pelos discípulos dos missionários apostólicos."},

"Martyrs Galacteon, Juliana, and Saturninus, of Constantinople":
{"type": "Mártires · séc. III", "life": "Os santos mártires Galacteão, Juliana e Saturnino padeceram por Cristo em Bizâncio na era das perseguições, ainda que os pormenores de sua paixão não se tenham conservado por inteiro.", "patron": "Invoca-se sua intercessão pelos que padecem o martírio juntos; pelos firmes na confissão."},

"Martyrs Galaction and his wife, Epistemis, at Emesa":
{"type": "Mártires · séc. III", "life": "Os santos mártires Galactião e sua mulher Epistémis padeceram em Emesa da Síria no ano 253, sob a perseguição de Décio. Galactião nasceu da nobre Leucipe, muito tempo estéril, que fora trazida a Cristo e batizada por um monge chamado Onofre, e que criou o filho em segredo na fé.", "patron": "Invoca-se sua intercessão pelos casais; pelos monges."},

"Martyrs Gervasius, Nazarius, Protasius, and Celsus of Milan":
{"type": "Mártires · séc. I", "life": "Os santos mártires Nazário, Gervásio, Protásio e Celso de Milão padeceram no reinado do imperador Nero. Nazário, nascido em Roma da cristã Perpétua e batizado, como relata a tradição, por Lino, sucessor de Pedro, deu sua juventude à pregação de Cristo e ao cuidado dos cristãos perseguidos, e, chegando a Milão, achou ali na prisão os irmãos gêmeos Gervásio e Protásio, filhos do mártir Vitálio e de Valéria, que haviam dado sua herança aos pobres e a vida ao jejum e à oração.", "patron": "Invoca-se sua intercessão pelo cuidado com os cristãos presos; pela criação dos filhos para Deus."},

"Martyrs Heliodorus and Dosa of Persia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Heliodoro e Dosa padeceram por Cristo na Pérsia no ano 380, durante a longa perseguição dos cristãos sob o rei Sapor. Ainda que pouco de seu combate se tenha conservado, sabe-se que confessaram a fé e suportaram a morte antes que negar seu Senhor ou adorar o fogo e o sol como faziam os persas.", "patron": "Invoca-se sua intercessão pela confissão firme."},

"Martyrs Heraclius, Paulinus, and Benedimus":
{"type": "Mártir · séc. IV", "life": "Os santos mártires Heráclio, Paulino e Benedimo padeceram em Noviduno, na Cítia Menor, a praça-forte do baixo Danúbio na terra que hoje é a Romênia, e estão unidos no calendário deste dia aos mártires Pedro e Dionísio.", "patron": "A fé confessada na borda setentrional do império."},

"Martyrs Hermes, Serapion, and Polyaenus of Rome":
{"type": "Mártires · séc. II", "life": "Os santos mártires Hermes, Serapião e Poliêno eram cidadãos de Roma no século II, zelosos em espalhar a fé de Cristo e em refutar os argumentos dos pagãos. Presos e levados diante das autoridades, mantiveram-se firmes na confissão de sua fé e não quiseram oferecer sacrifício aos ídolos, e por isso foram cruelmente espancados e lançados numa prisão escura e imunda, onde suportaram a fome e toda dureza sem vacilar.", "patron": "Invoca-se sua intercessão pela confissão firme."},

"Martyrs Inna, Pinna, and Rimma, disciples of Apostle Andrew in Scythia":
{"type": "Mártires · séc. II", "life": "Os santos mártires Ina, Pina e Rima foram das primícias do Evangelho nas terras do norte junto ao Mar Negro e ao Danúbio, discípulos do santo apóstolo André, o Primeiro-Chamado.", "patron": "Invoca-se sua intercessão pelos discípulos dos apóstolos; pelos iluminadores das terras do norte."},

"Martyrs Isaac, Apollos, and Quadratus, of Nicomedia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Isaac, Apolo e Quadrato eram servidores da casa imperial em Nicomédia, e suas coroas completam a assombrosa colheita que o combate do grande mártir Jorge recolheu dentro do próprio palácio.", "patron": "Invoca-se sua intercessão pelos servos dos grandes; pelos que confessam depois da rainha."},

"Martyrs Isidore and Myrope of Chios":
{"type": "Mártir · séc. III", "life": "O santo mártir Isidoro de Quios, natural de Alexandria do Egito, padeceu na ilha de Quios sob o imperador Décio, por volta do ano 251, e sua paixão juntou a confissão de um soldado à fidelidade de uma mulher.", "patron": "Cristo confessado diante do almirante."},

"Martyrs James (Jacob) the Presbyter, and Azadanes and Abdicius, Deacons, of Persia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Tiago, o presbítero, e os diáconos Azadanes e Abdieso padeceram na Pérsia sob o rei Sapor II, por volta do ano 380, nos últimos anos da guerra de quarenta anos daquele reinado contra a Igreja; foram presos junto com seu bispo, o santo Acepsimas, que a Igreja comemora em novembro, colhendo os perseguidores numa só prisão as três ordens do santuário, bispo, presbítero e diáconos, todo um clero tomado de uma vez.", "patron": "Invoca-se sua intercessão pelos sacerdotes e diáconos na perseguição; pelos que morrem de fome e de frio."},

"Martyrs Julian the Presbyter and Caesarius the Deacon at Terracina":
{"type": "Mártires · séc. I", "life": "Os santos mártires Julião, o presbítero, e Cesário, o diácono, padeceram por Cristo em Terracina, na Itália, na primeira idade da Igreja. Cesário, diácono vindo da África, viu naquela cidade o cruel costume pagão pelo qual um jovem, mimado por meses às custas da cidade, se lançava de uma altura em sacrifício aos ídolos.", "patron": "Invoca-se sua intercessão pelo protesto contra a crueldade; pela confissão firme."},

"Martyrs Kyriaina and Juliana in Cilicia":
{"type": "Mártires · séc. IV", "life": "As santas mártires Kiriena e Juliana padeceram na Cilícia na perseguição de Maximiano, por volta do ano 305. Kiriena era de Tarso e Juliana da cidade de Rossos, ambas mulheres que haviam dado sua vida a Cristo na pureza e na oração; e, presas por Marciano, governador da Cilícia, recusaram toda exigência de oferecer sacrifício aos ídolos.", "patron": "Invoca-se sua intercessão pela dignidade sob o escárnio; pelas mulheres fiéis até a morte."},

"Martyrs Kyriake, Kaleria, and Mary of Caesarea, in Palestine":
{"type": "Mártires · séc. IV", "life": "As santas mulheres mártires Kiriaki, Caléria, chamada também Valéria, e Maria padeceram por Cristo em Cesareia da Palestina na perseguição de Diocleciano, e sua história breve e bela é de conversão, de oração e de confissão firme.", "patron": "Invoca-se sua intercessão pelas mulheres que deixam o paganismo por Cristo; pelos que oram pelo fim da perseguição."},

"Martyrs Leonidas, Chariessa, Nice, Galina, Kalista, Nunechia, Basilissa, Theodora, and Irene, of Corinth":
{"type": "Mártires · séc. III", "life": "O santo mártir Leônidas e as oito santas mulheres que com ele padeceram, Cariessa, Nice, Galina, Calista, Nunéquia, Basilissa, Teodora e Irene, eram cristãos de Corinto, presos na perseguição do ano 258, no tempo pascal, presos os confessores de Cristo ressuscitado nas semanas mesmas em que a Igreja canta sua vitória sobre a morte.", "patron": "Invoca-se sua intercessão pelas companhias de mulheres confessoras; pelos cantores."},

"Martyrs Leontius, Hypatius, and Theodulus at Tripoli in Syria":
{"type": "Mártires · séc. I", "life": "Os santos mártires Leôncio, Hipácio e Teódulo padeceram por Cristo em Trípoli da Fenícia na primeira idade da Igreja, e seu martírio é a história de um perseguidor tornado companheiro de confissão.", "patron": "Invoca-se sua intercessão pelos soldados e comandantes; pelos convertidos enquanto perseguiam."},

"Martyrs Manuel and Theodosius":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Manuel e Teodósio padeceram no ano 304, no auge da grande perseguição, e pertencem àquela companhia de testemunhas que a morte de outros recrutou: vendo a constância dos mártires de sua região, os tormentos suportados com alegria e as coroas recebidas diante das multidões, os dois jovens não se assustaram, como os perseguidores queriam que todos os espectadores se assustassem, mas se acenderam, obrando o espetáculo da arena exatamente ao contrário, como obrou por toda aquela idade, e fazendo convertidos de sua plateia.", "patron": "Invoca-se sua intercessão pelos movidos pelo exemplo dos mártires; pela confissão oferecida sem ser exigida."},

"Martyrs Manuel, Sabel, and Ismael, of Persia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Manuel, Sabel e Ismael eram três irmãos de nobre nascimento persa que padeceram por Cristo na corte de Juliano, o Apóstata, no século IV, e seu martírio transformou uma embaixada de paz num testemunho de fé.", "patron": "Invoca-se sua intercessão pelos enviados e embaixadores; pelos irmãos na fé."},

"Martyrs Marcian and Martyrius, the Notaries of Constantinople":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Marciano e Martírio serviam como notários, isto é, secretários e leitores, de são Paulo, o Confessor, patriarca de Constantinopla, nos anos em que a heresia ariana, sustentada pela corte imperial, se enfurecia contra os defensores da fé de Niceia. Quando o santo patriarca foi banido e estrangulado em segredo no exílio, os arianos procuraram ganhar seus fiéis notários, oferecendo-lhes ouro, honras e até tronos episcopais se abraçassem a heresia que fazia do Filho de Deus uma criatura.", "patron": "Invoca-se sua intercessão pelos notários; pelos secretários."},

"Martyrs Maurice and his son, Photinus, and Martyrs Theodore, Philip, and 70 soldiers, at Apamea in Syria":
{"type": "Mártires · séc. IV", "life": "O santo mártir Maurício, comandante militar de Apameia da Síria, padeceu no ano 305 sob Maximiano Galério, junto com seu filho Fotino e os setenta soldados de seu comando, dos quais só dois nomes, Teodoro e Filipe, chegaram até nós, ficando os demais escritos, como dizem os padres de tais companhias, somente no Livro da Vida.", "patron": "Invoca-se sua intercessão pelos comandantes; pelos pais e filhos que servem juntos nas armas."},

"Martyrs Maximus, Theodotus, Hesychius, and Asclepiodota, of Adrianopolis":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Máximo, Teódoto, Hesíquio e Asclepiodota padeceram na Trácia na perseguição de Maximiano, por volta do ano 305, três homens de Adrianópolis e com eles Asclepiodota, mulher de família nobre cuja coragem deu o tom de todo o combate da companhia. Denunciados como cristãos nos anos em que os éditos imperiais esvaziavam as igrejas, não recuaram diante do tribunal.", "patron": "Invoca-se sua intercessão pelos companheiros na provação; pelas mulheres nobres de coragem."},

"Martyrs Menas, Hermogenes, and Eugraphus, of Alexandria":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Menas, Hermógenes e Eugrafo padeceram em Alexandria por volta do ano 313, sob o imperador Maximiano, e seu combate é uma corrente de conversões forjada no tormento. Menas, ateniense famoso pela eloquência, a quem os gregos chamam Kallikelados, o de doce fala, foi enviado pelo imperador a Alexandria para apaziguar a contenda entre pagãos e cristãos.", "patron": "Invoca-se sua intercessão pelos oradores; pelos juízes."},

"Martyrs Menodora, Metrodora, and Nymphodora, at Nicomedia":
{"type": "Mártires · séc. IV", "life": "As santas virgens mártires Menodora, Metrodora e Ninfodora eram irmãs da Bitínia, na Ásia Menor, que, desejando guardar a virgindade para Cristo e fugir da vaidade do mundo, se retiraram para um lugar solitário nos montes, onde viveram em jejum e oração; e a fama de sua santidade se espalhou, pois começaram a correr curas por suas orações.", "patron": "Invoca-se sua intercessão pelo amor entre irmãs; pela pureza."},

"Martyrs Modestus, Crescentia, and Vitus, at Lucania":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Vito, Modesto e Crescência padeceram por Cristo na perseguição de Diocleciano, e sua companhia juntou um menino ao aio e à ama que o haviam criado na fé e com ele morreram.", "patron": "Invoca-se sua intercessão pelas crianças e por quem as guarda; pelos aios e pelas amas."},

"Martyrs Nestor, Tribimius, and those with them":
{"type": "Mártires · séc. III", "life": "Os santos mártires Nestor, Tribímio, Marcelo e Antônio, de Perge, na Panfília, padeceram no reinado do imperador Décio, por volta do ano 250, na perseguição que exigia de toda alma do império um certificado de sacrifício e fazia de toda recusa um caso capital. Os quatro eram cristãos de Perge que não esperaram ser procurados.", "patron": "Invoca-se sua intercessão pelos companheiros na confissão; pelas quatro coroas ganhas pela espada."},

"Martyrs Nikephoros, Antoninus, and Germanus of Caesarea, in Palestine":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Antonino, Nicéforo e Germano padeceram em Cesareia da Palestina por volta do ano 308, no reinado de Maximino, quando o governador Firmiliano apertava a perseguição contra a Igreja com sacrifícios e espetáculos públicos. Enquanto os ritos pagãos se celebravam diante da cidade reunida, os três cristãos adiantaram-se por vontade própria e, de pé diante do governador, repreenderam o culto de ídolos sem vida e confessaram em alta voz o único Deus verdadeiro e seu Cristo.", "patron": "Invoca-se sua intercessão pela ousadia diante dos perseguidores."},

"Martyrs Onesiphorus and Porphyrius of Ephesus":
{"type": "Mártires · séc. III", "life": "Os santos mártires Onesíforo e Porfírio padeceram por Cristo na perseguição de Diocleciano, para o fim do século III. Confessando-se cristãos, foram levados a julgamento e submetidos a duros tormentos, sendo espancados e queimados com fogo; e, quando nem a dor nem as promessas os puderam afastar de Cristo, os algozes ataram os mártires a cavalos bravios, que os arrastaram por pedras e espinhos até que entregaram a Deus suas santas almas.", "patron": "Invoca-se sua intercessão pela perseverança até o fim."},

"Martyrs Pamphilius the Presbyter, Valens the Deacon, and those with them, at Caesarea in Palestine":
{"type": "Hieromártir · séc. IV", "life": "Os santos mártires Panfílio, o presbítero, Valente, o diácono, Paulo, Porfírio, Seleuco, Teódulo, Julião e os cinco jovens egípcios Elias, Jeremias, Isaías, Samuel e Daniel padeceram em Cesareia da Palestina por volta do ano 309, no sétimo ano da grande perseguição, e seu combate foi registrado por uma testemunha ocular que os amava, Eusébio, o historiador, que chamou aquela companhia uma imagem perfeita de toda uma comunidade da Igreja.", "patron": "Invoca-se sua intercessão pelos estudiosos; pelos copistas."},

"Martyrs Patermuthius, Coprius, and Alexander the Soldier, in Egypt":
{"type": "Monge · séc. IV", "life": "Os veneráveis mártires Patermútio e Cóprio e o mártir Alexandre, o soldado, padeceram no Egito sob o imperador Juliano, o Apóstata. Patermútio fora pagão e chefe de um bando de salteadores, mas, chegando ao arrependimento, foi batizado e retirou-se para o deserto, onde se entregou ao trabalho ascético e recebeu os dons da cura e da profecia.", "patron": "Invoca-se sua intercessão pela penitência; pela perseverança."},

"Martyrs Paul and Juliana of Syria":
{"type": "Mártires · séc. III", "life": "Os santos mártires Paulo e sua irmã Juliana padeceram por Cristo no reinado do imperador Aureliano, na cidade fenícia de Ptolemaida. Quando o imperador veio àquela cidade, Paulo, encontrando-o no meio da multidão, fez o sinal da Cruz, e por isso foi preso e lançado no cárcere, e no dia seguinte, levado a julgamento, confessou abertamente e sem medo sua fé em Cristo, pelo que foi cruelmente atormentado.", "patron": "Invoca-se sua intercessão pela pureza; pela confissão firme."},

"Martyrs Paul and two sisters, Chionia (Thea) and Alevtina (Valentina), at Cæsarea in Palestine":
{"type": "Leigos · séc. IV", "life": "Os santos mártires Paulo e as duas irmãs Quionia e Alevtina eram naturais do Egito e padeceram por Cristo na perseguição do imperador Maximiano. Presos por sua fé, foram levados a Cesareia da Palestina, onde sem o menor temor se confessaram seguidores de Cristo diante de seus juízes e recusaram sacrificar aos ídolos.", "patron": "Invoca-se sua intercessão pela confissão sem medo."},

"Martyrs Perpetua, a woman of Carthage, and the Catechumens: Saturus, Revocatus, Saturninus, Secundulus and Felicitas":
{"type": "Mártires · séc. III", "life": "As santas mártires Perpétua e Felicidade, com os catecúmenos Sátiro, Revocato, Saturnino e Secúndulo, padeceram em Cartago por volta do ano 203, e seu combate é o mais intimamente conhecido da Igreja antiga, pois Perpétua manteve um diário na prisão, e a Igreja lê há dezoito séculos a sua própria mão, o mais antigo escrito que possuímos de uma mulher cristã.", "patron": "Invoca-se sua intercessão pelas mães; pelas grávidas."},

"Martyrs Peter, Dionysius, Andrew, Paul, and Christina who suffered under Decius":
{"type": "Mártir · séc. III", "life": "Os santos mártires Pedro, Dionísio, André, Paulo e Cristina padeceram por Cristo na perseguição do imperador Décio, por volta de meados do século III, e são comemorados juntos neste dia, ainda que a tradição situe seus sofrimentos em mais de uma cidade do Oriente.", "patron": "A fé guardada sob Décio."},

"Martyrs Philadelphus, Cyprian, Alphius, Onesimus, Erasmus, and 14 others, in Sicily":
{"type": "Mártir · séc. III", "life": "Os santos mártires Alfio, Filadelfo e Cipriano, três irmãos, padeceram com seu mestre Onésimo, com Erasmo e com outros catorze na perseguição de Décio, por volta do ano 251, e seu combate uniu as duas pontas do Mediterrâneo cristão, começando no sul da Itália e terminando na Sicília.", "patron": "Três irmãos e uma só confissão."},

"Martyrs Philemon, Apollonios, Arrian, and Theonas of Alexandria":
{"type": "Mártires · séc. III", "life": "Os santos mártires Filêmon, Apolônio, Arriano e Teonas padeceram no Egito por volta do ano 286, e sua história é um revezamento da graça em que cada corredor entrega a coroa ao seguinte. Apolônio, leitor da igreja de Antínoe, temendo os tormentos, pagou ao pagão Filêmon, flautista famoso por todo o Egito, para que se cobrisse com suas roupas e oferecesse o sacrifício em seu nome.", "patron": "Invoca-se sua intercessão pelos músicos; pelos flautistas."},

"Martyrs Probus, Tarachus, and Andronicus, at Tarsus in Cilicia":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Probo, Táraco e Andrônico padeceram na Cilícia no ano 304, na perseguição de Diocleciano. Táraco era um velho soldado romano de sessenta e cinco anos, que havia deixado o exército em vez de negar Cristo; Probo era homem de Side, que trocou a riqueza pela fé.", "patron": "Invoca-se sua intercessão pelos soldados; pelos idosos."},

"Martyrs Processus and Martinian of Rome":
{"type": "Mártires · séc. I", "life": "Os santos mártires Processo e Martiniano eram os guardas do cárcere Mamertino em Roma, os carcereiros postos sobre os apóstolos maiores Pedro e Paulo em sua última prisão; e a Igreja se alegra em sua história como na miniatura perfeita do método do Evangelho, pois a prisão converteu ao contrário, de dentro para fora.", "patron": "Invoca-se sua intercessão pelos guardas de prisão; pelos carcereiros convertidos por seus presos."},

"Martyrs Proclus and Hilary of Ancyra":
{"type": "Leigos · séc. II", "life": "Os santos mártires Proclo e Hilário eram parentes de uma aldeia perto de Ancira e padeceram na perseguição do imperador Trajano. Proclo foi preso primeiro, e, quando confessou Cristo com ousadia diante do governador Máximo e predisse que o próprio governador seria um dia obrigado a reconhecer o Deus verdadeiro, foi cruelmente atormentado e obrigado a correr atrás do carro do governador.", "patron": "Invoca-se sua intercessão pela confissão ousada."},

"Martyrs Rhipsime and Gaianḗ of Armenia and those with them":
{"type": "Mártires · séc. IV", "life": "As santas mártires Ripsime e Gaiane e suas companheiras eram virgens de uma comunidade em Roma, que fugiram para o Oriente quando o imperador Diocleciano, tendo visto a beleza de Ripsime, quis tomá-la por mulher; e, chegando à Armênia, fixaram-se na pobreza perto da cidade de Vagharshapat, vivendo do trabalho de suas mãos.", "patron": "Invoca-se sua intercessão pela pureza; pela conversão da Armênia."},

"Martyrs Rusticus the Presbyter and Eleutherius the Deacon":
{"type": "Mártires · séc. I", "life": "Os santos mártires Rústico, o presbítero, e Eleutério, o diácono, foram os fiéis companheiros do hieromártir Dionísio, o Areopagita, em seus trabalhos apostólicos no Ocidente. Viajando com ele de terra em terra, partilharam sua pregação, seus perigos e suas cadeias, convertendo muitos a Cristo em Roma e além dela.", "patron": "Invoca-se sua intercessão pela companhia fiel no Evangelho."},

"Martyrs Sergius and Bacchus in Syria":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Sérgio e Baco eram romanos nobres, oficiais de alta patente nas tropas da casa do imperador Maximiano, que os tinha em honra sem saber que eram cristãos. Quando se relatou que não entravam nos templos com a corte, o imperador mandou que sacrificassem.", "patron": "Invoca-se sua intercessão pelos soldados; pela santa amizade."},

"Martyrs Simeon, Isaac and Bachtisius, of Persia":
{"type": "Mártir · séc. IV", "life": "Os santos mártires Simeão, Isaac e Bactísio padeceram por Cristo na Pérsia, entre a grande hoste de mártires que a Igreja do império persa deu a Deus no século IV, quando o poder zoroastriano exigia de seus súditos cristãos a adoração do fogo.", "patron": "Cristo confessado contra o culto do fogo."},

"Martyrs Solochon, Pamphamer, and Pamphalon, at Chalcedon":
{"type": "Mártir · séc. IV", "life": "Os santos mártires Solocon, Panfamer e Panfalon eram soldados, egípcios de nascimento, que serviam no exército romano em Calcedônia da Bitínia no reinado do imperador Maximiano, na virada do século IV, e padeceram juntos por recusarem o sacrifício que a perseguição fizera prova da lealdade de um soldado.", "patron": "O sacrifício recusado diante do tribuno."},

"Martyrs Sophia, Irene, and Castor of Egypt":
{"type": "Mártires · séc. III", "life": "As santas mártires Sofia e Irene padeceram por Cristo no Egito na era das perseguições, e com elas se comemora o mártir Castor. De seu combate pouco se conservou além do testemunho dos antigos calendários, que registram que as santas mulheres, tendo confessado Cristo diante de seus perseguidores e recusado oferecer sacrifício aos ídolos, foram decapitadas à espada, e que Castor igualmente terminou sua carreira no martírio.", "patron": "Invoca-se sua intercessão pela confissão firme."},

"Martyrs Theodore and his son, John, of Kyiv":
{"type": "Leigos · séc. X", "life": "Os santos mártires Teodoro, o Varegue, e seu filho João foram os primeiros mártires da terra da Rus, e viviam em Kyiv no século X, nos dias anteriores à conversão do príncipe Vladímir. Teodoro, varegue de origem e cristão, voltara a Kyiv com seu filho pequeno João.", "patron": "Invoca-se sua intercessão pela confissão diante da idolatria."},

"Martyrs Theodotus and Rufina of Caesarea, in Cappadocia":
{"type": "Mártires · séc. III", "life": "Os santos mártires Teódoto e Rufina, pais do grande mártir Mamas, eram de famílias patrícias e honrados por todos por sua piedade cristã. Quando o magistrado de Gangra os chamou por recusarem adorar os ídolos como mandava o decreto imperial, Teódoto não cedeu, e, porque seu nobre grau proibia ao magistrado castigá-lo, foi enviado ao governador Fausto, em Cesareia da Capadócia, que logo o lançou na prisão.", "patron": "Invoca-se sua intercessão pelos casais; pela confissão firme."},

"Martyrs Theodotus, Asclepiodotus, and Maximus, of Adrianopolis":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Teódoto, Asclepiodota e Máximo padeceram no princípio do século IV, na perseguição de Maximiano Galério. Máximo e Asclepiodota eram cidadãos eminentes de Marcianópolis, na Trácia, que levavam vida cristã devota, e junto com Teódoto foram denunciados por causa da fé e levados a julgamento.", "patron": "Invoca-se sua intercessão pela confissão firme."},

"Martyrs Thyrsos, Leukios, and Kallinikos":
{"type": "Mártires · séc. III", "life": "Os santos mártires Tirso, Lêucio e Calínico padeceram em Apolônia da Bitínia por volta do ano 250, na perseguição de Décio. Lêucio abriu o combate: vendo as crueldades infligidas aos cristãos, repreendeu na cara o governador Cumbrício por guerrear contra Deus, e, depois dos tormentos, foi decapitado, acendendo sua ousadia a cidade.", "patron": "Invoca-se sua intercessão pelos serradores; pelos sacerdotes convertidos dos ídolos."},

"Martyrs Timothy, Agapius, and Thekla, of Palestine":
{"type": "Mártires · séc. IV", "life": "Os santos mártires Timóteo, Agápio e Tecla padeceram por Cristo no ano 304, na perseguição de Diocleciano. São Timóteo era natural de Cesareia da Palestina, e havia estudado as santas Escrituras e, sendo dotado de eloquência, tornou-se mestre da fé cristã. Preso e intimado a negar Cristo e a sacrificar aos ídolos, recusou com firmeza, e, depois de suportar cruéis tormentos, foi queimado vivo, entregando sua alma a Deus.", "patron": "Invoca-se sua intercessão pela confissão firme."},

"Martyrs Trophimus and Eucarpus of Nicomedia":
{"type": "Mártires · séc. III", "life": "Os santos mártires Trófimo e Eucarpo eram soldados em Nicomédia nos dias da grande perseguição, por volta do ano 300, e começaram do lado errado dela: homens soberbos e violentos, zelosos na caça aos cristãos, distintos entre os perseguidores pela crueldade com que rastreavam os fiéis, arrastavam-nos aos tribunais e se enriqueciam do terror, saindo os dois executores dos éditos justamente na diligência que haveria de acabá-los.", "patron": "Invoca-se sua intercessão pelos perseguidores convertidos; pelos soldados afastados da crueldade."},
...
{"type": "Santo · séc. XII a.C.", "life": "O justo Gedeão, juiz de Israel, malhava trigo no lagar para escondê-lo dos assaltantes madianitas quando o Anjo do Senhor lhe apareceu e disse, O Senhor é contigo, homem valente, mandando-o livrar Israel da mão de Midiã.", "patron": "Invoca-se sua intercessão pelos soldados; pelos medrosos chamados à coragem."},

"The Three Holy Youths: Ananias, Azarias and Misael":
{"type": "Justo · séc. VI a.C.", "life": "Os três santos jovens Ananias, Azarias e Misael, chamados em Babilônia Sidraque, Mesaque e Abednego, eram companheiros do profeta Daniel no cativeiro, jovens de Judá que guardaram toda a lei de seu Deus no coração do império que lhe queimara o Templo. Quando Nabucodonosor levantou sua imagem de ouro na planície de Dura e mandou que todos os povos se prostrassem ao som da música, os três ficaram de pé.", "patron": "Invoca-se sua intercessão por todos os que enfrentam a fornalha da provação; pelos que confessam diante dos governantes."},

"The Universal Exaltation of the Precious and Life-Giving Cross":
{"type": "Festa", "life": "A Universal Exaltação da Preciosa e Vivificante Cruz é uma das doze grandes festas da Igreja, e dia de jejum rigoroso, em reverência aos sofrimentos do Senhor sobre o Lenho. Quando a santa imperatriz Helena veio a Jerusalém buscar a Cruz de Cristo, foi ela achada escondida na terra sob um templo pagão, junto com as cruzes dos dois ladrões.", "patron": "Invoca-se sua intercessão pelo mundo inteiro; pela vitória sobre o mal."},

"Third Day of the Nativity of our Lord":
{"type": "Festa", "life": "O terceiro dia da Natividade de nosso Senhor leva adiante a festa em glória não diminuída, e a Igreja, que uniu a Mãe ao Filho no segundo dia, no terceiro une o mártir ao Menino. Este é o dia do protomártir Estêvão, e a justaposição é o sermão mais antigo da estação.", "patron": "Comemora-se no santo calendário da Igreja."},

"Third Finding of the Honorable Head of the Holy Glorious Prophet, Forerunner and Baptist John":
{"type": "Festa · séc. IX", "life": "Neste dia a Igreja comemora a terceira descoberta da venerável cabeça do santo e glorioso profeta, precursor e batista João, a última das três recuperações pelas quais o Senhor conservou e devolveu à sua Igreja a sagrada relíquia do maior nascido de mulher.", "patron": "A cabeça do Batista achada uma terceira vez."},
...
{"type": "Festa · séc. X", "life": "Neste dia a Igreja comemora a trasladação do ícone de nosso Senhor Jesus Cristo não feito por mãos, de Edessa para Constantinopla, no ano de 944, a terceira das festas do Salvador guardadas em agosto. Quando o Senhor pregava na Galileia, Abgar, governante de Edessa, jazia doente de lepra, e, tendo ouvido dos muitos milagres de Cristo, mandou um mensageiro pedir-lhe que viesse curá-lo.", "patron": "Invoca-se sua intercessão pela cura; pela veneração dos santos ícones."},

"Translation of the Relics of Venerable Sergius and Herman, Wonderworkers of Valaam":
{"type": "Monge", "life": "Nossos veneráveis pais Sérgio e Germano foram os fundadores do grande mosteiro da Transfiguração na ilha de Valaam, no lago Ladoga, o Atos do norte da terra russa. A antiga tradição sustenta que eram hieromonges gregos que vieram às terras de Nóvgorod e se fixaram na ilha rochosa, reunindo uma irmandade e plantando a luz da Ortodoxia entre as tribos pagãs da Carélia.", "patron": "Invoca-se sua intercessão pelos monges; pelo monaquismo do norte."},

"Translation of the Relics of the Holy Passionbearers Boris and Gleb (in Baptism Roman and David, 1072 and 1115)":
{"type": "Festa · séc. XII", "life": "Neste dia a Igreja comemora a trasladação das relíquias dos santos portadores da paixão Bóris e Gleb, no santo batismo Romano e Davi, os primeiros santos glorificados pela terra da Rus, cuja memória principal ela guarda em julho; filhos de são Vladímir, igual aos apóstolos.", "patron": "Os irmãos entronizados por seu povo."},

"Translation of the Relics of the holy and wonderworking Unmercenaries Cyrus and John":
{"type": "Festa · séc. V", "life": "Neste dia a Igreja comemora a trasladação das relíquias dos santos e taumaturgos anárgiros Ciro e João, mártires do Egito, cujos corpos sagrados foram levados a um lugar de cura para derrubar o poder dos demônios.", "patron": "Invoca-se sua intercessão pelos médicos e pelos anárgiros; pelos que expulsam os demônios pela mão dos santos."},

"Translation of the relics of Blessed James of Borovichi, Wonderworker of Novgorod":
{"type": "Santo · séc. XVI", "life": "O bem-aventurado Tiago de Borovitchi, taumaturgo de Nóvgorod, foi revelado à Igreja não pelo registro de sua vida, mas pela glória de suas relíquias. Na primavera de 1540, nas corredeiras do rio Msta, junto ao povoado de Borovitchi, um grande bloco de gelo subiu o rio contra a corrente, trazendo sobre si um caixão de madeira queimada em que jazia o corpo de um jovem.", "patron": "Invoca-se sua intercessão pelos barqueiros; pelos justos que ninguém conhece."},

"Translation of the relics of Blessed Vsevolod (in Baptism Gabriel), Prince of Pskov":
{"type": "Festa · séc. XIX", "life": "Neste dia a Igreja comemora a trasladação das relíquias do bem-aventurado Vsevolod, no santo batismo Gabriel, príncipe de Pskov, o taumaturgo cuja memória principal ela guarda em fevereiro; neto de Vladímir Monômaco, príncipe primeiro da grande Nóvgorod, onde governou com justiça e misericórdia de mão aberta até que aquela cidade inconstante o expulsou, foi recebido com amor por Pskov, à qual serviu o resto de sua vida breve e onde ergueu a primeira igreja de pedra da Santíssima Trindade.", "patron": "Invoca-se sua intercessão por todos os que honram as relíquias dos santos; pelo príncipe devolvido em glória à sua catedral."},

"Translation of the relics of Hieromartyr Philip, Metropolitan of Moscow":
{"type": "Metropolita · séc. XVI", "life": "Esta festa comemora a solene trasladação das relíquias de são Filipe, metropolita de Moscou, para a capital no ano de 1652. Nascido Fiodor Kolytchev, são Filipe foi igumeno do mosteiro de Solovki antes de ser elevado à sé de Moscou, onde repreendeu sem temor as crueldades do czar Ivan, o Terrível, e as opressões de sua guarda.", "patron": "Invoca-se sua intercessão pela liberdade da Igreja diante do Estado."},

"Translation of the relics of Righteous Simeon of Verkhoturye":
{"type": "Santo · séc. XVII", "life": "O justo Simeão de Verkhoturie era um nobre da Rússia europeia que, escondendo seu nascimento, veio nos tempos conturbados do princípio do século XVII às terras recém-povoadas além dos Urais e viveu como pobre andarilho na aldeia de Merkuchino, perto de Verkhoturie. Ganhava o pão costurando casacos de pele para os camponeses, e era seu costume, para não receber pagamento, deixar alguma pequena parte do trabalho por acabar e partir em silêncio, suportando as censuras de quem o contratava por amor da santa pobreza.", "patron": "Invoca-se sua intercessão pelos alfaiates; pelos pescadores."},

"Translation of the relics of Saint Gurias, Archbishop of Kazan":
{"type": "Festa · séc. XVII", "life": "Neste dia a Igreja comemora a trasladação das relíquias de são Gúrias, primeiro arcebispo de Kazan, iluminador daquela terra recém-conquistada.", "patron": "Invoca-se sua intercessão pelos primeiros hierarcas de uma terra convertida; por aqueles cujas relíquias são transladadas em glória."},

"Translation of the relics of Saint Hilarion, Bishop of Meglin in Bulgaria":
{"type": "Bispo · séc. XII", "life": "Neste dia a Igreja comemora a trasladação das relíquias de santo Hilarião, bispo de Meglin, ocorrida no ano de 1206, quando o czar búlgaro Kaloian, reunindo os tesouros santos de sua terra, levou as relíquias milagrosas do hierarca à sua capital de Tarnovo.", "patron": "Invoca-se sua intercessão pelos apologistas; pela defesa da Ortodoxia contra a heresia."},

"Translation of the relics of Saint John Chrysostom, Archbishop of Constantinople":
{"type": "Arcebispo · séc. V", "life": "Neste dia a Igreja comemora a trasladação das relíquias de são João Crisóstomo, arcebispo de Constantinopla, a reparação em glória da grande injustiça de seu tempo. O Boca de Ouro fora expulso de seu trono pela inimizade da imperatriz Eudóxia e pelas intrigas de seus rivais, e morrera no exílio em Comana em 407, esgotado por marchas forçadas, com as palavras que resumem toda a sua teologia, Glória a Deus por todas as coisas.", "patron": "Invoca-se sua intercessão pelos pregadores; pelos exilados que são justificados."},

"Translation of the relics of Saint Maximus the Confessor":
{"type": "Monge · séc. VII", "life": "Nosso venerável pai Máximo, o Confessor, um dos maiores teólogos da Igreja, nasceu em Constantinopla por volta do ano 580 e serviu como primeiro secretário do imperador Heráclio antes de deixar a corte pela vida monástica no mosteiro de Crisópolis, onde com o tempo se tornou igumeno.", "patron": "Invoca-se sua intercessão pelos teólogos; pela teologia ortodoxa."},

"Translation of the relics of Saint Nicholas the Wonderworker from Myra to Bari":
{"type": "Festa · séc. XI", "life": "Neste dia a Igreja comemora a trasladação das relíquias de são Nicolau, o taumaturgo, arcebispo de Mira, na Lícia, de Mira para a cidade de Bari, na Itália, no ano de 1087, festa que o povo russo veio a chamar o Nicolau da primavera e a amar quase tanto quanto a sua memória de dezembro.", "patron": "O taumaturgo levado ao ocidente antes da tempestade."},

"Translation of the relics of Saint Nikephoros, Patriarch of Constantinople":
{"type": "Patriarca e confessor · séc. IX", "life": "Neste dia a Igreja comemora a trasladação das relíquias de são Nicéforo, patriarca de Constantinopla, um dos grandes confessores dos santos ícones, cuja festa principal se guarda em junho; a comemoração de março marca o dia de seu regresso triunfal à Cidade, que foi também, pela conta exata de Deus, o dia de sua expulsão dela.", "patron": "Invoca-se sua intercessão pelos patriarcas; pelos teólogos do ícone."},

"Translation of the relics of Saint Peter, Metropolitan of Moscow and All Russia":
{"type": "Metropolita · séc. XIV", "life": "São Pedro, metropolita de Moscou e de toda a Rússia, foi o primeiro primaz da Igreja russa a fixar morada em Moscou, e com isso abençoou a ascensão daquela cidade, que sob seus sucessores se tornou o coração da terra russa. Pastor de grande santidade e sabedoria, fortaleceu a fé em seu rebanho num tempo duro de divisão e de domínio tártaro, sustentou a unidade da Igreja e predisse a glória futura de Moscou.", "patron": "Invoca-se sua intercessão por Moscou; pela unidade da Igreja."},

"Translation of the relics of Saint Tikhon of Luchov, Kostroma":
{"type": "Festa · séc. XVI", "life": "Neste dia a Igreja comemora a trasladação das relíquias de são Tíkhon de Lukhov, o antigo soldado que se fez pobre monge na terra de Kostroma e foi glorificado por Deus com a incorrupção.", "patron": "Invoca-se sua intercessão por aqueles cujas relíquias se acham incorruptas; pelos monges pobres que Deus glorifica."},

"Translation of the relics of Venerable Ephraim, Abbot of Perekop, Novgorod":
{"type": "Festa · séc. XVI", "life": "Neste dia a Igreja comemora a trasladação das relíquias de nosso venerável pai Efrém, igumeno de Perekop e taumaturgo de Nóvgorod, trasladação ocorrida no ano de 1545 e confirmada como festa pelo Concílio de Moscou de 1549.", "patron": "O canal aberto até o lago."},

"Translation of the relics of Venerable John, Abbot of Rila, Bulgaria":
{"type": "Monge · séc. X", "life": "Neste dia a Igreja comemora a trasladação das relíquias de nosso venerável pai João de Rila, protetor celeste do povo búlgaro. Nascido por volta do ano de 876 na aldeia de Skrino, guardava os rebanhos de sua família como pobre órfão antes de deixar tudo para fazer-se monge.", "patron": "Invoca-se sua intercessão pelos monges; pelos eremitas."},

"Translation of the relics of Venerable Lazarus of Mount Galesius near Ephesus":
{"type": "Monge estilita · séc. XI", "life": "Esta festa comemora a trasladação das relíquias de nosso venerável pai Lázaro, o taumaturgo do monte Galésion. Nascido em Magnésia da Lídia, Lázaro era um jovem douto que amou a Deus desde a juventude, e viajou à Terra Santa, onde foi tonsurado na Lavra de São Sabas e trabalhou por dez anos, ganhando o amor dos irmãos por seus combates ascéticos, até ser ordenado sacerdote pelo patriarca de Jerusalém.", "patron": "Invoca-se sua intercessão pelos monges; pelo combate ascético."},

"Translation of the relics of Venerable Nilus of Stolobensk":
{"type": "Festa · séc. XVII", "life": "Neste dia a Igreja comemora a trasladação das relíquias de nosso venerável pai Nilo de Stolobensk, o grande eremita do lago Seliger, descobertas e transladadas no ano de 1667, mais de um século depois de seu repouso.", "patron": "O ermo insular de Seliger."},

"Translation of the relics of Venerable Theodore, Abbot of Studion":
{"type": "Igumeno · séc. IX", "life": "Neste dia a Igreja comemora a trasladação das relíquias de nosso venerável pai Teodoro, igumeno do Estúdio, cuja festa principal se guarda em novembro; a comemoração de janeiro recorda o dia em que o grande confessor voltou para casa. Teodoro passara a vida defendendo os santos ícones e a liberdade da Igreja contra os imperadores, suportando açoites, prisões e exílios repetidos, e repousara em 826 no desterro, longe de seu mosteiro, nos anos em que a iconoclastia ainda ocupava o palácio.", "patron": "Invoca-se sua intercessão pelos monges; pelos confessores justificados."},

"Translation of the relics of Venerable Theodosius of the Kyiv Far Caves":
{"type": "Igumeno · séc. XI", "life": "Nosso venerável pai Teodósio das Cavernas foi o pai da vida monástica comum na terra da Rus. Nascido em Vasilevo, perto de Kyiv, foi atraído desde a infância à vida ascética, desprezando os brinquedos das crianças, vestindo-se de roupas pobres e trabalhando nos campos, até que deixou sua casa para buscar a Deus na vida monástica.", "patron": "Invoca-se sua intercessão pelos monges; pela vida monástica."},

"Translation of the relics of Venerable Zosimas and Sabbatius of Solovki":
{"type": "Venerável · séc. XV", "life": "Nossos veneráveis pais Sabácio e Zósimas foram os fundadores do grande mosteiro de Solovki, em sua ilha no frio Mar Branco do norte russo. São Sabácio, buscando a solidão completa, foi o primeiro a fixar-se na ilha desabitada, onde trabalhou e repousou no ano de 1435.", "patron": "Invoca-se sua intercessão pelos apicultores; pelos monges."},

"Translation of the relics of slain Crown Prince Demetrius of Moscow":
{"type": "Festa · séc. XVII", "life": "Neste dia a Igreja comemora a trasladação das relíquias do santo e fiel czarévitche Demétrio de Uglitch, o príncipe menino e portador da paixão assassinado em Uglitch em 1591.", "patron": "Invoca-se sua intercessão pelos assassinados e justificados; por aqueles cujas relíquias confundem o impostor."},

"Translation of the relics of the Greatmartyr Theodore Stratelates":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora a trasladação das relíquias do santo grande mártir Teodoro Estrateles, o general, cujo martírio se guarda em fevereiro e cujo corpo sagrado foi levado de volta à sua própria cidade para ser uma fonte de graça.", "patron": "Invoca-se sua intercessão pelos soldados e comandantes; pelos que honram os grandes mártires."},

"Translation of the relics of the Hieromartyr Phocas, Bishop of Sinope":
{"type": "Bispo · séc. II", "life": "Esta festa comemora a trasladação das relíquias do santo hieromártir Focas, bispo de Sinope, de sua própria cidade para Constantinopla no ano de 403 ou 404. Nascido em Sinope, no Mar Negro, Focas levou desde a juventude uma vida cristã virtuosa e a seu tempo tornou-se bispo daquela cidade, onde por sua pregação converteu muitos pagãos a Cristo.", "patron": "Invoca-se sua intercessão pelos marinheiros; pela proteção contra o fogo."},

"Translation of the relics of the Martyr Epimachus of Pelusium":
{"type": "Mártir · séc. III", "life": "Neste dia a Igreja comemora a trasladação das relíquias do santo mártir Epímaco de Pelúsio, chamado também de Alexandria, cuja festa principal se guarda no fim de outubro; a comemoração de março marca o transporte de suas santas relíquias para Constantinopla, onde a Cidade recebeu entre seus tesouros o mártir egípcio e instituiu esta memória anual de sua chegada.", "patron": "Invoca-se sua intercessão pelos zelosos; pelos que os mártires curam."},

"Translation of the relics of the Protomartyr and Archdeacon Stephen from Jerusalem to Constantinople":
{"type": "Santo · séc. V", "life": "Depois que o santo protomártir e arquidiácono Estêvão foi apedrejado até a morte, seu corpo ficou insepulto fora da cidade, mas de noite o célebre doutor da Lei Gamaliel, discípulo secreto de Cristo, o recolheu e o pôs numa gruta de suas próprias terras, em Cafargamala, a umas vinte milhas de Jerusalém.", "patron": "Invoca-se sua intercessão pela cura."},

"Translation of the relics of the Right-believing Igor-George, Tonsured Gabriel, Grand Prince of Chernihiv, and Kyiv":
{"type": "Portador da paixão · séc. XII", "life": "Neste dia a Igreja comemora a trasladação das relíquias do santo portador da paixão Igor, no batismo Jorge, da casa principesca de Tchernígov, que ocupou brevemente o trono de Kyiv, fez-se monge e foi assassinado pela multidão enquanto orava.", "patron": "Invoca-se sua intercessão pelos príncipes que se fazem monges; pelas vítimas da multidão."},

"Uncovering of the Precious Cross and the Precious Nails by Empress Saint Helen in Jerusalem":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora a descoberta da Preciosa Cruz e dos preciosos Cravos pela santa imperatriz Helena, mãe de são Constantino, o Grande, no ano de 326. Movida por seu filho, o imperador, e por seu próprio grande amor a Cristo, a idosa Helena viajou a Jerusalém para buscar os lugares santos, que os pagãos havia muito haviam profanado e soterrado, erguendo sobre o Gólgota e o túmulo do Senhor um templo de seus ídolos para apagar a memória dos santuários dos cristãos.", "patron": "Invoca-se sua intercessão por todos os que buscam o que está soterrado; pelos peregrinos."},

"Uncovering of the relics Saint Acacius, Bishop of Melitene":
{"type": "Bispo · séc. III", "life": "Santo Acácio, o confessor, foi bispo de Melitene, na Armênia, nos dias da perseguição de Décio. Preso como cristão e levado diante do governador Marciano, confessou Cristo com ousadia e refutou a insensatez da idolatria, pelo que foi submetido ao tormento; e todavia não foi morto, mas depois de algum tempo posto em liberdade, trazendo no corpo as chagas de Cristo, e governou daí em diante seu rebanho como mártir vivo, repousando por fim em paz.", "patron": "Invoca-se sua intercessão pelos confessores; pela perseverança no tormento."},

"Uncovering of the relics of Holy Princess Juliana Olshanskaya":
{"type": "Princesa · séc. XVI", "life": "Santa Juliana era filha do príncipe Iuri Dubrovitsky-Olchansky, cuja família governava Olchansk quando Kyiv estava sob o reino da Lituânia. Benfeitor da lavra das Cavernas de Kyiv, seu pai a sepultou perto da grande igreja do mosteiro quando ela repousou virgem pura aos dezesseis anos, no século XVI.", "patron": "Invoca-se sua intercessão pelas mulheres; pela cura da alma."},

"Uncovering of the relics of Saint Alexis, Metropolitan of Moscow and Wonderworker of All Russia":
{"type": "Festa · séc. XV", "life": "Neste dia a Igreja comemora a descoberta das relíquias de santo Aleixo, metropolita de Moscou e taumaturgo de toda a Rússia, o grande hierarca e homem de estado que guiou a Igreja russa e o Estado de Moscou em meados do século XIV.", "patron": "As relíquias incorruptas reveladas pela queda de um teto."},

"Uncovering of the relics of Saint Andrew, Prince of Smolensk":
{"type": "Príncipe · séc. XIV", "life": "Neste dia a Igreja comemora a descoberta das relíquias de santo André, príncipe de Smolensk, ocorrida em Pereslavl-Zalessky no ano de 1539 pelos trabalhos de são Daniel de Pereslavl. O santo príncipe, entristecido pela inimizade e pelas contendas de seus parentes, deixara em segredo seu principado e, chegando como pobre desconhecido a Pereslavl, serviu por trinta anos como sacristão na igreja de São Nicolau, em jejum, oração e perfeito ocultamento, sem que ninguém soubesse que o humilde servidor da igreja era príncipe de nascimento.", "patron": "Invoca-se sua intercessão pelos sacristãos; pelos servidores das igrejas."},

"Uncovering of the relics of Saint Basil, Bishop of Amasea":
{"type": "Festa · séc. IV", "life": "Neste dia a Igreja comemora a descoberta das relíquias do santo hieromártir Basílio, bispo de Amaseia, cujo combate ela guarda antes nesta mesma semana; decapitado em Nicomédia na perseguição de Licínio, por volta do ano 322, por ter abrigado a virgem Gláfira dos desígnios do imperador, Basílio sofreu depois da morte o último despeito do perseguidor, sendo seu corpo lançado ao mar, com a intenção de que a Igreja não tivesse sequer um túmulo em torno do qual se reunir.", "patron": "Invoca-se sua intercessão por todos os que buscam as relíquias dos mártires; pelo mar obrigado a devolver o que lhe foi confiado."},

"Uncovering of the relics of Saint Demetrius (Dmitri), Metropolitan of Rostov":
{"type": "Metropolita · séc. XVIII", "life": "São Demétrio, metropolita de Rostov, no mundo Daniel Tuptalo, nasceu em 1651 perto de Kyiv e foi educado na academia de Kyiv, recebendo a tonsura monástica na juventude.", "patron": "Invoca-se sua intercessão pelos que escrevem as vidas dos santos; pelos escritores."},

"Uncovering of the relics of Saint Gurias, first Archbishop of Kazan, and Saint Barsanuphius, Bishop of Tver":
{"type": "Arcebispo · séc. XVI", "life": "Neste dia a Igreja comemora a descoberta das relíquias de são Gúrias, primeiro arcebispo de Kazan, e de são Barsanúfio, bispo de Tver, ocorrida em Kazan no ano de 1595, quando se edificava uma nova igreja de pedra da Transfiguração no mosteiro que Barsanúfio fundara, e as sepulturas dos dois hierarcas foram achadas sob a velha igreja de madeira.", "patron": "Invoca-se sua intercessão pelos missionários; pelos mestres."},

"Uncovering of the relics of Saint Joasaph, Bishop of Belgorod":
{"type": "Bispo · séc. XVIII", "life": "São Joasaf, bispo de Belgorod, nasceu em 1705 em Priluky, nas terras de Poltava, na própria festa da Natividade da Mãe de Deus, da nobre linhagem ucraniana dos Gorlenko, e recebeu no batismo o nome de Joaquim. Educado na academia espiritual de Kyiv, foi atraído cedo à vida monástica, foi tonsurado com o nome de Joasaf e, depois de servir como igumeno do mosteiro de Mgar e vigário da lavra da Trindade e de São Sérgio, foi sagrado bispo de Belgorod em 1748.", "patron": "Invoca-se sua intercessão pelo rigor de vida; pelo cuidado com o clero."},

"Uncovering of the relics of Saint Nikḗtas, Bishop of Novgorod":
{"type": "Festa · séc. XVI", "life": "Neste dia a Igreja comemora a descoberta das relíquias de são Nicetas, bispo de Nóvgorod, o recluso das Cavernas de Kyiv que caiu na juventude no engano do inimigo, foi restaurado pelas orações dos padres e subiu pela humildade ao episcopado que quase perdera pela soberba, apascentando Nóvgorod em santidade e prodígios, alcançando chuva pela oração e apagando um incêndio da cidade por sua intercessão, até seu repouso em 1108.", "patron": "Invoca-se sua intercessão por todos os que honram as relíquias dos santos; pelos que padecem dos olhos."},

"Uncovering of the relics of Saint Vsévolod (Gabriel) of Pskov":
{"type": "Príncipe · séc. XII", "life": "Neste dia a Igreja comemora a descoberta das relíquias do santo príncipe Vsevolod de Pskov, chamado Gabriel no santo batismo, ocorrida no ano de 1192. Neto de Vladímir Monômaco e filho de são Mstislav, o Grande, Vsevolod governou Nóvgorod desde a juventude com justiça e mãos abertas, edificando igrejas, alimentando os pobres na fome às suas próprias custas e conduzindo as hostes da cidade.", "patron": "Invoca-se sua intercessão pelos governantes; pelos construtores."},

"Uncovering of the relics of Venerable Alexander, Abbot of Svir":
{"type": "Festa · séc. XVII", "life": "Neste dia a Igreja comemora a descoberta das relíquias de nosso venerável pai Alexandre de Svir, o grande asceta das florestas do norte entre os lagos Ladoga e Onega, cuja festa principal ela guarda no fim de agosto.", "patron": "Invoca-se sua intercessão por todos os que honram as relíquias dos santos; pelo fundador incorrupto que se revelou."},

"Uncovering of the relics of Venerable Athanasius, Abbot of Brest-Litovsk":
{"type": "Igumeno · séc. XVII", "life": "Este dia comemora a descoberta das relíquias de nosso venerável pai Atanásio, igumeno de Brest, campeão destemido da Ortodoxia na idade em que a União foi imposta aos ortodoxos das terras polaco-lituanas. Como igumeno do mosteiro de São Simeão em Brest, opôs-se com ousadia à União por palavra e por obra, defendendo seus irmãos oprimidos e repetindo sua profecia, A União se extinguirá, mas a Ortodoxia florescerá.", "patron": "Invoca-se sua intercessão pela defesa da Ortodoxia."},
...
{"type": "Monge · séc. VI", "life": "Nosso venerável pai Jorge de Maleon viveu sua vida ascética no monte Málea, na Lacônia, o cabo selvagem no extremo sul do Peloponeso, cujas tempestades eram proverbiais entre os marinheiros e cujas alturas, justamente por sua dureza, atraíram os eremitas dos séculos bizantinos.", "patron": "Invoca-se sua intercessão pelos eremitas; pelos pais de discípulos dispersos."},

"Venerable Gerasimus of Vologda":
{"type": "Igumeno · séc. XII", "life": "Nosso venerável pai Gerásimo, primeiro taumaturgo de Vólogda, recebeu a tonsura monástica a quatro de março no mosteiro da Dormição em Gnilets, perto de Kyiv, tomando, pelo costume daquela idade, o nome do santo comemorado no dia de sua tonsura, Gerásimo do Jordão, cuja festa haveria depois de partilhar.", "patron": "Invoca-se sua intercessão pelos fundadores; pelos missionários do norte."},

"Venerable Gerasimus of the Jordan":
{"type": "Igumeno · séc. V", "life": "Nosso venerável pai Gerásimo do Jordão foi um dos grandes luminares do deserto palestino, nascido no princípio do século V na Lícia, de família rica, que renunciou ao mundo na juventude e foi aperfeiçoado primeiro nos desertos da Tebaida egípcia e depois, chegando à Terra Santa por volta do ano de 450, fixou-se junto ao rio Jordão, onde fundou uma grande lavra e reuniu em torno de si uma irmandade de uns setenta monges.", "patron": "Invoca-se sua intercessão pelos monges da regra austera; pelos que amansam os animais bravios."},

"Venerable Gerasimus the New Ascetic of Cephalonia":
{"type": "Hieromonge · séc. XVI", "life": "Nosso venerável pai Gerásimo, o novo asceta de Cefalônia, grande taumaturgo daquela ilha, nasceu em 1506 em Trikala, no Peloponeso, da nobre casa dos Notarás. Fazendo-se monge na ilha de Zante, foi aperfeiçoado no Monte Santo de Atos, onde recebeu o grande esquema.", "patron": "Invoca-se sua intercessão pelos que exorcizam; pelos possessos."},

"Venerable Gerontius the Canonarch of the Kyiv Far Caves":
{"type": "Monge · séc. XIV", "life": "Nosso venerável pai Geroncio, canonarca das Cavernas de Kyiv, viveu no século XIV e passou toda a sua vida terrena dentro da lavra numa única obediência, a de canonarca, o chefe do canto da igreja, que se põe diante dos coros e entoa os versos e anuncia os tons, a dobradiça viva sobre a qual gira toda a ordem audível dos ofícios.", "patron": "Invoca-se sua intercessão pelos cantores e leitores das igrejas; pelos canonarcas."},

"Venerable Gregory the Decapolite":
{"type": "Monge · séc. IX", "life": "Nosso venerável pai Gregório de Decápolis nasceu em Irenópolis, na Decápole da Isáuria, e, fugindo na juventude do casamento que seus pais haviam arranjado, entregou-se a Deus na vida monástica, formado sob um ancião de discernimento e provado por anos de reclusão numa gruta, onde suportou os assaltos abertos dos demônios e recebeu visões da graça.", "patron": "Invoca-se sua intercessão pelos que viajam pela verdade; pela defesa dos santos ícones."},

"Venerable Gregory the Iconographer of the Kyiv Near Caves":
{"type": "Monge · séc. XII", "life": "Nosso venerável pai Gregório, o iconógrafo, foi monge das Cavernas de Kyiv e companheiro de são Alípio, o primeiro iconógrafo da terra russa. Nas narrativas dos santos iconógrafos está escrito que pintou muitos ícones milagrosos por toda a Rus, e nos hinos do mosteiro é chamado bizantino, o que sugere que estava entre os mestres vindos de Constantinopla para adornar de santas imagens a grande catedral da Dormição no mosteiro das Cavernas.", "patron": "Invoca-se sua intercessão pelos iconógrafos; pela sagrada iconografia."},

"Venerable Gregory, Abbot of Pelsheme and Wonderworker of Vologda":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Gregório de Pelcheme, taumaturgo de Vólogda, nasceu da família boiarda dos Lopotov, no principado de Galitch, e, recusando na juventude tanto o casamento quanto a herança, recebeu a tonsura monástica e resplandeceu de tal modo em virtude que foi feito igumeno e lhe ofereceram honra ainda maior, da qual fugiu para as florestas do norte.", "patron": "Invoca-se sua intercessão pelos monges; pela ousadia diante dos príncipes."},

"Venerable Herodion, Abbot of Iloezersk":
{"type": "Monge · séc. XVI", "life": "Nosso venerável pai Herodião de Iloezersk foi discípulo de são Cornélio de Komel, em cujo mosteiro foi tonsurado e formado nas tradições ascéticas do ermo de Vólogda. Depois do repouso de seu ancião, buscando a quietude, retirou-se para as florestas da terra de Belozersk e fixou-se junto ao pequeno lago Ilo, onde construiu para si uma cela e uma capela em honra da Natividade da Santíssima Mãe de Deus, e viveu sozinho em jejum, vigília e oração incessante, tomando por fim o grande esquema.", "patron": "Invoca-se sua intercessão pelos eremitas; pela quietude."},

"Venerable Hilarion of Pskov, Lake Gdov":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Hilarião de Pskov, chamado também de Gdov, foi discípulo do grande Eufrosino de Pskov, pai da tradição do ermo de Pskov, e levou a escola de rigor e de quietude de seu ancião para o norte, até a própria borda da terra russa.", "patron": "Invoca-se sua intercessão pelos fundadores das terras de fronteira; pelos discípulos dos grandes anciãos."},

"Venerable Hilarion the Great":
{"type": "Venerável · séc. IV", "life": "Nosso venerável pai Hilarião, o Grande, nasceu na Palestina e estudou em Alexandria, onde ouviu falar de santo Antônio. Voltando à sua terra, distribuiu sua herança e abraçou a vida ascética perto de Gaza. Tornou-se fundador do monaquismo palestino, fugiu do louvor dos homens, obrou muitas curas e repousou em Chipre no século IV."},

"Venerable Hilarion the New, Abbot of Pelekete":
{"type": "Igumeno · séc. VIII", "life": "Nosso venerável pai Hilarião, o Novo, igumeno do mosteiro de Peleceta, perto de Prusa, na Bitínia, foi dado a Deus desde a juventude, e, passando por toda a escola da vida monástica, o silêncio, a obediência, o jejum e o saltério de cor, foi ordenado sacerdote e com o tempo feito igumeno de Peleceta, uma das casas monásticas mais célebres da Bitínia.", "patron": "Invoca-se sua intercessão pelos igumenos em dias maus; pelos que oram por chuva e por colheita."},

"Venerable Hilarion the New, Abbot of the Dalmatian Monastery":
{"type": "Igumeno · séc. IX", "life": "Nosso venerável pai Hilarião, o Novo, foi igumeno do antigo mosteiro de Dalmatos em Constantinopla, o primeiro mosteiro da cidade imperial, e confessor dos santos ícones que muito padeceu pela fé através dos reinados dos imperadores iconoclastas.", "patron": "Invoca-se sua intercessão pelos igumenos e confessores dos ícones; pelos presos e açoitados por causa da fé."},

"Venerable Hilarion the Schemamonk of the Kyiv Caves":
{"type": "Metropolita · séc. XI", "life": "Nosso venerável pai Hilarião, o esquemamonge das Cavernas de Kyiv, repousou por volta do ano de 1066, e a tradição da lavra o identifica com o grande Hilarião, metropolita de Kyiv, o primeiro nascido na Rus a ocupar o trono metropolitano. Presbítero na aldeia principesca de Berestovo, homem douto e de extremada piedade, costumava retirar-se a uma colina arborizada acima do Dniepre, onde cavou com as próprias mãos uma pequena gruta para a oração e a salmodia.", "patron": "Invoca-se sua intercessão pelos pregadores; pelos escritores."},

"Venerable Hilarion, Abbot of Gdov and Pskov Lake":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Hilarião de Gdov foi discípulo do grande ancião Eufrosino de Pskov, formado em sua escola do ermo, de jejum rigoroso, obediência e oração incessante. Saindo com a bênção de seu ancião, fundou sobre o rio Jeltcha, não longe de Gdov, junto às águas da terra dos lagos de Pskov, um mosteiro em honra da Proteção da Santíssima Mãe de Deus, numa terra de fronteira exposta aos assaltos dos cavaleiros livônios.", "patron": "Invoca-se sua intercessão pelos monges; pelos mosteiros das fronteiras."},

"Venerable Ignatius of Loma and Yaroslav":
{"type": "Monge · séc. XVI", "life": "Nosso venerável pai Inácio de Loma e de Iaroslavl escondeu tão bem seus começos que as circunstâncias de sua vida no mundo são desconhecidas, o que é já o primeiro fato de sua biografia, homem que entrou no registro apenas quando entrou no serviço de Deus. Começou seu caminho ascético no mosteiro do Salvador em Priluki, perto de Vólogda, e recebeu a tonsura monástica no grande mosteiro de São Cirilo, no Lago Branco.", "patron": "Invoca-se sua intercessão pelos eremitas; pelos fundadores que se retiram."},

"Venerable Ignatius, Archimandrite of the Kyiv Caves":
{"type": "Arquimandrita · séc. XV", "life": "Nosso venerável pai Inácio, arquimandrita das Cavernas de Kyiv, governou a grande lavra no século XV, por volta do ano de 1435, e sua breve biografia chegou até nós na inscrição copiada em idades posteriores de sua lápide: que por sua vida santa o monge Inácio alcançou de Deus o dom dos milagres e curou muitos enfermos por suas orações, e que a cura era dada pelo sabor da prosfora que ele oferecera, recebendo os fiéis a saúde ao comer o pão santo das Liturgias que ele servira.", "patron": "Invoca-se sua intercessão pelos sacerdotes que servem a Liturgia; pelos enfermos."},

"Venerable Irenarchus, Abbot of Solovki":
{"type": "Igumeno · séc. XVII", "life": "Nosso venerável pai Irenarco recebeu a tonsura monástica no mosteiro de Solovki, no extremo norte da Rússia, onde imitou com zelo os fundadores daquele lugar santo, os santos Zósimas e Sabácio, em seus trabalhos ascéticos. No ano de 1614, com a morte do igumeno Antônio, foi escolhido para sucedê-lo, e governou fielmente a comunidade numa idade difícil, quando o mosteiro de Solovki era um baluarte para a defesa das terras do norte contra os suecos e os dinamarqueses.", "patron": "Invoca-se sua intercessão pelos monges; pela vida monástica."},

"Venerable Isaac the Ascetic of the Dalmatian Monastery at Constantinople":
{"type": "Igumeno · séc. IV", "life": "Nosso venerável pai Isaac foi um eremita do ermo do oriente que viveu no século IV, no reinado do imperador ariano Valente. Quando soube que Valente perseguia os ortodoxos, expulsando seus bispos e entregando suas igrejas aos hereges, deixou sua solidão e veio a Constantinopla enfrentar o imperador, que então partia para a guerra contra os godos.", "patron": "Invoca-se sua intercessão pelos monges; pela defesa da Ortodoxia contra a heresia."},

"Venerable Isaac the Confessor, Founder of the Dalmatian Monastery at Constantinople":
{"type": "Igumeno e confessor · séc. IV", "life": "Nosso venerável pai Isaac, o confessor, fundador do mosteiro dalmata, era um eremita do ermo da Síria a quem a crise da Igreja arrancou de sua solidão e lançou na estrada de um imperador. Nos dias em que Valente, ariano, entregara aos hereges as igrejas de Constantinopla e expulsara os ortodoxos, Isaac veio à capital para fortalecer os perseguidos.", "patron": "Invoca-se sua intercessão pelos monges que enfrentam o poder; pelos fundadores."},

"Venerable Isaac the Recluse of the Kyiv Near Caves":
{"type": "Recluso · séc. XI", "life": "Nosso venerável pai Isaac, o recluso das Cavernas Próximas de Kyiv, foi o primeiro dos solitários enganados das Cavernas, e o Patérikon conta sua queda e sua vitória com igual franqueza, porque a Igreja precisa das duas metades. Rico mercador de Toropets, deu tudo o que tinha, veio a santo Antônio e ultrapassou a todos no rigor: emparedado numa cela de quatro côvados, vestido de uma pele de cabra crua que secou sobre seu corpo, comendo uma prosfora a cada dois dias, orou sem se deitar por sete anos.", "patron": "Invoca-se sua intercessão pelos enganados que foram restaurados; pelos que trabalham nas cozinhas."},

"Venerable Isaac, Founder of Dalmátos Monastery at Constantinople":
{"type": "Venerável · séc. IV", "life": "Nosso venerável pai Isaac, fundador do mosteiro de Dalmatos em Constantinopla, foi confessor que não temeu o rosto de imperador algum, e é lembrado sobretudo por sua repreensão destemida ao imperador ariano Valente e por sua profecia do terrível fim daquele imperador.", "patron": "O imperador ariano repreendido na cara."},

"Venerable Isaiah, Wonderworker of the Kyiv Near Caves":
{"type": "Venerável · séc. XII", "life": "Nosso venerável pai Isaías, o taumaturgo das Cavernas Próximas de Kyiv, trabalhou no grande mosteiro no fim do século XI e no princípio do XII e repousou, registra a tradição, por volta do ano de 1115, e sua memória se guarda neste dia, que partilha com seu homônimo Isaías de Rostov.", "patron": "Os trabalhos das Cavernas oferecidos a Deus."},

"Venerable Isidore of Pelusium":
{"type": "Hieromonge · séc. V", "life": "Nosso venerável pai Isidoro de Pelúsio nasceu em Alexandria de cristãos piedosos, parente dos arcebispos Teófilo e Cirilo, e recebeu a melhor educação da maior cidade douta daquela idade; e, ainda jovem, deixou o mundo, retirando-se para um mosteiro no monte perto de Pelúsio, na boca oriental do Nilo, onde com o tempo foi ordenado sacerdote e se tornou pai da comunidade, asceta da escola mais austera, que se revestiu, como escreveram seus admiradores, de toda a armadura do combate monástico.", "patron": "Invoca-se sua intercessão pelos que escrevem cartas; pelos diretores espirituais."},

"Venerable Isidore the Fool-For-Christ and Wonderworker of Rostov":
{"type": "Louco por Cristo · séc. XV", "life": "O bem-aventurado Isidoro Tverdislov, louco por Cristo e taumaturgo de Rostov, veio à Rússia e à santidade a partir do Ocidente latino, um dos lembretes do calendário de que a loucura por Cristo não conheceu uma só nação.", "patron": "A riqueza de uma casa estrangeira deixada por uma choça de ramos."},

"Venerable James, Abbot of Zheleznoborov":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Tiago de Jeleznoborov nasceu na segunda metade do século XIV da nobre linhagem dos Amosov, cujas terras ficavam perto de Galitch, na região de Kostroma, e, ainda moço, fez a escolha que o pôs dentro da maior linhagem espiritual de sua idade, indo ao mosteiro da Trindade e tornando-se discípulo de são Sérgio de Radonej.", "patron": "Invoca-se sua intercessão pelos discípulos de Sérgio; pelos fundadores em terra dura."},

"Venerable Joannicius the Great":
{"type": "Monge · séc. IX", "life": "Nosso venerável pai Joaniquio, o Grande, nasceu em 752 na aldeia bitínia de Marikat, de pais tão pobres que o menino não teve escola alguma, mas guardou o gado da família, enchendo de oração os pastos; e, chegado à força da idade, serviu com distinção por muitos anos como soldado do império, combatendo nas guerras búlgaras.", "patron": "Invoca-se sua intercessão pelos soldados que se fazem monges; pela penitência depois do erro."},

"Venerable Joasaph of Snetogorsk, Pskov":
{"type": "Igumeno e hieromártir · séc. XIII", "life": "Nosso venerável pai Joasaf, igumeno do mosteiro de Snetogorsk, perto de Pskov, padeceu com uma companhia de seus monges no assalto alemão que caiu sobre a terra de Pskov no fim do século XIII. Snetogorsk, dedicado à Natividade da Santíssima Mãe de Deus, era dos mais antigos mosteiros da região, e Joasaf o governava como um pai, guardando nele uma vida comum austera.", "patron": "Invoca-se sua intercessão pelos igumenos; pelos monges das casas cercadas pela guerra."},

"Venerable Job of Ushchelsk":
{"type": "Hieromonge · séc. XVII", "life": "Nosso venerável pai Jó, chamado o morador da garganta, foi monge do mosteiro de Solovki que no ano de 1608 foi ordenado hieromonge pelo metropolita Isidoro de Nóvgorod. Em 1614 foi enviado à região setentrional do Mezen, e ali, num lugar chamado Uchtchelie, onde o rio Ezega encontra o Mezen, fundou um ermo e ergueu uma igreja, reunindo em torno de si uma pequena irmandade naquele ermo remoto.", "patron": "Invoca-se sua intercessão pelos monges."},

"Venerable John Cassian the Roman":
{"type": "Igumeno e sacerdote · séc. V", "life": "Nosso venerável pai João Cassiano, o Romano, é o grande mensageiro do deserto, o homem que empacotou a sabedoria do Egito em dois livros e a levou ao Ocidente, e a Igreja lhe dá a festa mais rara de seu calendário, o dia vinte e nove de fevereiro, como que marcando que tais homens aparecem uma vez a cada longo intervalo.", "patron": "Invoca-se sua intercessão pelos monges do Ocidente; pelos que escrevem sobre a oração."},

"Venerable John Climacus of Sinai, Author of “the Ladder”":
{"type": "Venerável · séc. VII", "life": "Nosso venerável pai João Clímaco entrou ainda jovem no mosteiro do Sinai e viveu muitos anos em obediência e solidão. Escolhido depois igumeno do Sinai, escreveu a Escada da Ascensão Divina, descrevendo a subida da alma para Deus pela penitência e pela virtude. Venerado como mestre dos monges, repousou no século VII."},

"Venerable John of Damascus":
{"type": "Hieromonge · séc. VIII", "life": "Nosso venerável pai João Damasceno, o último dos grandes padres da Igreja antiga e o primeiro cantor de sua teologia acabada, nasceu por volta de 675 em Damasco, filho de um alto funcionário cristão na corte do califa; educado junto com seu irmão adotivo Cosme por um monge douto resgatado do cativeiro, dominou toda a sabedoria dos gregos e sucedeu ao pai no cargo sob o domínio sarraceno.", "patron": "Invoca-se sua intercessão pelos teólogos; pelos hinógrafos."},

"Venerable John of the Ancient Caves in Palestine":
{"type": "Monge · séc. IX", "life": "Nosso venerável pai João das Cavernas Antigas, chamado nos livros gregos o Paleolavrita, foi monge e sacerdote da Velha Lavra, no deserto de Judá, o mosteiro das grutas de Souka fundado por nosso venerável pai Cáriton, o confessor, no século IV, a mais antiga de todas as casas do deserto, a que os monges das idades seguintes chamavam simplesmente a Velha Lavra, sendo o seu próprio nome uma genealogia.", "patron": "Invoca-se sua intercessão pelos sacerdotes do deserto; pelos peregrinos que ficam."},

"Venerable John the Anchorite of Egypt":
{"type": "Anacoreta · séc. IV", "life": "Nosso venerável pai João, o anacoreta do Egito, é comemorado neste dia entre os padres do deserto cujos nomes a Igreja guardou enquanto os desertos guardavam as suas histórias, um da grande hoste anônima dos anacoretas, os homens que saíram para além mesmo dos esquetes e das lavras, para a solidão total, e cuja vocação era, por sua própria definição, não deixar testemunhas.", "patron": "Invoca-se sua intercessão pelos eremitas; pelos escondidos."},

"Venerable John the Clairvoyant, Anchorite, of Egypt":
{"type": "Anacoreta · séc. IV", "life": "Nosso venerável pai João, o clarividente, o grande anacoreta de Licópolis, na Tebaida egípcia, era artesão na juventude, ajudante de construtor, que deixou o mundo ainda moço e, depois de anos de formação sob os anciãos, se emparedou, por volta de seus quarenta anos, numa cela que preparara no rochedo acima de Licópolis, três pequenas câmaras muradas.", "patron": "Invoca-se sua intercessão pelos reclusos; pelos conselheiros dos governantes."},
...
{"type": "Mártir · séc. XVII", "life": "Neste dia a Igreja comemora a trasladação das relíquias de nosso venerável pai Macário, hieromártir, arquimandrita de Ovrutch e de Pinsk, cuja festa principal cai em setembro e cujo martírio coroou uma vida gasta em segurar seu povo na fé ortodoxa através das tormentas do século XVII.", "patron": "O rebanho de Ovrutch e de Pinsk guardado na fé."},

"Venerable Macrina, sister of Saint Basil the Great":
{"type": "Igumena · séc. IV", "life": "A venerável Macrina, a Jovem, era a irmã mais velha dos grandes hierarcas Basílio, o Grande, e Gregório de Nissa, nascida na Capadócia no princípio do século IV numa família que haveria de dar muitos santos à Igreja. Antes de seu nascimento, sua mãe, santa Emélia, viu em sonho um anjo que deu à criança o nome de Tecla, em memória da santa protomártir, e assim foi este o seu nome secreto, ainda que a chamassem Macrina em memória de sua avó, que padecera nas perseguições.", "patron": "Invoca-se sua intercessão pelas monjas; pelos monges."},

"Venerable Makarios, Abbot of Zheltovod and Unzha":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Macário nasceu no ano de 1349 em Nijni Nóvgorod, de pais piedosos, e aos doze anos deixou sua casa e foi tonsurado monge no mosteiro das Cavernas da Ascensão sob o santo igumeno Dionísio, entregando-se com o fervor da juventude à obra da salvação.", "patron": "Invoca-se sua intercessão pelos monges; pelos cativos."},

"Venerable Martha, mother of Saint Simeon Stylites":
{"type": "Santa · séc. V", "life": "A venerável Marta, mãe de são Simeão, o estilita, viveu na Cilícia nos séculos IV e V e vinha de família pobre, e com seu marido Sisotion criou o filho que haveria de ser o assombro de sua idade. Quando Simeão foi tonsurado monge sem que seus pais o soubessem e subiu à sua coluna, Marta veio anos depois desejando vê-lo.", "patron": "Invoca-se sua intercessão pelas mães."},

"Venerable Martha, mother of Venerable Simeon Stylites the Younger":
{"type": "Leiga · séc. VI", "life": "A venerável Marta, mãe de são Simeão, o estilita, o Novo, viveu no século VI e era natural de Antioquia. Desde a juventude desejou a vida monástica, mas por vontade de seus pais casou-se; seu marido João morreu cedo, e ela deu toda a sua força à criação do filho em santidade, tornando-se para ele um exemplo de virtude cristã.", "patron": "Invoca-se sua intercessão pelas mães e por seus filhos."},

"Venerable Martyrius of Zelenets, Pskov":
{"type": "Igumeno · séc. XVII", "life": "Nosso venerável pai Martírio de Zelenets, no mundo Menas, nasceu em Veliki Luki no século XVI, dos piedosos Cosme e Estefânida, e ficou órfão aos dez anos; o menino foi criado por seu pai espiritual, um sacerdote da igreja da Anunciação da cidade, e sua alma, registra a vida, apegou-se a Deus a partir daquela criação na perda, aprendendo o órfão cedo que um Pai não morre.", "patron": "Invoca-se sua intercessão pelos órfãos; pelos fundadores."},

"Venerable Martyrius the Deacon, Recluse of the Kyiv Caves":
{"type": "Diácono · séc. XIV", "life": "Nosso venerável pai Martírio, o diácono, trabalhou no mosteiro das Cavernas de Kyiv no século XIV, servindo aos ofícios divinos na ordem do diaconato e adornando seu ministério com o jejum, a pureza e a oração incessante. Tal ousadia diante de Deus lhe foi dada que, como registra a tradição da lavra, quando orava por alguma coisa de pé sobre o ambão, o Senhor a concedia sem demora.", "patron": "Invoca-se sua intercessão pelos diáconos; pela oração que Deus ouve."},

"Venerable Mary (who was called Marinus), and her father, Venerable Eugene, at Alexandria":
{"type": "Monja · séc. VI", "life": "Nossa venerável mãe Maria, que se chamou Marino, e seu pai Eugênio são o assombroso estudo que a Igreja oferece sobre os limites extremos da paciência. Quando o viúvo Eugênio resolveu acabar seus dias num mosteiro, sua filha pequena Maria recusou ficar para trás no mundo, e os dois inventaram a única porta que os admitiria juntos: Maria cortou os cabelos, vestiu roupas de homem e entrou no mosteiro da Bitínia ao lado do pai como o jovem monge Marino.", "patron": "Invoca-se sua intercessão pelos falsamente acusados; pelas mulheres disfarçadas por Deus."},

"Venerable Mary of Egypt":
{"type": "Venerável · sécs. V-VI", "life": "Nossa venerável mãe Maria Egipcíaca, meretriz de Alexandria que, impedida por um poder invisível de entrar na igreja em Jerusalém, arrependeu-se diante do ícone da Mãe de Deus e retirou-se para o deserto além do Jordão. Ali viveu quarenta e sete anos em ascese extrema, alcançando grande santidade. Descoberta pelo ancião Zósimas, recebeu a Comunhão e repousou pouco depois. É a imagem suprema da penitência.", "patron": "Modelo de penitência e de conversão; comemora-se no quinto domingo da Grande Quaresma."},

"Venerable Matrona of Chios":
{"type": "Monja · séc. XV", "life": "A venerável Matrona de Quios nasceu na aldeia de Volissos, naquela ilha, de pais ricos e devotos chamados Leão e Ana, e no mundo se chamava Maria. Inclinada desde a juventude à vida monástica, fugiu do casamento que sua família lhe destinava e retirou-se para um lugar solitário da ilha, entregando-se ao jejum e à oração.", "patron": "Invoca-se sua intercessão pelas monjas; pela virgindade."},

"Venerable Matrona, Abbess of Constantinople":
{"type": "Monja · séc. V", "life": "A venerável Matrona de Constantinopla nasceu em Perge, na Panfília, e foi dada em casamento a um nobre chamado Domeciano, a quem deu uma filha; e, chegando a Constantinopla, acendeu-se de tal modo de amor por Deus nas igrejas e nas vigílias da capital que, confiando sua filha a uma mulher piedosa, resolveu dar-se inteiramente ao Senhor.", "patron": "Invoca-se sua intercessão pelas igumenas; pelas monjas."},

"Venerable Melania the Younger of Rome":
{"type": "Monja · séc. V", "life": "A venerável Melânia, a Jovem, de Roma, nasceu na mais alta aristocracia do império, herdeira dos Valérios, senhora de propriedades na Itália, na Sicília, na Espanha, na África e na Bretanha, talvez a pessoa privada mais rica de sua idade.", "patron": "Invoca-se sua intercessão pelas herdeiras; pelas fundadoras de mosteiros."},

"Venerable Memnon the Wonderworker":
{"type": "Igumeno · séc. V", "life": "Nosso venerável pai Mêmnon, o taumaturgo, foi igumeno no Egito, formado desde a juventude em todo o currículo do deserto, o jejum, a vigília e a guarda dos pensamentos, até que, tendo governado primeiro a si mesmo, foi posto a governar os outros, e guiou sua irmandade com aquela mistura de severidade consigo e de mansidão com os fracos que marca os abbas autênticos.", "patron": "Invoca-se sua intercessão pelos igumenos; pelos marinheiros na tempestade."},

"Venerable Mercurius the Faster of the Kyiv Caves":
{"type": "Monge · séc. XIV", "life": "Nosso venerável pai Mercúrio, o jejuador, trabalhou na lavra das Cavernas de Kyiv no século XIV, e seu nome declara o seu combate: subjugou a carne por extrema abstinência, provando o alimento com tal contenção que o jejum se tornou nele não um exercício, mas uma natureza, gasto o corpo e resplandecente o espírito.", "patron": "Invoca-se sua intercessão pelos jejuadores; pela abstinência."},

"Venerable Methodius, Abbot of Peshnosha, Disciple of Venerable Sergius of Radonezh":
{"type": "Igumeno · séc. XIV", "life": "Nosso venerável pai Metódio, igumeno de Pechnocha, foi discípulo do grande são Sérgio de Radonej e um dos muitos fundadores de mosteiros que saíram de sob a direção de Sérgio para plantar a vida monástica por toda a terra russa.", "patron": "Invoca-se sua intercessão pelos discípulos dos santos fundadores; pelos que edificam mosteiros."},

"Venerable Micah, disciple of Venerable Sergius of Radonezh":
{"type": "Venerável · séc. XIV", "life": "Nosso venerável pai Miqueias de Radonej foi o servidor de cela de são Sérgio, e toda a sua biografia é uma só noite, preparada por uma vida inteira de pequenez.", "patron": "A visita da Mãe de Deus contemplada."},

"Venerable Michael Maleinos":
{"type": "Igumeno · séc. X", "life": "Nosso venerável pai Miguel Maleino nasceu na Capadócia de pais nobres e devotos e recebeu o nome de Manuel, e, sendo parente das grandes famílias do império, estava destinado a uma carreira brilhante na corte imperial. E todavia, ainda moço, deixou o mundo e suas honras e, retirando-se para o monte Kiminas, na Bitínia, foi tonsurado monge e entregou-se a uma vida de austera ascese sob um ancião experiente.", "patron": "Invoca-se sua intercessão pelos monges; pela vida monástica."},

"Venerable Moses the Ethiopian of Scete":
{"type": "Hieromonge · séc. V", "life": "Nosso venerável pai Moisés, chamado o Negro, viveu no Egito no século IV. Etíope de nascimento e escravo na juventude, foi expulso por seu senhor depois de cometer um homicídio, e juntou-se a um bando de salteadores que, por sua grande força e ousadia, o fizeram seu chefe, de modo que seu nome se tornou um terror por toda a região por seus roubos e suas mortes.", "patron": "Invoca-se sua intercessão pelos monges; pela penitência."},

"Venerable Moses the Hungarian of the Kyiv Near Caves":
{"type": "Monge · séc. XI", "life": "Nosso venerável pai Moisés, húngaro de nascimento e irmão de são Efrém de Novy Torg, entrou com seus irmãos no serviço do santo príncipe Bóris, o portador da paixão. Quando Bóris foi assassinado junto ao rio Alta no ano de 1015, e um dos irmãos morto com ele, Moisés fugiu e achou refúgio em Kyiv.", "patron": "Invoca-se sua intercessão pela castidade; pelos tentados pela luxúria."},

"Venerable Moses, Wonderworker of the Kyiv Caves":
{"type": "Monge · séc. XIV", "life": "Nosso venerável pai Moisés viveu no mosteiro das Cavernas de Kyiv nos séculos XIII e XIV e deu-se inteiramente a Deus. Trazia pesadas cadeias e carregava sobre si uma grande cruz de cobre, e seu trabalho constante e amado era o canto dos Salmos e as inumeráveis prostrações, com que cansava o corpo em favor da alma.", "patron": "Invoca-se sua intercessão pelo trabalho ascético; pela salmodia."},

"Venerable Neilos the Ascetic of Sinai":
{"type": "Hieromonge · séc. V", "life": "Nosso venerável pai Nilo, o asceta do Sinai, era homem de alta posição em Constantinopla, prefeito da capital, casado e pai de dois filhos, e discípulo de são João Crisóstomo, cujo ensino acendeu nele o desejo da vida angélica. Com o consentimento de sua mulher, a família dividiu-se por Deus.", "patron": "Invoca-se sua intercessão pelos escritores; pelos diretores espirituais."},

"Venerable Nestor the Chronicler of the Kyiv Caves":
{"type": "Diácono · séc. XII", "life": "Nosso venerável pai Nestor, o Cronista, pai da história russa, nasceu em Kyiv por volta do ano de 1050 e veio aos dezessete anos a são Teodósio, no mosteiro das Cavernas, recebendo a tonsura sob seu sucessor Estêvão, que também o ordenou hierodiácono. Adornado de profunda humildade, que respira em cada página que escreveu, tinha-se pelo menor de todos.", "patron": "Invoca-se sua intercessão pelos historiadores; pelos cronistas."},

"Venerable Nicholas Sviatosha Prince of Chernihiv, and Wonderworker of the Kyiv Near Caves":
{"type": "Príncipe · séc. XII", "life": "Nosso venerável pai Nicolau Sviatocha, príncipe de Tchernígov e taumaturgo das Cavernas de Kyiv, era bisneto de Iaroslav, o Sábio, e filho do príncipe Davi de Tchernígov, e governou como príncipe de Lutsk, tendo mulher e filhos. A dezessete de fevereiro de 1106, deixando família e principado, foi tonsurado no mosteiro das Cavernas de Kyiv, o primeiro dos príncipes da Rus a trocar a coroa pelo capuz.", "patron": "Invoca-se sua intercessão pelos porteiros; pelos jardineiros."},

"Venerable Nicholas the Monk of Bulgaria":
{"type": "Monge · séc. IX", "life": "Nosso venerável pai Nicolau, o soldado, chamado também o comandante, serviu no exército imperial na campanha que o imperador Nicéforo conduziu à Bulgária no ano de 811, e sua santidade se decidiu numa só noite de marcha. Hospedado numa estalagem, foi assaltado não por um inimigo, mas por uma tentação, vindo a ele na escuridão a filha do estalajadeiro.", "patron": "Invoca-se sua intercessão pelos soldados; por todos os que resistem à tentação na véspera da batalha."},

"Venerable Niketas of the Kyiv Caves, Far Caves, Bishop of Novgorod":
{"type": "Bispo · séc. XII", "life": "São Nicetas, o recluso das Cavernas e bispo de Nóvgorod, é o grande estudo da Igreja sobre o engano e o restabelecimento, guardado no Patericon com honestidade inteira porque cada geração precisa dele. Jovem monge das Cavernas de Kyiv, Nicetas pediu ao igumeno, são Nícon, a façanha da reclusão.", "patron": "Invoca-se sua intercessão pelos enganados e restaurados; pelos estudantes que recomeçam."},

"Venerable Niketas the Confessor, Abbot of Medikion":
{"type": "Igumeno e confessor · séc. IX", "life": "Nosso venerável pai Nicetas, o confessor, igumeno do mosteiro de Medício, nasceu em Cesareia da Bitínia e, morrendo sua mãe quando ele era ainda de peito, foi criado na piedade por sua avó.", "patron": "Invoca-se sua intercessão pelos igumenos sob perseguição; pelos que caíram e voltaram."},

"Venerable Niketas the Stylite, Wonderworker of Pereyaslavl, Zalesski":
{"type": "Estilita · séc. XII", "life": "Nosso venerável pai Nicetas, o estilita de Pereiaslavl-Zaleski, foi um grande pecador feito grande santo, e é dos exemplos mais vivos que a Igreja guarda do poder de uma só palavra da Escritura para quebrar e refazer um coração endurecido.", "patron": "O coração do extorsionário quebrado pela palavra do profeta."},

"Venerable Nikon the Dry, of the Kyiv Near Caves":
{"type": "Monge · séc. XII", "life": "Nosso venerável pai Nícon, o Seco, das Cavernas Próximas, era filho de família rica e honrada de Kyiv, e a tudo renunciara pelas cavernas de santo Antônio; nas incursões dos cumanos que devastaram a lavra, foi levado cativo para a estepe. Seu captor pôs por ele um grande resgate, sabendo da riqueza dos seus.", "patron": "Invoca-se sua intercessão pelos cativos; pelos prisioneiros de guerra."},

"Venerable Nikon, Abbot of Radonezh, disciple of Venerable Sergius":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Nícon de Radonej, discípulo e sucessor de são Sérgio, nasceu em Iúriev-Polski e veio ainda moço ao grande ancião, que, provando sua humildade, o enviou primeiro a seu discípulo Atanásio, em Serpukhov; ali Nícon foi tonsurado e ordenado, e voltou por fim a Sérgio, que tanto o amou que o guardou em sua própria cela e, seis meses antes de sua dormição, retirando-se ao silêncio, o pôs sobre a irmandade.", "patron": "Invoca-se sua intercessão pelos igumenos; pelos que edificam."},

"Venerable Nikon, Abbot of the Kyiv Far Caves":
{"type": "Igumeno · séc. XI", "life": "Nosso venerável pai Nícon, igumeno das Cavernas de Kyiv, a quem a tradição da lavra chama o Grande, veio à caverna de santo Antônio já sacerdote, o primeiro dessa dignidade na pequena irmandade sob a colina, e tornou-se a mão direita do fundador: foi pela mão sacerdotal de Nícon, com a bênção de Antônio, que os primeiros irmãos receberam a tonsura, e entre eles o jovem Teodósio, de modo que o pai do monaquismo cenobítico russo entrou na vida angélica pelas mãos de Nícon, o sacerdote silencioso posto na nascente de tudo o que as Cavernas vieram a ser.", "patron": "Invoca-se sua intercessão pelos que tonsuram e formam monges; pelos cronistas."},

"Venerable Nilus of Stolbensk Lake":
{"type": "Monge · séc. XVI", "life": "Nosso venerável pai Nilo de Stolobensk, dos mais severos ascetas do norte russo, nasceu nas terras de Nóvgorod e foi tonsurado no mosteiro de Krypetsk, de são Sava, perto de Pskov; e ardendo pela solidão, viveu treze anos como eremita na mata junto ao rio Seremlia, em jejum, oração e combate com os demônios e com os salteadores, que afugentou, dizem os relatos, só com sua oração.", "patron": "Invoca-se sua intercessão pelos eremitas; pela vigilância até a morte."},

"Venerable Nίkander Wonderworker of Pskov":
{"type": "Monge · séc. XVI", "life": "Nosso venerável pai Nicandro de Pskov, o habitante do ermo e taumaturgo, nasceu no ano de 1507 na aldeia de Videlebie, perto de Pskov, a mesma aldeia que dera à Igreja são Eufrosino, e no mundo chamou-se Nícon. Desde a infância desejava a vida ascética, e, tendo aprendido as letras e dado a sua parte aos pobres, retirou-se para o ermo junto ao rio Demianka, entre Pskov e Porkhov, onde depois de algum tempo recebeu a tonsura monástica com o nome de Nicandro, no mosteiro de Krypetsk.", "patron": "Invoca-se sua intercessão pelos eremitas; pela vida solitária."},

"Venerable Onesiphorus the Confessor of the Kyiv Near Caves":
{"type": "Hieromonge · séc. XII", "life": "Nosso venerável pai Onesíforo, o confessor, foi sacerdote e monge do mosteiro das Cavernas de Kyiv no século XII, ornado de jejum e de toda virtude, e dotado por Deus do dom de discernir os segredos dos corações; e todavia permitiu o Senhor que também este vidente fosse enganado, para instrução de todos.", "patron": "Invoca-se sua intercessão pelos confessores; pelos pais espirituais."},

"Venerable Onuphrius the Great":
{"type": "Monge · séc. IV", "life": "Nosso venerável pai Onofre, o Grande, foi dos mais célebres eremitas do deserto do Egito, anacoreta que passou sessenta anos em inteira solidão no fundo do ermo, a sós com Deus.", "patron": "Invoca-se sua intercessão pelos eremitas e anacoretas; pelos que habitam a sós com Deus."},

"Venerable Onuphrius the Silent and Venerable Onesimos the Recluse, of the Kyiv Caves":
{"type": "Monge · séc. XIII", "life": "Os veneráveis Onofre, o Silencioso, e Onésimo, o recluso, foram ascetas das Cavernas de Kyiv que lutaram nas Cavernas Próximas da lavra nos séculos XII e XIII. Onofre é chamado o Silencioso pelo estrito silêncio que guardava, custodiando os lábios e o coração para comungar mais puramente com Deus, enquanto Onésimo se fechou como recluso, entregando-se todo à oração e à memória da morte na clausura de sua cela.", "patron": "Invoca-se sua intercessão pelo silêncio; pela reclusão."},

"Venerable Pachomius the Great, Founder of Coenobitic Monasticism":
{"type": "Venerável · séc. IV", "life": "Nosso venerável pai Pacômio, o Grande, pai do monaquismo cenobítico, nasceu de pais pagãos por volta do ano de 292 na Tebaida Superior do Egito, e veio a Cristo pelo caminho do soldado.", "patron": "A vida comum recebeu dele a sua primeira regra escrita."},

"Venerable Paisios Velichkovsky":
{"type": "Arquimandrita · séc. XVIII", "life": "Nosso venerável pai Paísio Velitchkovski, pai da grande renovação do monaquismo ortodoxo, nasceu Pedro Velitchkovski em 1722, em Poltava, na Ucrânia, filho de um sacerdote de catedral; e deixando a Academia de Kyiv, cuja ciência escolástica não podia matar sua sede da tradição viva, buscou a Deus pelos mosteiros da Ucrânia e da Moldávia, até que, aos vinte e quatro anos, chegou ao Monte Santo do Atos.", "patron": "Invoca-se sua intercessão pelos tradutores; pelos pais espirituais."},

"Venerable Paisios the Athonite (1994)":
{"type": "Monge e ancião · séc. XX", "life": "Nosso venerável pai Paísio do Monte Santo, dos mais amados anciãos do século XX, nasceu Arsênio Eznepidis em 1924, em Farasa da Capadócia, e foi batizado por santo Arsênio da Capadócia, que predisse que a criança se faria monge. Trazido à Grécia ainda de colo na troca de populações, cresceu em Konitsa, trabalhou como carpinteiro e serviu de radiotelegrafista no exército durante a guerra civil, mostrando coragem e abnegação.", "patron": "Invoca-se sua intercessão pelos monásticos; pelos que estão em angústia."},

"Venerable Paisius the Great":
{"type": "Monge · séc. V", "life": "Nosso venerável pai Paísio, o Grande, foi dos mais elevados padres do deserto do Egito, asceta de abstinência e de oração extraordinárias, a quem foi dado ver o próprio Cristo.", "patron": "Invoca-se sua intercessão pelos ascetas e homens de oração; pelos que jejuam semanas inteiras."},

"Venerable Paisius, Abbot of Galich":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Paísio de Galitch foi igumeno do mosteiro da Dormição, na vila de Galitch, na terra de Kostroma, no século XV, e sua memória está ligada ao ícone milagroso Ovinov da Mãe de Deus, que era o tesouro de sua casa.", "patron": "O mosteiro da Dormição de Galitch apascentado."},

"Venerable Paisius, Abbot of Uglich":
{"type": "Igumeno · séc. XVI", "life": "Nosso venerável pai Paísio de Uglitch foi fundador da vida monástica no alto Volga, parente e discípulo de são Macário de Kaliazin, em cuja tradição se formou e que levou consigo para a sua própria fundação.", "patron": "Invoca-se sua intercessão pelos fundadores de mosteiros; pelos parentes e discípulos dos santos."},

"Venerable Palladius of Thessalonica":
{"type": "Monge · séc. VII", "life": "Nosso venerável pai Paládio de Tessalônica trabalhou na ascese naquela grande e santa cidade da Macedônia, no século VI ou VII, quando Tessalônica, guardada pelo grande mártir Demétrio, era fortaleza da Ortodoxia e mãe de monges. Renunciando ao mundo, Paládio tomou sobre si toda a milícia dos veneráveis: o jejum que aligeira o corpo, a vigília que arma a mente, a oração incessante que guarda o coração, e a profunda humildade que a todas coroa e resguarda.", "patron": "Invoca-se sua intercessão pelos monges; pela vida oculta."},

"Venerable Pambo the Recluse of the Kyiv Far Caves":
{"type": "Hieromonge · séc. XIII", "life": "Nosso venerável pai Pambo, hieromonge e recluso das Cavernas de Kyiv, foi confessor da fé nos dias das invasões tártaras. Estando ele em uma obediência do mosteiro, foi capturado e levado pelos tártaros, e por muitos anos suportou sua crueldade e suas exigências de que renegasse a Cristo, guardando firme a fé verdadeira em toda aflição.", "patron": "Invoca-se sua intercessão pela firmeza no cativeiro."},

"Venerable Paphnutius and Euphrosynē of Alexandria":
{"type": "Monges · séc. V", "life": "Nosso venerável pai Pafnúcio de Alexandria é comemorado neste dia com sua filha Eufrosina, cuja festa principal a Igreja guarda em setembro; a comemoração de fevereiro pertence sobretudo ao pai, e ao mais estranho consolo que há nas vidas dos santos. Pafnúcio era um cidadão rico e piedoso de Alexandria, cujo casamento longamente sem filhos foi respondido com uma única filha, Eufrosina, criada na piedade e prometida por ele a um jovem nobre.", "patron": "Invoca-se sua intercessão pelos pais de filhos consagrados; pelos pais dos que desapareceram."},

"Venerable Paphnutius the Recluse of the Kyiv Caves":
{"type": "Recluso · séc. XIII", "life": "Nosso venerável pai Pafnúcio, o recluso das Cavernas de Kyiv, trabalhou no século XIII nas Cavernas Distantes de são Teodósio, e a tradição da lavra o guarda por uma só façanha levada até o fim: Pafnúcio chorou. Fechando-se na reclusão, tomou por única meditação a memória da morte, que os padres põem por começo de toda compunção.", "patron": "Invoca-se sua intercessão pelos que choram; pelos que guardam a memória da morte."},

"Venerable Paphnutius, Abbot of Borov":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Pafnúcio, igumeno de Borovsk, trazia no sangue a resposta da Igreja ao jugo tártaro, pois seu avô fora baskak tártaro, cobrador dos tributos dos conquistadores sobre a terra russa, que veio à fé e foi batizado com o nome de Martinho.", "patron": "A linhagem tártara enxertada na santidade."},

"Venerable Paraskevi (Petka) of Serbia":
{"type": "Monja · séc. XI", "life": "A venerável Parascheva, chamada a Nova, a quem o povo sérvio dá com amor o nome de Sveta Petka, nasceu no século XI em Epivato, na Trácia, e deu sua juventude a Cristo, distribuindo as suas vestes e a sua herança aos pobres, trabalhando num mosteiro de Heracleia e vivendo como asceta no deserto do Jordão, até que um anjo lhe mandou voltar à sua pátria, onde repousou na obscuridade e foi glorificada por Deus com relíquias incorruptas e milagrosas.", "patron": "Invoca-se sua intercessão pelas mulheres; pelos enfermos."},
...
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Tíkhon de Kaluga, chamado também de Medin, foi eremita e fundador do século XV, que santificou com sua solidão as matas fundas da terra de Kaluga.", "patron": "Invoca-se sua intercessão pelos eremitas e amantes da solidão; pelos fundadores de mosteiros nas matas."},

"Venerable Tikhon of Luchov, Kostroma":
{"type": "Monge · séc. XVI", "life": "Nosso venerável pai Tíkhon de Lukhov, no mundo Timóteo, foi monge da terra de Kostroma que trocou o serviço de um príncipe terreno pelo serviço de Deus e viveu e morreu na pobreza que amava.", "patron": "Invoca-se sua intercessão pelos que deixam o mundo e o seu serviço; pelos pobres e pelos que trabalham."},

"Venerable Timothy of Symbola in Bithynia":
{"type": "Eremita · séc. VIII", "life": "Nosso venerável pai Timóteo de Símbola trabalhou no Olimpo da Bitínia, o monte santo da Ásia Menor cujas gargantas guardavam no século VIII uma república de mosteiros que só os desertos antigos excediam, e entre as suas comunidades a que se chamava Símbola o recebeu moço e o guardou até o fim.", "patron": "Invoca-se sua intercessão pelos monges de pureza; pelos exorcistas."},

"Venerable Titus the Presbyter of the Kyiv Near Caves":
{"type": "Hieromonge · séc. XII", "life": "Nosso venerável pai Tito, o presbítero das Cavernas Próximas de Kyiv, é a parábola das Cavernas sobre o perdão, o irmão russo do antigo Nicéforo, e o Patericon conta sua história como quem lavra o auto de um juízo de Deus. Tito, sacerdote do mosteiro, e Evágrio, diácono, tinham sido amigos tão chegados que os irmãos tomavam por modelo o amor dos dois.", "patron": "Invoca-se sua intercessão pelos que se estranharam; pelos sacerdotes em contendas."},

"Venerable Titus the Soldier, of the Kyiv Caves":
{"type": "Monge · séc. XIV", "life": "Nosso venerável pai Tito, o soldado, das Cavernas de Kyiv, veio a Deus pelo caminho de muitos guerreiros, uma ferida: homem de armas do século XIV, recebeu na batalha um golpe na cabeça tão grave que lhe pôs fim à milícia, e a lesão que lhe fechou a carreira lhe abriu a eternidade.", "patron": "Invoca-se sua intercessão pelos soldados que se fizeram monges; pelos veteranos."},

"Venerable Titus the Wonderworker":
{"type": "Igumeno · séc. IX", "life": "Nosso venerável pai Tito, o taumaturgo, ardeu do amor de Cristo desde a infância, e entrando moço num cenóbio, entregou-se à vida comum com uma inteireza que os sinaxários registram como sua marca: na humildade e na obediência, testemunha o sinaxário bizantino, excedeu a todos os monges de sua comunidade, disputando o moço o último lugar como outros disputam o primeiro, e guardando-se desde a juventude tão casto de corpo e de espírito como um anjo de Deus.", "patron": "Invoca-se sua intercessão pelos monges da vida comum; pelos obedientes."},

"Venerable Tryphon, Abbot of Vyatka":
{"type": "Arquimandrita · séc. XVII", "life": "Nosso venerável pai Trifon de Viatka nasceu de família camponesa nas terras de Mezen, no extremo norte, e fugindo na juventude do casamento que os seus lhe destinavam, andou como peregrino sem casa, suportando o frio e o escárnio pelo amor de Deus, até que recebeu a tonsura monástica no mosteiro de Pyskor, junto ao Kama.", "patron": "Invoca-se sua intercessão pelos missionários; pela iluminação dos povos do norte."},

"Venerable Xenophon, Abbot of Robeika, Novgorod":
{"type": "Igumeno · séc. XIII", "life": "Nosso venerável pai Xenofonte de Robeika foi discípulo de são Varlaam de Khutyn e fundador da vida monástica perto de Nóvgorod, e desde moço escolheu o caminho da pureza e da oração.", "patron": "Invoca-se sua intercessão pelos discípulos dos santos anciãos; pelos fundadores de mosteiros."},

"Venerable Xenophon, his wife, Mary, and their two sons, Arcadius and John, of Constantinople":
{"type": "Monásticos · séc. VI", "life": "Os veneráveis Xenofonte, sua mulher Maria e seus filhos Arcádio e João foram cidadãos notáveis de Constantinopla nos séculos V e VI, ricos de bens e de posição e, insiste o relato, mais ricos ainda de simplicidade de alma e de bondade de coração, uma grande casa que Deus quis trasladar inteira para o calendário.", "patron": "Invoca-se sua intercessão pelas famílias; pelos pais dos que se perderam."},

"Venerable Zachariah the Recluse":
{"type": "Monge e recluso · séc. IX", "life": "Nosso venerável pai Zacarias, o recluso, é comemorado neste dia, e o próprio sinaxário bizantino confessa com honesto cuidado que, entre os muitos santos que levam o nome de Zacarias, não se pode determinar ao certo qual deles a Igreja honra aqui, guardando somente a crença recebida de que viveu a vida da clausura num mosteiro de Constantinopla, junto à porta de Cársia.", "patron": "Invoca-se sua intercessão pelos reclusos; pelos escondidos."},

"Venerable Zeno the Faster, of the Kyiv Caves":
{"type": "Monge · séc. XIV", "life": "Nosso venerável pai Zenão, o jejuador e amigo do trabalho, das Cavernas Distantes de Kyiv, viveu no século XIV, e os dois títulos que a lavra lhe deu são toda a sua biografia, exatos e bastantes: o jejuador e o amigo do trabalho. Nas cavernas de são Teodósio, nas duras gerações que vieram depois da ruína mongol, Zenão travou o combate dobrado.", "patron": "Invoca-se sua intercessão pelos jejuadores; pelos trabalhadores."},

"Venerable Zeno the Hermit of Antioch, disciple of Saint Basil the Great":
{"type": "Eremita · séc. V", "life": "Nosso venerável pai Zenão, o eremita de Antioquia, nasceu no Ponto de família rica e serviu na corte do imperador Valente entre os correios que levavam os éditos imperiais por todo o império, homem cuja profissão eram a pressa, as estradas e as palavras do poder; e fora formado na juventude por são Basílio, o Grande, de quem era discípulo, de sorte que sob a capa do correio já cavalgava um monge.", "patron": "Invoca-se sua intercessão pelos correios; pelos mensageiros."},

"Venerable Zosimas, Abbot of Solovki":
{"type": "Igumeno · séc. XV", "life": "Nosso venerável pai Zósimo, igumeno de Solovki, completou a plantação que Sabácio e Germano tinham começado nas ilhas do mar Branco, e está com eles como fundador do grande mosteiro na beira do mundo habitado. Novgorodense que dera sua herança pelo ermo, Zósimo encontrou o ancião Germano, companheiro do falecido Sabácio.", "patron": "Invoca-se sua intercessão pelos monásticos das ilhas; pelos fundadores nos lugares extremos."},

"Venerable Zosimas, Abbot of Vorbozomsk":
{"type": "Igumeno · séc. XVI", "life": "Nosso venerável pai Zósimo de Vorbozomsk pertence à grande dispersão da Tebaida do norte, às gerações em que os discípulos dos anciãos do Lago Branco e de Komel levaram a vida monástica para fora, lago por lago, aos ermos além de Belozersk.", "patron": "Invoca-se sua intercessão pelos monásticos das ilhas; pelos discípulos dos grandes anciãos."},

"Virgin Martyr Anysia at Thessalonica":
{"type": "Virgem mártir · séc. III", "life": "A santa virgem mártir Anísia viveu em Tessalônica no reinado de Maximiano, filha órfã de pais piedosos que a haviam criado na fé; e herdando os bens deles, vendeu tudo, distribuiu o preço aos pobres e entregou-se a uma vida escondida de jejum, vigília e oração, um mosteiro de uma só alma na grande cidade pagã.", "patron": "Invoca-se sua intercessão pelas moças; pelas que são acossadas a caminho da igreja."},

"Virgin Martyr Eulalia of Barcelona and the Martyr Felix":
{"type": "Mártires · séc. IV", "life": "A santa virgem mártir Eulália vivia perto da cidade de Barcelona, na Espanha, e foi criada por seus pais na piedade e na fé cristã, de modo que, ainda donzela, se entregava à oração, à leitura das Escrituras e ao trabalho quieto de casa. Quando, na perseguição de Diocleciano, o governador Daciano veio a Barcelona destruir os cristãos, Eulália, ainda que menina, saiu de casa às escondidas, de noite, e pela manhã pôs-se diante do governante para confessar a Cristo e repreendê-lo por adorar ídolos.", "patron": "Invoca-se sua intercessão pelas moças; pela pureza."},

"Virgin Martyr Eupraxia of Tabenna":
{"type": "Monja · séc. V", "life": "A venerável Eupráxia era filha de Antígono, nobre dignitário de Constantinopla e parente do imperador Teodósio, o Grande, e de sua piedosa mulher, chamada também Eupráxia, que eram generosos em suas esmolas. Morto o pai, a mãe levou a menina para o Egito, e ali a criança, com apenas sete anos, sentiu-se de tal modo atraída à vida de um mosteiro de mulheres perto de Tabenisi que pediu para ficar entre as monjas, e foi recebida.", "patron": "Invoca-se sua intercessão pelas monjas; pela virgindade."},

"Virgin Martyr Euthalia of Sicily":
{"type": "Virgem mártir · séc. III", "life": "A santa virgem mártir Eutália da Sicília vivia com sua mãe e seu irmão em Leontinos, e sua breve vida virou inteira sobre o sonho de uma noite, no sono de outra mulher. Sua mãe, pagã, padecia havia longos anos de um fluxo de sangue que nenhum médico podia estancar, o mal da mulher do Evangelho posto sobre uma mulher que nunca ouvira o Evangelho.", "patron": "Invoca-se sua intercessão pelas filhas de casas divididas; pelos recém-batizados."},

"Virgin Martyr Febronia of Nisibis":
{"type": "Venerável mártir · séc. IV", "life": "A venerável mártir Febrônia de Nísibis era jovem monja da Mesopotâmia, e padeceu por Cristo um martírio de tormentos terríveis na perseguição de Diocleciano, e sua vida se tornou modelo amado de virgindade e de coragem.", "patron": "Invoca-se sua intercessão pelas monjas e virgens; pelos que suportam tormentos terríveis."},

"Virgin Martyr Glyceria at Heraclea":
{"type": "Mártir · séc. II", "life": "A santa virgem mártir Gliceria, cujo nome quer dizer doçura, padeceu em Heracleia da Trácia sob o imperador Antonino, em meados do século II, e agora, como canta a Igreja, alegra-se na doçura sem fim do Reino.", "patron": "A cruz traçada na fronte diante do ídolo."},

"Virgin Martyr Irais (Rhais) of Alexandria":
{"type": "Mártir · séc. IV", "life": "A santa mártir Iráis, chamada também Raís, era donzela de Alexandria, no Egito. Saindo um dia a tirar água ao poço, viu junto à praia um navio cheio de confessores de Cristo, sacerdotes, diáconos, monges e virgens, presos em cadeias pelos perseguidores.", "patron": "Invoca-se sua intercessão pela confissão voluntária; pela coragem."},

"Virgin Martyr Julia of Carthage":
{"type": "Virgem", "life": "Santa Júlia era donzela nobre e piedosa de Cartago, no norte da África, e, caindo a cidade em poder de seus inimigos, foi levada e vendida como escrava. Servindo a seu senhor com fidelidade e humildade, dava todas as suas horas livres à oração e ao jejum, e não se deixava apartar de sua fé em Cristo.", "patron": "Invoca-se sua intercessão pelos cativos; pela pureza."},

"Virgin Martyr Juliana of Nicomedia, and 500 men and 130 women with her":
{"type": "Virgem mártir · séc. IV", "life": "A santa virgem mártir Juliana de Nicomédia padeceu no ano de 304, na perseguição de Diocleciano e Maximiano, e com ela uma seara que a sua própria coragem semeara. Filha do pagão Africano e prometida contra a sua vontade ao senador Eleúsio, a cristã secreta ia adiando o casamento com condições, e quando pôs por fim a verdadeira, que não se casaria com homem que não adorasse o seu Deus, o pretendente rejeitado, agora elevado a eparca da cidade, tornou-se seu juiz.", "patron": "Invoca-se sua intercessão pelas noivas; pelas moças."},

"Virgin Martyr Lucy of Syracuse":
{"type": "Virgem mártir · séc. IV", "life": "A santa virgem mártir Luzia de Siracusa, cujo nome quer dizer luz, padeceu na Sicília no ano de 304, na grande perseguição de Diocleciano, e desde então sua festa tem levado luz aos dias mais escuros do inverno. Indo com sua mãe Eutíquia, que padecia de um fluxo de sangue, orar ao túmulo de santa Ágata em Catânia, Luzia viu a mártir numa visão, e sua mãe foi curada junto ao sepulcro.", "patron": "Invoca-se sua intercessão pelos cegos; pelos que trabalham à luz de candeia."},

"Virgin Martyr Pelagia of Tarsus, in Asia Minor":
{"type": "Mártir · séc. IV", "life": "A santa virgem mártir Pelágia de Tarso foi buscada pela graça antes de buscá-la: donzela de família nobre na Cilícia, na virada do século IV, ouvira falar da fé cristã e desejava sinceramente conhecer o seu ensino.", "patron": "O batismo buscado por meio de um sonho."},

"Virgin Martyr Seraphima (Serapia) of Antioch":
{"type": "Virgem · séc. II", "life": "A santa virgem mártir Serafima era natural de Antioquia e vivia em Roma no reinado do imperador Adriano, na casa de Sabina, nobre senhora senatorial que ela trouxera à fé em Cristo. Quando se levantou a perseguição, o governador Virilo a chamou, e desejando ela a coroa do martírio, foi a ele sem medo, com a sua fiel Sabina ao lado.", "patron": "Invoca-se sua intercessão pela pureza; pela confissão firme."},

"Virgin Martyr Theodosia the Nun of Constantinople":
{"type": "Mártir · séc. VIII", "life": "A santa virgem mártir Teodósia de Constantinopla era monja da cidade imperial e deu a vida em defesa dos santos ícones no próprio irromper da heresia iconoclasta, uma das primeiras mártires daquela longa perseguição.", "patron": "O ícone de Cristo sobre a porta de Calce defendido."},

"Virgin Martyrs Agape, Irene and Chionia, in Illyria":
{"type": "Virgens mártires · séc. IV", "life": "As santas virgens mártires Ágape, Irene e Quiônia eram três irmãs cujo combate em Tessalônica, no ano de 304, a Igreja conhece pelas próprias atas de seu julgamento, entre os documentos autênticos mais preciosos da idade dos mártires.", "patron": "Invoca-se sua intercessão pelas irmãs; pelos que guardam as Escrituras."},

"Virgin Martyrs Alexandria, Claudia, Euphrasia, Matrona, Juliana, Euphemia, and Theodora":
{"type": "Virgens mártires · séc. IV", "life": "As santas virgens mártires Alexandria, Cláudia, Eufrásia, Matrona, Juliana, Eufêmia e Teodósia padeceram juntas em Amiso, na costa do mar Negro, no Ponto, no ano de 310, no último furor da perseguição de Maximiano, quando as províncias do Oriente foram peneiradas casa por casa em busca dos cristãos que os éditos anteriores não haviam alcançado.", "patron": "Invoca-se sua intercessão pelas companhias de mulheres; pelas que ficam firmes juntas."},

"Yaroslavl-Pechersk (Caves) Icon of the Mother of God":
{"type": "Festa · séc. XIX", "life": "Neste dia a Igreja comemora o milagroso ícone de Iaroslavl das Cavernas da Santíssima Mãe de Deus, imagem do tipo das Cavernas de Kyiv que foi glorificada na cidade de Iaroslavl no século XIX por uma cura notável.", "patron": "Invoca-se sua intercessão pelos enfermos de corpo e de alma; pelos que padecem longa doença."},

"“Bogolyubov” Icon of the Mother of God":
{"type": "Festa · séc. XII", "life": "Neste dia a Igreja comemora o milagroso ícone de Bogoliubovo da Santíssima Mãe de Deus, imagem única entre os ícones da Mãe de Deus, pois a mostra não com seu Filho, mas como ela mesma apareceu numa visão, de pé e sozinha, em oração.", "patron": "Invoca-se sua intercessão pelos que contemplam a Mãe de Deus em oração; pelos que edificam igrejas por ordem dela."},

"“Chukhloma” Icon of the Mother of God from Galich":
{"type": "Festa · séc. XIV", "life": "O ícone de Tchukhloma da Mãe de Deus, chamado também ícone de Galitch e pertencente ao tipo da Ternura, apareceu no ano de 1350 a são Abrâmio de Galitch, que viera ao ermo do norte para os trabalhos ascéticos com a bênção de são Sérgio de Radonej. Nas margens bravias do lago de Galitch, junto a um grande monte escondido em mata cerrada, são Abrâmio orava à Mãe de Deus por sua bênção sobre o que empreendia, e viu sobre o monte o seu santo ícone resplandecendo com uma luz que se não pode descrever.", "patron": "Invoca-se sua intercessão pela ternura; pela intercessão materna."},

"“Enlightener of Minds” Icon of the Mother of God":
{"type": "Festa", "life": "O ícone da Mãe de Deus chamado Iluminador das Mentes mostra a Santíssima Mãe de Deus com seu Filho divino, que é a fonte de toda sabedoria e de todo entendimento. Diante desta imagem os fiéis oram pela iluminação da mente e do coração pela verdade de Deus, e os pais cujos filhos custam a aprender, seja nas coisas da fé, seja no saber do mundo, suplicam à Mãe de Deus que a mente de seus filhos seja fortalecida e que retenham o que lhes é ensinado.", "patron": "Invoca-se sua intercessão pelos estudantes; pelas crianças que custam a aprender."},

"“Kozel'shchansk” Icon of the Mother of God":
{"type": "Festa · séc. XIX", "life": "O ícone de Kozelchtchina da Mãe de Deus, um dos últimos grandes ícones milagrosos revelados antes da catástrofe russa, era o ícone de família dos condes Kapnist, em sua propriedade de Kozelchtchina, na terra de Poltava, imagem de feitio italiano havia muito na casa, que mostra a Mãe de Deus com o Menino e, ao lado deles, uma taça com uma colher, donde os enfermos sempre leram nela uma promessa de remédio vindo do céu.", "patron": "Invoca-se sua intercessão pelos paralíticos; pelas meninas e moças."},

"“O All-Hymned Mother” Icon of the Mother of God":
{"type": "Festa", "life": "O ícone da Mãe de Deus chamado Ó Mãe digna de todo louvor toma o nome das primeiras palavras do décimo terceiro contácio do hino Acatisto, em que a Igreja saúda a Mãe digna de todo louvor que deu à luz o Verbo, o mais santo de todos os santos; e neste dia se celebra.", "patron": "Invoca-se sua intercessão pelo louvor da Mãe de Deus; pelo socorro em toda necessidade."},

"“Our Lady of Sitka” Icon of the Mother of God":
{"type": "Festa · séc. XIX", "life": "O ícone de Sitka da Mãe de Deus está entre os mais venerados da América do Norte, entronizado na catedral de São Miguel Arcanjo, em Sitka, no Alasca. Atribui-se ao célebre iconógrafo russo Vladímir Borovikovsky e chegou ao Alasca nos primeiros dias da missão ortodoxa, onde tem sido honrado como imagem milagrosa e protetora dos fiéis na América.", "patron": "Invoca-se sua intercessão pela proteção da América do Norte."},

"“Ozerianka” Icon of the Mother of God of Shuiu-Smolensk":
{"type": "Festa · séc. XVII", "life": "Neste dia a Igreja comemora o ícone de Chuia e Smolensk da Santíssima Mãe de Deus, pintado na vila de Chuia nos anos de 1654 e 1655, quando uma peste mortal devastava as vilas da Rússia. O povo de Chuia, voltando-se para a Mãe de Deus como seu último refúgio, encomendou a um iconógrafo que pintasse a Hodegetria de Smolensk para sua igreja paroquial da Ressurreição.", "patron": "Invoca-se sua intercessão pelo livramento da peste; pela proteção nas epidemias."},

"“Seven Arrows” Icon of the Mother of God":
{"type": "Festa · séc. XVIII", "life": "Neste dia a Igreja comemora o milagroso ícone das Sete Setas da Santíssima Mãe de Deus, imagem que mostra a dor da Mãe de Deus e a que se recorre para o abrandamento dos corações endurecidos.", "patron": "Invoca-se sua intercessão pelos que buscam o abrandamento dos corações duros; pelos que reconciliam inimigos."},

"“Surety of Sinners” Icon of the Mother of God of Korets":
{"type": "Festa · séc. XIX", "life": "Neste dia a Igreja comemora o milagroso ícone da Santíssima Mãe de Deus chamado a Fiadora dos Pecadores, na versão venerada em Korets, imagem cujo próprio nome proclama a misericórdia da Mãe de Deus para com os que se arrependem.", "patron": "Invoca-se sua intercessão pelos pecadores que buscam a intercessão da Mãe de Deus; pelos que se arrependem."},

"“Svena” Icon of the Mother of God":
{"type": "Festa · séc. XIII", "life": "Neste dia a Igreja comemora o ícone de Svena da Santíssima Mãe de Deus, um dos tesouros da tradição das Cavernas, atribuído pela tradição à mão do venerável Alípio das Cavernas de Kyiv.", "patron": "O ícone de Alípio levado para o norte."},

"“Virgin of Tenderness” Icon of the Mother of God of the Pskov Caves":
{"type": "Festa · séc. XVI", "life": "O ícone da Ternura da Santíssima Mãe de Deus, do tipo em que o Menino Cristo encosta a sua face à de sua Mãe, pertence ao mosteiro das Cavernas de Pskov, aonde foi levado no princípio do século XVI por cristãos piedosos e onde se tornou o protetor da cidade.", "patron": "Invoca-se sua intercessão pela proteção de Pskov; pelo livramento da invasão."},
}
