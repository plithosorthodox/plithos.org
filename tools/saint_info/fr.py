# -*- coding: utf-8 -*-
"""French calendar entries. TEXT = {English name: {type, life, patron}}.

The calendar's life is the short one the day panel shows; the long one is in
tools/saint_lives/fr.py, and a saint is written in both places at once so
...
{"type": "Martyrs · IIIe s.", "life": "Les dix saints martyrs de Crète, Théodule, Saturnin, Euporos, Gélase, Eunicien, Zotique, Pompée, Agathopous, Basilide et Évariste, souffrirent en l'an 250 sous l'empereur Dèce, dont le gouverneur dans l'île, un Dèce lui aussi de nom comme de cruauté, entreprit d'arracher la foi de la Crète.", "patron": "On les invoque pour la joie devant la mort; pour la couronne que l'on se dispute par amour."},

"12 Greeks who built the Dormition Cathedral in the Kyiv Caves, Far Caves, Lavra":
{"type": "Moines et maîtres d'œuvre · XIe s.", "life": "Les douze Grecs qui bâtirent la grande cathédrale de la Dormition des Grottes de Kyiv sont commémorés en ce jour, maîtres d'œuvre de Constantinople que la Mère de Dieu elle-même engagea pour le plus grand chantier de l'ancienne Rus'. Le Paterikon des Grottes conserve leur propre déposition sous serment: la Reine du ciel leur apparut à l'église des Blachernes, à Constantinople, sous la figure d'une impératrice entourée de gardes, et leur ordonna d'aller en Rus', à Kyiv, et d'y bâtir en son honneur une église au lieu qui leur serait montré.", "patron": "On les invoque pour les bâtisseurs; pour les architectes."},

"120 Martyrs of Persia":
{"type": "Martyrs · IVe s.", "life": "Les saints Cent Vingt Martyrs de Perse souffrirent dans la grande persécution du roi Sapor II, vers l'an 344, dans les années où le royaume perse, en guerre avec l'empire romain nouvellement chrétien, se retourna contre l'Église qui était dans ses propres frontières comme contre une colonie ennemie, et où les confesseurs du Christ en Mésopotamie et en Perse furent saisis par milliers.", "patron": "On les invoque pour les captifs; pour les compagnies de confesseurs."},

"1st Saturday of Great Lent: The Miracle of the Boiled Wheat":
{"type": "Fête · IVe s.", "life": "Le premier samedi du Grand Carême, l'Église fait mémoire du miracle des collyves, le blé bouilli, opéré par le saint grand-martyr Théodore Tiron un demi-siècle après son propre martyre, le soldat défunt du Christ montant la garde sur la première semaine de jeûne de l'Église.", "patron": "En ce jour on prie pour tous ceux qui gardent le jeûne; pour les tentés et les trompés."},

"1st Sunday of Great Lent: Sunday of Orthodoxy":
{"type": "Fête · IXe s.", "life": "Le premier dimanche du Grand Carême, l'Église célèbre le Dimanche de l'Orthodoxie, fête du Triomphe de la vraie foi, institué en l'an 843, lorsque la sainte impératrice Théodora et le saint patriarche Méthode rétablirent la vénération des saintes icônes et mirent fin à la dernière grande hérésie du monde ancien.", "patron": "En ce jour on prie pour toute l'Église militante; pour tous ceux qui gardent la foi des Pères."},

"20,000 Martyrs of Nicomedia":
{"type": "Martyrs · IVe s.", "life": "Les saints Vingt Mille Martyrs de Nicomédie souffrirent en l'an 302, lorsque l'empereur Maximien, apprenant combien puissamment la foi avait grandi dans sa propre capitale, résolut de détruire en une seule nuit les chrétiens de la ville, et choisit pour cela la nuit où ils seraient tous rassemblés: la fête de la Nativité du Christ.", "patron": "On les invoque pour les assemblées menacées; pour les catéchumènes."},

"26 Martyrs in the Crimea":
{"type": "Martyrs · IVe s.", "life": "Les saints Vingt-Six Martyrs, dont les reliques ont sanctifié la Crimée, souffrirent au pays des Goths, au-delà du Danube, vers l'an 375, lorsque le roi goth païen suscita une persécution contre les chrétiens de son peuple, et que la jeune Église gothique, plantée par des captifs et des missionnaires, paya dans le sang son premier grand prix.", "patron": "On les invoque pour les assemblées en prière; pour les peuples nouvellement convertis."},

"2nd Sunday of Great Lent: St Gregory Palamas":
{"type": "Fête · XIVe s.", "life": "Le deuxième dimanche du Grand Carême, l'Église fait mémoire de saint Grégoire Palamas, archevêque de Thessalonique, et ce jour est justement appelé le second Triomphe de l'Orthodoxie, car il prolonge le premier: comme le premier dimanche proclame que Dieu peut être représenté parce qu'il s'est vraiment fait homme, le second proclame que Dieu peut être éprouvé parce qu'il se donne vraiment, l'icône et la lumière étant deux verdicts d'une seule foi.", "patron": "On l'invoque pour les hésychastes et pour tous ceux qui prient; pour les théologiens de l'expérience."},

"33 Holy Martyrs of Melitene":
{"type": "Martyrs · IIIe s.", "life": "Les saints Trente-Trois Martyrs de Mélitène souffrirent vers l'an 290, sous le règne de Dioclétien et de Maximien, lorsqu'un détachement commandé par Lysias fut envoyé en Cappadoce pour en extirper les chrétiens et pour enrôler dans l'armée les hommes robustes. À leur tête se tient Hiéron, laboureur de Tyane, élevé dans la piété par sa mère, homme d'une force corporelle extraordinaire.", "patron": "On les invoque pour les laboureurs; pour les conscrits."},

"3rd Sunday of Great Lent: Veneration of the Cross":
{"type": "Fête · IVe s.", "life": "Le troisième dimanche du Grand Carême, l'Église porte au dehors la précieuse et vivifiante Croix et la place au milieu des fidèles, ornée de fleurs, pour être vénérée durant la semaine qui suit; et cette place est toute la théologie du jour, car la Croix est plantée au centre exact du Carême, au milieu des quarante jours, comme un arbre de repos au milieu d'une route difficile.", "patron": "En ce jour on prie pour tous ceux qui portent une croix; pour ceux que la mi-chemin a lassés."},

"40 Holy Martyrs of Sebaste":
{"type": "Martyrs · IVe s.", "life": "Les saints Quarante Martyrs de Sébaste étaient des soldats de la fameuse Douzième Légion, dite la Fulminante, en garnison à Sébaste d'Arménie vers l'an 320, que le synaxaire byzantin compte pour 322 ou 323, lorsque l'empereur Licinius, rompant sa paix avec l'Église, ordonna à ses armées de sacrifier.", "patron": "On les invoque pour les soldats; pour les compagnies et les confréries."},

"42 Martyrs of Ammoria in Phrygia":
{"type": "Martyrs · IXe s.", "life": "Les saints Quarante-Deux Martyrs d'Amorion étaient les chefs et les nobles de l'armée byzantine, emmenés captifs lorsque la grande ville d'Amorion, en Phrygie, tomba aux mains des Sarrasins en l'an 838, et parmi eux Constantin, Aétios, Théophile, Théodore, Mélissène, Calliste et Basoès, la fleur des chefs de l'empire emportée en Mésopotamie.", "patron": "On les invoque pour les soldats; pour les chefs."},

"45 Holy Martyrs at Nicopolis in Armenia":
{"type": "Laïcs · IVe s.", "life": "Les quarante-cinq saints martyrs de Nicopolis en Arménie souffrirent sous l'empereur Licinius, qui régnait sur l'Orient et persécutait durement l'Église, décrétant la mort pour tout chrétien qui ne reviendrait pas aux idoles. Lorsque la persécution atteignit Nicopolis, plus de quarante fidèles, conduits par Léonce, Maurice, Daniel, Antoine et Alexandre, résolurent non pas de se cacher, mais de se présenter ouvertement devant les persécuteurs et de confesser le Christ.", "patron": "On les invoque pour la confession hardie."},

"4th Sunday of Great Lent: St John Climacus (of the Ladder)":
{"type": "Fête · VIIe s.", "life": "Le quatrième dimanche du Grand Carême, l'Église met devant ses enfants saint Jean Climaque, higoumène du Sinaï et auteur de l'Échelle sainte, et cette place relève d'une pédagogie voulue: passé le milieu du Carême, la Croix vénérée et Pâques encore hors de vue, l'Église produit son maître cartographe de la vie spirituelle.", "patron": "On l'invoque pour tous ceux qui montent vers Dieu; pour les lutteurs au milieu du Carême."},

"5th Saturday of Great Lent: of the Akathist to the Theotokos":
{"type": "Fête · VIIe s.", "life": "Le cinquième samedi du Grand Carême, l'Église célèbre la fête de l'Acathiste, chantant tout entière, en une seule nuit solennelle, la grande hymne à la Très Sainte Mère de Dieu qu'elle chante par parties le reste de l'année; et cette fête est un mémorial de guerre autant qu'un office, car elle fut instituée en action de grâces pour les délivrances de Constantinople.", "patron": "En ce jour on prie pour tous ceux qui recourent à la Mère de Dieu; pour les villes assiégées."},

"5th Sunday of Great Lent: St Mary of Egypt":
{"type": "Fête · VIe s.", "life": "Sainte Marie l'Égyptienne, dont la vie est lue à l'église durant le Grand Carême comme l'image même du repentir, passa sa jeunesse à Alexandrie dans un grand dérèglement. Étant allée à Jérusalem, elle se trouva retenue par une puissance invisible qui l'empêchait d'entrer dans l'église à l'Exaltation de la Croix, et, frappée au cœur, elle pleura devant une icône de la Mère de Dieu et fit vœu de changer de vie.", "patron": "On l'invoque pour les pénitents au sommet du Carême; pour tous ceux qui désespèrent de changer."},

"7 Holy Maccabee Martyrs":
{"type": "Jeunes gens · IIe s. av. J.-C.", "life": "Les sept saints frères Macchabées, Abim, Antonin, Gourias, Éléazar, Eusébone, Alime et Marcel, souffrirent en l'an 166 avant le Christ sous l'impie roi Antiochus Épiphane, qui méprisait la foi des Juifs et s'efforçait de détourner le peuple de la Loi de Moïse, profanant le Temple et y dressant une idole de Zeus afin que tous l'adorent.", "patron": "On les invoque pour la fidélité à la loi de Dieu; pour le courage dans les tourments."},

"7 Holy Youths “Seven Sleepers” of Ephesus":
{"type": "Jeunes gens · Ve s.", "life": "Les sept saints jeunes gens d'Éphèse, Maximilien, Jamblique, Martinien, Jean, Denys, Exacustodien et Antonin, vécurent au troisième siècle; ils étaient fils de citoyens illustres, amis depuis l'enfance et soldats ensemble. Lorsque l'empereur Dèce vint à Éphèse et ordonna à tous de sacrifier aux idoles, les sept confessèrent le Christ, et bien que les ceinturons de leur charge leur eussent été ôtés, l'empereur les laissa libres pour un temps, espérant qu'ils fléchiraient.", "patron": "On les invoque pour la résurrection des morts; pour les malades que le sommeil fuit."},

"Afterfeast of the Dormition of the Mother of God":
{"type": "Après-fête", "life": "Durant les jours de l'après-fête de la Dormition, l'Église continue de célébrer le bienheureux endormissement de notre Très Sainte Souveraine la Mère de Dieu et son passage dans la gloire au royaume céleste. Les hymnes de ces jours proclament que celle qui a porté l'Auteur de la vie n'a pas abandonné le monde en s'endormant, mais qu'elle a été élevée par son Fils pour régner avec lui et pour intercéder sans cesse en faveur de tous ceux qui l'honorent.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Afterfeast of the Elevation of the Cross":
{"type": "Après-fête", "life": "Voici les jours de l'après-fête de l'Exaltation universelle de la Précieuse et Vivifiante Croix, durant lesquels l'Église continue de célébrer la grande fête de la Croix du Seigneur. Les hymnes de l'Exaltation sont jointes aux offices quotidiens, et les fidèles continuent de vénérer le saint Bois élevé au milieu de la terre, contemplant le mystère par lequel l'instrument de la mort est devenu l'arbre de la vie.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Afterfeast of the Entry of the Most Holy Mother of God into the Temple":
{"type": "Après-fête", "life": "Dans les jours de l'après-fête de l'Entrée au Temple de la Très Sainte Mère de Dieu, l'Église demeure dans la lumière de la fête, continuant d'en chanter les hymnes et d'en contempler le mystère: l'enfant de trois ans, amenée par Joachim et Anne en accomplissement de leur vœu, montant sans aide les grands degrés du Temple, reçue par le grand prêtre Zacharie et conduite, contre tout usage, jusque dans le Saint des Saints, là où se tenaient jadis l'arche et le propitiatoire.", "patron": "En ce jour on prie pour demeurer dans la grâce de la fête."},

"Afterfeast of the Meeting of our Lord in the Temple":
{"type": "Après-fête", "life": "L'après-fête de la Rencontre de notre Seigneur au Temple porte la fête du deux février à travers les jours qui suivent, jusqu'à la clôture le neuf, et en ces jours l'Église demeure debout dans le Temple, l'Enfant dans les bras; car la Rencontre est la charnière où se ferme tout le cycle de la Nativité, l'accomplissement au quarantième jour de la loi de l'Incarnation, et un mystère de ce poids ne se congédie pas en un jour.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Afterfeast of the Nativity of our Lord and Savior Jesus Christ":
{"type": "Après-fête", "life": "L'après-fête de la Nativité de notre Seigneur porte la célébration à travers les jours qui suivent la fête, car l'Église ne referme pas la grotte de Bethléem après un seul jour, mais y demeure, reprenant à chaque office le tropaire et le kondakion de la fête, chantant le Christ est né, glorifiez-le, sur les saints de chaque jour et les labeurs de chaque jour, en sorte que les martyrs, les hiérarques et les ascètes commémorés en ces jours soient tous contemplés dans la lumière de la crèche.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Afterfeast of the Nativity of the Mother of God":
{"type": "Après-fête", "life": "Voici les jours de l'après-fête de la Nativité de la Très Sainte Mère de Dieu, durant lesquels l'Église continue de célébrer la naissance de la Mère de Dieu des justes Joachim et Anne. Les hymnes de la fête sont chantées avec les offices quotidiens, prolongeant la joie de la solennité, tandis que les fidèles contemplent la stérilité d'Anne déliée et l'apparition dans le monde de celle qui fut prédestinée dès les siècles à devenir la Mère du Sauveur.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Afterfeast of the Transfiguration of our Lord":
{"type": "Après-fête", "life": "Voici le premier jour de l'après-fête de la Transfiguration du Seigneur, où l'Église continue de célébrer la gloire révélée sur la sainte montagne. Les hymnes de la fête rappellent la stupeur des apôtres Pierre, Jacques et Jean lorsqu'ils virent leur Maître transfiguré devant eux, son visage et ses vêtements resplendissant plus que le soleil, et elles proclament son égalité avec le Père, car celui qui se revêt de lumière comme d'un manteau a montré à ses disciples son rayonnement divin.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Apostle Alphaeus of the Seventy":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Alphée fut l'un des Soixante-dix que le Seigneur choisit et envoya devant lui, deux à deux, dans toute ville et tout lieu où lui-même devait aller, et l'Église l'honore parmi cette seconde troupe d'apôtres qui, après les Douze, portèrent l'Évangile par le monde.", "patron": "L'Évangile prêché parmi les premiers disciples."},

"Apostle Ananias of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Ananie, l'un des Soixante-dix, était un disciple du Seigneur qui demeurait à Damas, à qui le Seigneur apparut dans une vision, lui ordonnant d'aller dans la rue appelée Droite et d'imposer les mains à Saul de Tarse, le persécuteur de l'Église, qui priait là, aveugle.", "patron": "On l'invoque pour la guérison de la cécité; pour l'obéissance à l'appel de Dieu."},

"Apostle Andrew, the Holy and All-Praised First-Called":
{"type": "Apôtre · Ier s.", "life": "Le saint et tout-loué apôtre André, le Premier-appelé, était de Bethsaïde en Galilée, pêcheur et frère de Simon Pierre; et, disciple de Jean le Précurseur, il entendit le Baptiste dire de Jésus, voici l'Agneau de Dieu, et il suivit le Seigneur le premier de tous les apôtres, ce pour quoi l'Église le nomme le Premier-appelé.", "patron": "On l'invoque pour les pêcheurs; pour les missionnaires."},

"Apostle Andronicus of the Seventy and his fellow-laborer, Junia":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Andronique, l'un des Soixante-dix, et sa collaboratrice Junie ont leurs noms gardés pour l'Église par saint Paul lui-même, dans la salutation de son épître aux Romains où il écrit, saluez Andronique et Junie, mes parents et mes compagnons de captivité.", "patron": "Les parents et les compagnons de captivité de Paul."},

"Apostle Aquila of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Aquilas, l'un des Soixante-dix, était juif, originaire du Pont, et vivait à Rome avec son épouse Priscille jusqu'à ce que, sous le règne de l'empereur Claude, les Juifs fussent chassés de la ville et que le couple s'établît à Corinthe. Ils y rencontrèrent l'apôtre Paul, qui, exerçant le même métier, logea chez eux et travailla avec eux à faire des tentes, et, ayant reçu de lui le baptême, ils devinrent ses disciples dévoués.", "patron": "On l'invoque pour les faiseurs de tentes; pour les époux."},

"Apostle Aristarchus of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Aristarque, l'un des Soixante-dix, était un Macédonien de Thessalonique et l'un des plus fidèles compagnons du saint apôtre Paul, nommé par lui dans ses épîtres son compagnon d'œuvre et son compagnon de captivité. Il partagea les labeurs et les périls de l'Apôtre à Éphèse, où il fut saisi par la foule dans le théâtre.", "patron": "On l'invoque pour les compagnons d'œuvre; pour la fidélité dans le compagnonnage."},

"Apostle Aristobulus of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Aristobule, l'un des Soixante-dix, frère de l'apôtre Barnabé, naquit à Chypre et suivit le saint apôtre Paul, qui salue sa maison dans l'épître aux Romains; et, consacré par Paul, comme le rapportent les anciens récits, il fut envoyé comme évêque en Bretagne, à l'extrême occident du monde connu.", "patron": "On l'invoque pour les missionnaires; pour l'illumination des îles."},

"Apostle Aristobulus of the Seventy, Bishop of Britain":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Aristobule, l'un des Soixante-dix, naquit à Chypre, frère de l'apôtre Barnabé, et accompagna avec son frère l'apôtre Paul dans ses voyages missionnaires, l'un de ce second rang d'apôtres que le Seigneur envoya devant sa face et que les Douze déployèrent par le monde après la Pentecôte.", "patron": "On l'invoque pour les missionnaires des confins lointains; pour les premiers prédicateurs d'un pays."},

"Apostle Barnabas of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Barnabé, l'un des Soixante-dix, fut parmi les premiers et les plus aimés des chefs de l'Église apostolique, compagnon de saint Paul et fondateur de l'Église de son île natale de Chypre.", "patron": "L'île de Chypre; tous ceux qui encouragent et consolent."},

"Apostle Bartholomew of the Twelve":
{"type": "Apôtre · Ier s.", "life": "Le saint et tout-loué apôtre Barthélemy, l'un des Douze, est généralement tenu par la tradition de l'Église pour le même que Nathanaël de Cana en Galilée, l'Israélite sans détour que le Seigneur vit sous le figuier avant que Philippe l'appelât.", "patron": "La terre d'Arménie; les missionnaires de l'Orient."},

"Apostle Carpus of the Seventy":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Carpe fut l'un des Soixante-dix et un compagnon et aide de l'apôtre Paul, et son nom est gardé pour l'Église dans les Écritures par la main même de Paul, dans la seconde épître à Timothée.", "patron": "Le manteau gardé pour l'Apôtre à Troas."},

"Apostle Crescens of the Seventy":
{"type": "Évêque · IIe s.", "life": "Le saint apôtre Crescent, l'un des Soixante-dix, était un disciple du Sauveur que l'apôtre Paul mentionne dans sa seconde épître à Timothée, notant que Crescent était parti prêcher en Galatie. Il y fut fait évêque, et porta ensuite l'Évangile dans les Gaules, en Occident, où il établit à Vienne son propre disciple Zacharie comme évêque.", "patron": "On l'invoque pour la prédication missionnaire."},

"Apostle Epenetus of the Seventy":
{"type": "Évêque · Ier s.", "life": "Le saint apôtre Épénète, l'un des Soixante-dix, était un disciple du Sauveur que l'apôtre Paul salue chaleureusement dans son épître aux Romains comme son bien-aimé Épénète, les prémices de l'Achaïe pour le Christ. Il fut établi évêque de Carthage, et là, endurant bien des afflictions de la part des idolâtres, il travailla à amener les païens à la connaissance du vrai Dieu, en gagnant beaucoup à la foi.", "patron": "On l'invoque pour la prédication missionnaire."},

"Apostle Epίmakhos of Alexandria":
{"type": "Martyr · IIIe s.", "life": "Le vénérable martyr Épimaque d'Alexandrie était Égyptien, et dès sa jeunesse il aima le Seigneur et se retira dans la contrée de Péluse, menant au désert la vie ascétique, dans le jeûne et la prière. Lorsque la persécution de Dèce s'abattit sur Alexandrie, l'ermite, enflammé de zèle, descendit dans la ville pour affermir les confesseurs.", "patron": "On l'invoque pour la guérison des yeux; pour le zèle de Dieu."},

"Apostle Hermas of the Seventy":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Hermas fut l'un des Soixante-dix, et son nom lui aussi est gardé pour l'Église dans les Écritures par la main de saint Paul, qui, dans les salutations qui ferment son épître aux Romains, salue Hermas parmi les fidèles de l'Église de Rome.", "patron": "Le nom salué dans l'épître aux Romains."},

"Apostle Hermes of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Hermès des Soixante-dix est de ces hommes que les Écritures ont rendus immortels d'un seul mot: l'apôtre Paul, fermant son épître aux Romains par l'appel des frères qu'il aimait, écrit: Saluez Asyncrite, Phlégon, Hermas, Patrobas, Hermès et les frères qui sont avec eux; et par cette salutation Hermès est entré dans le canon des Écritures, lu à haute voix dans toutes les Églises du monde à chaque génération depuis lors, la plus brève biographie qui se puisse concevoir et la plus largement publiée.", "patron": "On l'invoque pour les salués dont on n'a rien retenu; pour les évêques des sièges silencieux."},

"Apostle Herodion of the Seventy, and those with Him":
{"type": "Apôtres des Soixante-dix · Ier s.", "life": "En ce jour l'Église fait mémoire de six apôtres des Soixante-dix ensemble, Hérodion, Agabus, Rufus, Asyncrite, Phlégon et Hermès, compagnie recueillie pour l'essentiel sur une seule page de l'Écriture, le seizième chapitre de l'épître aux Romains, où l'apôtre Paul, saluant nom par nom l'Église de la capitale, dictait sans le savoir un morceau du calendrier de l'Église.", "patron": "On les invoque pour les évêques de la première plantation; pour les prophètes."},

"Apostle James the Brother of Saint John the Theologian":
{"type": "Apôtre et martyr · Ier s.", "life": "Le saint apôtre Jacques, fils de Zébédée et frère de Jean le Théologien, fut appelé des filets de Galilée avec son frère en un seul appel, tous deux laissant leur père dans la barque sur une parole; et le Seigneur les surnomma Boanergès, fils du tonnerre, à cause du feu qui était en eux, ce feu qui voulut un jour appeler la flamme du ciel sur un village inhospitalier et apprit plutôt de quel Esprit il était.", "patron": "On l'invoque pour les apôtres et les missionnaires; pour les fils du tonnerre."},

"Apostle James, son of Alphaeus":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Jacques, fils d'Alphée, fut l'un des Douze, appelé par le Seigneur avec les pêcheurs de Galilée, et selon la tradition de l'Église il était le frère de l'apôtre et évangéliste Matthieu, l'ancien publicain. De ses paroles les Évangiles n'ont rien retenu, mais ses actes comblent ce silence: après la Pentecôte il reçut avec les autres le feu de l'Esprit.", "patron": "On l'invoque pour les semailles de la parole; pour le labeur apostolique."},

"Apostle James, the Brother of the Lord":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Jacques, frère du Seigneur, était fils du juste Joseph le fiancé, né de son premier mariage, et dès l'enfance il partagea la pauvreté et les chemins de la sainte Famille, l'accompagnant, comme le rapporte la tradition, dans la fuite en Égypte. Nazir consacré à Dieu, il ne buvait pas de vin, ne mangeait pas de chair et ne portait qu'un seul vêtement; et il priait si continuellement dans le Temple que ses genoux s'étaient endurcis comme ceux d'un chameau, ce pourquoi tout Jérusalem, jusqu'à ceux du dehors, l'appelait Jacques le Juste.", "patron": "On l'invoque pour les évêques; pour les liturgistes."},

"Apostle Jude the Brother of the Lord":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Jude, appelé frère du Seigneur, fut l'un des douze apôtres, connu aussi sous les noms de Thaddée et de Lebbée, et honoré comme parent du Christ selon la chair.", "patron": "Les parents du Seigneur; ceux qui demandent comment le Christ se fait connaître."},

"Apostle Justus of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Just des Soixante-dix, appelé Joseph Barsabas, était, selon la tradition de l'Église, fils du juste Joseph le fiancé, et il fut ainsi compté parmi les frères du Seigneur, ayant grandi à l'ombre du Verbe incarné. Après l'Ascension, quand les onze voulurent combler la place de Judas, deux hommes furent présentés d'entre ceux qui avaient accompagné le Seigneur depuis le baptême de Jean, Joseph appelé Barsabas, surnommé Just, et Matthias.", "patron": "On l'invoque pour le contentement sans les honneurs; pour la fidélité que l'on n'élit pas."},

"Apostle Mark of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Marc des Soixante-dix, que l'Église distingue de l'Évangéliste du même nom, est identifié par la tradition à Jean surnommé Marc, dans la maison de qui, chez sa mère Marie, à Jérusalem, les fidèles s'assemblaient pour la prière, et où vint Pierre lorsque l'ange l'eut tiré de la prison.", "patron": "On l'invoque pour la guérison; pour le service de l'Évangile."},

"Apostle Matthias of the Seventy":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Matthias naquit à Bethléem, de la tribu de Juda, et dès son enfance il fut instruit dans la Loi de Dieu par saint Siméon le Théodoque. Lorsque le Seigneur Jésus-Christ parut dans le monde, Matthias crut en lui comme au Messie et le suivit fidèlement, et il fut compté parmi les Soixante-dix que le Seigneur envoya deux à deux devant sa face.", "patron": "On l'invoque pour les missionnaires; pour la fidélité cachée."},

"Apostle Nathaniel of the Seventy":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Nathanaël, dont la mémoire est célébrée en ce jour avec Luc et Clément, est cet homme de Cana en Galilée dont l'Évangile de Jean a gardé la vocation comme l'un de ses joyaux: lorsque Philippe le trouva pour lui annoncer que celui dont ont écrit Moïse et les prophètes était trouvé, Jésus de Nazareth, Nathanaël répondit par le préjugé franc d'un homme franc, Peut-il venir quelque chose de bon de Nazareth, et Philippe, sans perdre un mot à discuter, lui dit seulement: Viens et vois.", "patron": "On l'invoque pour les hommes sans détour; pour les élèves des Écritures."},

"Apostle Nicanor the Deacon of the Seventy":
{"type": "Diacre · Ier s.", "life": "Le saint apôtre Nicanor fut l'un des sept premiers diacres de l'Église du Christ, choisis, comme le rapportent les Actes des Apôtres, lorsque les Douze convoquèrent la multitude des disciples et désignèrent sept hommes de bon témoignage, remplis du Saint-Esprit et de sagesse, Étienne, Philippe, Prochore, Nicanor, Timon, Parménas et Nicolas, pour servir aux tables et prendre soin des veuves, afin que le service de la miséricorde fût aussi bien ordonné que le service de la parole.", "patron": "On l'invoque pour les diacres; pour ceux qui servent aux tables."},

"Apostle Onesimus of the Seventy":
{"type": "Apôtre des Soixante-dix et martyr · IIe s.", "life": "Le saint apôtre Onésime des Soixante-dix est le seul homme du Nouveau Testament qui en soit aussi le sujet, car la plus courte des épîtres de Paul fut écrite tout entière à son propos. Esclave de Philémon, ce chrétien de Colosses, Onésime fit tort à son maître et s'enfuit, et la route du fugitif s'acheva, par la providence qui gouverne de telles routes, à Rome, aux pieds de Paul prisonnier.", "patron": "On l'invoque pour les serviteurs; pour ceux qui furent esclaves."},

"Apostle Philip of the Seventy, One of the Seven Deacons":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Philippe des Soixante-dix, l'un des sept diacres, fut choisi avec Étienne et les autres par les apôtres pour servir aux tables des veuves dans la première Église de Jérusalem, étant un homme rempli de foi et de l'Esprit Saint. Quand la persécution eut dispersé l'Église, Philippe descendit en Samarie et y prêcha le Christ avec des signes et des prodiges, si bien que la ville reçut la parole avec grande joie, et que Simon le magicien lui-même crut et fut baptisé.", "patron": "On l'invoque pour les diacres; pour les évangélisateurs."},

"Apostle Pudens of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Pudens des Soixante-dix était un Romain de rang sénatorial, et il se tient dans les Écritures au milieu d'une seule salutation, car l'apôtre Paul, écrivant sa dernière épître de sa prison de Rome, envoie à Timothée les salutations d'Eubule, de Pudens, de Lin et de Claudia, le cercle qui restait à l'Apôtre condamné dans la capitale, ramassé en quatre noms, dont l'un était celui de ce sénateur.", "patron": "On l'invoque pour ceux qui accueillent l'Église; pour les maisons qui deviennent des églises."},

"Apostle Quadratus of the Seventy":
{"type": "Apôtre des Soixante-dix · IIe s.", "life": "Le saint apôtre Quadrat des Soixante-dix prêcha la parole de Dieu à Athènes et à Magnésie, et fut évêque d'Athènes, celui qui écrivit sa vie l'appelant une étoile du matin brillant au milieu des nuées du paganisme. Par sa prédication il tourna beaucoup de païens vers la vraie foi, et il endura pour cela la persécution, la lapidation et la prison de la part des ennemis du Christ.", "patron": "On l'invoque pour les apologistes; pour la défense de la foi."},

"Apostle Silas of the Seventy":
{"type": "Évêque · Ier s.", "life": "Le saint apôtre Silas, l'un des Soixante-dix, était un membre respecté de la première Église de Jérusalem et compté parmi les principaux d'entre les frères. Lorsque le concile apostolique se réunit à Jérusalem pour décider que les convertis d'entre les nations n'auraient pas à garder la Loi de Moïse, Silas fut choisi, étant rempli de la grâce du Saint-Esprit, pour porter et expliquer le décret aux fidèles d'Antioche.", "patron": "On l'invoque pour la prédication missionnaire."},

"Apostle Silvanus of the Seventy":
{"type": "Évêque · Ier s.", "life": "Le saint apôtre Silvain, l'un des Soixante-dix, prêcha la parole de Dieu avec les coryphées des apôtres Pierre et Paul, et l'apôtre Pierre le nomme avec honneur dans sa première épître, l'appelant un frère fidèle par qui il avait écrit. Travaillant à répandre l'Évangile et à affermir les Églises, saint Silvain fut établi évêque de Thessalonique, où il fut le pasteur du troupeau du Christ.", "patron": "On l'invoque pour la prédication missionnaire."},

"Apostle Simon the Zealot":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre Simon le Zélote fut l'un des Douze choisis par le Seigneur, appelé par saint Matthieu le Cananéen et par saint Luc le Zélote, les deux noms disant la même chose, car Cananéen rend le mot araméen que le grec Zêlôtês traduit.", "patron": "Le zèle dont il porte le nom."},

"Apostle Sosthenes of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Sosthène des Soixante-dix entre deux fois dans les Écritures, une fois battu et une fois bénissant, et la distance entre les deux est l'histoire de son âme. Dans les Actes des Apôtres il est le chef de la synagogue de Corinthe quand les Juifs se soulevèrent contre Paul et le traînèrent devant le tribunal du proconsul Gallion.", "patron": "On l'invoque pour les convertis venus du camp des adversaires; pour ceux que l'on bat injustement."},

"Apostle Tertius of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Tertius des Soixante-dix a laissé sa propre salutation à l'intérieur des saintes Écritures, car ce fut sa main qui écrivit l'épître de l'apôtre Paul aux Romains sous la dictée de l'Apôtre, et il y consigna: Je vous salue dans le Seigneur, moi Tertius, qui ai écrit cette lettre, le scribe de la grande épître de l'Évangile de la grâce devenant lui-même une petite parole vivante au dedans d'elle.", "patron": "On l'invoque pour les scribes; pour les copistes."},

"Apostle Thaddeus of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Thaddée, l'un des Soixante-dix, était Hébreu de naissance, né dans la ville syrienne d'Édesse; il faut le distinguer de Jude, appelé lui aussi Thaddée, qui fut l'un des Douze. Venu à Jérusalem pour une fête, il entendit la prédication de Jean le Précurseur et fut baptisé par lui, et ayant vu le Seigneur Jésus il le suivit et fut compté parmi les soixante-dix disciples.", "patron": "On l'invoque pour les missionnaires; pour la prédication missionnaire."},

"Apostle Timon the Deacon of the Seventy":
{"type": "Évêque · Ier s.", "life": "Le saint apôtre Timon fut l'un des sept diacres institués par les apôtres, comme le rapportent les Actes des Apôtres, lorsque les Douze choisirent des hommes remplis du Saint-Esprit et de sagesse pour servir les veuves indigentes de l'Église de Jérusalem, Étienne et Philippe à leur tête et Timon parmi eux, les premiers serviteurs ordonnés de la miséricorde de l'Église.", "patron": "On l'invoque pour les diacres; pour les évêques des sièges de frontière."},

"Apostle Titus of the Seventy and Bishop of Crete":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Tite, l'un des Soixante-dix, était natif de Crète et fils d'une famille païenne considérable, et dans sa jeunesse il étudia la philosophie et la poésie des Grecs tout en se gardant de leurs vices. Attiré par la vérité, il devint le disciple et le compagnon d'œuvre bien-aimé de l'apôtre Paul, qui l'appelle son fils véritable selon la foi commune et le fit premier évêque de Crète.", "patron": "On l'invoque pour les missionnaires; pour la Crète."},

"Apostle Trophimus of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Le saint apôtre Trophime des Soixante-dix était un Grec d'Éphèse, l'un de ces convertis d'entre les nations que l'apôtre Paul s'attacha comme compagnons de route, et les Écritures le montrent trois fois, chaque aperçu marquant une étape du disciple. Il paraît d'abord parmi les délégués qui accompagnaient Paul de la Grèce vers Jérusalem avec la collecte pour les saints pauvres, l'offrande des jeunes Églises voyageant sous la garde de leurs propres fils.", "patron": "On l'invoque pour les compagnons des grands; pour les malades laissés en arrière."},

"Apostle and Evangelist John the Theologian":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre et évangéliste Jean le Théologien, fils de Zébédée et frère de Jacques, fut le disciple bien-aimé du Christ. Il fut témoin de la Transfiguration et se tint auprès de la Croix avec la Mère de Dieu. Il prêcha l'Évangile, écrivit le quatrième Évangile, ses épîtres et l'Apocalypse, et se reposa à Éphèse dans une extrême vieillesse."},

"Apostle and Evangelist Luke":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre et évangéliste Luc était natif d'Antioche, médecin de son art et savant aussi dans la peinture, et venu au Seigneur il fut compté parmi les Soixante-dix et envoyé devant sa face; et il fut l'un des deux disciples à qui le Christ ressuscité apparut sur le chemin d'Emmaüs, quand leur cœur brûlait au dedans d'eux tandis qu'il leur ouvrait les Écritures.", "patron": "On l'invoque pour les médecins; pour les iconographes."},

"Apostle and Evangelist Luke of the Seventy":
{"type": "Apôtre et évangéliste · Ier s.", "life": "Le saint apôtre et évangéliste Luc, dont les calendriers de ce jour font mémoire avec les apôtres Nathanaël et Clément, et dont l'Église célèbre la fête principale en octobre, était un Grec d'Antioche, médecin de profession et, ajoute la tradition, peintre, les deux arts du corps et du regard entrant tout entiers au service de l'Évangile.", "patron": "On l'invoque pour les médecins; pour les iconographes et les peintres."},

"Apostle and Evangelist Mark":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre et évangéliste Marc fut l'un des soixante-dix apôtres et l'Évangéliste qui écrivit le second Évangile. Compagnon de Pierre, de Paul et de Barnabé, il prêcha en bien des lieux et fonda l'Église d'Alexandrie. Il souffrit pour le Christ en Égypte et reçut la couronne du martyre au premier siècle."},

"Apostle and Evangelist Matthew":
{"type": "Apôtre · Ier s.", "life": "Le saint apôtre et évangéliste Matthieu était publicain, appelé par le Christ à devenir l'un des douze apôtres. Il quitta son ancien métier, suivit le Seigneur et écrivit l'Évangile qui porte son nom. Après la Pentecôte il prêcha l'Évangile en bien des pays, endura des souffrances pour le Christ et reçut la couronne du martyre au premier siècle."},

"Apostles Jason and Sosipater of the Seventy, the Virgin Kerkyra, and those with them":
{"type": "Apôtres des Soixante-dix et martyrs · Ier s.", "life": "Les saints apôtres Jason et Sosipatre des Soixante-dix, avec la vierge Kerkyra et ceux qui étaient avec eux, ont donné à l'Église l'une des conversions d'île les plus complètes de l'âge apostolique; Jason était de Tarse, le premier chrétien de la ville même de l'apôtre Paul, et Sosipatre d'Achaïe, et Paul, dans l'épître aux Romains, les appelle ses parents, la tradition ajoutant que Jason est cet homme de Thessalonique qui logea Paul et Silas et en répondit devant les magistrats, et Sosipatre le Sopatros des Actes.", "patron": "On les invoque pour les Églises des îles; pour les prisonniers et pour ceux qui les convertissent."},

"Apostles Patrobus, Hermes, Linus, Gaius, and Philologus, of the Seventy":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Les saints apôtres Patrobas, Hermas, Lin, Gaïus et Philologue, des Soixante-dix, sont salués dans les épîtres de l'apôtre Paul, et chacun servit l'Évangile comme évêque, endurant les travaux et les périls du premier âge de l'Église. Lin, que Paul nomme dans sa dernière épître, devint après le martyre des coryphées des apôtres le premier évêque de Rome, gouvernant l'Église de la ville impériale dans les années de la persécution de Néron.", "patron": "On les invoque pour les évêques; pour la plantation des Églises."},

"Apostles of the Seventy Archippus and Philemon, and Martyr Apphia":
{"type": "Apôtres des Soixante-dix et martyrs · Ier s.", "life": "Les saints apôtres Archippe et Philémon des Soixante-dix, et la martyre Apphia, sont la maisonnée de la plus courte des épîtres, cette famille de Colosses à qui Paul écrivit la lettre qui porte le nom de Philémon.", "patron": "On les invoque pour les églises de maison; pour les époux qui servent ensemble."},
...
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Les saints apôtres Philémon et Archippe, la martyre Apphia, femme de Philémon, et saint Onésime, disciple de l'apôtre Paul, sont liés à jamais par la plus courte des épîtres de Paul, écrite à Philémon, notre bien-aimé et notre compagnon d'œuvre, à Apphia notre bien-aimée, à Archippe notre compagnon de combat, et à l'Église qui est dans ta maison.", "patron": "On les invoque pour les maisonnées de la foi; pour les maîtres et les serviteurs."},

"Apostles of the Seventy: Erastus, Olympas, Herodion, Sosipater, Quartus, and Tertius":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Les saints apôtres Éraste, Olympe, Hérodion, Sosipatre, Quartus et Tertius, des Soixante-dix, furent les disciples et les compagnons d'œuvre du saint apôtre Paul, qui les salue dans son épître aux Romains. Éraste, que Paul appelle le trésorier de la ville, servit comme économe de l'Église de Jérusalem et ensuite comme évêque de Panéas en Palestine.", "patron": "On les invoque pour les évêques; pour les trésoriers."},

"Appearance of Christ to Saint Martin of Tours":
{"type": "Fête · IVe s.", "life": "En ce jour l'Église fait mémoire de l'apparition du Christ à saint Martin de Tours, cette vision qui se tient au commencement de l'une des vies les plus aimées de l'Occident et prêche, en une seule scène nocturne, tout le vingt-cinquième chapitre de saint Matthieu. Martin était alors un jeune soldat de la cavalerie romaine en Gaule, et encore catéchumène, non baptisé.", "patron": "On l'invoque pour les soldats; pour ceux qui font l'aumône."},

"Appearance of the Icon of the Mother of God “The Footprint” at Pochaiv":
{"type": "Fête · XIVe s.", "life": "En ce jour l'Église fait mémoire de l'apparition de la très sainte Mère de Dieu sur la montagne de Pochaïv, ce prodige qui fonda la grande laure de Volhynie et laissa dans le roc vivant l'empreinte de son pied que les fidèles appellent simplement l'Empreinte.", "patron": "L'empreinte laissée dans le roc."},

"Arrival of the Ivḗron Icon of the Mother of God in Georgia":
{"type": "Icône de la Mère de Dieu", "life": "En ce jour l'Église de Géorgie fait mémoire de l'arrivée en Géorgie de l'icône d'Iviron de la très sainte Mère de Dieu. Le vingt-six septembre de l'an 1989, une copie exacte de la célèbre et thaumaturge Portaïtissa, la Gardienne de la Porte du monastère d'Iviron au mont Athos, arriva à Tbilissi depuis la Sainte Montagne, peinte par les moines athonites avec la bénédiction du catholicos-patriarche Ilia II, en gage d'amour et de reconnaissance envers le peuple géorgien, dont les pères avaient fondé jadis le monastère d'Iviron.", "patron": "On l'invoque pour la protection de la Géorgie; pour la consolation aux temps difficiles."},

"Beginning of Great Lent":
{"type": "Fête · IVe s.", "life": "En ce jour l'Église entre dans le Grand Carême, la sainte Quarantaine, la plus ancienne et la plus grande de ses saisons de repentir, gardée depuis les premières générations comme la dîme de l'année offerte à Dieu et comme la marche que tous les fidèles font ensemble vers Pâques. Ses racines plongent jusqu'aux commencements: le Seigneur lui-même a jeûné quarante jours.", "patron": "En ce jour on prie pour tous les fidèles; pour les catéchumènes qui se préparent au baptême."},

"Beheading of Venerable Cornelius, Abbot of the Pskov Caves":
{"type": "Martyr et higoumène · XVIe s.", "life": "Le hiéromartyr Corneille, higoumène des Grottes de Pskov, naquit à Pskov en 1501 du noble Étienne et de Marie, et fut formé au monastère de Mirojé à toute la culture du monachisme du Nord, faisant les cierges, fendant le bois, copiant et ornant les livres, peignant les icônes; et lorsque le secrétaire Missiour Mounekhine emmena l'adolescent au pauvre petit monastère des Grottes, au fond des bois, la beauté du lieu et la solennité de l'église creusée dans la roche décidèrent de sa vie, car Corneille y reçut la tonsure et n'en sortit plus.", "patron": "On l'invoque pour les higoumènes; pour les chroniqueurs."},

"Blessed Andrew of Totma the Fool-For-Christ":
{"type": "Fol-en-Christ · XVIIe s.", "life": "Le bienheureux André de Totma, fol-en-Christ, naquit en 1638 au village d'Oust-Totma, au pays de Vologda, et dès l'enfance il résolut de quitter le monde. Avec la bénédiction d'Étienne, higoumène du monastère de la Résurrection à Galitch, il prit sur lui la rude vocation de la folie pour le Christ, et se fixa auprès de l'église de la Résurrection, au bourg de Totma, sur la rivière Soukhona.", "patron": "On l'invoque pour la pauvreté volontaire; pour l'aumône cachée."},

"Blessed Andrew the Fool-For-Christ at Constantinople":
{"type": "Fol-en-Christ · Xe s.", "life": "Le bienheureux André, fol-en-Christ, était slave de naissance, et fut amené tout jeune comme esclave à Constantinople, où il servit un dignitaire de la ville et se fit aimer pour sa douceur et son application aux Écritures. Ayant vu en songe les armées des anges et des démons aux prises, et entendu le Seigneur l'appeler au combat, il prit sur lui, une fois affranchi par son maître, la plus dure des voies ascétiques, feignant la démence pour le Christ.", "patron": "On l'invoque pour les serviteurs cachés de Dieu; pour les visions des choses célestes."},

"Blessed Cleopatra with her son John, in Egypt":
{"type": "Bienheureuse · IVe s.", "life": "La bienheureuse Cléopâtre était une pieuse veuve de Palestine, qui vivait en Égypte au temps de la persécution; et ayant vu le combat du saint martyr Varus, elle obtint son corps en secret et le porta jusqu'à son village natal d'Edra, près du mont Thabor, où elle l'ensevelit avec honneur et bâtit sur lui une église au nom du martyr, toute sa maison le vénérant comme son protecteur.", "patron": "On l'invoque pour les mères; pour les mères en deuil."},

"Blessed Constantine, Metropolitan of Kyiv":
{"type": "Métropolite · XIIe s.", "life": "Le bienheureux Constantin, métropolite de Kyiv, gouverna l'Église russe au milieu du douzième siècle, en un temps de graves querelles autour du siège métropolitain, et on se souvient de lui surtout pour l'étonnante humilité avec laquelle il chercha, jusque dans la mort, la dernière place.", "patron": "Les hiérarques qui cherchent la dernière place; les humbles dans les hautes charges."},

"Blessed Dovmont (Timothy), Prince of Pskov":
{"type": "Prince fidèle · XIIIe s.", "life": "Saint Dovmont de Pskov, prince fidèle, appelé Timothée depuis son baptême, était un prince lituanien et un païen qui devint l'un des souverains les plus aimés et le protecteur céleste d'une ville russe, sa vie étant comme une parabole du zèle du converti répandu tout entier pour la défense du peuple qui l'avait accueilli.", "patron": "Le prince païen devenu champion chrétien."},

"Blessed John “the Hairy” and Fool-For-Christ at Rostov":
{"type": "Fol-en-Christ · XVIe s.", "life": "Le bienheureux Jean, appelé le Miséricordieux et aussi le Chevelu, prit sur lui à Rostov l'ascèse dure et cachée de la folie pour le Christ, endurant le froid, la faim et l'opprobre pour l'amour de Dieu. Il n'avait pas de demeure à lui, mais trouvait abri tantôt chez son père spirituel, prêtre de l'église de Tous-les-Saints, tantôt chez l'une ou l'autre des pauvres veuves de la ville.", "patron": "On l'invoque pour l'humilité; pour ceux qui n'ont pas de toit."},

"Blessed Laurence the Fool-For-Christ at Kaluga":
{"type": "Fol-en-Christ · XVIe s.", "life": "Le bienheureux Laurent, fol-en-Christ et thaumaturge de Kalouga, vivait au commencement du seizième siècle près de l'ancienne ville de Kalouga, tout proche d'une église de la Nativité du Christ dressée sur une haute colline boisée, à laquelle un long passage souterrain menait depuis sa demeure, afin qu'il pût assister aux offices.", "patron": "On l'invoque pour la défense de Kalouga."},

"Blessed Nicholas (Salos) of Pskov the Fool-For-Christ":
{"type": "Fol-en-Christ · XVIe s.", "life": "Le bienheureux Nicolas Salos de Pskov, que la ville appelait Mikoula le fol, porta l'exploit de la folie pour le Christ plus de trente ans, dormant sous les porches, endurant le gel et la moquerie dans ses haillons, parlant par énigmes qui se vérifiaient, et acquérant, longtemps avant sa fin, la grâce des miracles et de la prophétie, le fou de la ville devenant sans bruit son oracle le plus sûr.", "patron": "On l'invoque pour les fols en Christ; pour ceux qui disent la vérité devant les puissants."},

"Blessed Nicholas Kochanov the Fool-For-Christ at Novgorod":
{"type": "Fol-en-Christ · XIVe s.", "life": "Le bienheureux Nicolas Kochanov, fol-en-Christ de Novgorod, naquit d'une famille riche et noble, et dès sa jeunesse il aima l'église, le jeûne et la prière. Quand le peuple se mit à le louer pour sa vertu, il fuit cette estime en prenant le chemin difficile de la folie pour le Christ, cachant sa sainteté sous les dehors de la démence.", "patron": "On l'invoque pour la réconciliation; pour la paix au milieu des querelles."},

"Blessed Prince Gleb Andreevich, son of Saint Andrew Bogoliubsky":
{"type": "Prince · XIIe s.", "life": "Saint Gleb Andréïevitch était un jeune prince de Vladimir, fils du saint prince André Bogolioubski, qui vécut une vie brève d'une rare piété et que Dieu glorifia par l'incorruption.", "patron": "Les jeunes princes de piété; ceux qui aiment les Écritures et l'Église."},

"Blessed Yaropolk (in Baptism Peter), Prince of Volodymyr-Volhynia":
{"type": "Prince · XIe s.", "life": "Le saint prince Iaropolk de Volodymyr-Volhynie, nommé Pierre au saint baptême, était fils du grand-prince Iziaslav de Kyiv et petit-fils de Iaroslav le Sage; et sa courte vie fut une école du dépouillement, car il partagea les exils répétés de son père chez les Polonais et chez les Allemands, quand les querelles des princes les chassaient de la Rus, apprenant de bonne heure que les trônes sont prêtés et non donnés.", "patron": "On l'invoque pour les souverains; pour les princes qui souffrent l'injustice sans se venger."},

"Childmartyr Gabriel of Bialystok":
{"type": "Enfant-martyr · XVIIe s.", "life": "Le saint enfant-martyr Gabriel de Białystok naquit en 1684 au village de Zverki, près de Białystok, de pieux villageois orthodoxes, Pierre et Anastasie, et vécut les six brèves années qui lui furent données dans la sainteté ordinaire d'une enfance paysanne aimée, les prières apprises aux genoux de sa mère, les fêtes de l'église, les champs.", "patron": "On l'invoque pour les enfants; pour les innocents et les sans-défense."},

"Church New Year":
{"type": "Fête", "life": "Le premier jour de septembre, l'Église célèbre le commencement de l'Indiction, c'est-à-dire le Nouvel An ecclésiastique. Les Pères du premier concile œcuménique de Nicée ont établi que l'année de l'Église commencerait ce jour-là, suivant l'antique comput selon lequel septembre, le mois où l'on rentre les récoltes, était le début de l'année chez les Hébreux, qui en cette saison rendaient grâce à Dieu pour ses largesses.", "patron": "En ce jour on prie pour l'année nouvelle; pour l'action de grâces."},

"Commemoration of the Apparition of the Sign of the Precious Cross Over Jerusalem, in 351 AD":
{"type": "Fête · IVe s.", "life": "En ce jour l'Église fait mémoire de l'apparition du signe de la précieuse Croix dans le ciel au-dessus de Jérusalem, en l'an 351, sous l'empereur Constance, fils de Constantin le Grand; le 7 mai, le mardi qui précède la fête de l'Ascension.", "patron": "La Croix écrite à travers le ciel."},

"Commemoration of the Founding of Constantinople":
{"type": "Fête · IVe s.", "life": "En ce jour l'Église fait mémoire de la fondation et de la dédicace de Constantinople, qui eut lieu le lundi 11 mai de l'an 330, dans la troisième indiction, par le grand et chrétien empereur Constantin.", "patron": "La Nouvelle Rome fondée sous la Croix."},

"Commemoration of the Founding of the Church of the Resurrection (Holy Sepulchre) at Jerusalem":
{"type": "Fête", "life": "En ce jour l'Église fait mémoire de la fondation, c'est-à-dire de la consécration solennelle, de l'église de la Résurrection du Christ à Jérusalem, élevée par saint Constantin le Grand et sa mère, la sainte impératrice Hélène, sur le Tombeau du Seigneur et la colline du Golgotha. Quand Hélène fut venue à Jérusalem, qu'elle eut détruit les sanctuaires païens qui souillaient les Lieux saints et trouvé la Croix vivifiante sous le temple de Vénus, Constantin ordonna que fût bâtie une grande et magnifique église enfermant à la fois le lieu de la Crucifixion et le Sépulcre de la Résurrection.", "patron": "On l'invoque pour la consécration des églises."},

"Commemoration of the Great Earthquake at Constantinople":
{"type": "Fête", "life": "En ce jour l'Église fait mémoire du grand tremblement de terre qui frappa Constantinople en l'an 740, sous le règne de Léon l'Isaurien, quand la colère de Dieu ébranla la ville impériale, jetant bas les églises, les maisons et de longs pans des murailles avec leurs tours, et faisant périr beaucoup de monde, les secousses se prolongeant des mois durant, si bien que les habitants demeuraient dans la crainte à ciel ouvert.", "patron": "On l'invoque pour la délivrance des tremblements de terre; pour le repentir devant les jugements de Dieu."},

"Commemoration of the Holy Fathers of the First Ecumenical Council":
{"type": "Fête · IVe s.", "life": "En ce jour l'Église fait mémoire des saints Pères du premier concile œcuménique, les trois cent dix-huit évêques théophores qui se rassemblèrent à Nicée de Bithynie en l'an 325 pour défendre la divinité du Fils de Dieu et confesser la vraie foi contre la première grande hérésie.", "patron": "Les défenseurs de la divinité du Fils; les pères des conciles."},

"Commemoration of the Holy Fathers of the Second Ecumenical Council":
{"type": "Fête · IVe s.", "life": "En ce jour l'Église fait mémoire des saints Pères du deuxième concile œcuménique, les cent cinquante qui se rassemblèrent à Constantinople en l'an 381, sous l'empereur Théodose le Grand.", "patron": "Le Symbole achevé par l'article de l'Esprit."},

"Commemoration of the Holy Fathers of the Seventh Ecumenical Council":
{"type": "Fête", "life": "En ce jour l'Église fait mémoire des saints Pères du septième concile œcuménique, qui se rassembla à Nicée en l'an 787, du temps de l'impératrice Irène et de son fils Constantin, sous la présidence de saint Taraise, patriarche de Constantinople. Quelque trois cent cinquante pères s'y réunirent contre l'hérésie des iconoclastes, qui depuis des dizaines d'années ravageait l'Église, détruisant les saintes images et persécutant ceux qui les vénéraient.", "patron": "On les invoque pour la vénération des saintes icônes; pour la plénitude de l'enseignement orthodoxe."},

"Commemoration of the Holy Righteous David the King, Joseph the Betrothed, and James the Brother of the Lord":
{"type": "Justes · Ier s.", "life": "Dans les jours qui suivent la Nativité, l'Église fait mémoire ensemble des saints justes Joseph le fiancé, David le roi et Jacques frère du Seigneur, synaxe de la parenté du Seigneur selon la chair, fixée dès l'antiquité au dimanche après la fête et gardée aussi en ce jour.", "patron": "On les invoque pour les familles des serviteurs du Seigneur; pour la parenté avec le Christ par l'obéissance."},

"Commemoration of the Kazan Icon of the Mother of God and the deliverance from the Poles":
{"type": "Icône de la Mère de Dieu", "life": "En ce jour l'Église fait mémoire de l'icône de Kazan de la Très Sainte Mère de Dieu, en souvenir de la délivrance de Moscou et de toute la Russie des Polonais, en l'an 1612. Au Temps des troubles, quand le pays était déchiré par l'invasion et la trahison et que Moscou même était tenue par des armes étrangères qui bafouaient la foi orthodoxe, le patriarche Hermogène, prisonnier, appela le peuple à se lever pour la défense de l'Église et de la patrie.", "patron": "On l'invoque pour la délivrance des nations; pour la protection au temps des troubles."},

"Commemoration of the Miracle of the Archangel Michael at Colossae":
{"type": "Fête", "life": "En ce jour l'Église fait mémoire du glorieux miracle opéré par l'archange Michel à Chones, près de Colosses en Phrygie. Il y avait en ce lieu une source miraculeuse, annoncée d'avance par l'apôtre Jean le Théologien lorsqu'il prêchait à Hiérapolis; et un homme de Laodicée, dont la fille muette reçut la parole par ces eaux après que l'archange lui fut apparu en songe, fut baptisé avec toute sa maison et bâtit sur la source une église en l'honneur du chef de la milice céleste, Michel.", "patron": "On l'invoque pour la protection; pour la guérison."},

"Commemoration of the Shepherds in Bethlehem who were watching their flocks, and went to see the Lord":
{"type": "Justes · Ier s.", "life": "Au premier jour de la Nativité l'Église fait mémoire des bergers de Bethléem, qui veillaient la nuit sur leurs troupeaux dans les champs quand la gloire du Seigneur les enveloppa de sa lumière, et qui furent les premiers du genre humain à entendre annoncer l'Évangile.", "patron": "On les invoque pour les bergers; pour les veilleurs de nuit."},

"Commemoration of the Vladimir Icon of the Mother of God and the deliverance of Moscow from the Invasion of Tamerlane":
{"type": "Icône de la Mère de Dieu · XIVe s.", "life": "L'icône de Vladimir de la Très Sainte Mère de Dieu, peinte selon la tradition par l'évangéliste Luc et apportée de Constantinople en Rus, fut placée par saint André Bogolioubski dans la cathédrale de Vladimir, dont elle a pris son nom, et elle devint l'icône la plus aimée et la plus protectrice de la terre russe.", "patron": "On l'invoque pour la protection de la Russie; pour la délivrance de l'invasion."},

"Conception of the Honorable Glorious Prophet, Forerunner and Baptist John":
{"type": "Fête · Ier s.", "life": "En ce jour l'Église célèbre la Conception du vénérable et glorieux prophète, précurseur et baptiste Jean, commencement de l'histoire de l'Évangile. Comme le prêtre Zacharie, au tour de sa classe, était entré dans le Temple du Seigneur pour offrir l'encens, l'archange Gabriel lui apparut à droite de l'autel des parfums.", "patron": "On l'invoque pour les couples sans enfants; pour la prière exaucée."},

"Conception of the Most Holy Theotokos by Saint Anna":
{"type": "Fête", "life": "Cette fête célèbre la conception de la Vierge Marie par sa mère, la juste Anne, neuf mois avant la fête de la nativité de Marie, le 8 septembre. Selon la tradition de l'Église, Joachim et Anne étaient justes, mais sans enfants et avancés en âge, et leur stérilité leur était comptée pour un opprobre.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Confessors Barses and Eulogius, Bishops of Edessa, and Protogenes, Bishop of Carrhae":
{"type": "Évêque · IVe s.", "life": "Les saints Barsès et Euloge, évêques d'Édesse, et Protogène, évêque de Carrhes, furent des confesseurs qui souffrirent des ariens dans la seconde moitié du quatrième siècle, quand l'empereur Valens cherchait à répandre cette hérésie et persécutait cruellement les orthodoxes. Saint Barsès, ferme champion de la vraie foi, fut chassé de son trône d'Édesse et envoyé en exil, d'un lieu puis d'un autre, toujours plus loin de sa ville.", "patron": "On les invoque pour l'Orthodoxie contre l'hérésie; pour la constance dans l'exil."},

"Consecration of the Church of the Holy Great Martyr George in Lydda":
{"type": "Fête", "life": "En ce jour l'Église fait mémoire de la consécration de l'église du saint grand-martyr Georges à Lydda, en Palestine, et du dépôt en ce lieu de ses précieuses reliques. Le grand-martyr, qui souffrit à Nicomédie en l'an 303 sous Dioclétien, avait demandé à son serviteur, avant son combat, de porter son corps à Lydda, patrie de la famille de sa mère en Terre sainte.", "patron": "On l'invoque pour la vénération du saint grand-martyr Georges."},

"Constantinople Icon of the Mother of God":
{"type": "Fête · Ier s.", "life": "En ce jour l'Église fait mémoire de l'icône de Constantinople de la Très Sainte Mère de Dieu, image que la tradition compte parmi celles qu'a peintes le saint apôtre et évangéliste Luc lui-même, le médecin et l'iconographe de la Mère de Dieu, dont le pinceau, tient l'Église, a donné le premier aux fidèles sa ressemblance et a reçu d'elle sa bénédiction sur cet ouvrage, sa parole que sa grâce serait avec ces images.", "patron": "On l'invoque pour les iconographes; pour tous ceux qui honorent les icônes de la Mère de Dieu."},

"Dedication of the Church of the Greatmartyr George at Kyiv":
{"type": "Fête", "life": "En ce jour l'Église fait mémoire de la consécration de l'église du saint grand-martyr Georges à Kyiv. C'était la pieuse coutume des princes de la Rus, depuis saint Vladimir, d'élever des églises en l'honneur de leurs saints patrons: Vladimir, nommé Basile au baptême, bâtit des temples de saint Basile à Kyiv et à Vychgorod, et ses fils le suivirent en cela.", "patron": "On l'invoque pour la vénération du grand-martyr Georges en terre de Rus; pour les églises bâties en action de grâces."},

"Dormition of the Righteous Anna, the Mother of the Most Holy Theotokos":
{"type": "Juste · Ier s.", "life": "Cette fête commémore le repos paisible de la juste Anne, mère de la Très Sainte Mère de Dieu et aïeule de notre Seigneur selon la chair. Anne était fille du prêtre Matthan, de la tribu de Lévi et de la lignée d'Aaron, et avec son époux, le juste Joachim, elle porta de longues années l'opprobre de la stérilité, jusqu'à ce que, dans leur vieillesse, Dieu exauçât leurs prières et leur accordât une fille, la pure Vierge Marie, qui devait devenir la Mère de Dieu.", "patron": "On l'invoque pour les mères; pour les grand-mères."},

"Entrance of the Apostle Andrew into Georgia":
{"type": "Fête", "life": "En ce jour l'Église de Géorgie fait mémoire de l'entrée du saint apôtre André le Premier-Appelé dans les terres géorgiennes, fondation apostolique sur laquelle repose cette Église ancienne. La tradition de Géorgie rapporte que, lorsque les apôtres tirèrent au sort les nations, l'Ibérie échut à la Très Sainte Mère de Dieu elle-même.", "patron": "On l'invoque pour le fondement apostolique de l'Église de Géorgie; pour la Mère de Dieu protectrice de la Géorgie."},

"Equal of the Apostles and Emperor Constantine with his Mother Helen":
{"type": "Égaux aux Apôtres · IVe s.", "life": "Le saint empereur Constantin, égal aux apôtres, devint empereur des Romains et mit fin à la persécution des chrétiens par l'édit de Milan. Il soutint l'Église et convoqua à Nicée le premier concile œcuménique. Sa mère, sainte Hélène, se rendit à Jérusalem, et son nom demeure attaché à l'invention de la Croix vivifiante. Ils se reposèrent au quatrième siècle."},

"Equal-to-the-Apostles Blessed Great Princess Olga (in Holy Baptism Helen)":
{"type": "Égale aux Apôtres · Xe s.", "life": "Sainte Olga, égale aux apôtres, était princesse de Kyiv et aïeule de saint Vladimir. Après la mort du prince Igor, elle gouverna la terre de Rus avec sagesse. Elle reçut le saint baptême sous le nom d'Hélène et travailla à répandre la foi chrétienne parmi son peuple, bien que la Rus ne fût pas encore baptisée. Elle se reposa en 969."},

"Equals of the Apostles and Teachers of the Slavs, Cyril and Methodius":
{"type": "Apôtre · IXe s.", "life": "Les saints Cyrille et Méthode, égaux aux apôtres et docteurs des Slaves, étaient frères, d'une famille sénatoriale de Thessalonique, cette ville au bord du monde slave dont les rues leur avaient appris la langue slave dès l'enfance, providence pour l'œuvre qui les attendait.", "patron": "L'alphabet donné aux Slaves."},

"Eve of the Nativity of our Lord":
{"type": "Veille de fête", "life": "La veille de la Nativité de notre Seigneur, appelée la Paramonie, est le seuil de la fête, et l'Église la garde comme elle garde la seule veille de la Théophanie, par un jour de jeûne strict et la plus solennelle préparation de son année. Au matin se chantent les Heures royales, ainsi nommées parce que les empereurs s'y tenaient autrefois debout: à chaque heure sont lus les psaumes de l'Incarnation, les prophéties, l'Apôtre et l'Évangile de la naissance, toute l'Écriture rassemblée autour de la grotte.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Fathers of the First Six Councils":
{"type": "Évêques", "life": "En ce jour l'Église fait mémoire des saints Pères des six premiers conciles œcuméniques, hiérarques et docteurs théophores rassemblés de toutes les parties du monde chrétien pour défendre la foi apostolique contre les hérésies qui l'assaillaient. À Nicée et au premier concile de Constantinople ils proclamèrent la divinité du Fils et du Saint-Esprit et donnèrent à l'Église le Symbole de la foi que nous confessons jusqu'à ce jour.", "patron": "On les invoque pour la doctrine orthodoxe; pour la vraie foi."},

"Finding of the Relics of Saints Basil and Constantine, Princes of Yaroslavl":
{"type": "Fête · XVIe s.", "life": "En ce jour l'Église fait mémoire de l'invention des reliques des saints princes fidèles Basile et Constantin de Iaroslavl, deux frères qui gouvernèrent leur ville et souffrirent pour elle dans les années amères du joug tatar, et dont les corps incorrompus furent révélés longtemps après dans un incendie.", "patron": "Les princes de Iaroslavl; ceux dont les reliques sont trouvées après l'incendie."},

"Finding of the relics of Monastic Martyr Adrian of Poshekhonsk, Yaroslavl":
{"type": "Higoumène · XVIe s.", "life": "En ce jour l'Église fait mémoire de l'invention des reliques du moine-martyr Adrien de Pochekhonié, qui eut lieu le dix-neuf novembre 1625. Adrien, moine et iconographe de grand don, formé dans la tradition des grands monastères du Nord, avait fondé avec un compagnon d'ascèse un monastère de la Dormition de la Très Sainte Mère de Dieu dans les forêts de Pochekhonié, au pays de Iaroslavl, y peinant dans le jeûne, la prière et la peinture des saintes icônes, et rassemblant une fraternité autour de l'église du désert.", "patron": "On l'invoque pour les iconographes; pour les moines."},

"Finding of the relics of Righteous Saint Νikόdēmos":
{"type": "Juste · Ier s.", "life": "Le juste Nicodème était pharisien et chef des Juifs; il vint de nuit auprès du Seigneur Jésus, comme le rapporte l'Évangile de Jean, et il entendit de lui la parole de la nouvelle naissance par l'eau et l'Esprit. Bien qu'il fût venu d'abord en secret, par crainte des Juifs, il défendit le Sauveur devant le conseil, et après la crucifixion il vint ouvertement avec Joseph d'Arimathie, apportant un mélange de myrrhe et d'aloès, et il aida à oindre et à ensevelir le corps du Seigneur.", "patron": "On l'invoque pour les disciples secrets; pour les chercheurs de la vérité."},

"Finding of the relics of Saint Abibas":
{"type": "Juste · Ier s.", "life": "Le juste Abibas était le fils du juste Gamaliel, le maître de saint Paul, et il reçut avec son père le saint baptême des mains des apôtres, embrassant la foi du Christ. Vivant dans la pureté, il s'endormit encore jeune et fut enseveli par son père dans la grotte de Caphargamala, où reposaient déjà le protomartyr Étienne et saint Nicodème.", "patron": "On l'invoque pour la pureté."},

"Finding of the relics of Saint Basil, Bishop of Ryazan":
{"type": "Fête · XVIIe s.", "life": "En ce jour l'Église fait mémoire de l'invention des reliques de saint Basile, évêque de Riazan, hiérarque du treizième siècle dont l'innocence fut justifiée par un prodige fameux et dont les reliques furent révélées dans les années troublées du dix-septième.", "patron": "Les faussement accusés; les évêques chassés par la calomnie."},

"Finding of the relics of Saint Gamaliel":
{"type": "Juste · Ier s.", "life": "Le juste Gamaliel était pharisien et docteur renommé de la Loi, honoré parmi les Juifs; il conseilla la modération envers les apôtres lorsqu'ils furent amenés devant le conseil, comme le rapportent les Actes des Apôtres, et il avait été le maître de saint Paul. En secret il devint disciple du Christ, et lorsque le protomartyr Étienne eut été lapidé et laissé sans sépulture, ce fut Gamaliel qui releva son corps avec révérence et le déposa dans une grotte, sur sa propre terre, à Caphargamala.", "patron": "On l'invoque pour les maîtres; pour les disciples secrets."},

"Finding of the relics of Saint Theodore, Prince of Smolensk and Yaroslavl, and his children":
{"type": "Prince · XIIIe s.", "life": "En ce jour l'Église fait mémoire de l'invention des reliques du prince fidèle Théodore de Smolensk et de Iaroslavl, appelé le Noir, avec ses fils David et Constantin, qui eut lieu à Iaroslavl le cinq mars 1463; la dormition du prince lui-même se garde en septembre, mais ce jour appartient à l'invention de son corps incorrompu.", "patron": "On l'invoque pour les souverains; pour les familles."},

"Finding of the relics of Venerable Cyril, Abbot of Novoezersk, Vologda":
{"type": "Higoumène · XVIe s.", "life": "En ce jour l'Église fait mémoire de l'invention des reliques du vénérable Cyrille, higoumène de Novoiezersk, qui eut lieu en l'an 1649. Né d'une famille noble de Galitch, il s'enfuit de la maison de ses parents à l'âge de quinze ans, attiré par l'amour du Christ, et parvint à travers les forêts auprès du grand ancien Corneille de Komel, qui, discernant sur l'enfant le sceau de Dieu, le tonsura.", "patron": "On l'invoque pour les moines; pour la consécration dès la jeunesse."},

"Finding of the relics of Venerable Maximus the Greek (July 4, 1996)":
{"type": "Moine · XVIe s.", "life": "Cette fête commémore l'invention des reliques du vénérable Maxime le Grec, moine savant et confesseur. Né Michel Trivolis à Arta, en Grèce, vers 1470, il étudia en Italie, puis se fit moine au Mont Athos, et fut envoyé en Russie en 1518 pour traduire et corriger les livres sacrés.", "patron": "On l'invoque pour les traducteurs et les savants; pour les prisonniers injustement détenus."},

"First Translation of the relics of Saint Herman, Archbishop of Kazan":
{"type": "Archevêque · XVIe s.", "life": "Saint Germain, archevêque de Kazan, naquit à Staritsa, de la noble famille des Sadyrev-Polev; ayant reçu la tonsure au monastère de Volokolamsk, il fut formé à l'école de saint Joseph, et devint célèbre par son savoir, sa vie ascétique et son labeur de copiste. Lorsque les terres nouvellement conquises de Kazan furent ouvertes à l'Évangile, il fut envoyé avec saint Gourias pour les éclairer, et il fonda à Sviajsk le monastère de la Dormition de la Mère de Dieu, qui devint le centre de la mission auprès des peuples de la Volga.", "patron": "On l'invoque pour les missionnaires; pour l'illumination des terres de Kazan."},

"First and second finding of the Honorable Head of the Holy Glorious Prophet, Forerunner, and Baptist of the Lord, John":
{"type": "Fête · Ve s.", "life": "En ce jour l'Église célèbre la première et la deuxième invention du précieux chef de saint Jean le Précurseur, les deux premiers chapitres de l'étrange itinéraire de la relique la plus vénérée de la chrétienté après les instruments de la Passion. Lorsque Hérodiade eut obtenu sur un plat la tête du Baptiste, prix de sa vengeance, elle ne souffrit pas qu'elle fût ensevelie avec le corps, craignant, dit la tradition, la résurrection de l'homme qu'elle avait fait taire, et elle la cacha en un lieu impur du palais d'Hérode.", "patron": "On l'invoque pour tous ceux qui cherchent ce qui est caché; pour les gardiens des reliques."},

"First finding of the relics of Saint Metrophanes, first Bishop of Voronezh":
{"type": "Évêque · XVIIIe s.", "life": "Saint Mitrophane fut le premier évêque de Voronej, sacré en 1682, et il fut renommé pour sa profonde piété, son soin des pauvres et son zèle pour l'Église; conseiller et soutien de l'empereur Pierre le Grand dans la construction de la flotte russe à Voronej, il ne craignit pas de reprendre le souverain lorsque des statues païennes furent dressées, et il fut écouté.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Forefeast of the Annunciation":
{"type": "Fête · Ier s.", "life": "En ce jour l'Église garde l'avant-fête de l'Annonciation, l'unique journée de préparation qui précède la fête que les pères ont appelée le chef de notre salut et le commencement de toutes les fêtes; et les hymnes du jour se tiennent sur la pointe des pieds: aujourd'hui, chantent-elles, le grand mystère approche, l'archange est envoyé, la Vierge est en prière, et la joie de toute la création n'est plus qu'à un soir de distance.", "patron": "En ce jour on prie pour tous ceux qui se préparent à une grande joie; pour la veille de la grande bonne nouvelle."},

"Forefeast of the Dormition of the Mother of God":
{"type": "Avant-fête", "life": "Ce jour est l'avant-fête de la Dormition de notre Très Sainte Souveraine la Mère de Dieu, où l'Église commence à célébrer son bienheureux endormissement, gardé le quinze août à la clôture du jeûne qui lui est consacré. Les hymnes de l'avant-fête appellent les fidèles à se rassembler dans l'allégresse, car la Mère de Dieu va quitter la terre pour le Royaume des cieux, afin d'être élevée dans la gloire par son Fils.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Forefeast of the Elevation of the Cross":
{"type": "Avant-fête", "life": "Voici l'avant-fête de l'Exaltation universelle de la précieuse et vivifiante Croix, où l'Église commence à célébrer la grande fête du lendemain. Aux offices les hymnes de la Croix commencent à retentir, appelant les fidèles à purifier leur âme afin qu'ils puissent contempler le saint Bois élevé au milieu de la terre.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Forefeast of the Entry into the Temple of the Most Holy Theotokos":
{"type": "Avant-fête", "life": "En ce jour l'Église garde l'avant-fête de l'Entrée au Temple de la Très Sainte Mère de Dieu, se tenant au seuil de la fête comme l'enfant Marie se tint au seuil du sanctuaire. Les hymnes de l'avant-fête appellent les fidèles à se préparer: Réjouissons-nous aujourd'hui, fidèles, en psalmodiant au Seigneur, et honorons son tabernacle sanctifié, l'arche vivante qui contint le Verbe que rien ne peut contenir.", "patron": "On l'invoque pour la préparation aux fêtes de la Mère de Dieu."},

"Forefeast of the Meeting of our Lord in the Temple":
{"type": "Avant-fête", "life": "L'avant-fête de la Rencontre de notre Seigneur au Temple se garde le premier février, unique journée de préparation avant la fête qui clôt tout le cycle de la Nativité du Seigneur; et en elle l'Église tourne les yeux vers le Temple de Jérusalem, où demain le Législateur sera porté, enfant de quarante jours, pour accomplir sa propre Loi.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Forefeast of the Nativity of our Lord":
{"type": "Avant-fête", "life": "L'avant-fête de la Nativité de notre Seigneur embrasse les jours du vingt décembre à la vigile de la fête, et en eux l'Église, comme Bethléem dans les hymnes, se prépare. Les offices se tournent tout entiers vers la grotte: chaque jour, aux stichères, retentit l'appel: Bethléem, prépare-toi.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Forefeast of the Nativity of the Mother of God":
{"type": "Avant-fête", "life": "Voici l'avant-fête de la Nativité de la Très Sainte Mère de Dieu, où l'Église commence à célébrer la première des grandes fêtes de la nouvelle année ecclésiastique, la naissance de la Mère de Dieu des justes Joachim et Anne. En ce jour les hymnes de la fête qui vient commencent à retentir aux offices, appelant les fidèles à préparer leur cœur pour accueillir la Vierge dont la naissance annonça au monde l'approche de son salut.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Forefeast of the Procession of the Honorable and Lifegiving Cross of the Lord":
{"type": "Avant-fête", "life": "Ce jour est l'avant-fête de la Procession de la précieuse et vivifiante Croix du Seigneur, que l'Église célèbre le premier août. Dans la ville impériale de Constantinople, la coutume était, au mois d'août, où les maladies sévissaient le plus, de tirer le vénérable Bois de la Croix du trésor des empereurs.", "patron": "On l'invoque pour la délivrance des maladies; pour la sanctification."},

"Forefeast of the Transfiguration of our Lord":
{"type": "Avant-fête", "life": "Ce jour est l'avant-fête de la Transfiguration de notre Seigneur, Dieu et Sauveur Jésus-Christ, que l'Église célèbre le six août. Voulant donner à ses disciples, avant sa Passion, un avant-goût de la gloire du Royaume, le Seigneur prit avec lui Pierre, Jacques et Jean et les conduisit sur une haute montagne, et là il fut transfiguré devant eux, en sorte que son visage resplendit comme le soleil et que ses vêtements devinrent blancs comme la lumière.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Glorification of Saint Innocent, Metropolitan of Moscow, Enlightener of the Aleuts, Apostle to the Americas":
{"type": "Métropolite · XIXe s.", "life": "En ce jour l'Église fait mémoire de la glorification de saint Innocent, métropolite de Moscou, illuminateur des Aléoutes et apôtre des Amériques, compté parmi les saints par l'Église orthodoxe russe le six octobre 1977, à la demande de l'Église orthodoxe en Amérique. Il était né Jean Popov-Veniaminov en 1797 dans un village de Sibérie, sur la Léna.", "patron": "On l'invoque pour les missionnaires; pour les traducteurs."},

"Glorification of Saint John of Kronstadt":
{"type": "Prêtre · XXe s.", "life": "Saint Jean de Cronstadt, l'un des grands pasteurs de l'Église russe, naquit Jean Sergiev en 1829 dans un pauvre village de l'extrême Nord et devint prêtre marié à la cathédrale Saint-André de Cronstadt, près de Saint-Pétersbourg, où il servit plus de cinquante ans.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Glorification of Saint Tikhon, Patriarch of Moscow and All Russia, Enlightener of North America":
{"type": "Patriarche · XXe s.", "life": "En ce jour l'Église fait mémoire de la glorification de saint Tikhon, patriarche de Moscou et de toute la Russie, compté parmi les saints par le concile des évêques de l'Église orthodoxe russe le neuf octobre 1989. Né Basile Bellavine en 1865, fils d'un prêtre de village de Toropets, il était si aimé pour sa douceur que ses condisciples du séminaire l'appelaient par plaisanterie le Patriarche, sans savoir qu'ils prophétisaient.", "patron": "On l'invoque pour les hiérarques; pour les missionnaires."},

"Glorification of Venerable Herman of Alaska, Wonderworker of All America":
{"type": "Vénérable · XIXe s.", "life": "Le vénérable Germain d'Alaska, le premier des saints orthodoxes d'Amérique du Nord, était un humble moine du monastère de Valaam, en Russie, qui se joignit en 1794 à la mission envoyée pour porter l'Évangile aux peuples autochtones de l'Alaska. Établi sur l'île de Spruce, qu'il appelait la Nouvelle Valaam, il vécut en ascète et devint un père et un protecteur pour le peuple aléoute, le défendant contre les injustices des marchands russes, instruisant les enfants, prenant soin des malades et des orphelins, et attirant beaucoup d'hommes au Christ par sa douceur et son amour.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Glorification of the Priestmartyr Alexander Hotovitzky":
{"type": "Protopresbytre · XXe s.", "life": "En ce jour l'Église fait mémoire de la glorification du hiéromartyr Alexandre Hotovitzky, compté parmi les saints par l'Église orthodoxe russe le quatre décembre 1994. Né le onze février 1872 à Kremenets, en Volhynie, fils d'un archiprêtre aimé, recteur de séminaire, Alexandre acheva avec distinction l'Académie de théologie de Saint-Pétersbourg.", "patron": "On l'invoque pour les prêtres de paroisse; pour les missionnaires."},

"Great Martyr Anastasia the Deliverer from Poisons, her teacher, Martyr Chrysogonos, and many with them":
{"type": "Grande-martyre · IVe s.", "life": "La sainte grande-martyre Anastasie, la Libératrice des poisons, était romaine de haute naissance, fille d'un père païen et d'une mère chrétienne en secret, Fausta, et elle fut formée dans la foi par son maître, le sage confesseur Chrysogone. Mariée contre son cœur au païen Publius, elle garda sa virginité en feignant la maladie, et, revêtant l'habit d'une mendiante, elle parcourait avec une seule servante les prisons de Rome, nourrissant, soignant et rachetant les captifs du Christ, car elle était instruite dans l'art de la médecine et fit de sa science un ministère.", "patron": "On l'invoque pour les infirmiers; pour les médecins."},

"Great Martyr Euphemia the All-praised":
{"type": "Grande-martyre · IVe s.", "life": "La sainte grande-martyre Euphémie la Toute-louée était fille de pieux chrétiens de Chalcédoine, et elle souffrit dans cette ville en l'an 303, durant la persécution de Dioclétien. Comme le proconsul Priscus avait ordonné à tous les habitants de prendre part à la fête de l'idole Arès, Euphémie, avec d'autres chrétiens qui s'étaient cachés pour adorer le vrai Dieu, fut découverte et traduite en jugement.", "patron": "On l'invoque pour la pureté; pour la justification de l'Orthodoxie."},

"Great Martyr Irene":
{"type": "Grande-martyre · IVe s.", "life": "La sainte grande-martyre Irène, l'une des plus aimées des femmes martyres de l'Orient, naquit, disent les récits grecs, dans la ville de Magédon, fille d'un souverain païen nommé Licinius, et reçut le nom de Pénélope; son père, fier de sa beauté, l'éleva dans une tour avec des suivantes, close au monde.", "patron": "Le nom de la Paix gagné par des guerres."},

"Great Martyr Katherine of Alexandria":
{"type": "Grande-martyre · IVe s.", "life": "La sainte grande-martyre Catherine d'Alexandrie était une jeune femme savante, de lignée royale, qui confessa le Christ durant la persécution de Maximin. Elle confondit les philosophes païens, en convertit beaucoup et refusa d'épouser l'empereur. Après la prison et les tourments, dont la roue brisée, elle fut décapitée et reçut la couronne du martyre au commencement du quatrième siècle."},

"Great Martyr Marina (Margaret) of Antioch":
{"type": "Grande-martyre · IVe s.", "life": "La sainte grande-martyre Marine, appelée en Occident Marguerite, fut élevée à Antioche de Pisidie et confessa le Christ toute jeune durant la persécution de Dioclétien. Refusant d'épouser un fonctionnaire païen et refusant de sacrifier aux idoles, elle endura la prison et les tourments. Affermie par le Christ, elle fut enfin décapitée et reçut la couronne du martyre au commencement du quatrième siècle."},

"Great Martyr Mercurius of Caesarea, in Cappadocia":
{"type": "Grand-martyr · IIIe s.", "life": "Le saint grand-martyr Mercure de Césarée était un jeune soldat d'origine scythe servant dans les armées romaines, fils d'un officier chrétien; et lorsque les barbares déferlèrent sur la frontière aux jours de l'empereur Dèce, un ange du Seigneur lui apparut, lui mit une épée à la main et lui promit la victoire, lui enjoignant de se souvenir du Seigneur son Dieu.", "patron": "On l'invoque pour les soldats; pour la victoire donnée du ciel."},

"Great Martyr Theodore the Tyro (Recruit)":
{"type": "Grand-martyr · IVe s.", "life": "Le saint grand-martyr Théodore le Tyron était une recrue de l'armée romaine à Amasée, durant la persécution de Maximien. Refusant de sacrifier aux idoles, il brûla un temple païen et confessa le Christ devant le gouverneur. Après la prison et les tourments, il fut jeté au feu et reçut la couronne du martyre au commencement du quatrième siècle.", "patron": "On l'invoque traditionnellement pour retrouver ce qui a été volé."},

"Greatmartyr Artemius at Antioch":
{"type": "Grand-martyr · IVe s.", "life": "Le saint grand-martyr Artème d'Antioche était un chef militaire distingué sous saint Constantin le Grand et sous son fils Constance, honoré pour sa valeur et ses services et fait vice-roi impérial d'Égypte, où il travailla beaucoup à la propagation de la foi; et ce fut Artème que l'empereur envoya chercher les reliques de l'apôtre André à Patras et de l'apôtre Luc à Thèbes de Béotie, pour les porter à Constantinople, où elles furent déposées dans l'église des Saints-Apôtres.", "patron": "On l'invoque pour les soldats; pour les fonctionnaires."},

"Greatmartyr Barbara and Martyr Juliana, at Heliopolis in Syria":
{"type": "Grande-martyre · IVe s.", "life": "La sainte grande-martyre Barbe vivait à Héliopolis de Syrie sous le règne de Maximien. Tenue à l'écart du monde par son père païen, elle parvint à la connaissance du vrai Dieu et confessa le Christ. Après les tourments, elle fut mise à mort par la main de son propre père. Sainte Julienne, qui vit son combat et confessa le Christ, fut martyrisée elle aussi au commencement du quatrième siècle."},

"Greatmartyr Euphemia the All-praised":
{"type": "Vierge · IVe s.", "life": "Ce jour commémore le grand miracle opéré par sainte Euphémie la Toute-louée pour la défense de la foi orthodoxe. Ayant souffert le martyre à Chalcédoine sous Dioclétien, elle fut glorifiée de nouveau un siècle et demi plus tard, en l'an 451, lorsque le quatrième concile œcuménique se réunit dans l'église même où reposaient ses reliques, pour condamner l'hérésie des monophysites et confesser les deux natures du Christ, divine et humaine.", "patron": "On l'invoque pour la défense de la doctrine orthodoxe."},

"Greatmartyr Eustáthios Placidas, with his wife and children, of Rome":
{"type": "Grand-martyr · IIe s.", "life": "Le saint grand-martyr Eustathe, nommé Placide avant son baptême, était un général romain fameux sous les empereurs Titus et Trajan, libéral envers les pauvres quoiqu'il fût encore païen; et comme il chassait un jour, il lui fut accordé une vision admirable, un cerf se retournant vers lui, portant entre ses bois la Croix du Christ toute rayonnante, et une voix qui l'appelait par son nom, disant, Pourquoi me poursuis-tu, Placide? Je suis le Christ que tu honores sans le connaître par tes bonnes œuvres.", "patron": "On l'invoque pour les soldats; pour les chasseurs."},

"Greatmartyr George the New at Sofia, Bulgaria":
{"type": "Grand-martyr · XVIe s.", "life": "Le saint grand-martyr Georges le Nouveau, qui souffrit à Sofia, était un jeune chrétien des Slaves du sud au temps du joug turc, et ce jour garde la mémoire de l'élévation et de la déposition de ses saintes reliques, qui suivit de près son martyre.", "patron": "Le jeune homme de dix-huit ans, ferme comme le diamant."},

"Greatmartyr James the Persian":
{"type": "Grand-martyr · Ve s.", "life": "Le saint grand-martyr Jacques le Perse, appelé l'Intercis, le Coupé en morceaux, était un noble chrétien de Perse, riche, honoré et aimé du roi Yazdgard; et son âme, prise dans l'amitié du roi, tomba dans le grand péché de sa vie, car lorsque le roi se tourna contre les chrétiens, Jacques, ne voulant pas perdre sa faveur, renia le Christ avec la cour.", "patron": "On l'invoque pour les courtisans; pour le repentir après le reniement."},

"Greatmartyr Niketas the Goth":
{"type": "Grand-martyr · IVe s.", "life": "Le saint grand-martyr Nicétas était goth, né et demeurant sur les rives du Danube, et il fut baptisé par Théophile, évêque des Goths, qui avait pris part au premier concile œcuménique. Lorsque la guerre divisa son peuple et que le chef païen Athanaric souleva une violente persécution contre les chrétiens des Goths, Nicétas, qui par sa prédication et sa vie sainte avait amené au Christ beaucoup des siens, devint une colonne de l'Église persécutée, affermissant les fidèles pour le martyre et reprochant hardiment au persécuteur sa cruauté et son impiété.", "patron": "On l'invoque pour les soldats; pour les enfants."},

"Greatmartyr Paraskevi of Iconium":
{"type": "Grande-martyre · IIIe s.", "life": "La sainte grande-martyre Parascève d'Iconium vécut au troisième siècle, née d'une famille riche et pieuse qui vénérait particulièrement le vendredi de la Passion du Seigneur, et qui pour cette raison nomma sa fille Parascève, ce qui veut dire vendredi. Aimant la pureté dès sa jeunesse, elle voua sa virginité au Christ, et, ses parents s'étant endormis, elle distribua ses biens aux pauvres et se consacra à éclairer de la lumière de l'Évangile les païens de sa ville.", "patron": "On l'invoque pour les marchands; pour les négociants."},

"Greatmartyr Procopius of Caesarea, in Palestine":
{"type": "Proconsul (chef militaire) · IVe s.", "life": "Le saint grand-martyr Procope, appelé Néanias avant son baptême, était originaire de Jérusalem et vécut sous l'empereur Dioclétien. Élevé par sa mère païenne Théodosie après la mort de son père chrétien, il reçut une excellente éducation, s'éleva rapidement dans le service impérial et fut envoyé comme proconsul à Alexandrie pour y persécuter les chrétiens.", "patron": "On l'invoque pour les soldats; pour la conversion."},

"Greatmartyr and Healer Panteleimon":
{"type": "Grand-martyr · début du IVe s.", "life": "Le saint grand-martyr et guérisseur Pantéléimon était un jeune médecin de Nicomédie, converti au Christ et instruit par le prêtre Hermolaos. Il guérissait gratuitement les malades au nom du Christ, et parmi eux ceux que les médecins païens ne pouvaient guérir, et il donna ses biens aux pauvres. Dénoncé sous Maximien, il endura sans dommage de nombreux tourments avant d'être décapité. Il est compté parmi les saints anargyres.", "patron": "Patron des médecins et des malades; on l'invoque pour la guérison du corps et de l'âme."},

"Greatmartyr, Victory-bearer, and Wonderworker George":
{"type": "Grand-martyr · IVe s.", "life": "Le saint grand-martyr Georges était un soldat cappadocien qui servait dans l'armée romaine sous Dioclétien. Quand la persécution s'éleva, il confessa ouvertement le Christ, distribua ses biens et refusa d'adorer les idoles. Il endura de nombreux tourments et fut décapité à Nicomédie vers l'an 303, devenant célèbre comme porte-victoire et thaumaturge."},

"Heiromartyr Theokteristus":
{"type": "Confesseur-martyr et higoumène · IXe s.", "life": "Le saint confesseur Théoctériste, appelé aussi Théostérictos, higoumène du monastère de Pélécète près de Pruse, se tint au centre de l'une des plus noires atrocités de la persécution iconoclaste et donna à l'Église, du fond de cette nuit, l'une de ses prières les plus aimées. Né à Triglia de Bithynie, il se fit moine dans sa jeunesse au monastère de Saint-Jean-le-Théologien dit de Pélécète.", "patron": "On l'invoque pour les higoumènes; pour les hymnographes."},

"Hieromartyr Alexander of Sίdē, in Pamphylia":
{"type": "Hiéromartyr · IIIe s.", "life": "Le saint hiéromartyr Alexandre était prêtre de la ville de Sidè en Pamphylie, sur la côte méridionale de l'Asie Mineure, et il souffrit sous l'empereur Aurélien, dans le dernier sursaut de persécution du troisième siècle avant la grande tempête de Dioclétien. Amené devant le gouverneur Antonin, le prêtre fut interrogé sur son nom et sa charge, et répondit par la confession qui rendait le reste inévitable, qu'il était chrétien et pasteur du troupeau du Christ.", "patron": "On l'invoque pour les prêtres devant les tribunaux; pour la réponse hardie sous Aurélien."},

"Hieromartyr Alexander, Bishop of Adrianopolis, and the Martyrs Heraclius, Anna, Elizabeth, Theodota, and Glyceria":
{"type": "Martyrs · IIIe s.", "life": "Les saints martyrs Alexandre l'évêque, Héraclius le soldat, et les femmes Anne, Élisabeth, Théodote et Glycérie souffrirent à Andrinople de Thrace au temps des persécutions. Alexandre, évêque de cette ville, annonçait l'Évangile avec hardiesse et refusa de sacrifier aux idoles, ce pour quoi il fut soumis à de longs et cruels tourments.", "patron": "On les invoque pour la conversion par le témoignage des martyrs."},

"Hieromartyr Alexander, Bishop of Comana":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Alexandre vécut au troisième siècle près de Néocésarée, homme instruit dans les Écritures et dans beaucoup de sciences, qui prit pourtant sur lui l'exploit caché de la folie pour le Christ, vivant dans la pauvreté et vendant du charbon sur la place de la ville. Son visage était toujours noirci de poussière de charbon, et beaucoup le regardaient avec mépris, ignorant sa sagesse et sa sainteté.", "patron": "On l'invoque pour l'humilité; pour la sagesse cachée."},

"Hieromartyr Alexander, Bishop of Jerusalem":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Alexandre, évêque de Jérusalem, fut formé à l'école catéchétique d'Alexandrie sous Clément, condisciple et ami de toute sa vie d'Origène, et devint évêque d'une ville de Cappadoce, où la persécution de Septime Sévère le tint des années dans les fers, confesseur avant d'être hiérarque.", "patron": "On l'invoque pour les bibliothécaires; pour les savants."},

"Hieromartyr Antherus (Antheros) Pope of Rome":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Anthère, grec de naissance, fut choisi comme évêque de Rome pour succéder à saint Pontien, mais il ne tint le siège que peu de temps, car il confessa bientôt le Christ et souffrit la mort pour la foi en l'an 236. Il fut déposé dans la catacombe de Saint-Calixte, le premier des évêques de Rome à être enseveli en ce lieu vénérable, et après lui saint Fabien fut choisi pour paître l'Église de Rome.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Hieromartyr Anthimus, Bishop of Nicomedia and those with him":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Anthime, évêque de Nicomédie, naquit dans cette ville et fut élevé dès l'enfance dans la foi chrétienne; humble, pacifique et rempli de zèle pour la gloire de Dieu, il fut en son temps établi évêque de Nicomédie. Il conduisit l'Église de cette ville durant la cruelle persécution de Dioclétien et de Maximien, quand le sang des chrétiens coulait à flots.", "patron": "On l'invoque pour la confession constante; pour la garde fidèle du troupeau sous la persécution."},

"Hieromartyr Antipas, Bishop of Pergamum and Disciple of Saint John the Theologian":
{"type": "Hiéromartyr · Ier s.", "life": "Le saint hiéromartyr Antipas, évêque de Pergame, porte une gloire que nul autre martyr de l'Église ne partage, car son témoignage est certifié dans les Écritures par la voix du Christ lui-même; en effet, dans l'Apocalypse, dans la lettre à l'Église de Pergame, le Seigneur dit, Je sais où tu habites, là où est le trône de Satan, et tu retiens mon nom, et tu n'as pas renié ma foi, même aux jours d'Antipas, mon témoin fidèle, qui a été mis à mort chez vous, là où Satan habite, l'éloge funèbre de l'évêque écrit par son Dieu.", "patron": "On l'invoque pour les évêques de la plantation apostolique; pour ceux qui souffrent des dents."},

"Hieromartyr Apollinaris, Bishop of Ravenna":
{"type": "Évêque · Ier s.", "life": "Le saint hiéromartyr Apollinaire fut disciple de l'apôtre Pierre, qu'il suivit d'Antioche à Rome, et Pierre le consacra premier évêque de Ravenne et l'y envoya prêcher l'Évangile. Arrivé en étranger, il fut recueilli par le soldat Irénée, dont il guérit le fils aveugle, et ainsi Irénée et sa maison devinrent les premiers chrétiens de Ravenne.", "patron": "On l'invoque pour l'illumination missionnaire; pour la guérison."},

"Hieromartyr Artemon of Laodikeia":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Artémon, prêtre de Laodicée de Syrie, donna à l'Église toute une vie avant de lui donner son sang: né de parents chrétiens, il servit seize ans comme lecteur, vingt-huit comme diacre et trente-trois comme prêtre, soixante-dix-sept ans dans les degrés ascendants du sanctuaire, en sorte que, lorsque éclata la persécution de Dioclétien, l'homme qu'elle trouva à Laodicée était un ancien que trois générations avaient entendu lire, servir et offrir.", "patron": "On l'invoque pour les lecteurs, les diacres et les prêtres; pour ceux qui servent de longues années."},

"Hieromartyr Athanasios, Venerable Anthousa, and others":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Athanase, évêque de Tarse en Cilicie, et ceux qui étaient avec lui, souffrirent pour le Christ au troisième siècle. La vénérable Anthouse, jeune fille de Séleucie de Syrie et fille de riches païens, avait entendu parler de la foi chrétienne et désirait être instruite par l'évêque Athanase; prenant donc avec elle deux serviteurs, Charisime et Néophyte, elle vint à Tarse sous le prétexte d'un autre voyage.", "patron": "On les invoque pour la conversion; pour la confession constante."},

"Hieromartyr Athenogenes, Bishop of Heracleopolis, and his ten disciples":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Athénogène, évêque d'Héracléopolis, souffrit avec ses dix disciples durant la persécution de Dioclétien, dans la ville de Sébaste en Cappadoce. Comme le gouverneur Philomaque célébrait une grande fête en l'honneur des idoles et ordonnait au peuple de sacrifier, les habitants de Sébaste, chrétiens pour la plupart, refusèrent, et beaucoup reçurent la couronne du martyre sous l'épée des soldats.", "patron": "On l'invoque pour la garde fidèle du troupeau."},

"Hieromartyr Autonomus, Bishop in Italy":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Autonome était évêque en Italie aux jours de la persécution de Dioclétien, et, se retirant devant la tempête, il vint à Soréoi de Bithynie, où il fut reçu par un homme pieux nommé Corneille et, loin de se reposer en sûreté, se donna à une prédication infatigable, convertissant une si grande multitude de païens qu'il ordonna Corneille diacre, puis évêque du troupeau qu'il avait rassemblé.", "patron": "On l'invoque pour les missionnaires; pour la prédication missionnaire."},

"Hieromartyr Babylas, Bishop of Antioch, and those with him":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Babylas, évêque d'Antioche, souffrit sous l'empereur Dèce avec les trois jeunes frères Urbain, Prilidien et Épolonios et leur mère Christodoule. Comme l'empereur, pendant une fête païenne dans la ville, voulait par curiosité entrer dans l'église où le saint évêque célébrait la divine Liturgie, Babylas sortit et lui barra le chemin, refusant de laisser entrer le prince impie dans le temple de Dieu.", "patron": "On l'invoque pour la hardiesse devant les puissants; pour la confession constante."},

"Hieromartyr Basil of Ancyra":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Basile, prêtre d'Ancyre en Galatie, fut le gardien du troupeau de cette ville à travers deux tempêtes successives, l'arienne et la païenne, et il tomba dans la seconde. Durant les années où les ariens tenaient le pouvoir et où les églises de Galatie étaient troublées, le presbytre Basile travailla sans relâche pour la foi de Nicée, affermissant ceux qui chancelaient, dénonçant ouvertement l'hérésie et gardant le peuple d'Ancyre dans la vraie confession, quoiqu'il lui en coûtât les vexations et la suspension des mains ariennes, le prêtre de paroisse tenant une ligne que des hiérarques abandonnaient.", "patron": "On l'invoque pour les prêtres de paroisse; pour ceux qui défendent le troupeau contre l'hérésie et l'apostasie."},

"Hieromartyr Basil, Bishop of Amasea":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Basile, évêque d'Amasée du Pont, remporta sa couronne à la toute dernière heure des persécutions, sous Licinius, quand le co-empereur d'Orient, rompant ses promesses de tolérance, se tourna de nouveau contre les chrétiens par jalousie de Constantin; et le combat de Basile naquit d'un acte d'hospitalité.", "patron": "On l'invoque pour les évêques qui abritent les traqués; pour les protecteurs des femmes en danger."},

"Hieromartyr Clement, Pope of Rome":
{"type": "Patriarche · IIe s.", "life": "Le saint hiéromartyr Clément, pape de Rome, naquit à Rome d'une famille riche et illustre, apparentée aux empereurs, et par une étrange providence fut séparé dès l'enfance de ses parents et de ses frères, élevé parmi des étrangers avec tous les avantages du savoir mais avec le cœur inquiet d'un orphelin.", "patron": "On l'invoque pour les tailleurs de pierre; pour les exilés."},

"Hieromartyr Cornelius the Centurion":
{"type": "Évêque · Ier s.", "life": "Le saint hiéromartyr Corneille le centurion, prémices des nations, était un officier romain de la cohorte italique en garnison à Césarée de Palestine, homme pieux qui craignait Dieu avec toute sa maison, faisait de larges aumônes et priait sans cesse, comme en témoignent les Actes des Apôtres. Un ange lui apparut, lui disant que ses prières et ses aumônes étaient montées en mémorial devant Dieu, et lui ordonnant d'envoyer chercher Simon Pierre.", "patron": "On l'invoque pour les soldats; pour les convertis."},

"Hieromartyr Cyprian, Bishop of Carthage":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Cyprien, évêque de Carthage, l'un des plus grands Pères de l'Église primitive, naquit vers l'an 200 dans cette ville, fils d'un riche sénateur païen, et devint un maître célèbre de rhétorique et de philosophie et un avocat dans les tribunaux. Longtemps, comme il l'a confessé lui-même plus tard, il demeura dans une profonde obscurité, loin de la lumière de la vérité, et ses richesses et ses plaisirs ne pouvaient étancher sa soif de quelque chose de plus haut.", "patron": "On l'invoque pour les théologiens; pour l'unité de l'Église."},

"Hieromartyr Cyprian, Virgin Martyr Justina, and Martyr Theoctistus, of Nicomedia":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Cyprien, la vierge-martyre Justine et le martyr Théoctiste souffrirent à Nicomédie en l'an 304. Cyprien était philosophe et magicien d'Antioche, instruit dès l'enfance aux mystères païens sur l'Olympe et à Argos, à Memphis et à Babylone, jusqu'à devenir fameux comme serviteur du prince des ténèbres.", "patron": "On les invoque pour la délivrance de la magie et des esprits mauvais; pour la pureté gardée par la Croix."},

"Hieromartyr Cyril, Bishop of Gortyna in Crete":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Cyrille était évêque de Gortyne, dans l'île de Crète, qu'il conduisit fidèlement pendant cinquante ans, et il était un vieillard d'un grand âge lorsque la persécution des chrétiens atteignit sa ville. Saisi et sommé de sacrifier aux idoles, il refusa et fut condamné à être brûlé vif.", "patron": "On l'invoque pour la prédication constante."},

"Hieromartyr Desan, Bishop in Persia, and 272 others with him":
{"type": "Hiéromartyrs · IVe s.", "life": "Le saint hiéromartyr Désan, évêque en Perse, souffrit avec deux cent soixante-douze compagnons dans la persécution du roi Sapor II, vers les années 362 à 364, et leur combat garde la mémoire de l'une des cruautés propres à cette persécution, le martyre des déportés. Quand les armées perses prirent les forteresses romaines de la frontière de Mésopotamie, elles emmenèrent en masse les populations chrétiennes à l'intérieur du royaume, le clergé et le peuple ensemble, des communautés déracinées avec leurs pasteurs et conduites vers l'orient comme un butin vivant.", "patron": "On les invoque pour les communautés déportées; pour les clercs demeurés avec leur peuple."},

"Hieromartyr Dionysius the Areopagite, Bishop of Athens":
{"type": "Évêque · Ier s.", "life": "Le saint hiéromartyr Denys l'Aréopagite était un noble Athénien, instruit dans toute la sagesse des Grecs, qui, jeune homme étudiant à Héliopolis en Égypte, vit les ténèbres qui couvrirent la terre à l'heure de la Crucifixion et dit, Ou bien Dieu souffre, ou bien le monde touche à sa fin.", "patron": "On l'invoque pour les théologiens; pour les philosophes."},

"Hieromartyr Dorotheus, Bishop of Tyre":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Dorothée, évêque de Tyr, fut un confesseur et un martyr d'une longévité extraordinaire, qui traversa trois persécutions et laissa à l'Église, outre son témoignage, un précieux récit touchant les apôtres.", "patron": "Les évêques de longue vie et de longues épreuves; les confesseurs sous des persécutions successives."},

"Hieromartyr Emilian and with him Martyrs Hilarion, Dionysius, and Hermippus":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Émilien, évêque de Trebia, avec Hilarion, Denys et Hermippe, naquit en Arménie; et après la mort de leurs parents les frères Émilien, Denys et Hermippe, avec leur maître Hilarion, quittèrent leur patrie et vinrent en Italie, à la ville de Spolète. Là Émilien prêcha l'Évangile aux païens, et, estimé pour sa vie austère et vertueuse, il fut choisi comme évêque de Trebia et consacré par Marcellin de Rome.", "patron": "On l'invoque pour la prédication missionnaire."},

"Hieromartyr Eusebius, Bishop of Samosata":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Eusèbe, évêque de Samosate, fut l'un des grands champions de la foi orthodoxe contre l'hérésie arienne au quatrième siècle, ami et compagnon de travail des plus grands pères de son temps, et confesseur qui mourut de la mort d'un martyr.", "patron": "Les défenseurs de l'Orthodoxie contre l'hérésie; les évêques exilés pour la foi."},

"Hieromartyr Euthymius, Bishop of Sardis":
{"type": "Évêque · IXe s.", "life": "Le saint hiéromartyr Euthyme, évêque de Sardes, fut élevé à cet antique siège pour la vertu de sa vie aux jours de Constantin et d'Irène, et se tint au septième concile œcuménique, en 787, parmi ceux qui dénoncèrent l'hérésie iconoclaste; et quand l'hérésie revint sur le trône, son épiscopat devint une chaîne de quarante ans d'exils, un pour chaque empereur qui exigea de lui ce qu'il ne voulait pas donner.", "patron": "On l'invoque pour les évêques en exil; pour la vénération des saintes icônes."},

"Hieromartyr Eutyches, disciple of Saint John the Theologian":
{"type": "Évêque · IIe s.", "life": "Le saint hiéromartyr Eutyque fut disciple des saints apôtres Jean le Théologien et Paul, et, bien qu'il ne fût pas du nombre des Soixante-dix, il est honoré du nom d'apôtre pour ses travaux à leurs côtés, et c'est par eux qu'il fut fait évêque. Né dans la ville de Sébaste en Samarie, il suivit d'abord l'apôtre Jean, puis, ayant rencontré l'apôtre Paul, il prêcha l'Évangile avec lui dans ses voyages, et parcourut beaucoup de pays en annonçant le Christ et en renversant les temples des idoles.", "patron": "On l'invoque pour les missionnaires; pour la prédication."},

"Hieromartyr Gregory, Bishop of Greater Armenia, Equal of the Apostles, Enlightener of Armenia":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Grégoire, évêque de la Grande Arménie, égal aux apôtres et illuminateur de l'Arménie, était le fils du noble parthe Anak, qui avait tué le roi d'Arménie; et l'enfant Grégoire, sauvé de la vengeance qui détruisit sa maison, fut porté à Césarée de Cappadoce et y fut élevé dans la foi chrétienne.", "patron": "On l'invoque pour les missionnaires; pour l'illumination des nations."},

"Hieromartyr Hermogenes, Patriarch of Moscow and All Russia":
{"type": "Martyr · XVIIe s.", "life": "Le saint hiéromartyr Hermogène, patriarche de Moscou et de toute la Russie, dont l'Église commémore en ce jour la glorification, fut le pasteur dont la fermeté en prison sauva son pays, et dont l'Église russe garde la fête au jour de sa glorification comme elle garde son repos au mois de février.", "patron": "Les lettres qui levèrent les milices."},

"Hieromartyr Hermogenes, Patriarch of Moscow, Wonderworker of All Russia":
{"type": "Hiéromartyr et patriarche · XVIIe s.", "life": "Le saint hiéromartyr Hermogène, patriarche de Moscou et de toute la Russie, fut l'ancre qui retint une nation en train de sombrer, et il la retint depuis un cachot où on le laissait mourir de faim. Né vers 1530, il servit comme prêtre de paroisse à Kazan, et en 1579 se trouva à l'événement qui marqua sa vie, l'invention de l'icône de la Mère de Dieu de Kazan, portant de ses propres mains en procession l'image nouvellement révélée et composant plus tard le récit de son apparition ainsi que l'office en son honneur, le prêtre devenant le premier historien de l'icône.", "patron": "On l'invoque pour les patriarches; pour ceux qui défendent l'âme d'une nation."},

"Hieromartyr Hermolaus and Martyrs Hermippus and Hermocrates at Nicomedia":
{"type": "Prêtre · IVe s.", "life": "Les saints hiéromartyrs Hermolas, Hermippe et Hermocrate furent du petit nombre de ceux qui survécurent lorsque vingt mille chrétiens furent brûlés dans une église de Nicomédie, durant la persécution de Maximien. Vivant cachés, ils ne cessaient pas pour autant de prêcher l'Évangile aux païens, et ce fut le prêtre Hermolas qui, voyant passer devant sa demeure le jeune païen Pantoléon, l'appela auprès de lui et lui enseigna la vanité de l'idolâtrie et la vérité du Christ.", "patron": "On les invoque pour les catéchistes."},

"Hieromartyr Hierotheus, Bishop of Athens":
{"type": "Évêque · Ier s.", "life": "Le saint hiéromartyr Hiérothée, évêque d'Athènes, était membre du tribunal de l'Aréopage et fut amené au Christ, avec Denys l'Aréopagite, par la prédication du saint apôtre Paul, qui l'établit premier évêque d'Athènes; et lui-même à son tour instruisit Denys plus parfaitement dans les mystères de la foi, si bien que son disciple l'appelle son maître et parle avec révérence de ses hymnes et de ses définitions de l'amour divin.", "patron": "On l'invoque pour les théologiens; pour les hymnographes."},

"Hieromartyr Hippolytus, and those with him":
{"type": "Hiéromartyr · IIIe s.", "life": "Le saint hiéromartyr Hippolyte de Rome souffrit avec les martyrs Censorin, Sabin, la vierge Chrysé et vingt autres, au troisième siècle, vers l'an 269, sous l'empereur Claude; et le combat de cette compagnie commença par un magistrat. Censorin, haut fonctionnaire, fut dénoncé comme chrétien et jeté en prison, et dans cette prison la grâce du Christ opéra par lui un prodige qui décida de toute l'histoire.", "patron": "On l'invoque pour les théologiens; pour les écrivains."},

"Hieromartyr Ignatius the God-Bearer, Bishop of Antioch":
{"type": "Hiéromartyr · IIe s.", "life": "Le saint hiéromartyr Ignace le Théophore fut évêque d'Antioche et disciple de l'âge apostolique. Arrêté sous l'empereur Trajan, il fut conduit vers Rome et écrivit en chemin des lettres qui affermissaient les Églises dans la foi, l'unité et l'obéissance. Il désirait souffrir pour le Christ, et il fut livré aux bêtes à Rome au commencement du deuxième siècle."},

"Hieromartyr Irenaeus, Bishop of Lyons":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Irénée, évêque de Lyon, l'un des grands docteurs de l'Église primitive, naquit vers l'an 130 à Smyrne et reçut une excellente éducation dans le savoir de son temps. Son guide dans la foi fut saint Polycarpe de Smyrne, lui-même disciple de l'apôtre Jean le Théologien, et dans sa vieillesse Irénée se rappelait comment, tout enfant, il avait écouté Polycarpe parler de ses entretiens avec ceux qui avaient vu le Seigneur, écrivant ces choses, disait-il, non sur du papier mais dans son cœur.", "patron": "On l'invoque pour les théologiens; pour la théologie orthodoxe."},

"Hieromartyr Irenaeus, Bishop of Sirmium":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Irénée, évêque de Sirmium en Pannonie, souffrit dans la grande persécution en l'an 304, et son combat nous est conservé dans des actes de première authenticité, parmi les plus précieux des anciens récits de martyre. Jeune encore pour sa charge, et marié avec des enfants selon la discipline de ce temps-là, Irénée fut saisi comme évêque et amené devant le gouverneur Probus.", "patron": "On l'invoque pour les évêques chargés de famille; pour ceux dont les proches plaident contre leur confession."},

"Hieromartyr Januarius, Bishop of Benevento, and his companions, at Pozzuoli":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Janvier, évêque de Bénévent, souffrit avec ses compagnons à Pouzzoles en l'an 305, au plus fort de la persécution de Dioclétien, et sa passion est un portrait des liens d'affection de l'Église ancienne, car il fut saisi à cause d'une visite: son diacre Sosse de Misène et d'autres clercs ayant été jetés en prison dans la persécution, Janvier alla ouvertement fortifier les confesseurs dans leurs chaînes.", "patron": "On l'invoque pour les évêques et leurs diacres; pour les villes et leurs patrons."},

"Hieromartyr Kindeos the Presbyter of Pamphylia":
{"type": "Prêtre · IVe s.", "life": "Le saint hiéromartyr Kindée fut prêtre en Pamphylie d'Asie Mineure, au temps de la persécution de l'empereur Dioclétien. Sans se laisser arrêter par le danger, il travailla avec zèle à prêcher l'Évangile et à fortifier les fidèles, et lorsqu'il en fut dénoncé aux autorités, il fut saisi et mis à mort pour le nom du Christ.", "patron": "On l'invoque pour la prédication zélée."},

"Hieromartyr Kuksha and Venerable Pimen of the Kyiv Near Caves":
{"type": "Hiéromoine · XIIe s.", "life": "Le saint hiéromartyr Koukcha était un moine des Grottes de Kyiv qui s'en alla prêcher l'Évangile aux Viatitches, peuple païen et farouche habitant les forêts le long de l'Oka, qui vivait, comme dit le chroniqueur, pour le jour présent seulement et ne savait rien de la loi de Dieu.", "patron": "On l'invoque pour les missionnaires; pour l'illumination missionnaire."},

"Hieromartyr Lucian the Presbyter of the Kyiv Caves":
{"type": "Hiéromartyr · XIIIe s.", "life": "Le saint hiéromartyr Lucien, prêtre des Grottes de Kyiv, servit Dieu comme hiéromoine de la grande Laure dans les années les plus terribles que sa ville ait jamais connues, quand les hordes de Batou fondirent sur la Rous, et que Kyiv, la mère de ses villes, fut livrée au feu et au carnage. Dans cette dévastation, vers l'an 1243, le prêtre Lucien reçut la couronne du martyre, tué par les envahisseurs impies tandis qu'il demeurait à son poste parmi les saintes grottes.", "patron": "On l'invoque pour la fidélité jusqu'au sang."},

"Hieromartyr Lucian, Bishop of Beauvais, and those with him in France":
{"type": "Hiéromartyr · IIIe s.", "life": "Le saint hiéromartyr Lucien, évêque de Beauvais, fut l'un des illuminateurs missionnaires de l'ancienne Gaule, envoyé, selon la tradition, de Rome pour prêcher l'Évangile parmi les tribus encore païennes du nord, et il scella là son apostolat par le martyre au troisième siècle.", "patron": "Les évêques missionnaires; les illuminateurs de la Gaule."},

"Hieromartyr Marcellinus, Pope of Rome, and those with him":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Marcellin, pape de Rome, gouverna l'Église de Rome au plus fort de la persécution de Dioclétien, quand, disent les récits, des milliers furent martyrisés en un seul mois.", "patron": "Le pénitent après la chute; ceux que le repentir relève."},

"Hieromartyr Mark, Bishop of Arethusa, who suffered under Julian the Apostate":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Marc, évêque d'Aréthuse en Syrie, était déjà un vieillard comblé d'ans et d'honneur lorsque Julien l'Apostat lâcha les païens sur l'Église, et son combat, conservé pour les siècles par saint Grégoire le Théologien, est l'un des plus étranges et des plus glorieux de cette étrange persécution.", "patron": "On l'invoque pour les vieillards dans l'épreuve; pour ceux qui se livrent eux-mêmes à la place des autres."},

"Hieromartyr Methodius, Bishop of Patara":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Méthode, évêque de Patare, fut l'un des pères savants et des théologiens de l'Église primitive, défenseur de la vraie foi contre l'erreur et martyr dans la dernière grande persécution. Il fut évêque d'Olympe et de Patare en Lycie, et ensuite, dit la tradition, de Tyr, homme d'un vaste savoir et d'une grande éloquence, et il mit ses dons au service de la foi, surtout en deux grands ouvrages.", "patron": "Les évêques et les théologiens; les défenseurs de la résurrection des corps."},

"Hieromartyr Mocius the Presbyter of Amphipolis in Macedonia":
{"type": "Martyr · IVe s.", "life": "Le saint hiéromartyr Mocius était prêtre de l'église d'Amphipolis en Macédoine, ou, selon d'autres récits, en Thrace, et il souffrit à Byzance dans la persécution de Dioclétien, vers le commencement du quatrième siècle.", "patron": "Le temple des idoles renversé."},

"Hieromartyr Mίlos (or Milēs) the Wonderworker, and two disciples":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Milès, évêque de Perse, avait été dans sa jeunesse soldat et chef de guerre, et, quittant le service des rois de la terre, il se fit moine et fut avec le temps consacré évêque de l'antique cité de Suse, où le prophète Daniel avait eu ses visions. Pour sa vie ascétique Dieu l'orna des dons de guérison et de prophétie.", "patron": "On l'invoque pour la hardiesse prophétique; pour l'Église de Perse."},

"Hieromartyr Nestor, Bishop of Magydos in Pamphylia":
{"type": "Hiéromartyr · IIIe s.", "life": "Le saint hiéromartyr Nestor, évêque de Magydos en Pamphylie, souffrit en l'an 250, dans la persécution de Dèce, et son combat montre l'arithmétique du pasteur dans sa forme la plus pure: tous dehors, lui-même le dernier, lui-même seul. Quand l'édit impérial atteignit la Pamphylie et que la chasse commença, Nestor n'appela pas son troupeau à une glorieuse résistance commune.", "patron": "On l'invoque pour les évêques qui demeurent; pour les pasteurs des troupeaux traqués."},

"Hieromartyr Nikḗtas":
{"type": "Hiéromartyr · XIXe s.", "life": "Le saint hiéromartyr Nicétas le Nouveau, que les calendriers commémorent en ce jour, était hiéromoine de la skite de Sainte-Anne, à la Sainte Montagne, et il appartient à la lumineuse compagnie des néomartyrs athonites, ces moines que la Sainte Montagne, durant les siècles du joug turc, mûrissait et relâchait délibérément vers le martyre, des anciens préparant par une longue ascèse et une prière incessante des volontaires pour le seul ministère que l'Église asservie pût encore exercer en public, la confession du Christ jusqu'au sang.", "patron": "On l'invoque pour les hiéromoines; pour les prédicateurs sous un pouvoir hostile."},

"Hieromartyr Pancratius, Bishop of Taormina in Sicily":
{"type": "Évêque · Ier s.", "life": "Le saint hiéromartyr Pancrace, évêque de Taormine, naquit de parents d'Antioche aux jours où notre Seigneur marchait sur la terre. Son père, ayant entendu parler du grand Maître, emmena le jeune Pancrace avec lui à Jérusalem, et, voyant les miracles et entendant la divine doctrine, il crut au Christ et s'attacha aux apôtres, surtout à Pierre.", "patron": "On l'invoque pour l'illumination missionnaire."},

"Hieromartyr Paphnutius of Jerusalem":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Paphnuce de Jérusalem souffrit dans la dernière grande persécution, aux années de Dioclétien et de ses collègues, et les calendriers gardent sa mémoire avec un titre et une compagnie: évêque, il subit, rapportent les récits, toute l'échelle ascendante des arguments du tribunal, torturé par le feu, exposé aux bêtes sauvages, et enfin décapité par le glaive, les trois instruments classiques épuisés sur un seul confesseur inébranlable.", "patron": "On l'invoque pour les évêques dans les mines et les prisons; pour les compagnies d'exilés."},

"Hieromartyr Patriarch Gregory V of Constantinople":
{"type": "Hiéromartyr et patriarche · XIXe s.", "life": "Le saint hiéromartyr Grégoire le Cinquième, patriarche de Constantinople, naquit Georges Angelopoulos en 1746 à Dimitsana, dans le Péloponnèse, de parents pauvres et pieux, et s'éleva par le savoir et l'austérité, à travers les monastères et la métropole de Smyrne, jusqu'au trône œcuménique, qu'il occupa trois fois, les intervalles étant remplis d'exils à l'Athos, car son zèle à rebâtir les églises, à imprimer les livres et à corriger le clergé le rendit plus d'une fois incommode aux puissants.", "patron": "On l'invoque pour les patriarches; pour la nation grecque."},

"Hieromartyr Patrick, Bishop of Prusa, and his companions":
{"type": "Martyr · IVe s.", "life": "Le saint hiéromartyr Patrice, évêque de Pruse en Bithynie, souffrit avec ses compagnons les prêtres Acace, Ménandre et Polyen, au temps des persécutions, et son combat se joua sur une confession hardie et belle, faite auprès des célèbres sources chaudes de sa ville.", "patron": "Le Créateur des sources chaudes et du feu du jugement confessé."},

"Hieromartyr Peter, Archbishop of Alexandria":
{"type": "Patriarche · IVe s.", "life": "Le saint hiéromartyr Pierre, archevêque d'Alexandrie, fut élevé dans la grande école catéchétique de cette ville, dont il devint le chef, et en l'an 300 il monta sur le trône patriarcal, pour conduire son Église droit dans les feux de la dernière et de la plus violente persécution. Traqué de lieu en lieu, il gouverna son troupeau dispersé par des messagers et des épîtres, fortifiant les confesseurs, et composant avec une sagesse pastorale les canons pénitentiels par lesquels ceux qui avaient failli sous la torture pourraient être rétablis par le repentir, canons que l'Église entière reçut dans son droit.", "patron": "On l'invoque pour les catéchistes; pour les hiérarques."},

"Hieromartyr Philip, Bishop of Heraclea and with him the Martyrs Severus, Memnon, and 37 Soldiers in Thrace":
{"type": "Évêque · IVe s.", "life": "Saint Philippe, évêque d'Héraclée, souffrit pour le Christ dans la ville de Philippopolis en Thrace, avec une nombreuse compagnie de fidèles, dans la persécution de Dioclétien. Parmi eux était saint Sévère, qui avait amené à la foi du Christ le centurion Memnon; et quand cela fut connu du gouverneur, il livra le soldat aux tourments, et Sévère aussi fut cruellement torturé, déchiré avec des ongles de fer, brûlé par des anneaux rougis au feu et par une ceinture de fer, et privé enfin de la vue.", "patron": "On les invoque pour la confession constante."},

"Hieromartyr Philosophos of St. Petersburg":
{"type": "Martyr · XXe s.", "life": "Le saint hiéromartyr Philosophe Ornatski, archiprêtre de Saint-Pétersbourg, fut l'un des premiers et des plus éminents des néomartyrs de l'Église russe sous la persécution bolchevique, pasteur renommé de la capitale impériale, martyrisé avec ses deux fils à l'aube même de la terreur impie.", "patron": "La foi prêchée hardiment dans la capitale."},

"Hieromartyr Phocas, Bishop of Sinope":
{"type": "Évêque · IIe s.", "life": "Le saint hiéromartyr Phocas, évêque de Sinope sur la mer Noire, mena dès sa jeunesse une vie vertueuse et, devenu évêque de sa ville natale, convertit à la foi du Christ beaucoup de païens. Dans la persécution de l'empereur Trajan le gouverneur exigea qu'il reniât le Seigneur, et comme le saint refusait, il fut soumis à de violents tourments et enfin enfermé dans un bain surchauffé, où il reçut la couronne du martyre en l'an 117.", "patron": "On l'invoque pour les marins; pour la protection contre le feu."},

"Hieromartyr Polycarp, Bishop of Smyrna":
{"type": "Hiéromartyr · IIe s.", "life": "Le saint hiéromartyr Polycarpe, évêque de Smyrne, est la grande charnière entre les apôtres et l'Église des siècles: disciple de Jean le Théologien lui-même, établi sur le siège de Smyrne à la suite de Bucole, l'ami à qui Ignace condamné écrivit de la route: Tiens ferme comme une enclume sous le marteau.", "patron": "On l'invoque pour les évêques; pour les fidèles avancés en âge."},

"Hieromartyr Proterius, Patriarch of Alexandria":
{"type": "Hiéromartyr et patriarche · Ve s.", "life": "Le saint hiéromartyr Protérius, patriarche d'Alexandrie, fut l'homme établi pour tenir pour la foi de Chalcédoine le siège le plus dangereux de la chrétienté, et il le tint jusqu'à la dernière goutte. Prêtre d'Alexandrie sous le patriarche Dioscore, il eut l'intrépidité de dénoncer l'erreur monophysite de son propre hiérarque et de confesser la foi orthodoxe des deux natures tandis que Dioscore était au sommet de sa puissance.", "patron": "On l'invoque pour les hiérarques au milieu des émeutes; pour les défenseurs de Chalcédoine."},

"Hieromartyr Publius, Bishop of Athens":
{"type": "Hiéromartyr · IIe s.", "life": "Le saint hiéromartyr Publius, évêque d'Athènes, entre dans les Écritures par un acte d'hospitalité: il est le Publius des Actes des Apôtres, le premier de l'île de Malte, qui, lorsque l'apôtre Paul y fut jeté par le naufrage, sur la route de Rome, reçut l'Apôtre et ses compagnons et les logea trois jours avec courtoisie.", "patron": "On l'invoque pour ceux qui reçoivent et hébergent; pour les évêques des sièges anciens."},

"Hieromartyr Sadoc (Sadoth), Bishop of Persia, and 128 Martyrs with him":
{"type": "Hiéromartyr et évêque · IVe s.", "life": "Le saint hiéromartyr Sadoc, évêque de Perse, souffrit avec cent vingt-huit compagnons vers l'an 342, dans la grande persécution de Sapor le Second, quand l'empire perse entreprit d'extirper l'Église d'Orient; il avait succédé au hiéromartyr Siméon, le premier des évêques couronnés dans cette persécution, et il héritait avec le trône la quasi-certitude de la même fin.", "patron": "On l'invoque pour les évêques sous la persécution; pour les compagnies de confesseurs."},

"Hieromartyr Seraphim (Samoilovich), Archbishop of Uglich":
{"type": "Archevêque · XXe s.", "life": "Le saint hiéromartyr Séraphin, archevêque d'Ouglitch, naquit Simon Samoïlovitch en 1881 à Mirgorod, au pays de Poltava, et après le séminaire il se porta volontaire pour la mission d'Amérique, enseignant à l'école ecclésiastique d'Unalaska puis à Sitka, où il fut tonsuré et ordonné hiéromoine, servant les missions de l'Alaska et le séminaire de Sitka comme un zélé collaborateur du futur patriarche Tikhon, qui l'estimait grandement.", "patron": "On l'invoque pour les missionnaires; pour les hiérarques."},

"Hieromartyr Silvanus of Gaza":
{"type": "Évêque · IVe s.", "life": "Le saint hiéromartyr Silvain de Gaza était natif de cette ville, d'abord soldat et ensuite prêtre, et dans sa vieillesse il fut élevé à l'épiscopat, gouvernant l'Église de Gaza aux années de la grande persécution. Faussement accusé et condamné, il fut envoyé aux travaux forcés dans les mines de cuivre de Phaéno, où, âgé et usé, il porta la peine écrasante avec une foi inébranlable, fortifiant les nombreux confesseurs condamnés avec lui et ne cessant de les instruire et de les consoler comme un véritable père.", "patron": "On l'invoque pour les prisonniers; pour les mineurs."},

"Hieromartyr Simeon, Bishop in Persia, and those with him":
{"type": "Hiéromartyr et archevêque · IVe s.", "life": "Le saint hiéromartyr Siméon, archevêque de Séleucie-Ctésiphon et primat de l'Église de Perse, se tenait à la tête de cette Église lorsque le roi Sapor le Second, en guerre avec l'empire chrétien des Romains, ouvrit contre ses propres sujets chrétiens la persécution qui devait durer quarante ans et moissonner des milliers innombrables.", "patron": "On l'invoque pour les primats sous la persécution; pour les clercs tués avec leur évêque."},

"Hieromartyr Simeon, kinsman of the Lord, second Bishop of Jerusalem":
{"type": "Hiéromartyr et apôtre · IIe s.", "life": "Le saint hiéromartyr Siméon, parent du Seigneur et deuxième évêque de Jérusalem, était fils de Cléopas, frère du juste Joseph le Fiancé, et par là, selon le compte de la Loi, cousin du Seigneur selon la chair, de ce cercle de famille où l'incrédulité avait autrefois trouvé un scandale et dont la grâce fit une pépinière d'évêques.", "patron": "On l'invoque pour les évêques de long ministère; pour les parents du Seigneur."},

"Hieromartyr Sisinius the Deacon of Rome and those with him":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Sisinius, diacre, souffrit pour le Christ à Rome, avec une nombreuse compagnie de martyrs, dans la violente persécution des empereurs au tournant du quatrième siècle.", "patron": "Les diacres et les serviteurs de l'Église; les compagnies entières martyrisées ensemble."},

"Hieromartyr Terence, Bishop of Iconium":
{"type": "Hiéromartyr · Ier s.", "life": "Le saint hiéromartyr Térence, évêque d'Iconium, fut l'un des premiers pasteurs de l'âge apostolique, établi sur l'Église d'Iconium en Lycaonie, la ville où l'apôtre Paul avait prêché et souffert, et il scella son épiscopat par le martyre.", "patron": "Les premiers évêques des Églises apostoliques; ceux que les apôtres ont ordonnés."},

"Hieromartyr Theodore of Perge in Pamphylia, his mother, Philippa, and Martyrs Dioscorus, Socrates, and Dionysius":
{"type": "Martyrs · IIe s.", "life": "Le saint martyr Théodore de Pergé en Pamphylie souffrit au deuxième siècle, sous le règne d'Antonin, avec sa mère Philippa et les martyrs Dioscore, Socrate et Denys, et sa passion rassemble en un seul combat les trois conversions que l'Église chérit le plus, celle du fils, celle de la mère et celle des bourreaux.", "patron": "On les invoque pour les jeunes conscrits; pour les mères de martyrs."},

"Hieromartyr Theodotus, Bishop of Ancyra":
{"type": "Martyr · IVe s.", "life": "En ce jour l'Église fait la mémoire particulière du saint martyr Théodote d'Ancyre, dont la passion est racontée plus au long au calendrier avec les sept vierges d'Ancyre, et que cette fête honore surtout en son propre martyre.", "patron": "Les aubergistes et ceux qui reçoivent; ceux qui ensevelissent les martyrs."},

"Hieromartyr Theodotus, Bishop of Cyrenia":
{"type": "Hiéromartyr et confesseur · IVe s.", "life": "Le saint hiéromartyr Théodote, évêque de Cyrénie en Chypre, était originaire de Galatie en Asie Mineure et vint gouverner ce siège chypriote dans la dernière et la pire saison des persécutions, lorsque Licinius, rompant avec son collègue Constantin, renouvela en Orient la terreur que l'édit de Milan devait avoir fait cesser.", "patron": "On l'invoque pour les évêques sous la torture; pour ceux qui survivent à leurs persécuteurs."},

"Hieromartyr Therapon, Bishop of Cyprus":
{"type": "Martyr", "life": "Le saint hiéromartyr Thérapon, évêque de Chypre, fut un pasteur de l'Église dans cette île qui scella son ministère par une mort de martyr, et dont les reliques devinrent célèbres par la myrrhe guérissante qui en coulait.", "patron": "La confession scellée dans le sang à Chypre."},

"Hieromartyr Therapon, Bishop of Sardis":
{"type": "Martyr · IIIe s.", "life": "Le saint hiéromartyr Thérapon, évêque de Sardes en Lydie, souffrit pour le Christ dans les persécutions du troisième siècle, et sa passion est ornée d'une merveille qui fit de l'instrument même de son tourment un signe de vie.", "patron": "Le pieu desséché reverdi par le sang d'un martyr."},

"Hieromartyr Timothy, Bishop of Prusa":
{"type": "Hiéromartyr · IVe s.", "life": "Le saint hiéromartyr Timothée, évêque de Pruse en Bithynie, fut un pasteur, un thaumaturge et un martyr qui souffrit pour le Christ sous Julien l'Apostat, au quatrième siècle.", "patron": "Les évêques et les thaumaturges; ceux qui tuent le dragon par la prière."},

"Hieromartyr Urban, Pope of Rome":
{"type": "Martyr · IIIe s.", "life": "Le saint hiéromartyr Urbain, pape de Rome, gouverna l'Église de Rome dans les premières décennies du troisième siècle, sous le règne de l'empereur Alexandre Sévère, pasteur qui tint la chaire de l'apôtre Pierre en des années où être chrétien, et à plus forte raison être le pasteur en chef des chrétiens, c'était vivre toujours à l'ombre du glaive.", "patron": "Le troupeau de Rome gardé à l'âge du sang."},

"Hieromartyr Vitalius, Bishop of Ravenna":
{"type": "Évêque", "life": "Le saint hiéromartyr Vital est honoré parmi les premiers évêques et martyrs de la ville de Ravenne, et il est commémoré en ce jour avec le hiéromartyr Apollinaire, premier évêque de ce siège. Peu de détails de sa vie ont été conservés, mais l'Église se souvient de lui comme d'un pasteur qui confessa le Christ et scella son témoignage par le martyre dans les premiers siècles, et qui est compté parmi les saints hiérarques qui plantèrent et arrosèrent la foi dans cette cité antique.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Hieromartyr Zeno, Bishop of Verona":
{"type": "Hiéromartyr · IVe s.", "life": "Saint Zénon, évêque de Vérone, vint, selon la tradition, d'Afrique, apportant au nord de l'Italie le feu de l'Église africaine qui avait donné à l'Occident latin ses premières grandes voix; élevé au siège de Vérone vers l'an 362, il conduisit la cité à travers les dernières convulsions du paganisme et la haute marée des troubles ariens, et ses armes furent deux, les fonts et la parole.", "patron": "On l'invoque pour les prédicateurs; pour les pêcheurs."},

"Hieromartyr Zenobios and his sister Zenobia, of Aegæ in Cilicia":
{"type": "Évêque · IIIe s.", "life": "Le saint hiéromartyr Zénobios, évêque d'Égées, et sa sœur Zénobie souffrirent le martyre en Cilicie l'an 285. Élevés par des parents chrétiens dans la piété et la chasteté, ils distribuèrent aux pauvres, dès qu'ils en eurent la libre disposition, la fortune dont ils avaient hérité; et le Seigneur récompensa Zénobios du don de guérison, de sorte que les maladies fuyaient au toucher de ses mains, et qu'il rendit la santé, entre autres, à une femme que consumait un mal incurable au sein, ce pourquoi celles qui souffrent de cette maladie l'invoquent jusqu'à ce jour.", "patron": "On l'invoque pour les médecins; pour celles qui souffrent d'un mal au sein."},

"Hieromartyrs Akepsimas, Bishop in Persia, Presbyter Joseph, and Deacon Aeithalas":
{"type": "Évêque · IVe s.", "life": "Les saints hiéromartyrs Akepsimas l'évêque, Joseph le prêtre et Aeithalas le diacre conduisaient l'Église du Christ dans la ville perse de Naesson, où le troupeau aimait tendrement son hiérarque pour sa vie ascétique et son labeur pastoral infatigable. Dans la grande persécution du roi Sapor II, le vieil évêque, alors âgé de quelque quatre-vingts ans, fut saisi par les serviteurs du roi qui traquaient le clergé du Christ.", "patron": "On les invoque pour les clercs avancés en âge; pour la constance dans les longues prisons."},

"Hieromartyrs John the Bishop and Jacob (James) the Presbyter, of Persia":
{"type": "Martyrs · IVe s.", "life": "Les saints hiéromartyrs Jean l'évêque et Jacques le prêtre, surnommé le Zélé, souffrirent en Perse sous le règne du roi Sapor II, le grand persécuteur de l'Église au-delà de la frontière orientale de l'empire. Prêchant la vraie foi avec hardiesse, ils attirèrent au Christ beaucoup d'âmes pieuses, et la croissance de l'Église par leurs labeurs les fit traduire devant le roi.", "patron": "On les invoque pour l'Église sous la persécution perse."},

"Hieromartyrs Nicander, Bishop of Myra, and Hermas, the Presbyter":
{"type": "Martyrs · Ier s.", "life": "Les saints hiéromartyrs Nicandre, évêque de Myre, et Hermas le prêtre furent disciples de l'apôtre Tite, le compagnon de Paul, et reçurent de lui l'ordination au ministère sacré en Lycie. Joignant un labeur pastoral incessant à la vie ascétique, ils convertirent au Christ beaucoup de païens, ce pourquoi ils furent dénoncés et amenés devant le préfet Libanius.", "patron": "On les invoque pour la constance pastorale."},

"Hieromartyrs Pionius and Limnus of Smyrna and those with them: Asclepiades, Macedonia, and Sabina":
{"type": "Hiéromartyr · IIIe s.", "life": "Les saints hiéromartyrs Pione et Limnus, prêtres, et les martyres Sabine, Macédonie et Asclépiade souffrirent à Smyrne dans la persécution de Dèce, dans cette Église que l'apôtre Jean le Théologien avait fondée et que le sang de Polycarpe avait glorifiée; et le combat de Pione, conservé dans l'un des plus précieux des actes anciens des martyrs, commence par un détail sans pareil dans le martyrologe: il savait.", "patron": "On les invoque pour les prêtres; pour les apologistes."},

"Holy Apostles Stakhys, Apelles, Amplias, Urban, and Narcissus of the 70":
{"type": "Apôtre des Soixante-dix · Ier s.", "life": "Les saints apôtres Stachys, Apelle, Amplias, Urbain et Narcisse, des Soixante-dix, sont salués par leur nom dans l'épître de l'apôtre Paul aux Romains, et l'Église les commémore ensemble en ce jour avec l'apôtre Aristobule. Stachys, que Paul appelle son bien-aimé, fut établi par l'apôtre André le Premier-Appelé premier évêque de Byzance, la petite ville qui devait un jour être Constantinople, en sorte que le trône des patriarches œcuméniques fait remonter jusqu'à lui sa succession.", "patron": "On les invoque pour les évêques; pour la plantation des Églises locales."},

"Holy Apostles of the Seventy and Deacons: Prochorus, Nicanor, Timon, and Parmenas":
{"type": "Diacre · Ier s.", "life": "Les saints diacres Prochore, Nicanor, Timon et Parménas furent du nombre des sept hommes pleins d'Esprit Saint et de sagesse que les douze apôtres choisirent et ordonnèrent premiers diacres de l'Église, comme le racontent les Actes des Apôtres, et ils sont comptés aussi parmi les Soixante-dix.", "patron": "On les invoque pour les diacres; pour le service diaconal."},

"Holy Apostles of the Seventy: Sosthenes, Apollos, Cephas, Tychicus, Epaphroditus, Caesar, and Onesiphorus":
{"type": "Apôtres des Soixante-dix · Ier s.", "life": "Les saints apôtres des Soixante-dix Sosthène, Apollos, Céphas, Tychique, Épaphrodite, César et Onésiphore furent de ce second chœur que le Seigneur lui-même envoya deux à deux devant sa face, et leurs labeurs sont tissés à travers les épîtres de Paul. Sosthène avait été chef de la synagogue à Corinthe, et fut battu devant le tribunal dans l'émeute soulevée contre Paul.", "patron": "On les invoque pour les prédicateurs; pour les porteurs de lettres."},

"Holy Confessor Emilian, Bishop of Kyzikos":
{"type": "Évêque · IXe s.", "life": "Saint Émilien fut évêque de Cyzique au début du neuvième siècle, au temps du second assaut contre les saintes icônes sous l'empereur iconoclaste Léon l'Arménien. Convoqué avec d'autres évêques devant l'empereur et sommé d'interdire à son troupeau la vénération des saintes images, saint Émilien répondit hardiment qu'une question touchant la foi de l'Église doit être examinée et tranchée dans l'Église par ses pasteurs spirituels, et non réglée à la cour impériale.", "patron": "On l'invoque pour la vénération des icônes; pour la liberté de l'Église."},

"Holy Confessor Erasmus, Bishop of Formia in Campania":
{"type": "Hiérarque · IVe s.", "life": "Le saint confesseur Érasme, évêque de Formia en Campanie, commença en Orient et acheva en Occident, et entre les deux bouts de sa route s'étendait toute la géographie de la dernière persécution.", "patron": "Les tourments survécus et la confession gardée."},

"Holy Empress Markianḗ":
{"type": "Impératrice · VIe s.", "life": "Sainte Marciane l'impératrice fut l'épouse de l'empereur Justin Ier, qui régna à Constantinople de 518 à 527, l'empereur soldat d'origine paysanne dont Dieu éleva la maison des campagnes balkaniques jusqu'à la pourpre; et Marciane, partageant cette ascension étonnante, garda au travers d'elle les vertus que les trônes dissolvent plus souvent.", "patron": "On l'invoque pour les femmes de rang; pour les bienfaitrices."},

"Holy Great Prince Vladimir (Basil in Baptism), Equal of the Apostles, and Enlightener of Rus'":
{"type": "Égal aux Apôtres · Xe s.", "life": "Saint Vladimir, grand-prince de Kyiv, fut baptisé sous le nom de Basile et apporta la foi orthodoxe à la terre de Rus'. Après avoir examiné les religions des nations, il reçut le baptême et ordonna que le peuple de Kyiv fût baptisé dans le Dniepr. On se souvient de lui comme de l'illuminateur de la Rus', et il se reposa en 1015."},

"Holy Great-martyr Tsar Lazar (Vidovdan)":
{"type": "Prince · XIVe s.", "life": "Le saint grand-martyr le prince Lazar de Serbie conduisit son peuple à la bataille de Kosovo, au jour que les Serbes appellent Vidovdan, et par sa mort et par son choix devint le cœur de la foi et de l'identité de la nation serbe.", "patron": "Le peuple et la nation des Serbes; ceux qui choisissent le royaume des cieux."},

"Holy King Askiot of Georgia":
{"type": "Roi et martyr · IXe s.", "life": "Saint Askiot le Curopalate, roi de Géorgie, régna au neuvième siècle, dans la génération où les terres géorgiennes gisaient ravagées par les invasions arabes, et fut le souverain sous lequel la nation commença de se relever de ses ruines. Se retirant de la Karthlie occupée vers les hautes terres boisées du Tao-Klardjéthie, Askiot fut le premier de la lignée des Bagratides à y porter la dignité royale.", "patron": "On l'invoque pour les souverains qui rebâtissent; pour les protecteurs des monastères."},

"Holy Martyr Euthymius":
{"type": "Martyr · IVe s.", "life": "Le saint martyr Euthyme souffrit pour le Christ à Nicomédie dans la grande persécution de Dioclétien et de Maximien, où les chrétiens de cette ville périrent en foule immense. Comme les corps des saints martyrs demeuraient sans sépulture, Euthyme, avec la vierge Domna qui s'était détournée de son ancien paganisme vers le Christ, eut pitié des morts et se donna à la pieuse tâche d'ensevelir avec honneur les fidèles tombés.", "patron": "On l'invoque pour le soin des morts; pour la confession constante."},

"Holy Martyr and Confessor Michael and his councilor, Theodore, Wonderworkers of Chernihiv":
{"type": "Prince · XIIIe s.", "life": "Le saint martyr et confesseur Michel, prince de Tchernihiv, et son fidèle conseiller le boyard Théodore souffrirent à la Horde d'Or en l'an 1246. Le prince Michel, remarqué dès l'enfance pour sa piété et sa douceur, avait régné à Novgorod et à Kyiv dans les années de la tourmente mongole; et lorsqu'il fut convoqué à la Horde pour recevoir de Batou le droit sur sa principauté, les païens exigèrent qu'il passât d'abord entre les feux et se prosternât devant leurs idoles, selon leur coutume.", "patron": "On les invoque pour les souverains; pour les conseillers."},

"Holy Martyrs and Confessors Gurias, Samonas, and Habibus, of Edessa":
{"type": "Martyrs · IVe s.", "life": "Les saints martyrs et confesseurs Gourias, Samonas et Habib sont les grands protecteurs de la ville d'Édesse et du mariage honorable. Gourias et Samonas, prédicateurs de la parole de Dieu, furent arrêtés dans la persécution de Dioclétien; refusant de sacrifier, ils furent battus, suspendus par les mains avec de lourdes charges liées aux pieds, et jetés dans une prison étouffante, et après de longs tourments ils eurent la tête tranchée, vers l'an 306, Samonas priant par des paroles qu'un témoin recueillit pour l'Église.", "patron": "On les invoque pour le mariage honorable; pour la délivrance des troubles de famille."},

"Holy Prophet Zachariah and Righteous Elizabeth, parents of Saint John the Baptist":
{"type": "Prophète · Ier s.", "life": "Le saint prophète Zacharie et la juste Élisabeth furent les parents de saint Jean, le Précurseur et Baptiste du Seigneur. Tous deux étaient de la lignée d'Aaron, Zacharie servant comme prêtre au Temple de Jérusalem et Élisabeth étant parente de la Très Sainte Mère de Dieu; et, comme l'atteste l'Évangile, ils marchaient sans reproche dans tous les commandements du Seigneur, et pourtant ils avaient vieilli sans enfants.", "patron": "On les invoque pour les prêtres; pour les époux sans enfants."},

"Holy Prophet and God-seer Moses":
{"type": "Prophète · XVIe s. av. J.-C.", "life": "Le saint prophète et voyant de Dieu Moïse, le grand législateur d'Israël, était de la tribu de Lévi, et sa vie est écrite dans les livres de l'Exode au Deutéronome. Né en Égypte au temps où Pharaon avait ordonné de tuer tout enfant mâle des Hébreux, il fut caché par sa mère dans une corbeille parmi les roseaux du Nil, où la fille de Pharaon le trouva et l'éleva comme son propre fils dans toute la sagesse des Égyptiens.", "patron": "On l'invoque pour les législateurs; pour les prophètes."},

"Holy Righteous David the King":
{"type": "Roi et prophète · Xe s. av. J.-C.", "life": "Le saint prophète et roi David, le doux chantre d'Israël, était le plus jeune fils de Jessé de Bethléem, un jeune berger tiré du troupeau pour être oint par Samuel tandis que ses grands frères étaient écartés, car le Seigneur regarde au cœur. Sa jeunesse est l'épopée d'Israël: la harpe qui apaisait les ténèbres de Saül, la fronde qui abattit Goliath au nom du Seigneur des armées.", "patron": "On l'invoque pour les rois; pour les chantres."},

"Holy Righteous Joseph the Betrothed":
{"type": "Juste · Ier s.", "life": "Le saint et juste Joseph le fiancé, de la lignée royale de David, était charpentier à Nazareth, un veuf âgé, père de fils et de filles, parmi eux Jacques, Josès, Simon et Jude, que les Évangiles appellent les frères du Seigneur; et c'est à lui, comme à un gardien éprouvé, que les prêtres du Temple fiancèrent la Vierge Marie lorsque furent accomplies ses années de séjour au sanctuaire, fiançailles qui étaient une garde, le juste recevant le trésor d'Israël pour protéger son vœu.", "patron": "On l'invoque pour les charpentiers; pour les gardiens."},

"Holy Unmercenary Physician Diomedes":
{"type": "Médecin · IIIe s.", "life": "Saint Diomède l'anargyre naquit à Tarse en Cilicie et fut instruit dans l'art de la médecine, mais son savoir ne l'enfla pas d'orgueil, car il garda la piété dans laquelle ses parents l'avaient élevé. À l'imitation du Christ, médecin des âmes et des corps, il exerçait son art de guérir librement et sans salaire, et tandis qu'il soignait les malades dans leur corps il prenait soin aussi de leurs âmes, leur prêchant l'Évangile du salut et amenant beaucoup d'entre eux à la foi au Sauveur.", "patron": "On l'invoque pour les médecins; pour les malades."},

"Holy Virgin Martyr Theodosίa of Tyre":
{"type": "Vierge-martyre · IVe s.", "life": "La sainte vierge-martyre Théodosie de Tyr était une jeune fille qui n'avait pas encore dix-huit ans, et son martyre, rapporté par Eusèbe qui vécut ces jours-là à Césarée, commença par un acte de révérence. Une troupe de confesseurs était assise dans les chaînes devant le tribunal du gouverneur à Césarée, attendant la sentence.", "patron": "On l'invoque pour les jeunes gens; pour ceux qui honorent les confesseurs."},

"Holy Woman Olympias (Olympiada) the Deaconess of Constantinople":
{"type": "Diaconesse · Ve s.", "life": "Sainte Olympias, diaconesse de Constantinople, naquit dans cette ville d'une illustre famille sénatoriale et resta dans sa jeunesse riche héritière. Fiancée à un noble préfet qui mourut avant que leur mariage fût consommé, elle se tint pour veuve et, quoique l'empereur et ses proches la pressassent de se remarier, elle refusa, choisissant plutôt de se consacrer tout entière à Dieu.", "patron": "On l'invoque pour les diaconesses; pour l'aumône."},

"Holy Wonderworkers and Unmercenaries Cosmas and Damian of Mesopotamia":
{"type": "Anargyres · IIIe s.", "life": "Les saints thaumaturges et anargyres Côme et Damien d'Asie, les premiers des trois couples de saints frères anargyres qui portent ces noms, naquirent en Asie Mineure d'un père païen qui mourut lorsqu'ils étaient petits, et de la sainte Théodote, qui les éleva dans la piété et dans la lecture des livres divins.", "patron": "On les invoque pour les médecins; pour les chirurgiens."},

"Holy Wonderworkers and Unmercenaries Cyrus and John, and those with them":
{"type": "Martyrs anargyres · IVe s.", "life": "Les vénérables thaumaturges et anargyres Cyr et Jean souffrirent à Canope en Égypte en l'an 311, et l'Église les place auprès de Côme et Damien parmi les médecins qui ne voulaient pas d'honoraires. Cyr était un médecin d'Alexandrie, fameux par toute l'Égypte pour une pratique qui guérissait deux fois, car il soignait le corps sans salaire et se servait du chevet du malade pour soigner l'âme, disant à ses patients que la maladie suit souvent le péché et les conduisant au Médecin de tous.", "patron": "On les invoque pour les médecins; pour les infirmiers."},

"Holy Wonderworking Unmercenary Physicians Cosmas and Damian at Rome":
{"type": "Médecins · IIIe s.", "life": "Les saints martyrs et médecins anargyres Côme et Damien de Rome étaient frères, nés à Rome et formés à la médecine, et ils reçurent de Dieu le don de guérison. Ne prenant aucun salaire pour le soin des malades, ce pourquoi on les appelle anargyres, ils soignaient au nom du Christ tous ceux qui venaient et en attirèrent beaucoup à la foi.", "patron": "On les invoque pour les médecins; pour les chirurgiens."},

"Holy and Righteous Ancestors of God, Joachim and Anna":
{"type": "Synaxe · Ier s.", "life": "Au lendemain de la Nativité de la Mère de Dieu, l'Église célèbre la synaxe des saints et justes aïeux de Dieu Joachim et Anne, se rassemblant pour honorer ceux par qui la Mère de Dieu fut donnée au monde. Joachim était de la lignée royale de David et Anne de la lignée sacerdotale d'Aaron, et ils vivaient dans la justice, donnant un tiers de leurs revenus à Dieu et un tiers aux pauvres.", "patron": "On les invoque pour les époux sans enfants; pour les grands-parents."},

"Holy, All-Praised Apostle Philip":
{"type": "Apôtre · Ier s.", "life": "Le saint et tout-loué apôtre Philippe, l'un des Douze, était de Bethsaïde de Galilée, la ville d'André et de Pierre, et il fut nourri des Écritures dès sa jeunesse; et lorsque le Seigneur le trouva et lui dit: Suis-moi, Philippe aussitôt trouva Nathanaël et répondit à ses doutes par la parole qui demeure toute la méthode de l'Évangile: Viens et vois.", "patron": "On l'invoque pour les missionnaires; pour ceux qui trouvent le Christ."},

"Holy, Glorious Apostle Thomas":
{"type": "Apôtre · Ier s.", "life": "Le saint et glorieux apôtre Thomas, appelé le Jumeau, était un pêcheur de Galilée que le Seigneur appela dans la compagnie des Douze, et l'Évangile montre son cœur ardent, car lorsque le Seigneur s'en alla vers la Judée pour ressusciter Lazare, ce fut Thomas qui dit: Allons, nous aussi, afin de mourir avec lui.", "patron": "On l'invoque pour les bâtisseurs; pour les architectes."},

"Holy, Glorious Demetrios the Myrrh-gusher of Thessaloniki":
{"type": "Grand-martyr · IVe s.", "life": "Le saint grand-martyr Démétrios était un noble chrétien de Thessalonique et officier sous l'empereur Maximien. Il enseignait ouvertement la foi et affermissait les chrétiens malgré la persécution. Emprisonné par l'empereur, il bénit le jeune Nestor pour affronter Lyaios, le champion des païens. Démétrios fut transpercé de lances dans son cachot et reçut la couronne du martyre vers l'an 306.", "patron": "Dans la tradition slave on l'associe particulièrement au courage militaire et à la défense de la patrie."},

"Holy, Glorious Prophet Elijah":
{"type": "Prophète · IXe s. av. J.-C.", "life": "Le saint prophète Élie vécut au royaume d'Israël sous le règne d'Achab. Zélé pour le Seigneur, il reprit l'idolâtrie, appela Israël au repentir et opéra des prodiges par la puissance de Dieu. L'Écriture rapporte qu'il fut enlevé au ciel sur un char de feu, au lieu de mourir de la mort commune."},

"Holy, Righteous Anna the Prophetess":
{"type": "Prophétesse · Ier s.", "life": "Sainte et juste Anne la prophétesse se tient auprès de Siméon à la Rencontre du Seigneur, second témoin chargé d'ans que Dieu avait posté au Temple pour le quarantième jour; et l'évangéliste Luc, seul à la mentionner, lui donne une présentation entière et minutieuse, comme s'il enregistrait une déposition: Anne, prophétesse, fille de Phanuel, de la tribu d'Aser.", "patron": "On l'invoque pour les veuves; pour les vieillards."},

"Holy, Righteous Simeon the God-Receiver":
{"type": "Juste · Ier s.", "life": "Saint et juste Siméon le Théodoque est le vieillard de la Rencontre, l'homme établi de Dieu pour se tenir à la frontière des deux Testaments et recevoir le second entre ses bras; l'Évangile de Luc le décrit tout entier en trois traits, juste et pieux, il attendait la consolation d'Israël, et l'Esprit Saint était sur lui, et il rapporte la promesse qui ordonna sa longue vie, qu'il lui avait été révélé par l'Esprit Saint qu'il ne verrait point la mort avant d'avoir vu le Christ du Seigneur.", "patron": "On l'invoque pour les vieillards; pour les traducteurs."},

"Icon of Sophia, the Wisdom of God (Novgorod)":
{"type": "Icône", "life": "L'icône de Sophie, la Sagesse de Dieu, du type de Novgorod parut pour la première fois en cette ville au quinzième siècle, bien que la première église de Russie dédiée à la Sainte Sagesse eût été élevée à Novgorod au dixième siècle. Au centre de l'image la Sagesse de Dieu est montrée comme un Ange ailé et de feu, assis sur un trône d'or que portent sept colonnes, selon la parole des Proverbes que la Sagesse s'est bâti une maison et qu'elle a taillé ses sept colonnes.", "patron": "On l'invoque pour la sagesse divine; pour les malades."},

"Icon of the Mother of God of Armatia":
{"type": "Icône de la Mère de Dieu", "life": "L'icône de la Mère de Dieu d'Armatia était vénérée à Constantinople au monastère d'Armatia, qui tenait son nom du lieu appelé Armation, associé au magistros Armatios aux jours de l'empereur Zénon. La célébration de cette icône thaumaturge fut établie en action de grâces pour la délivrance de l'Église de l'hérésie iconoclaste, qui avait fait la guerre aux saintes images jusqu'à ce que l'Église, conduite par le septième concile œcuménique, en rétablît la vénération selon l'Écriture et la Tradition.", "patron": "On l'invoque pour la vénération des saintes icônes."},

"Icon of the Mother of God of Kasperov":
{"type": "Icône · XIXe s.", "life": "En ce jour l'Église fait mémoire de l'icône thaumaturge de la Très Sainte Mère de Dieu dite de Kasperov, image glorifiée dans les terres russes du midi par son renouvellement et par la délivrance d'une grande ville.", "patron": "Ceux qui prient devant les icônes délaissées; les défenseurs des villes."},

"Icon of the Mother of God of Kholm":
{"type": "Icône de la Mère de Dieu", "life": "L'icône de la Mère de Dieu de Kholm est l'une des plus anciennes et des plus vénérées des terres russes occidentales, et la pieuse tradition en attribue la peinture au saint évangéliste Luc et tient qu'elle fut apportée de Byzance aux jours de saint Vladimir, lorsque la terre de Rus reçut le saint baptême.", "patron": "On l'invoque pour la protection; pour la guérison."},
...
{"type": "Hiéromoine · VIe s.", "life": "Le vénérable Cyriaque l'anachorète naquit à Corinthe en l'an 448, fils d'un prêtre, et à dix-huit ans, ayant entendu à l'église la parole du Seigneur, que celui qui veut venir à sa suite se renie lui-même, il s'embarqua pour la Terre sainte et fut reçu par saint Euthyme le Grand, qui le revêtit de l'habit monastique et l'envoya à saint Gérasime au Jourdain.", "patron": "On l'invoque pour les moines; pour le jeûne strict."},

"Venerable Laurence, Abbot of Komel":
{"type": "Vénérable · XVIe s.", "life": "Le vénérable Laurent de Komel fut, comme saint Cassien avec qui l'Église le commémore en ce jour, un disciple de saint Corneille de Komel, et il poursuivit l'œuvre du gouvernement du monastère de Vologda dans l'esprit et la règle de leur maître commun.", "patron": "La lignée de Corneille continuée."},

"Venerable Lazarus of Murom":
{"type": "Higoumène · XIVe s.", "life": "Le vénérable Lazare de Mourom était grec, né à Constantinople, et devint moine dans sa ville natale au monastère du Haut-Mont sous l'ancien Athanase Diskotès, bâtisseur de nombreux monastères, et passa après huit ans sous la conduite de l'évêque Basile de Césarée; et en 1343 cet évêque, voulant encourager l'Église russe, envoya Lazare, déjà iconographe renommé, avec des moines et des présents, à saint Basile, archevêque de Novgorod.", "patron": "On l'invoque pour les iconographes; pour les missionnaires du Nord."},

"Venerable Lazarus the Iconographer, of Constantinople":
{"type": "Moine · IXe s.", "life": "Le vénérable Lazare iconographe, moine de Constantinople, était renommé pour la sainteté de sa vie et pour son art, peignant les saintes icônes dans les années où l'empereur Théophile, le dernier des iconoclastes, persécutait à la fois les images et les mains qui les faisaient. Sommé de cesser son travail, Lazare répondit en peignant.", "patron": "On l'invoque pour les iconographes; pour les peintres."},

"Venerable Lazarus, Wonderworker of Mount Galesius Near Ephesus":
{"type": "Hiéromoine · XIe s.", "life": "Le vénérable Lazare, thaumaturge du mont Galésion, naquit en Lydie, en Asie Mineure, et dans sa jeunesse fit le voyage de la Terre sainte, où il travailla dix ans à la laure de Saint-Sabas et fut ordonné prêtre par le patriarche de Jérusalem. Revenu dans sa patrie, il s'établit sur le mont Galésion, désolé, près d'Éphèse.", "patron": "On l'invoque pour les stylites; pour les moines."},

"Venerable Leontius of the Kyiv Far Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Léonce le canonarque mena l'ascèse dans les Grottes Lointaines de la laure de Kyiv, et servit les frères dans l'ordonnance et le chant des offices divins.", "patron": "Les chantres et les chefs de chœur; ceux que le monastère a élevés dès l'enfance."},

"Venerable Leontius the Hagiorite":
{"type": "Moine · XVIIe s.", "life": "Le vénérable Léonce l'hagiorite fut un moine du mont Athos, la Sainte Montagne, honoré avant tout pour la rigueur de sa stabilité monastique, car il se tint dans les murs de son monastère soixante ans et n'en franchit pas une seule fois l'enceinte.", "patron": "Les moines de stricte clôture; ceux qui ne quittent jamais leur monastère."},

"Venerable Limnaeus, Hermit of Syria":
{"type": "Ermite · Ve s.", "life": "Le vénérable Limnée, ermite de Syrie, commença sa course ascétique auprès de saint Thalassios, sur la colline proche de Targala, demeurant avec lui assez longtemps, comme le rapporte l'historien Théodoret, pour acquérir les vertus de son maître, la simplicité des manières, la douceur et l'humilité, le disciple copiant non d'abord les austérités de l'ancien mais son caractère, ce qui est le bon ordre.", "patron": "On l'invoque pour les aveugles; pour les ascètes du plein air."},

"Venerable Longinus of Yarenga":
{"type": "Moine · XVIe s.", "life": "Le vénérable Longin de Yarenga fut un moine du grand monastère de Solovki dans la mer Blanche, travaillant aux obédiences de cette rude fraternité du Nord dans les traditions des saints Zosime et Sabbatios. Vers l'an 1544, naviguant sur la mer au service du monastère avec son frère le moine Jean, il fut surpris par une tempête soudaine, et les deux ascètes périrent dans les eaux glacées, scellant par une telle fin des vies passées dans l'obéissance et le labeur.", "patron": "On l'invoque pour les marins; pour ceux qui travaillent sur la mer."},

"Venerable Longinus the Gatekeeper of the Kyiv Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Longin portier des Grottes de Kyiv accomplit son obédience monastique aux portes de la grande laure, et sa prière fervente et son humble amour du travail furent récompensés par le Seigneur du don de discernement, si bien que le portier du monastère devint un portier des âmes.", "patron": "On l'invoque pour les portiers; pour ceux qui gardent les portes."},

"Venerable Luke the Steward of the Kyiv Caves":
{"type": "Moine · XIIIe s.", "life": "Le vénérable Luc économe des Grottes de Kyiv portait au monastère l'obédience d'économe, l'intendant aux soins duquel sont confiés les biens, les provisions et les affaires temporelles de la fraternité; et il montra que ce ministère, qui empêtre si aisément une âme dans les soucis et les tentations du gain, peut être une voie de sainteté lorsqu'on y marche dans la droiture et la prière.", "patron": "On l'invoque pour les économes; pour les trésoriers."},

"Venerable Macarius the Wonderworker, Abbot of Kalyazin":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Macaire le thaumaturge, higoumène de Kaliazine, naquit Matthieu Kojine d'une famille de boyards de Kachine, et épousa par obéissance à ses parents une jeune fille nommée Hélène, quoique son cœur inclinât depuis longtemps vers le cloître; les jeunes époux convinrent entre eux que celui qui survivrait à l'autre prendrait l'habit monastique, et quand Hélène mourut la troisième année du mariage, Matthieu remplit aussitôt le pacte.", "patron": "On l'invoque pour les veufs; pour les fondateurs."},

"Venerable Macarius, Archimandrite of Ovruch":
{"type": "Martyr · XVIIe s.", "life": "En ce jour l'Église fait mémoire de la translation des reliques du hiéromartyr Macaire, archimandrite d'Ovroutch et de Pinsk, dont la fête principale tombe en septembre et dont le martyre couronna une vie passée à tenir son peuple dans la foi orthodoxe à travers les tempêtes du dix-septième siècle.", "patron": "Le troupeau d'Ovroutch et de Pinsk gardé dans la foi."},

"Venerable Macrina, sister of Saint Basil the Great":
{"type": "Higoumène · IVe s.", "life": "La vénérable Macrine la Jeune fut la sœur aînée des grands hiérarques Basile le Grand et Grégoire de Nysse, née en Cappadoce au commencement du quatrième siècle dans une famille qui devait donner beaucoup de saints à l'Église. Avant sa naissance sa mère, sainte Émilie, vit en songe un ange qui nommait l'enfant Thècle, du nom de la sainte protomartyre, et tel fut son nom secret, bien qu'on l'appelât Macrine du nom de son aïeule qui avait souffert dans les persécutions.", "patron": "On l'invoque pour les moniales; pour les moines."},

"Venerable Makarios, Abbot of Zheltovod and Unzha":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Macaire naquit en l'an 1349 à Nijni-Novgorod, de parents pieux, et à l'âge de douze ans il quitta la maison paternelle pour recevoir la tonsure monastique au monastère des Grottes de l'Ascension, sous la conduite du saint higoumène Denys, se donnant avec la ferveur de la jeunesse à l'œuvre du salut.", "patron": "On l'invoque pour les moines; pour les captifs."},

"Venerable Martha, mother of Saint Simeon Stylites":
{"type": "Mère · Ve s.", "life": "La vénérable Marthe, mère de saint Siméon le Stylite, vécut en Cilicie aux quatrième et cinquième siècles. Elle était d'une famille pauvre, et avec son époux Sisotion elle éleva le fils qui devait être la merveille de son temps. Quand Siméon eut reçu la tonsure monastique à l'insu de ses parents et fut monté sur sa colonne, Marthe, dans ses dernières années, vint avec le désir de le voir.", "patron": "On l'invoque pour les mères."},

"Venerable Martha, mother of Venerable Simeon Stylites the Younger":
{"type": "Laïque · VIe s.", "life": "La vénérable Marthe, mère du vénérable Siméon le Stylite le Jeune, vécut au sixième siècle et était native d'Antioche. Dès sa jeunesse elle aspirait à la vie monastique, mais elle se maria selon la volonté de ses parents; son époux Jean mourut peu après, et elle donna toute sa force à élever son fils dans la sainteté, devenant pour lui un modèle de vertu chrétienne.", "patron": "On l'invoque pour les mères et leurs enfants."},

"Venerable Martyrius of Zelenets, Pskov":
{"type": "Higoumène · XVIIe s.", "life": "Le vénérable Martyre de Zelenets, dans le monde Ménas, naquit à Veliki Louki au seizième siècle, des pieux Cosme et Stéphanide, et fut orphelin à dix ans; l'enfant fut élevé par son père spirituel, prêtre de l'église de l'Annonciation de la ville, et son âme, note la Vie, s'attacha à Dieu dès cette éducation dans le deuil, l'orphelin apprenant tôt qu'un Père ne meurt pas.", "patron": "On l'invoque pour les orphelins; pour les fondateurs."},

"Venerable Martyrius the Deacon, Recluse of the Kyiv Caves":
{"type": "Diacre · XIVe s.", "life": "Le vénérable Martyre le diacre peina au monastère des Grottes de Kyiv au quatorzième siècle, servant aux offices divins dans l'ordre du diaconat et ornant son ministère de jeûne, de pureté et de prière incessante. Une telle assurance lui fut donnée devant Dieu que, selon ce que rapporte la tradition de la Laure, lorsqu'il priait pour quelque chose se tenant à l'ambon, le Seigneur l'accordait aussitôt.", "patron": "On l'invoque pour les diacres; pour la prière que Dieu exauce."},

"Venerable Mary (who was called Marinus), and her father, Venerable Eugene, at Alexandria":
{"type": "Moniale · VIe s.", "life": "La vénérable Marie, qui était appelée Marin, et son père Eugène sont pour l'Église une étude étonnante des extrémités de la patience. Quand Eugène, devenu veuf, résolut d'achever ses jours dans un monastère, sa jeune fille Marie refusa d'être laissée dans le monde, et tous deux imaginèrent la seule porte qui les recevrait ensemble: Marie coupa ses cheveux, revêtit des habits d'homme et entra au monastère de Bithynie auprès de son père comme le jeune moine Marin.", "patron": "On l'invoque pour ceux que l'on accuse à tort; pour les femmes déguisées pour Dieu."},

"Venerable Mary of Egypt":
{"type": "Vénérable · Ve-VIe s.", "life": "La vénérable Marie l'Égyptienne fut une courtisane d'Alexandrie qu'une puissance invisible empêcha d'entrer dans l'église de Jérusalem, et qui se repentit devant l'icône de la Mère de Dieu et se retira au désert au-delà du Jourdain. Elle y vécut quarante-sept ans dans une ascèse extrême et parvint à une grande sainteté. Découverte par l'ancien Zosime, elle reçut la communion et s'endormit peu après. Elle est l'image souveraine du repentir.", "patron": "Un modèle de repentir et de conversion; on en fait mémoire le cinquième dimanche du Grand Carême."},

"Venerable Matrona of Chios":
{"type": "Moniale · XVe s.", "life": "La vénérable Matrone de Chios naquit au village de Volissos, dans cette île, de parents riches et pieux nommés Léon et Anne, et fut appelée Marie dans le monde. Portée dès sa jeunesse à la vie monastique, elle fuit le mariage que sa famille lui destinait et se retira en un lieu solitaire de l'île, se donnant au jeûne et à la prière.", "patron": "On l'invoque pour les moniales; pour la virginité."},

"Venerable Matrona, Abbess of Constantinople":
{"type": "Moniale · Ve s.", "life": "La vénérable Matrone de Constantinople naquit à Pergé de Pamphylie et fut donnée en mariage à un noble nommé Dométien, dont elle eut une fille; et venue à Constantinople, elle s'enflamma tellement d'amour pour Dieu dans les églises et les vigiles de la capitale que, confiant son enfant à une femme pieuse, elle résolut de se donner tout entière au Seigneur.", "patron": "On l'invoque pour les higoumènes; pour les moniales."},

"Venerable Melania the Younger of Rome":
{"type": "Moniale · Ve s.", "life": "La vénérable Mélanie la Jeune de Rome naquit dans la plus haute aristocratie de l'empire, héritière des Valerii, maîtresse de domaines en Italie, en Sicile, en Espagne, en Afrique et en Bretagne, peut-être la personne privée la plus riche de son temps.", "patron": "On l'invoque pour les héritières; pour les fondatrices de monastères."},

"Venerable Memnon the Wonderworker":
{"type": "Higoumène · Ve s.", "life": "Le vénérable Memnon le thaumaturge fut higoumène en Égypte, formé dès sa jeunesse à tout le cursus du désert, le jeûne, la veille et la garde des pensées, jusqu'à ce que, s'étant d'abord gouverné lui-même, il fût établi pour en gouverner d'autres; et il conduisit sa fraternité avec ce mélange de sévérité envers soi et de douceur envers les faibles qui marque les abbas authentiques.", "patron": "On l'invoque pour les higoumènes; pour les marins dans la tempête."},

"Venerable Mercurius the Faster of the Kyiv Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Mercure le jeûneur peina à la Laure des Grottes de Kyiv au quatorzième siècle, et son nom déclare son combat: il soumit la chair par une abstinence extrême, ne goûtant la nourriture qu'avec une telle retenue que le jeûne devint en lui non un exercice mais une nature, le corps consumé et l'esprit resplendissant.", "patron": "On l'invoque pour les jeûneurs; pour l'abstinence."},

"Venerable Methodius, Abbot of Peshnosha, Disciple of Venerable Sergius of Radonezh":
{"type": "Higoumène · XIVe s.", "life": "Le vénérable Méthode, higoumène de Pechnocha, fut disciple du grand saint Serge de Radonège et l'un des nombreux fondateurs de monastères qui sortirent de sa conduite pour planter la vie monastique à travers la terre russe.", "patron": "Les disciples des saints fondateurs; les bâtisseurs de monastères."},

"Venerable Micah, disciple of Venerable Sergius of Radonezh":
{"type": "Vénérable · XIVe s.", "life": "Le vénérable Michée de Radonège servait la cellule de saint Serge, et toute sa biographie tient en une seule nuit, préparée par une vie entière de petitesse.", "patron": "La visite de la Mère de Dieu contemplée."},

"Venerable Michael Maleinos":
{"type": "Higoumène · Xe s.", "life": "Le vénérable Michel Maléinos naquit en Cappadoce de parents nobles et pieux et reçut le nom de Manuel; apparenté aux grandes familles de l'empire, il était destiné à une brillante carrière à la cour impériale. Pourtant, jeune encore, il abandonna le monde et ses honneurs et, se retirant au mont Kyminas en Bithynie, il reçut la tonsure monastique et se donna à une ascèse rigoureuse sous la conduite d'un ancien expérimenté.", "patron": "On l'invoque pour les moines; pour la vie monastique."},

"Venerable Moses the Ethiopian of Scete":
{"type": "Hiéromoine · Ve s.", "life": "Le vénérable Moïse, appelé le Noir, vécut en Égypte au quatrième siècle. Éthiopien de naissance et esclave dans sa jeunesse, il fut chassé par son maître après avoir commis un meurtre, et il se joignit à une bande de brigands qui, à cause de sa grande force et de sa hardiesse, le prirent pour chef, en sorte que son nom devint la terreur de toute la région par ses vols et ses meurtres.", "patron": "On l'invoque pour les moines; pour le repentir."},

"Venerable Moses the Hungarian of the Kyiv Near Caves":
{"type": "Moine · XIe s.", "life": "Le vénérable Moïse, Hongrois de naissance et frère de saint Éphrem de Novy Torg, entra avec ses frères au service du saint prince Boris, porteur de la Passion. Quand Boris fut assassiné sur l'Alta en l'an 1015, et l'un des frères tué avec lui, Moïse s'enfuit et trouva refuge à Kyiv.", "patron": "On l'invoque pour la chasteté; pour ceux que tente la luxure."},

"Venerable Moses, Wonderworker of the Kyiv Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Moïse vécut au monastère des Grottes de Kyiv aux treizième et quatorzième siècles et se donna tout entier à Dieu. Il portait de lourdes chaînes et une grande croix de cuivre sur lui, et son labeur constant et bien-aimé était la psalmodie et les innombrables prosternations, par lesquelles il exténuait son corps pour le salut de son âme.", "patron": "On l'invoque pour le labeur ascétique; pour la psalmodie."},

"Venerable Neilos the Ascetic of Sinai":
{"type": "Hiéromoine · Ve s.", "life": "Le vénérable Neilos l'ascète du Sinaï était un homme de haut rang à Constantinople, préfet de la capitale, marié et père de deux enfants, et disciple de saint Jean Chrysostome, dont l'enseignement alluma en lui le désir de la vie angélique. Du consentement de son épouse, la famille se partagea pour l'amour de Dieu.", "patron": "On l'invoque pour les écrivains; pour les pères spirituels."},

"Venerable Nestor the Chronicler of the Kyiv Caves":
{"type": "Diacre · XIIe s.", "life": "Le vénérable Nestor le chroniqueur, père de l'histoire russe, naquit à Kyiv vers l'an 1050 et vint à dix-sept ans auprès de saint Théodose au monastère des Grottes, recevant la tonsure sous son successeur Étienne, qui l'ordonna aussi hiérodiacre. Orné d'une profonde humilité, qui respire à chaque page qu'il a écrite, il se comptait pour le dernier des moines.", "patron": "On l'invoque pour les historiens; pour les chroniqueurs."},

"Venerable Nicholas Sviatosha Prince of Chernihiv, and Wonderworker of the Kyiv Near Caves":
{"type": "Prince · XIIe s.", "life": "Le vénérable Nicolas Sviatocha, prince de Tchernihiv et thaumaturge des Grottes de Kyiv, était arrière-petit-fils de Iaroslav le Sage et fils du prince David de Tchernihiv, et il régnait comme prince de Loutsk, ayant femme et enfants. Le dix-sept février 1106, quittant sa famille et sa principauté, il reçut la tonsure au monastère des Grottes de Kyiv, le premier des princes de Rus' à échanger la couronne contre le froc.", "patron": "On l'invoque pour les portiers; pour les jardiniers."},

"Venerable Nicholas the Monk of Bulgaria":
{"type": "Moine · IXe s.", "life": "Le vénérable Nicolas le soldat, appelé aussi le stratélate, servait dans l'armée impériale lors de la campagne que l'empereur Nicéphore conduisit en Bulgarie en l'an 811, et sa sainteté se décida en une seule nuit de marche. Logé dans une auberge, il fut assailli non par un ennemi mais par une tentation, la fille de l'aubergiste venant à lui dans les ténèbres.", "patron": "On l'invoque pour les soldats; pour tous ceux qui résistent à la tentation la veille du combat."},

"Venerable Niketas of the Kyiv Caves, Far Caves, Bishop of Novgorod":
{"type": "Évêque · XIIe s.", "life": "Le vénérable Nicétas, reclus des Grottes et évêque de Novgorod, est pour l'Église le grand cas d'étude de la tromperie et du relèvement, gardé dans le Paterikon avec une honnêteté clinique parce que chaque génération en a besoin. Jeune moine des Grottes de Kyiv, Nicétas demanda à l'higoumène, saint Nikon, l'exploit de la réclusion.", "patron": "On l'invoque pour ceux qui sont trompés puis relevés; pour les étudiants qui recommencent."},

"Venerable Niketas the Confessor, Abbot of Medikion":
{"type": "Confesseur et higoumène · IXe s.", "life": "Le vénérable Nicétas le confesseur, higoumène du monastère de Médikion, naquit à Césarée de Bithynie et, sa mère étant morte alors qu'il était encore nourrisson, fut élevé dans la piété par son aïeule.", "patron": "On l'invoque pour les higoumènes sous la persécution; pour ceux qui sont tombés et sont revenus."},

"Venerable Niketas the Stylite, Wonderworker of Pereyaslavl, Zalesski":
{"type": "Stylite · XIIe s.", "life": "Le vénérable Nicétas le stylite de Pereyaslavl-Zalesski fut un grand pécheur devenu un grand saint, l'un des exemples les plus saisissants que l'Église possède de la puissance d'une seule parole de l'Écriture pour briser et refaire un cœur endurci.", "patron": "Le cœur de l'exacteur brisé par la parole du prophète."},

"Venerable Nikon the Dry, of the Kyiv Near Caves":
{"type": "Moine · XIIe s.", "life": "Le vénérable Nicon le sec, des Grottes Proches, était le fils d'une famille riche et honorée de Kyiv, qu'il avait quittée tout entière pour les Grottes de saint Antoine; et dans les incursions des Polovtsiens qui ravagèrent la Laure il fut emmené captif dans la steppe. Celui qui le tenait fixa une grande rançon, connaissant la richesse de sa famille.", "patron": "On l'invoque pour les captifs; pour les prisonniers de guerre."},

"Venerable Nikon, Abbot of Radonezh, disciple of Venerable Sergius":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Nicon de Radonège, disciple et successeur de saint Serge, naquit à Iouriev-Polski et vint dans sa jeunesse auprès du grand ancien, qui, éprouvant son humilité, l'envoya d'abord à son disciple Athanase à Serpoukhov; et là Nicon reçut la tonsure et l'ordination, pour revenir enfin à Serge, qui l'aima tellement qu'il le garda dans sa propre cellule et, six mois avant son repos, l'établit sur la fraternité.", "patron": "On l'invoque pour les higoumènes; pour les bâtisseurs."},

"Venerable Nikon, Abbot of the Kyiv Far Caves":
{"type": "Higoumène · XIe s.", "life": "Le vénérable Nicon, higoumène des Grottes de Kyiv, que la tradition de la Laure appelle le Grand, vint à la grotte de saint Antoine déjà prêtre, le premier de cette dignité dans la petite fraternité sous la colline, et devint le bras droit du fondateur: c'est par la main sacerdotale de Nicon, avec la bénédiction d'Antoine, que les premiers frères reçurent la tonsure, et parmi eux le jeune Théodose.", "patron": "On l'invoque pour ceux qui tonsurent et forment les moines; pour les chroniqueurs."},

"Venerable Nilus of Stolbensk Lake":
{"type": "Moine · XVIe s.", "life": "Le vénérable Nil du lac Stolbensk, l'un des plus rudes ascètes du Nord russe, naquit dans la terre de Novgorod et reçut la tonsure au monastère de Kryptsy de saint Sabbas près de Pskov; et brûlant pour la solitude, il vécut treize ans en ermite dans la forêt près de la rivière Seremlia, dans le jeûne, la prière et le combat contre les démons et contre des brigands, qu'il mit en fuite, disent les récits, par sa seule prière.", "patron": "On l'invoque pour les ermites; pour la vigilance jusqu'à la mort."},

"Venerable Nίkander Wonderworker of Pskov":
{"type": "Moine · XVIe s.", "life": "Le vénérable Nikandre de Pskov, habitant du désert et thaumaturge, naquit en 1507 au village de Videlebié près de Pskov, le même village qui avait donné à l'Église saint Euphrosyne, et fut nommé Nikon dans le monde. Dès l'enfance il aspirait à la vie ascétique, et ayant appris ses lettres et distribué sa part de bien, il se retira au désert sur la rivière Demianka, entre Pskov et Porkhov.", "patron": "On l'invoque pour les ermites; pour la vie solitaire."},

"Venerable Onesiphorus the Confessor of the Kyiv Near Caves":
{"type": "Hiéromoine · XIIe s.", "life": "Le vénérable Onésiphore le confesseur fut hiéromoine du monastère des Grottes de Kyiv au douzième siècle, orné du jeûne et de toute vertu, et gratifié par Dieu du don de discerner les secrets des cœurs; et pourtant le Seigneur permit que même ce voyant fût trompé, pour l'instruction de tous.", "patron": "On l'invoque pour les confesseurs; pour les pères spirituels."},

"Venerable Onuphrius the Great":
{"type": "Moine · IVe s.", "life": "Le vénérable Onuphre le Grand fut l'un des plus fameux ermites du désert d'Égypte, un anachorète qui passa soixante ans dans une solitude entière au fond du désert, seul avec Dieu.", "patron": "Les ermites et les anachorètes; ceux qui demeurent seuls avec Dieu."},

"Venerable Onuphrius the Silent and Venerable Onesimos the Recluse, of the Kyiv Caves":
{"type": "Moine · XIIIe s.", "life": "Les vénérables Onuphre le silencieux et Onésime le reclus furent des ascètes des Grottes de Kyiv qui combattirent aux Grottes Proches de la Laure aux douzième et treizième siècles. Saint Onuphre est surnommé le Silencieux pour le silence rigoureux qu'il gardait, veillant sur ses lèvres et sur son cœur afin de s'entretenir plus purement avec Dieu, tandis que saint Onésime s'enferma comme reclus, se donnant tout entier à la prière et au souvenir de la mort.", "patron": "On les invoque pour le silence; pour la réclusion."},

"Venerable Pachomius the Great, Founder of Coenobitic Monasticism":
{"type": "Vénérable · IVe s.", "life": "Le vénérable Pacôme le Grand, père du monachisme cénobitique, naquit de parents païens vers l'an 292 dans la Haute-Thébaïde d'Égypte, et vint au Christ par le chemin du soldat.", "patron": "La vie commune dotée de sa première règle écrite."},

"Venerable Paisios Velichkovsky":
{"type": "Archimandrite · XVIIIe s.", "life": "Le vénérable Païssy Velitchkovsky, père du grand renouveau du monachisme orthodoxe, naquit Pierre Velitchkovsky en 1722 à Poltava en Ukraine, fils d'un prêtre de la cathédrale; et quittant l'Académie de Kyiv, dont la science scolastique ne pouvait étancher sa soif de la tradition vivante, il chercha Dieu à travers les monastères d'Ukraine et de Moldavie jusqu'à ce que, à vingt-quatre ans, il atteignît la Sainte Montagne de l'Athos.", "patron": "On l'invoque pour les traducteurs; pour les pères spirituels."},

"Venerable Paisios the Athonite (1994)":
{"type": "Moine (ancien) · XXe s.", "life": "Le vénérable Païssios de la Sainte Montagne, l'un des anciens les plus aimés du vingtième siècle, naquit Arsénios Eznepidis en 1924 à Pharassa de Cappadoce, et fut baptisé par saint Arsène de Cappadoce, qui prédit que l'enfant serait moine. Amené en Grèce tout petit lors de l'échange des populations, il grandit à Konitsa, travailla comme menuisier et servit comme radiotélégraphiste dans l'armée pendant la guerre civile, montrant du courage et de l'abnégation.", "patron": "On l'invoque pour les moines; pour ceux qui sont dans la détresse."},

"Venerable Paisius the Great":
{"type": "Moine · Ve s.", "life": "Le vénérable Païsius le Grand fut l'un des plus hauts pères du désert d'Égypte, ascète d'une abstinence et d'une prière extraordinaires, à qui il fut donné de voir le Christ lui-même.", "patron": "Les ascètes et les hommes de prière; ceux qui jeûnent des semaines entières."},

"Venerable Paisius, Abbot of Galich":
{"type": "Vénérable · XVe s.", "life": "Le vénérable Païsius de Galitch fut higoumène du monastère de la Dormition, dans la ville de Galitch, au pays de Kostroma, au quinzième siècle, et sa mémoire demeure liée à l'icône thaumaturge de la Mère de Dieu dite d'Ovine, qui était le trésor de sa maison.", "patron": "Le monastère de la Dormition de Galitch conduit en père."},

"Venerable Paisius, Abbot of Uglich":
{"type": "Higoumène · XVIe s.", "life": "Le vénérable Païsius d'Ouglitch fut un fondateur de la vie monastique sur la haute Volga, parent et disciple de saint Macaire de Kaliazine, dans la tradition duquel il fut formé et qu'il porta dans sa propre fondation.", "patron": "Les fondateurs de monastères; les parents et les disciples des saints."},

"Venerable Palladius of Thessalonica":
{"type": "Moine · VIIe s.", "life": "Le vénérable Pallade de Thessalonique mena la vie ascétique dans cette grande et sainte cité de Macédoine, au sixième ou au septième siècle, au temps où Thessalonique, gardée par le grand-martyr Démétrios, était une forteresse de l'Orthodoxie et une mère de moines. Ayant renoncé au monde, Pallade prit sur lui tout le combat des vénérables pères: le jeûne qui allège le corps, la veille qui arme l'esprit, la prière incessante qui garde le cœur, et l'humilité profonde qui les couronne toutes.", "patron": "On l'invoque pour les moines; pour la vie cachée."},

"Venerable Pambo the Recluse of the Kyiv Far Caves":
{"type": "Hiéromoine · XIIIe s.", "life": "Le vénérable Pambo, hiéromoine et reclus des Grottes de Kyiv, fut un confesseur de la foi qui vécut au temps des invasions tatares. Comme il accomplissait une obédience de son monastère, il fut pris et emmené par les Tatars, et durant de longues années il supporta leur cruauté et leurs sommations de renier le Christ, tenant ferme la vraie foi à travers toutes les afflictions.", "patron": "On l'invoque pour la fermeté dans la captivité."},

"Venerable Paphnutius and Euphrosynē of Alexandria":
{"type": "Moines · Ve s.", "life": "Le vénérable Paphnuce d'Alexandrie est commémoré en ce jour avec sa fille Euphrosyne, dont l'Église garde la fête principale en septembre; la mémoire de février appartient surtout au père, et à la plus étrange des consolations qu'aient connues les vies des saints. Paphnuce était un citoyen riche et pieux d'Alexandrie dont le mariage longtemps stérile fut exaucé par une fille unique, élevée dans la piété et fiancée par son père à un noble jeune homme.", "patron": "On les invoque pour les pères d'enfants consacrés; pour les parents de ceux qui ont disparu."},

"Venerable Paphnutius the Recluse of the Kyiv Caves":
{"type": "Reclus · XIIIe s.", "life": "Le vénérable Paphnuce le reclus des Grottes de Kyiv mena son combat au treizième siècle dans les Grottes Lointaines de saint Théodose, et la tradition de la Laure se souvient de lui par un unique exploit porté à sa perfection: Paphnuce pleurait. S'étant enfermé dans la réclusion, il prit pour unique méditation la mémoire de la mort, que les pères appellent la mère de la vigilance.", "patron": "On l'invoque pour ceux qui pleurent; pour ceux qui gardent la mémoire de la mort."},

"Venerable Paphnutius, Abbot of Borov":
{"type": "Vénérable · XVe s.", "life": "Le vénérable Paphnuce, higoumène de Borovsk, portait dans son sang la réponse de l'Église au joug tatar, car son grand-père avait été un baskak tatar, percepteur des conquérants sur la terre russe, qui vint à la foi et fut baptisé Martin.", "patron": "La lignée tatare entée sur la sainteté."},

"Venerable Paraskevi (Petka) of Serbia":
{"type": "Moniale · XIe s.", "life": "La vénérable Parascève la Nouvelle, que le peuple serbe appelle avec amour Sveta Petka, naquit au onzième siècle à Épivate en Thrace et donna sa jeunesse au Christ, distribuant ses vêtements et son héritage aux pauvres, menant la vie monastique dans un couvent d'Héraclée, et vivant en ascète au désert du Jourdain, jusqu'à ce qu'un ange lui commandât de retourner dans sa patrie, où elle s'endormit dans l'obscurité et fut glorifiée par Dieu par des reliques incorrompues et thaumaturges.", "patron": "On l'invoque pour les femmes; pour les malades."},

"Venerable Patapius of Thebes":
{"type": "Moine · VIIe s.", "life": "Le vénérable Patape naquit à Thèbes d'Égypte de pieux parents chrétiens, et fuyant l'honneur qu'attiraient ses vertus, il se retira jeune au désert d'Égypte, où il travailla longtemps dans le jeûne, la veille et la prière; et lorsque la renommée l'y eut trouvé lui aussi, l'ermite fit ce que seuls osent les plus sages, se cachant non pas plus avant dans le désert mais dans la plus grande foule de la terre, venant à Constantinople et s'enfermant dans une cellule près du rempart, aux Blachernes.", "patron": "On l'invoque pour ceux qui guérissent; pour la guérison des aveugles et des malades."},

"Venerable Paul the Obedient, of the Kyiv Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Paul l'obéissant fut un ascète des Grottes Lointaines du monastère des Grottes de Kyiv. Ayant reçu le grand habit angélique, il prit sur lui sans un murmure les obédiences les plus pesantes que lui imposait le supérieur, et jamais on ne le trouva oisif: dès qu'il n'était pas à la tâche assignée, il moulait le grain sous la meule, usant son corps à ce lourd travail tandis que son âme parvenait à la prière intérieure incessante.", "patron": "On l'invoque pour les moines; pour ceux qui travaillent de leurs mains."},

"Venerable Paul the Simple, disciple of Venerable Anthony the Great":
{"type": "Moine · IVe s.", "life": "Le vénérable Paul le simple, d'Égypte, fut appelé le Simple pour la simplicité de son cœur et sa douceur, et il vint au désert par la porte d'un foyer brisé: paysan déjà âgé de soixante ans, il découvrit l'infidélité de sa femme, et répondant à l'injure sans violence ni procès, il la quitta sans amertume et s'en alla trouver saint Antoine le Grand, demandant à devenir moine.", "patron": "On l'invoque pour les vieillards qui commencent tard; pour les cœurs simples."},

"Venerable Pelagia the Penitent":
{"type": "Moniale · Ve s.", "life": "La vénérable Pélagie la pénitente fut la plus célèbre danseuse et courtisane d'Antioche, appelée Margarito, la Perle, pour sa beauté et ses joyaux; et un jour, comme elle passait en grand apparat avec sa suite devant les portes où siégeait un concile d'évêques, elle attira les regards de tous, et le saint évêque Nonnos pleura, disant aux autres: cette femme prend plus de soin à se parer pour les hommes que nous à parer nos âmes pour Dieu.", "patron": "On l'invoque pour les actrices; pour les pénitents."},

"Venerable Peter of Constantinople":
{"type": "Moine · IXe s.", "life": "Le vénérable Pierre naquit dans une famille patricienne de Constantinople vers la fin du huitième siècle. Reçu officier sous l'empereur Nicéphore, il prit part aux campagnes contre la Bulgarie, et dans la bataille où l'empereur fut tué il se trouva parmi les nombreux captifs.", "patron": "On l'invoque pour les captifs et les prisonniers."},

"Venerable Peter of Mount Athos":
{"type": "Moine · VIIIe s.", "life": "Le vénérable Pierre du Mont Athos fut le premier ermite connu de la Sainte Montagne, qui y demeura dans la solitude cinquante-trois ans et que l'on honore comme un père du monachisme athonite.", "patron": "Les ermites et les premiers des solitaires; le Mont Athos et ses moines."},

"Venerable Peter the Hermit of Galatia Near Antioch, in Syria":
{"type": "Ermite · Ve s.", "life": "Le vénérable Pierre l'ermite de Galatie commença son renoncement à l'âge où les autres enfants commencent leurs études: à neuf ans, épris de la vie de l'esprit, il quitta la maison de ses parents en Galatie et partit dans le monde de Dieu, allant d'abord en pèlerinage à Jérusalem vénérer les Lieux saints, puis à Antioche, où il se fixa pour tout le reste d'une très longue vie.", "patron": "On l'invoque pour ceux qui guérissent; pour les enfants que Dieu appelle tôt."},

"Venerable Philotheus, Patriarch of Constantinople":
{"type": "Patriarche · XIVe s.", "life": "Saint Philothée, patriarche de Constantinople, surnommé Kokkinos, était originaire de Thessalonique et reçut la tonsure monastique dans sa jeunesse. Après avoir travaillé quelque temps au mont Sinaï, il vint à la Sainte Montagne de l'Athos, où il devint higoumène de la Grande Laure; et en 1347 il fut fait métropolite d'Héraclée de Thrace, montant ensuite sur le trône œcuménique de Constantinople.", "patron": "On l'invoque pour les théologiens; pour les hymnographes."},

"Venerable Pimen the Ascetic of the Kyiv Far Caves":
{"type": "Vénérable · XIIe s.", "life": "Le vénérable Pimène l'ascète, des Grottes de Kyiv, que la tradition appelle le Jeûneur, vécut au douzième siècle, à l'âge héroïque de la Laure, et gagna sa place au calendrier par le plus ancien et le moins brillant des arts ascétiques, la maîtrise de l'appétit.", "patron": "Le jeûne gardé comme une fête de toute une vie."},

"Venerable Pimen the Great":
{"type": "Moine · Ve s.", "life": "Le vénérable Pimène le Grand naquit en Égypte vers l'an 340 et entra au monastère avec ses deux frères, Anoub et Païsius, tous trois recevant l'habit monastique et se donnant à un rude travail ascétique.", "patron": "On l'invoque pour les moines; pour l'humilité."},

"Venerable Pimen the Much-Ailing of the Kyiv Near Caves":
{"type": "Moine · XIIe s.", "life": "Le vénérable Pimène, dit le très-souffrant, atteignit le Royaume des cieux par la patiente endurance d'une pénible maladie. Né et élevé dans la maladie, il fut préservé par son infirmité même des maladies de l'âme, et dès sa jeunesse il supplia ses parents de le conduire au monastère des Grottes de Kyiv.", "patron": "On l'invoque pour les malades chroniques; pour la patience dans la souffrance."},

"Venerable Polycarp of Briansk":
{"type": "Higoumène · XVIIe s.", "life": "Le vénérable Polycarpe de Briansk mena son combat au tournant du dix-septième siècle, dans les années où le Temps des troubles se levait sur la terre russe, et sa sainteté prit la forme dont le siècle avait le plus besoin, celle de la reconstruction d'une maison de Dieu au milieu de la ruine générale.", "patron": "On l'invoque pour les pénitents de haut rang; pour ceux qui relèvent les monastères."},

"Venerable Polycarp, Archimandrite of the Kyiv Far Caves":
{"type": "Archimandrite · XIIe s.", "life": "Le vénérable Polycarpe entra au monastère des Grottes de Kyiv, où il fut tonsuré et travailla au salut de son âme, et, fidèle à son nom, qui signifie fruit abondant, il porta des fruits abondants de repentir et de vertu. Son parent saint Simon, qui devint évêque de Vladimir et de Souzdal, le conduisit dans la vie spirituelle, et les deux hommes furent unis d'esprit toujours plus étroitement comme ils l'étaient par le sang.", "patron": "On l'invoque pour les moines; pour ceux qui gouvernent avec vertu."},

"Venerable Porphyrios of Kavsokalyvia (1991)":
{"type": "Hiéromoine · XXe s.", "life": "Le vénérable Porphyre de Kavsokalyvia, l'un des grands anciens du vingtième siècle, naquit Evangélos Baïraktaris en 1906 dans une famille pauvre de l'île d'Eubée; et lisant tout enfant la vie de saint Jean le Calybite, il brûla d'un tel amour pour le Christ que, vers l'âge de douze ans, il s'enfuit à la Sainte Montagne, au skite de Kavsokalyvia, où il se donna en obéissance absolue à deux anciens austères, les frères Pantéleimon et Joannice.", "patron": "On l'invoque pour les médecins; pour les aumôniers."},

"Venerable Prince Andrew, in Monasticism Joasaph, of Kubensk, Vologda":
{"type": "Moine · XVe s.", "life": "Le vénérable Joasaph de Koubensk, thaumaturge de Vologda, était dans le monde le prince André, fils du pieux prince Dimitri de la Petite Zaozerié, descendant du saint prince Théodore de Smolensk et de Iaroslavl. Élevé dans une profonde piété, il quitta à vingt ans son héritage princier et reçut la tonsure avec le nom de Joasaph au monastère du Sauveur-de-la-Pierre, dans l'île du lac Koubensk.", "patron": "On l'invoque pour les moines; pour la jeunesse donnée à Dieu."},

"Venerable Prokopios the Confessor of Decapolis":
{"type": "Confesseur · VIIIe s.", "life": "Le vénérable Procope le confesseur de Décapolis fut moine de cette région d'Asie Mineure aux jours où l'empereur Léon l'Isaurien souleva la première grande persécution contre les saintes icônes, et il mérita son titre au plus haut prix que l'époque offrît en deçà de la mort.", "patron": "On l'invoque pour les confesseurs; pour les moines sous la persécution."},

"Venerable Publius of Egypt":
{"type": "Moine · IVe s.", "life": "Le vénérable Publius d'Égypte complète la compagnie des vénérables égyptiens de ce jour, commémoré avec Siméon, Théonas et Phorbinus dans la mémoire commune que les calendriers portent depuis les premiers siècles.", "patron": "On l'invoque pour les moines du désert; pour ceux qui veillent dans la prière."},

"Venerable Romanus the Melodist, “Sweet-Singer”":
{"type": "Diacre · VIe s.", "life": "Le vénérable Romain le Mélode, le doux chantre de l'Église, naquit à Émèse en Syrie et servit comme diacre d'abord à Beyrouth, puis à Constantinople au temps de l'empereur Anastase, desservant l'église de la Mère de Dieu de Kyros et veillant la nuit aux Blachernes.", "patron": "On l'invoque pour les chantres; pour les hymnographes."},

"Venerable Rufus the Obedient of the Kyiv Far Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Rufe l'obéissant, des Grottes Lointaines de Kyiv, vécut au quatorzième siècle et porte dans son surnom même toute sa biographie et le sommet de la science monastique, car les pères des Grottes, qui comptaient parmi eux des jeûneurs, des reclus, des thaumaturges et des guérisseurs, jugèrent que la marque propre de ce moine était l'obéissance, et fixèrent ce mot à son nom pour toujours.", "patron": "On l'invoque pour les novices; pour tous ceux qui vivent sous l'obéissance."},

"Venerable Sabbatius, Wonderworker of Solovki":
{"type": "Moine · XVe s.", "life": "Le vénérable Sabbace, thaumaturge de Solovki, était moine de Valaam sur le lac Ladoga, où son humilité et la rigueur de sa vie lui attirèrent de la part des frères une telle vénération que le saint, fuyant la louange des hommes, chercha un désert où nul ne le connût.", "patron": "On l'invoque pour les moines; pour la solitude extrême."},

"Venerable Savva the Recluse of the Kyiv Far Caves":
{"type": "Moine · XIIIe s.", "life": "Le vénérable Savva le reclus des Grottes de Kyiv partage la commémoration de ce jour avec le vénérable Alexis, les deux reclus joints au calendrier comme voisins d'un même combat caché.", "patron": "On l'invoque pour les reclus; pour les intercesseurs cachés."},

"Venerable Savva the Sanctified":
{"type": "Archimandrite · VIe s.", "life": "Le vénérable Savva le sanctifié, législateur du monachisme palestinien, naquit en 439 à Moutalaska de Cappadoce, et entré au monastère à huit ans, il montra dès l'enfance la volonté d'un ancien: ayant une fois cueilli et mangé une pomme contre la règle, il fit vœu de ne plus jamais goûter de pomme, et garda ce vœu jusqu'à sa mort.", "patron": "On l'invoque pour les moines; pour les liturgistes."},

"Venerable Savva, Abbot of Moscow":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Savva, higoumène de Moscou, fut le successeur de saint Andronic comme higoumène du monastère du Sauveur-Andronikov à Moscou, et il continua dans cette maison la tradition de vie commune qui venait de saint Serge de Radonège.", "patron": "Les successeurs des saints fondateurs; les higoumènes de la vie commune."},

"Venerable Savva, Abbot of Vishera, Novgorod":
{"type": "Moine · XVe s.", "life": "Le vénérable Savva de Vichera était fils d'un boyard de Kachine, et renonçant dans sa jeunesse à ses fiançailles et à son héritage, il reçut la tonsure monastique et se donna à une stricte ascèse, allant jusqu'à la Sainte Montagne de l'Athos pour s'y former à ses traditions. Revenu en terre russe, il s'établit près de la rivière Vichera, non loin de Novgorod, où il fonda en 1418 un monastère en l'honneur de l'Ascension du Seigneur.", "patron": "On l'invoque pour les moines; pour la prière vigilante."},

"Venerable Savva, Igoumen of Zvenigorod, Disciple of Venerable Sergius of Radonezh":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Savva de Storojevsk, le thaumaturge de Zvenigorod, fut des premiers disciples de saint Serge de Radonège, formé sous ce grand ancien dans le silence, l'obéissance et la prière incessante, et si sûr aux yeux de la fraternité qu'il servit de père spirituel à toute la communauté de la Trinité, et, un temps, d'higoumène de la Laure elle-même.", "patron": "On l'invoque pour les pères spirituels; pour les higoumènes."},

"Venerable Sebastian Dabovich":
{"type": "Archimandrite · XXe s.", "life": "Le vénérable Sébastien de Jackson et de San Francisco, l'apôtre des Amériques, naquit Jovan Dabović le vingt et un juin 1863 à San Francisco, de parents serbes immigrés, et fut le premier homme né aux États-Unis à être ordonné prêtre orthodoxe, en sorte que l'Orthodoxie américaine contemple en lui ses propres prémices.", "patron": "On l'invoque pour les missionnaires; pour les écrivains."},

"Venerable Sebastian of Poshekhonye":
{"type": "Higoumène · XVIe s.", "life": "Le vénérable Sébastien de Pochekhonié travailla vers le tournant du seizième siècle dans le pays des forêts au-delà de la Volga, l'un de cette armée silencieuse de fondateurs qui, dans les générations d'après Serge de Radonège, portèrent la lampe de l'ermite vers le nord, rivière après rivière, jusqu'à ce que tout le désert de la Russie fût jalonné de monastères.", "patron": "On l'invoque pour les fondateurs; pour les ermites des forêts du Nord."},

"Venerable Sebastian, Abbot of Pshekhonye Monastery, Vologda":
{"type": "Higoumène · XVIe s.", "life": "Le vénérable Sébastien de Pochekhonié peina dans les forêts du nord de la Russie au tournant du seizième siècle, et fonda sur la rivière Sokhot, au pays de Pochekhonié, vers Vologda, un ermitage de la Transfiguration du Seigneur, rassemblant autour de lui une fraternité établie sur la vie commune la plus stricte: rien en propre, tout en partage, et chaque bouche nourrie du travail de ses propres mains.", "patron": "On l'invoque pour les tisserands; pour les moines qui travaillent de leurs mains."},

"Venerable Seraphim of Vyritsa":
{"type": "Moine et ancien · XXe s.", "life": "Le vénérable Séraphin de Vyritsa, l'un des grands anciens de l'Église russe en son siècle crucifié, naquit Vassili Mouraviov en 1866, de paysans du pays de Iaroslavl, et fut envoyé enfant à Pétersbourg pour y gagner son pain.", "patron": "On l'invoque pour les marchands et les hommes d'affaires tournés vers Dieu; pour les enfants spirituels des anciens."},

"Venerable Serapion of Kozhe Lake":
{"type": "Moine · XVIIe s.", "life": "Le vénérable Sérapion du lac Kozhe fut un converti venu d'entre les Tatars, qui devint moine et fondateur de la vie monastique dans l'extrême nord de la Russie.", "patron": "Les convertis venus des peuples d'Orient; les fondateurs des monastères du Nord."},

"Venerable Serapion of Spaso-Eleazar Monastery, Pskov":
{"type": "Moine · XVe s.", "life": "Le vénérable Sérapion de Pskov naquit à Iouriev, aujourd'hui Tartu, qui relevait alors de la domination des Allemands, lesquels pressaient durement les orthodoxes; ses parents étaient paroissiens de l'église russe de Saint-Nicolas en cette ville, et le jeune homme, versé dans les saintes Écritures, se leva plus d'une fois pour la défense de la foi orthodoxe.", "patron": "On l'invoque pour les moines; pour la fermeté dans l'Orthodoxie."},

"Venerable Sergius and Herman, Wonderworkers of Valaam":
{"type": "Moines · XIVe s.", "life": "Les vénérables Serge et Herman, thaumaturges de Valaam, furent les fondateurs du grand monastère de Valaam, dans une île du lac Ladoga, et les illuminateurs du peuple carélien du nord de la Russie.", "patron": "Les fondateurs des monastères insulaires; les illuminateurs de la Carélie."},

"Venerable Sergius, Abbot of Nurma, disciple of Venerable Sergius of Radonezh, Vologda":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Serge de Nurma, thaumaturge de Vologda, était grec de naissance et avait peiné à la Sainte Montagne de l'Athos; et, bien qu'il fût déjà un ancien éprouvé, il fit le voyage du pays de Rus' pour consulter le vénérable Serge de Radonège et se placer sous sa conduite, passant quelques années comme disciple du grand abba.", "patron": "On l'invoque pour les moines; pour la vie au désert."},

"Venerable Silouan the Athonite (1938)":
{"type": "Moine · XXe s.", "life": "Le vénérable Silouane l'Athonite naquit en 1866 au village de Chovskoïé, dans la province de Tambov en Russie, fils de paysans pieux, et reçut le nom de Siméon. Doué dans sa jeunesse d'une grande force corporelle et d'un cœur déjà blessé par le souvenir de Dieu, il vint en 1892 au monastère russe de Saint-Pantéleimon au mont Athos, où il prit en toute rigueur le combat invisible, priant avec larmes pour le monde.", "patron": "On l'invoque pour les moines; pour tous ceux qui prient."},

"Venerable Silvanus the Schemamonk of the Kyiv Far Caves":
{"type": "Schémamoine · XIVe s.", "life": "Le vénérable Silvain fut un schémamoine des Grottes de Kyiv qui vécut à la fin du treizième et au commencement du quatorzième siècle. Gardant avec zèle la pureté de l'âme comme du corps, il soumit sa chair par le jeûne et la veille et purifia son esprit par la prière incessante et le souvenir de Dieu, et pour cela le Seigneur lui accorda de riches dons spirituels: la hardiesse dans la prière, la joie constante dans le Seigneur, la clairvoyance et l'opération des prodiges.", "patron": "On l'invoque pour la pureté de l'âme et du corps."},

"Venerable Silvanus the Schemamonk, of the Kyiv Far Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable schémamoine Silvain des Grottes de Kyiv mena l'ascèse dans les Grottes Lointaines de la laure aux treizième et quatorzième siècles, et sa mémoire garde un prodige qui révèle la puissance que Dieu donne à la prière des justes.", "patron": "Les gardiens des lieux saints; ceux qui travaillent au jardin."},

"Venerable Simeon Stylites the Younger of Wonderful Mountain":
{"type": "Stylite · VIe s.", "life": "Le vénérable Siméon le Stylite le Jeune, du Mont Admirable, renouvela dans sa propre génération l'ascèse stupéfiante du premier grand stylite, et passa presque toute sa vie sur une colonne, de son enfance jusqu'à sa mort dans une extrême vieillesse.", "patron": "La colonne gardée de l'enfance à la vieillesse."},

"Venerable Simeon of Emessa the Fool-For-Christ, and his fellow ascetic Venerable John":
{"type": "Fol-en-Christ · VIe s.", "life": "Les vénérables Siméon et Jean étaient des Syriens du sixième siècle, unis dès l'enfance par la plus étroite amitié. Tous deux étaient de familles riches, Siméon l'aîné vivant avec sa mère âgée, et Jean, quoique marié, demeurant avec son père et sa jeune épouse. Lorsque Siméon eut trente ans et Jean vingt-quatre, ils firent le pèlerinage de Jérusalem pour la fête de l'Exaltation de la Croix.", "patron": "On les invoque pour la sainteté cachée; pour l'humilité."},

"Venerable Simeon the New Theologian":
{"type": "Higoumène · XIe s.", "life": "Le vénérable Siméon le Nouveau Théologien, que l'Église a placé comme le troisième porteur de ce titre suprême auprès de Jean l'Évangéliste et de Grégoire de Nazianze, naquit Georges en 949 dans une famille noble de Galatie en Paphlagonie, et fut amené enfant à Constantinople pour la carrière que promettait la charge de son oncle à la cour.", "patron": "On l'invoque pour les théologiens; pour les pères spirituels."},

"Venerable Sisoes the Great":
{"type": "Moine (ermite) · Ve s.", "life": "Le vénérable Sisoès le Grand fut un moine solitaire du désert d'Égypte au cinquième siècle, qui prit pour demeure la grotte même que les labeurs de saint Antoine le Grand avaient sanctifiée. En soixante années de combat ascétique il parvint à une rare pureté d'âme et reçut le don des prodiges, rendant même une fois la vie à un enfant mort par sa prière.", "patron": "On l'invoque pour les moines; pour l'humilité."},

"Venerable Sisoes the Recluse of the Kyiv Near Caves":
{"type": "Schémamoine · XIIIe s.", "life": "Le vénérable Sisoès, schémamoine des Grottes de Kyiv, peina dans les Grottes Proches de saint Antoine au treizième siècle, et fut revêtu du grand habit, le degré le plus haut du renoncement monastique, dont le porteur meurt deux fois au monde. Embrassant la forme la plus stricte du combat des Grottes, il s'enferma dans la réclusion des cavernes.", "patron": "On l'invoque pour le combat caché de la réclusion."},

"Venerable Sisoes the Schemamonk of the Kyiv Far Caves":
{"type": "Schémamoine · XIIIe s.", "life": "Le vénérable Sisoès fut un schémamoine des Grottes de Kyiv qui peina dans les Grottes Lointaines au treizième siècle. On garde sa mémoire pour avoir dompté les passions de la chair par un jeûne rigoureux, et l'Église l'honore avec le vénérable Grégoire le jeûneur comme l'un de ceux à qui fut donnée la grâce de secourir les autres dans leurs propres combats contre la tentation.", "patron": "On l'invoque pour la maîtrise des passions."},

"Venerable Sophia of Suzdal, the Wonderworker":
{"type": "Moniale · XVIe s.", "life": "La vénérable Sophie de Souzdal, dans le monde la grande-princesse Solomonie Sabourova, naquit vers 1490, fille du noble Iouri Sabourov, et fut choisie en 1505 entre cinq cents jeunes filles de toute la Russie pour épouse de l'héritier Basile, leur mariage béni par le métropolite Simon dans la cathédrale de la Dormition au Kremlin.", "patron": "On l'invoque pour les femmes à qui l'on fait tort dans le mariage; pour celles qui n'ont pas d'enfants."},

"Venerable Sophronius the Recluse of the Kyiv Far Caves":
{"type": "Vénérable · XIIIe s.", "life": "Le vénérable Sophrone le reclus, des Grottes Lointaines de Kyiv, vécut au treizième siècle, au temps où le monastère des Grottes, déjà mère du monachisme russe, passait par le feu de la dévastation mongole de Kyiv.", "patron": "La réclusion gardée pour Dieu seul."},

"Venerable Sophrony (Sakharov) of Essex (1993)":
{"type": "Archimandrite · XXe s.", "life": "Le vénérable Sophrony d'Essex, l'un des grands anciens du vingtième siècle, naquit Serge Sakharov à Moscou en 1896 et s'adonna dans sa jeunesse au métier de peintre. Au milieu des bouleversements de son époque il quitta la Russie, et, après un temps de recherche, il vint au mont Athos, où il devint moine au monastère de Saint-Pantéleimon et le proche disciple du vénérable Silouane l'Athonite.", "patron": "On l'invoque pour les moines; pour les pères spirituels."},

"Venerable Stephen (in monasticism Simeon), the Myrrhgusher and Prince of Serbia":
{"type": "Moine et ancien grand joupan · XIIe s.", "life": "Le vénérable Siméon le myroblyte naquit Étienne Némania, grand joupan de Serbie, fondateur à la fois d'un État, d'une dynastie et d'un fleuve de sainteté. Régnant au douzième siècle, il travailla beaucoup pour sa patrie, unissant la plus grande part des terres serbes et gagnant à son pays son indépendance.", "patron": "On l'invoque pour les gouvernants qui renoncent; pour les pères de saints."},

"Venerable Stephen of Saint Savva Monastery":
{"type": "Moine · VIIIe s.", "life": "Le vénérable Étienne du monastère de Saint-Sabbas était neveu de saint Jean Damascène et naquit en l'an 725. Âgé de dix ans seulement, il entra à la grande laure de Saint-Sabbas le Sanctifié, au désert de Judée, et y reçut la tonsure monastique; et là il passa sa vie entière, se retirant souvent au désert pour se donner à la solitude et au combat spirituel.", "patron": "On l'invoque pour les moines; pour la vie monastique."},

"Venerable Stephen the Hymnographer of Saint Savva Monastery":
{"type": "Moine · IXe s.", "life": "Le vénérable Étienne l'hymnographe mena la vie ascétique dans la grande laure de Saint-Sabbas, au désert de Judée, cette école d'hymnographes qui donna à l'Église saint Jean Damascène et saint Cosmas de Maïouma; et là, formé dans le jeûne, la veille et la psalmodie sans fin, il reçut le don du chant sacré.", "patron": "On l'invoque pour les hymnographes; pour les chantres."},

"Venerable Stephen, Abbot of Makhrishche, Vologda":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Étienne de Makhrichtché était originaire de Kyiv et reçut la tonsure monastique au monastère des Grottes, où il passa plusieurs années dans l'obéissance et la prière. Quand l'oppression des Latins rendit la vie difficile, il partit vers le nord, à Moscou, où le grand-prince Ivan le reçut avec bienveillance et lui permit de s'établir au désert de Makhra, non loin du monastère de saint Serge de Radonège, dont il devint l'ami et le compagnon de labeur.", "patron": "On l'invoque pour les moines; pour la vie monastique."},

"Venerable Stephen, Abbot of the Kyiv Far Caves, and Bishop of Vladimir, in Volhynia":
{"type": "Évêque · XIe s.", "life": "Le vénérable Étienne, higoumène des Grottes de Kyiv et évêque de Volodymyr en Volhynie, porta le plus lourd des héritages monastiques, la succession d'un saint; disciple formé par le vénérable Théodose lui-même, il servit le grand fondateur comme domestique, maître du chant de l'église, et se tint si haut dans la confiance de son père que Théodose, mourant en 1074, désigna Étienne aux frères pour son successeur.", "patron": "On l'invoque pour les successeurs des grands fondateurs; pour ceux que l'on dépose injustement."},

"Venerable Stephen, Wonderworker, Abbot of Triglia":
{"type": "Confesseur et higoumène · IXe s.", "life": "Le vénérable Étienne le thaumaturge, higoumène du monastère de Triglia sur la côte de Bithynie près de Pruse, fut consacré à Dieu dès sa jeunesse, et excella tellement dans la vie ascétique, dans la pureté, le jeûne et la prière, qu'il fut mis à la tête de la confrérie de Triglia comme higoumène, et il la gouverna dans la sainteté, orné par Dieu de la grâce des prodiges.", "patron": "On l'invoque pour les higoumènes sous la persécution; pour les exilés."},

"Venerable Sylvester, Abbot of Obnora":
{"type": "Higoumène · XIVe s.", "life": "Le vénérable Sylvestre d'Obnora fut un disciple de saint Serge de Radonège et un contemporain de saint Alexis, métropolite de Moscou, et sa Vie complète, l'Église le reconnaît sans détour, n'a pas traversé les siècles, l'incendie et l'oubli de la terre du Nord ne lui laissant que son nom, sa rivière, son monastère et le contour d'une sainteté à laquelle elle se fie plus qu'aux documents.", "patron": "On l'invoque pour les ermites découverts malgré eux; pour les fondateurs des maisons de forêt."},

"Venerable Thais of Egypt":
{"type": "Moniale · IVe s.", "life": "La vénérable Thaïs d'Égypte fut livrée par sa mère à une vie de péché, et sa beauté la rendit célèbre et riche dans la honte, entraînant à la perdition bien des âmes. Le grand ancien Paphnuce, s'affligeant pour elle et pour ceux qu'elle perdait, revêtit des habits du monde et vint à elle avec une pièce d'or comme un client.", "patron": "On l'invoque pour les pénitents; pour le repentir."},

"Venerable Thalassius, Hermit of Syria":
{"type": "Ermite · Ve s.", "life": "Le vénérable Thalasse, ermite de Syrie, vécut au cinquième siècle, et se retira jeune encore sur une colline près du village de Targala, où il passa trente-huit ans de combat monastique sans toit au-dessus de la tête, sans cellule et sans abri d'aucune sorte, le ciel de Syrie pour toute architecture à travers près de quarante étés et hivers.", "patron": "On l'invoque pour les maîtres des ermites; pour les âmes douces."},

"Venerable Theocteristus, Abbot of Symbola on Mount Olympus, Bithynia":
{"type": "Higoumène · IXe s.", "life": "Le vénérable Théoctériste fut higoumène du monastère de Symbola sur l'Olympe de Bithynie, cette sainte montagne qui fut, aux huitième et neuvième siècles, la plus grande pépinière du monachisme de l'Orient chrétien, ses pentes couvertes de laures et de cellules, ses monastères forteresses de la foi durant les tempêtes iconoclastes.", "patron": "On l'invoque pour les higoumènes; pour la fidélité sous l'iconoclasme."},

"Venerable Theoctistus":
{"type": "Higoumène · Ve s.", "life": "Le vénérable Théoctiste fut un grand ascète du désert de Judée et le compagnon intime de saint Euthyme le Grand, auquel il fut uni d'un tel amour et d'une telle unité d'esprit que les deux semblaient une seule âme en deux corps. Chaque année, après la fête de la Théophanie, ils se retiraient ensemble au désert pour prier dans la solitude, et ne revenaient qu'au dimanche des Rameaux.", "patron": "On l'invoque pour les moines; pour l'obéissance monastique."},

"Venerable Theodora and her daughter Theopiste":
{"type": "Moniale · IXe s.", "life": "La vénérable Théodora, originaire de l'île d'Égine, et sa fille, appelée en monachisme Théopiste, vécurent en la ville de Thessalonique au neuvième siècle. Alors qu'ils étaient encore mariés, Théodora et son époux donnèrent leur fille unique à un couvent, où elle fut tonsurée et reçut son nom nouveau.", "patron": "On l'invoque pour les moniales; pour la vie monastique."},

"Venerable Theodora of Alexandria":
{"type": "Moniale · Ve s.", "life": "La vénérable Théodora d'Alexandrie vivait au cinquième siècle avec son mari dans l'amour et la concorde, jusqu'à ce que, prise au piège par l'insistance d'un homme riche et par la ruse d'une entremetteuse qui lui disait que Dieu ne voit pas ce qui se fait dans les ténèbres, elle tombât dans le péché.", "patron": "On l'invoque pour le repentir; pour ceux que l'on accuse faussement."},

"Venerable Theodore Graptus, “the branded,” Confessor":
{"type": "Moine · IXe s.", "life": "Le vénérable Théodore Grapte, le marqué, confesseur des saintes icônes, naquit à Jérusalem et fut formé avec son frère Théophane comme moine de la laure de Saint-Sabbas, les deux frères si savants et si saints que le patriarche de Jérusalem les envoya à Constantinople comme ses champions contre l'iconoclasme renaissant.", "patron": "On l'invoque pour les écrivains; pour les hymnographes."},

"Venerable Theodore Trichinas “the Hair-Shirt Wearer” and Hermit Near Constantinople":
{"type": "Moine · Ve s.", "life": "Le vénérable Théodore, que l'Église surnomme Trichinas, le porteur de cilice, naquit à Constantinople de parents riches, et fit de son renoncement une leçon de géographie, car il ne s'enfuit ni en Égypte ni au Sinaï, mais se retira dans un monastère du pays sauvage tout proche de la capitale, renonçant à la Ville à portée de vue de la Ville.", "patron": "On l'invoque pour les ermites; pour tous ceux qui portent pour Dieu de rudes vêtements."},

"Venerable Theodore the Sanctified, disciple of Venerable Pachomius the Great":
{"type": "Vénérable · IVe s.", "life": "Le vénérable Théodore le sanctifié fut le disciple et l'émule de saint Pacôme le Grand dans la voie de la perfection monastique, et s'endormit au quatrième siècle, dans la première floraison de la vie cénobitique le long du Nil; et son surnom porte tout le compte de sa sainteté.", "patron": "La perfection apprise aux côtés de Pacôme."},

"Venerable Theodore the Silent of the Kyiv Caves":
{"type": "Moine · XIIIe s.", "life": "Le vénérable Théodore le silencieux des Grottes de Kyiv peina au treizième siècle dans les Grottes Lointaines de saint Théodose, et il porte dans les livres de la laure le titre qui est toute sa biographie conservée: le Silencieux. Prenant sur lui l'exploit que les Pères appellent l'hésychia de la langue, Théodore renonça à la parole, ne gardant sa voix que pour la prière et la psalmodie.", "patron": "On l'invoque pour ceux qui se taisent; pour ceux qui gardent leur langue."},

"Venerable Theodosius of the Kyiv Far Caves":
{"type": "Higoumène · XIe s.", "life": "Le vénérable Théodose des Grottes fut, avec saint Antoine, père du monachisme au pays de Rus', le fondateur de la vie cénobitique parmi les moines russes. Il naquit à Vassilevo près de Kyiv, et dès sa jeunesse il fut attiré vers Dieu, fuyant les jeux et les beaux vêtements, travaillant humblement aux champs et cuisant le pain de l'église, quoique sa mère, qui l'aimait avec violence, tentât souvent par la force de le détourner de cette voie.", "patron": "On l'invoque pour les moines; pour le monachisme cénobitique."},

"Venerable Theodosius, Abbot of the Kyiv Far Caves Monastery, and Founder of Coenobitic Monasticism in Russia":
{"type": "Vénérable · XIe s.", "life": "Le vénérable Théodose, higoumène du monastère des Grottes Lointaines de Kyiv, commémoré sous ce titre en ce jour, est un seul et même père que le vénérable Théodose des Grottes de Kyiv.", "patron": "Le père unique des Grottes honoré sous tous ses titres."},

"Venerable Theoktίstē of the Isle of Lesbos":
{"type": "Moniale · IXe s.", "life": "La vénérable Théoctiste de Lesbos naquit à Méthymne, en cette île, et, orpheline de bonne heure, fut confiée à un monastère de femmes, où elle grandit dans l'amour du Christ; et vers sa dix-huitième année, comme elle visitait sa sœur dans un village voisin, elle fut emmenée dans un raid des pirates sarrasins qui ravageaient alors la mer Égée.", "patron": "On l'invoque pour les ermites; pour les captifs évadés."},

"Venerable Theophanes the Confessor of Sigriane":
{"type": "Confesseur et higoumène · IXe s.", "life": "Le vénérable Théophane le confesseur de Sigriane naquit vers 760 d'une noble maison de Constantinople, orphelin de bonne heure et remis à la tutelle de l'empereur lui-même, et engagé sur la plus haute route de la cour.", "patron": "On l'invoque pour les chroniqueurs; pour les historiens."},

"Venerable Theophanes the Faster of the Kyiv Near Caves":
{"type": "Moine · XIIe s.", "life": "Le vénérable Théophane le jeûneur peina dans les Grottes Proches de la Laure de Kyiv au douzième siècle, au premier grand âge du monastère des saints Antoine et Théodose, et son surnom est toute sa biographie: il fut un jeûneur, l'un de ces athlètes de l'abstinence en qui la tradition des Grottes voyait la voie la plus sûre vers la pureté du cœur.", "patron": "On l'invoque pour les jeûneurs; pour le jeûne."},

"Venerable Theophanes the Merciful of Gaza":
{"type": "Vénérable", "life": "Le vénérable Théophane le miséricordieux était citoyen de Gaza, riche en biens et plus riche encore en compassion. Sa maison était ouverte à tout étranger et à tout vagabond, il vêtait ceux qui étaient nus, nourrissait les affamés et soignait les malades, et il répandit toute sa substance en aumônes jusqu'à demeurer lui-même dans le besoin.", "patron": "On l'invoque pour ceux qui font l'aumône; pour la miséricorde envers les pauvres."},

"Venerable Theophilus the Recluse of the Kyiv Near Caves":
{"type": "Moine · XIIIe s.", "life": "Le vénérable Théophile le silencieux peina dans les Grottes Proches de la Laure de Kyiv aux douzième et treizième siècles, et prit sur lui le combat que son surnom conserve: la discipline ascétique du silence, par laquelle le moine offre à Dieu le membre le plus difficile de tous à dompter.", "patron": "On l'invoque pour le silence; pour la prière dans le secret."},

"Venerable Therapon, Abbot of Monza":
{"type": "Moine · XVIe s.", "life": "Le vénérable Térapont de Monza peina dans la seconde moitié du seizième siècle, formé à la vie monastique dans la région de Moscou, où il chérissait la mémoire et l'exemple du bienheureux Basile, le grand fol-en-Christ; et cherchant la quiétude, il se retira dans les forêts du Nord, au pays de Kostroma, s'établissant au monastère de la rivière Monza, près de Galitch, qui porta ensuite son nom.", "patron": "On l'invoque pour les cultivateurs dans la famine; pour l'avertissement avant le malheur."},

"Venerable Therapon, Abbot of White Lake":
{"type": "Vénérable · XVe s.", "life": "Le vénérable Térapont du Lac Blanc et de Mojaïsk fut un fondateur de monastères dans les forêts du Nord de la Russie et l'ami et le compagnon de labeur de saint Cyrille du Lac Blanc, et sa vie témoigne de la fécondité de la sainte amitié dans l'œuvre monastique.", "patron": "Le monastère de Saint-Théraponte fondé au bord du Lac Blanc."},

"Venerable Thomas of Bithynia":
{"type": "Moine · Xe s.", "life": "Le vénérable Thomas Déphourkinos naquit en Bithynie au dixième siècle, et, se donnant dès sa jeunesse à la vie monastique, il passa par les obédiences de la vie commune, puis se retira au désert, s'établissant enfin sur le mont Kyminas, l'une des montagnes saintes de Bithynie dont les laures et les ermitages rivalisaient avec l'Olympe et préparèrent la voie à l'Athos.", "patron": "On l'invoque pour les pères spirituels; pour ceux qui écrivent des lettres."},

"Venerable Thomas of Mount Maleos":
{"type": "Moine (ermite) · Xe s.", "life": "Le vénérable Thomas du mont Maléon fut, dans sa vie d'avant, un soldat et un chef, distingué et riche, qui, au sommet de sa réussite dans le monde, tourna son cœur tout entier vers Dieu. Renonçant à son rang et distribuant ses biens aux pauvres, il embrassa la vie monastique, et, guidé, comme le rapporte la tradition, par le prophète Élie, il se retira dans la solitude du mont Maléon pour se donner à la prière et au combat ascétique.", "patron": "On en fait mémoire au saint calendrier de l'Église."},

"Venerable Tikhon of Kaluga Or Medin":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Tikhon de Kalouga, dit aussi de Medin, fut un ermite et un fondateur du quinzième siècle qui sanctifia par sa solitude les forêts profondes du pays de Kalouga.", "patron": "Les ermites et les amis de la solitude; les fondateurs des monastères de forêt."},

"Venerable Tikhon of Luchov, Kostroma":
{"type": "Moine · XVIe s.", "life": "Le vénérable Tikhon de Loukhov, Timothée dans le monde, fut un moine du pays de Kostroma qui échangea le service d'un prince terrestre contre le service de Dieu et vécut et mourut dans la pauvreté qu'il aimait.", "patron": "Ceux qui quittent le monde et son service; les pauvres et ceux qui travaillent."},

"Venerable Timothy of Symbola in Bithynia":
{"type": "Ermite · VIIIe s.", "life": "Le vénérable Timothée de Symbola peina sur l'Olympe de Bithynie, la montagne sainte de l'Asie Mineure dont les ravins abritaient au huitième siècle une république de monastères que seuls les déserts anciens surpassaient, et parmi ses communautés celle qu'on appelait Symbola le reçut jeune et le garda jusqu'à la fin.", "patron": "On l'invoque pour les moines de pureté; pour les exorcistes."},

"Venerable Titus the Presbyter of the Kyiv Near Caves":
{"type": "Hiéromoine · XIIe s.", "life": "Le vénérable Tite le prêtre des Grottes Proches de Kyiv est la parabole du pardon propre aux Grottes, le frère russe de l'ancien Nicéphore, et le Patéricon raconte son histoire comme le procès-verbal d'un jugement de Dieu. Tite, prêtre du monastère, et Évagre, diacre, avaient été amis d'une amitié si étroite que les frères en faisaient un modèle.", "patron": "On l'invoque pour ceux qui sont brouillés; pour les prêtres en querelle."},

"Venerable Titus the Soldier, of the Kyiv Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Tite le soldat des Grottes de Kyiv vint à Dieu comme y sont venus bien des guerriers, par une blessure: homme de guerre du quatorzième siècle, il reçut au combat un coup à la tête si grave qu'il mit fin à son métier des armes, et la blessure qui ferma sa carrière ouvrit son éternité.", "patron": "On l'invoque pour les soldats devenus moines; pour les anciens combattants."},

"Venerable Titus the Wonderworker":
{"type": "Higoumène · IXe s.", "life": "Le vénérable Tite le thaumaturge fut enflammé de l'amour du Christ dès son enfance, et, entré jeune dans un cénobe, il se donna à la vie commune avec une plénitude que les synaxaires retiennent comme sa marque propre: en humilité et en obéissance il surpassa tous les moines de sa communauté, le jeune homme disputant la dernière place comme d'autres disputent la première.", "patron": "On l'invoque pour les moines de la vie commune; pour les obéissants."},

"Venerable Tryphon, Abbot of Vyatka":
{"type": "Archimandrite · XVIIe s.", "life": "Le vénérable Tryphon de Viatka naquit d'une famille de paysans au pays de la Mézen, dans le grand Nord, et, fuyant dans sa jeunesse le mariage que les siens lui destinaient, il erra en pèlerin sans toit, supportant le froid et la moquerie pour l'amour de Dieu, jusqu'à recevoir la tonsure monastique au monastère de Pyskor, sur la Kama.", "patron": "On l'invoque pour les missionnaires; pour l'illumination des peuples du Nord."},

"Venerable Xenophon, Abbot of Robeika, Novgorod":
{"type": "Higoumène · XIIIe s.", "life": "Le vénérable Xénophon de Robeika fut un disciple de saint Barlaam de Khoutyne et un fondateur de la vie monastique près de Novgorod, qui dès sa jeunesse choisit la voie de la pureté et de la prière.", "patron": "Les disciples des saints anciens; les fondateurs de monastères."},

"Venerable Xenophon, his wife, Mary, and their two sons, Arcadius and John, of Constantinople":
{"type": "Vénérables · VIe s.", "life": "Le vénérable Xénophon, son épouse Marie et leurs fils Arcade et Jean étaient des citoyens en vue de Constantinople aux cinquième et sixième siècles, riches de biens et de rang et, le récit y insiste, plus riches encore de simplicité d'âme et de bonté de cœur, une grande maison que Dieu voulait faire passer tout entière au calendrier.", "patron": "On les invoque pour les familles; pour les parents de ceux qui sont perdus."},

"Venerable Zachariah the Recluse":
{"type": "Moine et reclus · IXe s.", "life": "Le vénérable Zacharie le reclus est commémoré en ce jour, et le synaxaire byzantin lui-même confesse avec une honnête application que, parmi les nombreux saints qui portent le nom de Zacharie, on ne peut déterminer avec exactitude lequel l'Église honore ici, retenant seulement la croyance reçue qu'il mena la vie recluse dans un monastère de Constantinople près de la porte de Charsia.", "patron": "On l'invoque pour les reclus; pour ceux qui demeurent cachés."},

"Venerable Zeno the Faster, of the Kyiv Caves":
{"type": "Moine · XIVe s.", "life": "Le vénérable Zénon le jeûneur et ami du labeur, des Grottes Lointaines de Kyiv, vécut au quatorzième siècle, et les deux surnoms que la Laure lui donna sont toute sa biographie, exacts et suffisants: le jeûneur, et l'ami du labeur.", "patron": "On l'invoque pour les jeûneurs; pour ceux qui travaillent de leurs mains."},

"Venerable Zeno the Hermit of Antioch, disciple of Saint Basil the Great":
{"type": "Ermite · Ve s.", "life": "Le vénérable Zénon l'ermite d'Antioche naquit dans le Pont d'une riche famille et servit à la cour de l'empereur Valens parmi les courriers qui portaient les édits impériaux à travers l'empire, homme dont le métier était la vitesse, les routes et les paroles du pouvoir; et il avait été formé dans sa jeunesse par saint Basile le Grand, dont il était le disciple, en sorte que sous le manteau du courrier un moine chevauchait déjà.", "patron": "On l'invoque pour les courriers; pour les messagers."},

"Venerable Zosimas, Abbot of Solovki":
{"type": "Higoumène · XVe s.", "life": "Le vénérable Zosime, higoumène de Solovki, acheva la plantation que Sabbatios et Germain avaient commencée dans les îles de la mer Blanche, et il se tient avec eux comme fondateur du grand monastère au bord du monde habitable. Novgorodien qui avait donné son héritage pour le désert, Zosime rencontra l'ancien Germain, compagnon de Sabbatios reposé, et apprit de lui l'existence des îles.", "patron": "On l'invoque pour les moines des îles; pour les fondateurs des lieux les plus reculés."},

"Venerable Zosimas, Abbot of Vorbozomsk":
{"type": "Higoumène · XVIe s.", "life": "Le vénérable Zosime de Vorbozomsk appartient à la grande dispersion de la Thébaïde du Nord, ces générations où les disciples des anciens du Lac Blanc et de Komel portèrent la vie monastique au dehors, lac après lac, dans les déserts au-delà de Belozersk.", "patron": "On l'invoque pour les moines des îles; pour les disciples des grands anciens."},

"Virgin Martyr Anysia at Thessalonica":
{"type": "Vierge-martyre · IIIe s.", "life": "La sainte vierge martyre Anysie vivait à Thessalonique sous le règne de Maximien, fille orpheline de parents pieux qui l'avaient élevée dans la foi; et, ayant hérité de leurs biens, elle vendit tout, en distribua le prix aux pauvres et se donna à une vie cachée de jeûne, de veille et de prière, monastère d'une seule âme au milieu de la grande ville païenne.", "patron": "On l'invoque pour les jeunes filles; pour celles que l'on aborde sur le chemin de l'église."},

"Virgin Martyr Eulalia of Barcelona and the Martyr Felix":
{"type": "Martyrs · IVe s.", "life": "La sainte vierge martyre Eulalie vivait près de la ville de Barcelone en Espagne et fut élevée par ses parents dans la piété et la foi chrétienne, si bien que, toute jeune fille encore, elle se donnait à la prière, à la lecture des Écritures et au travail paisible de la maison. Quand, dans la persécution de Dioclétien, le gouverneur Dacien vint à Barcelone pour y détruire les chrétiens, Eulalie quitta secrètement sa maison de nuit, et au matin se tint devant le magistrat pour confesser le Christ.", "patron": "On les invoque pour les jeunes filles; pour la pureté."},

"Virgin Martyr Eupraxia of Tabenna":
{"type": "Moniale · Ve s.", "life": "La vénérable Eupraxie était fille d'Antigone, noble dignitaire de Constantinople et parent de l'empereur Théodose le Grand, et de sa pieuse épouse, nommée elle aussi Eupraxie, tous deux généreux en aumônes. Après la mort de son père, sa mère emmena la petite fille en Égypte, et là l'enfant, âgée de sept ans seulement, fut si attirée par la vie d'un monastère de femmes près de Tabennisi qu'elle supplia de demeurer parmi les moniales, et elle y fut reçue.", "patron": "On l'invoque pour les moniales; pour la virginité."},

"Virgin Martyr Euthalia of Sicily":
{"type": "Vierge-martyre · IIIe s.", "life": "La sainte vierge martyre Euthalie de Sicile vivait avec sa mère et son frère à Leontinoi, et sa courte vie tourna tout entière sur le songe d'une nuit dans le sommeil d'une autre femme. Sa mère, païenne, souffrait depuis de longues années d'une perte de sang qu'aucun médecin ne pouvait arrêter, le mal de la femme de l'Évangile venu sur une femme qui n'avait jamais entendu l'Évangile.", "patron": "On l'invoque pour les filles des maisons divisées; pour les nouveaux baptisés."},

"Virgin Martyr Febronia of Nisibis":
{"type": "Moniale-martyre · IVe s.", "life": "La sainte vierge martyre Febronie de Nisibe était une jeune moniale de Mésopotamie qui souffrit pour le Christ un martyre d'affreux tourments dans la persécution de Dioclétien, et dont la vie devint un modèle aimé de virginité et de courage.", "patron": "Les moniales et les vierges; celles qui endurent d'affreux tourments."},

"Virgin Martyr Glyceria at Heraclea":
{"type": "Martyre · IIe s.", "life": "La sainte vierge martyre Glycérie, dont le nom signifie douceur, souffrit à Héraclée de Thrace sous l'empereur Antonin, au milieu du deuxième siècle, et maintenant, comme le chante l'Église, elle se réjouit de la douceur sans fin du Royaume.", "patron": "La croix tracée sur le front devant l'idole."},

"Virgin Martyr Irais (Rhais) of Alexandria":
{"type": "Martyre · IVe s.", "life": "La sainte vierge martyre Iraïs, appelée aussi Rhaïs, était une jeune fille d'Alexandrie en Égypte. Sortie un jour pour puiser de l'eau au puits, elle vit au rivage un navire rempli de confesseurs du Christ, prêtres, diacres, moines et vierges, tenus dans les chaînes par les persécuteurs.", "patron": "On l'invoque pour la confession volontaire; pour le courage."},

"Virgin Martyr Julia of Carthage":
{"type": "Vierge", "life": "La sainte Julie était une jeune fille noble et pieuse de Carthage en Afrique du Nord qui, la ville étant tombée aux mains de ses ennemis, fut emmenée et vendue comme esclave. Servant son maître avec fidélité et humilité, elle donnait toutes ses heures libres à la prière et au jeûne, et elle ne voulut point se séparer de sa foi au Christ.", "patron": "On l'invoque pour les captifs; pour la pureté."},

"Virgin Martyr Juliana of Nicomedia, and 500 men and 130 women with her":
{"type": "Vierge-martyre · IVe s.", "life": "La sainte vierge martyre Julienne de Nicomédie souffrit en l'an 304, dans la persécution de Dioclétien et de Maximien, et avec elle une moisson que son propre courage avait semée. Fille du païen Africanus et fiancée contre son gré au sénateur Éleusios, la chrétienne secrète retardait le mariage par des conditions, et quand elle posa enfin la vraie, qu'elle n'épouserait aucun homme qui n'adorerait son Dieu, le prétendant éconduit, devenu éparque de la ville, devint son juge.", "patron": "On l'invoque pour les fiancées; pour les jeunes filles."},

"Virgin Martyr Lucy of Syracuse":
{"type": "Vierge-martyre · IVe s.", "life": "La sainte vierge martyre Lucie de Syracuse, dont le nom signifie lumière, souffrit en Sicile en l'an 304, dans la grande persécution de Dioclétien, et sa fête porte depuis lors la lumière dans les jours les plus sombres de l'hiver. Étant allée avec sa mère Eutychie, qui souffrait d'une perte de sang, prier au tombeau de sainte Agathe à Catane, Lucie vit la martyre en vision, et sa mère fut guérie au sanctuaire.", "patron": "On l'invoque pour les aveugles; pour ceux qui travaillent à la lampe."},

"Virgin Martyr Pelagia of Tarsus, in Asia Minor":
{"type": "Martyre · IVe s.", "life": "La sainte vierge martyre Pélagie de Tarse fut cherchée par la grâce avant de l'avoir cherchée: jeune fille de noble famille en Cilicie au tournant du quatrième siècle, elle avait entendu parler de la foi chrétienne et désirait sincèrement en connaître l'enseignement.", "patron": "Le baptême demandé à travers un songe."},

"Virgin Martyr Seraphima (Serapia) of Antioch":
{"type": "Vierge · IIe s.", "life": "Sainte Séraphima, vierge et martyre, était native d'Antioche et vivait à Rome sous le règne de l'empereur Hadrien, dans la maison de Sabine, noble dame de rang sénatorial qu'elle avait amenée à la foi du Christ. Lorsque la persécution éclata, le gouverneur Virilus la fit appeler; et comme elle désirait la couronne du martyre, elle se rendit auprès de lui sans crainte, sa fidèle Sabine à ses côtés.", "patron": "On l'invoque pour la pureté; pour la confession inébranlable."},

"Virgin Martyr Theodosia the Nun of Constantinople":
{"type": "Martyre · VIIIe s.", "life": "Sainte Théodosie, moniale de Constantinople, vierge et martyre, donna sa vie pour la défense des saintes icônes au commencement même de l'hérésie iconoclaste, et elle se compte parmi les premiers martyrs de cette longue persécution.", "patron": "L'icône du Christ au-dessus de la porte de la Chalcé défendue."},

"Virgin Martyrs Agape, Irene and Chionia, in Illyria":
{"type": "Vierges-martyres · IVe s.", "life": "Les saintes Agapé, Irène et Chionie, vierges et martyres, étaient trois sœurs dont le combat à Thessalonique en 304 est connu de l'Église par les actes mêmes de leur procès, l'un des plus précieux documents authentiques de l'âge des martyrs.", "patron": "On les invoque pour les sœurs; pour ceux qui gardent les Écritures."},

"Virgin Martyrs Alexandria, Claudia, Euphrasia, Matrona, Juliana, Euphemia, and Theodora":
{"type": "Vierges-martyres · IVe s.", "life": "Les saintes Alexandrie, Claudia, Euphrasie, Matrone, Julienne, Euphémie et Théodosie, vierges et martyres, souffrirent ensemble à Amisos, sur la côte pontique de la mer Noire, en l'an 310, dans la dernière fureur de la persécution de Maximien, quand les provinces d'Orient furent passées au crible maison par maison pour y trouver les chrétiens que les édits précédents avaient manqués.", "patron": "On les invoque pour les compagnies de femmes; pour celles qui tiennent ferme ensemble."},

"Yaroslavl-Pechersk (Caves) Icon of the Mother of God":
{"type": "Icône · XIXe s.", "life": "En ce jour, l'Église fait mémoire de l'icône miraculeuse de la Très Sainte Mère de Dieu de Iaroslavl-Petcherskaïa, image du type des Grottes de Kyiv qui fut glorifiée dans la ville de Iaroslavl au dix-neuvième siècle par une guérison remarquable.", "patron": "Les malades du corps et de l'âme; ceux qui souffrent d'une longue maladie."},

"“Bogolyubov” Icon of the Mother of God":
{"type": "Icône · XIIe s.", "life": "En ce jour, l'Église fait mémoire de l'icône miraculeuse de la Très Sainte Mère de Dieu de Bogolioubovo, image unique parmi les icônes de la Mère de Dieu, car elle ne la représente pas avec son Enfant, mais telle qu'elle apparut elle-même dans une vision, debout et seule, en prière.", "patron": "Ceux qui contemplent la Mère de Dieu en prière; ceux qui bâtissent des églises à son commandement."},

"“Chukhloma” Icon of the Mother of God from Galich":
{"type": "Icône · XIVe s.", "life": "L'icône de la Mère de Dieu de Tchoukhloma, appelée aussi icône de Galitch et appartenant au type de la Tendresse, apparut en l'an 1350 au vénérable Abrahame de Galitch, qui était venu au désert du nord pour les travaux ascétiques avec la bénédiction du vénérable Serge de Radonège. Sur les rives sauvages du lac de Galitch, il priait la Mère de Dieu de bénir son entreprise, et il vit sur la montagne sa sainte icône resplendissant d'une lumière indicible.", "patron": "On en fait mémoire pour la tendresse; pour l'intercession maternelle."},

"“Enlightener of Minds” Icon of the Mother of God":
{"type": "Icône", "life": "L'icône de la Mère de Dieu dite Illuminatrice des Esprits représente la Très Sainte Théotokos avec son divin Fils, qui est la source de toute sagesse et de toute intelligence. Devant cette image, les fidèles prient pour que l'esprit et le cœur soient illuminés par la vérité de Dieu, et les parents dont les enfants apprennent lentement supplient la Mère de Dieu que l'intelligence de leurs enfants soit affermie et qu'ils retiennent ce qui leur est enseigné.", "patron": "On en fait mémoire pour les étudiants; pour les enfants qui apprennent lentement."},

"“Kozel'shchansk” Icon of the Mother of God":
{"type": "Icône de la Mère de Dieu · XIXe s.", "life": "L'icône de la Mère de Dieu de Kozelchtchina, l'une des dernières grandes icônes miraculeuses révélées avant la catastrophe russe, était l'icône de famille des comtes Kapnist en leur domaine de Kozelchtchina, au pays de Poltava: une image de facture italienne conservée depuis longtemps dans la maison, montrant la Mère de Dieu avec l'Enfant, et près d'eux une coupe et une cuiller, où les malades ont toujours lu la promesse d'un remède venu du ciel.", "patron": "On en fait mémoire pour les paralysés; pour les jeunes filles."},

"“O All-Hymned Mother” Icon of the Mother of God":
{"type": "Icône", "life": "L'icône de la Mère de Dieu dite Ô Mère digne de toute hymne tire son nom des premiers mots du treizième kondakion de l'hymne Acathiste: Ô Mère digne de toute louange, qui as enfanté le Verbe, le plus saint de tous les saints; et sa mémoire est célébrée en ce jour.", "patron": "On en fait mémoire pour la louange de la Mère de Dieu; pour le secours en toute nécessité."},

"“Our Lady of Sitka” Icon of the Mother of God":
{"type": "Icône · XIXe s.", "life": "L'icône de la Mère de Dieu de Sitka est l'une des plus vénérées de l'Amérique du Nord; elle est enchâssée en la cathédrale Saint-Michel-Archange de Sitka, en Alaska. On l'attribue au célèbre iconographe russe Vladimir Borovikovski, et elle vint en Alaska aux premiers jours de la mission orthodoxe, où elle a été honorée comme une image miraculeuse et comme la protectrice des fidèles en Amérique.", "patron": "On en fait mémoire pour la protection de l'Amérique du Nord."},

"“Ozerianka” Icon of the Mother of God of Shuiu-Smolensk":
{"type": "Icône", "life": "En ce jour, l'Église fait mémoire de l'icône de la Mère de Dieu de Chouïa-Smolensk, peinte dans la ville de Chouïa dans les années 1654 et 1655, alors qu'une peste meurtrière ravageait les villes de Russie. Les habitants de Chouïa, se tournant vers la Mère de Dieu comme vers leur dernier refuge, commandèrent à un iconographe de peindre pour l'église paroissiale de la Résurrection l'Hodigitria de Smolensk.", "patron": "On en fait mémoire pour la délivrance de la peste; pour la protection dans les épidémies."},

"“Seven Arrows” Icon of the Mother of God":
{"type": "Icône · XVIIIe s.", "life": "En ce jour, l'Église fait mémoire de l'icône miraculeuse de la Très Sainte Théotokos dite Sept Flèches, image qui représente la douleur de la Mère de Dieu et que l'on invoque pour l'adoucissement des cœurs endurcis.", "patron": "Ceux qui cherchent l'adoucissement des cœurs durs; ceux qui réconcilient les ennemis."},

"“Surety of Sinners” Icon of the Mother of God of Korets":
{"type": "Icône · XIXe s.", "life": "En ce jour, l'Église fait mémoire de l'icône miraculeuse de la Très Sainte Théotokos dite Caution des Pécheurs, en la version vénérée à Korets, image dont le nom même proclame la miséricorde de la Mère de Dieu envers les pénitents.", "patron": "Les pécheurs qui cherchent l'intercession de la Mère de Dieu; ceux qui se repentent."},

"“Svena” Icon of the Mother of God":
{"type": "Fête · XIIIe s.", "life": "En ce jour, l'Église fait mémoire de l'icône de la Très Sainte Théotokos de Svena, l'un des trésors de la tradition des Grottes, attribuée par la tradition à la main du vénérable Alype des Grottes de Kyiv.", "patron": "L'icône d'Alype portée vers le nord."},

"“Virgin of Tenderness” Icon of the Mother of God of the Pskov Caves":
{"type": "Icône · XVIe s.", "life": "L'icône de la Tendresse de la Très Sainte Mère de Dieu, du type de l'Oumilenie où l'Enfant Jésus presse sa joue contre celle de sa Mère, appartient au monastère des Grottes de Pskov, où elle fut apportée au commencement du seizième siècle par de pieux chrétiens et devint la protectrice de la ville.", "patron": "On en fait mémoire pour la protection de Pskov; pour la délivrance de l'invasion."},
}
