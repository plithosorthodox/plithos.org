 ...
 *      fetches data/search-index.v5.json. It is fetched once, on first open,
...
(function () {
  ...
  var INDEX_URL = "data/search-index.v5.json";
  ...
  /* Everything the shared chrome says to a reader is held here rather than
     ...
     data/ui-i18n.v2.en.json is the same table as a file: it is the sheet a
     translator copies. The other languages are read from
     data/ui-i18n.v2.<code>.json, fetched once beside the index.
  ...
  function loadWords() {
    ...
    langWords = fetch("data/ui-i18n.v2." + lang + ".json")
      .then(function (r) {
