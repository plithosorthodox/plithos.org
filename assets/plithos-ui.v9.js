 ...
 *      fetches data/search-index.v5.json, once, on first open.
 *
...
(function () {
  ...
  /* Everything the shared chrome says to a reader is held here rather than
     ...
     data/ui-i18n.v4.en.json is the same table as a file: it is the sheet a
     translator copies. The other languages are read from
     data/ui-i18n.v4.<code>.json, fetched once beside the index.
  ...
  function loadWords() {
    ...
    langWords = fetch("data/ui-i18n.v4." + lang + ".json")
      .then(function (r) {
